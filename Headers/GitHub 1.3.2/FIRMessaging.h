...
#import "FIRMessagingInterop-Protocol.h"
...
@interface FIRMessaging : NSObject <FIRMessagingInterop, FIRLibrary, FIRMessagingClientDelegate, FIRMessagingReceiverDelegate, GULReachabilityDelegate>
{
...
- (void)deleteDataWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)deleteTokenWithCompletion:(CDUnknownBlockType)arg1;
- (void)tokenWithCompletion:(CDUnknownBlockType)arg1;
