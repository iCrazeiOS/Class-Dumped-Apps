...
#import <Core/_WAStaticTableViewControllerTrackingViewDelegate-Protocol.h>

@class NSArray, NSString, UIView, WACachedCopyMutableArray, _WAStaticTableViewControllerTrackingView;

@interface WAStaticTableViewController : WAWarningTableViewController <_WAStaticTableViewControllerTrackingViewDelegate>
{
