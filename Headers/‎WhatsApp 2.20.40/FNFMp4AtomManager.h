...
- (id)initWithMoovAtomSize:(unsigned long long)arg1 enableMp4AssetSeekingFix:(_Bool)arg2 enableMp4AssetEditListSeekingFix:(_Bool)arg3 enableMp4AssetRotationSupport:(_Bool)arg4 enableWhatsAppStreaming:(_Bool)arg5 enableHEVCSupport:(_Bool)arg6;
- (void)dealloc;
