...
@class NSArray, NSAttributedString, NSData, NSManagedObjectID, NSSet, NSString, NSURL, UIColor, WAChatUserJIDPair, WAGroupMember, WAMessageID, WAPBMessage_TemplateMessage_HydratedFourRowTemplate, WAUserJID;

@interface WAMessage (MultiDevice) <WAIndexableManagedObject, WAMediaUploadable, QLPreviewItem>
...
- (void)addPendingDevicesFromDictionary:(id)arg1;
