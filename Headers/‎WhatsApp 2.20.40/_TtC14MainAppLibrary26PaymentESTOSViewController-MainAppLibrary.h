...
#import "_TtC14MainAppLibrary26PaymentESTOSViewController.h"

#import "WAPaymentFlowViewControllerType-Protocol.h"

@interface _TtC14MainAppLibrary26PaymentESTOSViewController (MainAppLibrary) <WAPaymentFlowViewControllerType>
