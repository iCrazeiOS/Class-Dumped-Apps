...
@protocol FNFAVPlayer, FNFDecompressionSession, FNFFramesBufferInterface, FNFPlayerDisplayEngineDelegate, FNFVideoPlaybackLoggingContext, OS_dispatch_queue;
...
@interface FNFIOSurfacePlayerLayer : CALayer <FNFDecompressionSessionDelegate, CALayerDelegate, FNFPlayerDisplayEngine, FNFAVPlayerLayer>
{
    ...
    id <FNFFramesBufferInterface> _framesBuffer;
    ...
    _Bool _shouldNotCommitCATransactionWhenDecode;
    struct FNFDecompressionConfig _decompressionConfig;
    _Bool _disableApplyTransformIfUnchanged;
    id _lastDecodedFrame;
    _Bool _useCALayerDelegateForRender;
    _Bool _dispatchLastDecodeFrameToMainQueue;
...
- (void)enqueueSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 attributes:(unsigned int)arg2 codec:(unsigned long long)arg3;
...
- (id)initWithConfig:(CDStruct_af9396dd)arg1 andCodecMap:(struct NSDictionary *)arg2;
- (id)initWithConfig:(CDStruct_af9396dd)arg1;
