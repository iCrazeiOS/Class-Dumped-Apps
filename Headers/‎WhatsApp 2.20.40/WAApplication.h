...
@class UIView, UIWindow, WADeepLink, WATimeSpentMonitor;
...
- (_Bool)wa_openURLFromQRCode:(id)arg1 withCameraSource:(long long)arg2 fromController:(id)arg3 completion:(CDUnknownBlockType)arg4;
