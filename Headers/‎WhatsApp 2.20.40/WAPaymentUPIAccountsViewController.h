...
@class NSArray, NSIndexPath, NSString, UIBarButtonItem, WAActivityLabel, WAPaymentProcessedByFooterView, WAPaymentUPIManager, WAViewControllerConnectionObserver, _WAPaymentUPIAccountsTableHeaderView;

@interface WAPaymentUPIAccountsViewController : WAStaticTableViewController <WAPaymentLoadingViewControllerType>
{
