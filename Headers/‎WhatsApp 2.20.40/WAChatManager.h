...
#import "WAMDSyncServiceDelegate-Protocol.h"
...
@class CLLocation, NSDate, NSLock, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSString, WAAfterDateBlockTask, WABizManager, WABlockedContactsList, WAChatStorage, WAContactsStorage, WAMediaUploaderMain, WAMessageMediaDownloader, WAMessageNotificationCenter, WAMessagingService, WANameDirectory, WAProfilePictureManager, WARegistrationManager, WASignalManager, WASyncManager, WAWebClient, XMPPConnectionMain;
@protocol WAMDSyncService;

@interface WAChatManager : NSObject <WAChatStorageDelegate, WAWebClientDelegate, WAMDSyncServiceDelegate, XMPPConnectionDelegate, WASyncManagerDelegate, WAContactsStorageDelegate, WAMessageNotificationCenterDelegate>
{
    WAWebClient *_webClient;
    id <WAMDSyncService> _mdSyncService;
...
- (id)bestCurrentContactForUserJID:(id)arg1 addedContact:(id)arg2 removedContact:(id)arg3;
- (void)syncNewContacts:(id)arg1 removedContacts:(id)arg2 forceRemove:(_Bool)arg3;
- (void)contactsStorage:(id)arg1 addressBookDidUpdateContactNames:(id)arg2 deletedContacts:(id)arg3;
- (void)contactsStorage:(id)arg1 syncDidAddNewContacts:(id)arg2 removedContacts:(id)arg3;
- (void)contactsStorage:(id)arg1 syncDidRemoveContact:(id)arg2;
...
- (_Bool)shouldPerformChatActionWithWebLastMessageID:(id)arg1 inChatSession:(id)arg2;
...
- (_Bool)performSecurityNotificationSettingAction:(id)arg1;
- (_Bool)performMuteChatAction:(id)arg1;
- (_Bool)performPinChatAction:(id)arg1;
- (_Bool)performStarMessageAction:(id)arg1;
- (_Bool)internalPerformAction:(id)arg1;
...
- (void)setupWebClient;
- (unsigned long long)didReceivePhashMismatchAckForRevokeMessages:(id)arg1 deviceSyncNeeded:(_Bool)arg2 serverPhash:(id)arg3;
