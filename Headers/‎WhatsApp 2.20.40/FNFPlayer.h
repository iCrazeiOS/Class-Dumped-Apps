...
#import <Core/FNFAVPlayer-Protocol.h>
#import <Core/FNFSynchronousPlayerDelegate-Protocol.h>
...
- (void)prepareToSeekWithTime:(CDStruct_1b6d18a9)arg1 callbackQueue:(id)arg2 handler:(CDUnknownBlockType)arg3;
...
- (id)initWithDisplayEngine:(id)arg1 clock:(id)arg2 config:(CDStruct_8c4d8488)arg3 asyncTimebase:(_Bool)arg4 enableOpus:(_Bool)arg5;
- (id)initWithDisplayEngine:(id)arg1 config:(CDStruct_8c4d8488)arg2 asyncTimebase:(_Bool)arg3 enableOpus:(_Bool)arg4;
