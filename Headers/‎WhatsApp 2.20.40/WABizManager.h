...
- (id)translationArrayInPack:(struct WAPBHighlyStructuredMessagePack *)arg1 forElementName:(id)arg2;
- (_Bool)isPack:(struct WAPBHighlyStructuredMessagePack *)arg1 compatibleWithFourRowMessageData:(id)arg2 subType:(id *)arg3;
- (_Bool)isPack:(struct WAPBHighlyStructuredMessagePack *)arg1 compatibleWithMessageData:(id)arg2;
- (_Bool)isPack:(struct WAPBHighlyStructuredMessagePack *)arg1 compatibleWithContainer:(id)arg2 subType:(id *)arg3;
...
- (id)messageTextInMessageData:(id)arg1 usingPack:(struct WAPBHighlyStructuredMessagePack *)arg2 translation:(struct WAPBHighlyStructuredMessagePack_HighlyStructuredMessageTranslation *)arg3 translatedText:(id)arg4;
...
- (id)hydratedFourRowTemplateFromFourRowTemplateMessage:(id)arg1 usingPack:(struct WAPBHighlyStructuredMessagePack *)arg2 errorCode:(unsigned long long *)arg3 errorSubType:(id *)arg4 errorButtonIndex:(long long *)arg5;
- (id)textForButtonType:(int)arg1 pack:(id)arg2 templateButton:(id)arg3 translation:(struct WAPBHighlyStructuredMessagePack_HighlyStructuredMessageTranslation *)arg4 forDisplay:(_Bool)arg5;
- (id)textForTextType:(int)arg1 pack:(id)arg2 messageData:(id)arg3 translation:(struct WAPBHighlyStructuredMessagePack_HighlyStructuredMessageTranslation *)arg4;
