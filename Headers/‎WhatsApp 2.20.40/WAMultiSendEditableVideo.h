...
- (void)submitFieldStatsEventIfNeededWithExportFlowDuration:(double)arg1 isUsingFBTranscoder:(_Bool)arg2;
...
- (id)initWithTemporaryFileURL:(id)arg1 contentProvider:(long long)arg2 sourceFormat:(unsigned long long)arg3 quality:(id)arg4;
- (id)initWithVideoURL:(id)arg1 assetIdentifier:(id)arg2 contentProvider:(long long)arg3 sourceFormat:(unsigned long long)arg4 GIFAsset:(id)arg5 slowMotionTimeRange:(CDStruct_e83c9415)arg6 quality:(id)arg7;
