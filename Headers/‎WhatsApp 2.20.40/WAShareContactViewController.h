...
@class NSArray, NSMutableArray, WAShareContactTableHeaderView, WAVCardBizInfoSharingUnit, WAVCardNameSharingUnit;
...
- (id)initWithContact:(id)arg1 showCancelButton:(_Bool)arg2;
