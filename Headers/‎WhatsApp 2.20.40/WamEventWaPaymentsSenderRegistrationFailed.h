...
@interface WamEventWaPaymentsSenderRegistrationFailed : WamEvent
{
    ...
    double _try_another_method_selected;
}

@property(nonatomic) double try_another_method_selected; // @synthesize try_another_method_selected=_try_another_method_selected;
