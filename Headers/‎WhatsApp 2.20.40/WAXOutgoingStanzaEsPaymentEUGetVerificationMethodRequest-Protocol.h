...
@protocol WAXOutgoingStanzaElementEsPaymentEUGetVerificationMethodRequest_Account;

@protocol WAXOutgoingStanzaEsPaymentEUGetVerificationMethodRequest <NSObject, WAXOutgoingStanza>
@property(readonly, nonatomic) NSObject<WAXOutgoingStanzaElementEsPaymentEUGetVerificationMethodRequest_Account> *account;
