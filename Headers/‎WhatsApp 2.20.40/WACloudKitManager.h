...
- (id)initWithUserJID:(id)arg1 container:(id)arg2 keyValueStore:(id)arg3 chatStorage:(id)arg4 xmppConnection:(id)arg5 callStorage:(id)arg6 backedUpKeyValueStore:(id)arg7 userDefaults:(id)arg8 networkUsageManager:(id)arg9 wallpaperFileURL:(id)arg10;
