...
@interface WAPBMessage (HistorySync)
...
+ (void)populateImageInProtobufMessage:(id)arg1 fromWAMessage:(id)arg2 mediaInfoContainer:(id)arg3 contextInfo:(id)arg4 thumbnail:(id)arg5 product:(_Bool)arg6;
- (void)trimJPEGThumbnails;
