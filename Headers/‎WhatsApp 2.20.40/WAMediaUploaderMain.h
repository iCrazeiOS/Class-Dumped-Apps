...
+ (void)setupUserInfo:(id)arg1 withMessages:(id)arg2 mediaKey:(id)arg3 reuseReason:(unsigned long long)arg4 reuploading:(_Bool)arg5 asyncResumeCheckResult:(id)arg6 completion:(CDUnknownBlockType)arg7;
- (void)requestWithUserInfo:(id)arg1 didUpdateProgress:(double)arg2;
