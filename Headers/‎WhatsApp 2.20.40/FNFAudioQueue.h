...
- (void)dealloc;
- (void)setAudioStreamBasicDescription:(struct AudioStreamBasicDescription)arg1 extraParameters:(id)arg2 putDataCallback:(CDUnknownBlockType)arg3 outputCallback:(CDUnknownBlockType)arg4 bufferUnderrunCallback:(CDUnknownBlockType)arg5 errorCallback:(CDUnknownBlockType)arg6 logWarningCallback:(CDUnknownBlockType)arg7 sampleFrameSize:(unsigned int)arg8 minSampleFrameSize:(unsigned int)arg9;
- (id)initWithPlayerConfig:(CDStruct_8c4d8488)arg1;
- (id)init;
