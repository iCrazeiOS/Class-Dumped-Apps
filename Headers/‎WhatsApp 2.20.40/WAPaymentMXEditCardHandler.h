...
@interface WAPaymentMXEditCardHandler : _$s8Payments18PaymentBaseHandlerCN
{
...
- (void).cxx_destruct;
- (id)initWithRootViewController:(id)arg1 paymentManager:(id)arg2 card:(id)arg3 rootHandlerDelegate:(id)arg4;
