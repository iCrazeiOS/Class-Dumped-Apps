...
@interface WamEventWaPaymentsIdPartnerAccountRegistration : WamEvent
{
    double _partner_support_selected;
    double _partner_terms_selected;
    ...
    NSString *_payments_id_account_registration_status;
    NSString *_payments_partner_name;
    double _unrecognized_account_selected;
}

@property(nonatomic) double unrecognized_account_selected; // @synthesize unrecognized_account_selected=_unrecognized_account_selected;
@property(copy, nonatomic) NSString *payments_partner_name; // @synthesize payments_partner_name=_payments_partner_name;
@property(copy, nonatomic) NSString *payments_id_account_registration_status; // @synthesize payments_id_account_registration_status=_payments_id_account_registration_status;
...
@property(nonatomic) double partner_terms_selected; // @synthesize partner_terms_selected=_partner_terms_selected;
@property(nonatomic) double partner_support_selected; // @synthesize partner_support_selected=_partner_support_selected;
- (void).cxx_destruct;
