...
- (id)initMissedEventWithParticipants:(id)arg1 video:(_Bool)arg2 callTime:(double)arg3;
- (id)initWithParticipants:(id)arg1 callOutcome:(short)arg2 stanzaElement:(id)arg3;
- (id)initWithParticipants:(id)arg1 callLogInfo:(id)arg2 callInfo:(id)arg3;
- (id)initWithIncoming:(_Bool)arg1 outcome:(short)arg2 video:(_Bool)arg3 date:(id)arg4 duration:(double)arg5 bytesSent:(long long)arg6 bytesReceived:(long long)arg7 participants:(id)arg8;
