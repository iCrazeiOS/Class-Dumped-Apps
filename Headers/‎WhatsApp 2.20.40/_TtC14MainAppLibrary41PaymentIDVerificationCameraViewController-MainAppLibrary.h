...
#import "_TtC14MainAppLibrary41PaymentIDVerificationCameraViewController.h"

#import "WACameraButtonViewDelegate-Protocol.h"

@interface _TtC14MainAppLibrary41PaymentIDVerificationCameraViewController (MainAppLibrary) <WACameraButtonViewDelegate>
