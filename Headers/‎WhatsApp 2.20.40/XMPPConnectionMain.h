...
@class NSMutableDictionary, WABatchDispatcher, WAFieldStatsEventChatConnectionAttribution, WAMessageHandler, XMPPRequestSetProfilePicture;
...
- (void)enqueueRequestsForMultiReceiptsOfAck:(id)arg1;
- (void)processReceiptTypeIncomingAck:(id)arg1;
