...
@interface WamEventIndiaPaymentsGetAccounts : WamEvent
{
    NSNumber *_payments_psp_id_number;
    NSNumber *_payments_response_result_number;
    double _accounts_exist;
...
@property(nonatomic) double accounts_exist; // @synthesize accounts_exist=_accounts_exist;
- (void).cxx_destruct;
