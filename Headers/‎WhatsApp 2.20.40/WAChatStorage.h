...
@class CLLocation, CLLocationManager, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSPointerArray, NSString, WABatchDispatcher, WAChatSession, WAChatSessionSpotlightIndexer, WAExactTimer, WAMessagePortSender, WAMessageSearchEngine, WAMessagesBySessionTask, WAMutableDictionary, WAPersistentKeyValueStore, WASpotlightManager, WAStatusChangeRequestManager, WAStickerStorage, WATask, WATaskManager, XMPPConnection;
