...
@interface WamEventWaPaymentsVerifyCardPndRequestAgain : WamEvent
{
    ...
    double _payments_request_again_selected;
}

@property(nonatomic) double payments_request_again_selected; // @synthesize payments_request_again_selected=_payments_request_again_selected;
