...
#import <Core/FNFAssetEventListener-Protocol.h>
#import <Core/FNFPlayerDisplayEngineDelegate-Protocol.h>
...
- (void)_audioEngineOutputCallback:(struct AudioTimeStamp)arg1 framePts:(CDStruct_1b6d18a9)arg2;
- (_Bool)_readyToPlay;
- (void)_syncVolume;
...
- (void)play;
- (id)description;
- (id)initWithDisplayEngine:(id)arg1 config:(CDStruct_8c4d8488)arg2 audioEngine:(id)arg3 audioDecoder:(id)arg4 clock:(id)arg5 runningQueue:(id)arg6 muted:(_Bool)arg7 asyncTimebase:(_Bool)arg8;
- (void)dealloc;
