...
@interface WAListInfoViewController : WATableViewController <_WAListRecipientsControllerDelegate, WAParticipantPickerViewControllerDelegate, UITextFieldDelegate, UIGestureRecognizerDelegate>
{
