...
- (void).cxx_destruct;
- (id)initWithParticipantType:(unsigned long long)arg1 minContacts:(long long)arg2 maxContacts:(long long)arg3 screenTitle:(id)arg4 rightButtonTitle:(id)arg5 includeToolbar:(_Bool)arg6 singleSelection:(_Bool)arg7 showInvites:(_Bool)arg8;
