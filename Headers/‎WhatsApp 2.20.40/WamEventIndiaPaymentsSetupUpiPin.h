...
@interface WamEventIndiaPaymentsSetupUpiPin : WamEvent
{
    NSNumber *_payments_psp_id_number;
    double _payments_back_selected;
    NSString *_payments_bank_id;
    NSString *_payments_event_id;
    double _setup_pin_selected;
}

@property(nonatomic) double setup_pin_selected; // @synthesize setup_pin_selected=_setup_pin_selected;
