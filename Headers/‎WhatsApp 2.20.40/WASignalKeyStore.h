...
- (void)rotateSenderKeysOfLocalDeviceJID:(id)arg1 forOpaqueGroupIDs:(id)arg2;
- (void)markDeviceJID:(id)arg1 didReceiveLocalSenderKey:(_Bool)arg2 forGroupCipherJID:(id)arg3;
- (id)fetchSenderKeyOpaqueGroupIDsWithUserJID:(id)arg1;
...
- (void)clearIdentityForDeviceJID:(id)arg1;
