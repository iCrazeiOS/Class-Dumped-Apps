...
@class NSMutableArray, NSString, NSTimer, UILabel, UIView, UIViewController, WAAlertViewPresenter, WACallStorage, WAChatManager, WAChatStorage, WACloudBackupManager, WAContactsStorage, WAGroupInviteJoinController, WAReferenceCountToken, WASignalManager, WAStatusSessionManager, WATabBarController, WATaskManager, WATimelockViewController, WAWindow;
...
- (void)processContactURL:(id)arg1;
...
- (void)setNeedsProcessContactURL:(id)arg1;
...
- (void)setNeedsProcessGroupInviteURL:(id)arg1 fromController:(id)arg2 completion:(CDUnknownBlockType)arg3;
