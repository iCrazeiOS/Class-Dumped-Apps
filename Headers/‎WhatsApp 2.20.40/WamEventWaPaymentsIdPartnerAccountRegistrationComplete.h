...
@interface WamEventWaPaymentsIdPartnerAccountRegistrationComplete : WamEvent
{
    ...
    double _skip_account_upgrade;
}

@property(nonatomic) double skip_account_upgrade; // @synthesize skip_account_upgrade=_skip_account_upgrade;
