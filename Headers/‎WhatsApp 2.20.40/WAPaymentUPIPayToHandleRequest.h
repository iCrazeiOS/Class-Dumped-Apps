...
- (id)initWithCurrency:(id)arg1 amount_1000:(long long)arg2 credentialId:(id)arg3 deviceId:(id)arg4 encryptedMpin:(id)arg5 receiverHandle:(id)arg6 senderHandle:(id)arg7 clTransactionId:(id)arg8 merchantCode:(id)arg9 refId:(id)arg10 refUrl:(id)arg11 note:(id)arg12 payeeName:(id)arg13 bankInfo:(id)arg14 receiverFBHandleId:(id)arg15 senderFBHandleId:(id)arg16;
