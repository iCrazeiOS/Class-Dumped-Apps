...
@class NSLayoutConstraint, UIBarButtonItem, UILabel, UIView, WAPaymentCardView, _TtC8Payments23WAPaymentUPIBankAccount;
...
@interface WAPaymentUPIDebitCardViewController : WAViewController <WAPaymentCardViewDelegate>
{
    ...
    _TtC8Payments23WAPaymentUPIBankAccount *_account;
...
@property(retain, nonatomic) _TtC8Payments23WAPaymentUPIBankAccount *account; // @synthesize account=_account;
