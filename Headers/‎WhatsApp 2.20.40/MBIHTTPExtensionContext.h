...
@interface MBIHTTPExtensionContext : NSObject <NSURLSessionDataDelegate, NSURLSessionDelegate, NSURLSessionDownloadDelegate, NSURLSessionTaskDelegate>
{
    ...
    struct NSMutableDictionary *_taskIdentifierToAppBackgroundTaskMap_MAIN;
    struct NSMutableDictionary *_taskIdentifierToDataMap_NETWORK;
    struct NSMutableDictionary *_taskIdentifierToRequestContextMap_NETWORK;
    struct NSMutableDictionary *_taskIdentifierToTaskMap_NETWORK;
    struct NSMutableDictionary *_taskIdentifierToUploadProgressContextMap_NETWORK;
}
