...
+ (_Bool)unzipFileAtPath:(id)arg1 toDestination:(id)arg2 overwrite:(_Bool)arg3 password:(id)arg4 recursive:(_Bool)arg5 maxOutputSize:(unsigned long long)arg6 error:(id *)arg7 delegate:(id)arg8 progressHandler:(CDUnknownBlockType)arg9 completionHandler:(CDUnknownBlockType)arg10;
+ (_Bool)unzipFileAtPath:(id)arg1 toDestination:(id)arg2 overwrite:(_Bool)arg3 password:(id)arg4 recursive:(_Bool)arg5 maxOutputSize:(unsigned long long)arg6 progressHandler:(CDUnknownBlockType)arg7 completionHandler:(CDUnknownBlockType)arg8;
...
- (void).cxx_destruct;
- (_Bool)closeWithComment:(id)arg1;
- (_Bool)close;
