...
- (id)initWithCurrency:(id)arg1 amount_1000:(long long)arg2 deviceId:(id)arg3 receiverHandle:(id)arg4 senderHandle:(id)arg5 clTransactionId:(id)arg6 credentialId:(id)arg7 note:(id)arg8 bankInfo:(id)arg9;
