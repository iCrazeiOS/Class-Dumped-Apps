...
@class NSArray, NSMutableArray, NSObject, NSString, NSUserDefaults, WACallStorageAggregateEventMutableArray, WAContactsSearchController;
...
- (id)initWithUserDefaults:(id)arg1 taskKeyValueStore:(id)arg2 taskManager:(id)arg3;
