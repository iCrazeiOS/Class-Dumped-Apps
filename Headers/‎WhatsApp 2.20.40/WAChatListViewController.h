...
@class NSArray, NSIndexPath, NSMutableArray, NSNumber, NSString, NSTimer, UIBarButtonItem, UICollectionView, UIFont, UIView, WAActivityLabel, WAAllChatsArchivedView, WAChatListHeaderCell, WAChatListNavigationController, WAChatListSearchBar, WAChatSession, WAEmptyChatListView, WALoadingTableViewCell, WAMessage, WAMultiSelectBar, WANoResultsView, WAProductCatalogPresenter, WARestoreTableViewCell, WASearchResultsController, WASearchToolbar, WAViewControllerConnectionObserver;
@protocol UIViewControllerPreviewing, WAChatListExpandableHeader;

@interface WAChatListViewController : WAChatSessionsViewController <UIViewControllerTransitioningDelegate, UIGestureRecognizerDelegate, UINavigationControllerDelegate, WASearchResultsControllerDelegate, WANewChatPhoneInputViewControllerDelegate, WAChatComposerDelegate, WAEmptyChatListViewDelegate, WAAllChatsArchivedViewDelegate, WAChatListExpandableHeaderDelegate, WASearchControllerDelegate, WATextSharingViewControllerDelegate, WAMultiShotCameraControllerDelegate, WAMultiSelectBarDelegate, WARestorable, WAMultiSendMediaPickerControllerDelegate, WAGIFSearchViewControllerDelegate, WATokenizedSearchBarDelegate, WASearchResultsMessageTableViewCellDelegate, UICollectionViewDataSource, UICollectionViewDelegate, WANewContactViewControllerDelegate, WAContactDetailsViewControllerDelegate, WASearchTableViewFloatingHeaderSuppressing, WASearchToolbarDelegate, WANavigationItemCustomBackButtonTitle, WAImageToImageTransitioning, WANavigationControllerPopToAnimating, WAMultiSendPreviewViewControllerDelegate>
{
...
- (void)chatListExpandableHeaderDidRequestShowAction:(id)arg1 action:(id)arg2;
