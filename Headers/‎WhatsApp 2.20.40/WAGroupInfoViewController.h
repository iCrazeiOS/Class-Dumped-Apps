...
@class NSArray, NSMutableArray, NSMutableSet, NSString, UIBarButtonItem, WAChatMediaManager, WAGroupJID, WAGroupParticipantsController, WALabelAndButtonHeaderView, WAMutableDictionary, WATableRow, WATableSection, WAUserJID, _WAGroupCreationFooterView;
