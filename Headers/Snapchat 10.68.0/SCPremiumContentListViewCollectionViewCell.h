...
@class NSString, SCActionModel, SCDiscoverFeedDebugView, SCDiscoverFeedLabelOverlayView, SCDiscoverFeedPublisherStoryProgressBarView, SCDiscoverFeedWhiteSpaceProfileRowView, SCEventListenerAnnouncer, SCLazy, SCNetworkImageView, SCRoundedCornerContainerView, UITapGestureRecognizer, UIView;
@protocol SCActionHandling, SCImageDownloading;

@interface SCPremiumContentListViewCollectionViewCell : SCSearchCollectionViewCell <UIGestureRecognizerDelegate, SCEventAnnouncing, SCEventListener, SCViewModelConfigurable, SCActionable, SCViewportConfigurable, SCDiscoverFeedStoryTileWithCoverImageConfigurable>
{
