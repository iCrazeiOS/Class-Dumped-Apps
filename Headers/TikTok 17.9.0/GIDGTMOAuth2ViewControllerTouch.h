...
@class GIDGTMOAuth2Authentication, GIDGTMOAuth2SignIn, NSArray, NSDictionary, NSMutableDictionary, NSString, NSURL, NSURLRequest, UIActivityIndicatorView, UIBarButtonItem, UIButton, UIView, UIWebView;

@interface GIDGTMOAuth2ViewControllerTouch : UIViewController <UINavigationControllerDelegate, UIWebViewDelegate>
{
...
@property(readonly, retain, nonatomic) GIDGTMOAuth2SignIn *signIn; // @synthesize signIn=signIn_;
...
- (void)swapInCookies;
- (void)swapOutCookies;
@property(readonly, retain, nonatomic) GIDGTMOAuth2Authentication *authentication;
