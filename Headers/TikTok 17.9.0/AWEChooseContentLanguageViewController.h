...
@class AWEContentLanguageManager, NSArray, NSString, UIButton, UITableView;

@interface AWEChooseContentLanguageViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, AWERouterViewControllerProtocol>
{
