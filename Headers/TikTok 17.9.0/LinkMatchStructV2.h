...
@class CaptionAnchorStructV2, CaptionInfoStructV2, NSMutableArray;
...
@property(retain, nonatomic) CaptionAnchorStructV2 *captionAnchor; // @dynamic captionAnchor;
@property(retain, nonatomic) CaptionInfoStructV2 *captionInfo; // @dynamic captionInfo;
@property(nonatomic) _Bool hasCaptionAnchor; // @dynamic hasCaptionAnchor;
