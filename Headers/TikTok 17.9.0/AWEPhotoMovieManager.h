...
+ (void)saveChosenImages:(id)arg1 displayDuration:(double)arg2 transitionDuration:(double)arg3 forModel:(id)arg4 completion:(CDUnknownBlockType)arg5;
+ (void)updateModel:(id)arg1 withMusicList:(id)arg2 fileURL:(id)arg3 feedMusicModel:(id)arg4;
...
+ (id)imagesForTransitionWithImages:(id)arg1 displayDuration:(double)arg2 transitionDuration:(double)arg3;
