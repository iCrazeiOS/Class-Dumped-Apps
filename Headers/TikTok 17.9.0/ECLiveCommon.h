...
@class ECLiveText, NSString;

@interface ECLiveCommon : GPBMessage
{
}
...
@property(retain, nonatomic) ECLiveText *displayText; // @dynamic displayText;
...
@property(copy, nonatomic) NSString *msgProcessFilterK; // @dynamic msgProcessFilterK;
@property(copy, nonatomic) NSString *msgProcessFilterV; // @dynamic msgProcessFilterV;
@property(nonatomic) long long priorityScore; // @dynamic priorityScore;
