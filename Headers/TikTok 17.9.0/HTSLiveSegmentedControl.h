...
@class CALayer, HTSLiveScrollView, NSArray, NSDictionary, NSMutableDictionary, UIColor, UIImage;

@interface HTSLiveSegmentedControl : UIControl
{
    _Bool _userDraggable;
    _Bool _touchEnabled;
    _Bool _verticalDividerEnabled;
    _Bool _enableBounceAnimation;
    _Bool _shouldAnimateUserSelection;
    float _selectionIndicatorShadowOpacity;
    int _type;
    int _selectionStyle;
    int _segmentWidthStyle;
    int _selectionIndicatorPosition;
    NSArray *_sectionTitles;
    NSArray *_sectionImages;
    NSArray *_sectionSelectedImages;
    CDUnknownBlockType _indexChangeBlock;
    CDUnknownBlockType _reselectIndexBlock;
    CDUnknownBlockType _titleFormatter;
    NSDictionary *_titleTextAttributes;
    NSDictionary *_selectedTitleTextAttributes;
    UIColor *_backgroundColor;
    UIColor *_selectionIndicatorColor;
    double _selectionIndicatorShadowRadius;
    UIColor *_selectionIndicatorShadowColor;
    ...
    double _indicatorTitleInterval;
    UIImage *_selectionIndicatorImage;
    NSArray *_selectionIndicatorImages;
    double _leftOffsetForDynamicSytle;
    CALayer *_selectionIndicatorStripLayer;
    CALayer *_selectionIndicatorBoxLayer;
    CALayer *_selectionIndicatorArrowLayer;
    CALayer *_selectionIndicatorImageLayer;
    double _segmentWidth;
    NSArray *_segmentWidthsArray;
    HTSLiveScrollView *_scrollView;
    NSMutableDictionary *_badgeDict;
    struct CGSize _selectionIndicatorShadowOffset;
    struct UIEdgeInsets _selectionIndicatorEdgeInsets;
    struct UIEdgeInsets _segmentEdgeInset;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableDictionary *badgeDict; // @synthesize badgeDict=_badgeDict;
@property(retain, nonatomic) HTSLiveScrollView *scrollView; // @synthesize scrollView=_scrollView;
...
@property(retain, nonatomic) CALayer *selectionIndicatorImageLayer; // @synthesize selectionIndicatorImageLayer=_selectionIndicatorImageLayer;
...
@property(nonatomic) double leftOffsetForDynamicSytle; // @synthesize leftOffsetForDynamicSytle=_leftOffsetForDynamicSytle;
@property(copy, nonatomic) NSArray *selectionIndicatorImages; // @synthesize selectionIndicatorImages=_selectionIndicatorImages;
...
@property(nonatomic) _Bool enableBounceAnimation; // @synthesize enableBounceAnimation=_enableBounceAnimation;
@property(nonatomic) double indicatorTitleInterval; // @synthesize indicatorTitleInterval=_indicatorTitleInterval;
...
@property(nonatomic) int selectionIndicatorPosition; // @synthesize selectionIndicatorPosition=_selectionIndicatorPosition;
...
@property(retain, nonatomic) UIColor *selectionIndicatorShadowColor; // @synthesize selectionIndicatorShadowColor=_selectionIndicatorShadowColor;
@property(nonatomic) double selectionIndicatorShadowRadius; // @synthesize selectionIndicatorShadowRadius=_selectionIndicatorShadowRadius;
@property(nonatomic) struct CGSize selectionIndicatorShadowOffset; // @synthesize selectionIndicatorShadowOffset=_selectionIndicatorShadowOffset;
@property(nonatomic) float selectionIndicatorShadowOpacity; // @synthesize selectionIndicatorShadowOpacity=_selectionIndicatorShadowOpacity;
...
@property(copy, nonatomic) CDUnknownBlockType reselectIndexBlock; // @synthesize reselectIndexBlock=_reselectIndexBlock;
...
- (double)estimatedControlWidthWithTitles;
...
- (_Bool)isIOS10AndLater;
- (void)clearBadgeAtIndex:(unsigned long long)arg1;
- (void)clearAllBadges;
- (_Bool)badgeExistAtIndex:(unsigned long long)arg1;
- (void)setBadgeView:(id)arg1 atIndex:(unsigned long long)arg2;
- (void)setBadgeImage:(id)arg1 atIndex:(unsigned long long)arg2;
