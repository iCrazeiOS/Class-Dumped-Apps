...
@class GPBInt64ObjectDictionary, HTSLiveCommon, IESLiveRivalExtraInfo, NSMutableArray, NSString;
...
@property(copy, nonatomic) NSString *anchorLinkmicIdStr; // @dynamic anchorLinkmicIdStr;
@property(nonatomic) long long answer; // @dynamic answer;
@property(copy, nonatomic) NSString *appId; // @dynamic appId;
@property(copy, nonatomic) NSString *appSign; // @dynamic appSign;
...
@property(nonatomic) _Bool hasInviterRivalExtra; // @dynamic hasInviterRivalExtra;
@property(nonatomic) long long inviteType; // @dynamic inviteType;
@property(nonatomic) long long inviteUid; // @dynamic inviteUid;
@property(retain, nonatomic) IESLiveRivalExtraInfo *inviterRivalExtra; // @dynamic inviterRivalExtra;
...
@property(copy, nonatomic) NSString *replyPrompts; // @dynamic replyPrompts;
@property(nonatomic) int replyType; // @dynamic replyType;
@property(nonatomic) long long rivalAnchorId; // @dynamic rivalAnchorId;
@property(nonatomic) long long rivalLinkmicId; // @dynamic rivalLinkmicId;
@property(copy, nonatomic) NSString *rivalLinkmicIdStr; // @dynamic rivalLinkmicIdStr;
...
@property(nonatomic) long long secApplyUid; // @dynamic secApplyUid;
@property(copy, nonatomic) NSString *secFromUserId; // @dynamic secFromUserId;
@property(nonatomic) long long secInviteUid; // @dynamic secInviteUid;
@property(copy, nonatomic) NSString *secToUserId; // @dynamic secToUserId;
@property(nonatomic) _Bool showPopup; // @dynamic showPopup;
