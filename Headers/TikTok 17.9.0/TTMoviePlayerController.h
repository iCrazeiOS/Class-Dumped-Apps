...
@interface TTMoviePlayerController : NSObject <NotifyHandler>
{
    ...
    // Error parsing type: ^{PCMWriter=^^?^^?{atomic<com::ss::ttm::utils::AVState::States>=Ai}iiiB*^{AVSource}^{AVHandler}^^?ii{AVQueue<com::ss::ttm::AVBuffer *>=BB^{AVNode}^{AVNode}^{AVNode}^{AVNode}^{AVNode}{_opaque_pthread_mutex_t=q[56c]}{_opaque_pthread_cond_t=q[40c]}iiiii*^{AVBufferCallback}i}{AVStack<com::ss::ttm::AVBuffer *>=BB^{AVNode}^{AVNode}^{AVNode}^{AVNode}^{AVNode}{_opaque_pthread_mutex_t=q[56c]}{_opaque_pthread_cond_t=q[40c]}iiiii*}{AVThread={atomic<int>=Ai}*^{_opaque_pthread_t}{_opaque_pthread_mutex_t=q[56c]}{_opaque_pthread_cond_t=q[40c]}{_opaque_pthread_mutex_t=q[56c]}{_opaque_pthread_cond_t=q[40c]}BB^{AVProcessor}{AVTHREAD_INFO=^?^?^v}i}B^{__sFILE}*^{AVFilter}iiiii}, name: _pcmWriter
    // Error parsing type: ^{YUVWriter=^^?^^?{atomic<com::ss::ttm::utils::AVState::States>=Ai}iiiB*^{AVSource}^{AVHandler}^^?ii{AVQueue<com::ss::ttm::AVBuffer *>=BB^{AVNode}^{AVNode}^{AVNode}^{AVNode}^{AVNode}{_opaque_pthread_mutex_t=q[56c]}{_opaque_pthread_cond_t=q[40c]}iiiii*^{AVBufferCallback}i}{AVStack<com::ss::ttm::AVBuffer *>=BB^{AVNode}^{AVNode}^{AVNode}^{AVNode}^{AVNode}{_opaque_pthread_mutex_t=q[56c]}{_opaque_pthread_cond_t=q[40c]}iiiii*}{AVThread={atomic<int>=Ai}*^{_opaque_pthread_t}{_opaque_pthread_mutex_t=q[56c]}{_opaque_pthread_cond_t=q[40c]}{_opaque_pthread_mutex_t=q[56c]}{_opaque_pthread_cond_t=q[40c]}BB^{AVProcessor}{AVTHREAD_INFO=^?^?^v}i}B^{__sFILE}*^{AVFilter}[4i][4i]iiiii{AVRationalN=ii}}, name: _yuvWriter
    _Bool _prepared;
