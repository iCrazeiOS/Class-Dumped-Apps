...
- (long long)recursiveCalculateAtPath:(const char *)arg1 isAbnormal:(_Bool *)arg2 isOutdated:(_Bool *)arg3 needCheckIgnorePath:(_Bool)arg4 deepLevel:(unsigned long long)arg5;
