...
- (id)showBubble:(id)arg1 forView:(id)arg2 inContainerView:(id)arg3 anchorAdjustment:(struct CGPoint)arg4 inDirection:(unsigned long long)arg5 useWindowToAdjustBodyFrame:(_Bool)arg6 isDarkBackGround:(_Bool)arg7 completion:(CDUnknownBlockType)arg8;
...
- (id)showBubble:(id)arg1 forView:(id)arg2 inContainerView:(id)arg3 fromAnchor:(struct CGPoint)arg4 anchorAdjustment:(struct CGPoint)arg5 cornerAdjustment:(struct CGPoint)arg6 fixedSize:(struct CGSize)arg7 inDirection:(unsigned long long)arg8 isDarkBackGround:(_Bool)arg9 useWindowToAdjustBodyFrame:(_Bool)arg10 useAnchorAdjustmentAsOffset:(_Bool)arg11 completion:(CDUnknownBlockType)arg12;
- (id)showBubble:(id)arg1 forView:(id)arg2 fromAnchor:(struct CGPoint)arg3 anchorAdjustment:(struct CGPoint)arg4 cornerAdjustment:(struct CGPoint)arg5 fixedSize:(struct CGSize)arg6 inDirection:(unsigned long long)arg7 isDarkBackGround:(_Bool)arg8 useWindowToAdjustBodyFrame:(_Bool)arg9 useAnchorAdjustmentAsOffset:(_Bool)arg10 completion:(CDUnknownBlockType)arg11;
...
- (id)showBubble:(id)arg1 forView:(id)arg2 inContainerView:(id)arg3 fromAnchor:(struct CGPoint)arg4 anchorAdjustment:(struct CGPoint)arg5 cornerAdjustment:(struct CGPoint)arg6 fixedSize:(struct CGSize)arg7 inDirection:(unsigned long long)arg8 isDarkBackGround:(_Bool)arg9 completion:(CDUnknownBlockType)arg10 withAnimation:(CDUnknownBlockType)arg11;
...
- (id)showBubble:(id)arg1 forView:(id)arg2 inContainerView:(id)arg3 fromAnchor:(struct CGPoint)arg4 anchorAdjustment:(struct CGPoint)arg5 inDirection:(unsigned long long)arg6 withAnimations:(CDUnknownBlockType)arg7 useWindowToAdjustBodyFrame:(_Bool)arg8 isDarkBackGround:(_Bool)arg9 completion:(CDUnknownBlockType)arg10;
