...
@protocol IESLiveMTVideoPlayerControllerDelegate;

@interface IESLiveMTVideoPlayerController : NSObject <TTVideoEngineDataSource, TTVideoEngineDelegate>
{
    _Bool _mute;
    _Bool _loop;
    ...
    id <IESLiveMTVideoPlayerControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <IESLiveMTVideoPlayerControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)reloadLocalURL:(id)arg1;
- (void)reloadVideoURL:(id)arg1;
