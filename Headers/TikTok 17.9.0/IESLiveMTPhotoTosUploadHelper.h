...
@class IESLiveMTImagePickerManager, IESLiveMTPhotoTosUploadConfig, NSString, UIActivityIndicatorView, UIImagePickerController;
@protocol IESLiveAppInfo, IESLiveHTTPClient, IESLiveMTInternalRouter, IESLiveUserService;

@interface IESLiveMTPhotoTosUploadHelper : NSObject <UIImagePickerControllerDelegate, UINavigationControllerDelegate, IESLiveMTImagePickerManagerDelegate>
{
    ...
    IESLiveMTPhotoTosUploadConfig *_config;
...
@property(retain, nonatomic) IESLiveMTPhotoTosUploadConfig *config; // @synthesize config=_config;
...
- (_Bool)checkImageSizeSuccess:(id)arg1;
- (_Bool)checkImageSuccess:(id)arg1 sourceType:(long long)arg2;
- (void)uploadPhotoWithImage:(id)arg1 sourceType:(long long)arg2;
...
- (void)uploadPhotoWithConfig:(id)arg1 completeBlock:(CDUnknownBlockType)arg2;
- (id)init;
