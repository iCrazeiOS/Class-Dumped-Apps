...
@class IESSticker, IESStickerAdapter, NSMutableDictionary, VERenderer;
...
@property(retain, nonatomic) VERenderer *alphaTextureRenderer; // @synthesize alphaTextureRenderer=_alphaTextureRenderer;
