...
@class AWEAccountDeleteButton, AWEAccountPhoneNumber, AWELiveCountryCodeView, NSAttributedString, NSString, SHSPhoneTextField, UIFont;

@interface AWELiveMTPhoneInputView : UIView <UITextFieldDelegate, AWEAccountDeleteButtonDelegate>
{
    ...
    AWELiveCountryCodeView *_countryCodeView;
    AWEAccountDeleteButton *_deleteButton;
    UIView *_separator;
}

+ (_Bool)adapter_enableVirtualPhone;
- (void).cxx_destruct;
@property(retain, nonatomic) UIView *separator; // @synthesize separator=_separator;
@property(retain, nonatomic) AWEAccountDeleteButton *deleteButton; // @synthesize deleteButton=_deleteButton;
@property(retain, nonatomic) AWELiveCountryCodeView *countryCodeView; // @synthesize countryCodeView=_countryCodeView;
