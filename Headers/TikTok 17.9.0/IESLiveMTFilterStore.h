...
@protocol IESLiveMTFilterReactions;

@interface IESLiveMTFilterStore : NSObject <HTSLiveFilterActions>
{
    _Bool _isDraw;
    _Bool _showFilterRedDot;
    id <IESLiveMTFilterReactions> _reaction;
...
@property(nonatomic) __weak id <IESLiveMTFilterReactions> reaction; // @synthesize reaction=_reaction;
