...
#import "IVERenderVideoPipelineProtocol-Protocol.h"

@class AVAsset, HTSGLContext, HTSGLFilter, HTSGLFilterInput, HTSVideoData, IESMMEffectStickerInfo, IESMMMVModel, IESVideoAddEdgeData, NSString, VEConfigData, VECrossPlatClipEffectFilterAdapter, VECrossPlatClipPreprocessAdapter, VECrossPlatEditorSession, VECrossPlatSequenceAdapter, VEMVPRenderer, VEReverseUnit;
@protocol IESVideoEngineEffectProtocol, IVEEffectAlgorithmProtocol, IVEEffectPublicProtocol;

@interface VECrossPlatEffectProcessUnit : VEUnitObject <IVERenderVideoPipelineProtocol, IVEEffectProcess>
{
    ...
    VEMVPRenderer *_pixelBuffRenderer;
    struct CGSize _previewSize;
    struct CGSize _canvasSize;
}

@property(retain, nonatomic) VEMVPRenderer *pixelBuffRenderer; // @synthesize pixelBuffRenderer=_pixelBuffRenderer;
...
- (void)restoreColorInfoToPixelBuffer:(id)arg1 pipeline:(struct TEVideoPipeline *)arg2;
- (void)renderVideoPipeline:(struct TEVideoPipeline *)arg1;
