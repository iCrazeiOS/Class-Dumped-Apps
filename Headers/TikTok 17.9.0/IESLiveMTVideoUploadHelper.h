...
@interface IESLiveMTVideoUploadHelper : NSObject <UIImagePickerControllerDelegate, UINavigationControllerDelegate, IESLiveMTImagePickerManagerDelegate>
{
...
- (void)imageMTPickerController:(id)arg1 didFinishPickingWithVideoFile:(id)arg2;
