...
@interface UIColor (BDAUtils) <TikTokIconColorProtocol>
...
+ (id)ttad_colorWithHex:(unsigned int)arg1 alpha:(float)arg2;
...
+ (id)btd_colorWithRGBA:(unsigned int)arg1;
+ (id)btd_colorWithRGB:(unsigned int)arg1 alpha:(double)arg2;
+ (id)btd_colorWithRGB:(unsigned int)arg1;
+ (id)btd_colorWithHexString:(id)arg1 alpha:(double)arg2;
+ (id)btd_colorWithHexString:(id)arg1;
+ (id)colorWithHex:(unsigned long long)arg1;
+ (id)bdp_hexStringFromUIColor:(id)arg1;
+ (id)bdp_negativeColor:(long long)arg1;
+ (id)bdp_LightColor5;
+ (id)bdp_LightColor4;
+ (id)bdp_LightColor3;
+ (id)bdp_LightColor2;
...
+ (id)bdp_DarkColor2;
+ (id)bdp_DarkColor1;
+ (id)colorBetweenColor:(id)arg1 andColor:(id)arg2 percentage:(float)arg3;
+ (_Bool)isValidColorHexString:(id)arg1;
+ (id)bdp_colorWithHexString:(id)arg1 defaultValue:(id)arg2;
+ (id)bdp_colorWithHexString:(id)arg1;
+ (id)bdp_colorWithString:(id)arg1;
+ (id)colorWithHex:(unsigned long long)arg1;
...
+ (id)acc_lightNameWithColorName:(id)arg1;
...
+ (id)live_colorWithHex:(unsigned int)arg1 alpha:(double)arg2;
