...
@class IESLiveMTEffectListView, IESLiveMTEffectUIConfig, NSString, UILabel;

@interface IESLiveMTEffectContentCollectionViewCell : UICollectionViewCell <IESEffectListViewDelegate>
{
    CDUnknownBlockType _selectBlock;
    CDUnknownBlockType _downloadBlock;
    NSString *_hasNoTips;
    IESLiveMTEffectListView *_listView;
...
@property(retain, nonatomic) IESLiveMTEffectListView *listView; // @synthesize listView=_listView;
