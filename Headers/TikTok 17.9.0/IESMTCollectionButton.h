...
@interface IESMTCollectionButton : UIButton <CAAnimationDelegate>
{
    _Bool _storedSelectedState;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool storedSelectedState; // @synthesize storedSelectedState=_storedSelectedState;
...
- (void)beginTouchAnimationWithSelected:(_Bool)arg1;
