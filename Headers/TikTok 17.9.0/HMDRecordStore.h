...
- (id)andConditionsWithLocalIDRange:(struct HMDRecordLocalIDRange)arg1 andConditions:(id)arg2;
- (void)logicalCleanupRecordsWithRange:(struct HMDRecordLocalIDRange)arg1 andConditions:(id)arg2 storeClass:(Class)arg3 object:(id)arg4;
- (_Bool)cleanupRecordsWithRange:(struct HMDRecordLocalIDRange)arg1 andConditions:(id)arg2 storeClass:(Class)arg3;
