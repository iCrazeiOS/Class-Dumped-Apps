...
+ (id)btd_documentPath;
+ (id)btd_cachePath;
+ (_Bool)ieseffect_getFileSize:(unsigned long long *)arg1 filePath:(id)arg2 error:(id *)arg3;
+ (_Bool)ieseffect_getAllocatedSize:(unsigned long long *)arg1 ofDirectoryAtURL:(id)arg2 error:(id *)arg3;
