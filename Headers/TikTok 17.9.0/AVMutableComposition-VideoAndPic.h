...
+ (id)mixCompositionWithVideoData:(id)arg1 processAudio:(_Bool)arg2 onlyAudio:(_Bool)arg3 audioMix:(id)arg4;
...
- (id)appendVideoFragmentAsset:(id)arg1 withTimeClipRange:(CDStruct_e83c9415)arg2 startTime:(CDStruct_1b6d18a9)arg3 duration:(CDStruct_1b6d18a9)arg4 volume:(double)arg5 volumeDict:(id)arg6 repeat:(_Bool)arg7 useAudioFilter:(_Bool)arg8 nextOverlap:(float)arg9 isSubTrack:(_Bool)arg10 enableMultiTrack:(_Bool)arg11;
