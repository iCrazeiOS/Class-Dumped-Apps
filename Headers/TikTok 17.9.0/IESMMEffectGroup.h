...
@interface IESMMEffectGroup : HTSGLFilterGroup <IESMMEffectConnectorDelegate, IESMMEffectGroupProtocol>
{
    ...
    CDUnknownBlockType _genBitmapBlock;
    CDUnknownBlockType _genBitmapUTF32Block;
...
+ (id)effectVersion;
+ (void)load;
@property(nonatomic) _Bool maleMakeUpState; // @synthesize maleMakeUpState=_maleMakeUpState;
...
@property(copy, nonatomic) CDUnknownBlockType genBitmapUTF32Block; // @synthesize genBitmapUTF32Block=_genBitmapUTF32Block;
@property(copy, nonatomic) CDUnknownBlockType genBitmapBlock; // @synthesize genBitmapBlock=_genBitmapBlock;
...
- (int)switchFilterWithPathOne:(id)arg1 pathTwo:(id)arg2 progress:(double)arg3;
