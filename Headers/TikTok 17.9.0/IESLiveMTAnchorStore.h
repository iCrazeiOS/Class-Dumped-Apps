...
@class HTSEventContext, HTSLiveMessageHandler, IESLiveRoomService, IESLiveUIAspectUtil, LiveRoomModel, NSAttributedString, NSDate, NSError, NSString, RACCompoundDisposable;
@protocol HTSLiveMessageDispatchProvider, IESLiveMTAnchorReaction, IESLiveMTRoomRemoteActions, IESLiveMTTemplateProvider, IESLiveMonitor, IESLiveTracker;

@interface IESLiveMTAnchorStore : NSObject <IESLiveMTAnchorActions, HTSLiveMessageSubscriber, IESLiveCloseAction>
{
    _Bool _pauseOnBackground;
    _Bool _needHideAllComponent;
    HTSEventContext *_trackContext;
    LiveRoomModel *_room;
    id <IESLiveMTAnchorReaction> _reaction;
    NSError *_lastError;
...
@property(nonatomic) __weak id <IESLiveMTAnchorReaction> reaction; // @synthesize reaction=_reaction;
