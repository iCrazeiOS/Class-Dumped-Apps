...
- (id)strangerConversations:(int)arg1 limit:(int)arg2;
- (id)strangerConversations:(int)arg1 updatedAt:(id)arg2 limit:(int)arg3;
...
- (id)messagesInConversation:(id)arg1 startPullIndex:(long long)arg2 endPullIndex:(long long)arg3;
...
- (id)messageWithServerMessageID:(long long)arg1;
...
- (void)statisticConversationAction:(_Bool)arg1 interval:(long long)arg2;
- (void)updateConversation:(id)arg1 alterBlock:(CDUnknownBlockType)arg2;
- (void)updateConversationCoreInfo:(id)arg1 alterBlock:(CDUnknownBlockType)arg2;
- (void)updateConversationSettingInfo:(id)arg1 alterBlock:(CDUnknownBlockType)arg2;
- (void)updateConversationInfo:(id)arg1 alterBlock:(CDUnknownBlockType)arg2;
