...
#import "ACCSwitchModeContainerCollectionView-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class NSString, UILongPressGestureRecognizer, UITapGestureRecognizer;
@protocol ACCSwitchModeContainerCollectionViewDelegate;

@interface AWESwitchRecordModeCollectionView : UICollectionView <UIGestureRecognizerDelegate, ACCSwitchModeContainerCollectionView>
{
    _Bool _isTouching;
    CDUnknownBlockType _needKeepInitialContentOffsetBlock;
    long long _selectedIndex;
    id <ACCSwitchModeContainerCollectionViewDelegate> _touchDelegate;
...
@property(nonatomic) __weak id <ACCSwitchModeContainerCollectionViewDelegate> touchDelegate; // @synthesize touchDelegate=_touchDelegate;
