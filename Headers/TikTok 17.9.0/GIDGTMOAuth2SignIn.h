...
@class GIDGTMOAuth2Authentication, GTMSessionFetcher, NSDictionary, NSTimer, NSURL;

@interface GIDGTMOAuth2SignIn : NSObject
{
    GIDGTMOAuth2Authentication *auth_;
...
@property(retain, nonatomic) GIDGTMOAuth2Authentication *authentication; // @synthesize authentication=auth_;
