...
@class AWEStickerCommerceEnterView, NSString;

@interface AWEStickerPickerControllerCommerceEnteranceStickerPlugin : NSObject <AWEStickerPickerControllerPluginProtocol>
{
    NSString *_shootWay;
...
- (void)onCommerceEnterButton:(id)arg1;
- (void)handler:(id)arg1 showCommerceEnterViewWithSticker:(id)arg2;
