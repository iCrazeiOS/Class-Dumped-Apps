...
@property(copy, nonatomic) CDUnknownBlockType cacheSizeBlock;
@property(nonatomic) unsigned long long sessionId;
@property(nonatomic) _Bool playByRestored;
...
- (void)setPlayerSubTag:(NSString *)arg1;
- (void)setPlayerTag:(NSString *)arg1;
