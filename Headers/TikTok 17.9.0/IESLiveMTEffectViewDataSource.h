...
@interface IESLiveMTEffectViewDataSource : NSObject
{
...
- (void)_setupCategoriesWithResponseModel:(id)arg1 allowList:(id)arg2;
- (void)_setupWithModel:(id)arg1 allowList:(id)arg2;
- (id)initWithResponseModel:(id)arg1 allowList:(id)arg2 isStickerPickerDefaultType:(_Bool)arg3;
