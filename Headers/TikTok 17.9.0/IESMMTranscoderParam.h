...
@property(retain, nonatomic) NSString *bitrateSetting; // @synthesize bitrateSetting=_bitrateSetting;
...
- (int)writerBitrateByType:(long long)arg1 size:(unsigned long long)arg2 fps:(float)arg3 effectNeedHighBitrate:(_Bool)arg4;
