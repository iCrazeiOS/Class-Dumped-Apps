...
#import "IESLiveMTAllGesturesRouter-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class IESLiveComponentContext, NSMutableArray, NSString;
@protocol HTSLiveDetailRouter, HTSLiveViewHierarchyProvider, IESLiveWebViewService;

@interface IESLiveMTAllGesturesFragment : NSObject <UIGestureRecognizerDelegate, HTSLiveComponent, IESLiveMTAllGesturesRouter>
{
