...
@interface AWEIMPrivacySettingPersonalizationViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, AWERouterViewControllerProtocol>
{
...
- (void)dealloc;
- (void)updatePersAdModeSettings:(id)arg1;
- (void)disableBtnClicked:(id)arg1;
- (void)applicationWillEnterForeground:(id)arg1;
- (void)gotoThirdPartyMeaturementPage;
- (void)gotoInterestLabelPage;
