...
@class IESLiveMTInteractiveAnchorStore, NSString, RACDisposable, UIButton, UILabel, UITableView, UIView;
@protocol HTSLiveViewHierarchyProvider, IESLiveAlertFactory, IESLiveMTInteractiveAnchorActions, IESLiveToastFactory;

@interface IESLiveMTMultiAudioInteractivePanel : HTSLivePopUpView <UITableViewDelegate, UITableViewDataSource>
{
