...
@class NSString, TIMPBNParticipant;

@interface TIMPBNUpdateConversationParticipantResponseBody : GPBMessage
{
}
...
@property(retain, nonatomic) TIMPBNParticipant *participant; // @dynamic participant;
