...
+ (void)setYYCacheTrimEnableAfterMemoryWarning:(_Bool)arg1 expirationSeconds:(long long)arg2;
@property double memoryWarningTime; // @synthesize memoryWarningTime=_memoryWarningTime;
