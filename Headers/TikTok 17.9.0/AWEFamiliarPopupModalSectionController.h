...
#import "AWEUserRecommendBasicBaseSectionController.h"

#import "AWEUserMessage-Protocol.h"

@class NSString;

@interface AWEFamiliarPopupModalSectionController : AWEUserRecommendBasicBaseSectionController <AWEUserMessage>
{
}
