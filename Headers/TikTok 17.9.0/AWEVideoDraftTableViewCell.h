...
@interface AWEVideoDraftTableViewCell : UITableViewCell
{
    ...
    double _originalTitleX;
    double _originalTitleWidth;
}

- (void).cxx_destruct;
@property(nonatomic) double originalTitleWidth; // @synthesize originalTitleWidth=_originalTitleWidth;
@property(nonatomic) double originalTitleX; // @synthesize originalTitleX=_originalTitleX;
@property(retain, nonatomic) UILabel *draftSizeLabel; // @synthesize draftSizeLabel=_draftSizeLabel;
...
- (void)configCellWithDarft:(id)arg1 draftSize:(unsigned long long)arg2 shouldShowSize:(_Bool)arg3;
