...
@class LiveRoomModel, NSArray, NSDictionary, NSString, UIImage;

@interface IESLiveMTNormalStreamConfig : NSObject
{
    _Bool _enableBFrame;
    _Bool _enableNTP;
...
@property(nonatomic) unsigned long long streamContentType; // @synthesize streamContentType=_streamContentType;
