...
@property(readonly, copy, nonatomic) NSString *methodNamespace; // @synthesize methodNamespace=_methodNamespace;
...
- (void).cxx_destruct;
- (id)initWithMethodName:(id)arg1 methodNamespace:(id)arg2 authType:(unsigned long long)arg3 handler:(CDUnknownBlockType)arg4;
