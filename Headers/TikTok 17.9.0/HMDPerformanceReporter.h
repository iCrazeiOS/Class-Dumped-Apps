...
#import "HMDPerformanceReporterCheckPointProtocol-Protocol.h"

@class HMDReportLimitSizeTool, NSArray, NSMutableOrderedSet, NSString, NSTimer;
@protocol HMDNetworkProvider, OS_dispatch_queue;

@interface HMDPerformanceReporter : NSObject <HMDLimitReportDataSizeToolDelegate, HMDPerformanceReporterCheckPointProtocol>
{
...
@property(retain, nonatomic) NSMutableOrderedSet *performanceModules; // @synthesize performanceModules=_performanceModules;
...
- (void)checkErrorCodeAndDebugRealWithResponse:(id)arg1 statusCode:(long long)arg2;
- (void)cleanupWithConfig:(id)arg1;
- (id)allDebugRealPeformanceDataWithConfig:(id)arg1;
- (void)excuteCloudCommandIfAvailable:(id)arg1 ran:(id)arg2;
...
- (id)_dataArrayForNormalReportWithAddedMoudle:(id)arg1 modules:(id)arg2 maybeMoreData:(_Bool *)arg3;
...
- (void)autoReportPerformanceDataWithSizeLimited:(id)arg1;
