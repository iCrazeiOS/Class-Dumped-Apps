...
@class HTSLiveTextFormat, HTSLiveTextPieceGift, HTSLiveTextPieceHeart, HTSLiveTextPieceImage, HTSLiveTextPiecePatternRef, HTSLiveTextPieceUser, NSString;
...
@property(retain, nonatomic) HTSLiveTextPieceImage *imageValue; // @dynamic imageValue;
