...
@class NSString;
@protocol IESLiveMTInternalRouter, IESLiveMTUserPreviewRouter;

@interface IESLiveMTProfileSchemaParser : NSObject <IESLiveMTSchemaParser>
{
...
- (void)p_parseProfileWithParameter:(id)arg1;
