...
@class AWEAwemeDetailTableViewController, AWEConcernUsersCardDataController, AWEListDataController, MJRefreshHeader, NSArray, NSDictionary, NSMutableDictionary, NSObject, NSString, UICollectionView, UIView;
@protocol AWEDynamicCoverStrategyProtocol, AWEFollowEmptyHintViewControllerProtocol;

@interface AWEFeedCollectionViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, AWEPreviewable, AWEAwemeDeletionMessage, AWEUserMessage, AWENewCollectionDelegateWaterfallLayout, AWEFeedTabItemViewControllerProtocol, AWEFeedViewControllerSwitchProtocol, AWEZoomTransitionOuterContextProvider, AWEFeedCollectionViewControllerProtocol, UIScrollViewDelegate>
{
