...
@interface IESLiveMTDanmukuEngineSettings : NSObject
{
    _Bool _isRTL;
    _Bool _enableNormalDanmuku;
    _Bool _enableSeniorDanmuku;
    double _fontSize;
...
@property(nonatomic) _Bool enableSeniorDanmuku; // @synthesize enableSeniorDanmuku=_enableSeniorDanmuku;
