...
@interface AWEUserRecommendMutiTagBaseSectionController : AWEBaseListSectionController
{
}

- (void)updateUser:(id)arg1 alias:(id)arg2;
- (void)updateUserFollowStatus:(id)arg1 status:(long long)arg2;
- (void)createEditAliasViewWithUser:(id)arg1;
