...
+ (void)registerErrorReporter:(CDUnknownBlockType)arg1;
...
- (void)awe_setValue:(id)arg1 forKey:(id)arg2 typeOfValue:(Class)arg3 err:(id *)arg4;
...
- (void)im_setApplyEntranceLatestUpdateTimestamp:(double)arg1;
- (id)im_shouldDisplayApplyEntranceAccordingToFirstOpenSwitch;
- (void)im_setShouldDisplayApplyEntranceAccordingToFirstOpenSwitch:(_Bool)arg1;
- (_Bool)im_shouldShowMessageEmojiGuide;
- (void)im_setShouldShowMessageEmojiGuide:(_Bool)arg1;
- (double)im_enterMessageTabTimestamp;
- (void)im_setEnterMessageTabTimestamp:(double)arg1;
- (id)im_groupUpgradeSettingOfConversation:(id)arg1;
- (void)im_setGroupUpgradeSetting:(id)arg1 forConversation:(id)arg2;
- (_Bool)im_shouldShowGroupManagementGuideOfConversation:(id)arg1;
- (void)im_setShouldShowGroupManagementGuide:(_Bool)arg1 forConversation:(id)arg2;
- (id)im_inputTextDraftOfConversation:(id)arg1;
- (void)im_setInputTextDraft:(id)arg1 forConversation:(id)arg2;
- (long long)im_showMsgEmojiGuideTimes;
- (void)im_setShowMsgEmojiGuideTimes:(long long)arg1;
- (double)im_lastShowMsgEmojiGuideButtonTimeStamp;
- (void)im_setLastShowMsgEmojiGuideButtonTimeStamp:(double)arg1;
...
- (id)im_AWEIMDreamBannerConfig;
- (void)im_setAWEIMDreamBannerConfig:(id)arg1;
