...
@property(retain, nonatomic) NSArray *kidsModeAllowEventList;
@property(nonatomic) _Bool deviceLimitRegisterExpired;
@property(nonatomic) double deviceLimitRegisterExpiredTime;
@property(retain, nonatomic) NSDictionary *kidsRequestControl;
@property(nonatomic) _Bool appsflyerSharingBlock;
@property(retain, nonatomic) NSDictionary *trafficControl;
@property(retain, nonatomic) AWELegalEntityInfo *legalEntityInfo;
@property(retain, nonatomic) AWEAgeGateInfoModel *ageGateInfoModel;
@property(nonatomic) _Bool forcePrivateAccount;
@property(nonatomic) long long notifyPrivateAccount;
...
@property(nonatomic) _Bool showTermsConsentAlert;
...
@property(nonatomic) _Bool policyNoticeEnable;
