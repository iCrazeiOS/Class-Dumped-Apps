...
@class IESExtAudioFileWriter, IESMMAudioWaveformRT, IESWaveformConfig;
...
@property(retain, nonatomic) IESWaveformConfig *waveConfig; // @synthesize waveConfig=_waveConfig;
