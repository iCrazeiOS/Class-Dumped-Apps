...
@class IESLiveMTGiftGroupSelectionButtonViewModel, IESLiveMTGiftPanelDataSharing, NSArray, NSString, RACCommand;
@protocol HTSKVStore, IESLiveMTGiftPanelReaction, IESLiveTracker;

@interface IESLiveMTGiftGroupSelectionListItem : NSObject <IESLiveMTCollectionViewItemProtocol>
{
    _Bool _enable;
    Class _cellClass;
    ...
    NSArray *_buttonVMs;
    IESLiveMTGiftGroupSelectionButtonViewModel *_selectedButtonViewModel;
...
@property(retain, nonatomic) IESLiveMTGiftGroupSelectionButtonViewModel *selectedButtonViewModel; // @synthesize selectedButtonViewModel=_selectedButtonViewModel;
