...
#import "ReactBaseViewControllerAdapter-Protocol.h"
...
@interface ReactBaseViewController : UIViewController <ReactBaseViewControllerAdapter, AWEReactPage, UIGestureRecognizerDelegate, AWERouterViewControllerProtocol>
{
