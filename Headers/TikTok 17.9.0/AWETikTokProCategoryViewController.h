...
@interface AWETikTokProCategoryViewController : UIViewController <UITableViewDelegate, UITableViewDataSource>
{
    ...
    CDUnknownBlockType _chooseCategoryBlock;
    UITableView *_tableView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) UITableView *tableView; // @synthesize tableView=_tableView;
@property(copy, nonatomic) CDUnknownBlockType chooseCategoryBlock; // @synthesize chooseCategoryBlock=_chooseCategoryBlock;
...
- (void)changeConfirmButtomStyle:(id)arg1;
- (void)updateConfirmButtomStyle:(id)arg1;
