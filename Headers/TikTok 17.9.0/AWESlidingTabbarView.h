...
@class AWESlidingTabButton, AWESlidingViewController, NSArray, NSMutableArray, NSString, UIColor, UIFont, UIScrollView;
...
@interface AWESlidingTabbarView : UIView <UIScrollViewDelegate, AWESlidingTabbarProtocol>
{
    ...
    _Bool _fragmentLineViewFrameCorrection;
    _Bool _isAequilateStyle;
    ...
    CDUnknownBlockType _tabsDidUpdateBlock;
    CDUnknownBlockType _bottonTappedBlock;
...
@property(nonatomic) _Bool isAequilateStyle; // @synthesize isAequilateStyle=_isAequilateStyle;
@property(retain, nonatomic) NSMutableArray *buttonArray; // @synthesize buttonArray=_buttonArray;
@property(nonatomic) _Bool fragmentLineViewFrameCorrection; // @synthesize fragmentLineViewFrameCorrection=_fragmentLineViewFrameCorrection;
@property(copy, nonatomic) CDUnknownBlockType bottonTappedBlock; // @synthesize bottonTappedBlock=_bottonTappedBlock;
@property(copy, nonatomic) CDUnknownBlockType tabsDidUpdateBlock; // @synthesize tabsDidUpdateBlock=_tabsDidUpdateBlock;
...
- (void)slidingControllerDidScroll:(id)arg1 animated:(_Bool)arg2;
...
- (void)updateTrailingIconWithImage:(id)arg1 transform:(struct CGAffineTransform)arg2 index:(long long)arg3;
- (void)updateTrailingIconWithImage:(id)arg1 index:(long long)arg2;
