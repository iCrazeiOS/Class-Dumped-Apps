...
- (void)prepareDataWithMyCreateGroups:(id)arg1 myJoinGroups:(id)arg2 completeBlock:(CDUnknownBlockType)arg3;
...
- (void)deleteShareModelWithSection:(long long)arg1 withRow:(long long)arg2;
...
- (_Bool)isGroupSectionOfIndexPath:(id)arg1;
