...
@property(retain, nonatomic) NSMutableDictionary *stickerImageCache; // @synthesize stickerImageCache=_stickerImageCache;
...
- (void).cxx_destruct;
- (void)p_updateWithFilterIndex:(int)arg1 rotate:(double)arg2;
- (void)p_updateWithFilterIndex:(int)arg1 flipX:(_Bool)arg2 flipY:(_Bool)arg3;
- (void)p_updateWithFilterIndex:(int)arg1 alpha:(double)arg2;
- (void)p_updateWithFilterIndex:(int)arg1 scale:(double)arg2;
- (void)p_updateWithFilterIndex:(int)arg1 offsetX:(double)arg2 offsetY:(double)arg3;
- (id)getProcessInfo;
...
- (void)p_setTextStickerFreeFunc;
- (void)p_setTextStickerDataFunc;
...
- (void)p_restoreStickerInfo:(id)arg1 stickerID:(long long)arg2;
- (void)p_inputRestoreInfoSticker:(id)arg1 videoDataUpdateType:(long long)arg2;
