...
#import "OMIDBytedanceAdEventsPublisher-Protocol.h"
#import "OMIDBytedanceCommandPublisher-Protocol.h"
#import "OMIDBytedanceMediaEventsPublisher-Protocol.h"
#import "OMIDBytedanceSessionEventsPublisher-Protocol.h"

@class NSString;
@protocol OMIDBytedanceJSExecutor;

@interface OMIDBytedanceBridge : NSObject <OMIDBytedanceCommandPublisher, OMIDBytedanceSessionEventsPublisher, OMIDBytedanceAdEventsPublisher, OMIDBytedanceMediaEventsPublisher>
{
    id <OMIDBytedanceJSExecutor> _jsExecutor;
}

@property(readonly, nonatomic) id <OMIDBytedanceJSExecutor> jsExecutor; // @synthesize jsExecutor=_jsExecutor;
- (void).cxx_destruct;
