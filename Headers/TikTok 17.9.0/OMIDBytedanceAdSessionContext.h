...
@class NSArray, NSDictionary, NSString, OMIDBytedancePartner, UIView;

@interface OMIDBytedanceAdSessionContext : NSObject
{
...
@property(readonly, nonatomic) OMIDBytedancePartner *partner; // @synthesize partner=_partner;
