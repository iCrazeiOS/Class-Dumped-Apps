...
@interface TTAClassInfo : NSObject
{
    _Bool _needUpdate;
    _Bool _isMeta;
    Class _cls;
...
@property(readonly, nonatomic) TTAClassInfo *superClassInfo; // @synthesize superClassInfo=_superClassInfo;
