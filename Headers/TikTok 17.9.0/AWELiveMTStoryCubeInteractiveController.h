...
@protocol AWELiveMTStoryCubeTransitionAnimatorCoordinator, AWEStoryCubeDismissControllerProtocol, UIViewControllerContextTransitioning;

@interface AWELiveMTStoryCubeInteractiveController : UIPercentDrivenInteractiveTransition <UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate>
{
    ...
    id <AWELiveMTStoryCubeTransitionAnimatorCoordinator> _coordinator;
...
@property(nonatomic) __weak id <AWELiveMTStoryCubeTransitionAnimatorCoordinator> coordinator; // @synthesize coordinator=_coordinator;
