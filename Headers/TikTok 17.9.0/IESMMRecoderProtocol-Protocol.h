...
@class AVPlayer, HTSMediaMixPlayer, HTSVideoData, IESMMEffectStickerInfo, IESMMStoryConfig, NSString, NSURL, UIImage, VEEffectImage;
...
- (void)startBGMAsync:(unsigned long long)arg1 complete:(void (^)(void))arg2;
...
- (void)initAudioCapture:(void (^)(void))arg1;
...
- (void)multiVideoPlayWithTime:(CDStruct_1b6d18a9)arg1 completeBlock:(void (^)(_Bool))arg2;
- (void)multiVideoPlay;
...
- (void)setBGVideoWithVideoURL:(NSURL *)arg1 key:(NSString *)arg2 rate:(float)arg3 completeBlock:(void (^)(NSError *))arg4 didPlayToEndBlock:(void (^)(void))arg5;
