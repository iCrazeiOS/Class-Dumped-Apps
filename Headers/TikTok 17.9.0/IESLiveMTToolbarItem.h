...
@class NSBundle, NSString, TikTokLiveToolBarItem, UIImage, UIView;

@interface IESLiveMTToolbarItem : NSObject
{
    _Bool _isSelected;
...
- (id)init;
@property(retain, nonatomic) TikTokLiveToolBarItem *tiktokToolBarItem;
