...
@interface AWEIMFeedCardFullScreenMagnifyTransition : NSObject <AWETransitionContextProvider>
{
}

- (double)transitionDuration;
- (id)generateSnapshotWithContainerView:(id)arg1 endViewFrame:(struct CGRect)arg2 playController:(id)arg3 playingView:(id)arg4 feedCard:(id)arg5 toPlayer:(id)arg6;
