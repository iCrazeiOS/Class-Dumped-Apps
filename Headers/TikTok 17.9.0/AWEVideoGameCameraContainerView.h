...
@class ACCAnimatedButton, AWEGameRecordButton, CAKeyframeAnimation, NSString;

@interface AWEVideoGameCameraContainerView : UIView <CAAnimationDelegate>
{
    _Bool _isShowingForEffectControlGame;
...
@property(nonatomic) _Bool isShowingForEffectControlGame; // @synthesize isShowingForEffectControlGame=_isShowingForEffectControlGame;
@property(retain, nonatomic) ACCAnimatedButton *closeBtn; // @synthesize closeBtn=_closeBtn;
