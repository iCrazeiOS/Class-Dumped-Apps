...
#import "TikTokKidsPassportColor-Protocol.h"

@class NSString;

@interface TikTokKidsPassportConfigurationImplementation : NSObject <AWEPassportProductConfiguration, AWEPassportSettings, AWEPassportNetworkManager, AWEPassportAntiSpamDelegate, AWEPassportUtils, TikTokKidsPassportColor>
{
}
