...
#import "HTSGLFilterTwoPassSamplingFilter.h"

@interface HTSGLFilterGaussianBlur : HTSGLFilterTwoPassSamplingFilter
{
    _Bool _shouldResizeBlurRadiusWithImageSize;
...
@property(nonatomic) _Bool enableSubsampling; // @synthesize enableSubsampling=_enableSubsampling;
