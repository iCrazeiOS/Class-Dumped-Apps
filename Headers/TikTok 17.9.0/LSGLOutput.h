...
@class LSGLContext, LSGLFramebuffer, NSMutableArray;
@protocol LSGLInput;
...
@interface LSGLOutput : NSObject
{
    ...
    struct LSGPUTextureOptions _outputTextureOptions;
}

@property(retain, nonatomic) LSGLContext *context; // @synthesize context=_context;
@property(nonatomic) struct LSGPUTextureOptions outputTextureOptions; // @synthesize outputTextureOptions=_outputTextureOptions;
...
@property(nonatomic) id <LSGLInput> targetToIgnoreForUpdates; // @synthesize targetToIgnoreForUpdates=_targetToIgnoreForUpdates;
