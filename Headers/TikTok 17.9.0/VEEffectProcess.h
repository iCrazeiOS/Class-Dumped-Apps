...
@class HTSFilterInterface, HTSGLCropFilter, HTSGLFilter, HTSGLFilterGroup, HTSGLFilterInput, HTSGLPicture, HTSGLTransformFilter, HTSRawDataOutputRender, HTSVideoData, IESEffectVideoAnimatedRenderer, IESFiltersManager, IESGLAddEdgeFilter, IESGLEndingWaterMarkFilter, IESImageAnimationStickerFilter, IESMMCanvasGroup, IESMMEffectStickerInfo, IESMMMVModel, IESMMStoryImageGroup, IESMediaInfo, IESPhotoMovieTransManager, IESTrackInfosManager, IESVideoAddEdgeData, NSMutableArray, NSString, VEConfigData, VEGLCicleFilter, VEReverseUnit;
...
+ (id)effectProcessWithVideoData:(id)arg1 mvModel:(id)arg2 withEditorSession:(id)arg3;
...
@property(retain, nonatomic) IESMMCanvasGroup *canvasGroup; // @synthesize canvasGroup=_canvasGroup;
...
- (void)updateCanvasGroupWithKey:(id)arg1 config:(id)arg2;
...
- (void)processPixelBuf:(struct __CVBuffer *)arg1 frameTime:(CDStruct_1b6d18a9)arg2 realFramePts:(CDStruct_1b6d18a9)arg3;
- (void)resetTargets;
- (void)resetFilters;
