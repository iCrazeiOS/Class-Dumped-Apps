...
@class NSString, TikTokKidsAwemeModel;
@protocol TikTokKidsFeedPreloadStrategy;

@interface TikTokKidsFeedPreloadOperation : NSOperation
{
    _Bool _finished;
    _Bool _executing;
    ...
    id <TikTokKidsFeedPreloadStrategy> _strategy;
}

- (void).cxx_destruct;
@property(nonatomic) __weak id <TikTokKidsFeedPreloadStrategy> strategy; // @synthesize strategy=_strategy;
...
- (void)cancel;
- (void)start;
- (id)initWithBizScene:(id)arg1 strategy:(id)arg2 model:(id)arg3;
