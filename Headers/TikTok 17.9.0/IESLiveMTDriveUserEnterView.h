...
@protocol HTSLiveViewHierarchyProvider, IESLiveWebImageService, IESLiveWebPDecoder, IESLiveWebPPlayer;

@interface IESLiveMTDriveUserEnterView : UIView <CAAnimationDelegate, IESLiveMTUserEnterViewProtocol>
{
    _Bool _hasLevel;
