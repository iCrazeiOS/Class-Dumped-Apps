...
@interface LSGLPreviewView : UIView <LSGLInput>
{
    ...
    CDUnknownBlockType _didLayoutCallback;
...
@property(copy, nonatomic) CDUnknownBlockType didLayoutCallback; // @synthesize didLayoutCallback=_didLayoutCallback;
...
- (void)displayTexture:(int)arg1 size:(struct CGSize)arg2 pts:(CDStruct_1b6d18a9)arg3;
