...
@interface LiveStreamConfiguration : NSObject
{
    ...
    _Bool _allowsRealTimeAudioPowerLevel;
    _Bool _enableExtenionMode;
    _Bool _enableBackgroundMode;
    _Bool _useCustomizedSEI;
    _Bool _enableWSEI;
    _Bool _enableDownPKResolution;
    NSString *_rtmpURL;
    NSArray *_URLs;
...
@property(nonatomic) _Bool enableDownPKResolution; // @synthesize enableDownPKResolution=_enableDownPKResolution;
@property(nonatomic) _Bool enableWSEI; // @synthesize enableWSEI=_enableWSEI;
@property(copy, nonatomic) NSString *authorizationString; // @synthesize authorizationString=_authorizationString;
...
@property(nonatomic) _Bool enableExtenionMode; // @synthesize enableExtenionMode=_enableExtenionMode;
...
@property(nonatomic) _Bool allowsRealTimeAudioPowerLevel; // @synthesize allowsRealTimeAudioPowerLevel=_allowsRealTimeAudioPowerLevel;
...
@property(retain, nonatomic) NSArray *NTPServers; // @synthesize NTPServers=_NTPServers;
