...
@class GPBExtensionDescriptor, GPBFieldDescriptor, GPBUnknownFieldSet, HTSLiveCommon, HTSLivePBResponse_Header, IESLiveUserModel, NSMutableDictionary, NSNumber;
...
+ (void)initialize;
+ (id)tim_canonicalValue:(id)arg1 field:(id)arg2 toJson:(_Bool)arg3;
+ (id)tim_printMapFieldValue:(id)arg1 value:(id)arg2 useTextFormatKey:(_Bool)arg3;
+ (id)tim_printRepeatedFieldValue:(id)arg1 value:(id)arg2 useTextFormatKey:(_Bool)arg3;
+ (id)tim_printSingleFieldValue:(id)arg1 msg:(id)arg2 useTextFormatKey:(_Bool)arg3;
+ (id)tim_printField:(id)arg1 msg:(id)arg2 useTextFormatKey:(_Bool)arg3;
+ (id)tim_printMessage:(id)arg1 useTextFormatKey:(_Bool)arg2;
+ (CDUnion_88782d86)tim_readValue:(id)arg1 dataType:(unsigned char)arg2 field:(id)arg3;
+ (id)tim_fieldWithTextFormatName:(id)arg1 inDescriptor:(id)arg2;
+ (void)tim_mergeMapField:(id)arg1 json:(id)arg2 message:(id)arg3 ignoreDefaultValue:(_Bool)arg4;
+ (void)tim_mergeRepeatedField:(id)arg1 json:(id)arg2 message:(id)arg3 ignoreDefaultValue:(_Bool)arg4;
+ (void)tim_parseFieldValue:(id)arg1 json:(id)arg2 message:(id)arg3 ignoreDefaultValue:(_Bool)arg4;
+ (void)tim_mergeField:(id)arg1 json:(id)arg2 message:(id)arg3 ignoreDefaultValue:(_Bool)arg4;
+ (void)tim_merge:(id)arg1 message:(id)arg2 ignoreDefaultValue:(_Bool)arg3;
+ (id)tim_parseFromJson:(id)arg1 error:(id *)arg2;
+ (void)load;
+ (id)tim_canonicalValue:(id)arg1 field:(id)arg2 toJson:(_Bool)arg3;
+ (id)tim_printMapFieldValue:(id)arg1 value:(id)arg2 useTextFormatKey:(_Bool)arg3;
+ (id)tim_printRepeatedFieldValue:(id)arg1 value:(id)arg2 useTextFormatKey:(_Bool)arg3;
...
- (id)init;
- (id)tim_toJson;
- (void)tim_mergeFromJson:(id)arg1;
...
@property(retain, nonatomic) IESLiveUserModel *toUserModel;
@property(retain, nonatomic) IESLiveUserModel *userModel;
- (void)ieslive_dealloc;
- (id)mapUserFromPBToLive:(id)arg1;
