...
@class AWEAlbumImageModel, AWEAlbumPhotoCollector, NSIndexPath, NSString, UIButton, UICollectionView;
...
@interface AWEMattingView : UIView <UICollectionViewDataSource, UICollectionViewDelegate, PHPhotoLibraryChangeObserver, AWEAlbumPhotoCollectorObserver>
{
    ...
    AWEAlbumImageModel *_loadingAlbumImageModel;
    UIView *_loadingView;
}
...
@property(retain, nonatomic) AWEAlbumImageModel *loadingAlbumImageModel; // @synthesize loadingAlbumImageModel=_loadingAlbumImageModel;
...
- (void)cancelAlbumPhotoDetect;
- (void)resumeAlbumPhotoDetect;
- (void)resetAlbumPhotoDetectingStatus;
