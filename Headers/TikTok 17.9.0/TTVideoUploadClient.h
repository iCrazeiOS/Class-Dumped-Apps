...
{
    // Error parsing type: ^{TTVideoUploader=^^?^^?^^?^v^?^?^^?^{HttpUploadClient}^{HttpUploadClient}^{TTVideoCancelUpload}^{TTFileUploaderInterface}^{APPWRAPPER}^?^?^v^{UploadInfo}[2^{UploadInfo}]^{UploadError}{AVThread={atomic<int>=Ai}*^{_opaque_pthread_t}{_opaque_pthread_mutex_t=q[56c]}{_opaque_pthread_cond_t=q[40c]}{_opaque_pthread_mutex_t=q[56c]}{_opaque_pthread_cond_t=q[40c]}B^{AVProcessor}{AVTHREAD_INFO=^?^?^v}}{AVQueue<com::ss::ttmuploader::TTVideoUploader::Message *>=BB^{AVNode}^{AVNode}^{AVNode}^{AVNode}^{AVNode}^{AVNode}{_opaque_pthread_mutex_t=q[56c]}{_opaque_pthread_cond_t=q[40c]}iiiiii*^{AVBufferCallback}i}i{Value=(ValueHolder=qQdB*^{map<Json::Value::CZString, Json::Value, std::__1::less<Json::Value::CZString>, std::__1::allocator<std::__1::pair<const Json::Value::CZString, Json::Value> > >})b8b1^{CommentInfo}qq}{atomic<bool>=AB}{TTUploadParameters=iiiiiiiiiiiiiiiiiq^vi*i^vii*iiiiiiiii}qiiiiiiiiiiiiii{mutex={_opaque_pthread_mutex_t=q[56c]}}**********i^{TTUploadEncryptionInfo}[2048c]******f**ii[1024c]qqBiB^{TTUploaderTracker}^{SpeedTest}iiiq{Value=(ValueHolder=qQdB*^{map<Json::Value::CZString, Json::Value, std::__1::less<Json::Value::CZString>, std::__1::allocator<std::__1::pair<const Json::Value::CZString, Json::Value> > >})b8b1^{CommentInfo}qq}^{TTNetworkRout}[2048c]fiii}, name: _uploader
    _Bool _isSpeedTest;
    _Bool _finished;
...
@property(nonatomic) _Bool isSpeedTest; // @synthesize isSpeedTest=_isSpeedTest;
@property(nonatomic) long long routWeight; // @synthesize routWeight=_routWeight;
@property(nonatomic) long long routMode; // @synthesize routMode=_routMode;
...
- (void)stop;
- (void)start;
- (void)setVideoContext:(id)arg1 speed:(int)arg2 speedThreshold:(int)arg3;
- (void)stopSpeedTest;
- (void)startSpeedTest:(int)arg1 tryCount:(int)arg2 speedTestMode:(long long)arg3;
