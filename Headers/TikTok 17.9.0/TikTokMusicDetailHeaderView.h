...
#import "TikTokMusicDetailBaseHeaderView.h"

@class AWEBillboardLabel, AWECollectionButton, AWEMusicModel, AWERelatedChallengeMusicView, AWEUserCountDescView, NSMutableArray, NSString, TikTokMusicMatchSoundView, TikTokMusicPlatformView, UIButton, UIImageView, UILabel, UIView, YYLabel;
@protocol TikTokMusicDetailMusicControlDelegate;

@interface TikTokMusicDetailHeaderView : TikTokMusicDetailBaseHeaderView
{
    ...
    NSString *_processID;
    long long _style;
    id <TikTokMusicDetailMusicControlDelegate> _delegate;
}

+ (_Bool)isCommerceUser;
...
- (void).cxx_destruct;
@property(nonatomic) __weak id <TikTokMusicDetailMusicControlDelegate> delegate; // @synthesize delegate=_delegate;
