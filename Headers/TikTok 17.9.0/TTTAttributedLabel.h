...
- (void)drawFramesetter:(struct __CTFramesetter *)arg1 attributedString:(id)arg2 textRange:(CDStruct_7ea651ba)arg3 inRect:(struct CGRect)arg4 context:(struct CGContext *)arg5;
