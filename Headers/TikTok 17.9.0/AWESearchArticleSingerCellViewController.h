...
@interface AWESearchArticleSingerCellViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, AWEGeneralSearchCellControllerProtocol>
{
    NSString *_enterFrom;
...
@property(copy, nonatomic) NSArray *articlesArray; // @synthesize articlesArray=_articlesArray;
