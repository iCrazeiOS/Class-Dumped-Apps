...
@class NSNumber;
@protocol IESLiveHTTPClient, IESLiveTimeService;
...
- (void).cxx_destruct;
@property(retain, nonatomic) id <IESLiveTimeService> timeService; // @synthesize timeService=_timeService;
...
- (void)enterRoomWithRequestModel:(id)arg1 finish:(CDUnknownBlockType)arg2;
