...
@class TiktokV1kidsUrlStructV2;

@interface TiktokV1kidsImageInfoStructV2 : GPBMessage
{
}
...
@property(retain, nonatomic) TiktokV1kidsUrlStructV2 *labelLarge; // @dynamic labelLarge;
@property(retain, nonatomic) TiktokV1kidsUrlStructV2 *labelThumb; // @dynamic labelThumb;
