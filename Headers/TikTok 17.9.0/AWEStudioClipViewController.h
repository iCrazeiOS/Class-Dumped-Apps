...
@interface AWEStudioClipViewController : AWEStudioClipBaseViewController <UICollectionViewDelegate, UICollectionViewDataSource, UIScrollViewDelegate, UIGestureRecognizerDelegate, AWEReorderableForIOS8CollectionViewDataSource, AWEReorderableForIOS8CollectionViewDelegateFlowLayout, AWEVideoRangeSliderDelegate, HTSVideoSpeedControlDelegate>
{
...
- (void).cxx_destruct;
@property(retain, nonatomic) UIView *invalidGestureView; // @synthesize invalidGestureView=_invalidGestureView;
