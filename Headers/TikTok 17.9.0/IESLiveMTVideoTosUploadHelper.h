...
@class IESLiveMTImagePickerManager, IESLiveMTVideoTosUploadConfig, NSString, UIActivityIndicatorView, UIImagePickerController;
...
@interface IESLiveMTVideoTosUploadHelper : NSObject <UIImagePickerControllerDelegate, UINavigationControllerDelegate, IESLiveMTImagePickerManagerDelegate>
{
    ...
    IESLiveMTVideoTosUploadConfig *_config;
...
@property(retain, nonatomic) IESLiveMTVideoTosUploadConfig *config; // @synthesize config=_config;
