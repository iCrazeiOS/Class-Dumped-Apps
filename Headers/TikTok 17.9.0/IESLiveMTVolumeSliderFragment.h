...
@class IESLiveMTVolumeSliderView, MPVolumeView, NSString;
@protocol HTSLiveViewHierarchyProvider;

@interface IESLiveMTVolumeSliderFragment : NSObject <HTSLiveComponent>
{
    IESLiveMTVolumeSliderView *_volumeView;
...
@property(retain, nonatomic) IESLiveMTVolumeSliderView *volumeView; // @synthesize volumeView=_volumeView;
