...
@property(nonatomic) _Bool hasMinIndexV2; // @dynamic hasMinIndexV2;
...
@property(nonatomic) _Bool hasReadIndexV2; // @dynamic hasReadIndexV2;
@property(nonatomic) _Bool hasSetFavoriteTime; // @dynamic hasSetFavoriteTime;
@property(nonatomic) _Bool hasSetTopTime; // @dynamic hasSetTopTime;
...
@property(nonatomic) long long minIndexV2; // @dynamic minIndexV2;
...
@property(nonatomic) long long readIndexV2; // @dynamic readIndexV2;
@property(nonatomic) long long setFavoriteTime; // @dynamic setFavoriteTime;
@property(nonatomic) long long setTopTime; // @dynamic setTopTime;
