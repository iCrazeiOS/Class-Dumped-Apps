...
@class NSString;
@protocol HTSLiveDetailRouter, IESLiveMTFansGroupRouter, IESLiveMTInternalRouter;

@interface IESLiveMTShowFansClubSchemaParser : NSObject <IESLiveMTSchemaParser>
{
