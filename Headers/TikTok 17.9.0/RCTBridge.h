...
@class NSArray, NSDictionary, NSLock, NSString, NSURL, RCTAccessibilityManager, RCTDevMenu, RCTDevSettings, RCTImageLoader, RCTImageStoreManager, RCTNetworking, RCTPerformanceLogger, RCTRedBox, RCTUIManager, TTRNBridgeEngine;
...
- (id)webSocketModule;
@property(readonly, nonatomic) TTRNBridgeEngine *tt_engine;
- (void)setNeedInvalidate:(CDUnknownBlockType)arg1;
- (_Bool)willInvalidate;
- (void)rct_release;
- (id)rct_retain;
@property(readonly, nonatomic) long long rct_retainCount;
- (void)setRetainCounter:(id)arg1;
- (id)retainCounter;
