...
#import "HMDTTMonitorCheckPointProtocol-Protocol.h"

@class HMDGCDTimer, HMDMonitorDataManager, HMDReportLimitSizeTool, HMDTTMonitorCounter, NSArray, NSMutableArray, NSString;
@protocol OS_dispatch_queue;

@interface HMDTTMonitorTracker : NSObject <HMDPerformanceReporterDataSource, HMDTTMonitorCheckPointProtocol>
{
...
+ (id)generateUploadID;
+ (id)generateLogID;
@property(retain, nonatomic) HMDGCDTimer *GCDTimer; // @synthesize GCDTimer=_GCDTimer;
@property(retain, nonatomic) HMDTTMonitorCounter *counter; // @synthesize counter=_counter;
@property(retain, nonatomic) NSMutableArray *recordCache; // @synthesize recordCache=_recordCache;
...
- (void)addLocalSumForReporting:(id)arg1;
...
- (_Bool)needUploadWithlogTypeStr:(id)arg1 serviceType:(id)arg2;
