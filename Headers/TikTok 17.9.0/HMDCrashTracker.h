...
+ (id)excludedModule;
+ (id)sharedTracker;
@property(copy) NSArray *notDetectBlocks; // @synthesize notDetectBlocks=_notDetectBlocks;
...
- (void)addCrashNotDetectCallBack:(CDUnknownBlockType)arg1;
...
- (void)start;
- (_Bool)detectAppExtensionCrashAvailable;
