...
- (void).cxx_destruct;
@property(nonatomic) _Bool hasFetchedUser; // @synthesize hasFetchedUser=_hasFetchedUser;
...
- (void)onTopFollowBtnClicked:(id)arg1;
- (id)paramsForTopFollowBtnClicked:(id)arg1;
- (void)didFetchFullDetailUser:(id)arg1;
- (void)topCloseBtnClicked:(id)arg1;
- (void)topFollowBtnClicked:(id)arg1;
- (void)dismissTopFollowView:(_Bool)arg1;
