...
#import <ByteRtcEngineKit/ByteAudioFrameObserver-Protocol.h>
#import <ByteRtcEngineKit/ByteRtcEngineDelegate-Protocol.h>
#import <ByteRtcEngineKit/NetworkManagerDelegate-Protocol.h>

@class ByteRtcLiveTranscoding, ByteVideoCanvasManager, NSArray, NSMutableDictionary, NSString, NetworkManager;
@protocol ByteRtcEngineDelegate, ByteVideoSinkProtocol;

@interface ByteRtcEngineKit : NSObject <ByteAudioDeviceObserver, ByteAudioFrameObserver, ByteRtcEngineDelegate, NetworkManagerDelegate>
{
...
+ (void)forceGlobalAPIServer:(_Bool)arg1;
...
- (void)clearInternalEventDelegate;
...
- (int)adjustRemoteAudioVolume:(int)arg1 ofUid:(id)arg2;
...
- (_Bool)setPlaybackAudioFrameBeforeMixingParameters:(long long)arg1 channels:(long long)arg2;
...
- (int)setupRemoteScreenRenderer:(id)arg1 forRoomId:(id)arg2 forUserId:(id)arg3;
...
- (int)setLocalVideoRender:(id)arg1 userId:(id)arg2;
