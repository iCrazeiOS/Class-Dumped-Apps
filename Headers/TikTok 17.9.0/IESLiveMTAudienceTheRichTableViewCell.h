...
@class HTSLiveAvatarImageView, IESLiveMTAudienceModel, UIButton, UIImageView, UILabel;
@protocol IESLiveMTAudienceListActions, IESLiveSettings, IESLiveUserService;

@interface IESLiveMTAudienceTheRichTableViewCell : UITableViewCell
{
