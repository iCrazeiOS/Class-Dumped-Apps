...
- (void)processFrame:(struct __CVBuffer *)arg1 frameTime:(CDStruct_1b6d18a9)arg2 isSeek:(_Bool)arg3;
- (void)processFrame:(struct __CVBuffer *)arg1 frameTime:(CDStruct_1b6d18a9)arg2;
- (void)processLastPixelBufferAtTime:(CDStruct_1b6d18a9)arg1;
- (void)processLastPixelBuffer;
- (void)processPixelBufferAtTime:(CDStruct_1b6d18a9)arg1 isSeek:(_Bool)arg2;
- (void)processNoPlayerItem;
- (void)displayLinkCallbackWithNoPlayerItem:(id)arg1;
