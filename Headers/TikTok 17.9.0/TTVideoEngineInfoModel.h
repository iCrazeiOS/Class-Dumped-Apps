...
@property(copy, nonatomic) NSString *fullscreen_strategy; // @synthesize fullscreen_strategy=_fullscreen_strategy;
...
@property(nonatomic) _Bool hasByteVC1Codec; // @synthesize hasByteVC1Codec=_hasByteVC1Codec;
...
@property(copy, nonatomic) NSString *bashString; // @synthesize bashString=_bashString;
@property(copy, nonatomic) NSString *decodingMode; // @synthesize decodingMode=_decodingMode;
...
- (void)getNewModelRefString:(id)arg1 key:(id)arg2;
- (void)setUpResolutionMap:(id)arg1;
- (id)videoEngineUrlInfoToDict:(id)arg1;
- (id)toBashString;
- (id)getVideoList;
- (id)initWithDictionary:(id)arg1 encrypted:(_Bool)arg2;
- (id)initWithDictionary:(id)arg1;
- (id)initVideoInfoWithPb:(id)arg1;
- (id)init;
