...
@property(nonatomic) double currentTransitionTabbarAnimationDuration; // @synthesize currentTransitionTabbarAnimationDuration=_currentTransitionTabbarAnimationDuration;
