...
- (id)replaceColor:(id)arg1 highlightColor:(id)arg2;
- (double)textMessageLineHeight;
- (id)p_localEmotionInfos;
- (id)emoticonWithImageMapperKey:(id)arg1;
...
- (id)decodeWithText:(id)arg1 textColor:(id)arg2 highlightColor:(id)arg3 companyTemplate:(id)arg4 linkArray:(id)arg5 font:(id)arg6 isCompany:(_Bool)arg7 linkTapAction:(CDUnknownBlockType)arg8 type:(unsigned long long)arg9;
...
- (_Bool)shouldEnlargeEmoticonForAttributedString:(id)arg1;
