...
@class IESLiveMTADAuthor, IESLiveMTFeedAdVideo, NSArray, NSNumber, NSString;

@interface IESLiveMTFeedAdModel : MTLModel <MTLJSONSerializing>
{
    NSNumber *_adId;
    NSString *_type;
    NSString *_openUrl;
    ...
    NSArray *_imageList;
    IESLiveMTFeedAdVideo *_videoInfo;
    NSString *_title;
    NSString *_adLabel;
    NSString *_requestId;
    NSString *_logExtra;
...
- (void).cxx_destruct;
@property(retain, nonatomic) IESLiveMTADAuthor *author; // @synthesize author=_author;
...
@property(retain, nonatomic) IESLiveMTFeedAdVideo *videoInfo; // @synthesize videoInfo=_videoInfo;
