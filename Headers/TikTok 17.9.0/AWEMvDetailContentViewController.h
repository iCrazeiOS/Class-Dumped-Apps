...
@class AWEMvAwemeListDataController, AWEUILoadingView, NSDictionary, NSString, UICollectionView, UIView;
@protocol AWEUILoadingProvider, UIViewControllerPreviewing;

@interface AWEMvDetailContentViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, AWEPreviewable, AWEZoomTransitionOuterContextProvider>
{
    id _scrollDelegate;
...
- (void)addTopSeperateLineIfNeeded;
