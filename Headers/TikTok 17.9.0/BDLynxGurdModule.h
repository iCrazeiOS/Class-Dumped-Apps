...
#import "BDLGurdModuleProtocol-Protocol.h"
...
- (void)syncResourcesWithChannel:(id)arg1 accessKey:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)syncResourcesWithChannel:(id)arg1 completion:(CDUnknownBlockType)arg2;
