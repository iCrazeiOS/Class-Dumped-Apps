...
@protocol OS_dispatch_queue, TIMMessageStoreProtocol, TIMStrangerConversationFetcherProtocolDelegate;

@interface TIMStrangerConversationsFetcher : NSObject <TIMMessageStoreChangesObserver, TIMNotifierDelegate, TIMStrangerConversationFetcherProtocol>
{
    _Bool _hasMore;
    _Bool _fetching;
    int _inbox;
...
- (void)applyNewResult:(id)arg1 updateConversationIdentifiers:(id)arg2 reason:(long long)arg3;
