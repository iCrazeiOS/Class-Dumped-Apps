...
@class HTSGLContext, HTSGLFramebufferConfig, IESMMSampleBufferInfo, NSLock, NSString;

@interface HTSGLFramebuffer : NSObject
{
    struct TERLRenderingInfo *_renderingInfo;
    ...
    NSLock *_refLock;
    HTSGLFramebufferConfig *_config;
    struct CGSize _size;
    CDStruct_1b6d18a9 _realFramePts;
}

+ (id)hashForSize:(struct CGSize)arg1 onlyTexture:(_Bool)arg2 needsRLContext:(_Bool)arg3;
@property(retain, nonatomic) HTSGLFramebufferConfig *config; // @synthesize config=_config;
...
- (void).cxx_destruct;
- (void)copyAttachmentsFromSampleData:(id)arg1;
- (void)copyAttachmentsFromPixelBuffer:(struct __CVBuffer *)arg1;
...
- (void)generateTextureWithBindingPixelBuffer;
- (void)generateFramebuffer;
- (void)generateRenderlibContextWithPixelBuffer:(struct __CVBuffer *)arg1;
- (void)generateRenderlibContext;
- (void)generateTexture;
- (void)p_setupMipmap:(unsigned long long)arg1;
- (void)downloadImageData:(void *)arg1;
- (void)uploadImageData:(void *)arg1 withFilterType:(unsigned long long)arg2;
- (void)uploadImageData:(void *)arg1;
- (void)destroyFramebuffer;
- (void)dealloc;
- (id)initWithPixelBuffer:(struct __CVBuffer *)arg1 context:(id)arg2 genRLInfo:(_Bool)arg3;
- (id)initWithPixelBuffer:(struct __CVBuffer *)arg1 context:(id)arg2;
- (id)initWithConfig:(id)arg1;
- (id)initWithSize:(struct CGSize)arg1 onlyTexture:(_Bool)arg2 disableCache:(_Bool)arg3 genRLInfo:(_Bool)arg4 context:(id)arg5;
