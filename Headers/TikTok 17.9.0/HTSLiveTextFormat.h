...
@interface HTSLiveTextFormat : GPBMessage
{
}
...
@property(nonatomic) _Bool useHeighLightColor; // @dynamic useHeighLightColor;
@property(nonatomic) _Bool useRemoteClor; // @dynamic useRemoteClor;
