...
@class HTSMediaMixPlayer, IESVideoAddEdgeData, NSMutableArray, NSString, VEConfigData, VECrossPlatEditorSession, VEEditorSessionConfig, VEPinUnit, VEReverseUnit, VEScreenshotCompleteUnit;
@protocol IVEAlgorithmPublicProtocol, IVEEffectProcess, IVEEffectPublicProtocol, IVEPlayerUnitProtocol, IVEScreenShot;
...
@interface VEEditorSession : NSObject <IVEAmazingFeatureProtocol, IVEEffectTextProtocol, IVEEffectMessageProtocol>
{
    ...
    VECrossPlatEditorSession *_editorSessionOC;
    VECrossPlatEditorSession *_editorSessionScreenShotOC;
    id <IVEEffectProcess> _effectUnitScreenShotOC;
...
@property(retain, nonatomic) id <IVEScreenShot> screenshotUnitOC; // @synthesize screenshotUnitOC=_screenshotUnitOC;
@property(retain, nonatomic) NSMutableArray *previewUnitOCArrays; // @synthesize previewUnitOCArrays=_previewUnitOCArrays;
@property(retain, nonatomic) id <IVEEffectProcess> captureFrameEffectUnitOC; // @synthesize captureFrameEffectUnitOC=_captureFrameEffectUnitOC;
@property(retain, nonatomic) id <IVEEffectProcess> effectUnitOC; // @synthesize effectUnitOC=_effectUnitOC;
@property(retain, nonatomic) id <IVEEffectProcess> effectUnitScreenShotOC; // @synthesize effectUnitScreenShotOC=_effectUnitScreenShotOC;
@property(retain, nonatomic) VECrossPlatEditorSession *editorSessionScreenShotOC; // @synthesize editorSessionScreenShotOC=_editorSessionScreenShotOC;
@property(retain, nonatomic) VECrossPlatEditorSession *editorSessionOC; // @synthesize editorSessionOC=_editorSessionOC;
@property(retain, nonatomic) id <IVEPlayerUnitProtocol> playerUnitOC; // @synthesize playerUnitOC=_playerUnitOC;
...
- (void).cxx_destruct;
- (void)updateVideoData:(id)arg1 mvModel:(id)arg2 completeBlock:(CDUnknownBlockType)arg3;
- (void)replaceResource:(id)arg1 newResource:(id)arg2;
...
- (struct CGSize)getCanvasOrVideoSize;
...
@property(readonly, nonatomic) VEEditorSessionConfig *config; // @synthesize config=_config;
...
- (void)setNormalizedPreviewColorRed:(float)arg1 green:(float)arg2 blue:(float)arg3 alpha:(float)arg4;
- (void)p_updateUnitConfig:(id)arg1 updateType:(long long)arg2;
...
- (void)capturePreviewUIImageAsync:(CDUnknownBlockType)arg1;
...
- (void)setKeyFrameCallBack:(CDUnknownBlockType)arg1;
...
- (void)setGetAudioTimeCallback:(CDUnknownBlockType)arg1;
