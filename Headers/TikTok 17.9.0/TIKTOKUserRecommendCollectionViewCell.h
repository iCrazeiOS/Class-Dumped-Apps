...
@class AWEAliasEditLabel, AWEUserModel, AWEUserNameLabel, NSString, UIButton, UIImageView, UIView, YYAnimatedImageView;

@interface TIKTOKUserRecommendCollectionViewCell : UICollectionViewCell <AWEUserMessage>
{
    ...
    AWEUserNameLabel *_recommendLabel;
...
@property(retain, nonatomic) AWEUserNameLabel *recommendLabel; // @synthesize recommendLabel=_recommendLabel;
