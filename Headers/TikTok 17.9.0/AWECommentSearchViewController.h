...
#import "AWECommentSearchCellDelegate-Protocol.h"
#import "AWECommentSearchManagerDelegate-Protocol.h"
#import "UITableViewDataSource-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class AWECommentSearchManager, NSArray, NSCache, NSString, UIImageView, UILabel, UITableView, UIView;
@protocol AWECommentSearchViewControllerDelegate;

@interface AWECommentSearchViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, AWECommentSearchManagerDelegate, AWECommentSearchCellDelegate>
{
...
@property(retain, nonatomic) NSArray *defaultUserArray; // @synthesize defaultUserArray=_defaultUserArray;
...
- (void)searchWithsearchManager:(id)arg1;
...
- (void)sendMessageToUser:(id)arg1;
- (void)clearSearchCache;
- (void)p_reloadDataIfNeeded:(id)arg1 error:(id)arg2 searchStopped:(_Bool)arg3;
- (void)searchWithKeyword:(id)arg1 currentInputText:(id)arg2;
- (void)loadDefaultListWithCurrentInputText:(id)arg1;
