...
#import "IESLiveMTBlockListActions-Protocol.h"

@class HTSEventContext, HTSLiveUserAPI, IESLiveUserModel, LiveRoomModel, NSMutableArray, NSString, RACDisposable;
@protocol IESLiveMTBlockListReactions, IESLiveTracker, IESLiveUserService;

@interface IESLiveMTBlockListStore : NSObject <IESLiveMTBlockListActions>
{
    _Bool _isNewStyle;
    NSMutableArray *_dataSource;
    id <IESLiveMTBlockListReactions> _reaction;
    LiveRoomModel *_room;
...
@property(nonatomic) __weak id <IESLiveMTBlockListReactions> reaction; // @synthesize reaction=_reaction;
@property(retain, nonatomic) NSMutableArray *dataSource; // @synthesize dataSource=_dataSource;
- (void)unkickOut:(id)arg1;
- (void)removeUserFromBlockList:(unsigned long long)arg1;
- (void)fetchBlockList:(unsigned long long)arg1;
- (void)setup;
