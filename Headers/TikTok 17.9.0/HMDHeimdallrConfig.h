...
@property(retain, nonatomic) NSArray *apiAllowHeaderList; // @synthesize apiAllowHeaderList=_apiAllowHeaderList;
@property(retain, nonatomic) NSArray *apiAllowList; // @synthesize apiAllowList=_apiAllowList;
@property(retain, nonatomic) NSArray *apiBlockList; // @synthesize apiBlockList=_apiBlockList;
...
- (_Bool)isHeaderInAllowHeaderList:(id)arg1;
- (_Bool)isURLInAllowList:(id)arg1;
- (_Bool)isURLInBlockList:(id)arg1;
