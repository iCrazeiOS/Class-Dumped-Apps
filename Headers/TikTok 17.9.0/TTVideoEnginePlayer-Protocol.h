...
@class AVPlayerItem, NSDictionary, NSString, NSURL, TTVideoEngineAVPlayerItemAccessLog, UIImage, UIView;
...
- (void)setMaskInfo:(id <TTAVPlayerMaskInfoInterface>)arg1;
- (void)setLoadControl:(id <TTAVPlayerLoadControlInterface>)arg1;
...
- (void)setCurrentPlaybackTime:(double)arg1 complete:(void (^)(_Bool))arg2 renderComplete:(void (^)(_Bool))arg3;
