...
@interface RCTUIManager : NSObject <RCTBridgeModule, RCTInvalidating>
{
    ...
    _Bool _maybeContentDidAdded;
    _Bool _maybeFirstScreenAvailable;
    _Bool _maybePageHierarchyStable;
    _Bool _maybePageFinish;
    double _maybePageFinishTime;
    RCTBridge *_bridge;
    RCTUIManagerObserverCoordinator *_observerCoordinator;
}

+ (id)JSResponder;
+ (const struct RCTMethodInfo *)__rct_export__163220;
+ (const struct RCTMethodInfo *)__rct_export__156019;
+ (const struct RCTMethodInfo *)__rct_export__155018;
+ (const struct RCTMethodInfo *)__rct_export__148117;
+ (const struct RCTMethodInfo *)__rct_export__143516;
+ (const struct RCTMethodInfo *)__rct_export__141915;
+ (const struct RCTMethodInfo *)__rct_export__140314;
+ (const struct RCTMethodInfo *)__rct_export__135213;
+ (const struct RCTMethodInfo *)__rct_export__132412;
+ (const struct RCTMethodInfo *)__rct_export__129011;
+ (const struct RCTMethodInfo *)__rct_export__111710;
+ (const struct RCTMethodInfo *)__rct_export__10949;
+ (const struct RCTMethodInfo *)__rct_export__10868;
+ (const struct RCTMethodInfo *)__rct_export__10787;
+ (const struct RCTMethodInfo *)__rct_export__10546;
+ (const struct RCTMethodInfo *)__rct_export__9935;
+ (const struct RCTMethodInfo *)__rct_export__9134;
+ (const struct RCTMethodInfo *)__rct_export__8783;
+ (const struct RCTMethodInfo *)__rct_export__8322;
+ (const struct RCTMethodInfo *)__rct_export__8131;
+ (const struct RCTMethodInfo *)__rct_export__6980;
...
- (void)checkIfContentDidAdded:(id)arg1;
