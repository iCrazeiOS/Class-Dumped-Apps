...
@class AVAsset, HTSVideoData, IESMMMVEffectFilter, IESMMMVModel, IESMMTimeMachine, NSMutableArray, NSMutableDictionary;
...
+ (long long)getScaleModeWithFillMode:(long long)arg1;
...
- (id)init;
- (id)initWithVideoData:(id)arg1 enableMultiTrack:(_Bool)arg2;
