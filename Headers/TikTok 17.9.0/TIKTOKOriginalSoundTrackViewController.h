...
@interface TIKTOKOriginalSoundTrackViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, AWEPreviewable, AWEAVPlayerWrapperDelegate, AWEUserMessage, AWEUserProfileTabBaseMethod>
{
    _Bool _fromHomepage;
    ...
    UILabel *_emptyLabel;
    UILabel *_emptyDescriptionLabel;
