...
+ (id)adapterWithModelClass:(Class)arg1;
...
+ (id)traverseDictionaryTransformerWithModelClass:(Class)arg1 valueNodeForwardBlock:(CDUnknownBlockType)arg2 reverseBlock:(CDUnknownBlockType)arg3;
+ (id)traverseArrayTransformerWithModelClass:(Class)arg1 valueNodeForwardBlock:(CDUnknownBlockType)arg2 reverseBlock:(CDUnknownBlockType)arg3;
+ (id)traverseArrayTransformerWithModelClass:(Class)arg1;
