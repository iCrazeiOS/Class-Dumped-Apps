...
@property _Bool shouldCheckHeightChange; // @synthesize shouldCheckHeightChange;
...
- (void)setContentInsetPurely:(struct UIEdgeInsets)arg1;
- (void)layoutSubviews;
