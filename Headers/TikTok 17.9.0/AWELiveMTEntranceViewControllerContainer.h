...
@class NSString;
@protocol AWELiveCamera, IESLiveMTOpenLiveProtocol;

@interface AWELiveMTEntranceViewControllerContainer : UIViewController <AWELiveEntranceViewControllerProtocol>
{
    id <AWELiveCamera> camera;
    CDUnknownBlockType dismissHandler;
    UIViewController<IESLiveMTOpenLiveProtocol> *_childVC;
}

- (void).cxx_destruct;
@property(retain, nonatomic) UIViewController<IESLiveMTOpenLiveProtocol> *childVC; // @synthesize childVC=_childVC;
