...
@class AWECommerceStickerDetailModel, AWEShareModel, AWEStickerChallengeGuideModel, AWEURLModel, NSArray, NSDictionary, NSString;
...
- (void).cxx_destruct;
@property(nonatomic) long long effectSource; // @synthesize effectSource=_effectSource;
@property(retain, nonatomic) AWEStickerChallengeGuideModel *challengeGuide; // @synthesize challengeGuide=_challengeGuide;
...
@property(copy, nonatomic) NSString *designerSecUserID; // @synthesize designerSecUserID=_designerSecUserID;
