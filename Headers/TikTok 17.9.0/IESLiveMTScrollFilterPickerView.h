...
#import "IESLiveMTPageingViewDataSource-Protocol.h"
#import "IESLiveMTPageingViewDelegate-Protocol.h"
#import "IESLiveScrollFilterPickerViewProtocol-Protocol.h"

@class IESLiveMTPagingView, IESLiveMTSlideLabelAnimator, IESLiveRoomFilter, NSArray, NSString;
@protocol IESLiveFilterProvider, IESLiveLanguageService, IESLiveScrollFilterPickerViewDelegate;

@interface IESLiveMTScrollFilterPickerView : UIView <IESLiveMTPageingViewDelegate, IESLiveMTPageingViewDataSource, IESLiveScrollFilterPickerViewProtocol>
{
    ...
    IESLiveMTPagingView *_pagingView;
    IESLiveMTSlideLabelAnimator *_animator;
    UIView *_emptyView;
...
@property(retain, nonatomic) IESLiveMTSlideLabelAnimator *animator; // @synthesize animator=_animator;
@property(retain, nonatomic) IESLiveMTPagingView *pagingView; // @synthesize pagingView=_pagingView;
