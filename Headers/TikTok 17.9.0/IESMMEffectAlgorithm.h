...
@class HTSGLContext, IESMMEffectConfig, NSDictionary, NSMutableDictionary, NSString;
...
+ (int)getPixelFormatFromPixelBuffer:(struct __CVBuffer *)arg1;
@property(retain, nonatomic) NSDictionary *runtimeParam; // @synthesize runtimeParam=_runtimeParam;
...
@property(nonatomic) unsigned long long autoTestFrameCout; // @synthesize autoTestFrameCout=_autoTestFrameCout;
