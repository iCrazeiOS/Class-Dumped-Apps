...
@class NSArray, NSDictionary, NSError, NSString, TTVideoEngineEvent, TTVideoEngineEventBase, TTVideoEnginePlayer;
...
- (void)setStringOption:(long long)arg1 value:(NSString *)arg2;
...
- (void)beginToPlayVideo:(NSString *)arg1;
- (void)prepareBeforePlay;
- (void)initPlay:(NSString *)arg1;
