...
@class GPBInt64Int32Dictionary, NSString;

@interface TIMPBNConversationSetRoleRequestBody : GPBMessage
{
}
...
@property(retain, nonatomic) GPBInt64Int32Dictionary *roles; // @dynamic roles;
@property(readonly, nonatomic) unsigned long long roles_Count; // @dynamic roles_Count;
