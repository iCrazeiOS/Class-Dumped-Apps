...
- (void)splashControllerViewShowImageAdCompleted:(TTAdSplashControllerView *)arg1 model:(TTAdSplashModel *)arg2;
- (void)splashViewVideoPlayCompleted:(TTAdSplashModel *)arg1;
