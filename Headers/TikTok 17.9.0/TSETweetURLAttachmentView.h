...
@interface TSETweetURLAttachmentView : UIView
{
    ...
    NSLayoutConstraint *_linkerHeightAnchor;
}

@property(retain, nonatomic) NSLayoutConstraint *linkerHeightAnchor; // @synthesize linkerHeightAnchor=_linkerHeightAnchor;
