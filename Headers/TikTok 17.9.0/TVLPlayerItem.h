...
@class NSArray, NSDictionary, NSString, TVLPlayer, TVLPlayerItemAccessLog, TVLPlayerItemInternal, TVLPlayerItemPreferences;
...
- (id)resolutionWithVideoBitrate:(long long)arg1;
