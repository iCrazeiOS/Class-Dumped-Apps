...
@interface AWEStudioMeasureManager : NSObject
{
    ...
    _Bool _hadTrackDraftInfo;
    _Bool _hadTrackEffectInfo;
    _Bool _hadTrackCaptureIMG;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool hadTrackCaptureIMG; // @synthesize hadTrackCaptureIMG=_hadTrackCaptureIMG;
@property(nonatomic) _Bool hadTrackEffectInfo; // @synthesize hadTrackEffectInfo=_hadTrackEffectInfo;
@property(nonatomic) double draftClickStart; // @synthesize draftClickStart=_draftClickStart;
@property(nonatomic) _Bool hadTrackDraftInfo; // @synthesize hadTrackDraftInfo=_hadTrackDraftInfo;
...
- (void)trackCaptureIMG:(CDUnknownBlockType)arg1;
- (void)trackEffectInfo;
- (void)trackOfDraftClickEnd:(id)arg1;
- (void)trackOfDraftClickStart;
- (void)trackOfDraftInfo:(long long)arg1;
