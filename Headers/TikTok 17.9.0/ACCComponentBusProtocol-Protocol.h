...
@protocol ACCComponentProtocol, ACCComponentProvider, IESServiceProvider, UIViewControllerTransitionCoordinator;

@protocol ACCComponentBusProtocol <NSObject>
@property(copy, nonatomic) CDUnknownBlockType completeComponentsPerformHook;
...
- (id)initWithContainerViewController:(UIViewController *)arg1 componentProvider:(id <ACCComponentProvider>)arg2 serviceProvider:(id <IESServiceProvider>)arg3;
- (id)initWithContainerViewController:(UIViewController *)arg1 rootComponentProtocol:(Protocol *)arg2 componentProvider:(id <ACCComponentProvider>)arg3 serviceProvider:(id <IESServiceProvider>)arg4;
