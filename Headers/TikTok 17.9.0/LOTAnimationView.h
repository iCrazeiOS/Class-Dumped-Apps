...
+ (id)awe_animationNamed:(id)arg1 inSearchBundleName:(id)arg2;
+ (id)awe_studioAnimationNamed:(id)arg1;
...
- (void)awe_tapRecognized:(id)arg1;
- (void)awe_addTapAction:(CDUnknownBlockType)arg1 toLayer:(id)arg2;
- (void)awe_addTapAction:(CDUnknownBlockType)arg1 toLayerNamed:(id)arg2;
- (id)awe_layerNamed:(id)arg1;
@property(readonly, nonatomic) LOTCompositionContainer *compContainer;
- (id)awe_tapRecognizer;
- (void)setAwe_tapRecognizer:(id)arg1;
- (id)awe_tapHandlers;
- (void)setAwe_tapHandlers:(id)arg1;
