...
@interface IESMMCamera : VERunloopObject <IESMMEffectMessageProtocol, IESMMEffectTextProtocol>
{
    ...
    _Bool _notNeedAutoStartAudioCapture;
    _Bool _pureCameraMode;
    _Bool _hasCameraStartFailedRecreated;
    ...
    CDUnknownBlockType _firstEffectRenderBlock;
    CDUnknownBlockType _monitorUpdateBlock;
    ...
    struct __CVBuffer *_capturePixelBuf;
...
@property(nonatomic) struct __CVBuffer *capturePixelBuf; // @synthesize capturePixelBuf=_capturePixelBuf;
...
@property(nonatomic) _Bool hasCameraStartFailedRecreated; // @synthesize hasCameraStartFailedRecreated=_hasCameraStartFailedRecreated;
@property(nonatomic) _Bool pureCameraMode; // @synthesize pureCameraMode=_pureCameraMode;
@property(nonatomic) _Bool notNeedAutoStartAudioCapture; // @synthesize notNeedAutoStartAudioCapture=_notNeedAutoStartAudioCapture;
...
@property(copy, nonatomic) CDUnknownBlockType monitorUpdateBlock; // @synthesize monitorUpdateBlock=_monitorUpdateBlock;
@property(copy, nonatomic) CDUnknownBlockType firstEffectRenderBlock; // @synthesize firstEffectRenderBlock=_firstEffectRenderBlock;
...
- (void)p_removeBufferInputMonitor;
- (void)p_addBufferInputMonitor;
...
- (void)captureHDImageWith:(struct CGSize)arg1 byUser:(_Bool)arg2 completionHandle:(CDUnknownBlockType)arg3;
- (void)captureHDImageWith:(struct CGSize)arg1 completionHandle:(CDUnknownBlockType)arg2;
- (void)captureSourcePhotoAsImageByUser:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2 afterProcess:(_Bool)arg3;
- (void)captureSourcePhotoAsImageWithCompletionHandler:(CDUnknownBlockType)arg1 afterProcess:(_Bool)arg2;
- (void)captureSourcePhotoAsImageByUser:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)captureSourcePhotoAsImageWithCompletionHandler:(CDUnknownBlockType)arg1;
- (void)captureStillImageByUser:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
