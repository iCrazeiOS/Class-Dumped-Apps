...
@class AVAsset, AVURLAsset, HTSVideoData, NSLock, NSString;
...
@property(retain, nonatomic) AVURLAsset *multiVideoMergeAsset; // @synthesize multiVideoMergeAsset=_multiVideoMergeAsset;
@property(nonatomic) unsigned long long multiVideoMergeStatus; // @synthesize multiVideoMergeStatus=_multiVideoMergeStatus;
...
- (void)applyTimeMachineWithConfig:(id)arg1 completeBlk:(CDUnknownBlockType)arg2;
- (void)applyTimeMachineWithConfig:(id)arg1;
- (void)reverseAssetWithComplete:(CDUnknownBlockType)arg1;
- (id)mergeVideodata:(id)arg1;
