...
@class BDImageCache, BDImageCacheMonitor, BDWebImageDecoder, BDWebImageURLFilter, NSDictionary, NSMutableDictionary;
...
@interface BDWebImageManager : NSObject <BDWebImageDownloaderDelegate>
{
    ...
    _Bool _isCacheMonitorEnable;
    _Bool _isPrefetchLowPriority;
    _Bool _isPrefetchIgnoreImage;
    ...
    long long _cacheMonitorInterval;
...
@property(nonatomic) _Bool isPrefetchIgnoreImage; // @synthesize isPrefetchIgnoreImage=_isPrefetchIgnoreImage;
@property(nonatomic) _Bool isPrefetchLowPriority; // @synthesize isPrefetchLowPriority=_isPrefetchLowPriority;
@property(nonatomic) long long maxConcurrentTaskCount; // @synthesize maxConcurrentTaskCount=_maxConcurrentTaskCount;
@property(nonatomic) long long cacheMonitorInterval; // @synthesize cacheMonitorInterval=_cacheMonitorInterval;
@property(nonatomic) _Bool isCacheMonitorEnable; // @synthesize isCacheMonitorEnable=_isCacheMonitorEnable;
...
@property(copy) NSDictionary *downloadManagerDefaultHeaders; // @synthesize downloadManagerDefaultHeaders=_downloadManagerDefaultHeaders;
...
- (void)bd_recordLargeImageInfo:(id)arg1 data:(id)arg2 task:(id)arg3 forRequest:(id)arg4;
...
- (long long)transformQueuePriority:(long long)arg1;
- (void)downloadImageWithRequest:(id)arg1;
- (void)queryImageForRequest:(id)arg1 memory:(_Bool)arg2 disk:(_Bool)arg3 callback:(CDUnknownBlockType)arg4;
...
- (id)requestImage:(id)arg1 alternativeURLs:(id)arg2 options:(long long)arg3 size:(struct CGSize)arg4 timeoutInterval:(double)arg5 cacheName:(id)arg6 transformer:(id)arg7 decryptBlock:(CDUnknownBlockType)arg8 progress:(CDUnknownBlockType)arg9 complete:(CDUnknownBlockType)arg10;
...
- (id)requestImage:(id)arg1 options:(long long)arg2 size:(struct CGSize)arg3 complete:(CDUnknownBlockType)arg4;
