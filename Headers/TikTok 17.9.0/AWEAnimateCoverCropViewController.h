...
@class AVAsset, AVAssetExportSession, AVAssetImageGenerator, AVPlayer, AVPlayerLayer, AWEProgressLoadingView, AWEVideoRangeSlider, NSArray, NSString, NSTimer, NSURL, UICollectionView, UINavigationController, UIView;
...
- (void).cxx_destruct;
@property(nonatomic) __weak AWEProgressLoadingView *loadingView; // @synthesize loadingView=_loadingView;
