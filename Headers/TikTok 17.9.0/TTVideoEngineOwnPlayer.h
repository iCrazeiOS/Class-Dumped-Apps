...
@protocol AVAssetResourceLoaderDelegate, TTAVPlayerLoadControlInterface, TTAVPlayerMaskInfoInterface, TTVideoPlayerEngineInfoProtocol, TTVideoPlayerStateProtocol;
...
@interface TTVideoEngineOwnPlayer : NSObject <TTVideoEnginePlayer>
{
    ...
    _Bool _enableRadioMode;
    _Bool _playerLazySeek;
    _Bool _dummyAudioSleep;
    _Bool _isPreparedAsync;
    _Bool _isPlayedinPreparedAsync;
    _Bool _enableNNSR;
    _Bool _enableRange;
...
@property(nonatomic) long long prepareMaxCachesMs; // @synthesize prepareMaxCachesMs=_prepareMaxCachesMs;
@property(nonatomic) long long decoderOutputType; // @synthesize decoderOutputType=_decoderOutputType;
@property(nonatomic) long long defaultBufferEndTime; // @synthesize defaultBufferEndTime=_defaultBufferEndTime;
@property(nonatomic) _Bool isPlayedinPreparedAsync; // @synthesize isPlayedinPreparedAsync=_isPlayedinPreparedAsync;
@property(nonatomic) _Bool isPreparedAsync; // @synthesize isPreparedAsync=_isPreparedAsync;
...
@property(nonatomic) _Bool enableRadioMode; // @synthesize enableRadioMode=_enableRadioMode;
...
@property(nonatomic) id <TTAVPlayerLoadControlInterface> loadControl; // @synthesize loadControl=_loadControl;
...
@property(nonatomic) _Bool handleAudioExtradata; // @synthesize handleAudioExtradata=_handleAudioExtradata;
...
- (void)setPlayerKsyByteVC1Decode:(_Bool)arg1;
@property(nonatomic) _Bool ksyByteVC1Decode; // @synthesize ksyByteVC1Decode=_ksyByteVC1Decode;
