...
@interface AWENetworkICMPPingFoundation : NSObject
{
    _Bool _nextSequenceNumberHasWrapped;
    unsigned short _identifier;
    unsigned short _nextSequenceNumber;
    NSString *_hostName;
    id <AWENetworkICMPPingFoundationDelegate> _delegate;
...
@property(nonatomic) __weak id <AWENetworkICMPPingFoundationDelegate> delegate; // @synthesize delegate=_delegate;
