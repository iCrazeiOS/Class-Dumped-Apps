...
#import "IESLiveMTVideoPlayerControllerDelegate-Protocol.h"
#import "IESLiveMTVideoPlayerProvider-Protocol.h"

@class IESLiveMTVideoPlayerController, NSString, UIView;
@protocol IESLiveMTStreamPlayerProvider, IESLiveMTVideoPlayerDelegate, IESLiveRoomService;

@interface IESLiveMTVideoPlayer : NSObject <IESLiveMTVideoPlayerControllerDelegate, IESLiveMTVideoPlayerProvider>
{
    id <IESLiveMTVideoPlayerDelegate> _delegate;
    IESLiveMTVideoPlayerController *_player;
    UIView *_view;
...
- (void).cxx_destruct;
@property(retain, nonatomic) id <IESLiveMTStreamPlayerProvider> streamPlayerProvider; // @synthesize streamPlayerProvider=_streamPlayerProvider;
...
@property(retain, nonatomic) IESLiveMTVideoPlayerController *player; // @synthesize player=_player;
@property(nonatomic) __weak id <IESLiveMTVideoPlayerDelegate> delegate; // @synthesize delegate=_delegate;
