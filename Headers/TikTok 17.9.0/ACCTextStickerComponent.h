...
@class NSString;
@protocol ACCComponentBusProtocol, ACCComponentProtocol, ACCEditTransitionServiceProtocol, ACCInfoStickerContainerComponentProtocol, ACCPollStickerContainerComponentProtocol, ACCTextStickerContainerComponentProtocol, IESServiceProvider;

@interface ACCTextStickerComponent : ACCFeatureComponent <ACCTextStickerComponentProtocol>
{
