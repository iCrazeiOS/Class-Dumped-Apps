...
@protocol HTSLivePluginLayoutMachineProvider, HTSLiveSmallGiftAction, HTSLiveUserEnterAction, HTSLiveViewHierarchyProvider, IESLiveLayoutContainerProvider, IESLiveMTStreamPlayerProvider, IESLiveRoomService, IESLiveSettings;
...
@property(nonatomic) double messageOriginY; // @synthesize messageOriginY=_messageOriginY;
...
- (id)initWithMessageOriginY:(double)arg1;
