...
@protocol OMIDBytedanceCommandPublisher;

@interface OMIDBytedanceAdSessionStatePublisher : NSObject
{
    id <OMIDBytedanceCommandPublisher> _commandPublisher;
...
@property(readonly, nonatomic) id <OMIDBytedanceCommandPublisher> commandPublisher; // @synthesize commandPublisher=_commandPublisher;
- (void).cxx_destruct;
