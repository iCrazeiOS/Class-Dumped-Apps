...
@interface IESLiveMTRemoteCommand : NSObject
{
    NSNumber *_roomID;
    NSNumber *_anchorID;
    IESLiveMTRemoteCommand *_underlyCommand;
    NSString *_enterFrom;
...
@property(retain, nonatomic) IESLiveMTRemoteCommand *underlyCommand; // @synthesize underlyCommand=_underlyCommand;
