...
@class HTSLiveAvatarImageView, HTSLiveScorllLabelView, IESLiveMTNativeAnimationUserEnterNode, NSString, UIImageView;
@protocol IESLiveMTTemplateProvider, IESLiveWebImageService, IESLiveWebPDecoder;

@interface IESLiveMTSuperUserEnterView : UIView <CAAnimationDelegate, IESLiveMTUserEnterViewProtocol>
{
