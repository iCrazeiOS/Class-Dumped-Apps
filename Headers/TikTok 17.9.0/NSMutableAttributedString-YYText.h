...
+ (_Bool)awe_alpGlobalDisableOperation;
+ (void)awe_setAlpGlobalDisableOperation:(_Bool)arg1;
...
@property(nonatomic) _Bool alp_didClearOperation;
@property(nonatomic) _Bool alp_disableOperationsCollection;
@end
