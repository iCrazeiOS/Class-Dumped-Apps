...
@class NSArray, NSDictionary, NSMutableArray, NSNumber, NSParagraphStyle, NSShadow, NSString, UIColor, UIFont, YYTextBorder, YYTextDecoration, YYTextShadow;
...
- (struct CGSize)prettyLayoutSizeWithMaxWidth:(double)arg1 lastLineAtLeastRatio:(double)arg2;
- (struct CGRect)boundingRectWithSize:(struct CGSize)arg1 maximumNumberOfLines:(unsigned long long)arg2;
- (_Bool)isEmptyAfterTrimmed;
- (id)trimmed;
- (id)trim:(id)arg1;
@end
