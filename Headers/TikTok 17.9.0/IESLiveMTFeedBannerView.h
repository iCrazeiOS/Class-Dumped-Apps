...
@protocol IESLiveMTFeedSchemeHandler, IESLiveTracker;

@interface IESLiveMTFeedBannerView : UIView <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
{
    NSString *_reference;
