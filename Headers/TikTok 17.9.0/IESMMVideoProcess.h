...
@class HTSFilterInterface, HTSGLCropFilter, HTSGLFilter, HTSGLFilterGroup, HTSGLFilterInput, HTSGLPhotoMovieTransitionFilter, HTSGLPicture, HTSGLTransformFilter, HTSRawDataOutputRender, IESGLAddEdgeFilter, IESGLEndingWaterMarkFilter, IESImageAnimationStickerFilter, IESMMEffectStickerInfo, IESMMStoryImageGroup, IESPhotoMovieTransManager, NSMutableArray, NSObject, NSString;
@protocol HTSGLInput, IESMMEffectGroupProtocol, IESVideoEngineEffectProtocol, OS_dispatch_semaphore;

@interface IESMMVideoProcess : IESMMObject <IVEGestureProtocol, IVEGestureAmazingEngineProtocol, IVEInfoStickerProtocol, IVEBrushProtocol, IESMMHashProtocol, IVESrtInfoStickerProtocol>
{
    _Bool _bNeedPreview;
    _Bool _bUseFilter;
    ...
    id <IESVideoEngineEffectProtocol> _water2Filter;
...
@property(retain, nonatomic) id <IESVideoEngineEffectProtocol> water2Filter; // @synthesize water2Filter=_water2Filter;
