...
@class HTSGLBrightenFilter, HTSGLFilter, HTSGLFilterAlphaBlend, HTSGLFilterBilateral, HTSGLFilterCustomBlend, HTSGLFilterSecondBlur, HTSGLFilterToneCurve, HTSImageLookupFilter;
...
@interface HTSGLNewBeautyFilter : HTSGLFilterGroup
{
    ...
    HTSGLBrightenFilter *_blendFilter;
