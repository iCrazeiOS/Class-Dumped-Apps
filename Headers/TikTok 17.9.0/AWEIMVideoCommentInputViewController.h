...
@interface AWEIMVideoCommentInputViewController : UIViewController <AWEGrowingTextViewDelegate>
{
    id <AWEIMVideoCommentInputViewControllerDelegate> _delegate;
    AWEGrowingTextView *_textView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) AWEGrowingTextView *textView; // @synthesize textView=_textView;
@property(nonatomic) __weak id <AWEIMVideoCommentInputViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)p_setupUI;
