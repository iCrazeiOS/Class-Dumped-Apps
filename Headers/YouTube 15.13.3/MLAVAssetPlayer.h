...
@protocol AVAssetResourceLoaderDelegate, HAMClock, MLAVAssetPlayerDelegate, MLFairPlayContentKeySessionProtocol, MLPlayerConfig, NSObject;
...
@interface MLAVAssetPlayer : NSObject
{
    ...
    id <MLFairPlayContentKeySessionProtocol> _keySession;
