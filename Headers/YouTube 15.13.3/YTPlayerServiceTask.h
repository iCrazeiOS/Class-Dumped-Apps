...
@class GIMMe, MLQOEPingController, NSString, YTDispatchTimer, YTIPlayerServiceRetryConfig, YTInnerTubeRequest, YTReachabilityController, YTRetryInterval;
@protocol YTApiaryParser, YTInnerTubeRequestor, YTStopwatch;
