...
@class NSData, YTICommand, YTICompleteTransactionAction, YTIFrameworkUpdateTransport, YTIResponseContext, YTIShowTransactionMessageAction;
...
@property(retain, nonatomic) YTICompleteTransactionAction *completeTransactionAction; // @dynamic completeTransactionAction;
...
@property(retain, nonatomic) YTIShowTransactionMessageAction *showTransactionMessageAction; // @dynamic showTransactionMessageAction;
