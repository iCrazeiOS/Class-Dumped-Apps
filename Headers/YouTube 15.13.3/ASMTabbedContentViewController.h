...
#import <Module_Framework/ASMPageViewControllerDelegate-Protocol.h>
#import <Module_Framework/ASMScrollViewTrackingDelegate-Protocol.h>
#import <Module_Framework/MDCTabBarDelegate-Protocol.h>
#import <Module_Framework/UIPageViewControllerDataSource-Protocol.h>

@class ASMHeaderViewController, ASMPageViewController, ASMViewBlueprint, MDCTabBar, NSMutableDictionary, NSString, UIScrollView;
@protocol ASMScrollViewTrackingDelegate, ASMTopNavigationViewModel, ASMViewControllerFactory;

@interface ASMTabbedContentViewController : ASMObservingViewController <ASMPageViewControllerDelegate, ASMScrollViewTrackingDelegate, MDCTabBarDelegate, UIPageViewControllerDataSource, ASMHeaderContentViewController, ASMNavigationHierarchyController>
{
