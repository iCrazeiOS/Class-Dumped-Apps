...
@class GIMMe, MLNerdStatsPlaybackData, NSMutableArray, NSString, UIViewController, YTAdVideoPlayerOverlayView, YTAnnotationsViewController, YTBrandInteractionViewController, YTCreatorEndscreenViewController, YTDownAndOutController, YTHotConfig, YTIAdPlayerOverlayRenderer, YTICommand, YTInstreamAdCtaViewController;
@protocol YTAdPlayerOverlayDelegate, YTAdVideoEndProtocol, YTAdVideoPlayerOverlayDelegate, YTInstreamAd, YTResponder, YTSingleVideoObservable, YTVideoPlayerOverlayDelegate;
