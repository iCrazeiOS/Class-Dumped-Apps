...
@class NSData, NSMutableArray, YTIBadgeSupportedRenderers, YTICommand, YTIFormattedString, YTIPlayerOverlayAutoplayButtonSupportedRenderers, YTIPlayerOverlayAutoplayPausedSupportedRenderers, YTIPlayerOverlayNextButtonSupportedRenderers, YTIThumbnailDetails;
