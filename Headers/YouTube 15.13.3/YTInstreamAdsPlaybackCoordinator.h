...
@class GIMMe, NSString, YTAdFulfillmentCore, YTGlobalConfig, YTInPlayerExternallyManagedSlotAdapter, YTInstreamAdSingleVideoObserver, YTInstreamAdTrackingController, YTInstreamAdsCoordinator, YTPlayerBytesExternallyManagedSlotAdapter, YTPlayerCurrentAdsState, YTPlayerResponse, YTUserDefaults, YTVideoAdsOverlayCoordinator;
...
@interface YTInstreamAdsPlaybackCoordinator : NSObject <YTSingleVideoCurrentTimeObserver, YTSingleVideoErrorObserver, YTSingleVideoLifecycleStateObserver, YTSingleVideoMediaStateObserver, YTSingleVideoMediaStateSideEffectfulObserver, YTAdsPlaybackCoordinator, YTAdsPlaybackProtocol>
{
    ...
    YTInPlayerExternallyManagedSlotAdapter *_inPlayerExternallyManagedSlotAdapter;
    YTPlayerBytesExternallyManagedSlotAdapter *_playerBytesExternallyManagedSlotAdapter;
