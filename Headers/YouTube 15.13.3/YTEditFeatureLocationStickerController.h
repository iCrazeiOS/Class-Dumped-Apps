...
@class GIMMe, NSString, YTCommandResponderEvent, YTUploadLocationPermissionsViewController, YTUploadSelectLocationViewController;
@protocol YTResponder;

@interface YTEditFeatureLocationStickerController : UIViewController <YTUploadLocationPermissionsViewControllerDelegate, YTTopController>
{
