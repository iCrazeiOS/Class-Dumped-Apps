...
@class GIMMe, HAMEventCenter, HAMPlayerContext, HAMPlayerInternal, HAMQueueingRootSampleBufferSource, MLAudioSession, MLFormat, MLHAMPlayerItemSegment, MLHAMQueuePlayerSegmentList, MLPlayerEventCenter, MLPlayerStickySettings, MLSegmentTimeline, MLTextTrackRenderer, MLVideo, MLVideoDecoderFactory, MLViewportSize, NSArray, NSData, NSDictionary, NSError, NSString, UIView, YTIHamplayerHotConfig, YTSystemNotifications;
...
- (void)playerItemTextTrackDisabledDidChange:(id)arg1;
...
- (void)requestSeekToTime:(double)arg1 inSegment:(id)arg2;
