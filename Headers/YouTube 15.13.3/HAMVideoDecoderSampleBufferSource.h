...
@class GIMMe, HAMFormatDescription, HAMSampleBuffer, NSDictionary, NSError, NSMutableArray, NSObject, NSString;
@protocol HAMAsyncSampleBufferSourceDelegate, HAMClock, HAMMediaSourceDelegate, HAMSampleBufferSource, HAMVideoDecoder, HAMVideoDecoderFactory, OS_dispatch_queue;
...
@property(readonly, nonatomic) int pendingSamples;
