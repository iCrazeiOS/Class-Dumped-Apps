...
@interface YTAppWatchController : NSObject <MDXAirPlayManagerObserver, MDXSessionManagerObserver, MDXViewObserver, YTMDXScreenContentControllerDelegate, YTRemoteCommandHandlerDelegate, YTAppViewWatchDelegate, YTModalPlaybackChangeResponderProvider, YTResponder>
{
