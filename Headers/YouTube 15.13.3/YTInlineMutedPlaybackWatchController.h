...
@class GIMMe, NSError, NSString, UIViewController, YTColdConfig, YTDefaultPlayerOverlayFactory, YTHotConfig, YTICommand, YTInlineMutedPlaybackOverlayFactory, YTInlineMutedPlaybackViewControllerManager, YTInlineMutedPlaybackWatchViewController, YTPlayerResponse, YTUserDefaults, YTWatchTransition;
@protocol YTInceptionControllerProtocol, YTInlineMutedPlaybackWatchControllerDelegate, YTPlaybackController, YTResponder;
