...
@class GIMMe, NSError, NSHashTable, NSMutableDictionary, NSString, UIView, UIViewController, YTClipController, YTConfirmDialogController, YTDelayedWatchNextService, YTICommand, YTIConfirmDialogRenderer, YTIMenuRenderer, YTIVideoReportingSupportedRenderers, YTIWatchNextResponse, YTInnerTubeControllerFactory, YTPlaybackDebugData, YTPlayerResponse, YTPlayerWatchNextOrderingController, YTRestoreController, YTShareEndpointController, YTVideoQualityPromoController, YTWatchNextResultsViewController, YTWatchNextViewController, YTWatchSurveyTriggerController, YTWatchTransition, YTYouThereController;
...
@interface YTWatchController : NSObject <YCHPlaybackEventsProvider, YTAppOfflineVideoControllerObserver, YTAutonavPlayabilityDelegate, YTCompanionRenderingProtocol, YTEngagementPanelNavigationControllerEventObserver, YTExternalCompanionShelfResponderProvider, YTImmersiveRenderingProtocol, YTOfflineModeObserver, YTOfflineVideoControllerObserver, YTPlaybackControllerUIDelegate, YTShareObserver, YTSpeedyGResponderProvider, YTVELoggingAPI, YTWatchBreakControllerDelegate, YTYouThereControllerDelegate, MDXSessionObserver, MDXSessionManagerObserver, YTBedtimeReminderControllerDelegate, YTActiveVideoProvider, YTActiveVideoReportingRendererProvider, YTOfflineabilityResponderProvider, YTPlaybackControllerEventsDelegate, YTPlaybackDebugDataProvider, YTPlaylistPanelControllerPlaybackDelegate, YTResponder, YTWatchControllerProtocol, YTWatchNextStateResponderProvider>
{
...
- (void)loadCompanionAd:(id)arg1 layoutID:(id)arg2;
...
- (void)startCompanion:(id)arg1 withLayoutID:(id)arg2;
