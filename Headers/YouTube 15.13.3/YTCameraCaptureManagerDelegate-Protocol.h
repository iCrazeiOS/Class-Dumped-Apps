...
@protocol YTCameraCaptureManager, YTCameraCaptureManagerDelegate;
...
- (void)captureManagerWasPreempted:(id <YTCameraCaptureManager>)arg1 byDelegate:(id <YTCameraCaptureManagerDelegate>)arg2;
