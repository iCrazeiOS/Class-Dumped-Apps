...
@class NSString, RTCAudioTrack, RTCPeerConnection, RTCVideoTrack, YTLCRTCMediaStatistic, YTTimedAction;
...
@interface YTLCRTCMediaStatisticsReporter : NSObject
{
    ...
    RTCAudioTrack *_audioSendTrack;
    RTCVideoTrack *_videoSendTrack;
}

@property(retain, nonatomic) RTCVideoTrack *videoSendTrack; // @synthesize videoSendTrack=_videoSendTrack;
@property(retain, nonatomic) RTCAudioTrack *audioSendTrack; // @synthesize audioSendTrack=_audioSendTrack;
