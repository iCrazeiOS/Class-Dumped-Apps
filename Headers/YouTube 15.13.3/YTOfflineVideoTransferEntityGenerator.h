...
@interface YTOfflineVideoTransferEntityGenerator : NSObject <YTOfflineVideoEntityGeneratorProtocol>
{
...
+ (int)transferStateFromVideoState:(int)arg1;
...
- (id)transferEntityForVideo:(id)arg1;
