...
#import <Module_Framework/YTYtMainCoreDownloadedPlaylistEntityModel.h>

#import <Module_Framework/YTMutableEntity-Protocol.h>

@class NSData, NSDictionary, NSString, YTYtMainPlaylistEntityModel;

@interface YTMutableYtMainCoreDownloadedPlaylistEntityModel : YTYtMainCoreDownloadedPlaylistEntityModel <YTMutableEntity>
{
}
