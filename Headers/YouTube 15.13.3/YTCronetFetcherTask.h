...
@class GIMMe, NSArray, NSString, NSURLRequest, YTFetcherTaskConfiguration;
...
- (void)resume;
- (id)initWithRequest:(id)arg1 requestDecorators:(id)arg2 configuration:(id)arg3 engine:(struct Cronet_Engine *)arg4;
