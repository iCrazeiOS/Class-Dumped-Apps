...
@class GIMMe, GOOOverlayObserver, NSError, NSString, UIViewController, YTIVideoDetails, YTInteractionLoggingProxyButton, YTNGWatchFlexyController, YTNGWatchMiniBarView, YTNGWatchQueue, YTPaidContentController;
@protocol YTAutonavControllerProtocol, YTNGWatchMiniBarViewControllerDelegate, YTResponder, YTServices, YTWatchPlayerViewControllerDelegate;
