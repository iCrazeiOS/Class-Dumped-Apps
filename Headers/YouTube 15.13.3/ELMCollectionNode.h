...
-     // Error parsing type: r^{CollectionTypeSection=^^?{InternalMetadata=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<youtube::elements::Element>=^{Arena}ii^{Rep}}}24@0:8Q16, name: sectionAtIndex:
...
-     // Error parsing type: v24@0:8r^{CollectionTypeScrollToItemCommand=^^?{InternalMetadata=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}ifiB}16, name: handleScrollToItemCommand:
...
-     // Error parsing type: B24@0:8r^{CollectionType=^^?{InternalMetadata=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<youtube::elements::CollectionTypeSection>=^{Arena}ii^{Rep}}^{DimensionEdges}^{DimensionEdges}^{Command}^{Command}^{Command}iffBBBBii}16, name: isHorizontal:
