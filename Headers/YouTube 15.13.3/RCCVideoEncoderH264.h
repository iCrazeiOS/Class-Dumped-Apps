...
@class NSString, RTCCodecSpecificInfoH264, RTCVideoCodecInfo;

@interface RCCVideoEncoderH264 : NSObject <RTCVideoEncoder, RCCVideoToolboxEncoderDelegate>
{
    RTCVideoCodecInfo *_codecInfo;
    struct BitrateAdjuster *_bitrateAdjuster;
    ...
    RTCCodecSpecificInfoH264 *_codecSpecificInfo;
