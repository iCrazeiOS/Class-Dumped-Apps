...
@property(retain) YTEditGLKRenderer *glRenderer; // @synthesize glRenderer=_glRenderer;
@property(retain) YTEditGLKBufferView *effectsPreviewView; // @synthesize effectsPreviewView=_effectsPreviewView;
...
- (struct GPCPromise *)startRecordingWithRecordingSettings:(id)arg1;
