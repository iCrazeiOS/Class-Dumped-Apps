...
@class GIMMe, HAMEventCenter, HAMFormatSelection, HAMPlayerContext, MLAdaptiveLiveController, MLFormat, MLHAMQueuePlayerSegmentList, MLOnesieVideoData, MLPlayerItemEventCenter, MLQOEPingController, MLSegmentTimeline, MLServerABRLoader, MLServerABRSampleBufferSource, MLVideo, NSArray, NSError, NSString;
...
@interface MLServerABRPlayerItem : NSObject <MLHAMPlayerItemProtocol>
{
    id <HAMClock> _clock;
