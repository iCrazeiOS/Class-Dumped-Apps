...
@class NSArray, NSData, NSDate, NSDictionary, NSString, NSURL, YTUploadMetadata, YTUploadOperationStateEntity;
...
@property(retain, nonatomic) YTUploadOperationStateEntity *commitVideoState; // @dynamic commitVideoState;
...
@property(nonatomic) _Bool flowUpload; // @dynamic flowUpload;
...
@property(copy, nonatomic) NSString *metadataCategory; // @dynamic metadataCategory;
@property(copy, nonatomic) NSString *metadataDescription; // @dynamic metadataDescription;
@property(copy, nonatomic) NSString *metadataLicense; // @dynamic metadataLicense;
...
@property(nonatomic) _Bool readyToCreateReelItems; // @dynamic readyToCreateReelItems;
