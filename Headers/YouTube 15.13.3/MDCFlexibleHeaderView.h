...
@class CADisplayLink, CALayer, MDCFlexibleHeaderMinMaxHeight, MDCFlexibleHeaderScrollViewInfo, MDCFlexibleHeaderTopSafeArea, MDCStatusBarShifter, NSHashTable, NSMapTable, NSString, UIColor, UIScrollView, UIViewController;
