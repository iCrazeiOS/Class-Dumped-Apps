...
@class GIMMe, MDXView, NSString, UIViewController, YTFullscreenDismissAnimator, YTFullscreenPresentAnimator, YTICommand, YTIWatchNextResponse, YTInteractionLoggingProxyButton, YTNGWatchFlowViewController, YTNGWatchFullscreenViewController, YTNGWatchLayerView, YTNGWatchMiniBarViewController, YTNGWatchQueue, YTNGWatchQueueSingleItemManager, YTPageStyleController, YTTransitionManager, YTWatchTransition;
@protocol YTLayoutStyle, YTNGWatchContainerViewController, YTResponder, YTResponder><YTNGWatchFlexyUIDelegate><YTNGWatchLayerViewExpansionObserver, YTServices, YTVideoPlayerOverlayConfig, YTWatchPlayerViewControllerDelegate;
