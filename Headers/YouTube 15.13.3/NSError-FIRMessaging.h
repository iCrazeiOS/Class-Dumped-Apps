...
+ (id)MLCacheErrorWithCode:(int)arg1 details:(id)arg2 underlyingError:(id)arg3;
+ (id)MLCacheErrorWithCode:(int)arg1 details:(id)arg2;
+ (id)MLDRMErrorWithCode:(long long)arg1;
+ (id)MLDownloadErrorWithCode:(long long)arg1 details:(id)arg2 underlyingError:(id)arg3;
+ (id)MLDownloadErrorWithCode:(long long)arg1 details:(id)arg2;
...
+ (id)yt_uploadRetryableErrorWithError:(id)arg1;
...
@property(readonly, nonatomic, getter=yt_uploadIsRetryable) _Bool yt_uploadRetryable;
