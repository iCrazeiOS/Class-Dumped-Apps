...
@class FLXLayout, GIMMe, NSString, UIAccessibilityCustomAction, UIImage, UIImageView, UITapGestureRecognizer, YTBadge, YTCompactVideoView, YTEngagementToolbarView, YTFormattedStringLabel, YTICommentRenderer, YTImageView, YTLabel, YTPollView, YTQTMButton, YTVerifiedChannelBadgeView, YTVideoView;
...
@interface YTCommentView : UIView <GA11YMixinEmbedder, YTPageStyling, YTReusableView, YTThumbnailMapping>
{
    ...
    YTQTMButton *_translateCommentTextButton;
...
@property(retain, nonatomic) YTQTMButton *translateCommentTextButton; // @synthesize translateCommentTextButton=_translateCommentTextButton;
...
- (void)didTapTranslateCommentTextButton;
