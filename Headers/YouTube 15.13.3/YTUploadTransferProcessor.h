...
@class GIMMe, NSArray, NSString, YTUploadHandle, YTUploadProgressProvider, YTUploadTransferService;

@interface YTUploadTransferProcessor : NSObject <YTUploadProcessor>
{
    YTUploadTransferService *_service;
...
- (void).cxx_destruct;
- (void)resumeTransferWithFrontendID:(id)arg1 handle:(id)arg2 completion:(CDUnknownBlockType)arg3;
