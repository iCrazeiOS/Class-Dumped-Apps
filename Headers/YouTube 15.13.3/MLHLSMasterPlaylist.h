...
+ (id)masterPlaylistByPairingStreams:(id)arg1 videoToAudioItagMap:(id)arg2 captionTrackLanguageToURLMap:(id)arg3 hasIndependentSegments:(_Bool)arg4 startTag:(id)arg5 error:(id *)arg6;
