...
@class GIMMe, NSString, UIViewController, YTActivityWaitViewController, YTBackgroundURLSessionNotifications, YTCSIYouTubeActionsController, YTEntitlementRefreshController, YTFeedbackStateController, YTInnerTubeUIServiceMapper, YTMDXObserver, YTOfflinePlaylistActionController, YTOfflineRefreshWorker, YTOfflineVideoActionController, YTScrollsToTopCoordinator, YTSettings, YTSignedOutLocalSearchHistory, YTStoreKitPurchaseController, YTTimingResponderEventProcessor;
