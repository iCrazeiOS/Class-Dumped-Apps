...
@interface YTUploadCreateReelItemsController : NSObject <YTRetryTaskConfig, YTUploadSynchronousController>
{
...
- (void).cxx_destruct;
- (void)createReelItemsFailedForFrontendUploadID:(id)arg1 error:(id)arg2 errorBlock:(CDUnknownBlockType)arg3;
- (void)retryCreateReelItemsForFrontendUploadID:(id)arg1 error:(id)arg2 errorBlock:(CDUnknownBlockType)arg3;
- (void)markCreateReelItemsCompleteForFrontendUploadID:(id)arg1 playlistIds:(id)arg2 responseBlock:(CDUnknownBlockType)arg3 errorBlock:(CDUnknownBlockType)arg4;
