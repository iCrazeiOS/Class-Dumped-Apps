...
@class NSArray, NSData, NSDictionary, NSString, YTIMainRecommendedDownloadVideoEntity, YTMainAppVideoMetadataEntityModel, YTMainRecommendedDownloadVideoEntity_LocalizedStringsModel, YTYtMainVideoEntityModel;
@protocol YTEntityStore;

@interface YTMainRecommendedDownloadVideoEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    NSString *_id_p;
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSArray *_formatsArray;
    YTMainRecommendedDownloadVideoEntity_LocalizedStringsModel *_localizedStrings;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIMainRecommendedDownloadVideoEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMainRecommendedDownloadVideoEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTMainRecommendedDownloadVideoEntity_LocalizedStringsModel *localizedStrings; // @synthesize localizedStrings=_localizedStrings;
- (void).cxx_destruct;
...
- (void)metadataWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTMainAppVideoMetadataEntityModel *metadata;
- (_Bool)isEqualToEntity:(id)arg1;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;
@property(readonly, nonatomic) NSArray *formatsArray; // @synthesize formatsArray=_formatsArray;
