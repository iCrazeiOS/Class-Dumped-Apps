...
@class AVSampleBufferRenderSynchronizer, GIMMe, HAMPixelBuffer, NSObject, NSString;
...
- (id)init;
- (id)initWithContext:(id)arg1 rootMediaSource:(id)arg2 configuration:(struct HAMPixelBufferVideoTrackRendererConfiguration)arg3 sampleBufferSource:(id)arg4;
