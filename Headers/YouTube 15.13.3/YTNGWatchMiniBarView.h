...
@protocol GA11YMixinImpl, YTNGWatchMiniBarViewDelegate, YTNGWatchMiniBarViewSizeProvider, YTPageStyleProvider;

@interface YTNGWatchMiniBarView : UIView <GA11YMixinEmbedder, UIGestureRecognizerDelegate, YTNGWatchMiniBarControlsViewDelegate, YTPageStyling, YTPageStyleProvider>
{
