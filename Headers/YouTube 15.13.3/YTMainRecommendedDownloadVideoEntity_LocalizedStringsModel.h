...
@class NSData, NSString, YTIMainRecommendedDownloadVideoEntity_LocalizedStrings;
@protocol YTEntityStore;

@interface YTMainRecommendedDownloadVideoEntity_LocalizedStringsModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIMainRecommendedDownloadVideoEntity_LocalizedStrings *_protoBuf;
}

@property(copy, nonatomic) YTIMainRecommendedDownloadVideoEntity_LocalizedStrings *protoBuf; // @synthesize protoBuf=_protoBuf;
