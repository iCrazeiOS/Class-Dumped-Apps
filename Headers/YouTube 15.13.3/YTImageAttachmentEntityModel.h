...
@class NSArray, NSData, NSDictionary, NSString, YTCommandModel, YTIImageAttachmentEntity;
...
@interface YTImageAttachmentEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTCommandModel *_retryUploadCommand;
    NSData *_data;
...
@property(retain, nonatomic) YTCommandModel *retryUploadCommand; // @synthesize retryUploadCommand=_retryUploadCommand;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) NSArray *fullSizeImageSourcesArray; // @synthesize fullSizeImageSourcesArray=_fullSizeImageSourcesArray;
