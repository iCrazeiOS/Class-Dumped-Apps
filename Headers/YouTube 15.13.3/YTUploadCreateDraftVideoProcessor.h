...
@class GIMMe, NSArray, NSString, YTDeleteVideoService, YTUploadService;

@interface YTUploadCreateDraftVideoProcessor : NSObject <YTUploadProcessor>
{
...
- (void).cxx_destruct;
- (id)videoIDFromRenderer:(id)arg1 error:(id *)arg2;
