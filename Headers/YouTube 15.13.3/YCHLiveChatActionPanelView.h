...
@class GIMMe, NSString, QTMButton, UIImage, UIImageView, UILabel, YTEmojiController, YTEmojiCustomEmojiParser, YTEmojiTextView, YTEmojiTextViewManager, YTIIcon, YTILiveChatActionPanelSupportedRenderers, YTILiveChatCreatorSupportRenderer, YTILiveChatProductPickerRenderer, YTIMessageRenderer, YTImageView, YTQTMButton, YTThumbnailController;
