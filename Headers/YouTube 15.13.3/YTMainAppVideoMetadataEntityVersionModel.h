...
@class NSData, YTIMainAppVideoMetadataEntityVersion;
@protocol YTEntityStore;

@interface YTMainAppVideoMetadataEntityVersionModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIMainAppVideoMetadataEntityVersion *_protoBuf;
}

@property(copy, nonatomic) YTIMainAppVideoMetadataEntityVersion *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(readonly, nonatomic) long long lastMetadataRefreshTimestamp;
@property(readonly, nonatomic) _Bool hasLastMetadataRefreshTimestamp;
- (id)entityVersion;
- (id)init;
