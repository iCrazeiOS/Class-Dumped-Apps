...
@class GIMMe, NSString, YTKoreanAgeVerificationViewController, YTPlayabilityResolutionUserActionRequest;
@protocol YTPlayabilityResolutionUIProtocol, YTResponder;

@interface YTPlayabilityResolutionUserActionUIController : NSObject <YTKoreanAgeVerificationViewControllerDelegate, YTResponder>
{
