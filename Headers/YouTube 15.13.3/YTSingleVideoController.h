...
@class GIMMe, MLFormat, MLNerdStatsPlaybackData, MLPlayerPool, MLPlayerStickySettings, MLQOEError, NSArray, NSData, NSDictionary, NSError, NSHashTable, NSString, UIView, YTBackgroundabilityPolicy, YTCaptionViewController, YTMediaPlayerManager, YTPlayerView, YTSingleVideo, YTSingleVideoAirplaySkipDetector, YTSingleVideoControllerTime, YTSingleVideoEventCenter, YTSingleVideoLoggingController, YTSingleVideoMediaTimeAccumulator, YTSingleVideoTime, YTVSSControllerState;
...
@interface YTSingleVideoController : NSObject <MLQueuePlayerDelegate, YTAVDAIPlayerControls, YTHAMDAIPlayerControls, YTBackgroundabilityPolicyObserver, YTPlayerControls, YTSingleVideoObservable, YTPlayerItemControls>
{
    id <MLPlayer> _player;
...
- (void)assertValue:(double)arg1 isCloseToValue:(double)arg2;
