...
@class GIMMe, MDCActivityIndicator, NSString, UIGestureRecognizer, UIImageView, UIPanGestureRecognizer, UITapGestureRecognizer, YTAnnotationsView, YTAutonavBackgroundView, YTAutonavEndscreenView, YTAutonavPreviewView, YTCreatorEndscreenView, YTDoubleTapToSeekView, YTErrorPlayerOverlayView, YTFullscreenEngagementOverlayView, YTGlassContainerView, YTImageView, YTInlinePlayerScrubUserEducationView, YTLabel, YTLiveOfflineSlateView, YTMagicWindowEduOverlayView, YTMainAppControlsOverlayView, YTNoSoundMemoView, YTOverflowMenuView, YTTimedAction, YTVideoZoomOverlayView;
@protocol YTAutonavEndscreenViewProtocol><YTPlayerViewLayoutProtocol, YTCaptionViewProtocol, YTInfoCardTeaserViewProtocol, YTPlayerBarControllerViewProtocol, YTResponder, YTVideoPlayerOverlayConfig;
