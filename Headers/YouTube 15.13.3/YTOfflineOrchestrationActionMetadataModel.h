...
@class NSArray, NSData, YTIOfflineOrchestrationActionMetadata;
...
@interface YTOfflineOrchestrationActionMetadataModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    NSArray *_retryScheduleIntervalsInSecondsArray;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIOfflineOrchestrationActionMetadata *_protoBuf;
}

@property(copy, nonatomic) YTIOfflineOrchestrationActionMetadata *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(readonly, nonatomic) NSArray *retryScheduleIntervalsInSecondsArray; // @synthesize retryScheduleIntervalsInSecondsArray=_retryScheduleIntervalsInSecondsArray;
@property(readonly, nonatomic) NSArray *constraintsArray; // @synthesize constraintsArray=_constraintsArray;
