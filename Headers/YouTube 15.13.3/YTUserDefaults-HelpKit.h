...
@class NSArray, NSDate, NSNumber, NSString, YTNGWatchRestorableState;
...
@property(retain, nonatomic) YTNGWatchRestorableState *watchRestorableState;
...
- (id)bedtimeReminderWaitAfterVideoEndsKey;
- (id)bedtimeReminderTriggerDateKey;
- (id)bedtimeReminderBedtimeEndTimeIntervalSinceMidnightKey;
- (id)bedtimeReminderBedtimeStartTimeIntervalSinceMidnightKey;
