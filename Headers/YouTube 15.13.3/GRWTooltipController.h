...
#import <Module_Framework/GRWTooltipLifeCycleDelegate-Protocol.h>
#import <Module_Framework/GRWTouchForwardingViewDelegate-Protocol.h>

@class GRWTooltipView, GRWTouchForwardingView, NSString, UIView;

@interface GRWTooltipController : NSObject <GRWTooltipLifeCycleDelegate, GRWTouchForwardingViewDelegate>
{
    GRWTooltipView *_tooltip;
    CDUnknownBlockType _completion;
    UIView *_anchorView;
    long long _originalInterfaceOrientation;
    GRWTouchForwardingView *_touchForwardingView;
    struct CGRect _anchorFrame;
}

@property(retain, nonatomic) GRWTouchForwardingView *touchForwardingView; // @synthesize touchForwardingView=_touchForwardingView;
