...
@class ASMHeaderViewController, ASMMessage, ASMScreenIntro, NSMutableArray, NSString, QTMPullToRefreshController, UIImage, UIScrollView, UITableView;
...
@property(retain, nonatomic) NSMutableArray *blockListData; // @synthesize blockListData=_blockListData;
...
- (CDUnknownBlockType)createNavigateToBlock;
