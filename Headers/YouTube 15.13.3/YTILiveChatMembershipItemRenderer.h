...
@class NSMutableArray, NSString, YTIAccessibilitySupportedDatas, YTICommand, YTIFormattedString, YTILiveChatPaidMessageInputFieldSupportedRenderers, YTIThumbnailDetails;
...
@property(nonatomic) _Bool hasHeaderPrimaryText; // @dynamic hasHeaderPrimaryText;
...
@property(retain, nonatomic) YTIFormattedString *headerPrimaryText; // @dynamic headerPrimaryText;
@property(retain, nonatomic) YTIFormattedString *headerSubtext; // @dynamic headerSubtext;
