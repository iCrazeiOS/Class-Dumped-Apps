...
@class GIMMe, YTILiveChatHotConfig, YTIPdgHotConfig;
...
@property(readonly, nonatomic) _Bool isTextureEnabledForChat;
...
@property(readonly, nonatomic) _Bool isLiveChatTimestampSmoothingEnabled;
- (id)init;
