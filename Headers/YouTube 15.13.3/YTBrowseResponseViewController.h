...
@class GIMMe, NSError, NSString, UIColor, UIViewController, YTConfirmDialogController, YTFullScreenOverlayViewController, YTIBrowseResponse, YTIButtonRenderer, YTICommand, YTNavigationalLatencyEventInfo, YTThumbnailController;
@protocol YTDataServices, YTInnerTubeUIService, YTResponder, YTResponseViewController, YTServices;
