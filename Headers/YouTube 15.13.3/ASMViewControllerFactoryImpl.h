...
@protocol ASMOptions, OGLAccountService, OGLProfileSource, SSOService;
...
- (id)initWithViewModelFactory:(id)arg1 ssoService:(id)arg2 externalLauncher:(id)arg3 oglProfileSource:(id)arg4 oglAccountService:(id)arg5 profilePicturePickerLauncher:(id)arg6 options:(id)arg7;
