...
-     // Error parsing type: ^{KeysetHandle={Keyset=^^?{InternalMetadata=^v}{RepeatedPtrField<google::crypto::tink::Keyset_Key>=^{Arena}ii^{Rep}}I{CachedSize={atomic<int>=Ai}}}}16@0:8, name: ccKeysetHandle
