...
#import <CocoaMQTT/NSObject-Protocol.h>

@class GCDAsyncSocket, NSData, NSError, NSString, NSURL, OS_dispatch_queue;
...
- (OS_dispatch_queue *)newSocketQueueForConnectionFromAddress:(NSData *)arg1 onSocket:(GCDAsyncSocket *)arg2;
@end
