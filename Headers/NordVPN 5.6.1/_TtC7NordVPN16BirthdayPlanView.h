...
@interface _TtC7NordVPN16BirthdayPlanView : UIView
{
    // Error parsing type: , name: titleLabel
    // Error parsing type: , name: subtitleLabel
    // Error parsing type: , name: pricingTitle
...
- (void)awakeFromNib;
@property(nonatomic) __weak UILabel *pricingTitle; // @synthesize pricingTitle;
