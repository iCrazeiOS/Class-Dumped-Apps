...
@class NSHashTable, RLMRealmConfiguration, RLMSchema, RLMSyncSession;
...
+ (_Bool)deleteFilesForConfiguration:(id)arg1 error:(id *)arg2;
+ (_Bool)fileExistsForConfiguration:(id)arg1;
...
- (struct RLMClassPrivileges)privilegesForClassNamed:(id)arg1;
- (struct RLMClassPrivileges)privilegesForClass:(Class)arg1;
- (struct RLMObjectPrivileges)privilegesForObject:(id)arg1;
...
- (_Bool)transactionWithoutNotifying:(id)arg1 block:(CDUnknownBlockType)arg2 error:(id *)arg3;
- (void)transactionWithoutNotifying:(id)arg1 block:(CDUnknownBlockType)arg2;
