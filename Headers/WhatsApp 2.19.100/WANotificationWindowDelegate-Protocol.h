...
@class NSString, WANotification, WANotificationWindow;

@protocol WANotificationWindowDelegate <NSObject>
- (void)notificationWindowDidDeclineCall:(WANotificationWindow *)arg1;
- (void)notificationWindowDidAcceptCall:(WANotificationWindow *)arg1;
