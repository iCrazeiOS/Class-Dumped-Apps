...
@class NSAttributedString, NSString, UIColor, UIImage, WAJID, WAMessagePaymentIconInfo, WAMessageQuotedItem, WASticker, WAUserJID;
...
@interface WAMessageReplyContext : NSObject
{
    ...
    _Bool _fallbackIsQuotedStatusAd;
    _Bool _fallbackIsFromMe;
    WAMessagePaymentIconInfo *_fallbackMessagePaymentIconInfo;
...
- (void)fetchThumbnailForStatusAd:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
