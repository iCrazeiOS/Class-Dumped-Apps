...
@class NSString, WAContactsStorage;
@protocol WAContactsSearchContactsLoaderDelegate;

@interface WAContactsSearchOutOfNetworkContactsLoader : NSObject <WAContactsSearchContactsLoader>
{
...
- (id)contactsToSearch;
- (id)initWithContactsStorage:(id)arg1;
