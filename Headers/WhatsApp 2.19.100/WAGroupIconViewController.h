...
@class NSString, UIActivityIndicatorView, UIBarButtonItem, UIImageView, WAActivityLabel, WAChatJID, WAImageToImagePanPopGestureRecognizer, WAProfilePictureScrollView;
@protocol WAProfilePictureJID;

@interface WAGroupIconViewController : WAViewController <WASinglePhotoPickerControllerDelegate, WAWebImagePickerDelegate, WAImageToImagePanPopGestureRecognizerDelegate, WANavigationControllerPopFromAnimating>
{
