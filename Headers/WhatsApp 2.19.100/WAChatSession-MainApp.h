...
@class NSArray, NSManagedObjectID, NSString, WAChatJID, WAChatSessionSavedReply, WAChatSessionTransaction;

@interface WAChatSession (MainApp) <WAIndexableManagedObject>
