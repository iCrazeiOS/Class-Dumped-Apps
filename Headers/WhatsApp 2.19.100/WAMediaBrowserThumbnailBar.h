...
@interface WAMediaBrowserThumbnailBar : UIView <UICollectionViewDelegate, WAMediaBrowserThumbnailFlowLayoutDelegate, WAMediaBrowserThumbnailCollectionViewCellDelegate>
{
