...
- (void)dropDatabase;
- (void)dealloc;
- (id)initWithCallLogger:(id)arg1 chatManager:(id)arg2 chatStorage:(id)arg3 localKeyValueStore:(id)arg4 nameDirectory:(id)arg5 sessionManager:(id)arg6 rankingStore:(id)arg7 taskManager:(id)arg8 userDefaults:(id)arg9;
- (id)initWithCallLogger:(id)arg1 chatManager:(id)arg2 chatStorage:(id)arg3 localKeyValueStore:(id)arg4 nameDirectory:(id)arg5 sessionManager:(id)arg6 taskManager:(id)arg7 userDefaults:(id)arg8;
