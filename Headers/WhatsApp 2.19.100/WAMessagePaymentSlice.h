...
@class NSLayoutManager, NSString, NSTextContainer, NSTextStorage, WAPaymentAmountTextContainer, WAWeakTimer, _TtC14MainAppLibrary29WAPaymentTransactionFormatter;
...
@interface WAMessagePaymentSlice : WAMessageContainerSlice
{
    ...
    _TtC14MainAppLibrary29WAPaymentTransactionFormatter *_transactionFormatter;
    _Bool _fromMe;
...
- (id)initWithMessages:(id)arg1 expirationDate:(id)arg2 metrics:(CDStruct_f481d0b7)arg3;
