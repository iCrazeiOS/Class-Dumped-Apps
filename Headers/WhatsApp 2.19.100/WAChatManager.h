...
@interface WAChatManager : NSObject <WAChatStorageDelegate, WAWebClientDelegate, XMPPConnectionDelegate, WASyncManagerDelegate, WAContactsStorageDelegate, WAMessageNotificationCenterDelegate>
{
...
- (void)businessNameVNameCertUpdateFailedWithError:(id)arg1 retryBlock:(CDUnknownBlockType)arg2;
- (void)changeNumberFailedWithError:(id)arg1;
- (void)changeNumberFinished;
- (void)updateBusinessVNameCertWithCompletion:(CDUnknownBlockType)arg1;
- (void)updateBusinessVNameCertWithSyncResult:(unsigned long long)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)webClient:(id)arg1 didSetStatusPrivacyTo:(long long)arg2 userJIDs:(id)arg3;
...
- (void)xmppConnectionDidNotAuthenticate:(id)arg1 dataCenter:(id)arg2 failureCode:(long long)arg3 lockDuration:(double)arg4 retryAfter:(double)arg5 tempBanReasonCode:(long long)arg6;
