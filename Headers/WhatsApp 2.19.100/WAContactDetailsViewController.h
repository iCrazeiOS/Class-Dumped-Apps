...
@interface WAContactDetailsViewController : WAStaticTableViewController <WAContactCardItemTableViewCellDelegate, WANewContactViewControllerDelegate, WAProfilePictureParallaxViewDelegate, WAParticipantPickerViewControllerDelegate, MFMessageComposeViewControllerDelegate>
{
...
- (void)sendInviteMessageToNumber:(id)arg1;
...
- (id)initWithContact:(id)arg1 newContact:(_Bool)arg2;
