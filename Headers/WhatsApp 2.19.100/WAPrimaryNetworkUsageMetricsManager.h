...
- (id)configurationForMediaType:(long long)arg1 transferRadio:(long long)arg2 origin:(long long)arg3 autoDownload:(_Bool)arg4 senderExperimentGroupID:(unsigned long long)arg5;
