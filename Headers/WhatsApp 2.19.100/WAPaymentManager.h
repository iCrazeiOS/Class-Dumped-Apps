...
@interface WAPaymentManager : NSObject <WAPaymentStorageDelegate>
{
    ...
    _TtC14MainAppLibrary22WAPaymentNameDirectory *_paymentNameDirectory;
...
- (void)updateTransaction:(id)arg1 toStatusWithBlock:(CDUnknownBlockType)arg2 save:(_Bool)arg3;
...
@property(readonly, nonatomic) _TtC14MainAppLibrary22WAPaymentNameDirectory *paymentNameDirectory;
...
- (void)dealloc;
- (id)initWithChatManager:(id)arg1 chatStorage:(id)arg2 xmppConnection:(id)arg3 paymentSettings:(id)arg4 persistentKeyValueStore:(id)arg5 persistentRequestManager:(id)arg6;
- (void)cancelIncomingCollectRequestWithTransaction:(id)arg1;
