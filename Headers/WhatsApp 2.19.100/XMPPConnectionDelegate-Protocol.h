...
@class NSArray, NSDate, NSDictionary, NSNumber, NSString, WAChatJID, WAJID, WAUserJID, XMPPCallAckStanza, XMPPCallStanza, XMPPConnection, XMPPMessageStanza, XMPPReceiptStanza;
...
- (void)xmppConnection:(XMPPConnection *)arg1 didReceiveRetryReceiptForStanzaID:(NSString *)arg2 fromJID:(WAJID *)arg3 participantJID:(WAUserJID *)arg4 edit:(long long)arg5 registrationId:(NSNumber *)arg6 retryCount:(unsigned int)arg7;
- (void)xmppConnection:(XMPPConnection *)arg1 didReceiveServerErrorForOutgoingMessagesWithStanzas:(NSArray *)arg2 fromJID:(WAJID *)arg3 participantJID:(WAUserJID *)arg4;
...
- (unsigned long long)xmppConnection:(XMPPConnection *)arg1 statusChanged:(int)arg2 forOutgoingMessagesWithStanzas:(NSArray *)arg3 fromJID:(WAJID *)arg4 participantJID:(WAUserJID *)arg5 userData:(NSDictionary *)arg6;
- (void)xmppConnectionDidDisconnect:(XMPPConnection *)arg1;
- (void)xmppConnectionDidNotAuthenticate:(XMPPConnection *)arg1 dataCenter:(NSString *)arg2 failureCode:(long long)arg3 lockDuration:(double)arg4 retryAfter:(double)arg5 tempBanReasonCode:(long long)arg6;
