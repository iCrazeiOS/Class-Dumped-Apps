...
@class NSArray, NSMutableArray, NSNumber, NSSet, NSString, UIBarButtonItem, UIToolbar, UIView, WAChatCellData, WAChatMessagesController, WAChatMessagesTableView, WAGroupInviteJoinController, WAMessage, WAMessageBubbleTableViewCell, WAMessagePresenterHelper, WAMultiSendMediaItem, WAPaymentBaseHandler, WAPaymentCoordinator, WAProductCatalogPresenter, WAReportSpamCell, WAVCardMatchCell, WAWallpaperView;
@protocol WABlurredBackgroundProviding;

@interface WAChatMessagesViewController : WAViewController <MFMessageComposeViewControllerDelegate, MFMailComposeViewControllerDelegate, WANewContactViewControllerDelegate, WAParticipantPickerViewControllerDelegate, EKEventEditViewDelegate, WAGroupInviteJoinControllerDelegate, WAMessageBubbleTableViewCellDelegate, WAStickerPackViewControllerDelegate, WAChatMessagesControllerDelegate, WAPaymentCoordinatorDelegate, WATableViewCellPreviewingDelegate, WAVCardMessagePreviewActionDelegate, WANavigationControllerPopToAnimating, WAReplyButtonsCellDelegate, WAChatMessagesTableViewDelegate, WACalloutViewPresenterDelegate>
{
...
- (void).cxx_destruct;
- (void)replyButtonsCellDidSendMessageWithButtonData:(id)arg1 forMessage:(id)arg2;
- (void)calloutViewPresenterDidFinish:(id)arg1;
- (struct UIEdgeInsets)overlayInsetsForCalloutViewPresenter:(id)arg1;
- (id)truncateURLStringInTheMiddleIfNeeded:(id)arg1;
...
- (id)viewControllerForContactsInVCardMessage:(id)arg1 forJID:(id)arg2;
...
- (void)callUserJID:(id)arg1 withVideo:(_Bool)arg2;
...
- (void)startPaymentHandlerFlowWithConfiguration:(id)arg1;
- (void)startPaymentCoordinatorFlowWithConfiguration:(id)arg1;
