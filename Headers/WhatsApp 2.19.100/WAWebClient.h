...
@class NSCache, NSDate, NSMutableArray, NSMutableDictionary, NSString, WAChatSessionTransactionListener, WAMutableDictionary, WAPersistentRequestManager, WAWebClientSession, XMPPConnectionMain;
...
- (void)beginNewMDSessionWithQRCode:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (id)outgoingAndPTTMessagesFromMessages:(id)arg1 updatedAfter:(double *)arg2;
