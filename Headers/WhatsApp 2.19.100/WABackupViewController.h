...
@class NSNumber, NSString, UIActivityIndicatorView, UILabel, UISwitch, UITableViewCell, UIView, WABackupInfoTableViewCell, WABackupViewControllerDataProvider;

@interface WABackupViewController : WAWarningViewController <UITableViewDelegate, WABackupViewControllerDataProviderDelegate>
{
