...
- (id)initWithSenderName:(id)arg1 senderNameColor:(id)arg2 hasVerifiedBadge:(_Bool)arg3 pushName:(id)arg4 sourceChatName:(id)arg5 metrics:(CDStruct_f481d0b7)arg6 style:(unsigned long long)arg7;
