...
- (id)initWithMessages:(id)arg1 metrics:(CDStruct_f481d0b7)arg2 attributedText:(id)arg3 maximumNumberOfLines:(long long)arg4 detectHyperlinks:(_Bool)arg5 formatText:(_Bool)arg6 appendReadMoreLinkIfNeeded:(_Bool)arg7;
