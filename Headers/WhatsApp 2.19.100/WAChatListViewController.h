...
#import "WASearchResultsHeaderViewDelegate-Protocol.h"
#import "WASearchResultsMediaTableViewCellDelegate-Protocol.h"
...
@class NSArray, NSIndexPath, NSMutableArray, NSNumber, NSString, NSTimer, UIBarButtonItem, UICollectionView, UIFont, UIView, WAActivityLabel, WAAllChatsArchivedView, WAChatListHeaderCell, WAChatListNavigationController, WAChatListSearchBar, WAChatSession, WAEmptyChatListView, WALoadingTableViewCell, WAMessage, WAMultiSelectBar, WANoResultsView, WAProductCatalogPresenter, WARestoreTableViewCell, WASearchResultsController, WASearchResultsMediaTableViewCell, WAViewControllerConnectionObserver;
@protocol UIViewControllerPreviewing, WAChatListExpandableHeader;

@interface WAChatListViewController : WAChatSessionsViewController <UIViewControllerTransitioningDelegate, UIGestureRecognizerDelegate, UINavigationControllerDelegate, WASearchResultsControllerDelegate, WAPhoneInputViewControllerDelegate, WAChatComposerDelegate, WAEmptyChatListViewDelegate, WAAllChatsArchivedViewDelegate, WAChatListExpandableHeaderDelegate, WASearchControllerDelegate, WATextSharingViewControllerDelegate, WAMultiSendPreviewViewControllerDelegate, WAMultiShotCameraControllerDelegate, WAMultiSelectBarDelegate, WARestorable, WAMultiSendMediaPickerControllerDelegate, WAGIFSearchViewControllerDelegate, WASearchResultsMediaTableViewCellDelegate, WASearchResultsHeaderViewDelegate, WATokenizedSearchBarDelegate, WASearchResultsMessageTableViewCellDelegate, UICollectionViewDelegate, WANewContactViewControllerDelegate, WAContactDetailsViewControllerDelegate, WANavigationItemCustomBackButtonTitle, WANavigationControllerPopToAnimating>
{
    ...
    WALoadingTableViewCell *_noResultsCell;
    WASearchResultsMediaTableViewCell *_mediaResultsCell;
    ...
    unsigned long long _searchResultsControllerType;
...
- (id)phoneNumberFromShortAPILink:(id)arg1;
...
- (void)searchResultsHeaderView:(id)arg1 didTapButtonAtSectionIndex:(long long)arg2;
...
- (_Bool)searchResultsControllerShouldUpdateLazyLoadedRowsAsReload:(id)arg1;
...
- (id)mediaSearchResultsController;
- (id)gallerySearchResultsController;
- (id)emptySearchResultsController;
- (id)defaultSearchResultsController;
...
- (void)searchResultsMediaTableViewCell:(id)arg1 didSelectDocumentType:(long long)arg2;
...
- (void)inviteContactsFromSourceView:(id)arg1;
