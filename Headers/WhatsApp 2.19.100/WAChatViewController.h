...
@interface WAChatViewController : WAChatMessagesViewController <WAChatSessionNotificationViewDelegate, WAChatBarDelegate, WAGIFSearchViewControllerDelegate, WAMentionsSelectorViewDelegate, WAStickerSearchViewControllerDelegate, WADraggablePopUpViewControllerDelegate, WAAutoCompleteSelectorViewDelegate, UIGestureRecognizerDelegate, WAMultiSendMediaPickerControllerDelegate, WAMultiSendPreviewViewControllerDelegate, WAConversationHeaderViewDelegate, WAGroupInfoViewControllerDelegate, WASearchResultsControllerDelegate, UISearchBarDelegate, WAMessageSearchPreparingTextControllerDelegate, WAStatusViewerViewControllerDelegate, WAChatBarCameraPluginDelegate, WAChatBarShareDocumentPluginDelegate, WAChatBarShareContactPluginDelegate, WAChatBarShareLocationPluginDelegate, WANextResponderProvider, UIViewControllerPreviewingDelegate, WANavigationItemCustomBackButtonTitle, WAChatBarMenuPluginDelegate, WAChatBarHelperDelegate, WAPttComponentDelegate>
{
    ...
    WAProductForwardingHelper *_productForwardingHelper;
...
- (void)startStickerAnimationsInVisibleCellsIfNeeded_previewAnimationOnAllStickers:(_Bool)arg1;
