...
@class NSArray, NSMutableArray, NSString, WAAggregateCallEvent, WABizDetailsVerificationLevelCell, WABizInfoTableRow, WABizProfile, WAContact, WAMediaManager, WAName, WAProductCatalogSectionHandler, WATableRow, WATableSection, WAUserJID;

@interface WAContactViewController : WAPictureContainerViewController <UITableViewDelegate, WAContactCardItemTableViewCellDelegate, WANewContactViewControllerDelegate, WAParticipantPickerViewControllerDelegate, WAShareContactViewControllerDelegate>
{
