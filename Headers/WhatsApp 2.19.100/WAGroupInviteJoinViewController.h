...
@class NSArray, NSDate, NSLayoutConstraint, NSString, UIActivityIndicatorView, UIButton, UICollectionView, UIImageView, UILabel, UIStackView, UITapGestureRecognizer, UIView, WAContactGridCellConfiguration, WAExactTimer, WAExpandingTextView, WAExpandingTextViewController, XMPPGroup;
@protocol WAServerDate;

@interface WAGroupInviteJoinViewController : WAViewController <WAGroupInviteJoinUISupport>
{
