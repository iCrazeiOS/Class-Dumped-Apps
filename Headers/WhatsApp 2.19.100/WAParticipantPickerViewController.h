...
@interface WAParticipantPickerViewController : WAViewController <UISearchBarDelegate, WAContactGridViewControllerDataSource, WAContactGridViewControllerDelegate, UITableViewDelegate>
{
    NSArray *_sections;
    NSArray *_actionRows;
