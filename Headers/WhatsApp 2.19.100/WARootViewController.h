...
- (void)qrCodeController:(id)arg1 didRequestError:(id)arg2;
- (void)qrCodeController:(id)arg1 didRequestGroupChatQR:(id)arg2;
- (void)qrCodeController:(id)arg1 didRequestContactQRWithDetails:(id)arg2;
...
- (void)performAfterFinishLaunchingWithCallLogger:(id)arg1 chatStorage:(id)arg2 contactsStorage:(id)arg3 chatManager:(id)arg4 cloudBackupManager:(id)arg5 signalManager:(id)arg6 statusSessionManager:(id)arg7 taskManager:(id)arg8 afterUpgrading:(_Bool)arg9;
- (id)init;
