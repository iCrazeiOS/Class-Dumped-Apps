...
@interface _TtC14MainAppLibrary27WAPaymentNewTransactionData : NSObject
{
...
@property(nonatomic, readonly) NSString *localTransactionId; // @synthesize localTransactionId;
