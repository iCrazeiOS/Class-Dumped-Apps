...
@class AVAssetWriter, AVAssetWriterInput, AVCaptureAudioDataOutput, AVCaptureDeviceInput, AVCaptureMetadataOutput, AVCaptureOutput, AVCaptureSession, AVCaptureVideoDataOutput, NSArray, NSMutableDictionary, NSSet, NSString, UIView, WAAudioActivity;
