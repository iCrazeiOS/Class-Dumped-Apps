...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString, UIActivityIndicatorView, UITableViewCell, WAChatStorage, WADatabaseUsageManager, WADiskUsageCommand, WADiskUsageOverviewCell;
