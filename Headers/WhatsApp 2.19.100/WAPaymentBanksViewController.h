...
@class NSArray, NSString, UIActivityIndicatorView, UITableView, WAActivityLabel, WAPaymentManager, WAViewControllerConnectionObserver;
@protocol WAPaymentBankListItem;

@interface WAPaymentBanksViewController : WAViewController <WASearchControllerDelegate, UITableViewDelegate>
{
