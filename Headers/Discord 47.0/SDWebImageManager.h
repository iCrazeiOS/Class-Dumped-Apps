...
- (_Bool)shouldBlockFailedURLWithURL:(id)arg1 error:(id)arg2 options:(unsigned long long)arg3 context:(struct NSDictionary *)arg4;
...
- (void)storeImage:(id)arg1 imageData:(id)arg2 forKey:(id)arg3 cacheType:(long long)arg4 options:(unsigned long long)arg5 context:(struct NSDictionary *)arg6 completion:(CDUnknownBlockType)arg7;
- (void)safelyRemoveOperationFromRunning:(id)arg1;
- (void)callTransformProcessForOperation:(id)arg1 url:(id)arg2 options:(unsigned long long)arg3 context:(struct NSDictionary *)arg4 originalImage:(id)arg5 originalData:(id)arg6 finished:(_Bool)arg7 progress:(CDUnknownBlockType)arg8 completed:(CDUnknownBlockType)arg9;
...
- (void)callOriginalCacheProcessForOperation:(id)arg1 url:(id)arg2 options:(unsigned long long)arg3 context:(struct NSDictionary *)arg4 progress:(CDUnknownBlockType)arg5 completed:(CDUnknownBlockType)arg6;
...
- (id)cacheKeyForURL:(id)arg1 context:(struct NSDictionary *)arg2;
