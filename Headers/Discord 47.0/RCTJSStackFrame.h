...
@property(readonly, nonatomic) long long collapse; // @synthesize collapse=_collapse;
...
- (id)description;
- (id)toDictionary;
- (id)initWithMethodName:(id)arg1 file:(id)arg2 lineNumber:(long long)arg3 column:(long long)arg4 collapse:(long long)arg5;
