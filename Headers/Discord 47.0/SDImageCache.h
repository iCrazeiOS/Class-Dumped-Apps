...
- (id)queryCacheOperationForKey:(id)arg1 options:(unsigned long long)arg2 context:(struct NSDictionary *)arg3 cacheType:(long long)arg4 done:(CDUnknownBlockType)arg5;
...
- (id)imageFromCacheForKey:(id)arg1 options:(unsigned long long)arg2 context:(struct NSDictionary *)arg3;
- (id)imageFromCacheForKey:(id)arg1;
- (id)imageFromDiskCacheForKey:(id)arg1 options:(unsigned long long)arg2 context:(struct NSDictionary *)arg3;
...
- (id)queryImageForKey:(id)arg1 options:(unsigned long long)arg2 context:(struct NSDictionary *)arg3 cacheType:(long long)arg4 completion:(CDUnknownBlockType)arg5;
