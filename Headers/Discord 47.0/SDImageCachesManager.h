...
- (void)serialQueryImageForKey:(id)arg1 options:(unsigned long long)arg2 context:(struct NSDictionary *)arg3 cacheType:(long long)arg4 completion:(CDUnknownBlockType)arg5 enumerator:(id)arg6 operation:(id)arg7;
...
- (void)concurrentQueryImageForKey:(id)arg1 options:(unsigned long long)arg2 context:(struct NSDictionary *)arg3 cacheType:(long long)arg4 completion:(CDUnknownBlockType)arg5 enumerator:(id)arg6 operation:(id)arg7;
