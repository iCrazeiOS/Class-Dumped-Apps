...
@interface SQPBFranklinAppGetFlowRequest : GPBMessage
{
}
...
@property(nonatomic) _Bool hasInitiationData; // @dynamic hasInitiationData;
@property(nonatomic) _Bool hasRequestContext; // @dynamic hasRequestContext;
@property(copy, nonatomic) NSString *initiationData; // @dynamic initiationData;
