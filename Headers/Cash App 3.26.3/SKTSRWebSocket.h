...
#import <Smooch/NSStreamDelegate-Protocol.h>

@class NSArray, NSInputStream, NSMutableArray, NSMutableData, NSMutableSet, NSOperationQueue, NSOutputStream, NSString, NSURL, NSURLRequest, SKTSRIOConsumerPool;
@protocol OS_dispatch_queue, SKTSRWebSocketDelegate;

@interface SKTSRWebSocket : NSObject <NSStreamDelegate>
{
    ...
    SKTSRWebSocket *_selfRetain;
    NSArray *_requestedProtocols;
    SKTSRIOConsumerPool *_consumerPool;
    _Bool _allowsUntrustedSSLCertificates;
    id <SKTSRWebSocketDelegate> _delegate;
    NSURL *_url;
...
@property(nonatomic) __weak id <SKTSRWebSocketDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
