...
#import "GMSBaseClearcutClient.h"

@class GMSClearcutRequestGenerator;

@interface GMSClearcutClient : GMSBaseClearcutClient
{
...
@property(readonly, nonatomic) GMSClearcutRequestGenerator *requestGenerator; // @synthesize requestGenerator=_requestGenerator;
- (void).cxx_destruct;
