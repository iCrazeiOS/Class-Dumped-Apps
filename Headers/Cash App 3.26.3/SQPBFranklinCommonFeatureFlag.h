...
@interface SQPBFranklinCommonFeatureFlag : GPBMessage
{
}
...
@property(nonatomic) _Bool hasClientDataEnabled; // @dynamic hasClientDataEnabled;
@property(nonatomic) _Bool hasLabel; // @dynamic hasLabel;
@property(nonatomic) _Bool hasName; // @dynamic hasName;
@property(nonatomic) _Bool hasSelectedOptionValue; // @dynamic hasSelectedOptionValue;
