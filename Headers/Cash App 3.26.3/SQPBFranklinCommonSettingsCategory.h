...
@interface SQPBFranklinCommonSettingsCategory : GPBMessage
{
}
...
@property(retain, nonatomic) NSMutableArray *progressBarsArray; // @dynamic progressBarsArray;
@property(readonly, nonatomic) unsigned long long progressBarsArray_Count; // @dynamic progressBarsArray_Count;
