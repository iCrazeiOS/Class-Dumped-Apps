...
@interface SQPBFranklinAppAssignClaimableAssetRequest : GPBMessage
{
}
...
@property(nonatomic) _Bool claimEntireCollection; // @dynamic claimEntireCollection;
@property(nonatomic) _Bool hasClaimEntireCollection; // @dynamic hasClaimEntireCollection;
