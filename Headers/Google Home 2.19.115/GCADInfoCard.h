...
@class GCADInfoCard_Attribution, NSString;

@interface GCADInfoCard : GPBMessage
{
}
...
@property(retain, nonatomic) GCADInfoCard_Attribution *attribution; // @dynamic attribution;
