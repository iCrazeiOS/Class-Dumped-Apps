...
@class HMEE911NetworkService, NSString, NSTimer, UIViewController;
@protocol HMELinkOpener, HMEStructureData, HMEUserData;
...
@interface HMEE911Coordinator : NSObject <HMEE911BottomDrawerContentViewControllerDelegate, HMEE911Coordinator>
{
    ...
    HMEE911NetworkService *_networkService;
...
@property(readonly, nonatomic) HMEE911NetworkService *networkService; // @synthesize networkService=_networkService;
...
- (id)initWithNetworkService:(id)arg1 structureData:(id)arg2 userData:(id)arg3 structureID:(id)arg4 linkOpener:(id)arg5;
