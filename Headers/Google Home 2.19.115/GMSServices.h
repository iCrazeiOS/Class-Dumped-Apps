...
@class GMSAPIClientParameters, GMSDASHConnection, GMSDisplayLink, GMSMapsClearcutClient, GMSNetworkMonitor, GMSServerResourceManager, GMSStyleTableService, GMSSystemClock, GMSTileRequestCoordinator, GMSTileServiceRegistrar, GMSVectorMapSharedResourceCache, GMSVersion, NSCache, NSMutableDictionary, NSString;
