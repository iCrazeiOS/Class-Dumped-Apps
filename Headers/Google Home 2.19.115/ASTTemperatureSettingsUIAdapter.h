...
@class ASTMenuSelectionStreamItem;

@interface ASTTemperatureSettingsUIAdapter : ASTSettingsUIAdapter
{
    ASTMenuSelectionStreamItem *_fahrenheitStreamItem;
    ASTMenuSelectionStreamItem *_celsiusStreamItem;
