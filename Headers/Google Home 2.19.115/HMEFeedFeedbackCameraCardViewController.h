...
@class HMEFeedCheckboxView, HMEFeedFeedbackCameraCardViewModel, HMEFeedRadioButtonPickerView, HMEStatusViewController, MDCMultilineTextField, MDCTextInputControllerOutlinedTextArea, NSLayoutConstraint, NSString, UIImageView, UILabel, UIScrollView, UIStackView, UITapGestureRecognizer, UIView;
...
@property(readonly, nonatomic) UIImageView *feedbackImageView; // @synthesize feedbackImageView=_feedbackImageView;
