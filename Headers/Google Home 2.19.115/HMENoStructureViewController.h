...
@class AnalyticsLogger, HMEModel, HMEStatusViewController, NSArray, NSMutableArray, NSMutableSet, NSString, UIViewController;
@protocol GCAConfigurationFlags, HMELocalDeviceData, HMENoStructureViewControllerDelegate, HMESectionLayout, HMESpacesChipData, HMEUnifiedDeviceData;
