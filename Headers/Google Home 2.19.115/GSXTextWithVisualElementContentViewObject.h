...
@interface GSXTextWithVisualElementContentViewObject : GSXTextContentViewObject <GSXObjectWithVisualElement>
{
...
- (id)initWithTitle:(id)arg1 visualElementID:(int)arg2 visualElementMetadata:(id)arg3;
