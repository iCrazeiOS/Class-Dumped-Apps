...
@class GHKChatQueueContentViewLandscapeLayout, GHKChatQueueContentViewLayout, GHKChatQueueContentViewObjectM1, UIImageView, UILabel;

@interface GHKChatQueueContentViewM1 : GOOBaseContentView
{
    GHKChatQueueContentViewObjectM1 *_object;
