...
@interface CDRMapPricingInformation : GPBMessage
{
}
...
@property(nonatomic) _Bool hasStrikethroughPrice; // @dynamic hasStrikethroughPrice;
...
@property(copy, nonatomic) NSString *strikethroughPrice; // @dynamic strikethroughPrice;
