...
@class CDRFeeEntry, NSMutableArray, NSString;

@interface CDRFeeSectionEntry : GPBMessage
{
}
...
@property(nonatomic) _Bool hasTotalEntry; // @dynamic hasTotalEntry;
@property(copy, nonatomic) NSString *label; // @dynamic label;
@property(retain, nonatomic) CDRFeeEntry *totalEntry; // @dynamic totalEntry;
