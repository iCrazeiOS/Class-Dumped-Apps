...
@class GMSAutocompleteFilter, GMSAutocompleteSessionToken, GMSCoordinateBounds, GMSPlacesClient, NSString;
...
@interface GMSAutocompleteFetcher : NSObject
{
    ...
    unsigned long long _autocompleteBoundsMode;
...
@property(nonatomic) unsigned long long autocompleteBoundsMode; // @synthesize autocompleteBoundsMode=_autocompleteBoundsMode;
...
- (void)configureWithBounds:(id)arg1 filter:(id)arg2 requestSource:(id)arg3;
- (void)provideSessionToken:(id)arg1;
- (id)initWithBounds:(id)arg1 filter:(id)arg2 requestSource:(id)arg3;
