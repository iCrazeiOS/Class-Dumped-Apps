...
@class NSArray, NSMutableSet, NSNumber, NSString, PDLClientConfigInternal, PDLResourceCollector, Reachability;
@protocol OS_dispatch_queue, PDLExperimentsService, PDLMetricsLogger, PDLMetricsTimer, PDLQueryProcessorDelivererDelegate, PDLTopNCacheStatusProvider;
...
- (id)initWithClientConfig:(id)arg1 query:(id)arg2 metricsLogger:(id)arg3 reachability:(id)arg4 setQueryTimer:(id)arg5 querySessionID:(id)arg6 resourceCollector:(id)arg7 topNCacheStatusProvider:(id)arg8 experimentsService:(id)arg9 deliveryQueue:(id)arg10 delegate:(id)arg11 callbacks:(id)arg12;
