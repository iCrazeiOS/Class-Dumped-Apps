...
#import "GCAConfigurationFlags-Protocol.h"

@class AnalyticsLogger, HPHRemoteControlEligibilityConditions, NSArray, NSString, PHTBreakpadDecorator, PHTPhenotypeFlags;
@protocol SSOService;

@interface GCAFlags : NSObject <GCAConfigurationFlags>
{
...
+ (id)sharedInstance;
@property(retain, nonatomic) PHTBreakpadDecorator *phenotypeBreakpadDecorator; // @synthesize phenotypeBreakpadDecorator=_phenotypeBreakpadDecorator;
...
- (void)setCurrentIdentity:(id)arg1 service:(id)arg2;
- (void)enableWithAnalyticsLogger:(id)arg1;
