...
@class GMSx_GMMPostContributionThanksPageParameters, GMSx_GMMSubmitReview2RequestProto_AttachedPhotos, GMSx_GMTTLoggingParams, GMTTSRVisitDetails, NSString;
...
@property(retain, nonatomic) GMTTSRVisitDetails *visitDetails; // @dynamic visitDetails;
