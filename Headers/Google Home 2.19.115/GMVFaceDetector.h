...
+     // Error parsing type: {FaceDetectorOptions=^^?{InternalMetadataWithArenaLite=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{FaceSsdConfig}^{BlazeFaceConfig}^{LandmarkerConfig}BBBfiiiff}24@0:8@16, name: clientOptionsFromDetectorOptions:
+ (id)detector:(id)arg1;
...
-     // Error parsing type: @192@0:8{Face=^^?{ExtensionSet=^{Arena}SS(AllocatedData=^{KeyValue}^{map<int, google::protobuf_opensource::internal::ExtensionSet::Extension, std::__1::less<int>, std::__1::allocator<std::__1::pair<const int, google::protobuf_opensource::internal::ExtensionSet::Extension> > >})}{InternalMetadataWithArenaLite=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<human_sensing::Face_Landmark>=^{Arena}ii^{Rep}}{RepeatedPtrField<human_sensing::Face_Embedding>=^{Arena}ii^{Rep}}{RepeatedPtrField<human_sensing::Face_Attribute>=^{Arena}ii^{Rep}}^{Face_BoundingBox}ffffQQQf}16, name: faceFeatureFromFace:
