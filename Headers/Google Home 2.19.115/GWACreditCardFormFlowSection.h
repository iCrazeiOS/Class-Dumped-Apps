...
@interface GWACreditCardFormFlowSection : NSObject <GOOTextFieldValidator, GWACardScanningViewControllerDelegate, GWAFocusDelegate, GWASummaryViewDelegate, GWACollapsibleFlowSection, GWAMegalogsSupporting>
{
