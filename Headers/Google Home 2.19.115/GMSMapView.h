...
@class CAAnimation, CALayer, CLLocation, GMSBubbleEntityProvider, GMSCameraPosition, GMSCoordinateBounds, GMSDelegateForward, GMSIndoorDisplay, GMSMapLayer, GMSMapStyle, GMSMarker, GMSMarkerDelayedRemovalManager, GMSMarkupProvider, GMSMyLocationProvider, GMSOffscreenEntitiesHostView, GMSProjection, GMSRenderTileProvider, GMSSDKEntityProvider, GMSServices, GMSStickersEntityProvider, GMSUISettings, GMSVectorMapView, GMSx_GMSLSpotlightDescription, NSDate, NSMutableArray, NSMutableSet, NSString, UILongPressGestureRecognizer;
...
- (void)updateMarkerLabeling:(id)arg1;
