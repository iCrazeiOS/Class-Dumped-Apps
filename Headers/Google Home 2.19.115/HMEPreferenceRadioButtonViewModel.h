...
@interface HMEPreferenceRadioButtonViewModel : NSObject <HMEPreferenceMutableViewModel>
{
    _Bool _disabled;
    _Bool _on;
    NSString *_title;
...
@property(readonly, copy, nonatomic) NSString *cellIdentifier; // @synthesize cellIdentifier;
