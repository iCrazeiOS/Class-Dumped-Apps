...
@class AnalyticsLogger, HMECardsViewController, HMEModel, HMEStatusViewController, NSArray, NSCache, NSIndexPath, NSSet, NSString, NSTimer, UIView;
@protocol GCAConfigRegister, GCAConfigurationFlags, HMEAutomationData, HMECastChannelData, HMENowPlayingViewControllerDelegate, HMEStreamTransferData, HMEUnifiedDeviceData;

@interface HMENowPlayingViewController : HMEAppBarViewController <HMEModelObserver, HMECardsViewControllerDataSource, HMECardsViewControllerDelegate, HMENowPlayingPlaySomethingDelegate, HMEChromecastMiniRemoteConfigReloadDelegate, HMEAnalyticsCardIndexProvider>
{
...
- (void)dealloc;
- (id)initWithCastChannelData:(id)arg1 streamTransferData:(id)arg2 unifiedDeviceData:(id)arg3 homeAutomationData:(id)arg4 configRegister:(id)arg5 experimentFlags:(id)arg6 analyticsLogger:(id)arg7;
