...
@class GMSx_GMPCAreaRenderOpGroup, GMSx_GMPCLabelRenderOpGroup, GMSx_GMPCLabelSpriteMap, GMSx_GMPCLineRenderOpGroup, GMSx_GMPCProviderTable, GMSx_GMPCRasterRenderOpGroup, GMSx_GMPCShaderRenderOpGroup, GMSx_GMPCTileOptions, GMSx_GMPCVolumeRenderOpGroup, GMSx_GMUTileCoordinateProto, NSData, NSMutableArray;
