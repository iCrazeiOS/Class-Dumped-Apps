...
@class ASTUIMainPageUi_MainPageLinkTarget, NSString;

@interface ASTUIMainPageUi_MainPageLink : GPBMessage
{
}
...
@property(retain, nonatomic) ASTUIMainPageUi_MainPageLinkTarget *target; // @dynamic target;
