...
@optional
@property(nonatomic) __weak id <JETHalfcourtClientListener> listener;
@property(nonatomic) double timeoutInterval;
- (void)updateWPA3Enabled:(_Bool)arg1 forGroupID:(NSString *)arg2 withCompletion:(void (^)(id, NSError *))arg3;
- (void)updateGuestNetworkPskVisibility:(_Bool)arg1 forGroupID:(NSString *)arg2 withCompletion:(void (^)(GTLRAccesspoints_UpdateGuestNetworkPskVisibilityResponse *, NSError *))arg3;
...
- (void)updateApFeatureEnabledForAP:(NSString *)arg1 featureName:(NSString *)arg2 enabled:(_Bool)arg3 withCompletion:(void (^)(GTLRAccesspoints_UpdateApFeatureEnabledResponse *, NSError *))arg4;
- (void)fetchCompatibleRegionsForGroupID:(NSString *)arg1 completion:(void (^)(NSArray *, NSError *))arg2;
- (void)updateHybridDeviceWithAPID:(NSString *)arg1 meshEnabled:(_Bool)arg2 completion:(void (^)(GTLRAccesspoints_SetHybridDeviceEnabledResponse *, NSError *))arg3;
...
- (void)createAccessPointInGroup:(NSString *)arg1 structureID:(NSString *)arg2 withAPIdentifier:(NSString *)arg3 certificateData:(NSData *)arg4 chainData:(NSData *)arg5 signatureTimestamp:(long long)arg6 signedAPIdentifier:(NSData *)arg7 weaveNodeID:(long long)arg8 completion:(void (^)(NSString *, NSError *))arg9;
...
- (void)updateStadiaPrioritizationInGroup:(NSString *)arg1 enablePrioritization:(_Bool)arg2 withCompletionHandler:(void (^)(GTLRAccesspoints_UpdateStadiaPrioritizationResponse *, NSError *))arg3;
