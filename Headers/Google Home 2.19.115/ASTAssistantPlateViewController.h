...
@class ASTAssistantClient, ASTAssistantPlateHistoryManager, ASTAssistantPlateTransitionController, ASTAssistantPlateView, ASTAssistantPlateViewContext, ASTFullScreenRecognitionView, ASTKeyboardTracker, ASTPlateActionsHandler, ASTSurveyFeedbackView, NSArray, NSLayoutConstraint, NSString, SSOIdentity, UIView;
@protocol ASTAssistantClientExtendedDelegate, ASTAssistantPlateViewControllerDelegate;

@interface ASTAssistantPlateViewController : UIViewController <ASTAssistantClientExtendedDelegate, ASTAudioSessionHolder, ASTConsentViewControllerDelegate, ASTDraggableGestureRecognizerDelegate, ASTKeyboardTrackerDelegate, ASTPlateContentHandler, ASTPlateKeyboardInputHandler, ASTPlateLinkHandler, ASTPlateQueryHandler, ASTSurveyFeedbackViewDelegate, UIViewControllerTransitioningDelegate, ASTAssistantClientDelegate, ASTStyleableContent>
{
...
@property(retain, nonatomic) SSOIdentity *avatarIdentity; // @synthesize avatarIdentity=_avatarIdentity;
