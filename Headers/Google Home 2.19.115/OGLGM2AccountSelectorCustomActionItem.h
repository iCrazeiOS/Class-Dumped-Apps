...
#import "OGLGM2AccountSelectorTextAndImageItem-Protocol.h"
...
@interface OGLGM2AccountSelectorCustomActionItem : NSObject <OGLGM2AccountSelectorTextAndImageItem>
{
    ...
    NSIndexPath *_customActionIndexPath;
...
@property(retain, nonatomic) NSIndexPath *customActionIndexPath; // @synthesize customActionIndexPath=_customActionIndexPath;
