...
@interface NLPSPIntentUpdate : GPBMessage
{
}
...
@property(retain, nonatomic) NSMutableArray *argumentUpdateArray; // @dynamic argumentUpdateArray;
@property(readonly, nonatomic) unsigned long long argumentUpdateArray_Count; // @dynamic argumentUpdateArray_Count;
