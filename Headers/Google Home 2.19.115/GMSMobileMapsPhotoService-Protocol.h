...
@class GMMDeleteReviewPhotoRequest, GMMTactilePhotoTakedownRequest, GMMUserPhotoEditRequestProto, GMMUserPhotosRequestProto, GMSx_GMMPhotoVoteRequest, GMSx_GMMTactilePhotoRequestProto;
...
- (id <GMSNetworkFetcherRequest>)RPCToDeletePhotoWithRequest:(GMMDeleteReviewPhotoRequest *)arg1 handler:(void (^)(GMMDeleteReviewPhotoResponseProto *, NSError *))arg2;
- (void)deletePhotoWithRequest:(GMMDeleteReviewPhotoRequest *)arg1 handler:(void (^)(GMMDeleteReviewPhotoResponseProto *, NSError *))arg2;
@end
