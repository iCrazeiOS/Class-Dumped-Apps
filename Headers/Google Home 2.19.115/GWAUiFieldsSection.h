...
@interface GWAUiFieldsSection : NSObject <GOOTextFieldValidator, GWADependencyGraphComponent, GWAFocusDelegate, GWASelectFieldViewDelegate, GWASummaryViewDelegate, GWAUIFieldDelegate, GWAFlowSection, GWADynamicListExistingSubItemComponent, GWAMegalogsSupporting>
{
    NSArray *_fields;
