...
@interface CDRContactSuggestion : GPBMessage
{
}
...
@property(nonatomic) _Bool hasProfileFifeURL; // @dynamic hasProfileFifeURL;
@property(copy, nonatomic) NSString *name; // @dynamic name;
@property(copy, nonatomic) NSString *profileFifeURL; // @dynamic profileFifeURL;
