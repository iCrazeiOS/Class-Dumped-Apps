...
@class CRPTKeyedOperationQueue, GAZAppInfo, GAZCredentialStore, GAZDateProvider, GAZEnrollmentManager, GAZPromptManager, GAZPromptStore, GAZProtocolManager, GAZWebViewPromptStore, NSData, NSMutableArray, NSMutableDictionary, NSMutableSet, SSOService;
