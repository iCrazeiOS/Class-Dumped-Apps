...
@class NSString, PRMApplicationInfo, PRMBatteryUsageMetric, PRMCPUTimeMetric, PRMCPUUsageMetric, PRMCrashMetric, PRMDroppedFramesEvent, PRMFrameRateMetric, PRMLaunchTimeMetric, PRMMemoryUsageMetric, PRMMetricExtension, PRMMetricKitPayload, PRMNetworkUsageMetric, PRMTimerMetric, PRMTraceMetric, PRMUuidProto;
