...
@class GMSAnalytics, GMSCacheStorageDescriptor, GMSCoreClientParameters, GMSDASHConnection, GMSStyleTableService, GMSx_GPBInt32EnumDictionary, NSMutableDictionary, NSMutableIndexSet, NSString;
...
@interface GMSTileServices : NSObject <GMSTileServiceRegistry>
{
    ...
    GMSx_GPBInt32EnumDictionary *_tileFetchModes;
