...
@class CastCertificate, CastDeviceCapabilities, CastSSIDSuffix, GetDeviceAuthenticationInfoAsyncOperation, GetSupportedTimeZonesRequest, NSArray, NSMutableArray, NSString, NSTimer, ScanForDeviceAsyncOperation, SequentialAsyncOperationQueue, SetupAnalyticsLogger, SetupCastDevice, SetupDeviceScanner, WiFiNetwork;
@protocol LinkedDevicesManager, SetupSessionCountryCodeDelegate, SetupSessionDeviceInfoDelegate, SetupSessionOperationManager, SetupSessionWifiNetworksDelegate;
