...
@interface CDREmptyPageIconAndMessage : GPBMessage
{
}
...
@property(nonatomic) _Bool hasSubMessage; // @dynamic hasSubMessage;
@property(retain, nonatomic) CDRIcon *icon; // @dynamic icon;
@property(copy, nonatomic) NSString *message; // @dynamic message;
@property(copy, nonatomic) NSString *subMessage; // @dynamic subMessage;
