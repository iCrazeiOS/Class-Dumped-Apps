...
@class GMSx_GMMApiParametersProto, GMSx_GMMNavigationSdkParametersProto, NSArray, NSMutableArray;
...
- (void)refetchWithMapIdentifier:(id)arg1;
- (id)styledMapIdentifiers;
- (_Bool)needsRefetch;
