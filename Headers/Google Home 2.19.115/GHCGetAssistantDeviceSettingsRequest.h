...
@interface GHCGetAssistantDeviceSettingsRequest : GPBMessage
{
}
...
@property(nonatomic) _Bool clientProactiveSettingsEnabled; // @dynamic clientProactiveSettingsEnabled;
