...
@class ASTFlexibleHeaderContentView, ASTMenuStreamController, ASTSettingsErrorView, ASTSettingsMenuService, ASTSettingsNavigationSearchView, ASTSettingsUIAdapter, ASTSpinnerView, ASTUISettingsUi, GOOPopoverViewController, MDCAppBar, NSLayoutConstraint, NSString, QTMButton, UIRefreshControl, UIView;
@protocol ASTSettingsViewControllerDelegate;

@interface ASTSettingsViewController : UIViewController <ASTSettingsErrorViewDelegate, ASTSettingsUIController, ASTSettingsUIAdapterDelegate, ASTWebViewControllerDelegate, GOOPopoverViewControllerDelegate, MDCFlexibleHeaderViewLayoutDelegate, UIScrollViewDelegate, ASTThemable, ASTStyleableContent>
{
