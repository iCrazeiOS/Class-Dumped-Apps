...
@class GMSx_GMMMetadataDescription, GMSx_GMMPhotoAttribution, GMSx_GMMPhotoStatistics, GMSx_GSPPHImageKey, GMSx_GSPPHRenderInfo, NSMutableArray;
...
@property(retain, nonatomic) GMSx_GSPPHRenderInfo *renderInfo; // @dynamic renderInfo;
