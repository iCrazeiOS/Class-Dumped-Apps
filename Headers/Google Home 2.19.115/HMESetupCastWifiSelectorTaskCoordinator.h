...
@class HMESetupNavigationController, HMESetupWifiConnectingToNetworkViewController, HMESetupWifiSelectorTaskCoordinator, NSMutableArray, NSString, NSTimer, SetupAnalyticsLogger, SetupSession, UIViewController, WiFiNetwork;
...
@interface HMESetupCastWifiSelectorTaskCoordinator : NSObject <HMESetupWifiSelectorTaskCoordinatorDelegate, HMESetupWifiConnectingToNetworkDelegate, SetupSessionWifiNetworksDelegate, HMESetupCastWifiSelectorTaskCoordinatorProtocol>
{
    ...
    HMESetupWifiSelectorTaskCoordinator *_chooseWifiCoordinator;
...
@property(nonatomic) _Bool passcodeVerificationPassed; // @synthesize passcodeVerificationPassed=_passcodeVerificationPassed;
...
@property(retain, nonatomic) HMESetupWifiSelectorTaskCoordinator *chooseWifiCoordinator; // @synthesize chooseWifiCoordinator=_chooseWifiCoordinator;
