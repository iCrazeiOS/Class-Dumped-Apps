...
+ (id)infoDialog;
+ (id)dialog;
+ (id)cast_errorDialogWithDefaultAcknowledgeAction:(_Bool)arg1;
+ (id)ast_alertViewWithTitle:(id)arg1 description:(id)arg2 descriptionAttributes:(id)arg3 linkDictionary:(id)arg4;
+ (id)ast_alertViewWithTitle:(id)arg1 description:(id)arg2 linkDictionary:(id)arg3;
