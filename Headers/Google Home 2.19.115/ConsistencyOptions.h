...
@class ConsistencyLevelOptions;

@interface ConsistencyOptions : GPBMessage
{
}
...
@property(retain, nonatomic) ConsistencyLevelOptions *levelOptions; // @dynamic levelOptions;
