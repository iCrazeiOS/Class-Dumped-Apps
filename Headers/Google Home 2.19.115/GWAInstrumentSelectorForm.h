...
@interface GWAInstrumentSelectorForm : NSObject <GWAFlowSection, GWASelectorOptionDelegate, GWAForm, GWAResultingComponent, GWATriggerComponent, GWAMegalogsSupporting>
{
