...
@class HMEFeedRecapModuleViewController, NSArray, NSString, UICollectionViewLayout;

@interface HMEFeedSectionedLayoutProvider : NSObject <HMEFeedLayoutProvider, HMESectionedCollectionViewLayoutDelegate>
{
