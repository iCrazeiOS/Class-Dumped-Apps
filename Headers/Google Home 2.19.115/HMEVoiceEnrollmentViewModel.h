...
@interface HMEVoiceEnrollmentViewModel : NSObject <HMESetupCollectionViewModel>
{
    _Bool _hasMultipleLocales;
    HMESetupCollectionLayoutViewController *_parent;
    NSMutableArray *_sections;
}

+ (id)sectionsForDevices:(id)arg1;
@property(readonly, nonatomic) _Bool hasMultipleLocales; // @synthesize hasMultipleLocales=_hasMultipleLocales;
...
@property(readonly, nonatomic) _Bool hasUnenrolledDevices;
