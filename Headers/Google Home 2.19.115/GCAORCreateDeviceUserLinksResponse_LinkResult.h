...
@interface GCAORCreateDeviceUserLinksResponse_LinkResult : GPBMessage
{
}
...
@property(nonatomic) _Bool hasLinkSuccessful; // @dynamic hasLinkSuccessful;
@property(nonatomic) _Bool linkSuccessful; // @dynamic linkSuccessful;
