...
@interface JCVFrameLayoutArgs : GPBMessage
{
}
...
@property(nonatomic) _Bool hasInterceptTouchEvent; // @dynamic hasInterceptTouchEvent;
@property(nonatomic) _Bool hasViewArgs; // @dynamic hasViewArgs;
@property(nonatomic) _Bool interceptTouchEvent; // @dynamic interceptTouchEvent;
