...
@class MDCSnackbarMessageAction, NSAttributedString, NSString, UIColor, UIView;
...
+ (id)hmefeed_undoSnackbarMessageWithUndoBlock:(CDUnknownBlockType)arg1 completionBlock:(CDUnknownBlockType)arg2;
