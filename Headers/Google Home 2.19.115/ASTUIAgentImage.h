...
@interface ASTUIAgentImage : GPBMessage
{
}
...
@property(nonatomic) _Bool hasImageText; // @dynamic hasImageText;
...
@property(copy, nonatomic) NSString *imageText; // @dynamic imageText;
