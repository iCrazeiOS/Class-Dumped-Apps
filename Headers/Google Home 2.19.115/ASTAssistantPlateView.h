...
@property(retain, nonatomic) ASTPlateInputView *inputView; // @synthesize inputView=_inputView;
...
- (void)showContentItem:(id)arg1 header:(_Bool)arg2;
- (void)showContentItem:(id)arg1 exclusively:(_Bool)arg2;
- (void)showContentItem:(id)arg1;
- (void)showContentItem:(id)arg1 margin:(struct UIEdgeInsets)arg2 header:(_Bool)arg3;
