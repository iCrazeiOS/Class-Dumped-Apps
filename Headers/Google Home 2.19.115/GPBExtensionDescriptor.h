...
- (void)dealloc;
- (id)initWithExtensionDescription:(GPBExtensionDescription_b2840997 *)arg1;
- (id)initWithExtensionDescription:(GPBExtensionDescription_b2840997 *)arg1 usesClassRefs:(_Bool)arg2;
