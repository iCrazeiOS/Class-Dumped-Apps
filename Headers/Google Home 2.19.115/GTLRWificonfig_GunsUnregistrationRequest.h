...
@class GTLRWificonfig_GunsPlatformSpecificRegistration, NSString;

@interface GTLRWificonfig_GunsUnregistrationRequest : GTLRObject
{
}
...
@property(copy, nonatomic) NSString *stableDeviceId; // @dynamic stableDeviceId;
@end
