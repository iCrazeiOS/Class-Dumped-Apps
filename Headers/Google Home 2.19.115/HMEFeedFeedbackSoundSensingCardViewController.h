...
@interface HMEFeedFeedbackSoundSensingCardViewController : HMEAppBarViewController
{
    ...
    UIStackView *_bottomButtonsStackView;
...
@property(readonly, nonatomic) UIStackView *bottomButtonsStackView; // @synthesize bottomButtonsStackView=_bottomButtonsStackView;
