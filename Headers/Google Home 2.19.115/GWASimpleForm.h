...
@interface GWASimpleForm : NSObject <GWAForm, GWADependencyGraphComponent, GWADynamicListExistingSubItemComponent, GWAMessageTemplateSupportingComponent, GWAResultingComponent, GWAFlowSection, GWAMegalogsSupporting>
{
    _Bool _isSubForm;
    NSString *_formID;
    NSData *_dataToken;
