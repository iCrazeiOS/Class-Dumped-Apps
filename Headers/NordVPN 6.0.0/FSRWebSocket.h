...
@class FSRIOConsumerPool, NSArray, NSInputStream, NSMutableArray, NSMutableData, NSMutableSet, NSOperationQueue, NSOutputStream, NSString, NSURL, NSURLRequest;
@protocol FSRWebSocketDelegate, OS_dispatch_queue;
...
- (id)initWithURLRequest:(id)arg1 queue:(id)arg2 googleAppID:(id)arg3 andUserAgent:(id)arg4;
- (id)initWithURLRequest:(id)arg1 protocols:(id)arg2;
- (id)initWithURLRequest:(id)arg1 protocols:(id)arg2 queue:(id)arg3 googleAppID:(id)arg4 andUserAgent:(id)arg5;
