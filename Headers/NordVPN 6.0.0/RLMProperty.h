...
@property(nonatomic) Class swiftAccessor; // @synthesize swiftAccessor=_swiftAccessor;
...
@property(nonatomic) _Bool array; // @synthesize array=_array;
@property(nonatomic) _Bool optional; // @synthesize optional=_optional;
@property(copy, nonatomic) NSString *linkOriginPropertyName; // @synthesize linkOriginPropertyName=_linkOriginPropertyName;
