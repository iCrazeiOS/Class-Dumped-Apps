...
@property(nonatomic) _Bool hasIsUserModerationEnabled; // @dynamic hasIsUserModerationEnabled;
...
@property(nonatomic) _Bool isUserModerationEnabled; // @dynamic isUserModerationEnabled;
