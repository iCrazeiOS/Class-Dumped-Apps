...
@class CAGradientLayer, MOPUBActivityIndicatorView, MOPUBPlayerView, MOPUBPlayerViewController, MPExtendedHitBoxButton, NSString, UIActivityIndicatorView, UIImage, UIView;
...
- (void).cxx_destruct;
@property(copy, nonatomic) NSString *overridePrivacyClickUrl; // @synthesize overridePrivacyClickUrl=_overridePrivacyClickUrl;
@property(retain, nonatomic) UIImage *overridePrivacyIconImage; // @synthesize overridePrivacyIconImage=_overridePrivacyIconImage;
@property(copy, nonatomic) NSString *overridePrivacyIcon; // @synthesize overridePrivacyIcon=_overridePrivacyIcon;
...
@property(retain, nonatomic) MPExtendedHitBoxButton *ctaButton; // @synthesize ctaButton=_ctaButton;
@property(retain, nonatomic) MPExtendedHitBoxButton *closeButton; // @synthesize closeButton=_closeButton;
@property(retain, nonatomic) MPExtendedHitBoxButton *privacyButton; // @synthesize privacyButton=_privacyButton;
...
- (void)viewDidLoad;
- (id)initWithVideoPlayer:(id)arg1 nativeAdProperties:(id)arg2 dismissBlock:(CDUnknownBlockType)arg3;
