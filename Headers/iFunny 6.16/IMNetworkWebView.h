...
@class IMRequest, IMResponse, IMWKWebViewController, NSString, NSTimer, NSURLRequest;
...
@property(retain, nonatomic) IMWKWebViewController *networkWebViewController; // @synthesize networkWebViewController=_networkWebViewController;
