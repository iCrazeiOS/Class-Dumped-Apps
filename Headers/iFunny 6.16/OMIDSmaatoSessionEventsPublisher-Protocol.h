...
@class NSDictionary, NSString, OMIDSmaatoAdSessionConfiguration;

@protocol OMIDSmaatoSessionEventsPublisher <NSObject>
...
- (void)publishInitWithConfiguration:(OMIDSmaatoAdSessionConfiguration *)arg1;
@end
