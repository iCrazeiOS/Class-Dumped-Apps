...
@protocol OMIDSmaatoCommandPublisher;

@interface OMIDSmaatoAdSessionStatePublisher : NSObject
{
    id <OMIDSmaatoCommandPublisher> _commandPublisher;
...
@property(readonly, nonatomic) id <OMIDSmaatoCommandPublisher> commandPublisher; // @synthesize commandPublisher=_commandPublisher;
- (void).cxx_destruct;
