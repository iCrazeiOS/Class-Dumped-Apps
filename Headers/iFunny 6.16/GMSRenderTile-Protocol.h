...
#import <Funny/GMSTileEpoch-Protocol.h>
#import <Funny/NSObject-Protocol.h>

@class GMSServerResourceManager, GMSTileCoords, GMSTileType, GMSTileTypeExpirations, NSArray;
@protocol GMSEntityResources, GMSTileDataVersions, GMSTileService;
...
- (_Bool)hasDataVersionMismatchWith:(id <GMSTileDataVersions>)arg1 shouldUseMajorEpoch:(_Bool)arg2;
