...
@protocol SMAAdPresentingDelegate, SMAInterstitialAdPresenterDelegate, SMAViewabilityVideoTracking;

@interface SMAVastInterstitialAdPresenter : NSObject <SMAVastInterstitialDelegate, SMAAdDisplayerDelegate, SMAInterstitialAdPresenting>
{
