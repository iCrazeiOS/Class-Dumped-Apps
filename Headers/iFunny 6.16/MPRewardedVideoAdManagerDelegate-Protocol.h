...
@class MPImpressionData, MPRewardedVideoAdManager, MPRewardedVideoReward, NSData, NSError;
...
- (void)rewardedVideoAdManager:(MPRewardedVideoAdManager *)arg1 didReceiveImpressionEventWithImpressionData:(MPImpressionData *)arg2 adResponseData:(NSData *)arg3;
