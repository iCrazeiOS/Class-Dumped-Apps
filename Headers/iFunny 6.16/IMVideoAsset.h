...
#import <Funny/IMUIVideoViewDelegate-Protocol.h>
#import <Funny/IMVastMediaFileUtilDelegate-Protocol.h>
#import <Funny/IMVastUnwrapperDelegate-Protocol.h>

@class AVPlayer, AVPlayerItem, AVURLAsset, IMMoatNativeVideoViewability, IMOMViewabilityTracker, IMTimerManager, IMUISlider, IMUIVideoProperties, IMVastCompanion, IMVastUnwrapper, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSNumber, NSString, UIColor;
...
@property(retain, nonatomic) NSMutableArray *omidViewableImpressionResources; // @synthesize omidViewableImpressionResources=_omidViewableImpressionResources;
