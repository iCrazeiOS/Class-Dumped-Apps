...
#import <Funny/GADWebAdViewDelegate-Protocol.h>

@class GADAdContent, GADClickProtection, GADObserverCollection, NSArray, NSString;
...
@interface GADOpenActionMonitor : NSObject <GADWebAdViewDelegate>
{
    ...
    id _messageSource;
    NSString *_appStoreIDToOpenInAppStore;
...
- (id)initWithAd:(id)arg1 messageSource:(id)arg2 clickProtection:(id)arg3 analyticsLoggingEnabled:(_Bool)arg4 storeKitParameters:(id)arg5;
