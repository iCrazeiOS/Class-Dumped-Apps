...
#import <Funny/OMIDInmobiJSExecutor-Protocol.h>
#import <Funny/OMIDInmobiJSInvoker-Protocol.h>

@class JSContext, NSString, OMIDInmobiJSNetworkBridge, OMIDInmobiJSTimer;
...
@property(readonly, nonatomic) OMIDInmobiJSNetworkBridge *networkBridge; // @synthesize networkBridge=_networkBridge;
@property(readonly, nonatomic) OMIDInmobiJSTimer *timer; // @synthesize timer=_timer;
