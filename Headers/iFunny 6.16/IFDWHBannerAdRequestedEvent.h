...
@interface IFDWHBannerAdRequestedEvent : IFDWHBaseEvent
{
...
- (id)name;
- (id)initWithType:(unsigned long long)arg1 tier:(id)arg2 status:(unsigned long long)arg3 timeInMilliseconds:(double)arg4 feedType:(long long)arg5 dspCreativeId:(id)arg6 error:(id)arg7;
