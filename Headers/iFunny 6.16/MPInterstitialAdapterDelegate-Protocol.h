...
@class CLLocation, MPBaseInterstitialAdapter, MPInterstitialAdController, NSData, NSError;

@protocol MPInterstitialAdapterDelegate
- (void)interstitialDidReceiveImpressionEventForAdapter:(MPBaseInterstitialAdapter *)arg1;
- (void)interstitialWillLeaveApplicationForAdapter:(MPBaseInterstitialAdapter *)arg1;
- (void)interstitialDidReceiveTapEventForAdapter:(MPBaseInterstitialAdapter *)arg1 adResponseData:(NSData *)arg2;
