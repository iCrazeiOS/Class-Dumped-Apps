...
@interface GMSFloorPickerViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
{
    ...
    double _rowHeight;
    set_3c2611ca _placemarkIconLevelIDs;
    set_3c2611ca _measleLevelIDs;
...
- (void)setMeasleLevelIDs:(const set_3c2611ca *)arg1;
- (void)setPlacemarkIconLevelIDs:(set_3c2611ca *)arg1;
