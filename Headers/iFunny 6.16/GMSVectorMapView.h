...
+ (id)createTilesEntityProviderWithVectorMapView:(id)arg1 tileServiceRegistry:(id)arg2 styleTableService:(id)arg3 tileRequestCoordinator:(id)arg4 clientParameters:(id)arg5 resourceManager:(id)arg6 mapViewFlags:(unsigned long long)arg7 labelsEntityProvider:(id)arg8;
+ (Class)layerClass;
+ (void)initialize;
...
- (struct CGRect)accessibilityFrameForPoints:(const vector_52d06928 *)arg1;
...
- (void)removeBehavior:(reffed_ptr_f31d11c9)arg1;
- (void)addBehavior:(reffed_ptr_f31d11c9)arg1;
...
- (void)dealloc;
- (id)initWithFrame:(struct CGRect)arg1 tileServiceRegistry:(id)arg2 styleTableService:(id)arg3 tileRequestCoordinator:(id)arg4 clientParameters:(id)arg5 resourceManager:(id)arg6 sharedResourceCache:(id)arg7 networkMonitor:(id)arg8 displayLink:(id)arg9 offscreenSink:(id)arg10 flags:(unsigned long long)arg11;
