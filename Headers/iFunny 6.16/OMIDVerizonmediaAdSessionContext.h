...
@class NSArray, NSDictionary, NSString, OMIDVerizonmediaPartner, WKWebView;
...
@property(readonly, nonatomic) OMIDVerizonmediaPartner *partner; // @synthesize partner=_partner;
