...
@protocol OMIDInmobiStateWatcherDelegate;

@interface OMIDInmobiStateWatcher : NSObject
{
    unsigned long long _appState;
    id <OMIDInmobiStateWatcherDelegate> _delegate;
}

+ (id)getInstance;
@property(nonatomic) __weak id <OMIDInmobiStateWatcherDelegate> delegate; // @synthesize delegate=_delegate;
