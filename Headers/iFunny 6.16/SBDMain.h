...
@class NSData, NSMapTable, NSMutableArray, NSMutableDictionary, NSString, NSTimer, SBDReachability, SBDReconnectionConfiguration, SBDReconnectionTask, SBDTimerBoard, SBDUser, SBDWebSocketClient;
...
+ (void)getMyGroupChannelChangeLogsWithToken:(id)arg1 byTimestamp:(long long)arg2 customTypes:(id)arg3 includeEmptyChannel:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
+ (_Bool)hasConnectionCompletionHandler;
...
- (void)_sendCommand:(id)arg1 lazy:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)handleEnterForeground;
- (void)tryToReconnect:(id)arg1;
- (void)reconnectWithTask:(id)arg1 fromError:(_Bool)arg2;
- (void)waitConnectTimeout:(id)arg1;
- (_Bool)isReconnectingFromOnError;
- (id)init;
