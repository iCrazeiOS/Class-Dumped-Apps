...
#import <Funny/IMAssetActionDelegate-Protocol.h>
#import <Funny/IMAssetBuilderDelegate-Protocol.h>
#import <Funny/IMNativeLandingPageProcessorDelegate-Protocol.h>
#import <Funny/IMViewabilityDelegate-Protocol.h>

@class IMAsset, IMMoatNativeViewability, IMMoatWebViewability, IMNativeLandingPageProcessor, IMNativeRenderViewController, IMNativeVideoProperties, IMOMViewabilityTracker, NSArray, NSDictionary, NSMutableArray, NSMutableString, NSNumber, NSString, SKStoreProductViewController, UIColor, UIView;
...
@interface IMNativeRenderController : NSObject <IMAssetActionDelegate, IMAssetBuilderDelegate, IMNativeLandingPageProcessorDelegate, IMViewabilityDelegate>
{
    ...
    _Bool _skipAssetAvailable;
    _Bool _adAttachedToSKStore;
    ...
    NSDictionary *_assetOnClickSKStoreParams;
...
@property(nonatomic) _Bool adAttachedToSKStore; // @synthesize adAttachedToSKStore=_adAttachedToSKStore;
@property(retain, nonatomic) NSNumber *skipDelayOffset; // @synthesize skipDelayOffset=_skipDelayOffset;
@property(nonatomic) _Bool skipAssetAvailable; // @synthesize skipAssetAvailable=_skipAssetAvailable;
...
@property(retain, nonatomic) NSDictionary *assetOnClickSKStoreParams; // @synthesize assetOnClickSKStoreParams=_assetOnClickSKStoreParams;
...
@property(retain, nonatomic) NSMutableArray *friendlyViewsArray; // @synthesize friendlyViewsArray=_friendlyViewsArray;
...
- (void)imActionFoundSKStoreWithParams:(id)arg1;
...
- (_Bool)shouldFailOnZeroGeometryForAsset:(id)arg1;
