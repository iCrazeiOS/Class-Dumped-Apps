...
#import <Funny/GMSPhoenixRenderBinSource-Protocol.h>

@class GMSAnalyticsTimer, GMSDisplayLink, GMSIOSGLContext, GMSScreenInfo, NSString, NSTimer, UIColor, UIImageView;
