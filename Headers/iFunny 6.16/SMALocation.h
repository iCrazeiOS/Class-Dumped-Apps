...
- (id)initWithLatitude:(double)arg1 longitude:(double)arg2 horizontalAccuracy:(double)arg3 timestamp:(id)arg4;
@property(readonly, copy, nonatomic) NSString *locationInSomaFormat;
