...
#import <Funny/AFRKMultipartFormData-Protocol.h>

@class AFRKMultipartBodyStream, NSMutableURLRequest, NSString;

@interface AFRKStreamingMultipartFormData : NSObject <AFRKMultipartFormData>
{
    NSMutableURLRequest *_request;
    AFRKMultipartBodyStream *_bodyStream;
...
@property(retain, nonatomic) AFRKMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
