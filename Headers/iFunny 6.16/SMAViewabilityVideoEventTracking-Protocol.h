...
@class SMAViewabilityVideoProperties;

@protocol SMAViewabilityVideoEventTracking <NSObject>
...
- (void)trackVideoEventStartWithProperties:(SMAViewabilityVideoProperties *)arg1;
- (void)trackVideoEventLoadWithProperties:(SMAViewabilityVideoProperties *)arg1;
@end
