...
#import <Funny/IFProfileMemeExperienceRouterProtocol-Protocol.h>

@class IFRouterFields, NSString, UIViewController;

@interface IFProfileMemeExperienceRouter : IFBaseRouter <IFProfileMemeExperienceRouterProtocol>
{
}
