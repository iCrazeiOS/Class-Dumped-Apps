...
@class NSDictionary, NSString, OMIDInmobiAdSessionConfiguration;

@protocol OMIDInmobiSessionEventsPublisher <NSObject>
...
- (void)publishInitWithConfiguration:(OMIDInmobiAdSessionConfiguration *)arg1;
@end
