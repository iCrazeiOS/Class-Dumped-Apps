...
#import <Funny/MDCBaseTextAreaTextViewDelegate-Protocol.h>
...
@class MDCBaseTextAreaLayout, MDCBaseTextAreaTextView, MDCTextControlAssistiveLabelView, MDCTextControlGradientManager, NSMutableDictionary, NSString, UIFont, UILabel, UITapGestureRecognizer, UITextView, UIView;
