...
#import <Funny/GMSTileFetchingTileObserver.h>
...
@interface GMSIndoorTileObserver : GMSTileFetchingTileObserver
{
    ...
    struct unique_ptr<gmscore::utils::LRUCache<gmscore::model::FeatureID, GMSIndoorBuilding *, std::__1::hash<gmscore::model::FeatureID>, false>, std::__1::default_delete<gmscore::utils::LRUCache<gmscore::model::FeatureID, GMSIndoorBuilding *, std::__1::hash<gmscore::model::FeatureID>, false>>> _buildingCache;
