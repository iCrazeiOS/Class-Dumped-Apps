...
@protocol OMIDVerizonmediaCommandPublisher;

@interface OMIDVerizonmediaAdSessionStatePublisher : NSObject
{
    id <OMIDVerizonmediaCommandPublisher> _commandPublisher;
...
@property(readonly, nonatomic) id <OMIDVerizonmediaCommandPublisher> commandPublisher; // @synthesize commandPublisher=_commandPublisher;
- (void).cxx_destruct;
