...
- (void)adDidCollapseForAdapter:(MPBaseBannerAdapter *)arg1;
- (void)adWillExpandForAdapter:(MPBaseBannerAdapter *)arg1;
- (void)adapterDidTrackImpressionForAd:(MPBaseBannerAdapter *)arg1;
