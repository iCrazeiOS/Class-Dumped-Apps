...
// Property attributes: T^{Group=^^?{SlabAlloc=^^?Q^{Replication}iQ{atomic<unsigned long long>={__cxx_atomic_impl<unsigned long long, std::__1::__cxx_atomic_base_impl<unsigned long long> >=AQ}}{shared_ptr<realm::SlabAlloc::MappedFile>=^{MappedFile}^{__shared_weak_count}}{unique_ptr<std::__1::shared_ptr<const realm::util::File::Map<char> > [], std::__1::default_delete<std::__1::shared_ptr<const realm::util::File::Map<char> > []> >={__compressed_pair<std::__1::shared_ptr<const realm::util::File::Map<char> > *, std::__1::default_delete<std::__1::shared_ptr<const realm::util::File::Map<char> > []> >=^{shared_ptr<const realm::util::File::Map<char> >}}}Q*QQi{unique_ptr<unsigned long [], std::__1::default_delete<unsigned long []> >={__compressed_pair<unsigned long *, std::__1::default_delete<unsigned long []> >=^Q}}QiBi{vector<realm::SlabAlloc::Slab, std::__1::allocator<realm::SlabAlloc::Slab> >=^{Slab}^{Slab}{__compressed_pair<realm::SlabAlloc::Slab *, std::__1::allocator<realm::SlabAlloc::Slab> >=^{Slab}}}{vector<realm::SlabAlloc::Chunk, std::__1::allocator<realm::SlabAlloc::Chunk> >=^{Chunk}^{Chunk}{__compressed_pair<realm::SlabAlloc::Chunk *, std::__1::allocator<realm::SlabAlloc::Chunk> >=^{Chunk}}}{vector<realm::SlabAlloc::Chunk, std::__1::allocator<realm::SlabAlloc::Chunk> >=^{Chunk}^{Chunk}{__compressed_pair<realm::SlabAlloc::Chunk *, std::__1::allocator<realm::SlabAlloc::Chunk> >=^{Chunk}}}B[256{hash_entry=Q*Q}]Q}{Array=^^?^{VTable}*qqQQ^{Allocator}Q^{ArrayParent}QCBBB}{ArrayInteger=^^?^{VTable}*qqQQ^{Allocator}Q^{ArrayParent}QCBBB}{ArrayString=^^?^{VTable}*qqQQ^{Allocator}Q^{ArrayParent}QCBBBB}{vector<realm::Table *, std::__1::allocator<realm::Table *> >=^^{Table}^^{Table}{__compressed_pair<realm::Table **, std::__1::allocator<realm::Table *> >=^^{Table}}}BB{function<void (const realm::Group::CascadeNotification &)>={__value_func<void (const realm::Group::CascadeNotification &)>={type=[24C]}^{__base<void (const realm::Group::CascadeNotification &)>}}}{function<void ()>={__value_func<void ()>={type=[24C]}^{__base<void ()>}}}},R,N
