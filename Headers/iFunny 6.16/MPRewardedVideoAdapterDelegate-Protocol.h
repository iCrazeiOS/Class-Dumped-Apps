...
- (void)rewardedVideoDidTimeoutForAdapter:(MPRewardedVideoAdapter *)arg1 error:(NSError *)arg2;
...
- (void)rewardedVideoDidReceiveImpressionEventForAdapter:(MPRewardedVideoAdapter *)arg1;
