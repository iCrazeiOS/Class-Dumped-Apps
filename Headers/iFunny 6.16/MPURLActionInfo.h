...
@class MPEnhancedDeeplinkRequest, NSDictionary, NSString, NSURL;
...
@property(retain, nonatomic) NSDictionary *iTunesStoreParameters; // @synthesize iTunesStoreParameters=_iTunesStoreParameters;
