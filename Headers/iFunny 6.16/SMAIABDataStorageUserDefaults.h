...
#import <Funny/SMAIABDataStorageProtocol-Protocol.h>

@class NSArray, NSNumber, NSString, NSUserDefaults;
@protocol SMAGDPRDataStorageProtocol;

@interface SMAIABDataStorageUserDefaults : NSObject <SMAIABDataStorageProtocol>
{
    NSUserDefaults *_userDefaults;
    id <SMAGDPRDataStorageProtocol> _gdprStorer;
}

+ (id)sharedInstance;
@property(retain, nonatomic) id <SMAGDPRDataStorageProtocol> gdprStorer; // @synthesize gdprStorer=_gdprStorer;
- (void).cxx_destruct;
@property(readonly, nonatomic) NSUserDefaults *userDefaults; // @synthesize userDefaults=_userDefaults;
@property(retain, nonatomic) NSString *usPrivacyString;
...
- (void)addObserverOnConsentString;
- (id)initWithConsentString:(id)arg1;
