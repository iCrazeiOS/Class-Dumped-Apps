...
@class GMSx_GSPSABooleanValue;

@interface GMSx_GSPSAValue : GMSx_GPBMessage
{
}
...
@property(retain, nonatomic) GMSx_GSPSABooleanValue *booleanValue; // @dynamic booleanValue;
