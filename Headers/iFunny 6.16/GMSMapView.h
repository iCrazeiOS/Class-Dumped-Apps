...
#import <Funny/GMSBubbleEntityProviderDelegate-Protocol.h>
#import <Funny/GMSMapViewOverlay-Protocol.h>
#import <Funny/GMSMyLocationProviderDelegate-Protocol.h>
#import <Funny/GMSRendererDelegate-Protocol.h>
#import <Funny/GMSVectorMapViewDelegate-Protocol.h>

@class CAAnimation, CALayer, CLLocation, GMSBubbleEntityProvider, GMSCameraPosition, GMSCoordinateBounds, GMSDelegateForward, GMSIndoorDisplay, GMSMapLayer, GMSMapStyle, GMSMarker, GMSMarkupProvider, GMSMyLocationProvider, GMSOffscreenEntitiesHostView, GMSProjection, GMSRenderTileProvider, GMSSDKEntityProvider, GMSServices, GMSStickersEntityProvider, GMSUISettings, GMSVectorMapView, GMSx_GMSLSpotlightDescription, NSMutableSet, NSString, UILongPressGestureRecognizer;
@protocol GMSMapViewAllDelegates, GMSMapViewDelegate, GMSMapViewInternalNavSDKDelegate, GMSTileServiceRegistry;
...
- (void)vectorMapView:(id)arg1 didShowNewLabels:(const set_99ab198b *)arg2;
