...
@class NSData, NSDate, NSDictionary, NSError, NSInputStream, NSOutputStream, NSRecursiveLock, NSSet, NSString, NSURLConnection, NSURLCredential, NSURLRequest, NSURLResponse;

@interface AFRKURLConnectionOperation : NSOperation <NSURLConnectionDelegate, NSURLConnectionDataDelegate, NSCoding, NSCopying>
{
    NSDate *startTime;
    NSDate *responseTime;
    NSDate *finishTime;
...
@property(readonly, nonatomic) long long ttfb;
