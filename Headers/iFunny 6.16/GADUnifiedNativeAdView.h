...
#import <Funny/GADNativeAdViewOverlayProtocol-Protocol.h>

@class GADAdChoicesView, GADEventContext, GADMediaView, GADNativeAssetViewTracker, GADObserverCollection, GADOverlayView, GADUnifiedNativeAd, NSArray, NSDictionary, NSString;
