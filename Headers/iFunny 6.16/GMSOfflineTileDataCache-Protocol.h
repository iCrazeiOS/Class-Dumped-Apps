...
- (void)loadTileForTileCoords:(GMSTileCoords *)arg1 dataVersion:(int)arg2 supportsVersionID:(_Bool)arg3 completionHandler:(void (^)(_Bool, NSData *, NSString *, unsigned long long, int, int, long long))arg4;
