...
- (unsigned long long)setLines:(id)arg1 styleTable:(id)arg2 tappable:(_Bool)arg3 priority:(unsigned int)arg4 itemID:(unsigned long long)arg5 tapPriority:(struct GMSEntityTapPriority)arg6 minZoom:(float)arg7;
...
- (unsigned long long)setPolyline:(const vector_52d06928 *)arg1 style:(const vector_c36147bd *)arg2 textureImage:(id)arg3 width:(float)arg4 revealOptions:(struct MarkupRevealOptions)arg5 tappable:(_Bool)arg6 priority:(unsigned int)arg7 itemID:(unsigned long long)arg8 tapPriority:(struct GMSEntityTapPriority)arg9;
