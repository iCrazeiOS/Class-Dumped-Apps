...
@class NSArray, NSSet, NSURL, SBFolder, SBIcon, SBIconView, UIColor, UITargetedDragPreview, UITouch, UIView, UIView<SBIconAccessoryView>, UIView<SBIconLabelAccessoryView>, UIView<SBReusableView>;
