...
@class NSDate, NSHashTable, NSString, SBBestAppSuggestion, SBCloseBoxView, SBFParallaxSettings, SBFolderIconBackgroundView, SBIcon, SBIconImageCrossfadeView, SBIconImageView, UIColor, UIDragInteraction, UIGestureRecognizer, UITapGestureRecognizer, UIView<SBIconAccessoryView>, UIView<SBIconLabelAccessoryView>, UIView<SBIconLabelView>, UIViewPropertyAnimator, _UILegibilitySettings;
