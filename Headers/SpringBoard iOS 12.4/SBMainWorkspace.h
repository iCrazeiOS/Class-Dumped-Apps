...
@class BKSEventFocusDeferralProperties, BSEventQueueLock, BSWatchdog, FBDisplayLayoutTransition, FBSceneManager, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSSet, NSString, SBAlertManager, SBAppStatusBarSettingsAssertion, SBHomeGestureArbiter, SBIdleTimerCoordinatorHelper, SBMainAlertManager, SBOrientationAggdLogger, SBWorkspaceTransaction;
