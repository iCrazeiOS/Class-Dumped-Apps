...
@class NSString, SBAppLayout, SBAppSwitcherPageView, SBAppSwitcherSettings, SBFailureNotifyingTapGestureRecognizer, SBFluidBehaviorSettings, SBFluidSwitcherIconOverlayView, SBFluidSwitcherItemContainerHeaderView, SBSwitcherCardCloseBox, UILongPressGestureRecognizer, UIScrollView, UISwipeGestureRecognizer, UITapGestureRecognizer, UIView<SBAppSwitcherPageContentView>;
