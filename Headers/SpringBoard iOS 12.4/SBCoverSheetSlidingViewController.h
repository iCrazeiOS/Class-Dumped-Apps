...
@class NSObject<OS_dispatch_group>, NSString, SBCoverSheetPositionView, SBCoverSheetSystemGesturesDelegate, SBCoverSheetTransitionSettings, SBHomeGestureSettings, SBLockScreenSettings, SBScreenEdgePanGestureRecognizer, UIViewController<SBCoverSheetSlidingViewControllerContentViewController>, UIViewFloatAnimatableProperty;
