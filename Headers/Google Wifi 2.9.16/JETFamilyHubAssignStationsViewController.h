...
@class GOONavigationStyle, JETAccessPointGroup, JETFamilyHubAssignStationsView, JETFamilyHubHelper, JETFamilyHubStationSelectionViewController, NSSet, NSString, UIScrollView, UIView;
@protocol JETUserStateProtocol;

@interface JETFamilyHubAssignStationsViewController : UIViewController <GOONavigationCustomization, JETFamilyHubAssignStationsViewDelegate>
{
...
- (void).cxx_destruct;
- (unsigned long long)maximumStationSetID;
- (void)returnToLanding;
- (void)showFindDeviceFlow;
- (id)siteBlockingParentViewController;
- (_Bool)isInBlockingSetupFlow;
- (void)stationSelectionDidFinish;
- (_Bool)isInSetupScheduleFlow;
- (void)viewDidLoad;
- (void)loadView;
@property(readonly, nonatomic) GOONavigationStyle *navigationStyle;
- (id)initWithCoder:(id)arg1;
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;
- (id)initWithUserState:(id)arg1 group:(id)arg2 setName:(id)arg3;
