...
- (id)setData:(id)arg1 forDomain:(id)arg2 andKey:(id)arg3 accessGroup:(id)arg4 synchronizable:(_Bool)arg5;
- (id)setString:(id)arg1 forDomain:(id)arg2 andKey:(id)arg3 accessGroup:(id)arg4;
