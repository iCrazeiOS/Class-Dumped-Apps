...
@class GMSx_GIPLogCallstack, NSDictionary, NSError, NSString;

@interface GMSx_GIPLogMetadata : NSObject <NSCopying>
{
...
@property(readonly, nonatomic) GMSx_GIPLogCallstack *callstack;
