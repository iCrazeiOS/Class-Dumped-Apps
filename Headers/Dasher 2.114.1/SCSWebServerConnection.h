...
@class NSData, NSString, SCSWebServer, SCSWebServerHandler, SCSWebServerRequest, SCSWebServerResponse;

@interface SCSWebServerConnection : NSObject
{
    SCSWebServer *_server;
    ...
    SCSWebServerRequest *_request;
    SCSWebServerHandler *_handler;
    struct __CFHTTPMessage *_responseMessage;
    SCSWebServerResponse *_response;
...
@property(readonly, nonatomic) SCSWebServer *server; // @synthesize server=_server;
- (void).cxx_destruct;
- (void)dealloc;
