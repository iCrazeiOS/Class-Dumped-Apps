...
#import <NavigationFramework/GMSx_MDCFloatingButton.h>
...
@interface GMSx_AZFloatingButton : GMSx_MDCFloatingButton <GMCSClientVisualElement, AZButtonElevationConfigurable>
{
    int _veType;
}
