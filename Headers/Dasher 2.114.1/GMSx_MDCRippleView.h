...
#import <NavigationFramework/MDCRippleLayerDelegate-Protocol.h>

@class CAShapeLayer, GMSx_MDCRippleLayer, NSString, UIColor;
@protocol MDCRippleViewDelegate;

@interface GMSx_MDCRippleView : UIView <CALayerDelegate, MDCRippleLayerDelegate>
{
    _Bool _usesSuperviewShadowLayerAsMask;
    GMSx_MDCRippleLayer *_activeRippleLayer;
...
@property(retain, nonatomic) GMSx_MDCRippleLayer *activeRippleLayer; // @synthesize activeRippleLayer=_activeRippleLayer;
