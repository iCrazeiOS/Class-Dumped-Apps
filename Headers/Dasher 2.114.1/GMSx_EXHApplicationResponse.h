...
@class GMSx_EXHConfigurationTier, GMSx_EXHScope, GMSx_GPBInt32Array, NSData, NSMutableArray, NSString;

@interface GMSx_EXHApplicationResponse : GMSx_GPBMessage
{
}
...
@property(retain, nonatomic) GMSx_GPBInt32Array *clientExperimentIdArray; // @dynamic clientExperimentIdArray;
@property(readonly, nonatomic) unsigned long long clientExperimentIdArray_Count; // @dynamic clientExperimentIdArray_Count;
@property(retain, nonatomic) GMSx_EXHConfigurationTier *configTier; // @dynamic configTier;
