...
@class GMSx_EXHExperimentIds, GMSx_GPBInt32Array, GMSx_NetworkConnectionInfo, NSData, NSString;

@interface GMSx_LogEvent : GMSx_GPBMessage
{
}
...
@property(retain, nonatomic) GMSx_EXHExperimentIds *experimentIds; // @dynamic experimentIds;
@property(retain, nonatomic) GMSx_GPBInt32Array *genericDimensionsArray; // @dynamic genericDimensionsArray;
...
@property(retain, nonatomic) GMSx_NetworkConnectionInfo *networkConnectionInfo; // @dynamic networkConnectionInfo;
...
@property(retain, nonatomic) GMSx_GPBInt32Array *testCodeArray; // @dynamic testCodeArray;
