...
#import <NavigationFramework/GOOGroupedCell-Protocol.h>
#import <NavigationFramework/NICell-Protocol.h>
#import <NavigationFramework/NIGroupedCellAppearance-Protocol.h>

@class NSString, UIView;
@protocol GOOContentView;

@interface GMSx_GOOCardTableViewCell : UITableViewCell <GOOGroupedCell, NICell, NIGroupedCellAppearance>
{
