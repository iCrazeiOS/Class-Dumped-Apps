...
#import <NavigationFramework/GMSUserEvent3Logging-Protocol.h>
...
- (void)prepareImpressionEvent:(id)arg1;
...
- (id)addPrimaryUserAction:(int)arg1 ei:(id)arg2 ved:(id)arg3 veType:(int)arg4 uiState:(id)arg5 cardinalDirection:(int)arg6 params:(id)arg7 mapsData:(id)arg8;
...
- (id)addUserInteraction:(int)arg1 ve:(id)arg2 veType:(int)arg3 mapsData:(id)arg4 params:(id)arg5 fprintve:(id)arg6;
...
- (id)addUserInteraction:(int)arg1 ve:(id)arg2 veType:(int)arg3 mapsData:(id)arg4;
