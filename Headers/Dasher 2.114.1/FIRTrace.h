...
@class FPRClient, FPRCounterList, FPRTraceBackgroundActivityTracker, NSArray, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSString;
...
@property(retain, nonatomic) FPRClient *fprClient; // @synthesize fprClient=_fprClient;
