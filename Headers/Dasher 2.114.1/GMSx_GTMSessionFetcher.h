...
#import <NavigationFramework/NSURLSessionDelegate-Protocol.h>

@class GMSx_GTMSessionUploadFetcher, NSArray, NSData, NSDate, NSDictionary, NSError, NSHTTPCookieStorage, NSMutableData, NSMutableDictionary, NSMutableURLRequest, NSOperationQueue, NSString, NSTimer, NSURL, NSURLCredential, NSURLRequest, NSURLResponse, NSURLSession, NSURLSessionConfiguration, NSURLSessionTask;
