...
@class NSDate, NSDictionary, NSNumber, NSString, STPPaymentIntentSourceAction;
...
@interface STPPaymentIntent : NSObject <STPAPIResponseDecodable>
{
    ...
    STPPaymentIntentSourceAction *_nextSourceAction;
...
+ (id)stringFromSourceActionType:(unsigned long long)arg1;
+ (unsigned long long)sourceActionTypeFromString:(id)arg1;
...
@property(retain, nonatomic) STPPaymentIntentSourceAction *nextSourceAction; // @synthesize nextSourceAction=_nextSourceAction;
