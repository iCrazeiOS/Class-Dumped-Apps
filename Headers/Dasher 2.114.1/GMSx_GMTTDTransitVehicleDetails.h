...
@class GMSx_GMTTDRenderableComponent, GMSx_GMTTDTransitStopProto, GMSx_GSPDDuration, NSMutableArray, NSString;
...
@property(retain, nonatomic) NSMutableArray *vehicleCategoryNameArray; // @dynamic vehicleCategoryNameArray;
@property(readonly, nonatomic) unsigned long long vehicleCategoryNameArray_Count; // @dynamic vehicleCategoryNameArray_Count;
