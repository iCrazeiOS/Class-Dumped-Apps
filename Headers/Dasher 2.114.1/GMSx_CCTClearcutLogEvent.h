...
@class GMSx_GPBInt32Array, GMSx_GPBMessage, GMSx_NetworkConnectionInfo, NSArray, NSData, NSMutableArray, NSString;

@interface GMSx_CCTClearcutLogEvent : NSObject <NSCopying>
{
    ...
    GMSx_NetworkConnectionInfo *_networkConnectionInfo;
    NSString *_testID;
...
@property(copy, nonatomic) GMSx_NetworkConnectionInfo *networkConnectionInfo; // @synthesize networkConnectionInfo=_networkConnectionInfo;
...
@property(retain, nonatomic) GMSx_GPBMessage *extension; // @synthesize extension=_extension;
...
@property(readonly, nonatomic) GMSx_GPBInt32Array *testCodes; // @synthesize testCodes=_testCodes;
...
@property(readonly, nonatomic) GMSx_GPBInt32Array *experimentIDs; // @synthesize experimentIDs=_experimentIDs;
