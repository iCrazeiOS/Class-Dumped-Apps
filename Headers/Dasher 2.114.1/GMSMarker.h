...
#import <NavigationFramework/GMSOverlay.h>
...
@interface GMSMarker : GMSOverlay <CALayerDelegate, GMSEntityTappableUIItem>
{
    ...
    shared_ptr_9916a073 _labelableFeature;
...
@property(nonatomic) shared_ptr_9916a073 labelableFeature; // @synthesize labelableFeature=_labelableFeature;
