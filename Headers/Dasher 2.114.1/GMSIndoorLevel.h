...
- (id)initWithIndoorID:(struct GMSFeatureID)arg1 enclosingBuildingIDs:(id)arg2 name:(id)arg3 shortName:(id)arg4 elevation:(int)arg5 relativeElevation:(int)arg6 minRenderingZoom:(int)arg7;
