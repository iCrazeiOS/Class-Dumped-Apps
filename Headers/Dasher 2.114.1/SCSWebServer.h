...
@protocol OS_dispatch_group, OS_dispatch_queue, OS_dispatch_source, SCSWebServerDelegate;

@interface SCSWebServer : NSObject
{
    id <SCSWebServerDelegate> _delegate;
...
@property(nonatomic) id <SCSWebServerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)stop;
