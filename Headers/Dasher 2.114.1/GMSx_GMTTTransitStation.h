...
@property(nonatomic) int departureBoardMetadataIndex; // @dynamic departureBoardMetadataIndex;
...
@property(nonatomic) _Bool hasDepartureBoardMetadataIndex; // @dynamic hasDepartureBoardMetadataIndex;
...
@property(retain, nonatomic) NSMutableArray *polylineSegmentArray; // @dynamic polylineSegmentArray;
@property(readonly, nonatomic) unsigned long long polylineSegmentArray_Count; // @dynamic polylineSegmentArray_Count;
