...
#import <NavigationFramework/GMSFeatureWithServerID-Protocol.h>
...
+ (id)createFromPOI:(id)arg1 absolutePositions:(vector_adfa1f2f *)arg2 primaryLabelGroup:(struct LabelGroup *)arg3 secondaryLabelGroup:(struct LabelGroup *)arg4 relativePositions:(vector_0dce662e *)arg5 rank:(short)arg6 veType:(int)arg7;
