...
@class GMSx_CCTClearcutFlags, GMSx_CCTClearcutMetaLogger, GMSx_CCTLogWriter, GMSx_GIPPseudonymousIDStore, GMSx_GTMSessionFetcher, NSError, NSHashTable, NSMutableArray, NSMutableDictionary, NSURL;
@protocol CCTClearcutAuthorizer, CCTClockProtocol, CCTLogRequestFilter, CCTUploaderLock, CCTUploaderLockProvider, GMSx_PHTPhenotype, NSObject, OS_dispatch_queue, OS_dispatch_source;

@interface GMSx_CCTClearcutUploader : NSObject
{
    ...
    id <GMSx_PHTPhenotype> _phenotype;
    ...
    GMSx_GTMSessionFetcher *_currentFetcher;
    NSError *_lastError;
    long long _startUploadTimeMilliseconds;
    NSObject<OS_dispatch_source> *_collectForDebugTimer;
    GMSx_CCTClearcutMetaLogger *_metaLogger;
}

+ (void)crashIfNecessary;
+ (void)crashIfMultipleUploadersInstantiated;
- (void).cxx_destruct;
@property(retain, nonatomic) GMSx_CCTClearcutMetaLogger *metaLogger; // @synthesize metaLogger=_metaLogger;
...
@property(retain, nonatomic) GMSx_GTMSessionFetcher *currentFetcher; // @synthesize currentFetcher=_currentFetcher;
...
@property(readonly, nonatomic) id <GMSx_PHTPhenotype> phenotype; // @synthesize phenotype=_phenotype;
...
@property(readonly, nonatomic) GMSx_GIPPseudonymousIDStore *pseudonymousIDStore; // @synthesize pseudonymousIDStore=_pseudonymousIDStore;
...
@property(readonly, nonatomic) GMSx_CCTLogWriter *logWriter; // @synthesize logWriter=_logWriter;
