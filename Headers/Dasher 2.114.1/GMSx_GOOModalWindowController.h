...
@class GMSx_GOOModalWindowViewController, UIWindow;

@interface GMSx_GOOModalWindowController : NSObject
{
    UIWindow *_displacedKeyWindow;
    UIWindow *_window;
    GMSx_GOOModalWindowViewController *_modalViewController;
}

+ (id)sharedController;
- (void).cxx_destruct;
@property(retain, nonatomic) GMSx_GOOModalWindowViewController *modalViewController; // @synthesize modalViewController=_modalViewController;
