...
@class CAGradientLayer, GMSIndoorBuilding, GMSIndoorState, NSSet, NSString, UIColor, UIFont, UIImage, UITableView, UIView;
...
@interface GMSFloorPickerViewController : UIViewController <GMSIndoorStateListener, UITableViewDataSource, UITableViewDelegate>
{
    ...
    double _rowHeight;
    NSSet *_placemarkIconLevelIDs;
    NSSet *_measleLevelIDs;
...
- (void)setMeasleLevelIDs:(id)arg1;
- (void)setPlacemarkIconLevelIDs:(id)arg1;
