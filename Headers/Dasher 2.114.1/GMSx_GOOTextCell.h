...
#import <NavigationFramework/GMSx_NITextCell.h>

#import <NavigationFramework/GOOGroupedCell-Protocol.h>

@class GMSx_NIAttributedLabel, NSString;

@interface GMSx_GOOTextCell : GMSx_NITextCell <GOOGroupedCell>
{
    struct UIEdgeInsets _textInsets;
    GMSx_NIAttributedLabel *_attributedTextLabel;
    GMSx_NIAttributedLabel *_attributedDetailTextLabel;
