...
@class GMSx_ClientInfo, GMSx_CollectForDebug, NSMutableArray, NSString;

@interface GMSx_LogRequest : GMSx_GPBMessage
{
}
...
@property(retain, nonatomic) GMSx_CollectForDebug *collectForDebug; // @dynamic collectForDebug;
