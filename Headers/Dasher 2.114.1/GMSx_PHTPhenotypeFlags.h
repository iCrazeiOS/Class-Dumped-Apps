...
#import <NavigationFramework/PHTPhenotypeFlagsProtocol-Protocol.h>

@class GMSx_PHTPhenotypeExperimentTokens, GMSx_PHTPhenotypeFlagsSnapshot, NSCondition, NSHashTable, NSString;
@protocol GMSx_PHTPhenotype;

@interface GMSx_PHTPhenotypeFlags : NSObject <PHTPhenotypeFlagsProtocol>
{
    ...
    GMSx_PHTPhenotypeFlagsSnapshot *_atomicSnapshot;
}

- (void).cxx_destruct;
@property(retain) GMSx_PHTPhenotypeFlagsSnapshot *atomicSnapshot; // @synthesize atomicSnapshot=_atomicSnapshot;
