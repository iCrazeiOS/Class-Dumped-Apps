...
@interface GMSRenderTileProvider : NSObject
{
    ...
    shared_ptr_9addc998 _defaultLabelSource;
...
- (id)findOrRequestParentForCoords:(id)arg1 isNavigation:(_Bool)arg2 fallbackCoords:(id *)arg3;
- (void)requestTile:(id)arg1;
- (shared_ptr_9addc998)labelSourceForTileService:(id)arg1 unlimited:(_Bool)arg2 differentiator:(unsigned long long)arg3;
...
@property(readonly, nonatomic) shared_ptr_9addc998 defaultLabelSource;
