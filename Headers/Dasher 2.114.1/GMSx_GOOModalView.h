...
#import <NavigationFramework/GOOModalPresentation-Protocol.h>
#import <NavigationFramework/UIGestureRecognizerDelegate-Protocol.h>

@class GMSx_GOODialogView, NSString, UIButton, UIColor, UIFont;

@interface GMSx_GOOModalView : UIView <UIGestureRecognizerDelegate, GOOModalPresentation>
{
    ...
    id _target;
    id _userObject;
    GMSx_GOODialogView *_dialogView;
}

+ (void)applyContainerShadowToLayer:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) GMSx_GOODialogView *dialogView; // @synthesize dialogView=_dialogView;
