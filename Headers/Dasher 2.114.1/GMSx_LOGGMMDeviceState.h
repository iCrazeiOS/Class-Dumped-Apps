...
@property(nonatomic) _Bool hasSupportsVertexTextureFetching; // @dynamic hasSupportsVertexTextureFetching;
@property(retain, nonatomic) GMSx_LOGGMMNetworkState *networkState; // @dynamic networkState;
@property(nonatomic) _Bool supportsVertexTextureFetching; // @dynamic supportsVertexTextureFetching;
