...
#import <NavigationFramework/GMSx_CCTClearcutLogger-Protocol.h>

@class GMSx_GIPPseudonymousIDStore, NSArray, NSString, NSURL;
@protocol CCTClockProtocol;

@interface GMSx_CCTClearcutLogger : NSObject <GMSx_CCTClearcutLogger>
{
    _Bool _isAnonymous;
    int _qosTier;
