...
#import <NavigationFramework/GMSObjectDataCache-Protocol.h>
...
@interface GMSObjectDataCache : NSObject <GMSObjectDataCache>
{
    ...
    // Error parsing type: {atomic<int>="__a_"{__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >="__a_value"Ai}}, name: _deleteObjectDataCachePendings
