...
@class GMSx_GIPLogCallstack, GMSx_GIPLogMetadata, NSDictionary, NSString;

@interface GMSx_GIPLogMessage : NSObject <NSCopying>
{
    ...
    GMSx_GIPLogCallstack *_callstack;
    NSDictionary *_safeParameters;
    GMSx_GIPLogMetadata *_logMetadata;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) GMSx_GIPLogMetadata *logMetadata; // @synthesize logMetadata=_logMetadata;
@property(readonly, nonatomic) NSDictionary *safeParameters; // @synthesize safeParameters=_safeParameters;
@property(readonly, nonatomic) GMSx_GIPLogCallstack *callstack; // @synthesize callstack=_callstack;
