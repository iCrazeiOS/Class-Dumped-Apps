...
@class GMSx_GPBEnumArray, GMSx_GPBInt32Array, NSMutableArray, NSString;

@interface GMSx_PHTApplicationInfo : GMSx_GPBMessage
{
}
...
@property(retain, nonatomic) GMSx_GPBEnumArray *logSourceArray; // @dynamic logSourceArray;
...
@property(retain, nonatomic) GMSx_GPBInt32Array *weakExperimentIdArray; // @dynamic weakExperimentIdArray;
