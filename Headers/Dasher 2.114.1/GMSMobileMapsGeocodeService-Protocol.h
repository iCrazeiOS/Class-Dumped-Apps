...
@class GMMGetGeocodeExhaustiveSearchRequest, GMMTactileGeocodeRequestProto, GMMTactileLocationDetailsRequestProto, GMMTactileRevealRequestProto, GMSx_GMMReverseGeocodeRequestProto;
...
- (id <GMSNetworkFetcherRequest>)RPCToGetExhaustiveSearchWithRequest:(GMMGetGeocodeExhaustiveSearchRequest *)arg1 handler:(void (^)(GMMGetGeocodeExhaustiveSearchResponse *, NSError *))arg2;
- (void)getExhaustiveSearchWithRequest:(GMMGetGeocodeExhaustiveSearchRequest *)arg1 handler:(void (^)(GMMGetGeocodeExhaustiveSearchResponse *, NSError *))arg2;
@end
