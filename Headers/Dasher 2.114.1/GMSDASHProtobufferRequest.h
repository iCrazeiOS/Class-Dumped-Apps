...
- (void).cxx_destruct;
@property(nonatomic) _Bool bypassResponseHooks; // @synthesize bypassResponseHooks=_bypassResponseHooks;
@property(nonatomic) _Bool bypassRequestHooks; // @synthesize bypassRequestHooks=_bypassRequestHooks;
...
@property(retain, nonatomic) GMSx_GPBExtensionRegistry *extensionRegistry; // @synthesize extensionRegistry=_extensionRegistry;
@property(retain, nonatomic) GMSx_GPBMessage *protobuffer; // @synthesize protobuffer=_protobuffer;
