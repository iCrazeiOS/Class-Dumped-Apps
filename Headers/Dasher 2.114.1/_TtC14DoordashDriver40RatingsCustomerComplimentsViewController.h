...
@interface _TtC14DoordashDriver40RatingsCustomerComplimentsViewController : UIViewController
{
    // Error parsing type: , name: interactor
    // Error parsing type: , name: customerCompliments
    // Error parsing type: , name: $__lazy_storage_$_headerView
    // Error parsing type: , name: $__lazy_storage_$_seeAllHeader
