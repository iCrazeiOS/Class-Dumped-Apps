...
@class GMSx_PHTPhenotypeFlags, NSMutableDictionary, NSString;

@interface GMSx_CCTClearcutFlags : NSObject
{
    GMSx_PHTPhenotypeFlags *_allFlags;
...
- (void)update;
@property(readonly) GMSx_PHTPhenotypeFlags *allFlags;
