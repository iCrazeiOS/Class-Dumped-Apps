...
- (void)gmcs_attachToClass:(Class)arg1 secondaryTarget:(id)arg2 tapSelector:(SEL)arg3;
- (id)gmcs_attachToObject:(id)arg1 secondaryTarget:(id)arg2 tapSelector:(SEL)arg3;
