...
#import <NavigationFramework/GIPLogAppControl-Protocol.h>
#import <NavigationFramework/GIPLogMultiplexing-Protocol.h>

@class GMSx_GIPGTMForwardingLogger, NSSet;
@protocol OS_dispatch_queue;

@interface GMSx_GIPLogMultiplexer : NSObject <GIPLogAppControl, GIPLogMultiplexing>
{
    NSSet *_filters;
    NSSet *_syncLoggers;
    NSSet *_asyncLoggers;
    GMSx_GIPGTMForwardingLogger *_gtmForwardingLogger;
