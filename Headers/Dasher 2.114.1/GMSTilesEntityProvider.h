...
#import <NavigationFramework/GMSFeatureEntityUIItemDelegate-Protocol.h>
#import <NavigationFramework/GMSRenderTileConsumer-Protocol.h>
...
@interface GMSTilesEntityProvider : NSObject <GMSRenderTileConsumer, GMSFeatureEntityUIItemDelegate, GMSEntityProvider>
{
    ...
    struct shared_ptr<gmscore::vector::TileLabelProvider> _tileLabelProvider;
