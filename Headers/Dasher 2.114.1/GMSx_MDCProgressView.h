...
@class GMSx_MDCProgressGradientView, NSArray, UIColor, UIProgressView;

@interface GMSx_MDCProgressView : UIView
{
    _Bool _animating;
    ...
    GMSx_MDCProgressGradientView *_progressView;
    GMSx_MDCProgressGradientView *_indeterminateProgressView;
    UIView *_trackView;
}
...
@property(retain, nonatomic) GMSx_MDCProgressGradientView *indeterminateProgressView; // @synthesize indeterminateProgressView=_indeterminateProgressView;
@property(retain, nonatomic) GMSx_MDCProgressGradientView *progressView; // @synthesize progressView=_progressView;
