...
#import <NavigationFramework/GMSAnalyticsLogger-Protocol.h>
...
@interface GMSMockClearcutLogger : NSObject <GMSAnalyticsLogger>
{
    ...
    NSMutableDictionary *_realtimeLogs;
    id <GMCSClock> _clock;
...
- (void)incrementCounter:(id)arg1 dimensions:(id)arg2 bucket:(long long)arg3 amount:(long long)arg4 logDictionary:(id)arg5;
- (void)stopLoggingAnonymously;
- (void)startLoggingAnonymously;
- (void)flushWithCompletionHandler:(CDUnknownBlockType)arg1;
- (void)logRealtimeEventCounter:(long long)arg1 bucket:(long long)arg2 dimensions:(id)arg3;
...
- (long long)loggedCountForRealtimeCounter:(long long)arg1 bucket:(long long)arg2;
- (long long)elapsedTimeForCounter:(long long)arg1;
- (int)loggedBucketCountForCounterName:(id)arg1;
- (long long)loggedCountForCounterName:(id)arg1 bucket:(long long)arg2 logDictionary:(id)arg3;
