...
#import <NavigationFramework/PHTInternalPhenotypeFlagsProtocol-Protocol.h>

@class GMSx_PHTPhenotypeExperimentTokens, GMSx_PHTPhenotypeFlagsSnapshot, NSCondition, NSString;
@protocol OS_dispatch_queue;

@interface GMSx_PHTInternalPhenotypeFlags : NSObject <PHTInternalPhenotypeFlagsProtocol>
{
