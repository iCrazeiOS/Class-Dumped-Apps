...
#import <NavigationFramework/GMDCTypographyScheming-Protocol.h>

@class GMSx_GMDCTypographySchemeTypeScaleStyles, NSString, UIFont;
@protocol GMDCTypographySchemingAdditions, MDCTypographyScheming;

@interface GMSx_GMDCTypographyScheme : NSObject <GMDCTypographyScheming>
{
    ...
    UIFont *_overline;
    UIFont *_button;
    GMSx_GMDCTypographySchemeTypeScaleStyles *_typeScaleStyles;
...
@property(retain, nonatomic) GMSx_GMDCTypographySchemeTypeScaleStyles *typeScaleStyles; // @synthesize typeScaleStyles=_typeScaleStyles;
