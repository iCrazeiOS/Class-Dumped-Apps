...
@interface GMSx_GPBStringEnumDictionary : NSObject <GPBDictionaryInternalsProtocol, NSCopying>
{
...
- (id)serializedDataForUnknownValue:(int)arg1 forKey:(CDUnion_7ae79ea2 *)arg2 keyDataType:(unsigned char)arg3;
