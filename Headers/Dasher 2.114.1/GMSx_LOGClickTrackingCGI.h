...
@class GMSx_EIDClientEventIdMessage, GMSx_LOGVeOffsetIdentifier;
...
@property(nonatomic) _Bool hasVeOffsetIdentifier; // @dynamic hasVeOffsetIdentifier;
...
@property(retain, nonatomic) GMSx_LOGVeOffsetIdentifier *veOffsetIdentifier; // @dynamic veOffsetIdentifier;
