...
#import <NavigationFramework/GMSDASHConnection-Protocol.h>

@class GMSCoreClientParameters, GMSDASHClientDescription, GMSDASHClientState, GMSXGeoHeaderEncoder, GMSx_GPBInt32Array, GMSx_GTMSessionFetcherService, NSArray, NSMutableArray, NSString, NSURL;
@protocol GMSAnalyticsLogger, GMSCellularInfo, GMSTimingClock, OS_dispatch_group;
...
@interface GMSDASHConnection : NSObject <GMSDASHConnection>
{
    ...
    // Error parsing type: {atomic<long long>="__a_"{__cxx_atomic_impl<long long, std::__1::__cxx_atomic_base_impl<long long> >="__a_value"Aq}}, name: _outgoingCount
    // Error parsing type: {atomic<long long>="__a_"{__cxx_atomic_impl<long long, std::__1::__cxx_atomic_base_impl<long long> >="__a_value"Aq}}, name: _incomingCount
    NSObject<OS_dispatch_group> *_dispatchGroup;
    // Error parsing type: {atomic<int>="__a_"{__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >="__a_value"Ai}}, name: _numInProgressConnections
...
@property(nonatomic) __weak GMSCoreClientParameters *clientParams;
...
- (_Bool)shouldUseUploadTaskForSessionFetcher;
...
- (id)initWithServerURL:(id)arg1 clientDescription:(id)arg2 clientState:(id)arg3 fetcherService:(id)arg4 cellularInfo:(id)arg5 timingClock:(id)arg6 logger:(id)arg7;
