...
+ (id)capabilityMoveFailureReasonForError:(id)arg1 files:(id)arg2;
+ (id)appDisplayName;
...
- (id)unavailableFilterWithReason:(id)arg1 title:(id)arg2 image:(id)arg3;
- (id)teamDriveFilterForFiles:(id)arg1;
- (id)myDriveFilterForFiles:(id)arg1;
...
- (void)approvalsController:(id)arg1 didRequestApprovalForFileIDResourceKeyPair:(id)arg2;
- (void)presentFilesVCForFolderIDResourceKeyPair:(id)arg1 withHighlightedFiles:(id)arg2;
...
- (void)navigateFromProjectorToTrashForTeamDrive:(id)arg1;
...
- (void)projectorController:(id)arg1 navigateToTrashForTeamDrive:(id)arg2;
- (void)navigateToMyDriveTrashWithProjectorController:(id)arg1;
...
- (void)presentGUNSNotificationsVCWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)notificationsHomeVC:(id)arg1 userRequestedToShareFile:(id)arg2 withUserEmails:(id)arg3 defaultRole:(long long)arg4;
- (void)openFileWithIDResourceKeyPair:(id)arg1;
...
- (_Bool)isViewControllerRestorationIdentifier:(id)arg1 topLevelInFABController:(id)arg2;
...
- (void)displayGUNSNotificationsWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)displayTrashForTeamDrive:(id)arg1;
- (void)displayTrash;
- (void)displayOffline;
- (void)displayRecent;
...
- (void)presentUploadFromCamera;
- (void)presentUploadPhotosInterface;
- (void)handleApplicationShortcutAction:(long long)arg1;
- (void)handleURLAction:(long long)arg1;
- (void)openFileWithIDResourceKeyPair:(id)arg1 usersToInvite:(id)arg2 linkToApprovalList:(_Bool)arg3 approvalToOpen:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)requestAccessForFileWithIDResourceKeyPair:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)shutdownWithCompletionQueue:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)uploadFileAtURL:(id)arg1;
- (void)openFileWithIDResourceKeyPair:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
@property(readonly, nonatomic) _Bool updateResourceSupportEnabled; // @synthesize updateResourceSupportEnabled=_updateResourceSupportEnabled;
@property(readonly, nonatomic) _Bool updateBannerSupportEnabled; // @synthesize updateBannerSupportEnabled=_updateBannerSupportEnabled;
@property(readonly, nonatomic) _Bool updateWebViewSupportEnabled; // @synthesize updateWebViewSupportEnabled=_updateWebViewSupportEnabled;
