...
@interface HATSQuestionMultipleChoice : HATSQuestion <HATSQuestionWithSelectableAnswers>
{
    NSArray *_ordering;
    NSArray *_answers;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) NSString *spriteName; // @synthesize spriteName=_spriteName;
