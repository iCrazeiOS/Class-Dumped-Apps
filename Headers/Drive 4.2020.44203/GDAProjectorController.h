...
@class GAVDriveLoaderFactory, GAVProjectorVC, GDAActionPanelContext, GDAAppFlags, GDAOpenInAppController, GDARateAppManager, GDASwiftUserServices, GDAUserFlags, GDAUserSettings, GDKAddShortcutController, GDKFileDropController, GDKFolderColorPalette, GDKSearchQueryParser, GDKTheme, GDKUploadService, GDKUserPathManager, GSCImageFetcher, GSCImageFetcherCache, GTMSessionFetcherService, NSArray, NSDictionary, NSHashTable, NSMutableArray, NSMutableDictionary, NSString, UIBarButtonItem, UIView;
@protocol GAVBlocosManager, GAVBlocosService, GDAFilePresenting, GDAProjectorControllerDelegate, GDKActivityFetching, GDKAlertControlling, GDKApprovalsService, GDKCapabilityChecking, GDKCategoryFetching, GDKContactAvatarCaching, GDKContactManagerAPIClient, GDKContentProvider, GDKFile, GDKFileActionProvider, GDKFileFetcher, GDKFileMutating, GDKFileResolving, GDKHandoffURLFactory, GDKHelpKitService, GDKItemsLiveListQuerent, GDKPermissionsFetching><GDKPermissionsMutating, GDKRootIDFetcher, GDKSiriSuggestionDonationManaging, GDKSnackbarControlling, GDKThumbnailCaching, GDKURLOpening, GDKViewControllerPresenting, GDKViewControllerToken, SSOAuthorization;

@interface GDAProjectorController : NSObject <GAVProjectorDataSource, GAVProjectorDelegate, GAVBlocosManagerDelegate, GAVBlocosProjectorDelegate, GDAActionPanelObserving, GDKDetailsCollectionVCDelegate, GDKDetailsVCPresenting, GDKDialogControllerDelegate, GDKActionItemVCDelegate>
{
    _Bool _hasMultipleActiveUsers;
    _Bool _adminOptedOutSettingEnabled;
    ...
    UIBarButtonItem *_restoreBarButtonItem;
}

+ (id)restoreBarButtonItemWithTarget:(id)arg1 action:(SEL)arg2;
+ (_Bool)blocosEnabledForFile:(id)arg1 autoPurgingMessagingEnabled:(_Bool)arg2;
- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool adminOptedOutSettingEnabled; // @synthesize adminOptedOutSettingEnabled=_adminOptedOutSettingEnabled;
@property(retain, nonatomic) UIBarButtonItem *restoreBarButtonItem; // @synthesize restoreBarButtonItem=_restoreBarButtonItem;
...
- (void)postNotification:(id)arg1 withFile:(id)arg2 userIDParam:(id)arg3;
...
- (void)openTrashInTeamDrive:(id)arg1;
...
- (id)trashedFileMessageActionForForProjector:(id)arg1;
...
- (void)presentProjectorForFile:(id)arg1 withFileList:(id)arg2 inTeamDrive:(id)arg3 presentedWithModalVC:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
...
- (_Bool)openFile:(id)arg1 fromView:(id)arg2 withFileList:(id)arg3 inTeamDrive:(id)arg4 actionPanelContext:(id)arg5 completion:(CDUnknownBlockType)arg6;
