...
- (id)initWithJavaUtilSpliterator:(id)arg1 withJavaUtilSpliterator:(id)arg2 withJavaUtilFunctionFunction:(id)arg3 withComGoogleCommonCollectCollectSpliterators_FlatMapSpliterator_Factory:(id)arg4 withInt:(int)arg5 withLong:(long long)arg6;
