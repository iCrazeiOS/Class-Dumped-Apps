...
@protocol GAVBlocosProjectorDelegate, GAVFileInfo, GAVProjectorDataSource, GAVProjectorDelegate, GAVRendererFactory, SSOAuthorization;
...
@property(nonatomic) _Bool enableAnchoredCommentCreation;
@property(retain, nonatomic) id <GAVBlocosProjectorDelegate> blocosProjectorDelegate;
- (id)currentBlocosRenderer;
- (_Bool)rendererDidRequestEnableAnchoredCommentCreation:(id)arg1;
- (void)renderer:(id)arg1 didSelectAnchorWithID:(id)arg2;
- (void)renderer:(id)arg1 didRequestAnchorIDCreated:(id)arg2;
...
- (id)blocosProjectorWithDataSource:(id)arg1 delegate:(id)arg2 configuration:(id)arg3 ssoAuthorization:(id)arg4;
- (id)blocosProjectorWithDataSource:(id)arg1 delegate:(id)arg2 configuration:(id)arg3 ssoAuthorization:(id)arg4 theme:(id)arg5;
