...
@class NSArray, NSString, NSTimer, OGLAccountMenuDependencies, OGLAccountParticleDiscButton, OGLAccountSnackbarManager, OGLAnalyticsComponentContext, UIColor, UIPointerInteraction, UIView;
...
@interface OGLAccountParticleDiscViewController : UIViewController <OGLAccountParticleDiscButtonDelegate, OGLAnalyticsAccountParticleDiscDelegate, OGLAccountParticleDiscLongPressManagerDelegate, OGLAccountParticleDiscEducationManagerDelegate, OGLAccountParticleDiscBadgingDelegate, UIGestureRecognizerDelegate, OGLAccountParticleDiscViewController>
{
    ...
    NSTimer *_fauxbakeEducationTimer;
...
@property(retain, nonatomic) NSTimer *fauxbakeEducationTimer; // @synthesize fauxbakeEducationTimer=_fauxbakeEducationTimer;
...
- (_Bool)supportFauxbakeEducation;
...
- (void)handleEducationForAccountSwitchFromAccount:(id)arg1 toAccount:(id)arg2;
...
- (void)startFauxbakeEducationWithDismissCallback:(CDUnknownBlockType)arg1;
