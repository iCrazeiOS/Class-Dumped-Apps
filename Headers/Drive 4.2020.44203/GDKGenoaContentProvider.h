...
@property(readonly, nonatomic) _Bool viewingOnlyCache; // @synthesize viewingOnlyCache=_viewingOnlyCache;
...
- (void)dealloc;
- (id)initWithStorageURL:(id)arg1 actionObserverRegistrar:(id)arg2 fileFetcher:(id)arg3 fileMutator:(id)arg4 snackbarController:(id)arg5 downloadService:(id)arg6 videoFetcher:(id)arg7 viewingOnlyCache:(_Bool)arg8 ssoIdentity:(id)arg9 backendInstance:(id)arg10;
- (id)initWithStorageURL:(id)arg1 actionObserverRegistrar:(id)arg2 fileFetcher:(id)arg3 fileMutator:(id)arg4 snackbarController:(id)arg5 downloadService:(id)arg6 videoFetcher:(id)arg7 viewingOnlyCache:(_Bool)arg8 ssoIdentity:(id)arg9;
