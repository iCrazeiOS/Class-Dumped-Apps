...
@class ComGoogleCommonUtilConcurrentExecutionSequencer_ThreadConfinedTaskQueue, JavaUtilConcurrentAtomicAtomicReference;

@interface ComGoogleCommonUtilConcurrentExecutionSequencer : NSObject
{
    JavaUtilConcurrentAtomicAtomicReference *ref_;
    ComGoogleCommonUtilConcurrentExecutionSequencer_ThreadConfinedTaskQueue *latestTaskQueue_;
}
