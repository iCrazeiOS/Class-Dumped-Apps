...
@class GDKTheme, NSString, QTMCollectionViewModel;
@protocol GDKAutoSizablePresenter;

@interface GDKMenuCVO : NSObject <GDKMenuThemableCVO, GDKMenuViewObject, GDKAutoSizable>
{
    GDKTheme *_theme;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) QTMCollectionViewModel *model; // @synthesize model=_model;
...
- (id)initWithTitle:(id)arg1 model:(id)arg2 theme:(id)arg3;
