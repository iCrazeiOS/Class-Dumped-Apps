...
@property(nonatomic) _Bool hasInlineForm; // @dynamic hasInlineForm;
...
@property(nonatomic) _Bool hasSorted; // @dynamic hasSorted;
...
@property(nonatomic) _Bool inlineForm; // @dynamic inlineForm;
...
@property(nonatomic) _Bool sorted; // @dynamic sorted;
