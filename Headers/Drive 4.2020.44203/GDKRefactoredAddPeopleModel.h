...
- (void)dispatchPermissionsBlockAfterFileAvailableOnServer:(id)arg1 dispatchQueue:(id)arg2 permissionsBlock:(CDUnknownBlockType)arg3 handleResourceKeys:(_Bool)arg4;
- (void)addPermissionsForItemWithIDResourceKeyPair:(id)arg1 item:(id)arg2 permissions:(id)arg3 selectedSuggestionsIndexSet:(id)arg4 sendNotificationEmails:(_Bool)arg5 emailMessage:(id)arg6 confirmed:(_Bool)arg7 temakiEnabled:(_Bool)arg8 completionQueue:(id)arg9 completion:(CDUnknownBlockType)arg10;
- (void)fetchPermissionsForItemWithIDResourceKeyPair:(id)arg1 completionQueue:(id)arg2 temakiEnabled:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
