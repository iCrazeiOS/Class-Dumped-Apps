...
@class MoPub_AvidAdSessionRegistry, NSMutableDictionary;
@protocol OS_dispatch_queue;

@interface MoPub_AvidStatePublisher : NSObject
{
...
- (void).cxx_destruct;
- (void)cleanupCache;
- (void)_publishEmptyStateToSessions:(id)arg1 timestamp:(double)arg2;
