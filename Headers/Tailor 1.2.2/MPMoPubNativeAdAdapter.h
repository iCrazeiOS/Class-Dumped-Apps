...
#import "MPAdImpressionTimerDelegate-Protocol.h"
#import "MPNativeAdAdapter-Protocol.h"

@class MPAdConfiguration, MPAdDestinationDisplayAgent, MPAdImpressionTimer, NSArray, NSDictionary, NSString, NSURL;
