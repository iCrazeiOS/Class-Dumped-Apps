...
@class NSArray, NSString, UIScrollView, UIWebView, WKWebView;
...
@interface MPWebView : UIView <UIWebViewDelegate, WKNavigationDelegate, WKUIDelegate, UIScrollViewDelegate>
{
    ...
    NSArray *_wkWebViewLayoutConstraints;
}

+ (_Bool)isForceWKWebView;
+ (void)forceWKWebView:(_Bool)arg1;
@property(nonatomic) _Bool hasMovedToWindow; // @synthesize hasMovedToWindow=_hasMovedToWindow;
@property(retain, nonatomic) NSArray *wkWebViewLayoutConstraints; // @synthesize wkWebViewLayoutConstraints=_wkWebViewLayoutConstraints;
...
- (void)constrainWebViewShouldUseSafeArea:(_Bool)arg1;
- (void)dealloc;
