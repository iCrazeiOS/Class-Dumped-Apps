...
@class MPUBMoatWebViewAndBridge, NSArray, NSMutableDictionary, NSString, NSTimer, UIView;
...
@interface MPUBMoatVideoTracker : MPUBMoatBaseTracker
{
    ...
    MPUBMoatWebViewAndBridge *_mWebViewAndBridge;
    NSTimer *_timer;
...
@property(retain) MPUBMoatWebViewAndBridge *mWebViewAndBridge; // @synthesize mWebViewAndBridge=_mWebViewAndBridge;
