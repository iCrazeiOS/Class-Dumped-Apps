...
@class BMFairplayEncryptionAttributes, NSString;
...
@interface SPTVideoManifestProfile : NSObject
{
    ...
    NSString *_mimeType;
    BMFairplayEncryptionAttributes *_fairplayEncryptionAttributes;
    struct CGSize _videoSize;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) BMFairplayEncryptionAttributes *fairplayEncryptionAttributes; // @synthesize fairplayEncryptionAttributes=_fairplayEncryptionAttributes;
