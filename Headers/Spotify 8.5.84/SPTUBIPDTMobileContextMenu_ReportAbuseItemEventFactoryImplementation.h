...
#import "SPTUBIPDTMobileContextMenu_ReportAbuseItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ReportAbuseItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ReportAbuseItemEventFactory>
{
    NSArray *_components;
...
- (id)hitReportAbuseWithItemToReport:(id)arg1;
- (id)impression;
- (id)absoluteLocation;
- (id)_location;
