...
#import "SPTUBIMobileLyrics_ShareDestinationPickerView_BackButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileLyrics_ShareDestinationPickerView_BackButtonEventFactoryImplementation : NSObject <SPTUBIMobileLyrics_ShareDestinationPickerView_BackButtonEventFactory>
{
    NSArray *_components;
