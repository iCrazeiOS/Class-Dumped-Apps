...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_LabelsEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_LabelsEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_LabelsEventFactory>
{
    NSArray *_components;
