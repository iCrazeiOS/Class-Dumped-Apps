...
#import "SPTUBIMobileContextMenu_TogglePlaylistPublicEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_TogglePlaylistPublicEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_TogglePlaylistPublicEventFactory>
{
    NSArray *_components;
