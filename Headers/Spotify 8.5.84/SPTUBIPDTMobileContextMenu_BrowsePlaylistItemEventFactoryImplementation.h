...
#import "SPTUBIPDTMobileContextMenu_BrowsePlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_BrowsePlaylistItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_BrowsePlaylistItemEventFactory>
{
    NSArray *_components;
