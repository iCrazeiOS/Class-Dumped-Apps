...
@class NSArray, NSDictionary, NSString, SPTUBIMobileDrivingJumpstartInteractionEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileDrivingJumpstartInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileDrivingJumpstartInteractionEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobileDrivingJumpstartInteractionEventLocation *location; // @synthesize location=_location;
