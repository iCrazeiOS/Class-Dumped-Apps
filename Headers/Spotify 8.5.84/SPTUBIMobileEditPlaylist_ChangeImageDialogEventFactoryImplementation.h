...
#import "SPTUBIMobileEditPlaylist_ChangeImageDialogEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileEditPlaylist_ChangeImageDialogEventFactoryImplementation : NSObject <SPTUBIMobileEditPlaylist_ChangeImageDialogEventFactory>
{
    NSArray *_components;
...
- (id)cancelFactory;
- (id)removeCurrentImageButtonFactory;
- (id)chooseImageButtonFactory;
- (id)takePhotoButtonFactory;
- (id)absoluteLocation;
- (id)_location;
