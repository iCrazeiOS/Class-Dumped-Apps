...
#import "SPTUBIMobileContextMenu_RenamePlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_RenamePlaylistItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_RenamePlaylistItemEventFactory>
{
    NSArray *_components;
