...
#import "SPTUBIMobilePlaylistEntity_AutoRefreshToggleEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_AutoRefreshToggleEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_AutoRefreshToggleEventFactory>
{
    NSArray *_components;
