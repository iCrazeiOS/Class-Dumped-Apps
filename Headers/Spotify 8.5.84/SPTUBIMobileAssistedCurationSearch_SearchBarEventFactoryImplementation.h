...
#import "SPTUBIMobileAssistedCurationSearch_SearchBarEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_SearchBarEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_SearchBarEventFactory>
{
    NSArray *_components;
