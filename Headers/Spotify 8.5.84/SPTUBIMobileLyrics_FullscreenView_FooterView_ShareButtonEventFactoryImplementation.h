...
#import "SPTUBIMobileLyrics_FullscreenView_FooterView_ShareButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileLyrics_FullscreenView_FooterView_ShareButtonEventFactoryImplementation : NSObject <SPTUBIMobileLyrics_FullscreenView_FooterView_ShareButtonEventFactory>
{
    NSArray *_components;
