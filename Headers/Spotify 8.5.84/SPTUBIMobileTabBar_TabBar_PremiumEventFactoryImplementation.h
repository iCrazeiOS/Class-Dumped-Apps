...
#import "SPTUBIMobileTabBar_TabBar_PremiumEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileTabBar_TabBar_PremiumEventFactoryImplementation : NSObject <SPTUBIMobileTabBar_TabBar_PremiumEventFactory>
{
    NSArray *_components;
