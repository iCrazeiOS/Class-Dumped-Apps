...
#import "SPTUBIMobileContextMenu_ToggleMarkAsPlayedItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ToggleMarkAsPlayedItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ToggleMarkAsPlayedItemEventFactory>
{
    NSArray *_components;
