...
#import "SPTUBIMobileAssistedCurationSearch_Content_RecentsEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_Content_RecentsEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_Content_RecentsEventFactory>
{
    NSArray *_components;
