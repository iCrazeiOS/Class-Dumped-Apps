...
#import "SPTUBIPDTMobileContextMenu_MoreLikeThisEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_MoreLikeThisEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_MoreLikeThisEventFactory>
{
    NSArray *_components;
