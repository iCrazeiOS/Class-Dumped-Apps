...
@class NSSet;
@protocol SPTEncoreArtistHeaderFactory, SPTFreeTierEntityOfflineViewModel, SPTImageLoader, SPTLinkDispatcher;

@interface SPTEncoreArtistHeaderHubComponent : NSObject <HUBComponent>
{
    ...
    id <SPTEncoreArtistHeaderFactory> _artistHeaderFactory;
...
@property(retain, nonatomic) id <SPTEncoreArtistHeaderFactory> artistHeaderFactory; // @synthesize artistHeaderFactory=_artistHeaderFactory;
...
- (id)initWithArtistHeaderFactory:(id)arg1 imageLoader:(id)arg2 linkDispatcher:(id)arg3;
