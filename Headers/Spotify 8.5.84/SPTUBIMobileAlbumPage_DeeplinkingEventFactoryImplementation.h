...
#import "SPTUBIMobileAlbumPage_DeeplinkingEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAlbumPage_DeeplinkingEventFactoryImplementation : NSObject <SPTUBIMobileAlbumPage_DeeplinkingEventFactory>
{
    NSArray *_components;
