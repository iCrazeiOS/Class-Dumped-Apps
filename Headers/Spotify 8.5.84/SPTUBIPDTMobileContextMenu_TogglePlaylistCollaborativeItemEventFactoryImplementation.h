...
#import "SPTUBIPDTMobileContextMenu_TogglePlaylistCollaborativeItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_TogglePlaylistCollaborativeItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_TogglePlaylistCollaborativeItemEventFactory>
{
    NSArray *_components;
