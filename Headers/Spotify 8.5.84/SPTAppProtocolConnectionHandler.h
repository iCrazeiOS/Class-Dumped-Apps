...
@class NSDictionary, NSMutableDictionary, NSString, SPTAccessory, SPTAppProtocolCallForwarder, SPTAppProtocolCallMessageHandler, SPTAppProtocolMainHandler, SPTAppProtocolSessionMessageHandler, SPTAuthLegacySession;
@protocol SPTAccessoryActionLogger, SPTAccessoryStateManager, SPTAppProtocolConnection, SPTAppProtocolConnectionHandlerDelegate, SPTExternalIntegrationContentRequestOrigin, SPTExternalIntegrationDebugLog, SPTExternalIntegrationPlatform, SPTGaiaConnectAPI, SPTImageLoaderFactory, SPTPreferences, SPTProductState;
...
@property(retain, nonatomic) id <SPTExternalIntegrationContentRequestOrigin> currentContentRequestOrigin; // @synthesize currentContentRequestOrigin=_currentContentRequestOrigin;
...
@property(copy, nonatomic) NSString *lastBundleId; // @synthesize lastBundleId=_lastBundleId;
...
- (void)contentRequestOriginSessionEnd;
- (void)contentRequestOriginSessionStart;
- (void)logSessionEnd;
...
- (void)connectionDidCloseDueToSocketError:(id)arg1;
