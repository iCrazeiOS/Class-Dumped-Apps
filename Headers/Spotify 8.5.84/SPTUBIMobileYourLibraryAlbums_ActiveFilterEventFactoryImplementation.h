...
#import "SPTUBIMobileYourLibraryAlbums_ActiveFilterEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileYourLibraryAlbums_ActiveFilterEventFactoryImplementation : NSObject <SPTUBIMobileYourLibraryAlbums_ActiveFilterEventFactory>
{
    NSArray *_components;
