...
#import "SPTUBIMobileBrowse_Grid_EntityCardEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileBrowse_Grid_EntityCardEventFactoryImplementation : NSObject <SPTUBIMobileBrowse_Grid_EntityCardEventFactory>
{
    NSArray *_components;
