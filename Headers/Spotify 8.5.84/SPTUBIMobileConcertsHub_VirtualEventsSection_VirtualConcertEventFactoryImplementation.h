...
#import "SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcertEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcertEventFactoryImplementation : NSObject <SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcertEventFactory>
{
    NSArray *_components;
...
- (id)impression;
- (id)concertDetailsFactory;
- (id)concertImageFactoryWithIdentifier:(id)arg1;
- (id)absoluteLocation;
- (id)_location;
