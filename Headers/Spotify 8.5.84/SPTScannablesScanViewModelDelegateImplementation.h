...
@protocol SPTScannablesImagePickerController, SPTScannablesRegistry;
...
@interface SPTScannablesScanViewModelDelegateImplementation : NSObject <SPTScannablesScanViewModelDelegate>
{
    ...
    SPTScannablesScanViewController *_viewController;
...
@property(readonly, nonatomic) __weak SPTScannablesScanViewController *viewController; // @synthesize viewController=_viewController;
