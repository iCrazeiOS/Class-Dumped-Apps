...
#import "SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_SeeAllItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_SeeAllItemEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_SeeAllItemEventFactory>
{
    NSArray *_components;
