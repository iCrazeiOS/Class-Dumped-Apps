...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_TopBar_ContextMenuButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_TopBar_ContextMenuButtonEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_TopBar_ContextMenuButtonEventFactory>
{
    NSArray *_components;
