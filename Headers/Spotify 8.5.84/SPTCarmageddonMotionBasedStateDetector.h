...
@class NSMutableArray, NSNotificationCenter, NSString, NSTimer, SPTCarmageddonCarDetectionState, SPTCarmageddonMotionDetectionLoader, SPTCarmageddonMotionManager, SPTCarmageddonMotionRecorderConfigurationFactory, SPTObserverManager;
...
@property(readonly, nonatomic) double repetitionDelay; // @synthesize repetitionDelay=_repetitionDelay;
@property(readonly, nonatomic) double recordingDelay; // @synthesize recordingDelay=_recordingDelay;
@property(readonly, nonatomic) SPTCarmageddonMotionRecorderConfigurationFactory *recorderConfigurationFactory; // @synthesize recorderConfigurationFactory=_recorderConfigurationFactory;
...
- (id)initWithMotionManager:(id)arg1 dataLoader:(id)arg2 notificationCenter:(id)arg3 recorderConfigurationFactory:(id)arg4 recordingDelay:(double)arg5;
