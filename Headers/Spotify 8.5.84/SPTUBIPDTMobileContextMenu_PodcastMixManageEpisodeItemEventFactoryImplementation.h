...
#import "SPTUBIPDTMobileContextMenu_PodcastMixManageEpisodeItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_PodcastMixManageEpisodeItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_PodcastMixManageEpisodeItemEventFactory>
{
    NSArray *_components;
