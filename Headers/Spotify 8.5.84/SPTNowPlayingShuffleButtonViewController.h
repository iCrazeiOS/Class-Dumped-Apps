...
@interface SPTNowPlayingShuffleButtonViewController : UIViewController <SPTNowPlayingModelObserver, SPTNowPlayingPlaybackActionsHandlerObserver>
{
    SPTNowPlayingModel *_model;
    id <SPTNowPlayingPlaybackActionsHandler> _playbackActionsHandler;
    SPTTheme *_theme;
    SPTNowPlayingButton *_shuffleButton;
...
@property(retain, nonatomic) SPTNowPlayingButton *shuffleButton; // @synthesize shuffleButton=_shuffleButton;
