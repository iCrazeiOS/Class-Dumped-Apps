...
#import "SPTUBIMobileTabBar_TabBar_SearchTabEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileTabBar_TabBar_SearchTabEventFactoryImplementation : NSObject <SPTUBIMobileTabBar_TabBar_SearchTabEventFactory>
{
    NSArray *_components;
...
- (id)longHitUiNavigateWithDestination:(id)arg1;
