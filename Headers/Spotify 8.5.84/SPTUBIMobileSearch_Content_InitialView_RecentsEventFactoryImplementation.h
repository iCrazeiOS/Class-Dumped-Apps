...
#import "SPTUBIMobileSearch_Content_InitialView_RecentsEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSearch_Content_InitialView_RecentsEventFactoryImplementation : NSObject <SPTUBIMobileSearch_Content_InitialView_RecentsEventFactory>
{
    NSArray *_components;
