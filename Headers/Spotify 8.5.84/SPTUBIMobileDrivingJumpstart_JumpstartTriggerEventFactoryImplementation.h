...
#import "SPTUBIMobileDrivingJumpstart_JumpstartTriggerEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileDrivingJumpstart_JumpstartTriggerEventFactoryImplementation : NSObject <SPTUBIMobileDrivingJumpstart_JumpstartTriggerEventFactory>
{
    NSArray *_components;
