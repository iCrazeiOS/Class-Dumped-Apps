...
- (void)encore_updateStyle:(id)arg1 withAccessibilityScale:(double)arg2;
- (void)encore_registerForAccessibilityAutosizingWithStyle:(id)arg1;
- (id)encore_stringAttributes;
