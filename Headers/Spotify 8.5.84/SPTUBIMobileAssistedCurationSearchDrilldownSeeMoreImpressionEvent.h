...
@class NSArray, NSString, SPTUBIMobileAssistedCurationSearchDrilldownSeeMoreEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearchDrilldownSeeMoreImpressionEvent : NSObject <SPTUBIImpressionEvent>
{
    SPTUBIMobileAssistedCurationSearchDrilldownSeeMoreEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobileAssistedCurationSearchDrilldownSeeMoreEventLocation *location; // @synthesize location=_location;
