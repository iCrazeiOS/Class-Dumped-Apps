...
@class NSURL;
@protocol SPTUBIEventAbsoluteLocation, SPTUBIEventLocation, SPTUBIInteractionEvent, SPTUBIMobileYourLibraryLikedSongs_ItemList_PreviewItem_AlbumCoverEventFactory, SPTUBIMobileYourLibraryLikedSongs_ItemList_PreviewItem_ContextMenuButtonEventFactory, SPTUBIMobileYourLibraryLikedSongs_ItemList_PreviewItem_HeartButtonEventFactory;
