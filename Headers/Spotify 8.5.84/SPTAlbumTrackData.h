...
- (id)initWithTrackName:(id)arg1 trackURL:(id)arg2 artists:(id)arg3 albumName:(id)arg4 albumURL:(id)arg5 playableState:(unsigned long long)arg6 ratedExplicit:(_Bool)arg7 trackDuration:(double)arg8;
