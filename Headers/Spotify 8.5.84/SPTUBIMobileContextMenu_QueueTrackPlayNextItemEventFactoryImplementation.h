...
#import "SPTUBIMobileContextMenu_QueueTrackPlayNextItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_QueueTrackPlayNextItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_QueueTrackPlayNextItemEventFactory>
{
    NSArray *_components;
