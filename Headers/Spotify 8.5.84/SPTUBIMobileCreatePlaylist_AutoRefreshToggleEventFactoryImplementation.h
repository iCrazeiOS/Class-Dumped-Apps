...
#import "SPTUBIMobileCreatePlaylist_AutoRefreshToggleEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileCreatePlaylist_AutoRefreshToggleEventFactoryImplementation : NSObject <SPTUBIMobileCreatePlaylist_AutoRefreshToggleEventFactory>
{
    NSArray *_components;
