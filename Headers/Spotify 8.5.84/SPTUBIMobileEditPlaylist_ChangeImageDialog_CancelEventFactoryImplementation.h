...
#import "SPTUBIMobileEditPlaylist_ChangeImageDialog_CancelEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileEditPlaylist_ChangeImageDialog_CancelEventFactoryImplementation : NSObject <SPTUBIMobileEditPlaylist_ChangeImageDialog_CancelEventFactory>
{
    NSArray *_components;
