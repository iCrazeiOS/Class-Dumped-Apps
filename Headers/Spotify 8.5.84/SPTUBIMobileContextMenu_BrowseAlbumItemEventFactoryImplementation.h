...
#import "SPTUBIMobileContextMenu_BrowseAlbumItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_BrowseAlbumItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_BrowseAlbumItemEventFactory>
{
    NSArray *_components;
