...
@class NSArray, NSString, SPTUBIMobileSocialListeningEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListeningImpressionEvent : NSObject <SPTUBIImpressionEvent>
{
    SPTUBIMobileSocialListeningEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobileSocialListeningEventLocation *location; // @synthesize location=_location;
