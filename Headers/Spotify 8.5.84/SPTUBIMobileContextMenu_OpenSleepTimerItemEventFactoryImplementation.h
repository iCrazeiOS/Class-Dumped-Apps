...
#import "SPTUBIMobileContextMenu_OpenSleepTimerItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_OpenSleepTimerItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_OpenSleepTimerItemEventFactory>
{
    NSArray *_components;
