...
#import "SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsButtonEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsButtonEventFactory>
{
    NSArray *_components;
