...
#import "SPTUBIPDTMobileContextMenu_BrowsePodcastItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_BrowsePodcastItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_BrowsePodcastItemEventFactory>
{
    NSArray *_components;
