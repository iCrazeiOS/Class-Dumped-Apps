...
@class GLUEButton, NSString, NSURL, SPTChartFeatureProperties, SPTChartFreeTierNavigationBarModel, SPTChartFreeTierViewModel, SPTChartTheme, SPTEntityTableHeaderView, SPTTableView, UIView;
...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithURL:(id)arg1 viewModel:(id)arg2 navigationBarModel:(id)arg3 recommendedPlaylistFooter:(id)arg4 theme:(id)arg5 properties:(id)arg6;
