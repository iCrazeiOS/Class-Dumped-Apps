...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_SkipNextButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_SkipNextButtonEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_SkipNextButtonEventFactory>
{
    NSArray *_components;
