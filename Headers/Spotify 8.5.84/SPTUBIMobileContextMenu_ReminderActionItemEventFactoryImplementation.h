...
#import "SPTUBIMobileContextMenu_ReminderActionItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ReminderActionItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ReminderActionItemEventFactory>
{
    NSArray *_components;
