...
@class NSMutableArray, NSString, NSURL, SPTAuthLegacySession, SPTDataLoader, SPTInfinitePlaybackContext, SPTRadioLogger, SPTRadioPlaybackService;
@protocol SPTGaiaConnectAPI, SPTLocalSettings, SPTNetworkConnectivityController, SPTPlayer, SPTRadioRemoteConfigProperties;
...
@interface SPTInfinitePlaybackManager : NSObject <SPTDataLoaderDelegate, SPTPlayerObserver>
{
    ...
    id <SPTRadioRemoteConfigProperties> _remoteConfigProperties;
...
@property(readonly, nonatomic) __weak id <SPTRadioRemoteConfigProperties> remoteConfigProperties; // @synthesize remoteConfigProperties=_remoteConfigProperties;
...
- (void)resetState;
- (_Bool)shouldUseBespokeSocialOnDemandOverrideOldState:(id)arg1 newState:(id)arg2;
- (void)dataLoader:(id)arg1 didCancelRequest:(id)arg2;
- (void)dataLoader:(id)arg1 didReceiveErrorResponse:(id)arg2;
- (void)dataLoader:(id)arg1 didReceiveSuccessfulResponse:(id)arg2;
- (void)player:(id)arg1 stateDidChange:(id)arg2 fromState:(id)arg3;
- (void)dealloc;
- (id)initWithPlayer:(id)arg1 playbackService:(id)arg2 localSettings:(id)arg3 session:(id)arg4 dataLoader:(id)arg5 networkConnectivity:(id)arg6 connectManager:(id)arg7 logger:(id)arg8 remoteConfigProperties:(id)arg9;
