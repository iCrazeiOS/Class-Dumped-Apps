...
#import "SPTUBIMobileHome_Shelf_NavCardEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_Shelf_NavCardEventFactoryImplementation : NSObject <SPTUBIMobileHome_Shelf_NavCardEventFactory>
{
    NSArray *_components;
