...
#import "SPTUBIMobileBrowse_PageHeader_ChipEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileBrowse_PageHeader_ChipEventFactoryImplementation : NSObject <SPTUBIMobileBrowse_PageHeader_ChipEventFactory>
{
    NSArray *_components;
