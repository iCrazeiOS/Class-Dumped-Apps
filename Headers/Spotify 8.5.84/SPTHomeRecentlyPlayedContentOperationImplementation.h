...
- (id)ubiLoggingDataForRecentlyPlayedShelfWithPosition:(unsigned long long)arg1 itemIndex:(unsigned long long)arg2 itemURL:(id)arg3 sourceContentIdentifier:(id)arg4;
- (void)addLoggingForItemAtIndex:(unsigned long long)arg1 withItemUrl:(id)arg2 toItemComponentModelBuilder:(id)arg3 usingRecentlyPlayedInfo:(id)arg4;
