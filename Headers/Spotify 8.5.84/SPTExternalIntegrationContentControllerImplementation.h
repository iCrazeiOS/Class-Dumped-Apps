...
- (void)requestRecommendedRootItemsFromSpacesWithIdentifier:(id)arg1 externalActionOrigin:(id)arg2 options:(id)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
...
- (void)resolveChildContentOfParentWithURI:(id)arg1 options:(id)arg2 externalActionOrigin:(id)arg3 requestOrigin:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;
...
- (id)contentRequestOriginWithClientID:(id)arg1 bundleIdentifier:(id)arg2 category:(id)arg3 transportType:(id)arg4 protocol:(id)arg5;
