...
#import "SPTLyricsV2TextViewTouchDelegate-Protocol.h"
#import "UITextViewDelegate-Protocol.h"

@class NSArray, NSString, SPTLyricsLineSet, SPTLyricsV2LyricsView;
...
@interface SPTLyricsV2LyricsViewController : UIViewController <SPTLyricsProgressManagerObserver, UITextViewDelegate, SPTLyricsV2TextViewTouchDelegate>
{
    _Bool _expanded;
    _Bool _loggingEnabled;
    _Bool _shareModeEnabled;
    ...
    double _maxYOffset;
    double _minYOffset;
    long long _firstSelectedLineIndexForSharing;
    long long _lastSelectedLineIndexForSharing;
    long long _activeLength;
}

- (void).cxx_destruct;
@property(nonatomic) long long activeLength; // @synthesize activeLength=_activeLength;
@property(nonatomic) long long lastSelectedLineIndexForSharing; // @synthesize lastSelectedLineIndexForSharing=_lastSelectedLineIndexForSharing;
@property(nonatomic) long long firstSelectedLineIndexForSharing; // @synthesize firstSelectedLineIndexForSharing=_firstSelectedLineIndexForSharing;
...
@property(nonatomic, getter=isShareModeEnabled) _Bool shareModeEnabled; // @synthesize shareModeEnabled=_shareModeEnabled;
...
- (void)textView:(id)arg1 didTouchAt:(struct CGPoint)arg2;
...
- (void)collapse;
- (void)expand;
- (void)scrollToLine:(long long)arg1;
...
- (void)updateActiveTextIfNeeded:(long long)arg1;
...
- (void)reset;
@property(readonly, nonatomic) NSArray *linesSelectedForSharing;
- (void)dealloc;
