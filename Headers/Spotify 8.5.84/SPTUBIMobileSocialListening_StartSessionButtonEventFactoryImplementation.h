...
#import "SPTUBIMobileSocialListening_StartSessionButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListening_StartSessionButtonEventFactoryImplementation : NSObject <SPTUBIMobileSocialListening_StartSessionButtonEventFactory>
{
    NSArray *_components;
