...
#import "SPTUBIPDTMobileContextMenu_BrowseEpisodeItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_BrowseEpisodeItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_BrowseEpisodeItemEventFactory>
{
    NSArray *_components;
