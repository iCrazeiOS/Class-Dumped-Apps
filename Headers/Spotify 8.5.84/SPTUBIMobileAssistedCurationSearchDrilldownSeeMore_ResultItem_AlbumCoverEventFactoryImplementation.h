...
#import "SPTUBIMobileAssistedCurationSearchDrilldownSeeMore_ResultItem_AlbumCoverEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearchDrilldownSeeMore_ResultItem_AlbumCoverEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearchDrilldownSeeMore_ResultItem_AlbumCoverEventFactory>
{
    NSArray *_components;
