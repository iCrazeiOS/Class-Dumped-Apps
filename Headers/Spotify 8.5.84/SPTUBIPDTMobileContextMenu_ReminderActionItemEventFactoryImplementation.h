...
#import "SPTUBIPDTMobileContextMenu_ReminderActionItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ReminderActionItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ReminderActionItemEventFactory>
{
    NSArray *_components;
