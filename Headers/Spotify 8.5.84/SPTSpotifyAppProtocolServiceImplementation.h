...
@class NSMapTable, NSString, SPTAllocationContext, SPTAppProtocolBackgroundController, SPTAppProtocolCallForwarder, SPTAppProtocolEAConnector, SPTAuthLegacySession, SPTSpotifyAppProtocolFeatureProperties;
...
@interface SPTSpotifyAppProtocolServiceImplementation : NSObject <NSNetServiceDelegate, SPTAppProtocolConnectionHandlerDelegate, SPTAppProtocolConnectorDelegate, SPTExternalIntegrationPlaybackControllerObserver, SPTAppProtocolBackgroundControllerDelegate, SPTService, SPTSpotifyAppProtocolService>
{
    ...
    SPTSpotifyAppProtocolFeatureProperties *_properties;
...
@property(retain, nonatomic) SPTSpotifyAppProtocolFeatureProperties *properties; // @synthesize properties=_properties;
