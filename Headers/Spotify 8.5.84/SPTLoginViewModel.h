...
@class NSString, SPTAuthenticationHandler, SPTLoginAttemptLogger, SPTLoginFailureHandler, SPTLoginMagicLinkRequestTracker, SPTLoginMagicLinkRequestWarningPresenter, SPTLoginRecoverAccountDataLoader, SPTLoginViewLogger;
...
- (id)initWithNavigationCoordinator:(id)arg1 logger:(id)arg2 authenticationHandler:(id)arg3 userEmail:(id)arg4 initialErrorDescription:(id)arg5 magicLinkRequestTracker:(id)arg6 magicLinkWarningPresenter:(id)arg7 magicLinkLoginFailurehandler:(id)arg8 recoverAccountDataLoader:(id)arg9 loginAttemptLogger:(id)arg10;
