...
#import "SPTUBIMobileSocialListening_OutputModeSelectionDialog_CancelEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListening_OutputModeSelectionDialog_CancelEventFactoryImplementation : NSObject <SPTUBIMobileSocialListening_OutputModeSelectionDialog_CancelEventFactory>
{
    NSArray *_components;
