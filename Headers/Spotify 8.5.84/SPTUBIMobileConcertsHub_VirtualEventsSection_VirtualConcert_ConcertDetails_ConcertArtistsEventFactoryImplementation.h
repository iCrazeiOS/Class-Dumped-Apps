...
#import "SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcert_ConcertDetails_ConcertArtistsEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcert_ConcertDetails_ConcertArtistsEventFactoryImplementation : NSObject <SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcert_ConcertDetails_ConcertArtistsEventFactory>
{
    NSArray *_components;
