...
#import "SPTUBIMobileContextMenu_LessLikeThisEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_LessLikeThisEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_LessLikeThisEventFactory>
{
    NSArray *_components;
