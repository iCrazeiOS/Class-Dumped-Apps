...
#import "SPTUBIPDTMobileContextMenu_SetPlaybackSpeedItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_SetPlaybackSpeedItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_SetPlaybackSpeedItemEventFactory>
{
    NSArray *_components;
