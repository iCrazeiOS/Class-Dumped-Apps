...
@protocol SPTBarButtonItemManager, SPTContainerService, SPTContainerUIService, SPTFreeTierTooltipService, SPTGLUEService, SPTImageLoadingService, SPTLocalSettings, SPTNavigationFeature, SPTNetworkService, SPTPageLoaderViewService, SPTScannablesOnboardingPresenter, SPTScannablesPresenter, SPTScannablesRegistry, SPTScannablesShortcutItemProvider, SPTSessionService, SPTSettingsFeature, SPTSnackbarService, SPTUBIService, SPTUIPresentationService, SPTURIDispatchService, SlateFeature;
