...
#import "SPTUBIMobileContextMenu_BrowsePodcastItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_BrowsePodcastItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_BrowsePodcastItemEventFactory>
{
    NSArray *_components;
