...
@class NSArray, NSString, SPTLoginButtonActionHandler, SPTLoginWelcomeModel;
@protocol SPTLoginThirdPartyLoginHandlerDelegate;

@interface SPTLoginWelcomeButtonContainerViewModel : NSObject <SPTLoginThirdPartyLoginControllerDelegate, SPTLoginActionButtonsViewModel>
{
...
- (id)initWithActionButtons:(id)arg1 actionButtonHandler:(id)arg2;
