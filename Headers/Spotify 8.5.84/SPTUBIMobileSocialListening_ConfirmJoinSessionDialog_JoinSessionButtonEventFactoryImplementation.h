...
#import "SPTUBIMobileSocialListening_ConfirmJoinSessionDialog_JoinSessionButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListening_ConfirmJoinSessionDialog_JoinSessionButtonEventFactoryImplementation : NSObject <SPTUBIMobileSocialListening_ConfirmJoinSessionDialog_JoinSessionButtonEventFactory>
{
    NSArray *_components;
