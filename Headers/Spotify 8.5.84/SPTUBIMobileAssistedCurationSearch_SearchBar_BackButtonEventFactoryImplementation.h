...
#import "SPTUBIMobileAssistedCurationSearch_SearchBar_BackButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_SearchBar_BackButtonEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_SearchBar_BackButtonEventFactory>
{
    NSArray *_components;
