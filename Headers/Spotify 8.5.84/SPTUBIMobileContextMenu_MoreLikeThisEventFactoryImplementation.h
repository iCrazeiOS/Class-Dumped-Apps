...
#import "SPTUBIMobileContextMenu_MoreLikeThisEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_MoreLikeThisEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_MoreLikeThisEventFactory>
{
    NSArray *_components;
