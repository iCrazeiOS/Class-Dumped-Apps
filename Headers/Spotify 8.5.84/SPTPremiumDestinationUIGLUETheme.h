...
@property(readonly, copy, nonatomic) SPTPremiumDestinationUIVisualHeaderStyle<GLUEStyle> *visualHeaderStyle;
@property(readonly, copy, nonatomic) SPTPremiumDestinationUIBenefitsChartRowStyle<GLUEStyle> *benefitsChartHeaderRowStyle;
