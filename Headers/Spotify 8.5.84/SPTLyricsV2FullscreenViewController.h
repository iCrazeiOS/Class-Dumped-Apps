...
{
    _Bool _areAllowedSocialNetworksAvailable;
...
@property(nonatomic) _Bool areAllowedSocialNetworksAvailable; // @synthesize areAllowedSocialNetworksAvailable=_areAllowedSocialNetworksAvailable;
...
- (void)fullscreenFooterViewControllerDidTapShareButton:(id)arg1;
...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithTheme:(id)arg1 title:(id)arg2 track:(id)arg3 lyricsModel:(id)arg4 cardViewFrameCallback:(CDUnknownBlockType)arg5 lyricsViewFrameCallback:(CDUnknownBlockType)arg6 shareCallback:(CDUnknownBlockType)arg7 lyricsConfiguration:(id)arg8 vocalRemovalConfiguration:(id)arg9;
