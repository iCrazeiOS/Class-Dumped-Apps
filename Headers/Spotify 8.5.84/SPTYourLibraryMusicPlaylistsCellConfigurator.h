...
@protocol GLUEImageLoader, _TtP19YourLibraryXFeature41SPTYourLibraryXAssistantBannerViewFactory_;
...
- (void)configureAssistantCell:(id)arg1 withViewModel:(id)arg2;
- (void)configureCell:(id)arg1 withViewModel:(id)arg2;
@property(readonly, nonatomic) double preferredAssistantCellHeight;
@property(readonly, nonatomic) double preferredCellHeight;
- (id)initWithImageLoader:(id)arg1 theme:(id)arg2 style:(id)arg3 assistantBannerViewFactory:(id)arg4;
