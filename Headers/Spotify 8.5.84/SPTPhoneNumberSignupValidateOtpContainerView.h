...
@class GLUEButton, GLUEGradientView, GLUELabel, NSLayoutConstraint, NSString, SPTLoginLoadingActionButton, SPTPhoneNumberSignupA11yEnvironment, SPTPhoneNumberSignupBannerView, SPTPhoneNumberSignupInputFieldStackView, SPTPhoneNumberSignupValidateOtpContainerViewStyle, UIScrollView;
...
- (void)setInputFieldAccessibilityLabelForInputFieldAtIndex:(unsigned long long)arg1 accessibilityLabel:(id)arg2;
...
- (id)initWithTheme:(id)arg1 numberOfInputs:(unsigned long long)arg2 delegate:(id)arg3 a11yEnvironment:(id)arg4;
