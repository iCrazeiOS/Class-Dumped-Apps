...
@class NSArray, NSMutableArray, NSSet, NSString, SPTAccessory, SPTCarPlayContentItemBuilder, SPTCarPlayContentTreeCache, SPTCarPlayContinuePlayingFeature, SPTCarPlayFeatureProperties, SPTCarPlayUBILogger;
...
- (id)parseHomeviewResponseAndFlattenAllShelves:(id)arg1;
- (id)parseHomeviewResponseAndFlattenShortcuts:(id)arg1;
- (unsigned long long)handleHomeResponse:(id)arg1 forParent:(id)arg2 withIndexPath:(id)arg3;
