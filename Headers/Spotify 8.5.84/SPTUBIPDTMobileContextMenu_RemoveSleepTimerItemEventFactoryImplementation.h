...
#import "SPTUBIPDTMobileContextMenu_RemoveSleepTimerItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_RemoveSleepTimerItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_RemoveSleepTimerItemEventFactory>
{
    NSArray *_components;
