...
#import "SPTUBIMobileSocialListening_ErrorLayoutEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListening_ErrorLayoutEventFactoryImplementation : NSObject <SPTUBIMobileSocialListening_ErrorLayoutEventFactory>
{
    NSArray *_components;
