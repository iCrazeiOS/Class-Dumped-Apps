...
#import "SPTUBIMobileTabBar_TabBarEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileTabBar_TabBarEventFactoryImplementation : NSObject <SPTUBIMobileTabBar_TabBarEventFactory>
{
    NSArray *_components;
