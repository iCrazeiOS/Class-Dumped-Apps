...
#import "SPTUBIMobileHome_Shortcuts_SectionHeaderEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_Shortcuts_SectionHeaderEventFactoryImplementation : NSObject <SPTUBIMobileHome_Shortcuts_SectionHeaderEventFactory>
{
    NSArray *_components;
