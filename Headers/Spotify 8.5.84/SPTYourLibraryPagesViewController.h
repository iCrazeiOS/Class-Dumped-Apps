...
@class NSArray, NSDictionary, NSNumber, NSString, SPTYourLibraryLogger, SPTYourLibraryPageViewController, SPTYourLibraryPageViewControllerScrollToSectionDatasource;
...
- (void).cxx_destruct;
@property(nonatomic) __weak SPTYourLibraryLogger *logger; // @synthesize logger=_logger;
