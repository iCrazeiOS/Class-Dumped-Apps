...
#import "_TtP20IntentsRouterFeature16SPTIntentHandler_-Protocol.h"
...
@interface SPTSiriIntentsHandlerImplementation : NSObject <SPTLoginStateControllerObserver, SPTPlayerObserver, SPTSiriIntentsHandler, _TtP20IntentsRouterFeature16SPTIntentHandler_>
{
    _Bool _backgrounded;
...
- (void)handleIntent:(id)arg1 measurements:(id)arg2 isColdStartup:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
