...
@class NSMutableArray, NSString, SPTDataLoader, SPTImageLoaderCache, SPTImageLoaderRegistry, SPTImageLoaderTimeMeasurementFactory, SPTPersistentCache;
...
- (id)init;
- (void)endTimeMeasurementForRequest:(id)arg1 source:(id)arg2 result:(id)arg3;
- (void)startTimeMeasurementForRequest:(id)arg1;
...
- (id)decodeImage:(id)arg1 toSize:(struct CGSize)arg2 allowUpscaling:(_Bool)arg3 timeMeasurement:(id)arg4;
...
- (void)imageLoaded:(id)arg1 forRequest:(id)arg2 source:(id)arg3;
