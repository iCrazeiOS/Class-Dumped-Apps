...
- (id)initWithItemURI:(id)arg1 contextSourceURI:(id)arg2 itemName:(id)arg3 creatorName:(id)arg4 sourceName:(id)arg5 itemImageURL:(id)arg6 itemType:(long long)arg7 clipboardLinkTitle:(id)arg8 logContext:(id)arg9 stickerImage:(id)arg10 fullscreenBackgroundImage:(id)arg11 freeText:(id)arg12 extraQueryItems:(id)arg13 capability:(unsigned long long)arg14 integration:(id)arg15;
