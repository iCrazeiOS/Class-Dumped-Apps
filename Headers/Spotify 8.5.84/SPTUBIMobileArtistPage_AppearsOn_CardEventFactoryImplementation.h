...
#import "SPTUBIMobileArtistPage_AppearsOn_CardEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileArtistPage_AppearsOn_CardEventFactoryImplementation : NSObject <SPTUBIMobileArtistPage_AppearsOn_CardEventFactory>
{
    NSArray *_components;
