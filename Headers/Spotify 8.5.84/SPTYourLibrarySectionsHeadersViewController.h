...
@class NSLayoutConstraint, NSMutableDictionary, NSString, SPTYourLibraryGLUETheme, SPTYourLibraryLogger, SPTYourLibraryPageViewController;
@protocol SPTYourLibrarySectionsHeadersViewControllerDelegate, SPTYourLibraryViewModel;

@interface SPTYourLibrarySectionsHeadersViewController : UIViewController <SPTYourLibraryPageViewControllerDelegate, SPTYourLibraryPageViewControllerDataSource, SPTYourLibrarySectionHeaderViewControllerDelegate, GLUEThemeObserver, SPTYourLibraryViewModelObserver>
{
