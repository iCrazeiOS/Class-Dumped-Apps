...
#import "SPTNowPlayingThumbsDownButtonUBILogger-Protocol.h"
#import "SPTNowPlayingThumbsUpButtonUBILogger-Protocol.h"
#import "SPTNowPlayingTrackTitleLabelUBILogger-Protocol.h"
#import "SPTNowPlayingViewUBILogger-Protocol.h"

@class NSString;
@protocol SPTUBILogger, SPTUBIMobileNowPlayingViewPlaylistSteeringEventFactory;

@interface SPTNowPlayingPlaylistSteeringModeUBILoggerImplementation : NSObject <SPTNowPlayingViewUBILogger, SPTNowPlayingScrollUBILogger, SPTNowPlayingQueueButtonUBILogger, SPTNowPlayingConnectButtonUBILogger, SPTNowPlayingSkipNextButtonUBILogger, SPTNowPlayingPlayButtonUBILogger, SPTNowPlayingSkipPreviousButtonUBILogger, SPTNowPlayingProgressBarUBILogger, SPTNowPlayingHeartButtonUBILogger, SPTNowPlayingArtistLabelUBILogger, SPTNowPlayingTrackTitleLabelUBILogger, SPTNowPlayingCoverArtUBILogger, SPTNowPlayingContextMenuButtonUBILogger, SPTNowPlayingPlaybackSourceLabelUBILogger, SPTNowPlayingCloseButtonUBILogger, SPTNowPlayingThumbsUpButtonUBILogger, SPTNowPlayingThumbsDownButtonUBILogger>
{
    id <SPTUBILogger> _ubiLogger;
    id <SPTUBIMobileNowPlayingViewPlaylistSteeringEventFactory> _eventFactory;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) id <SPTUBIMobileNowPlayingViewPlaylistSteeringEventFactory> eventFactory; // @synthesize eventFactory=_eventFactory;
@property(readonly, nonatomic) id <SPTUBILogger> ubiLogger; // @synthesize ubiLogger=_ubiLogger;
- (void)logThumbsDownButtonTappedWithFeedbackButtonBehavior:(long long)arg1 playerState:(id)arg2;
- (void)logThumbsUpButtonTappedWithFeedbackButtonBehavior:(long long)arg1 playerState:(id)arg2;
