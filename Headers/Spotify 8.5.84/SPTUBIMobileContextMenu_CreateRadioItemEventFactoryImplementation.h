...
#import "SPTUBIMobileContextMenu_CreateRadioItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_CreateRadioItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_CreateRadioItemEventFactory>
{
    NSArray *_components;
