...
@class NSString;
@protocol HUBContentOperationDelegate, SPTNetworkConnectivityController, SPTOfflineContentModel, SPTOfflineContentModelEntity, SPTProductState, SPTUBIHubsUtilities;
...
- (id)initWithOfflineMusicModel:(id)arg1 offlinePodcastModel:(id)arg2 productState:(id)arg3 networkConnectivityController:(id)arg4 ubiHubsInstrumentation:(id)arg5;
