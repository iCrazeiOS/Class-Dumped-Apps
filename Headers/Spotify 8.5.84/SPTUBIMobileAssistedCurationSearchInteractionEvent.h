...
@class NSArray, NSDictionary, NSString, SPTUBIMobileAssistedCurationSearchInteractionEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearchInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileAssistedCurationSearchInteractionEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobileAssistedCurationSearchInteractionEventLocation *location; // @synthesize location=_location;
