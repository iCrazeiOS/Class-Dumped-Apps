...
#import "SPTUBIMobilePlaylistEntity_Header_CollaboratorsEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_Header_CollaboratorsEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_Header_CollaboratorsEventFactory>
{
    NSArray *_components;
