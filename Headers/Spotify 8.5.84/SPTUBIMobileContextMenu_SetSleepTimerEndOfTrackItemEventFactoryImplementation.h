...
#import "SPTUBIMobileContextMenu_SetSleepTimerEndOfTrackItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_SetSleepTimerEndOfTrackItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_SetSleepTimerEndOfTrackItemEventFactory>
{
    NSArray *_components;
