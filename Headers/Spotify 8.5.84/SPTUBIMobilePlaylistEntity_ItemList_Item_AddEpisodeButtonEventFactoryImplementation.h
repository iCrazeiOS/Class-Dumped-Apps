...
#import "SPTUBIMobilePlaylistEntity_ItemList_Item_AddEpisodeButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_ItemList_Item_AddEpisodeButtonEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_ItemList_Item_AddEpisodeButtonEventFactory>
{
    NSArray *_components;
