...
#import "SPTUBIMobileBrowse_List_SectionFooterEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileBrowse_List_SectionFooterEventFactoryImplementation : NSObject <SPTUBIMobileBrowse_List_SectionFooterEventFactory>
{
    NSArray *_components;
