...
@class NSLayoutConstraint, SPTLyricsV2ShareButton, SPTNowPlayingButton, SPTNowPlayingDurationViewV2, SPTVocalRemovalMenuButton, SPTVocalRemovalToggleButton;
...
@property(retain, nonatomic) SPTLyricsV2ShareButton *shareButton; // @synthesize shareButton=_shareButton;
