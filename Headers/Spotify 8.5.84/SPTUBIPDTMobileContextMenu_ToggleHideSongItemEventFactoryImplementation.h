...
#import "SPTUBIPDTMobileContextMenu_ToggleHideSongItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ToggleHideSongItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ToggleHideSongItemEventFactory>
{
    NSArray *_components;
