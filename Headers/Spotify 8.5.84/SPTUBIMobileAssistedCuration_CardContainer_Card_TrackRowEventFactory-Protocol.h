...
@class NSURL;
@protocol SPTUBIEventAbsoluteLocation, SPTUBIEventLocation, SPTUBIInteractionEvent, SPTUBIMobileAssistedCuration_CardContainer_Card_TrackRow_AddButtonEventFactory, SPTUBIMobileAssistedCuration_CardContainer_Card_TrackRow_AlbumCoverEventFactory, SPTUBIMobileAssistedCuration_CardContainer_Card_TrackRow_HeartButtonEventFactory;
