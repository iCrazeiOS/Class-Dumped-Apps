...
#import "SPTUBIMobileBrowse_List_RowEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileBrowse_List_RowEventFactoryImplementation : NSObject <SPTUBIMobileBrowse_List_RowEventFactory>
{
    NSArray *_components;
