...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBarEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBarEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBarEventFactory>
{
    NSArray *_components;
