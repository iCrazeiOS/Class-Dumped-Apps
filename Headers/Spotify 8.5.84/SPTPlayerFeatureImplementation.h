...
@class NSString, SPTAllocationContext, SPTAudioSessionControllerImpl, SPTPlaybackErrorPicker, SPTPlayerFeatureProperties, SPTPlayerSubscription;
@protocol CosmosFeature, SPTContainerService, SPTContainerUIService, SPTCoreService, SPTDebugService, SPTFeatureFlaggingService, SPTNetworkService, SPTPlaybackErrorDialogs, SPTPlayer, SPTPlayerLocalObservers, SPTRemoteConfigurationService, SPTResolver, SPTSessionService, SPTSettingsFeature, _TtP18CoreSessionFeature21SPTCoreSessionService_;
...
@interface SPTPlayerFeatureImplementation : NSObject <SPTPlayerFeature>
{
    ...
    SPTPlayerFeatureProperties *_properties;
    _Bool _initialized;
