...
@interface SPTFreeTierAlbumTrackRowComponentView : HUBComponentView <SPTEncoreTrackRowDelegate, HUBComponentViewWithEvents, SPTHubSwipeableTableViewCellComponentView>
{
...
- (id)initWithFrame:(struct CGRect)arg1 encoreComponentFactory:(id)arg2;
