...
#import "SPTUBIPDTMobileContextMenu_BrowseArtistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_BrowseArtistItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_BrowseArtistItemEventFactory>
{
    NSArray *_components;
