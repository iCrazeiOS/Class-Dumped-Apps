...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformationEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformationEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformationEventFactory>
{
    NSArray *_components;
