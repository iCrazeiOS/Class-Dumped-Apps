...
@class NSArray, NSString, SPTUBIMobileNowPlayingViewPlaylistSteeringEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteeringImpressionEvent : NSObject <SPTUBIImpressionEvent>
{
    SPTUBIMobileNowPlayingViewPlaylistSteeringEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobileNowPlayingViewPlaylistSteeringEventLocation *location; // @synthesize location=_location;
