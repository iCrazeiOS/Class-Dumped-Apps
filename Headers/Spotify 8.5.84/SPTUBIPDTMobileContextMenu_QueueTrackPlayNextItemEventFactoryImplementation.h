...
#import "SPTUBIPDTMobileContextMenu_QueueTrackPlayNextItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_QueueTrackPlayNextItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_QueueTrackPlayNextItemEventFactory>
{
    NSArray *_components;
