...
@property(readonly, nonatomic, getter=isRadioFallbackEnabled) _Bool radioFallbackEnabled;
@property(readonly, nonatomic, getter=isSpacesContentServiceEnabled) _Bool recommendationServiceEnabled;
