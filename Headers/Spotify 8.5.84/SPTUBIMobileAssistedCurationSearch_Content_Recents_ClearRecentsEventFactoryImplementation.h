...
#import "SPTUBIMobileAssistedCurationSearch_Content_Recents_ClearRecentsEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_Content_Recents_ClearRecentsEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_Content_Recents_ClearRecentsEventFactory>
{
    NSArray *_components;
