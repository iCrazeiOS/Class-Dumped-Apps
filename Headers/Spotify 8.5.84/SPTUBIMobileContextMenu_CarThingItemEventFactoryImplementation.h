...
#import "SPTUBIMobileContextMenu_CarThingItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_CarThingItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_CarThingItemEventFactory>
{
    NSArray *_components;
