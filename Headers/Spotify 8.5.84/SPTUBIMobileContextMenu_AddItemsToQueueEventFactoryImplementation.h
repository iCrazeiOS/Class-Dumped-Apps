...
#import "SPTUBIMobileContextMenu_AddItemsToQueueEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_AddItemsToQueueEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_AddItemsToQueueEventFactory>
{
    NSArray *_components;
