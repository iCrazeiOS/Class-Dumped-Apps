...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBar_ConnectButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBar_ConnectButtonEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBar_ConnectButtonEventFactory>
{
    NSArray *_components;
