...
#import "SPTUBIPDTMobileContextMenu_PodcastMixDislikeShowItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_PodcastMixDislikeShowItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_PodcastMixDislikeShowItemEventFactory>
{
    NSArray *_components;
