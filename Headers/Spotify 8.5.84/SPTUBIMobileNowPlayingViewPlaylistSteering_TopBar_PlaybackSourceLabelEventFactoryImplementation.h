...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_TopBar_PlaybackSourceLabelEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_TopBar_PlaybackSourceLabelEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_TopBar_PlaybackSourceLabelEventFactory>
{
    NSArray *_components;
