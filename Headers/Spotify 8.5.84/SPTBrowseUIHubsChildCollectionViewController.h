...
@property(readonly, nonatomic) __weak HUBComponentView<HUBComponentViewWithChildren><HUBComponentViewWithEvents> *parentComponentView; // @synthesize parentComponentView=_parentComponentView;
