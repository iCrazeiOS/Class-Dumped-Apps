...
@interface SPTBannerWindowPresenter : NSObject <SPTBannerWindowRootViewControllerDelegate, SPTStatusBarManagerObserver, SPTBannerPresenter>
{
    ...
    CDUnknownBlockType _mainWindowProvider;
    UIScreen *_screen;
...
@property(readonly, nonatomic) CDUnknownBlockType mainWindowProvider; // @synthesize mainWindowProvider=_mainWindowProvider;
...
- (id)initWithMainWindow:(CDUnknownBlockType)arg1 screen:(id)arg2 statusBarManager:(id)arg3;
