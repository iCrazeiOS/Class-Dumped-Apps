...
@protocol GLUETheme, SPTBarButtonItemManager, SPTCollectionArtistModel, SPTCollectionPlatformTestManager, SPTConnectivityManager, SPTContextMenuPresenter, SPTImageLoader, SPTModalPresentationController, SPTPageContainer, SPTProductState, SPTShelves;
...
@property(readonly, nonatomic) id <SPTConnectivityManager> connectivityManager; // @synthesize connectivityManager=_connectivityManager;
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithArtistModel:(id)arg1 productState:(id)arg2 shelves:(id)arg3 imageLoader:(id)arg4 connectivityManager:(id)arg5 logger:(id)arg6 barButtonItemManager:(id)arg7 collectionTestManager:(id)arg8 modalPresentationController:(id)arg9;
