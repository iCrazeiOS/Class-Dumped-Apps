...
#import "SPTUBIMobileSocialListeningParticipants_Toolbar_InviteButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListeningParticipants_Toolbar_InviteButtonEventFactoryImplementation : NSObject <SPTUBIMobileSocialListeningParticipants_Toolbar_InviteButtonEventFactory>
{
    NSArray *_components;
