...
#import "SPTUBIMobileLyrics_CardView_ShareButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileLyrics_CardView_ShareButtonEventFactoryImplementation : NSObject <SPTUBIMobileLyrics_CardView_ShareButtonEventFactory>
{
    NSArray *_components;
