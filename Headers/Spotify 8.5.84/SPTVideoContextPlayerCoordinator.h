...
@protocol BMBetamaxPlayer, BMEventObserverFactory, BMPlaybackIdentity, BMVideoSurfaceManager, OS_dispatch_queue, SPTDistractionControl, SPTVideoContextPlayerCoordinatorErrorHandler, SPTVideoPlayerFactory;
