...
@class NSString, SPTAllocationContext, SPTSiriIntentsFeatureProperties, SPTSiriIntentsHandlerImplementation, SPTSiriIntentsKeepAliveHandler, SPTSiriIntentsVocabularyManager;
@protocol GaiaFeature, SPTLoginService, SPTNetworkService, SPTPlayerFeature, SPTPlaylistPlatformService, SPTRemoteConfigurationService, SPTSessionService, _TtP19CarDetectionFeature22SPTCarDetectionService_, _TtP20IntentsRouterFeature23SPTIntentsRouterService_;
...
@interface SPTSiriIntentsServiceImplementation : NSObject <SPTSiriIntentsService>
{
    ...
    SPTSiriIntentsHandlerImplementation *_intentsHandler;
    ...
    id <_TtP20IntentsRouterFeature23SPTIntentsRouterService_> _intentsRouterService;
...
@property(nonatomic) __weak id <_TtP20IntentsRouterFeature23SPTIntentsRouterService_> intentsRouterService; // @synthesize intentsRouterService=_intentsRouterService;
...
@property(retain, nonatomic) SPTSiriIntentsHandlerImplementation *intentsHandler; // @synthesize intentsHandler=_intentsHandler;
