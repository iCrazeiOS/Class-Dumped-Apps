...
@class NSURL;
@protocol SPTUBIEventAbsoluteLocation, SPTUBIEventLocation, SPTUBIMobilePlaylistEntity_ItemList_ItemEventFactory, SPTUBIMobilePlaylistEntity_ItemList_ShuffleEducationEventFactory, SPTUBIMobilePlaylistEntity_ItemList_WeAddedSectionHeaderEventFactory;
