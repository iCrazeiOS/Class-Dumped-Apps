...
#import "SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_TopResults_ResultItem_AlbumCoverEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_TopResults_ResultItem_AlbumCoverEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_TopResults_ResultItem_AlbumCoverEventFactory>
{
    NSArray *_components;
