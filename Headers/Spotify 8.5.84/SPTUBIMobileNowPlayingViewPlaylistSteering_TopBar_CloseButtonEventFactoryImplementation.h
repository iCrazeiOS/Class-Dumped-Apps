...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_TopBar_CloseButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_TopBar_CloseButtonEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_TopBar_CloseButtonEventFactory>
{
    NSArray *_components;
