...
#import "SPTUBIMobilePlaylistEntity_Toolbar_ContextMenuButton_ReportAbuseOptionEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_Toolbar_ContextMenuButton_ReportAbuseOptionEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_Toolbar_ContextMenuButton_ReportAbuseOptionEventFactory>
{
    NSArray *_components;
