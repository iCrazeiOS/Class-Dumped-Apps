...
@interface SPTFreeTierEntityCollectionStateContentOperation : NSObject <HUBContentOperation>
{
    ...
    NSDictionary *_URLSavedMap;
    NSSet *_subscribedURLs;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSSet *subscribedURLs; // @synthesize subscribedURLs=_subscribedURLs;
@property(copy, nonatomic) NSDictionary *URLSavedMap; // @synthesize URLSavedMap=_URLSavedMap;
