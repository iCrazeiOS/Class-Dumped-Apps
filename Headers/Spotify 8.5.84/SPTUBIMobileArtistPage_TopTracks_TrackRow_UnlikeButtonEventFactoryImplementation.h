...
#import "SPTUBIMobileArtistPage_TopTracks_TrackRow_UnlikeButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileArtistPage_TopTracks_TrackRow_UnlikeButtonEventFactoryImplementation : NSObject <SPTUBIMobileArtistPage_TopTracks_TrackRow_UnlikeButtonEventFactory>
{
    NSArray *_components;
