...
@class NSArray, NSDictionary, NSString, SPTUBIMobileTabBarInteractionEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileTabBarInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileTabBarInteractionEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobileTabBarInteractionEventLocation *location; // @synthesize location=_location;
