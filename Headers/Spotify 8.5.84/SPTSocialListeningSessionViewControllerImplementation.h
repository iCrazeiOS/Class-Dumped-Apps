...
@class NSString, SPTSocialListeningFacepileItemViewConfigurator, SPTSocialListeningGLUETheme, SPTSocialListeningLoggerImplementation;
...
- (_Bool)sessionStateInitial;
- (void)seeListenersButtonTapped;
- (void)startSessionButtonTapped;
