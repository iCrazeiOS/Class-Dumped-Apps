...
#import "SPTUBIMobileHome_RecentlyPlayedEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_RecentlyPlayedEventFactoryImplementation : NSObject <SPTUBIMobileHome_RecentlyPlayedEventFactory>
{
    NSArray *_components;
