...
#import "SPTUBIMobilePlaylistAllSongs_TuningSectionEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistAllSongs_TuningSectionEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistAllSongs_TuningSectionEventFactory>
{
    NSArray *_components;
...
- (id)tuningDiscardDialogFactory;
- (id)tuningControlsSectionFactory;
- (id)tuningToolbarFactory;
- (id)absoluteLocation;
- (id)_location;
