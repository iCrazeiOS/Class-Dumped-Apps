...
#import "SPTUBIMobileContextMenu_AddAppShortcutItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_AddAppShortcutItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_AddAppShortcutItemEventFactory>
{
    NSArray *_components;
