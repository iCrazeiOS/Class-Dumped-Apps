...
- (void)presentTooltipWithIdentifier:(id)arg1 text:(id)arg2 fromRect:(struct CGRect)arg3 inView:(id)arg4 permittedArrowDirections:(unsigned long long)arg5 duration:(long long)arg6 maxNumberOfTimes:(unsigned long long)arg7 wrapsText:(_Bool)arg8;
- (void)presentTooltipWithIdentifier:(id)arg1 contentView:(id)arg2 fromRect:(struct CGRect)arg3 inView:(id)arg4 permittedArrowDirections:(unsigned long long)arg5 duration:(long long)arg6 maxNumberOfTimes:(unsigned long long)arg7 wrapsText:(_Bool)arg8;
