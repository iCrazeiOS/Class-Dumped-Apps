...
#import "SPTUBIMobilePlaylistEntity_AlgolinkingEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_AlgolinkingEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_AlgolinkingEventFactory>
{
    NSArray *_components;
