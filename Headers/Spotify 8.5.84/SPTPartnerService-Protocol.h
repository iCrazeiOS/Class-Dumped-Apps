...
@protocol SPTPartnerIntegrationRegistry, SPTPartnerIntegrationStateResolver, SPTPartnerLogger, SPTPartnerTestManager;

@protocol SPTPartnerService <SPTService>
- (id <SPTPartnerIntegrationStateResolver>)provideStateResolver;
