...
@interface SPTNowPlayingSkipBackwardButtonViewController : UIViewController <SPTNowPlayingModelObserver>
{
    SPTNowPlayingModel *_model;
    id <SPTNowPlayingPlaybackActionsHandler> _playbackActionsHandler;
    SPTNowPlayingButton *_skipBackwardButton;
}

- (void).cxx_destruct;
@property(retain, nonatomic) SPTNowPlayingButton *skipBackwardButton; // @synthesize skipBackwardButton=_skipBackwardButton;
