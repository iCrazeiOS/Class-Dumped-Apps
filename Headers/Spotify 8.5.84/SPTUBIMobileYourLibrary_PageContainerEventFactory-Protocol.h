...
@class NSURL;
@protocol SPTUBIEventAbsoluteLocation, SPTUBIEventLocation, SPTUBIInteractionEvent, SPTUBIMobileYourLibrary_PageContainer_PageItemEventFactory;

@protocol SPTUBIMobileYourLibrary_PageContainerEventFactory <NSObject>
- (id <SPTUBIInteractionEvent>)swipeUiNavigateWithDestination:(NSURL *)arg1;
