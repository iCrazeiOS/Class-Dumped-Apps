...
#import "SPTUBIMobileAssistedCurationSearchDrilldownSeeMore_Error_RetryButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearchDrilldownSeeMore_Error_RetryButtonEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearchDrilldownSeeMore_Error_RetryButtonEventFactory>
{
    NSArray *_components;
