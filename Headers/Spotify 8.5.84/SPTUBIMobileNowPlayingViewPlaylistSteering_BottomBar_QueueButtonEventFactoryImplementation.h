...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBar_QueueButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBar_QueueButtonEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBar_QueueButtonEventFactory>
{
    NSArray *_components;
