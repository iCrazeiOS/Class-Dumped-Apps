...
#import "SPTUBIMobilePlaylistAllSongs_TuningSection_TuningToolbarEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistAllSongs_TuningSection_TuningToolbarEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistAllSongs_TuningSection_TuningToolbarEventFactory>
{
    NSArray *_components;
...
- (id)tuningSaveButtonFactory;
- (id)tuningCloseButtonFactory;
- (id)absoluteLocation;
- (id)_location;
