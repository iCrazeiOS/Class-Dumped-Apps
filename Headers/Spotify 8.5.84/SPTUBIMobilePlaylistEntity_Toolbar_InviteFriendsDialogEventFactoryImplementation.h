...
#import "SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsDialogEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsDialogEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsDialogEventFactory>
{
    NSArray *_components;
...
- (id)impression;
- (id)maybeLaterButtonFactory;
- (id)makeCollaborativeButtonFactory;
- (id)absoluteLocation;
- (id)_location;
