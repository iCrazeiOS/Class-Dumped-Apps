...
#import "SPTUBIMobilePodcastepisodeEntity_Actions_AddEpisodeButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePodcastepisodeEntity_Actions_AddEpisodeButtonEventFactoryImplementation : NSObject <SPTUBIMobilePodcastepisodeEntity_Actions_AddEpisodeButtonEventFactory>
{
    NSArray *_components;
