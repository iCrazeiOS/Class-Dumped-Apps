...
#import "SPTUBIMobileContextMenu_PromoDisclosureEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_PromoDisclosureEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_PromoDisclosureEventFactory>
{
    NSArray *_components;
