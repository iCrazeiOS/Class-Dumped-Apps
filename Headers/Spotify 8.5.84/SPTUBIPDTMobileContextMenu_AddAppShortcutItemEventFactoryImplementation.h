...
#import "SPTUBIPDTMobileContextMenu_AddAppShortcutItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_AddAppShortcutItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_AddAppShortcutItemEventFactory>
{
    NSArray *_components;
...
- (id)hitAddAppShortcutWithDestination:(id)arg1;
- (id)impression;
- (id)absoluteLocation;
- (id)_location;
