...
@protocol SPTCollectionPlatform, SPTEntitySeeAllSongsService, SPTFreeTierArtistTestManager, SPTHubCommandHandlerFactory, SPTHubsRendererFactory, SPTPlayerFeature;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) id <SPTFreeTierArtistTestManager> testManager; // @synthesize testManager=_testManager;
...
- (id)createArtistViewCommandHandlerForViewURI:(id)arg1 referrerIdentifier:(id)arg2 reloadPageSignalSource:(id)arg3 explicitContentAccessManager:(id)arg4 ageVerificationProvider:(id)arg5 inAppMessageRequester:(id)arg6 ubiLogger:(id)arg7 pageInstanceIdProvider:(id)arg8;
- (id)createCommandHandlerForViewURI:(id)arg1 referrerIdentifier:(id)arg2 reloadPageSignalSource:(id)arg3 explicitContentAccessManager:(id)arg4 ageVerificationProvider:(id)arg5 inAppMessageRequester:(id)arg6 ubiLogger:(id)arg7 pageInstanceIdProvider:(id)arg8;
- (id)initWithDefaultCommandHandlerFactory:(id)arg1 playerService:(id)arg2 hubsRendererFactory:(id)arg3 allSongsService:(id)arg4 collectionPlatform:(id)arg5 testManager:(id)arg6;
