...
#import "SPTUBIMobileContextMenu_AddVideoSubtitlesItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_AddVideoSubtitlesItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_AddVideoSubtitlesItemEventFactory>
{
    NSArray *_components;
