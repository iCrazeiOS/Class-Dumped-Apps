...
#import "SPTUBIPDTMobileContextMenu_RenamePlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_RenamePlaylistItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_RenamePlaylistItemEventFactory>
{
    NSArray *_components;
