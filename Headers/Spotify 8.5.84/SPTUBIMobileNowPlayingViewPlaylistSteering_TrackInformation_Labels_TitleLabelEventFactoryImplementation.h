...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_Labels_TitleLabelEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_Labels_TitleLabelEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_Labels_TitleLabelEventFactory>
{
    NSArray *_components;
