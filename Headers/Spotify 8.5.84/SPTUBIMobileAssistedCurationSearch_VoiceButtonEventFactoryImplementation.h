...
#import "SPTUBIMobileAssistedCurationSearch_VoiceButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_VoiceButtonEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_VoiceButtonEventFactory>
{
    NSArray *_components;
