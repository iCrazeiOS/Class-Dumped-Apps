...
@class NSString, SPTObserverManager, SPTVoiceLibrarySessionHandlingOptions;
...
- (id)initWithNetworkConnectivityController:(id)arg1 offlineModeState:(id)arg2 sessionHandlingOptions:(id)arg3;
