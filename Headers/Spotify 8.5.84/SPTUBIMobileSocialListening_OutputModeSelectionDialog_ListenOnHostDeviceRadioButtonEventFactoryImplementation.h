...
#import "SPTUBIMobileSocialListening_OutputModeSelectionDialog_ListenOnHostDeviceRadioButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListening_OutputModeSelectionDialog_ListenOnHostDeviceRadioButtonEventFactoryImplementation : NSObject <SPTUBIMobileSocialListening_OutputModeSelectionDialog_ListenOnHostDeviceRadioButtonEventFactory>
{
    NSArray *_components;
