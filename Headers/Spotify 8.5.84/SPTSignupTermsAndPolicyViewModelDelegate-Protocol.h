...
- (void)termAndPolicyViewModel:(SPTSignupTermsAndPolicyViewModel *)arg1 didChangeTermsAndPolicyAcceptState:(unsigned long long)arg2;
- (void)userDidAcceptAllRequiredLicencesFromDialog:(SPTSignupTermsAndPolicyViewModel *)arg1;
@end
