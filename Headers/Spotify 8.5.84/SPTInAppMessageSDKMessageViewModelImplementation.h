...
@class NSDictionary, NSString, SPTInAppMessageSDKMessageV1, SPTInAppMessageSDKScriptMessageHandler, WKWebView, WKWebViewConfiguration;
@protocol SPTInAppMessageLogger, SPTInAppMessagePresenter, SPTInAppMessageSDKMessage;

@interface SPTInAppMessageSDKMessageViewModelImplementation : NSObject <SPTInAppMessageSDKMessageViewModel>
{
    WKWebView *_webview;
    ...
    SPTInAppMessageSDKScriptMessageHandler *_messageHandler;
}

- (void).cxx_destruct;
@property(retain, nonatomic) SPTInAppMessageSDKScriptMessageHandler *messageHandler; // @synthesize messageHandler=_messageHandler;
...
@property(nonatomic) __weak id <SPTInAppMessagePresenter> presenter; // @synthesize presenter=_presenter;
