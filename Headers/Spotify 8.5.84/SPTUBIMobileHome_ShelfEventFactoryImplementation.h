...
#import "SPTUBIMobileHome_ShelfEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_ShelfEventFactoryImplementation : NSObject <SPTUBIMobileHome_ShelfEventFactory>
{
    NSArray *_components;
...
- (id)playCardFactoryWithIdentifier:(id)arg1 position:(long long)arg2 uri:(id)arg3;
- (id)tappableSectionHeaderFactoryWithUri:(id)arg1;
