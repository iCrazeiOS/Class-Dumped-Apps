...
#import "SPTUBIMobilePlaylistAllSongs_TuningSection_TuningToolbar_TuningCloseButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistAllSongs_TuningSection_TuningToolbar_TuningCloseButtonEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistAllSongs_TuningSection_TuningToolbar_TuningCloseButtonEventFactory>
{
    NSArray *_components;
