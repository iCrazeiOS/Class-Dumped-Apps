...
#import "SPTUBIMobileContextMenu_ShowLyricsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ShowLyricsItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ShowLyricsItemEventFactory>
{
    NSArray *_components;
