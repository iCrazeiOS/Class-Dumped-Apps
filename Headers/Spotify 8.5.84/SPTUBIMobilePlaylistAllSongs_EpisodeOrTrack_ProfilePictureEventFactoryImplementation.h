...
#import "SPTUBIMobilePlaylistAllSongs_EpisodeOrTrack_ProfilePictureEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistAllSongs_EpisodeOrTrack_ProfilePictureEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistAllSongs_EpisodeOrTrack_ProfilePictureEventFactory>
{
    NSArray *_components;
