...
#import "SPTUBIMobileContextMenu_CanvasChangePlaybackSettingsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_CanvasChangePlaybackSettingsItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_CanvasChangePlaybackSettingsItemEventFactory>
{
    NSArray *_components;
