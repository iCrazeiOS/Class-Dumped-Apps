...
@class NSHashTable, NSString, SPTImageLoaderCache, SPTImageLoaderRegistry, SPTImageLoaderTimeMeasurementFactory, SPTPersistentCache;
...
- (void)enableInstrumentationWithTimeKeeper:(id)arg1 samplingPercentage:(long long)arg2;
