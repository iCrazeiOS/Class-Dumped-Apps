...
#import "SPTUBIMobileSocialListening_ConfirmJoinSessionDialog_NotNowButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListening_ConfirmJoinSessionDialog_NotNowButtonEventFactoryImplementation : NSObject <SPTUBIMobileSocialListening_ConfirmJoinSessionDialog_NotNowButtonEventFactory>
{
    NSArray *_components;
