...
@class NSString;
@protocol SPTContextMenuOptionsFactory, SPTContextMenuPresenterFactory, SPTLinkDispatcher, SPTPlayerFeature, SPTUBIPageInstanceIdentifierProvider, SPTUBIUserBehaviourInstrumentation;
...
- (id)createDefaultCommandHandlersWithViewURI:(id)arg1 referrerIdentifier:(id)arg2 interactionLogger:(id)arg3 pageIdentifier:(id)arg4;
- (id)initWithFeatureIdentifier:(id)arg1 linkDispatcher:(id)arg2 playerService:(id)arg3 contextMenuLogContext:(id)arg4 contextMenuOptionsFactory:(id)arg5 presenterFactory:(id)arg6 userBehaviourInstrumentation:(id)arg7 pageInstanceIdProvider:(id)arg8;
