...
#import "SPTHomeViewModelHiddenComponentsDelegate-Protocol.h"

@class NSString, SPTHomeContentOperationLoader, SPTObserverManager;
@protocol SPTHubViewModelProviderDelegate;

@interface SPTHomeViewModelProvider : SPTHubViewModelProvider <HUBViewModelLoaderDelegate, SPTHomeViewModelHiddenComponentsDelegate>
{
...
- (void)hiddenComponentsDidChange:(id)arg1;
