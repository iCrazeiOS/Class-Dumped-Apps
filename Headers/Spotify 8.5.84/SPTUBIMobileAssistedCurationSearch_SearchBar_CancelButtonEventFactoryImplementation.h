...
#import "SPTUBIMobileAssistedCurationSearch_SearchBar_CancelButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_SearchBar_CancelButtonEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_SearchBar_CancelButtonEventFactory>
{
    NSArray *_components;
