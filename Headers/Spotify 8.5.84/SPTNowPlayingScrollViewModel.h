...
@interface SPTNowPlayingScrollViewModel : NSObject <SPTNowPlayingModelObserver, SPTNowPlayingModeResolverObserver, SPTBannerPresentationObserver, SPTNowPlayingScrollDataSourceDelegate>
{
...
- (void)dataSource:(id)arg1 providerPreferredContentSizeDidChange:(id)arg2;
