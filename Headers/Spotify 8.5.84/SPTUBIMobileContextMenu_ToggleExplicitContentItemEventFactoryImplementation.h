...
#import "SPTUBIMobileContextMenu_ToggleExplicitContentItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ToggleExplicitContentItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ToggleExplicitContentItemEventFactory>
{
    NSArray *_components;
