...
@interface SPTPodcastEpisodeServiceImplementation : SPTUIPageService <SPTPodcastEpisodeService>
{
    ...
    id <_TtP27PodcastInteractivityFeature13SPTQnAService_> _qnaService;
...
@property(nonatomic) __weak id <_TtP27PodcastInteractivityFeature13SPTQnAService_> qnaService; // @synthesize qnaService=_qnaService;
