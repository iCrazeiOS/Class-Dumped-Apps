...
@class NSString, SPTHomeUIComponentDependencies, SPTHomeUILargeRowView, UILongPressGestureRecognizer, UITapGestureRecognizer;
...
- (void)configureAccessibilityWithModel:(id)arg1;
