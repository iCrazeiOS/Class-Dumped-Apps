...
#import "SPTUBIMobileAssistedCurationSearch_Content_Recents_RecentItem_AlbumCoverEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_Content_Recents_RecentItem_AlbumCoverEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_Content_Recents_RecentItem_AlbumCoverEventFactory>
{
    NSArray *_components;
