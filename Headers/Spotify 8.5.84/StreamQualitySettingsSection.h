...
@protocol SPTInAppMessageMessageRequester, SPTProductState, _TtP22CorePreferencesFeature14SPTPreferences_;
...
- (id)initWithSettingsViewController:(id)arg1 productState:(id)arg2 inAppMessageRequester:(id)arg3 preferences:(id)arg4 dataSaverActivated:(_Bool)arg5 logger:(id)arg6 settingType:(long long)arg7;
