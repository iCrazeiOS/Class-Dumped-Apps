...
#import "SPTUBIPDTMobileContextMenu_QueueTrackPlayLaterItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_QueueTrackPlayLaterItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_QueueTrackPlayLaterItemEventFactory>
{
    NSArray *_components;
