...
#import "SPTUBIMobileHome_PageHeader_WelcomeBannerEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_PageHeader_WelcomeBannerEventFactoryImplementation : NSObject <SPTUBIMobileHome_PageHeader_WelcomeBannerEventFactory>
{
    NSArray *_components;
