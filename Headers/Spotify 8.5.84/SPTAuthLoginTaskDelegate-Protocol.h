...
- (void)loginTask:(SPTAuthLoginTask *)arg1 didRequireBootstrapUsingWebgateSession:(id <SPTAuthWebgateSession>)arg2 completionCallback:(void (^)(_Bool, NSDictionary *))arg3;
