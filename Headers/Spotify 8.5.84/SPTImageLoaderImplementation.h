...
@class NSHashTable, NSString, SPTImageLoaderEntityImageTracker, SPTImageLoaderRemoteImplementation, SPTImageLoaderTimeMeasurementFactory, SPTPersistentCache;
...
@property(retain, nonatomic) SPTImageLoaderTimeMeasurementFactory *timeMeasurementFactory;
