...
#import "SPTUBIPDTMobileContextMenu_CanvasEnhancedPlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_CanvasEnhancedPlaylistItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_CanvasEnhancedPlaylistItemEventFactory>
{
    NSArray *_components;
