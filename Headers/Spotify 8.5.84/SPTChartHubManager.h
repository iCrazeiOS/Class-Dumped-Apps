...
@protocol GLUETheme, HUBIconImageResolver, SPTHubCommandHandlerFactory, SPTHubsRendererFactory, SPTHugsFactory, SPTShelves;
...
- (id)viewControllerForURL:(id)arg1 pageIdentifier:(id)arg2 referrerIdentifier:(id)arg3 contentDecorator:(id)arg4 cardAccessibilityContentOperation:(id)arg5 podcastChartsComponents:(id)arg6;
- (id)initWithServiceIdentifier:(id)arg1 hubsRendererFactory:(id)arg2 hugsFactory:(id)arg3 theme:(id)arg4 shelves:(id)arg5 glueTheme:(id)arg6;
