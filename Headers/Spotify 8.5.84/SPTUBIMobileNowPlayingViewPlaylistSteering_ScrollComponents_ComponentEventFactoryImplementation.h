...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_ScrollComponents_ComponentEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_ScrollComponents_ComponentEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_ScrollComponents_ComponentEventFactory>
{
    NSArray *_components;
