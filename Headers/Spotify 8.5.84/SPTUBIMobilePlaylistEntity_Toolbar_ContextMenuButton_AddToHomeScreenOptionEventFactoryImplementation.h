...
#import "SPTUBIMobilePlaylistEntity_Toolbar_ContextMenuButton_AddToHomeScreenOptionEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_Toolbar_ContextMenuButton_AddToHomeScreenOptionEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_Toolbar_ContextMenuButton_AddToHomeScreenOptionEventFactory>
{
    NSArray *_components;
