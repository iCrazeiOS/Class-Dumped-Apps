...
@class NSError, SPTAuthAppleSignInCredentials, SPTAuthGoogleSignInCredentials, SPTAuthLoginCredentials, SPTAuthLoginOptions, SPTAuthOneTimeTokenCredentials, SPTAuthPhoneNumberIdentifier;
...
- (void)loginWithGoogleCredentials:(SPTAuthGoogleSignInCredentials *)arg1 options:(SPTAuthLoginOptions *)arg2 onLoginComplete:(void (^)(NSError *))arg3 onSignupRequired:(void (^)(SPTAuthSignupInfo *))arg4;
