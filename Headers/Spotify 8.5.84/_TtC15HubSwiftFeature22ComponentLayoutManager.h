...
@interface _TtC15HubSwiftFeature22ComponentLayoutManager : NSObject
{
    // Error parsing type: , name: animationDelegate
    // Error parsing type: , name: hubsLayoutManager
}

- (void).cxx_destruct;
- (id)init;
- (id)collectionView:(id)arg1 layout:(id)arg2 finalLayoutAttributesForDisappearingItemAtIndexPath:(id)arg3 startingAttributes:(id)arg4;
