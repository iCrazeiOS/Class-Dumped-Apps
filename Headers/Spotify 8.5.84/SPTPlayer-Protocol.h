...
@class NSString, NSURL, OS_dispatch_queue, SPTAddToQueueOptions, SPTCommandOptions, SPTLoggingParams, SPTPauseOptions, SPTPlayOptions, SPTPlayOrigin, SPTPlayerContext, SPTPlayerOptionOverrides, SPTPlayerQueue, SPTPlayerState, SPTPlayerTrack, SPTSeekOptions, SPTSkipNextOptions, SPTSkipPrevOptions, SPTask;
...
- (SPTask *)skipToNextTrackWithOptions:(SPTSkipNextOptions *)arg1 track:(SPTPlayerTrack *)arg2;
- (SPTask *)skipToPreviousTrackWithOptions:(SPTSkipPrevOptions *)arg1 track:(SPTPlayerTrack *)arg2;
- (SPTask *)skipToNextTrackWithOptions:(SPTSkipNextOptions *)arg1;
- (SPTask *)skipToPreviousTrackWithOptions:(SPTSkipPrevOptions *)arg1;
...
- (SPTask *)playContext:(SPTPlayerContext *)arg1 options:(SPTPlayOptions *)arg2 loggingParams:(SPTLoggingParams *)arg3 viewURI:(NSURL *)arg4;
