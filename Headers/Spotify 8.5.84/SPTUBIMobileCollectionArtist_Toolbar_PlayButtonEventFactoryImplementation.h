...
#import "SPTUBIMobileCollectionArtist_Toolbar_PlayButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileCollectionArtist_Toolbar_PlayButtonEventFactoryImplementation : NSObject <SPTUBIMobileCollectionArtist_Toolbar_PlayButtonEventFactory>
{
    NSArray *_components;
