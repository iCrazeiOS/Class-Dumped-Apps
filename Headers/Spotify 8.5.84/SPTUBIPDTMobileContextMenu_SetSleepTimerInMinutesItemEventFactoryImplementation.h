...
#import "SPTUBIPDTMobileContextMenu_SetSleepTimerInMinutesItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_SetSleepTimerInMinutesItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_SetSleepTimerInMinutesItemEventFactory>
{
    NSArray *_components;
