...
@class NSString;
@protocol SPContextMenuFeature, SPTAlertInterface, SPTContextMenuPresenter, SPTFreeTierPlaylistItemsViewModel, SPTFreeTierPlaylistLogger, SPTFreeTierPlaylistViewModel;
...
- (id)initWithPlaylistViewModel:(id)arg1 itemsViewModel:(id)arg2 contextMenuService:(id)arg3 logger:(id)arg4 alertInterface:(id)arg5;
