...
#import "SPTUBIMobileContextMenu_BrowseArtistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_BrowseArtistItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_BrowseArtistItemEventFactory>
{
    NSArray *_components;
