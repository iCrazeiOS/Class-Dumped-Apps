...
@class NSString, SPTAllocationContext, SPTCarmageddonFeedbackController, SPTCarmageddonMotionBasedStateDetector, SPTCarmageddonMotionRecorderConfigurationFactory;
@protocol SPTCarmageddonRemoteConfiguration, SPTExternalIntegrationDebugLogService, SPTGLUEService, SPTNetworkService, SPTRemoteConfigurationService, SPTSettingsFeature, SPTUIPresentationService, SlateFeature;
