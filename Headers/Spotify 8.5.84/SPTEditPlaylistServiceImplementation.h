...
@protocol SPContextMenuFeature, SPTContainerService, SPTFreeTierPlaylistService, SPTGLUEService, SPTPageLoaderViewService, SPTPerformanceMetricsService, SPTPlaylistPlatformService, SPTRemoteConfigurationService, SPTSessionService, SPTSettingsFeature, SPTUBIService, SPTUIPresentationService, _TtP25PlaylistAnnotationFeature28SPTPlaylistAnnotationService_;
...
- (_Bool)shouldShowTracksInEdit;
- (id)createViewControllerForURL:(id)arg1 model:(id)arg2;
- (id)provideEditPlaylistViewControllerForURL:(id)arg1;
- (void)isPlaylistOwnedBySelf:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)shouldShowEditActionForPlaylist:(id)arg1 completion:(CDUnknownBlockType)arg2;
