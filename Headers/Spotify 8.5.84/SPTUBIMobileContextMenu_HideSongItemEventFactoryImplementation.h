...
#import "SPTUBIMobileContextMenu_HideSongItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_HideSongItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_HideSongItemEventFactory>
{
    NSArray *_components;
