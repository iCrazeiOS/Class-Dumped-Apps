...
- (id)logPlaybackToggledWithEpisode:(id)arg1 indexPath:(id)arg2 startedPlayback:(_Bool)arg3 unfinishedEpisodeCard:(_Bool)arg4;
- (_Bool)isPlayingEpisode:(id)arg1;
- (void)pauseEpisode:(id)arg1 indexPath:(id)arg2;
- (void)playEpisode:(id)arg1 indexPath:(id)arg2 loggingParams:(id)arg3;
- (void)togglePlaybackForEpisode:(id)arg1 indexPath:(id)arg2 ubiLogHandler:(CDUnknownBlockType)arg3;
...
- (id)featureId;
- (id)URI;
- (id)initWithPodcastContextMenuProvider:(id)arg1 snackbarPresenter:(id)arg2 logger:(id)arg3 podcastOffliningManager:(id)arg4 collectionLogger:(id)arg5 player:(id)arg6 explicitContentAccessManager:(id)arg7 linkDispatcher:(id)arg8 episodeProvider:(id)arg9 shouldRespectPlaybackOrder:(_Bool)arg10 yourEpisodesSaveManager:(id)arg11;
