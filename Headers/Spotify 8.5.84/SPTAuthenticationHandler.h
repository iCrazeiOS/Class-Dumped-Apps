...
@class SPTAuthenticationHandlerLogger, SPTLoginDelayedSignupAccountSwitcher, SPTLoginErrorDecorator, SPTLoginMainViewLoader;
...
- (id)initWithLoginStateController:(id)arg1 logger:(id)arg2 errorDecorator:(id)arg3 mainViewLoader:(id)arg4 accountSwitcher:(id)arg5 authLoginOptionsUtils:(id)arg6;
