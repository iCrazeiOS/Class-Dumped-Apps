...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_ThumbsUpButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_ThumbsUpButtonEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_ThumbsUpButtonEventFactory>
{
    NSArray *_components;
