...
@class NSURL;
@protocol SPTUBIEventAbsoluteLocation, SPTUBIEventLocation, SPTUBIInteractionEvent, SPTUBIMobileYourLibraryLikedSongs_ItemList_DownloadToggle_CancelEventFactory, SPTUBIMobileYourLibraryLikedSongs_ItemList_DownloadToggle_ConfirmRemoveDownloadsEventFactory;
