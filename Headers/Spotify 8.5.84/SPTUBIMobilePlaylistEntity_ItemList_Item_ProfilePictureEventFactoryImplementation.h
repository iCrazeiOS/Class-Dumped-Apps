...
#import "SPTUBIMobilePlaylistEntity_ItemList_Item_ProfilePictureEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_ItemList_Item_ProfilePictureEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_ItemList_Item_ProfilePictureEventFactory>
{
    NSArray *_components;
