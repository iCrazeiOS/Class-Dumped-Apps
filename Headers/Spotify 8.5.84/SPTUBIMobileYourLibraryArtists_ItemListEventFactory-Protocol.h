...
@class NSURL;
@protocol SPTUBIEventAbsoluteLocation, SPTUBIEventLocation, SPTUBIMobileYourLibraryArtists_ItemList_AddArtistsItemEventFactory, SPTUBIMobileYourLibraryArtists_ItemList_HiddenContentEventFactory, SPTUBIMobileYourLibraryArtists_ItemList_ItemEventFactory;
