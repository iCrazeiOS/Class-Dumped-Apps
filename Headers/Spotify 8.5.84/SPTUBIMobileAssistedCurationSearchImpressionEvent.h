...
@class NSArray, NSString, SPTUBIMobileAssistedCurationSearchEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearchImpressionEvent : NSObject <SPTUBIImpressionEvent>
{
    SPTUBIMobileAssistedCurationSearchEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobileAssistedCurationSearchEventLocation *location; // @synthesize location=_location;
