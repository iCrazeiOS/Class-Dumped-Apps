...
#import "SPTUBIMobileArtistPage_AppearsOnEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileArtistPage_AppearsOnEventFactoryImplementation : NSObject <SPTUBIMobileArtistPage_AppearsOnEventFactory>
{
    NSArray *_components;
...
- (id)cardFactoryWithPosition:(long long)arg1 uri:(id)arg2;
- (id)absoluteLocation;
- (id)_location;
