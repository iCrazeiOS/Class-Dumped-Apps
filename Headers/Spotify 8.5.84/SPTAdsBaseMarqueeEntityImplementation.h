...
@interface SPTAdsBaseMarqueeEntityImplementation : SPTAdsBaseEntityImplementation <SPTAdsBaseMarqueeEntity>
{
    ...
    NSString *_tag;
    NSString *_tagCta;
    NSString *_optoutText;
    NSString *_optoutTextCta;
    NSURL *_artistURL;
    NSString *_optOutArtistCta;
    NSString *_optOutMarqueeCta;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool isTest; // @synthesize isTest=_isTest;
@property(readonly, copy, nonatomic) NSString *optOutMarqueeCta; // @synthesize optOutMarqueeCta=_optOutMarqueeCta;
@property(readonly, copy, nonatomic) NSString *optOutArtistCta; // @synthesize optOutArtistCta=_optOutArtistCta;
@property(readonly, copy, nonatomic) NSURL *artistURL; // @synthesize artistURL=_artistURL;
@property(readonly, copy, nonatomic) NSString *optoutTextCta; // @synthesize optoutTextCta=_optoutTextCta;
@property(readonly, copy, nonatomic) NSString *optoutText; // @synthesize optoutText=_optoutText;
@property(readonly, copy, nonatomic) NSString *tagCta; // @synthesize tagCta=_tagCta;
...
@property(readonly, copy, nonatomic) NSString *disclosure; // @synthesize disclosure=_disclosure;
