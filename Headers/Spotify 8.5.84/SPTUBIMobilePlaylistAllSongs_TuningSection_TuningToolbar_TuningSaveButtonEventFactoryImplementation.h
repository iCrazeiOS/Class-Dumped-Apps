...
#import "SPTUBIMobilePlaylistAllSongs_TuningSection_TuningToolbar_TuningSaveButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistAllSongs_TuningSection_TuningToolbar_TuningSaveButtonEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistAllSongs_TuningSection_TuningToolbar_TuningSaveButtonEventFactory>
{
    NSArray *_components;
