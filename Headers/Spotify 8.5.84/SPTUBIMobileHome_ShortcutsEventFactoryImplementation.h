...
#import "SPTUBIMobileHome_ShortcutsEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_ShortcutsEventFactoryImplementation : NSObject <SPTUBIMobileHome_ShortcutsEventFactory>
{
    NSArray *_components;
