...
#import "SPTUBIMobileLyrics_ShareLyricsSelectionViewEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileLyrics_ShareLyricsSelectionViewEventFactoryImplementation : NSObject <SPTUBIMobileLyrics_ShareLyricsSelectionViewEventFactory>
{
    NSArray *_components;
