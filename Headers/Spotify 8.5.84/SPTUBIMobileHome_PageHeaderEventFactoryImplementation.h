...
#import "SPTUBIMobileHome_PageHeaderEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_PageHeaderEventFactoryImplementation : NSObject <SPTUBIMobileHome_PageHeaderEventFactory>
{
    NSArray *_components;
...
- (id)welcomeBannerFactoryWithIdentifier:(id)arg1;
- (id)tasteOnboardingFactory;
- (id)absoluteLocation;
- (id)_location;
