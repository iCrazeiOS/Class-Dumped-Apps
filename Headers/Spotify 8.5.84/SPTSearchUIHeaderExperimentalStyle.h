...
@interface SPTSearchUIHeaderExperimentalStyle : NSObject <NSCopying>
{
    UIFont *_titleFont;
    UIColor *_titleColor;
    ...
    double _buttonSide;
    double _buttonsSpacing;
    struct UIEdgeInsets _searchBarComponentsInsets;
}

+ (id)defaultStyleWithTheme:(id)arg1;
- (void).cxx_destruct;
@property(readonly, nonatomic) double buttonsSpacing; // @synthesize buttonsSpacing=_buttonsSpacing;
@property(readonly, nonatomic) double buttonSide; // @synthesize buttonSide=_buttonSide;
...
- (id)init;
- (id)initWithTitleFont:(id)arg1 titleColor:(id)arg2 searchBarTextFont:(id)arg3 searchBarTextColor:(id)arg4 searchBarColor:(id)arg5 searchBarCornerRadius:(double)arg6 spacing:(double)arg7 searchBarComponentsSpacing:(double)arg8 searchBarComponentsInsets:(struct UIEdgeInsets)arg9 buttonSide:(double)arg10 buttonsSpacing:(double)arg11;
