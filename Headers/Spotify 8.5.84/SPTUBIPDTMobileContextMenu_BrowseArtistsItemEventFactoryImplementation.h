...
#import "SPTUBIPDTMobileContextMenu_BrowseArtistsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_BrowseArtistsItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_BrowseArtistsItemEventFactory>
{
    NSArray *_components;
