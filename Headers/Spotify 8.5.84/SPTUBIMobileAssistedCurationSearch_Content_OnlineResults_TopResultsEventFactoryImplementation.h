...
#import "SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_TopResultsEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_TopResultsEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_TopResultsEventFactory>
{
    NSArray *_components;
