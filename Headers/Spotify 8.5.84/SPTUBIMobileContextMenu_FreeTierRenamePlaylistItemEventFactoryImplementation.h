...
#import "SPTUBIMobileContextMenu_FreeTierRenamePlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_FreeTierRenamePlaylistItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_FreeTierRenamePlaylistItemEventFactory>
{
    NSArray *_components;
