...
#import "SPTUBIPDTMobileContextMenu_AddShowLyricsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_AddShowLyricsItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_AddShowLyricsItemEventFactory>
{
    NSArray *_components;
