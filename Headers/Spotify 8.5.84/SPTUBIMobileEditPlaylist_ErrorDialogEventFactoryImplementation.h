...
#import "SPTUBIMobileEditPlaylist_ErrorDialogEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileEditPlaylist_ErrorDialogEventFactoryImplementation : NSObject <SPTUBIMobileEditPlaylist_ErrorDialogEventFactory>
{
    NSArray *_components;
