...
#import "SPTUBIPDTMobileContextMenu_ToggleHideArtistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ToggleHideArtistItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ToggleHideArtistItemEventFactory>
{
    NSArray *_components;
...
- (id)hitRemoveHideArtistWithItemNoLongerHidden:(id)arg1;
- (id)hitHideArtistWithItemToHide:(id)arg1;
- (id)absoluteLocation;
- (id)_location;
