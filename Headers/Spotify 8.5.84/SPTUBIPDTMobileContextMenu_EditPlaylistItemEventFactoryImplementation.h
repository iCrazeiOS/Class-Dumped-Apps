...
#import "SPTUBIPDTMobileContextMenu_EditPlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_EditPlaylistItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_EditPlaylistItemEventFactory>
{
    NSArray *_components;
