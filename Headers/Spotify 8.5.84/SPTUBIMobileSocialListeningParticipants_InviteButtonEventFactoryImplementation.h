...
#import "SPTUBIMobileSocialListeningParticipants_InviteButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListeningParticipants_InviteButtonEventFactoryImplementation : NSObject <SPTUBIMobileSocialListeningParticipants_InviteButtonEventFactory>
{
    NSArray *_components;
