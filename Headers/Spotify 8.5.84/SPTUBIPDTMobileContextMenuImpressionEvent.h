...
@class NSArray, NSString, SPTUBIPDTMobileContextMenuEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenuImpressionEvent : NSObject <SPTUBIImpressionEvent>
{
    SPTUBIPDTMobileContextMenuEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIPDTMobileContextMenuEventLocation *location; // @synthesize location=_location;
