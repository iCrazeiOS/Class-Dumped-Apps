...
- (id <SPTPlaylistPlatformDataLoaderRequestToken>)subscribePlaylistTracksForPlaylistURL:(NSURL *)arg1 options:(SPTPlaylistPlatformPlaylistTracksSubscriptionOptions *)arg2 withPolicyProtocols:(NSArray *)arg3 completion:(void (^)(SPTPlaylistPlatformDataLoaderResponse<SPTPlaylistPlatformDataLoaderField> *))arg4 onError:(void (^)(NSError *))arg5;
...
- (void)fetchPlaylistTracksForPlaylistURL:(NSURL *)arg1 options:(SPTPlaylistPlatformPlaylistTracksFetchOptions *)arg2 withPolicyProtocols:(NSArray *)arg3 replyOnMainThread:(_Bool)arg4 completion:(void (^)(SPTPlaylistPlatformDataLoaderResponse<SPTPlaylistPlatformDataLoaderField> *))arg5 onError:(void (^)(NSError *))arg6;
