...
#import "SPTUBIMobileAssistedCurationSearch_Content_Error_RetryButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_Content_Error_RetryButtonEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_Content_Error_RetryButtonEventFactory>
{
    NSArray *_components;
