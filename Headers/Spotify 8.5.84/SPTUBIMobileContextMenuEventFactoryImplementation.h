...
#import "SPTUBIMobileContextMenuEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenuEventFactoryImplementation : NSObject <SPTUBIMobileContextMenuEventFactory>
{
    NSArray *_components;
