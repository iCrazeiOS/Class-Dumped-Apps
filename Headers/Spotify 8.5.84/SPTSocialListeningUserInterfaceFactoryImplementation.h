...
@class NSString, SPTSocialListeningDialogPresenter, SPTSocialListeningGLUETheme, SPTSocialListeningListenTogetherStateManagerImplementation, SPTSocialListeningLoggerImplementation, SPTSocialListeningModelImplementation, SPTSocialListeningScannableModelImplementation;
@protocol GLUEImageLoader, SPTContainerUIService, SPTLinkDispatcher, SPTOfflineModeState, SPTPageLoaderViewService, SPTProfileUserData, SPTScannablesPresenter, SPTShareFeature, SPTSocialListeningTestManager;
...
@interface SPTSocialListeningUserInterfaceFactoryImplementation : NSObject <SPTSocialListeningUserInterfaceFactory>
{
    ...
    SPTSocialListeningScannableModelImplementation *_scannableModel;
...
@property(readonly, nonatomic) SPTSocialListeningScannableModelImplementation *scannableModel; // @synthesize scannableModel=_scannableModel;
...
- (id)initWithTheme:(id)arg1 scannablesPresenter:(id)arg2 containerUIService:(id)arg3 offlineModeState:(id)arg4 shareFeature:(id)arg5 model:(id)arg6 logger:(id)arg7 dialogPresenter:(id)arg8 imageLoader:(id)arg9 linkDispatcher:(id)arg10 testManager:(id)arg11 currentUserData:(id)arg12 pageLoaderViewService:(id)arg13 scannableModel:(id)arg14;
