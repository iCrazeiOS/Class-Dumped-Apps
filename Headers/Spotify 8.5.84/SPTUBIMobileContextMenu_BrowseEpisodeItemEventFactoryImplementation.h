...
#import "SPTUBIMobileContextMenu_BrowseEpisodeItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_BrowseEpisodeItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_BrowseEpisodeItemEventFactory>
{
    NSArray *_components;
