...
@protocol SPTContainerService, SPTFeatureFlagSignal, SPTFeatureFlaggingService, SPTLocalSettings, SPTRemoteConfigurationService, SPTSessionService, SPTSettingsFeature, _TtP22CorePreferencesFeature14SPTPreferences_, _TtP22CorePreferencesFeature25SPTCorePreferencesService_;
...
@interface SPTDataSaverServiceImplementation : NSObject <SPTDataSaverLowDataModeMonitorDelegate, SPTDataSaverService>
{
    ...
    id <_TtP22CorePreferencesFeature14SPTPreferences_> _corePreferences;
...
@property(retain, nonatomic) id <_TtP22CorePreferencesFeature14SPTPreferences_> corePreferences; // @synthesize corePreferences=_corePreferences;
...
- (id)provideAudioOnlyPodcastsSettingSection:(id)arg1;
