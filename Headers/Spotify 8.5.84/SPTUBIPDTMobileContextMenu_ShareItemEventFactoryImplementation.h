...
#import "SPTUBIPDTMobileContextMenu_ShareItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ShareItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ShareItemEventFactory>
{
    NSArray *_components;
