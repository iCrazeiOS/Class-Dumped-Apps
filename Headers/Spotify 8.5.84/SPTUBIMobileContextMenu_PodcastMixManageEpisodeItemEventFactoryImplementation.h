...
#import "SPTUBIMobileContextMenu_PodcastMixManageEpisodeItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_PodcastMixManageEpisodeItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_PodcastMixManageEpisodeItemEventFactory>
{
    NSArray *_components;
