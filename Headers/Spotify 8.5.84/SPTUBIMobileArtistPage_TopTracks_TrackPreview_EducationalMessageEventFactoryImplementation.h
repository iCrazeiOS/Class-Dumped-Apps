...
#import "SPTUBIMobileArtistPage_TopTracks_TrackPreview_EducationalMessageEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileArtistPage_TopTracks_TrackPreview_EducationalMessageEventFactoryImplementation : NSObject <SPTUBIMobileArtistPage_TopTracks_TrackPreview_EducationalMessageEventFactory>
{
    NSArray *_components;
