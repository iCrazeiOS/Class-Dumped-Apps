...
#import "SPTUBIMobileTabBar_TabBar_HomeTabEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileTabBar_TabBar_HomeTabEventFactoryImplementation : NSObject <SPTUBIMobileTabBar_TabBar_HomeTabEventFactory>
{
    NSArray *_components;
