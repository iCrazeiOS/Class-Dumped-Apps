...
#import "SPTUBIMobileHome_Promotion_Promotionv3EventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_Promotion_Promotionv3EventFactoryImplementation : NSObject <SPTUBIMobileHome_Promotion_Promotionv3EventFactory>
{
    NSArray *_components;
