...
@protocol GLUETheme, SPTLinkDispatcher, SPTPageContainer, SPTPodcastEpisodeCellActionTarget, SPTPodcastEpisodeCellConfigurator, SPTPodcastLogger, SPTPodcastPlayer, SPTShowInfoViewProvider, SPTYourLibraryPageDelegate, UIViewControllerPreviewing, _TtP19YourEpisodesFeature36SPTYourEpisodesEntryPointCellFactory_;
...
@property(retain, nonatomic) id <_TtP19YourEpisodesFeature36SPTYourEpisodesEntryPointCellFactory_> yourEpisodesEntryPointCellFactory; // @synthesize yourEpisodesEntryPointCellFactory=_yourEpisodesEntryPointCellFactory;
...
- (void)viewDidLoad;
- (id)initWithViewModel:(id)arg1 cellConfigurator:(id)arg2 theme:(id)arg3 cellActionHandler:(id)arg4 player:(id)arg5 infoViewProvider:(id)arg6 viewLogger:(id)arg7 podcastLogger:(id)arg8 yourEpisodesEntryPointCellFactory:(id)arg9 linkDispatcher:(id)arg10;
