...
#import "SPTUBIPDTMobileContextMenu_ShowCreditsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ShowCreditsItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ShowCreditsItemEventFactory>
{
    NSArray *_components;
