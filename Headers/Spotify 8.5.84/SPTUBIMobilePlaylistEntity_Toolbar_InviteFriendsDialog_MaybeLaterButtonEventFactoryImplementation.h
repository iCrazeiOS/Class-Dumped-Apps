...
#import "SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsDialog_MaybeLaterButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsDialog_MaybeLaterButtonEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsDialog_MaybeLaterButtonEventFactory>
{
    NSArray *_components;
