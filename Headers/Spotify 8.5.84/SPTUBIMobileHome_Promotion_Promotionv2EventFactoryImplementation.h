...
#import "SPTUBIMobileHome_Promotion_Promotionv2EventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_Promotion_Promotionv2EventFactoryImplementation : NSObject <SPTUBIMobileHome_Promotion_Promotionv2EventFactory>
{
    NSArray *_components;
