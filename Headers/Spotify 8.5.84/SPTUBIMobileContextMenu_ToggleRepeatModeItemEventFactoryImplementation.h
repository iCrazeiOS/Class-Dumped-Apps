...
#import "SPTUBIMobileContextMenu_ToggleRepeatModeItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ToggleRepeatModeItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ToggleRepeatModeItemEventFactory>
{
    NSArray *_components;
