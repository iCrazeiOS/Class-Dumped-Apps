...
@class GLUEViewAnimator, NSArray, NSDictionary, NSMutableDictionary, NSString, NSURL, SPTPageCreationContext;
@protocol SPTContainerUIService, SPTLinkDispatcher, SPTNavigationRouter, SPTPageContainer;
...
@property(readonly, nonatomic) SPTPageCreationContext *pageCreationContext; // @synthesize pageCreationContext=_pageCreationContext;
