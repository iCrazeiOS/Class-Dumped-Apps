...
@interface SPTSocialListeningServiceImplementation : NSObject <SPTOfflineModeStateObserver, SPTSocialListeningService>
{
    ...
    id <_TtP28SocialListeningNearbyFeature31SPTSocialListeningNearbyService_> _socialListeningNearbyService;
...
- (void).cxx_destruct;
@property(retain, nonatomic) SPTSocialListeningScannableModelImplementation *scannableModel; // @synthesize scannableModel=_scannableModel;
...
@property(nonatomic) __weak id <_TtP28SocialListeningNearbyFeature31SPTSocialListeningNearbyService_> socialListeningNearbyService; // @synthesize socialListeningNearbyService=_socialListeningNearbyService;
...
- (id)provideJoinNearbyViewControllerForURI:(id)arg1 context:(id)arg2;
- (void)offlineModeState:(id)arg1 updated:(_Bool)arg2;
- (id)buildScannableModel;
- (id)buildModel;
