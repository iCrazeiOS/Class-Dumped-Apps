...
#import "SPTUBIMobileAssistedCurationSearch_SearchBar_ScannablesButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_SearchBar_ScannablesButtonEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_SearchBar_ScannablesButtonEventFactory>
{
    NSArray *_components;
