...
@class NSString, NSURL, SPTAudioPreview, SPTDataLoaderFactory, SPTObserverManager, SPTPlayerState;
@protocol SPTAudioSessionActivator, SPTAudioSessionController, SPTPlayer, SPTProductState;
