...
#import "SPTUBIPDTMobileContextMenu_ToggleExplicitContentItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ToggleExplicitContentItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ToggleExplicitContentItemEventFactory>
{
    NSArray *_components;
...
- (id)hitNoAction;
- (id)hitReportExplicitContentWithItemToReport:(id)arg1;
- (id)impression;
- (id)absoluteLocation;
- (id)_location;
