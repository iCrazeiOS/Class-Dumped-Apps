...
@property(nonatomic, getter=shouldEndAfterTrack) _Bool endAfterTrack; // @synthesize endAfterTrack=_endAfterTrack;
...
- (void)setShouldEndAfterTrack:(_Bool)arg1;
