...
@interface SPTRadioFeatureProperties : NSObject <SPTRemoteConfigurationProperties>
{
    ...
    _Bool _radioBespokeSocialOnDemandAutoplayOverride;
}

@property(readonly, nonatomic) _Bool radioBespokeSocialOnDemandAutoplayOverride; // @synthesize radioBespokeSocialOnDemandAutoplayOverride=_radioBespokeSocialOnDemandAutoplayOverride;
