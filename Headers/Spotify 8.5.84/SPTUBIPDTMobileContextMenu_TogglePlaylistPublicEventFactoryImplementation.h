...
#import "SPTUBIPDTMobileContextMenu_TogglePlaylistPublicEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_TogglePlaylistPublicEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_TogglePlaylistPublicEventFactory>
{
    NSArray *_components;
