...
@class GMSx_GPBInt32Array, GMSx_LOGGMMAppEvent, GMSx_LOGGMMDeviceState, GMSx_LOGGMMDynamicReroutingEvent, GMSx_LOGGMMNavigationSession, GMSx_LOGGMMPageActivatedEvent, GMSx_LOGGMMUserInteraction, GMSx_LOGGMMVisualElementImpressions;
...
@property(nonatomic) _Bool alsoLoggedInClearcut; // @dynamic alsoLoggedInClearcut;
...
@property(nonatomic) _Bool hasAlsoLoggedInClearcut; // @dynamic hasAlsoLoggedInClearcut;
...
@property(retain, nonatomic) GMSx_GPBInt32Array *referencedExperimentIdArray; // @dynamic referencedExperimentIdArray;
@property(readonly, nonatomic) unsigned long long referencedExperimentIdArray_Count; // @dynamic referencedExperimentIdArray_Count;
