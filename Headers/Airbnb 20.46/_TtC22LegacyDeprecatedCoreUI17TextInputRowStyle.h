...
@interface _TtC22LegacyDeprecatedCoreUI17TextInputRowStyle : _TtCs12_SwiftObject
{
    ...
    // Error parsing type: , name: hintLabelLeftMargin
    // Error parsing type: , name: textColor
    // Error parsing type: , name: textStyle
    // Error parsing type: , name: textFieldTopMargin
