...
@interface PLKMfaDevicePaneTableViewController : UITableViewController <PLKFlowCoordinated>
{
...
- (id)accessibilityValueForMfaType:(id)arg1 mfaMask:(id)arg2;
- (id)accessibilityLabelForMfaType:(id)arg1 mfaMask:(id)arg2;
- (id)accessibilityIdentifierForMfaType:(id)arg1 mfaMask:(id)arg2;
