...
@class AIRExploreSearchParams, NSString, NSURL;

@interface AIRExploreNavigationMethod : AIRModel
{
...
+ (id)idAttributeName;
- (void).cxx_destruct;
@property(readonly, copy, nonatomic) NSString *navigationType; // @synthesize navigationType=_navigationType;
