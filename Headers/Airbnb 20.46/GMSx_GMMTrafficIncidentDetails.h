...
@class GMSx_GMMMapPointProto, GMSx_GMTTDNoticeAttribution, GMSx_GSPDDuration, NSString;
...
@property(retain, nonatomic) GMSx_GSPDDuration *lastReported; // @dynamic lastReported;
