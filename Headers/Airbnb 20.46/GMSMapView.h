...
@interface GMSMapView : UIView <GMSVectorMapViewDelegate, GMSMyLocationProviderDelegate, GMSBubbleEntityProviderDelegate, GMSRendererDelegate, GMSMapViewOverlay>
{
    ...
    struct map<GMSMarker *, gmscore::base::reffed_ptr<gmscore::vector::LabelableFeature>, std::__1::less<GMSMarker *>, std::__1::allocator<std::__1::pair<GMSMarker *const, gmscore::base::reffed_ptr<gmscore::vector::LabelableFeature>>>> _markerToLabelableFeature;
    struct map<gmscore::base::reffed_ptr<gmscore::vector::LabelableFeature>, GMSMarker *, std::__1::less<gmscore::base::reffed_ptr<gmscore::vector::LabelableFeature>>, std::__1::allocator<std::__1::pair<const gmscore::base::reffed_ptr<gmscore::vector::LabelableFeature>, GMSMarker *>>> _labelableFeatureToMarker;
...
- (id)markerForLabel:(reffed_ptr_49fb12e5)arg1;
...
- (void)vectorMapView:(id)arg1 didShowNewLabels:(const set_fa8f8985 *)arg2 updatedPlaceholders:(const vector_cf2e4e34 *)arg3;
