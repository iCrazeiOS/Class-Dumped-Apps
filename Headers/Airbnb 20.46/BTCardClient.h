...
+ (void)setPayPalDataCollectorClassString:(id)arg1;
...
- (void)collectRiskData:(id)arg1 configuration:(id)arg2;
- (_Bool)isPayPalDataCollectorAvailable;
- (_Bool)isGraphQLEnabledForCardTokenization:(id)arg1;
- (id)clientAPIParametersForCard:(id)arg1 options:(id)arg2;
- (void)sendUnionPayAnalyticsEvent:(_Bool)arg1;
- (void)sendGraphQLAnalyticsEventWithSuccess:(_Bool)arg1;
