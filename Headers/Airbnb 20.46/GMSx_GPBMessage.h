...
@class GMSx_GPBExtensionDescriptor, GMSx_GPBFieldDescriptor, GMSx_GPBUnknownFieldSet, NSMutableDictionary;

@interface GMSx_GPBMessage : NSObject <NSSecureCoding, NSCopying>
{
    GMSx_GPBUnknownFieldSet *unknownFields_;
    NSMutableDictionary *extensionMap_;
    NSMutableDictionary *autocreatedExtensionMap_;
    GMSx_GPBMessage *autocreator_;
    GMSx_GPBFieldDescriptor *autocreatorField_;
    GMSx_GPBExtensionDescriptor *autocreatorExtension_;
...
@property(copy, nonatomic) GMSx_GPBUnknownFieldSet *unknownFields;
