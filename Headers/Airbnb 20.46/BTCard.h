...
@interface BTCard : NSObject
{
    ...
    _Bool _authenticationInsightRequested;
    NSString *_number;
...
@property(nonatomic) _Bool authenticationInsightRequested; // @synthesize authenticationInsightRequested=_authenticationInsightRequested;
...
@property(readonly, nonatomic) NSString *cardTokenizationGraphQLMutation;
