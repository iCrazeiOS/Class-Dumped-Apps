...
@property(nonatomic) _Bool postalCodeRequested; // @synthesize postalCodeRequested=_postalCodeRequested;
...
@property(readonly, nonatomic) _Bool postalCodeRequired;
