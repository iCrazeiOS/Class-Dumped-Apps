...
@class NSString, PLKFlowContext, PLKMfaSelectionPaneViewModel, PLKMicrodepositsClassTypePaneTableViewController, UIButton, UISelectionFeedbackGenerator;
@protocol PLKFlowCoordinator;

@interface PLKMicrodepositsClassTypePaneViewController : UIViewController <UITableViewDelegate, PLKCustomizable, PLKFlowCoordinated>
{
    PLKMfaSelectionPaneViewModel *_viewModel;
    id <PLKFlowCoordinator> _flowCoordinator;
    PLKFlowContext *_flowContext;
    UIButton *_continueButton;
    PLKMicrodepositsClassTypePaneTableViewController *_tableViewController;
...
@property(retain, nonatomic) PLKMicrodepositsClassTypePaneTableViewController *tableViewController; // @synthesize tableViewController=_tableViewController;
