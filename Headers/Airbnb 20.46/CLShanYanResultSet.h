...
@class CLShanYanDatabase, CLShanYanStatement, NSDictionary, NSMutableDictionary, NSString;

@interface CLShanYanResultSet : NSObject
{
    NSMutableDictionary *_columnNameToIndexMap;
    CLShanYanDatabase *_parentDB;
    NSString *_query;
    CLShanYanStatement *_statement;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) CLShanYanStatement *statement; // @synthesize statement=_statement;
@property(retain) NSString *query; // @synthesize query=_query;
@property(retain, nonatomic) CLShanYanDatabase *parentDB; // @synthesize parentDB=_parentDB;
- (void).cxx_destruct;
