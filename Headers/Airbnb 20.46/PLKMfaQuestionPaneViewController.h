...
@class NSLayoutConstraint, NSString, PLKFlowContext, PLKMfaQuestionPaneViewModel, PLKStepBar, PLKTextField, UIBarButtonItem, UITextView, UIView;
@protocol PLKFlowCoordinator;

@interface PLKMfaQuestionPaneViewController : UIViewController <UITextFieldDelegate, PLKCustomizable, PLKFlowCoordinated, PLKExitHandler, PLKDevelopmentModeInfoDataSource>
{
    id <PLKFlowCoordinator> _flowCoordinator;
    PLKFlowContext *_flowContext;
    PLKMfaQuestionPaneViewModel *_viewModel;
    UITextView *_questionView;
    NSLayoutConstraint *_questionViewHeightConstraint;
    NSLayoutConstraint *_answerFieldTopConstraint;
    PLKTextField *_answerField;
    PLKStepBar *_stepBar;
...
@property(retain, nonatomic) PLKTextField *answerField; // @synthesize answerField=_answerField;
@property(retain, nonatomic) NSLayoutConstraint *answerFieldTopConstraint; // @synthesize answerFieldTopConstraint=_answerFieldTopConstraint;
@property(retain, nonatomic) NSLayoutConstraint *questionViewHeightConstraint; // @synthesize questionViewHeightConstraint=_questionViewHeightConstraint;
@property(retain, nonatomic) UITextView *questionView; // @synthesize questionView=_questionView;
@property(retain, nonatomic) PLKMfaQuestionPaneViewModel *viewModel; // @synthesize viewModel=_viewModel;
