...
+ (const struct GTICMPHeader *)icmpInPacket:(id)arg1;
...
@property(nonatomic) __weak id <GTSimplePingDelegate> delegate; // @synthesize delegate=_delegate;
