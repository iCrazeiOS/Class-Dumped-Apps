...
@interface _TtC25ConstellationOrganizeTeam14InviteGuestRow : _TtC27ConstellationElementsCoreUI14BaseMarginView
{
    // Error parsing type: , name: titleText
    // Error parsing type: , name: subtitleText
    // Error parsing type: , name: trailingButtonWasTapped
