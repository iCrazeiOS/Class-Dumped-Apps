...
@protocol YTPlaybackController, YTPlaybackControllerActiveVideoObserver, YTPlaybackControllerErrorObserver, YTPlaybackControllerEventsDelegate, YTPlaybackControllerScrubbingObserver, YTPlaybackControllerUIDelegate, YTPlayerOverlayFactory, YTResponder, YTSingleVideoObservable, YTVideoPlayerOverlayProtocol;
...
- (void)removeActiveVideoObserver:(id <YTPlaybackControllerActiveVideoObserver>)arg1;
- (void)addActiveVideoObserver:(id <YTPlaybackControllerActiveVideoObserver>)arg1;
