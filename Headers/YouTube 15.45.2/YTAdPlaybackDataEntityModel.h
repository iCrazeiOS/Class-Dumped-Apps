...
@class NSData, NSDictionary, NSString, YTIAdPlaybackDataEntity, YTTransferEntityModel;
...
@interface YTAdPlaybackDataEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIAdPlaybackDataEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIAdPlaybackDataEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
