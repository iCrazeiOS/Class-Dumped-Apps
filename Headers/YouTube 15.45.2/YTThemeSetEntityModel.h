...
@class NSData, NSDictionary, NSString, YTIThemeSetEntity;
...
@interface YTThemeSetEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIThemeSetEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIThemeSetEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
