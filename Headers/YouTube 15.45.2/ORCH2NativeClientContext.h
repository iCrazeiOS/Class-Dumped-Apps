...
@class GPBEnumArray, NSMutableArray, NSString, PFMDeviceFingerprinting_Parsed;
...
@property(retain, nonatomic) GPBEnumArray *supportedAuthTypesArray; // @dynamic supportedAuthTypesArray;
@property(readonly, nonatomic) unsigned long long supportedAuthTypesArray_Count; // @dynamic supportedAuthTypesArray_Count;
@property(retain, nonatomic) GPBEnumArray *supportedDeviceBasedInputTypesArray; // @dynamic supportedDeviceBasedInputTypesArray;
@property(readonly, nonatomic) unsigned long long supportedDeviceBasedInputTypesArray_Count; // @dynamic supportedDeviceBasedInputTypesArray_Count;
