...
@class NSDictionary, NSString, YTISectionListRenderer;
...
@interface YTEngagementPanelScrollToItemController : NSObject <YTEntityStoreObserver>
{
    ...
    YTISectionListRenderer *_sectionListRendererModel;
    NSDictionary *_sectionIdentifierIndexMap;
    id <YTEntityStore> _entityStore;
}

+ (id)sectionIdentifiersFromRenderer:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) id <YTEntityStore> entityStore; // @synthesize entityStore=_entityStore;
@property(copy, nonatomic) NSDictionary *sectionIdentifierIndexMap; // @synthesize sectionIdentifierIndexMap=_sectionIdentifierIndexMap;
@property(retain, nonatomic) YTISectionListRenderer *sectionListRendererModel; // @synthesize sectionListRendererModel=_sectionListRendererModel;
