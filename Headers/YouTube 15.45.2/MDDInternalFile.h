...
@property(nonatomic) _Bool deprecatedUsedOnlyByOlderMddVersionsDone; // @dynamic deprecatedUsedOnlyByOlderMddVersionsDone;
@property(nonatomic) _Bool hasDeprecatedUsedOnlyByOlderMddVersionsDone; // @dynamic hasDeprecatedUsedOnlyByOlderMddVersionsDone;
