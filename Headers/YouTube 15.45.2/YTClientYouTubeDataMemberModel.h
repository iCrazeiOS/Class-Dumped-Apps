...
@class NSData, YTIClientYouTubeDataMember;
...
@interface YTClientYouTubeDataMemberModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIClientYouTubeDataMember *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIClientYouTubeDataMember *protoBuf; // @synthesize protoBuf=_protoBuf;
