...
@class NSArray, NSData, NSDictionary, NSString, YTIYtMainDownloadedPlaylistEntity, YTYtMainPlaylistEntityModel;
...
@interface YTYtMainDownloadedPlaylistEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIYtMainDownloadedPlaylistEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIYtMainDownloadedPlaylistEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
