...
@class NSData, NSDictionary, NSString, YTDrmLicenseEntityModel, YTIMainAppVideoEntity, YTMainAppVideoMetadataEntityModel, YTOfflineVideoPolicyEntityModel, YTPlaybackDataEntityModel, YTTransferEntityModel;
...
@interface YTMainAppVideoEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMainAppVideoEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIMainAppVideoEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (void)videoPolicyWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTOfflineVideoPolicyEntityModel *videoPolicy;
- (void)drmLicenseWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTDrmLicenseEntityModel *drmLicense;
- (void)transferWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTTransferEntityModel *transfer;
- (void)playbackDataEntityWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTPlaybackDataEntityModel *playbackDataEntity;
- (void)mainAppVideoMetadataWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
