...
@interface UIImageView (ASMFading) <GWAMegalogsSupportingComponent, PINRemoteImageCategory>
+ (Class)layerClass;
- (void)asm_fadeToImage:(id)arg1;
...
- (id)grw_imageURL;
- (void)grw_setImageURL:(id)arg1;
- (void)grw_setImageWithURL:(id)arg1;
