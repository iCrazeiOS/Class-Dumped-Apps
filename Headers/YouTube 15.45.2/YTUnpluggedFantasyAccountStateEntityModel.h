...
@class NSData, NSDictionary, NSString, YTIUnpluggedFantasyAccountStateEntity;
...
@interface YTUnpluggedFantasyAccountStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIUnpluggedFantasyAccountStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIUnpluggedFantasyAccountStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
