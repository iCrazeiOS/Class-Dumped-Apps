...
@class NSData, NSDictionary, NSString, YTIUnpluggedOnboardingStateEntity;
...
@interface YTUnpluggedOnboardingStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIUnpluggedOnboardingStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIUnpluggedOnboardingStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
