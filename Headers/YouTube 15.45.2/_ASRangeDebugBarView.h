...
- (void)updateWithVisibleRatio:(double)arg1 displayRatio:(double)arg2 leadingDisplayRatio:(double)arg3 preloadRatio:(double)arg4 leadingpreloadRatio:(double)arg5 direction:(unsigned char)arg6;
- (void)layoutSubviews;
