...
@property(retain, nonatomic) PRMClientErrorLoggingMetric *clientErrorLoggingMetrics; // @dynamic clientErrorLoggingMetrics;
...
@property(nonatomic) _Bool hasClientErrorLoggingMetrics; // @dynamic hasClientErrorLoggingMetrics;
