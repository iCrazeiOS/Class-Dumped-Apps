...
@class NSData, NSDictionary, NSString, YTIYtMainChannelEntity, YTThumbnailDetailsModel;
...
@interface YTYtMainChannelEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIYtMainChannelEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIYtMainChannelEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
