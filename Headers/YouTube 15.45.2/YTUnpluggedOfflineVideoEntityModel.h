...
@class NSData, NSDictionary, NSString, YTIUnpluggedOfflineVideoEntity, YTPlaybackDataEntityModel, YTRefreshEntityModel, YTUnpluggedOfflineVideoMetadataEntityModel;
...
@interface YTUnpluggedOfflineVideoEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIUnpluggedOfflineVideoEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIUnpluggedOfflineVideoEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (void)refreshEntityWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTRefreshEntityModel *refreshEntity;
- (void)playbackDataWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTPlaybackDataEntityModel *playbackData;
- (void)videoMetadataWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
