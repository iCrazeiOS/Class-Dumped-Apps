...
@class GOOGRTCConfiguration, GOOGRTCPeerConnectionFactory, GOOGRTCSessionDescription, NSArray, NSMutableArray;
@protocol GOOGRTCPeerConnectionDelegate;
...
@interface GOOGRTCPeerConnection : NSObject
{
    ...
    id <GOOGRTCPeerConnectionDelegate> _delegate;
}
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(readonly, nonatomic) GOOGRTCPeerConnectionFactory *factory; // @synthesize factory=_factory;
@property(nonatomic) __weak id <GOOGRTCPeerConnectionDelegate> delegate; // @synthesize delegate=_delegate;
