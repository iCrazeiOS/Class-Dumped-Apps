...
@class NSData, NSString, YTIViewModelEntityId;
...
@interface YTViewModelEntityIdModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIViewModelEntityId *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIViewModelEntityId *protoBuf; // @synthesize protoBuf=_protoBuf;
