...
#import "GALWebOAuthFlowController-Protocol.h"
#import "SFSafariViewControllerDelegate-Protocol.h"

@class GALLogger, GALURLHandler, GALWebOAuthFlowParams, NSString, SFSafariViewController;
...
- (void)dismissSafariViewControllerWithCompletion:(CDUnknownBlockType)arg1;
- (void)completeFlowWithLink:(id)arg1 error:(id)arg2;
- (void)safariViewControllerDidFinish:(id)arg1;
- (void)presentURL:(id)arg1;
- (_Bool)handleAuthorizationCallbackURL:(id)arg1;
- (_Bool)canResumeFlowWithURL:(id)arg1;
