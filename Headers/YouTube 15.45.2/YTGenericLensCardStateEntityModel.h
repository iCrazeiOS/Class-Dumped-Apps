...
@class NSData, NSDictionary, NSString, YTIGenericLensCardStateEntity, YTUnpluggedLensClipModel;
...
@interface YTGenericLensCardStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    YTUnpluggedLensClipModel *_clip;
    YTUnpluggedLensClipModel *_visibility;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIGenericLensCardStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIGenericLensCardStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTUnpluggedLensClipModel *visibility; // @synthesize visibility=_visibility;
@property(retain, nonatomic) YTUnpluggedLensClipModel *clip; // @synthesize clip=_clip;
