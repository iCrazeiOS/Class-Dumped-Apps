...
@class NSArray, NSError, NSString, PHTPhenotypeExperimentTokens;
@protocol ASMOptions;

@protocol ASMEventLogger <NSObject>
- (void)updateExperimentTokens:(PHTPhenotypeExperimentTokens *)arg1;
- (void)logAccessingPhotoLibraryFailedOnScreen:(int)arg1 withOptions:(id <ASMOptions>)arg2 enableSingleAppSignOut:(_Bool)arg3;
- (void)logAccessingCameraFailedOnScreen:(int)arg1 withOptions:(id <ASMOptions>)arg2 enableSingleAppSignOut:(_Bool)arg3;
- (void)logRemovingProfilePhotoSucceededFromScreen:(int)arg1 withOptions:(id <ASMOptions>)arg2 rpcIdentifier:(NSString *)arg3 enableSingleAppSignOut:(_Bool)arg4;
- (void)logRemovingProfilePhotoFailedFromScreen:(int)arg1 withOptions:(id <ASMOptions>)arg2 rpcIdentifier:(NSString *)arg3 error:(NSError *)arg4 enableSingleAppSignOut:(_Bool)arg5;
- (void)logUploadingProfilePhotoSucceededFromScreen:(int)arg1 withOptions:(id <ASMOptions>)arg2 rpcIdentifier:(NSString *)arg3 enableSingleAppSignOut:(_Bool)arg4 accountHadPictureBefore:(_Bool)arg5;
- (void)logUploadingProfilePhotoFailedFromScreen:(int)arg1 withOptions:(id <ASMOptions>)arg2 rpcIdentifier:(NSString *)arg3 error:(NSError *)arg4 enableSingleAppSignOut:(_Bool)arg5 accountHadPictureBefore:(_Bool)arg6;
