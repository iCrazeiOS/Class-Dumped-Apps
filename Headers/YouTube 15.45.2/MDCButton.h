...
@class MDCInkView, MDCShapedShadowLayer, MDCStatefulRippleView, NSMutableDictionary, NSString, UIColor, UILayoutGuide, UIView;
...
@interface MDCButton : UIButton <MDCElevatable, MDCElevationOverriding>
{
    ...
    MDCInkView *_inkView;
    UIView *_visibleAreaLayoutGuideView;
...
@property(retain, nonatomic) UIView *visibleAreaLayoutGuideView; // @synthesize visibleAreaLayoutGuideView=_visibleAreaLayoutGuideView;
...
@property(readonly, nonatomic) UILayoutGuide *visibleAreaLayoutGuide; // @synthesize visibleAreaLayoutGuide=_visibleAreaLayoutGuide;
...
- (void)gmdc_applyOnSurfaceVariantWithColorScheme:(id)arg1;
- (void)gmdc_applyIconThemeWithScheme:(id)arg1;
