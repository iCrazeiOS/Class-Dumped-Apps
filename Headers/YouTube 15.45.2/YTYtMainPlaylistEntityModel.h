...
@class NSArray, NSData, NSDictionary, NSString, YTIYtMainPlaylistEntity, YTThumbnailDetailsModel, YTYtMainChannelEntityModel;
...
@interface YTYtMainPlaylistEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    NSDictionary *_thumbnailStyleData;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIYtMainPlaylistEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIYtMainPlaylistEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) NSDictionary *thumbnailStyleData; // @synthesize thumbnailStyleData=_thumbnailStyleData;
...
- (void)collaboratorChannelsArrayAtIndexes:(id)arg1 callbackQueue:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (void)channelOwnerWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
