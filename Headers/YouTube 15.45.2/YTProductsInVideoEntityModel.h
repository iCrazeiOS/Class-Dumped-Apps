...
@class NSData, NSDictionary, NSString, YTIProductsInVideoEntity;
...
@interface YTProductsInVideoEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIProductsInVideoEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIProductsInVideoEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
