...
#import <Module_Framework/YTGenericLensCardStateEntityModel.h>

#import <Module_Framework/YTMutableEntity-Protocol.h>

@class NSData, NSDictionary, NSString, YTUnpluggedLensClipModel;
...
@property(retain, nonatomic) YTUnpluggedLensClipModel *visibility; // @dynamic visibility;
@property(retain, nonatomic) YTUnpluggedLensClipModel *clip; // @dynamic clip;
