...
@class NSData, YTClientYouTubeDataModel, YTIClientVeSpec;
...
@interface YTClientVeSpecModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    YTClientYouTubeDataModel *_clientYoutubeData;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIClientVeSpec *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIClientVeSpec *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTClientYouTubeDataModel *clientYoutubeData; // @synthesize clientYoutubeData=_clientYoutubeData;
