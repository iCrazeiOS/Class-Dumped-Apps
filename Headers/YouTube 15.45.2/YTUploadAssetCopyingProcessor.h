...
- (void)removeAsset:(id)arg1 userConfirmed:(_Bool)arg2;
- (void)copyAssetWithURL:(id)arg1 toURL:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)copyAssetWithLocalIdentifier:(id)arg1 assetURL:(id)arg2 toURL:(id)arg3 completion:(CDUnknownBlockType)arg4;
