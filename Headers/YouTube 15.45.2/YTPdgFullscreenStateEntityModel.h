...
@class NSData, NSDictionary, NSString, YTIPdgFullscreenStateEntity;
...
@interface YTPdgFullscreenStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIPdgFullscreenStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIPdgFullscreenStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
