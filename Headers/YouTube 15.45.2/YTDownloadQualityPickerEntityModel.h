...
@class NSArray, NSData, NSDictionary, NSString, YTIDownloadQualityPickerEntity;
...
@interface YTDownloadQualityPickerEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIDownloadQualityPickerEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIDownloadQualityPickerEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(readonly, nonatomic) int selectedFormat;
@property(readonly, nonatomic) _Bool hasSelectedFormat;
