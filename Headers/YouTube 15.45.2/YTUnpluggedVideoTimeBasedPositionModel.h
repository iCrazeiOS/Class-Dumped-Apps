...
@class NSData, YTIUnpluggedVideoTimeBasedPosition;
...
@interface YTUnpluggedVideoTimeBasedPositionModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIUnpluggedVideoTimeBasedPosition *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIUnpluggedVideoTimeBasedPosition *protoBuf; // @synthesize protoBuf=_protoBuf;
