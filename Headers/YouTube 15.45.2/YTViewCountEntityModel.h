...
@class NSData, NSDictionary, NSString, YTFormattedStringModel, YTIViewCountEntity;
...
@interface YTViewCountEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    YTFormattedStringModel *_viewCount;
    YTFormattedStringModel *_shortViewCount;
    YTFormattedStringModel *_extraShortViewCount;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIViewCountEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIViewCountEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTFormattedStringModel *extraShortViewCount; // @synthesize extraShortViewCount=_extraShortViewCount;
@property(retain, nonatomic) YTFormattedStringModel *shortViewCount; // @synthesize shortViewCount=_shortViewCount;
@property(retain, nonatomic) YTFormattedStringModel *viewCount; // @synthesize viewCount=_viewCount;
