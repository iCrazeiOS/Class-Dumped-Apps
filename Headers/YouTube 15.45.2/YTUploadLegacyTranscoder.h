...
@class AVAssetReader, AVAssetWriter, AVAssetWriterInputPixelBufferAdaptor, NSCondition, NSString, NSURL, YTUploadLegacyTranscodeConfig;
...
@interface YTUploadLegacyTranscoder : NSObject <YTUploadTranscoder>
{
    ...
    YTUploadLegacyTranscodeConfig *_transcodeConfig;
...
- (void)transcodeAssetURL:(id)arg1 withTranscodeConfig:(id)arg2 editInstructions:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)dealloc;
- (id)init;
- (void)transcodeAssetSegmentURLs:(id)arg1 withTranscodeConfig:(id)arg2 completion:(CDUnknownBlockType)arg3;
