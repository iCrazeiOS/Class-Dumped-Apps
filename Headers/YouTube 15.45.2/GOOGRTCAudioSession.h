...
#import <Module_Framework/GOOGRTCAudioSessionActivationDelegate-Protocol.h>
...
{
    struct RecursiveCriticalSection _crit;
...
@property(readonly, nonatomic) vector_c59c89c4 delegates; // @synthesize delegates=_delegates;
