...
@class NSData, NSDictionary, NSString, YTIYtMainPlaylistVideoEntity, YTYtMainChannelEntityModel, YTYtMainVideoEntityModel;
...
@interface YTYtMainPlaylistVideoEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIYtMainPlaylistVideoEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIYtMainPlaylistVideoEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
