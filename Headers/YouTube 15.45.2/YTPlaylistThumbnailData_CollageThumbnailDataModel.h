...
@class NSData, YTIPlaylistThumbnailData_CollageThumbnailData, YTThumbnailDetailsModel;
...
@interface YTPlaylistThumbnailData_CollageThumbnailDataModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    YTThumbnailDetailsModel *_coverThumbnail;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIPlaylistThumbnailData_CollageThumbnailData *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIPlaylistThumbnailData_CollageThumbnailData *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTThumbnailDetailsModel *coverThumbnail; // @synthesize coverThumbnail=_coverThumbnail;
