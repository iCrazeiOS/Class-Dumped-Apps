...
@class NSData, NSDictionary, NSString, YTIPollAttachmentEditorOptionEntity;
...
@interface YTPollAttachmentEditorOptionEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIPollAttachmentEditorOptionEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIPollAttachmentEditorOptionEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
