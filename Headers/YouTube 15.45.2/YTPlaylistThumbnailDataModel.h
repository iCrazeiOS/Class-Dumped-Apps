...
@class NSData, YTIPlaylistThumbnailData, YTPlaylistThumbnailData_CollageThumbnailDataModel, YTThumbnailDetailsModel;
...
@interface YTPlaylistThumbnailDataModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTPlaylistThumbnailData_CollageThumbnailDataModel *_collageThumbnail;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIPlaylistThumbnailData *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIPlaylistThumbnailData *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTPlaylistThumbnailData_CollageThumbnailDataModel *collageThumbnail; // @synthesize collageThumbnail=_collageThumbnail;
