...
@class NSArray, NSData, NSString, YTILoggingUrl;
...
@interface YTLoggingUrlModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTILoggingUrl *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTILoggingUrl *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) NSArray *macrosArray; // @synthesize macrosArray=_macrosArray;
