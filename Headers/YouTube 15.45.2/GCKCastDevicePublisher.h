...
@class GCKAnalyticsEventLogger, GCKCastOptions, GCKDBNetworkInfo, GCKDatabase, GCKDevice, GCKDiscoveryCriteria, GCKNNetworkReachability, GCKProberScheduler, GCKRuntimeConfiguration, NSArray, NSMutableDictionary, NSString, NSTimer;
@protocol GCKCastDevicePublisherDelegate;

@interface GCKCastDevicePublisher : NSObject <NSObject>
{
