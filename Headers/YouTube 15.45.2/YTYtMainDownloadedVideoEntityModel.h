...
@class NSData, NSDictionary, NSString, YTIYtMainDownloadedVideoEntity, YTOfflineVideoPolicyEntityModel, YTPlaybackDataEntityModel, YTYtMainVideoEntityModel;
...
@interface YTYtMainDownloadedVideoEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIYtMainDownloadedVideoEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIYtMainDownloadedVideoEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
