...
@class NSData, YTIClientYouTubeDataMember_PlaylistItem;
...
@interface YTClientYouTubeDataMember_PlaylistItemModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIClientYouTubeDataMember_PlaylistItem *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIClientYouTubeDataMember_PlaylistItem *protoBuf; // @synthesize protoBuf=_protoBuf;
