...
@class YTIHintRenderer, YTIUnseenContentCountRenderer, YTIUnseenContentDotRenderer;
...
@property(retain, nonatomic) YTIUnseenContentDotRenderer *unseenContentDotRenderer; // @dynamic unseenContentDotRenderer;
