...
@class NSData, NSDictionary, NSString, YTIMainDownloadableVideoMetadataEntity;
...
@interface YTMainDownloadableVideoMetadataEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMainDownloadableVideoMetadataEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIMainDownloadableVideoMetadataEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
