...
@class YTICommandExecutorCommand, YTIFrameworkUpdateTransport, YTIResponseContext;

@interface YTIUpdateAutotaggingSettingsResponse : GPBMessage
{
}
...
@property(retain, nonatomic) YTICommandExecutorCommand *commands; // @dynamic commands;
