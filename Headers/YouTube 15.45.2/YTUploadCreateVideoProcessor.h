...
@class GIMMe, NSArray, NSString, YTDeleteVideoService, YTUploadCreateVideoService, YTUploadProgressProvider, YTUploadTaskStore;

@interface YTUploadCreateVideoProcessor : NSObject <YTUploadProcessor>
{
    YTUploadCreateVideoService *_createVideoService;
...
- (void)saveUploadStatusRenderer:(id)arg1 forFrontendID:(id)arg2;
- (void)handleResponse:(id)arg1 frontendID:(id)arg2 completion:(CDUnknownBlockType)arg3;
