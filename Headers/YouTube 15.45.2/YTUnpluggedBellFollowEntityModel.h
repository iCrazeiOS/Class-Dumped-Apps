...
@class NSData, NSDictionary, NSString, YTIUnpluggedBellFollowEntity;
...
@interface YTUnpluggedBellFollowEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIUnpluggedBellFollowEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIUnpluggedBellFollowEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
