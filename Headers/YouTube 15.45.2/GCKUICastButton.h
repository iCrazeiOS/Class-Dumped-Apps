...
@interface GCKUICastButton : UIButton
{
    ...
    UIImage *_castUnavailableIcon;
    UIImage *_tintedCastUnavailableIcon;
...
- (void)didTap:(id)arg1;
- (void)userDidHideCastUnavailableButtonNotification;
- (void)handleNetworkReachabilityChange;
- (void)localNetworkPermissionDidChangeNotification:(id)arg1;
- (void)discoveryDidStartTheFirstTimeNotification:(id)arg1;
