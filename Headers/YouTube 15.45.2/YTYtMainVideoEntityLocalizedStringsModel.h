...
@class NSData, NSString, YTIYtMainVideoEntityLocalizedStrings;
...
@interface YTYtMainVideoEntityLocalizedStringsModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIYtMainVideoEntityLocalizedStrings *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIYtMainVideoEntityLocalizedStrings *protoBuf; // @synthesize protoBuf=_protoBuf;
