...
#import <Module_Framework/YTOfflineVideoPolicyEntityModel.h>
...
@property(retain, nonatomic) NSString *shortMessageForDisabledAction; // @dynamic shortMessageForDisabledAction;
...
@property(retain, nonatomic) NSData *offlineStateBytes; // @dynamic offlineStateBytes;
