...
@class NSData, NSDictionary, NSString, YTDownloadStatusEntityModel, YTDownloadsPagePlaylistEntity_CollageThumbnailModel, YTIDownloadsPagePlaylistEntity, YTThumbnailDetailsModel;
...
@interface YTDownloadsPagePlaylistEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    YTThumbnailDetailsModel *_playlistThumbnail;
    YTDownloadsPagePlaylistEntity_CollageThumbnailModel *_playlistCollageThumbnail;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIDownloadsPagePlaylistEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIDownloadsPagePlaylistEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTDownloadsPagePlaylistEntity_CollageThumbnailModel *playlistCollageThumbnail; // @synthesize playlistCollageThumbnail=_playlistCollageThumbnail;
@property(retain, nonatomic) YTThumbnailDetailsModel *playlistThumbnail; // @synthesize playlistThumbnail=_playlistThumbnail;
