...
@class NSData, NSDictionary, NSString, YTIAccountLinkStatusEntity;
...
@interface YTAccountLinkStatusEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIAccountLinkStatusEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIAccountLinkStatusEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
