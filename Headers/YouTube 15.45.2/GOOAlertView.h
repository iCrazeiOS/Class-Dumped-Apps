...
#import <Module_Framework/GOOModalView.h>
...
+ (id)infoDialog;
+ (id)dialog;
+ (id)channelCreationErrorDialogWithMessage:(id)arg1;
+ (id)notEnoughSpaceToFetchAssetDialog;
+ (id)couldNotFetchAssetDialog;
+ (id)couldNotFetchAssetDialogWithDelegate:(id)arg1 retryAction:(CDUnknownBlockType)arg2;
+ (id)confirmEditorDismissDialogWithDelegate:(id)arg1 target:(id)arg2 selector:(SEL)arg3;
+ (id)photosExportPermissionDialogWithDelegate:(id)arg1 action:(CDUnknownBlockType)arg2;
+ (id)photosDeniedPermissionDialogWithDelegate:(id)arg1 action:(CDUnknownBlockType)arg2;
+ (id)assetInvalidDialogWithDelegate:(id)arg1 target:(id)arg2 selector:(SEL)arg3;
