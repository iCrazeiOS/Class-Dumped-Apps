...
@class NSArray, NSData, NSDictionary, NSString, YTDownloadStatusEntityModel, YTIDownloadsPageRecommendedVideoEntity, YTThumbnailDetailsModel;
@protocol YTEntityStore;

@interface YTDownloadsPageRecommendedVideoEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    NSString *_key;
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    YTThumbnailDetailsModel *_thumbnail;
    NSArray *_recommendedDownloadFormatsArray;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIDownloadsPageRecommendedVideoEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIDownloadsPageRecommendedVideoEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) NSArray *recommendedDownloadFormatsArray; // @synthesize recommendedDownloadFormatsArray=_recommendedDownloadFormatsArray;
