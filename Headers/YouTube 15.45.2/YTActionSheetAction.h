...
+ (id)actionWithTitle:(id)arg1 titleColor:(id)arg2 iconImage:(id)arg3 iconColor:(id)arg4 disableAutomaticButtonColor:(_Bool)arg5 accessibilityIdentifier:(id)arg6 handler:(CDUnknownBlockType)arg7;
+ (id)actionWithButton:(id)arg1 title:(id)arg2 iconImage:(id)arg3 handler:(CDUnknownBlockType)arg4;
+ (id)actionWithTitle:(id)arg1 iconImage:(id)arg2 visiblyDisabled:(_Bool)arg3 accessibilityIdentifier:(id)arg4 handler:(CDUnknownBlockType)arg5;
