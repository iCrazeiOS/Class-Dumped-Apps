...
@class NSArray, NSData, NSDictionary, NSString, YTIMainRecommendedDownloadVideoEntity, YTMainAppVideoMetadataEntityModel, YTYtMainVideoEntityLocalizedStringsModel, YTYtMainVideoEntityModel;
...
@property(retain, nonatomic) NSArray *formatsArray; // @synthesize formatsArray=_formatsArray;
