...
@class NSArray, NSData, NSDictionary, NSString, YTIOfflineVideoStreamsEntity;
...
@interface YTOfflineVideoStreamsEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    NSArray *_streamsProgressArray;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIOfflineVideoStreamsEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIOfflineVideoStreamsEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) NSArray *streamsProgressArray; // @synthesize streamsProgressArray=_streamsProgressArray;
