...
#import <Module_Framework/YTLocalImageEntityModel.h>
...
@property(retain, nonatomic) NSString *localImageFilename; // @dynamic localImageFilename;
@property(retain, nonatomic) NSString *remoteImageURL; // @dynamic remoteImageURL;
