...
@class NSArray, NSData, YTIDownloadsPagePlaylistEntity_CollageThumbnail;
...
@interface YTDownloadsPagePlaylistEntity_CollageThumbnailModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    NSArray *_firstColumnThumbnailsArray;
    NSArray *_secondColumnThumbnailsArray;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIDownloadsPagePlaylistEntity_CollageThumbnail *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIDownloadsPagePlaylistEntity_CollageThumbnail *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) NSArray *secondColumnThumbnailsArray; // @synthesize secondColumnThumbnailsArray=_secondColumnThumbnailsArray;
@property(retain, nonatomic) NSArray *firstColumnThumbnailsArray; // @synthesize firstColumnThumbnailsArray=_firstColumnThumbnailsArray;
