...
@interface YTSingleVideoController : NSObject <YTAVDAIPlayerControls, YTHAMDAIPlayerControls, YTBackgroundabilityPolicyObserver, YTPlayerControls, YTSingleVideoObservable, YTPlayerItemControls, MLQueuePlayerDelegate, MLPlayerItemDelegate>
{
    id <MLPlayer> _player;
