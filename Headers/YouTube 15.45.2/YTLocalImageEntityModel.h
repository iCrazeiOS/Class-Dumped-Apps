...
@class NSData, NSDictionary, NSString, YTILocalImageEntity;
...
@interface YTLocalImageEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTILocalImageEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTILocalImageEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(readonly, nonatomic) NSString *localImageFilename;
