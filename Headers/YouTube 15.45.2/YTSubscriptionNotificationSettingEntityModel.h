...
@class NSData, NSDictionary, NSString, YTISubscriptionNotificationSettingEntity;
...
@interface YTSubscriptionNotificationSettingEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTISubscriptionNotificationSettingEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTISubscriptionNotificationSettingEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
