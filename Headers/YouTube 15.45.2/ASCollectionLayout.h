...
#import <Module_Framework/ASDataControllerLayoutDelegate-Protocol.h>
...
+ (struct CGSize)_viewportSizeForCollectionNode:(id)arg1 scrollableDirections:(unsigned char)arg2;
