...
@class NSData, NSDictionary, NSString, YTIPostCreationDialogContentTextEntity;
...
@interface YTPostCreationDialogContentTextEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIPostCreationDialogContentTextEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIPostCreationDialogContentTextEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
