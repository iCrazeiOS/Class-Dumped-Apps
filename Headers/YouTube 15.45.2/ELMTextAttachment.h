...
{
    // Error parsing type: {AttachmentRun="_vptr$MessageLite"^^?"_internal_metadata_"{InternalMetadata="ptr_"^v}"_has_bits_"{HasBits<1>="has_bits_"[1I]}"_cached_size_"{CachedSize="size_"{atomic<int>="__a_"{__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >="__a_value"Ai}}}"element_"^{MessageLite}"alignment_"i"start_index_"I"length_"I}, name: _attachmentRun
...
- (void)updateText;
-     // Error parsing type: r^{LayoutProperties=^^?{InternalMetadata=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}fi^{MessageLite}^{MessageLite}^{MessageLite}^{MessageLite}^{MessageLite}^{MessageLite}^{MessageLite}iififiiii^{MessageLite}^{MessageLite}^{MessageLite}}16@0:8, name: layoutProperties
