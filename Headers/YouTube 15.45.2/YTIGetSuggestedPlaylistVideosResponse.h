...
@class NSData, YTIContinuationSupportedRenderers, YTIFrameworkUpdateTransport, YTIGetSuggestedPlaylistVideosContentSupportedRenderers, YTIResponseContext;
...
@property(retain, nonatomic) YTIGetSuggestedPlaylistVideosContentSupportedRenderers *content; // @dynamic content;
