...
#import <Module_Framework/YTICompactShowRenderer.h>
...
@interface YTICompactShowRenderer (YTGridVideoViewModel) <YTGridVideoViewModel, YTProminentThumbnailViewModel>
