...
#import <Module_Framework/YTIPremiumSeasonCardRenderer.h>
...
@interface YTIPremiumSeasonCardRenderer (YTVideoCardModel) <YTVideoCardModel>
...
@property(readonly, nonatomic) _Bool hasOfferButton; // @dynamic hasOfferButton;
@property(readonly, nonatomic) _Bool hasThumbnail;
@property(readonly, nonatomic) _Bool hasTitle;
@property(readonly) unsigned long long hash;
@property(readonly, nonatomic) YTICommand *navigationEndpoint;
@property(readonly, nonatomic) YTIRenderer *offerButton; // @dynamic offerButton;
