...
@class GIMMe, NSString, YTPlaybackData, YTPlayerPrebufferConfig, YTSingleVideoController, YTTimedAction;
@protocol MLViewportSizeProvider;

@interface YTPlayerPrebufferTask : NSObject <YTPrebufferTask>
{
