...
#import <Module_Framework/GRXWriter.h>

#import <Module_Framework/GRXWriteable-Protocol.h>

@class GRPCCallOptions, GRPCRequestHeaders, GRPCWrappedCall, GRXConcurrentWriteable, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject, NSString;
