...
-     // Error parsing type: {CGSize=dd}40@0:8{CGSize=dd}16r^{CollectionType=^^?{InternalMetadata=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{WeakRepeatedPtrField<youtube::elements::CollectionTypeSection>=(?={RepeatedPtrField<youtube::elements::CollectionTypeSection>=^{Arena}ii^{Rep}})}^{MessageLite}BiffBBBii^{MessageLite}^{MessageLite}^{MessageLite}^{MessageLite}}32, name: calculateSizeThatFitsLargestCellWithConstrainedSize:forCollectionType:
- (_Bool)shouldBypassSizingCellForCollectionSizing:(id)arg1 isHorizontal:(_Bool)arg2;
-     // Error parsing type: B24@0:8r^{CollectionType=^^?{InternalMetadata=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{WeakRepeatedPtrField<youtube::elements::CollectionTypeSection>=(?={RepeatedPtrField<youtube::elements::CollectionTypeSection>=^{Arena}ii^{Rep}})}^{MessageLite}BiffBBBii^{MessageLite}^{MessageLite}^{MessageLite}^{MessageLite}}16, name: isHorizontal:
