...
#import <Module_Framework/YTImagePreviewSelectViewControllerDelegate-Protocol.h>

@class GIMMe, NSString;

@interface YTImagePreviewSelectCommandHandler : NSObject <YTImagePreviewSelectViewControllerDelegate, YTCommandHandler>
{
