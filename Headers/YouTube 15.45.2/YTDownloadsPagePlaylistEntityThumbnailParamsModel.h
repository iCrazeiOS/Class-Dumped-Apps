...
@class NSData, YTIDownloadsPagePlaylistEntityThumbnailParams;
...
@interface YTDownloadsPagePlaylistEntityThumbnailParamsModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIDownloadsPagePlaylistEntityThumbnailParams *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIDownloadsPagePlaylistEntityThumbnailParams *protoBuf; // @synthesize protoBuf=_protoBuf;
