...
@class YTIFrameworkUpdateTransport, YTIOfflineClientRefreshData, YTIResponseContext;
...
@property(retain, nonatomic) YTIOfflineClientRefreshData *clientRefreshData; // @dynamic clientRefreshData;
@property(retain, nonatomic) YTIFrameworkUpdateTransport *frameworkUpdates; // @dynamic frameworkUpdates;
@property(nonatomic) _Bool hasClientRefreshData; // @dynamic hasClientRefreshData;
