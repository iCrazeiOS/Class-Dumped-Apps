...
#import <Module_Framework/YTThemeSetEntityModel.h>
...
@property(retain, nonatomic) NSDictionary *themeMap; // @dynamic themeMap;
@property(retain, nonatomic) NSString *activeThemeKey; // @dynamic activeThemeKey;
