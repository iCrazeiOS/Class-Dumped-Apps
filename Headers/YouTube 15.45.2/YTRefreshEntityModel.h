...
@class NSData, NSDictionary, NSString, YTIRefreshEntity;
...
@interface YTRefreshEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIRefreshEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIRefreshEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
