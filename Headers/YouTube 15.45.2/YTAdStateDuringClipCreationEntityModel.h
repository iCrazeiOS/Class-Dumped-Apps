...
@class NSData, NSDictionary, NSString, YTIAdStateDuringClipCreationEntity;
...
@interface YTAdStateDuringClipCreationEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIAdStateDuringClipCreationEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIAdStateDuringClipCreationEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
