...
#import <Module_Framework/PSKPeopleStackAutocompleteService-Protocol.h>

@class FCDRPC, NSArray, NSString;
@protocol FCDRPCAuthorizer, FCDRPCManager, FCDTransport;

@interface PSKPeopleStackAutocompleteServiceImpl : FCDRPCService <PSKPeopleStackAutocompleteService>
{
    FCDRPC *_rpcs[3];
}
