...
@class NSData, NSDictionary, NSString, YTIMetadataEditorDirtinessStateEntity;
...
@interface YTMetadataEditorDirtinessStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMetadataEditorDirtinessStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIMetadataEditorDirtinessStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
