...
@class GFMFamilyMemberProfile, GFMFamilyMember_DirectAddIdentifier, GFMMemberAttributes, GFMMemberSupervisionInfo, GFMUnconfirmedMemberInfo, GPBEnumArray, NSString;
...
@property(retain, nonatomic) GFMFamilyMember_DirectAddIdentifier *directAddIdentifier; // @dynamic directAddIdentifier;
