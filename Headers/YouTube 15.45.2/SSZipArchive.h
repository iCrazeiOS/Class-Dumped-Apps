...
+ (void)zipInfo:(CDStruct_192a48cb *)arg1 setAttributesOfItemAtPath:(id)arg2;
...
+ (_Bool)createZipFileAtPath:(id)arg1 withContentsOfDirectory:(id)arg2 keepParentDirectory:(_Bool)arg3 compressionLevel:(int)arg4 progressHandler:(CDUnknownBlockType)arg5;
