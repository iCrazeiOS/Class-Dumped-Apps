...
#import <TwitterKit/TWTRNetworkSessionProvider-Protocol.h>
...
+ (void)userSessionWithAuthConfig:(id)arg1 APIServiceConfig:(id)arg2 completion:(CDUnknownBlockType)arg3;
