...
- (id)initWithAuthConfig:(id)arg1 APIServiceConfig:(id)arg2 refreshStrategies:(id)arg3 URLSession:(id)arg4 accessGroup:(id)arg5;
- (id)initWithAuthConfig:(id)arg1 APIServiceConfig:(id)arg2 refreshStrategies:(id)arg3 URLSession:(id)arg4;
