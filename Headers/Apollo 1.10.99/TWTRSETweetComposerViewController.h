...
#import <TwitterKit/CLLocationManagerDelegate-Protocol.h>
#import <TwitterKit/TWTRSEAccountSelectionDelegate-Protocol.h>
#import <TwitterKit/TWTRSEAutoCompletionTableViewControllerDelegate-Protocol.h>
#import <TwitterKit/TWTRSELocationSelectionDelegate-Protocol.h>
#import <TwitterKit/UITableViewDelegate-Protocol.h>

@class CLLocation, CLLocationManager, NSLayoutConstraint, NSString, TWTRSEAutoCompletionTableViewController, TWTRSETweetComposerTableViewDataSource, TWTRSETweetShareConfiguration, TWTRSETweetTextViewContainer, UIBarButtonItem, UIScrollView, UITableView, UIView;
@protocol TWTRSEAccount, TWTRSEGeoPlace;

@interface TWTRSETweetComposerViewController : UIViewController <UITableViewDelegate, TWTRSEAccountSelectionDelegate, CLLocationManagerDelegate, TWTRSELocationSelectionDelegate, TWTRSEAutoCompletionTableViewControllerDelegate>
{
    ...
    TWTRSETweetComposerTableViewDataSource *_dataSource;
    ...
    id <TWTRSEGeoPlace> _selectedGeoPlace;
    unsigned long long _locationStatus;
    TWTRSEAutoCompletionTableViewController *_autoCompletionResultsViewController;
}
...
@property(readonly, nonatomic) TWTRSEAutoCompletionTableViewController *autoCompletionResultsViewController; // @synthesize autoCompletionResultsViewController=_autoCompletionResultsViewController;
...
@property(retain, nonatomic) id <TWTRSEGeoPlace> selectedGeoPlace; // @synthesize selectedGeoPlace=_selectedGeoPlace;
...
@property(readonly, nonatomic) TWTRSETweetComposerTableViewDataSource *dataSource; // @synthesize dataSource=_dataSource;
@property(readonly, nonatomic) __weak TWTRSETweetShareConfiguration *configuration; // @synthesize configuration=_configuration;
@property(readonly, nonatomic) UITableView *tableView; // @synthesize tableView=_tableView;
@property(readonly, nonatomic) TWTRSETweetTextViewContainer *tweetTextViewContainer; // @synthesize tweetTextViewContainer=_tweetTextViewContainer;
