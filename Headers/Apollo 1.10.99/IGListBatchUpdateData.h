...
- (id)initWithInsertSections:(id)arg1 deleteSections:(id)arg2 moveSections:(id)arg3 insertIndexPaths:(id)arg4 deleteIndexPaths:(id)arg5 updateIndexPaths:(id)arg6 moveIndexPaths:(id)arg7 fixIndexPathImbalance:(_Bool)arg8;
