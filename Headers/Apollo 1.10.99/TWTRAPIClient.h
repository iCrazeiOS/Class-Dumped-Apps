...
@class NSString, TWTRAuthConfig, TWTRNetworking;
...
@property(readonly, nonatomic) TWTRNetworking *networkingClient; // @synthesize networkingClient=_networkingClient;
...
- (_Bool)isLoggedIn;
- (id)URLRequestWithMethod:(id)arg1 URLString:(id)arg2 parameters:(id)arg3 error:(id *)arg4;
