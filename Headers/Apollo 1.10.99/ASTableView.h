...
@class ASBatchContext, ASCellNode, ASDataController, ASRangeController, ASTableLayoutController, ASTableNode, ASTableViewProxy, NSCountedSet, NSHashTable, NSString, UIButton, UIView, _ASHierarchyChangeSet;
...
@interface ASTableView : UITableView <ASRangeControllerDataSource, ASRangeControllerDelegate, ASDataControllerSource, _ASTableViewCellDelegate, ASCellNodeInteractionDelegate, ASDelegateProxyInterceptor, ASBatchFetchingScrollView>
{
    ...
    unsigned long long _floatingActionButtonPosition;
}
...
@property(nonatomic) unsigned long long floatingActionButtonPosition; // @synthesize floatingActionButtonPosition=_floatingActionButtonPosition;
...
- (void)addFloatingActionButton:(id)arg1;
