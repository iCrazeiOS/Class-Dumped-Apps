...
#import <TwitterKit/UITextViewDelegate-Protocol.h>

@class NSLayoutConstraint, NSString, NSUndoManager, TWTRSETweet, TWTRSETweetAttachmentView, TWTRSETweetTextView, UIColor, UILabel;
@protocol TWTRSETweetTextViewContainerDelegate;

@interface TWTRSETweetTextViewContainer : UIView <UITextViewDelegate>
{
    long long _containerConstraintsToken;
    long long _attachmentViewConstraintsToken;
    id <TWTRSETweetTextViewContainerDelegate> _delegate;
    TWTRSETweetTextView *_textView;
    UILabel *_placeholderLabel;
    UILabel *_characterCounterLabel;
    TWTRSETweet *_tweet;
    TWTRSETweetAttachmentView *_attachmentView;
...
@property(retain, nonatomic) TWTRSETweetAttachmentView *attachmentView; // @synthesize attachmentView=_attachmentView;
@property(copy, nonatomic) TWTRSETweet *tweet; // @synthesize tweet=_tweet;
...
@property(readonly, nonatomic) TWTRSETweetTextView *textView; // @synthesize textView=_textView;
@property(nonatomic) __weak id <TWTRSETweetTextViewContainerDelegate> delegate; // @synthesize delegate=_delegate;
