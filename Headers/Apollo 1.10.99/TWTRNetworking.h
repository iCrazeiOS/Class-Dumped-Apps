...
- (id)URLRequestForDELETEMethodWithURLString:(id)arg1 parameters:(id)arg2;
- (id)URLRequestForPOSTMethodWithURLString:(id)arg1 parameters:(id)arg2;
- (id)URLRequestForGETMethodWithURLString:(id)arg1 parameters:(id)arg2;
