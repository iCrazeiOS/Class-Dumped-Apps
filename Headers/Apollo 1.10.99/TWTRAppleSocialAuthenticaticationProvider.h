...
#import <TwitterKit/UIActionSheetDelegate-Protocol.h>

@class ACAccountStore, NSArray, NSString, TWTRAuthConfig, TWTRUserAPIClient;
...
@interface TWTRAppleSocialAuthenticaticationProvider : TWTRAuthenticationProvider <UIActionSheetDelegate>
{
    ...
    TWTRUserAPIClient *_twitterClient;
}

@property(readonly, nonatomic) TWTRUserAPIClient *twitterClient; // @synthesize twitterClient=_twitterClient;
