...
@property(nonatomic) CDStruct_08e49f5d traitCollection; // @synthesize traitCollection=_traitCollection;
...
- (id)initWithNodeModel:(id)arg1 nodeBlock:(CDUnknownBlockType)arg2 supplementaryElementKind:(id)arg3 constrainedSize:(CDStruct_42a63532)arg4 owningNode:(id)arg5 traitCollection:(CDStruct_08e49f5d)arg6;
