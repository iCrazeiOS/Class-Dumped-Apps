...
@class NSString, TWTRAppAPIClient, TWTRAuthConfig;
...
@interface TWTRGuestAuthProvider : TWTRAuthenticationProvider
{
    ...
    TWTRAppAPIClient *_appAPIClient;
}

@property(retain, nonatomic) TWTRAppAPIClient *appAPIClient; // @synthesize appAPIClient=_appAPIClient;
