...
@interface _TtC6Apollo27SettingsAboutViewController : _TtC6Apollo25ApolloTableViewController <MFMailComposeViewControllerDelegate>
{
    ...
    // Error parsing type: , name: normalUserBetaSignupURL
    // Error parsing type: , name: proUserBetaSignupURL
    // Error parsing type: , name: ultraUserBetaSignupURL
    // Error parsing type: , name: apolloIconSize
    // Error parsing type: , name: firstView
    // Error parsing type: , name: resetAllBarButtonItem
}

- (void).cxx_destruct;
- (void)longPressedTableViewWithGestureRecognizer:(id)arg1;
- (void)resetAllBarButtonItemTapped:(id)arg1;
