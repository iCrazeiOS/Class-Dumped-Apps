...
@property(nonatomic) _Bool alwaysHandleTruncationTokenTap; // @synthesize alwaysHandleTruncationTokenTap=_alwaysHandleTruncationTokenTap;
...
@property unsigned char highlightStyle;
