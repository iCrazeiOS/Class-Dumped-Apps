...
@protocol OS_dispatch_queue, TWTRSECardPreviewProvider, TWTRSEImageDownloader;
...
@property(readonly, copy, nonatomic) id <TWTRSEImageDownloader> imageDownloader; // @synthesize imageDownloader=_imageDownloader;
@property(readonly, copy, nonatomic) id <TWTRSECardPreviewProvider> cardPreviewProvider; // @synthesize cardPreviewProvider=_cardPreviewProvider;
