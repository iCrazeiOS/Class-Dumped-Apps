...
@protocol TWTRAPIServiceConfig, TWTRAuthSession;
...
+ (void)userSessionWithAuthConfig:(TWTRAuthConfig *)arg1 APIServiceConfig:(id <TWTRAPIServiceConfig>)arg2 completion:(void (^)(TWTRSession *, NSError *))arg3;
@end
