...
@class NSData, NSDate, NSError, NSMutableDictionary, NSMutableIndexSet, PINOperationQueue, PINRemoteLock, UIImage;
...
- (void)_cacheWithFrameIndex:(unsigned long long)arg1;
- (void)cleanupFrames;
