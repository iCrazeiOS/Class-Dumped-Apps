...
@interface TAVAnalytics6SecInViewTracker : NSObject <TAVAnalyticsTracker>
{
...
- (_Bool)didReachThresholdWithPlaybackState:(id)arg1 playthroughState:(id)arg2;
- (_Bool)didReachVisibilityThresholdWithPlaybackState:(id)arg1 playthroughState:(id)arg2;
