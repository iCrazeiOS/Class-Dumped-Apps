...
@class NSString, T1ImageViewFetchHelper, T1InlineMediaContainerView, T1InlineMediaView, T1MultiPhotoView, T1PrerollCTAModel, T1StatusPhotoVideoDetailsView, T1VoiceView, TAVPlaybackState, TFNTwitterAccount;
@protocol T1StatusPhotoVideoForwardViewDelegate, T1StatusViewModel;

@interface T1StatusPhotoVideoForwardView : UIView <T1InlineMediaViewDelegate, T1StatusPhotoVideoDetailsViewDelegate, T1ImageViewFetchHelperDelegate, TAVPlaybackObserver, T1InlineMediaContainerViewDelegate, T1StatusViewInlineImages>
{
...
- (void)setViewModel:(id)arg1 options:(unsigned long long)arg2 account:(id)arg3 attachmentType:(unsigned long long)arg4 displayType:(unsigned long long)arg5;
