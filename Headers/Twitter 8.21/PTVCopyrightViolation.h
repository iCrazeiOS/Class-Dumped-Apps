...
@property(readonly, nonatomic) _Bool broadcasterWhitelisted; // @synthesize broadcasterWhitelisted=_broadcasterWhitelisted;
...
- (id)initWithViolationType:(long long)arg1 copyrightHolderName:(id)arg2 copyrightContentName:(id)arg3 broadcasterWhitelisted:(_Bool)arg4 matchAccepted:(_Bool)arg5 matchDisputed:(_Bool)arg6 learnMoreURL:(id)arg7;
