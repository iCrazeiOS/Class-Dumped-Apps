...
- (id)initWithAccountUsername:(id)arg1 navigationContext:(id)arg2 source:(long long)arg3 sourceAppBundleID:(id)arg4 externalURLBehavior:(id)arg5 referrer:(id)arg6 externallyReferred:(_Bool)arg7;
