...
- (id)initWithHeaderViewModel:(id)arg1 choices:(id)arg2 selectionType:(long long)arg3 nextLinkLabel:(id)arg4 nextLinkOptions:(id)arg5 skipLinkLabel:(id)arg6 detailText:(id)arg7 activeRanges:(id)arg8 nuxRefreshAppearanceEnabled:(_Bool)arg9 delegate:(id)arg10;
