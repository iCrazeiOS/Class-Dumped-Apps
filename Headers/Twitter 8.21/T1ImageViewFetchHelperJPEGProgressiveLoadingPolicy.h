...
@class NSString, T1ImageViewFetchHelper;

@interface T1ImageViewFetchHelperJPEGProgressiveLoadingPolicy : NSObject <TIPImageFetchProgressiveLoadingPolicy>
{
    T1ImageViewFetchHelper *_owner;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) __weak T1ImageViewFetchHelper *owner; // @synthesize owner=_owner;
