...
#import <T1Twitter/TFNDirectMessageParticipantsJoinedEntry-Protocol.h>
...
@interface TFNDirectMessageParticipantsJoinedEntry : TFNDirectMessageConversationEntry <TFNDirectMessageParticipantsJoinedEntry>
{
    ...
    TFNDirectMessageUser *_addedBy;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) TFNDirectMessageUser *addedBy; // @synthesize addedBy=_addedBy;
