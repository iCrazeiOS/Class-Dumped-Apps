...
@class NSString, T1AvatarImageView, T1ComposeRichTextView, T1ConversationInlineComposeAccountView, T1ReactionItem, T1ReactionsRowView, T1TweetComposeSocialContextTextView, TFNButton, TFNButtonBarView, TFNPlaceholderTextView, TFNTwitterAccount, UIFont, UITapGestureRecognizer;
@protocol T1ConversationInlineComposeViewDelgate;

@interface T1ConversationInlineComposeView : UIView <T1TweetComposeSocialContextTextViewDelegate, UIGestureRecognizerDelegate>
{
