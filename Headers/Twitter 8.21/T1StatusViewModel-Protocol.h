...
@class NSArray, NSDate, NSDictionary, NSString, TFNAttributedTextModel, TFNTwitterAccount, TFNTwitterCardData, TFNTwitterFeedbackInfo, TFNTwitterGeotag, TFNTwitterStatus, TFNTwitterStatusConversationContext, TFSTwitterCameraMoment, TFSTwitterConversationControl, TFSTwitterEntitySet, TFSTwitterMediaInfo, TFSTwitterVideoMonetizationSettings, TFSURTImageVariant, TFSURTRichText, UIColor, UIFont;
