...
- (id)initWithAccount:(id)arg1 title:(id)arg2 subtitle:(id)arg3 hideSearch:(_Bool)arg4 searchHeaderText:(id)arg5 searchHint:(id)arg6 nextLabel:(id)arg7 skipLabel:(id)arg8 nuxRefreshAppearanceEnabled:(_Bool)arg9 delegate:(id)arg10;
