...
- (void)performSimulateCopyrightViolationWhitelisted:(_Bool)arg1 accepted:(_Bool)arg2;
- (void)simulateCopyrightViolationWhitelisted:(_Bool)arg1 accepted:(_Bool)arg2;
