...
@interface TFSTwitterAPIStatusesUpdateParameters : NSObject <NSCopying>
{
    ...
    unsigned long long _composerSource;
    NSString *_paletteID;
...
@property(copy, nonatomic) NSDate *originalPostTime; // @synthesize originalPostTime=_originalPostTime;
@property(copy, nonatomic) NSString *paletteID; // @synthesize paletteID=_paletteID;
@property(nonatomic) unsigned long long composerSource; // @synthesize composerSource=_composerSource;
