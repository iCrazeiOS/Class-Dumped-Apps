...
@class NSArray, NSDate, NSMutableArray, NSMutableOrderedSet, NSString, TFNDirectMessageComposition, TFNDirectMessageContext, TFNDirectMessageConversationIdentifier, TFNDirectMessageConversationParticipant, TFNDirectMessageInbox, TFNDirectMessageModel, TFNDirectMessageUser, TFSTwitterEntityImageInfo;
