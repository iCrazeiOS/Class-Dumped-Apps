...
@interface TFNNavigationController : UINavigationController <TFNKeyboardShortcutDelegate, UINavigationControllerDelegate, UIGestureRecognizerDelegate, TFNLayoutMetricsEnvironment>
{
