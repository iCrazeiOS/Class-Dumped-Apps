...
@interface TFSTwitterAPIDirectMessageReactionNewRequest : TFSTwitterAPIEndpointRequest
{
}

+ (long long)HTTPMethodValue;
- (id)initWithConversationID:(id)arg1 dmID:(id)arg2 reactionKey:(id)arg3 requestID:(id)arg4 context:(id)arg5 responseModelBuilder:(id)arg6;
