...
- (void)viewDidLoad;
- (id)initWithAccount:(id)arg1 delegate:(id)arg2 title:(id)arg3 subtitle:(id)arg4 hintText:(id)arg5 defaultText:(id)arg6 defaultPlaceID:(id)arg7 nextLabel:(id)arg8 skipLabel:(id)arg9 maxLength:(long long)arg10 nuxRefreshAppearanceEnabled:(_Bool)arg11;
