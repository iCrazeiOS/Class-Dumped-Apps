...
@class NSLayoutConstraint, T1NewsCameraCaptureOutput, T1NewsCameraCapturePreviewView, T1NewsCameraCaptureViewController, T1NewsCameraControlButton, TFNButton, UIView;
...
@interface T1NewsCameraCaptureCameraModeConfirmationViewController : TFNViewController
{
    ...
    T1NewsCameraControlButton *_muteButton;
...
@property(retain, nonatomic) T1NewsCameraControlButton *muteButton; // @synthesize muteButton=_muteButton;
...
@property(readonly, nonatomic) _Bool showMuteAndTrim; // @synthesize showMuteAndTrim=_showMuteAndTrim;
...
- (void)viewDidLoad;
- (id)initWithShowMuteAndTrim:(_Bool)arg1;
