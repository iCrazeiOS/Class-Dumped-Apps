...
- (void)viewDidLoad;
- (id)initWithFlowToken:(id)arg1 subtaskID:(id)arg2 title:(id)arg3 subtitle:(id)arg4 nextLabel:(id)arg5 skipLabel:(id)arg6 itemsDataViewController:(id)arg7 nuxRefreshAppearanceEnabled:(_Bool)arg8 delegate:(id)arg9;
