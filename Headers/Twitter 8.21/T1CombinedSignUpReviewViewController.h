...
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 name:(id)arg3 phone:(id)arg4 email:(id)arg5 birthday:(id)arg6 signUpButtonTitle:(id)arg7 signInText:(id)arg8 activeRanges:(id)arg9 detailText:(id)arg10 activeRanges:(id)arg11 noticeText:(id)arg12 activeRanges:(id)arg13 shouldInputBirthdayAsAge:(_Bool)arg14 nuxRefreshAppearanceEnabled:(_Bool)arg15;
