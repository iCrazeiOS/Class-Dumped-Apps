...
@interface TFSTwitterAPILiveEventTimelineRequest : TFSTwitterAPIEndpointRequest
{
}

- (id)initWithEventID:(id)arg1 sourceID:(id)arg2 utcOffset:(id)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
