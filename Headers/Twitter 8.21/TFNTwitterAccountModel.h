...
- (id)_statusesForIDs:(id)arg1 resultsAccumulator:(id)arg2;
- (_Bool)_hydrateAdditionalTweetReferences:(id)arg1 resultsAccumulator:(id)arg2;
- (id)_hydrateAllStatuses:(id)arg1 resultsAccumulator:(id)arg2;
