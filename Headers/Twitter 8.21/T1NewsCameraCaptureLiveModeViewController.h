...
#import <T1Twitter/T1NewsCameraLiveInviteeSelectionViewControllerDelegate-Protocol.h>
...
@class NSArray, NSLayoutConstraint, NSString, PTVAPIResponseErrorInfo, PTVBroadcast, T1AutocompleteController, T1AutocompleteViewController, T1ComposeAccountAvatarImageView, T1ComposeController, T1NewsCameraCaptureViewController, T1NewsCameraControlButton, T1NewsCameraEventHashtagsViewController, T1NewsCameraGeoPickerController, T1NewsCameraPlace, TFNCircularCountProgressView, TFNPlaceholderTextView, TFNTwitterComposition, TFNTwitterTweetTextCounter, TFSTwitterScribeContext, UIActivityIndicatorView, UIButton, UILabel, UIPanGestureRecognizer, UIScrollView, UITapGestureRecognizer, UIView;

@interface T1NewsCameraCaptureLiveModeViewController : TFNViewController <UITextViewDelegate, T1AutocompleteControllerDelegate, T1AutocompleteViewControllerDelegate, T1NewsCameraCaptureViewControllerEventHashtagsDelegate, T1ComposeControllerDelegate, T1NewsCameraCaptureViewControllerPlacesDelegate, T1NewsCameraGeoPickerControllerDelegate, TFNCircularCountProgressDataSource, TFNTwitterTweetTextCounterContext, T1NewsCameraEventHashtagsViewControllerDelegate, UIGestureRecognizerDelegate, T1NewsCameraLiveInviteeSelectionViewControllerDelegate, PTVTwitterCameraLiveDelegate>
{
...
- (void)newsCameraCaptureViewControllerDidChangePeriscopeAccountAuthentication:(id)arg1;
