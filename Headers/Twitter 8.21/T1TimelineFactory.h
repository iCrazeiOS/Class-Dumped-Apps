...
- (id)_t1_altHomeTimelineWithAccount:(id)arg1 scribePage:(id)arg2 suggestsConfigurationType:(long long)arg3;
...
- (id)_t1_homeTimelineEntryTimelineCreatorWithAccount:(id)arg1;
- (id)init;
