...
- (void).cxx_destruct;
@property(readonly, nonatomic, getter=isNuxRefreshAppearanceEnabled) _Bool nuxRefreshAppearanceEnabled; // @synthesize nuxRefreshAppearanceEnabled=_nuxRefreshAppearanceEnabled;
