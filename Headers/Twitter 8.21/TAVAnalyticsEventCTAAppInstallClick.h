...
#import <TwitterAVCore/TAVAnalyticsAppStoreCTAEvent.h>
...
@interface TAVAnalyticsEventCTAAppInstallClick : TAVAnalyticsAppStoreCTAEvent <TAVAnalyticsPromotedEvent, TAVAnalyticsClientEvent>
{
}
