...
@interface TFSTwitterAPIMomentsSportsScoresRequest : TFSTwitterAPIEndpointRequest
{
}

+ (unsigned long long)responseHydrationFlags;
+ (id)endpointPath;
- (id)initWithEventIDs:(id)arg1 UTCOffset:(id)arg2 context:(id)arg3 responseModelBuilder:(id)arg4;
