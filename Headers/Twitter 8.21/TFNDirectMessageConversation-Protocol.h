...
@class NSArray, NSDate, NSString, TFNDirectMessageComposition, TFNDirectMessageContext, TFNDirectMessageConversationIdentifier, TFNDirectMessageUser, TFSTwitterEntityImageInfo;
@protocol TFNDirectMessageConversationEntry, TFNDirectMessageConversationParticipant, TFNDirectMessageInbox;
