...
- (id)initWithUserID:(id)arg1 screenName:(id)arg2 handlesChallenges:(_Bool)arg3 impressionID:(id)arg4 earned:(_Bool)arg5 context:(id)arg6 responseModelBuilder:(id)arg7;
