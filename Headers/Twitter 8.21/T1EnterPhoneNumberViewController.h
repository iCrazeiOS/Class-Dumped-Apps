...
- (void)abandonForm;
- (void)submitForm;
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 nextLabel:(id)arg3 skipLabel:(id)arg4 hintText:(id)arg5 countryCodes:(id)arg6 defaultCountryCode:(id)arg7 discoverabilitySettingsTitle:(id)arg8 discoverabilitySettingsValue:(_Bool)arg9 nuxRefreshAppearanceEnabled:(_Bool)arg10 delegate:(id)arg11;
