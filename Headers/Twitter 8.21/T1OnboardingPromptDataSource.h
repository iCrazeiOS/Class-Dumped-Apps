...
- (id)initWithPresentationType:(long long)arg1 promptViewClass:(Class)arg2 account:(id)arg3 subtaskController:(id)arg4 subtaskDataProvider:(id)arg5 headerImage:(id)arg6 primaryText:(id)arg7 secondaryText:(id)arg8 detailText:(id)arg9 textAlignment:(long long)arg10 nuxRefreshAppearanceEnabled:(_Bool)arg11;
