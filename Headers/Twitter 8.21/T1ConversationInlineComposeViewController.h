...
@interface T1ConversationInlineComposeViewController : T1ComposeViewController <T1NewsCameraCaptureViewControllerDelegate, T1ConversationInlineComposeViewDelgate, T1JumpBackToHomeTimelineBehavior, TFNModalSheetViewControllerDelegate>
{
...
- (void)persistentComposeViewDidTapReaction:(id)arg1;
