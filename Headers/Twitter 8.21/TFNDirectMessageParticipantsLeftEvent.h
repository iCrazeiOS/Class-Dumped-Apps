...
@class NSArray, NSDate, NSString, TFNDirectMessageParticipantsLeftEntry;
...
@interface TFNDirectMessageParticipantsLeftEvent : NSObject <TFNDirectMessageEvent>
{
    ...
    TFNDirectMessageParticipantsLeftEntry *_entry;
    NSArray *_participantIDs;
}

- (void).cxx_destruct;
@property(readonly, copy, nonatomic) NSArray *participantIDs; // @synthesize participantIDs=_participantIDs;
@property(readonly, nonatomic) TFNDirectMessageParticipantsLeftEntry *entry; // @synthesize entry=_entry;
...
- (id)initWithEventID:(long long)arg1 time:(id)arg2 requestID:(id)arg3 conversationID:(id)arg4 participantIDs:(id)arg5 entry:(id)arg6;
