...
#import <T1Twitter/T1NudgeControllerDelegate-Protocol.h>
...
@class NSArray, NSMutableArray, NSString, T1AmbientNotificationContainer, T1AppSplitViewController, T1ComposeController, T1DirectMessageParticipantValidator, T1DockingController, T1FoundMediaPresentationContext, T1NudgeController, T1OnboardingFlowController, T1PhotoGalleryPresentationContext, T1SettingsOnboardingFlowPresenter, T1TweetSentToast, TFNHUD, TFNTwitterAccount, TFNTwitterStatus, UIViewController;
@protocol T1PanelNavigationController, T1TabbedAppNavigationDelegate, TFSTwitterLegacyScribeLogMethods;

@interface T1TabbedAppNavigation : NSObject <T1AppNavigationDocking, T1OnboardingFlowControllerDelegate, T1ComposeControllerDelegate, T1TweetDraftsViewControllerDelegate, T1NudgeControllerDelegate, T1AppNavigation>
{
    ...
    T1NudgeController *_nudgeController;
...
@property(retain, nonatomic) T1NudgeController *nudgeController; // @synthesize nudgeController=_nudgeController;
...
- (void)nudgeController:(id)arg1 didDismissMenuSheetViewController:(id)arg2;
