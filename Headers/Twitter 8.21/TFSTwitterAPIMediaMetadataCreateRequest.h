...
@interface TFSTwitterAPIMediaMetadataCreateRequest : TFSTwitterAPIEndpointRequest
{
}
...
- (id)initWithMediaID:(id)arg1 mediaMetadata:(id)arg2 context:(id)arg3 responseModelBuilder:(id)arg4;
