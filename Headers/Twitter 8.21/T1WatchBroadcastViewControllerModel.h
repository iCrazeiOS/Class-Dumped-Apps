...
@class NSString, NSURL, PTVExternalVideoAccessManager, T1PeriscopeAccount, TFNTwitterAccount, TFNTwitterLiveEvent, TFNTwitterStatus, TFNTwitterUser, TFSTwitterBroadcast;
