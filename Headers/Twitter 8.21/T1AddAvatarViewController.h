...
- (id)initWithAccount:(id)arg1 title:(id)arg2 subtitle:(id)arg3 nextLabel:(id)arg4 skipLabel:(id)arg5 delegate:(id)arg6 requireAvatar:(_Bool)arg7 nuxRefreshAppearanceEnabled:(_Bool)arg8;
