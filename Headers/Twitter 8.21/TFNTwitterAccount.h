...
@interface TFNTwitterAccount : NSObject <T1TimelinesFeatureSwitches, TAVTwitterFeatures, TFNTwitterMediaUploadConfiguration, TFNTwitterAPIConfiguration>
{
...
- (_Bool)isConversationControlConsumptionEducationEnabledNoImpression;
...
- (_Bool)isFoundMediaAutoAltTextEnabled;
...
- (_Bool)checkIsNewStartupReporterEnabledByMakingImpression:(_Bool)arg1;
...
- (_Bool)isOnboardingRuxShareToSnapEnabled;
...
- (_Bool)isListManagementGraphQLIntegrationEnabled;
- (_Bool)isListCustomBannerImageReadsEnabled;
- (_Bool)isListCreationAndEditFlowsCustomBannerImageEnabled;
- (_Bool)isDetailPageMutingEnabledUnsafePeek;
- (_Bool)isDetailPageMutingEnabled;
...
- (_Bool)isNewsCameraStreamLinedFlowPhase2Enabled;
...
@property(readonly, nonatomic) _Bool isQuoteTweetCountEnabled;
