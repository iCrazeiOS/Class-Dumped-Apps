...
- (void)viewDidLoad;
- (id)initWithTitleText:(id)arg1 subtitleText:(id)arg2 continueButtonLabel:(id)arg3 skipButtonLabel:(id)arg4 fullName:(id)arg5 email:(id)arg6 username:(id)arg7 skipPasswordValidation:(_Bool)arg8 nuxRefreshAppearanceEnabled:(_Bool)arg9;
