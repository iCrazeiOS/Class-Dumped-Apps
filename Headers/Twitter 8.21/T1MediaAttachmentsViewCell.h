...
@interface T1MediaAttachmentsViewCell : UICollectionViewCell <T1MediaAttachmentViewDelegate>
{
    ...
    _Bool _altTextForFoundMediaEnabled;
...
@property(nonatomic) _Bool altTextForFoundMediaEnabled; // @synthesize altTextForFoundMediaEnabled=_altTextForFoundMediaEnabled;
