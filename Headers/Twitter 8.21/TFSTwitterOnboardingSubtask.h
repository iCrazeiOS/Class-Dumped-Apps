...
+ (id)typeNames;
- (void).cxx_destruct;
@property(nonatomic, getter=isNuxRefreshAppearanceEnabled) _Bool nuxRefreshAppearanceEnabled; // @synthesize nuxRefreshAppearanceEnabled=_nuxRefreshAppearanceEnabled;
