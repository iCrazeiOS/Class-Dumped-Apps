...
{
    _Bool _isEnabledForDisabledEngagementEducation;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool isEnabledForDisabledEngagementEducation; // @synthesize isEnabledForDisabledEngagementEducation=_isEnabledForDisabledEngagementEducation;
...
- (void)statusDidUpdate:(id)arg1 options:(unsigned long long)arg2 animated:(_Bool)arg3;
