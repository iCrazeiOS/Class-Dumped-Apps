...
@interface TFSTwitterAPIDirectMessageDestroyRequest : TFSTwitterAPIEndpointRequest
{
}

+ (long long)HTTPMethodValue;
+ (id)endpointPath;
- (id)initWithMessageID:(id)arg1 requestID:(id)arg2 context:(id)arg3 responseModelBuilder:(id)arg4;
