...
@interface T1URTTimelineStatusItemViewModel : NSObject <T1StatusViewModel, T1URTEntryViewModel>
{
...
@property(nonatomic, readonly) _Bool isAutoTranslated;
