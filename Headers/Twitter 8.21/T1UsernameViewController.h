...
- (void)viewDidLoad;
- (id)initWithAccount:(id)arg1 prefillUsername:(id)arg2 title:(id)arg3 subtitle:(id)arg4 nextLinkLabel:(id)arg5 skipLinkLabel:(id)arg6 detailText:(id)arg7 activeRanges:(id)arg8 options:(long long)arg9 shouldShowLogoTitleView:(_Bool)arg10 showsActionsInNavigationBar:(_Bool)arg11 scribeContext:(id)arg12 nuxRefreshAppearanceEnabled:(_Bool)arg13;
