...
@interface ADJActivityState : NSObject <NSCoding, NSCopying>
{
    ...
    _Bool _isThirdPartySharingDisabled;
...
@property(nonatomic) _Bool isThirdPartySharingDisabled; // @synthesize isThirdPartySharingDisabled=_isThirdPartySharingDisabled;
