...
@class NSArray, NSString, UIImageView, UILongPressGestureRecognizer, UIView, UIView<YTAttributedLabel>, YTFormattedStringLabel, YTIPlaylistVideoRenderer, YTProgressOverlayView, YTQTMButton, YTStandaloneBadgeView, YTSubtitleView, YTVideoContributorView, YTVideoThumbnailView;
