...
- (void)startDownloadOfVideoWithID:(id)arg1 selectedQuality:(int)arg2 playerResponse:(id)arg3 offlineabilityRenderer:(id)arg4 pinTypes:(int)arg5 queueFromMetadata:(_Bool)arg6 customToastAction:(CDUnknownBlockType)arg7 firstResponder:(id)arg8;
- (void)authenticateAndOfflineWithVideoID:(id)arg1 playerData:(id)arg2 offlineabilityRenderer:(id)arg3 pinTypes:(int)arg4 queueFromMetadata:(_Bool)arg5 customToastAction:(CDUnknownBlockType)arg6 firstResponder:(id)arg7;
