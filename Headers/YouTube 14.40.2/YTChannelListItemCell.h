...
@class MDCInkTouchController, NSString, UIView, YTFormattedStringLabel, YTIButtonRenderer, YTIChannelListItemRenderer, YTISubscriptionNotificationOptionsRenderer, YTISubscriptionNotificationToggleButtonRenderer, YTIToggleButtonRenderer, YTImageView, YTNotificationMultiToggleButton, YTNotificationOptionsButton, YTNotificationPreferenceToggleButton, YTQTMButton;
