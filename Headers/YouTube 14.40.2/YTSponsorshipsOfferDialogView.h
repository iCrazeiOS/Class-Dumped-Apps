...
@class NSMutableArray, NSString, YTFormattedStringLabel, YTIMembershipOfferRenderer, YTPerksView, YTQTMButton, YTSponsorshipsDialogHeaderView;

@interface YTSponsorshipsOfferDialogView : UIView <UIScrollViewDelegate, YTSponsorshipsDialogViewProtocol>
{
    YTIMembershipOfferRenderer *_renderer;
    double _scrollPositionY;
    YTPerksView *_perksContainerView;
    UIView *_footerView;
    UIView *_separator;
    YTFormattedStringLabel *_priceTextLabel;
    NSMutableArray *_paymentClauseLabels;
