...
@class GIMMe, NSString, UIViewController<YTPlaybackController>, YTActivityWaitViewController, YTBackgroundURLSessionNotifications, YTCSIYouTubeActionsController, YTEntitlementRefreshController, YTFeedbackStateController, YTInnerTubeUIServiceMapper, YTMDXObserver, YTOfflinePlaylistActionController, YTOfflineRefreshWorker, YTOfflineVideoActionController, YTScrollsToTopCoordinator, YTSettings, YTSignedOutLocalSearchHistory, YTStoreKitPurchaseController, YTTimingResponderEventProcessor;
