...
@class NSError, NSIndexSet, UIView, UIViewController, UIViewController<YTNGWatchViewControllerProtocol>, UIViewController<YTWatchPlayerViewControllerDelegate>, YTICommand, YTIWatchNextResponse, YTPlaybackData, YTPlayerResponse, YTWatchTransition;
