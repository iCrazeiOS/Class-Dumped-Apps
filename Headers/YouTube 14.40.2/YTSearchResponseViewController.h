...
@class GIMMe, NSError, NSString, UIColor, UIViewController<YTResponseViewController>, YTConfirmDialogController, YTISearchResponse, YTMonotonicDate, YTNavigationalLatencyEventInfo, YTSearchLatencyCache;
