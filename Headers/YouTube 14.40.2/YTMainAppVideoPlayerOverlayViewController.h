...
@class GIMMe, MLNerdStatsOverlayViewController, MLNerdStatsPlaybackData, NSError, NSString, UIViewController<YTInfoCardDrawerOverlayProtocol>, UIViewController<YTInfoCardTeaserOverlayProtocol>, YTCPN, YTCaptionTrackSwitchController, YTCaptionViewController, YTHotConfig, YTIMenuRenderer, YTIPlayerOverflowRenderer, YTIReportFormModalRenderer, YTMainAppVideoPlayerOverlayView, YTNoSoundMemoViewController, YTOverflowMenuViewController, YTPlayerOverflowRendererController, YTPlayerResponse, YTVEVisibilityUpdateResponderEventGate;

@interface YTMainAppVideoPlayerOverlayViewController : UIViewController <MLNerdStatsOverlayViewControllerDelegate, YTCaptionTrackSwitchDelegate, YTLegalReportMediaTimeResponderProvider, YTOfflineModeObserver, YTOverflowMenuViewControllerDelegate, YTPlaybackRouteButtonVisibilityObserver, YTUserDefaultsObserver, YTAudioTrackSwitchUIObserver, YTInfoCardDrawerOverlayDelegate, YTPlayerOverflowInfoProvider, YTResponder, YTVideoPlayerOverlayProtocol, YTVideoQualitySwitchUIObserver, YTMainAppControlsOverlayViewEventsDelegate>
{
