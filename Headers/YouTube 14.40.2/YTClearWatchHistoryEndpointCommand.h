...
@interface YTClearWatchHistoryEndpointCommand : NSObject <GOOAlertViewDelegate, YTCommandHandler>
{
...
- (void).cxx_destruct;
- (CDUnknownBlockType)alertViewLinkTapBlockForAlertView:(id)arg1 responder:(id)arg2;
