...
@class GIMMe, NSString, YTICommand, YTReelCameraViewControllerV2View;

@interface YTReelCameraViewControllerV2 : UIViewController <YTTopController, YTReelCreationViewControllerTransition>
{
    YTICommand *_model;
    GIMMe *_gimme;
    id <YTReelCameraViewControllerDelegate> _delegate;
    id <YTResponder> _parentResponder;
}

@property(nonatomic) __weak id <YTResponder> parentResponder; // @synthesize parentResponder=_parentResponder;
@property(nonatomic) __weak id <YTReelCameraViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
@property(retain, nonatomic) YTReelCameraViewControllerV2View *view; // @dynamic view;
