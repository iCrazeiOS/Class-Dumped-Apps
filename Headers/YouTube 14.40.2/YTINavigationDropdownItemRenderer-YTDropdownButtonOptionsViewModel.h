...
#import "YTINavigationDropdownItemRenderer.h"

#import "YTDropdownButtonOptionsViewModel.h"

@class NSString, YTICommand, YTIIcon, YTIReloadContinuationData;

@interface YTINavigationDropdownItemRenderer (YTDropdownButtonOptionsViewModel) <YTDropdownButtonOptionsViewModel>
