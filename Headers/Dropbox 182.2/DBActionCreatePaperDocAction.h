...
@interface DBActionCreatePaperDocAction : DBFileAction
{
}

+ (_Bool)db_paperAppAnyVersionInstalled;
+ (void)db_showInstallPaperInterstitial:(id)arg1 modalManager:(id)arg2;
