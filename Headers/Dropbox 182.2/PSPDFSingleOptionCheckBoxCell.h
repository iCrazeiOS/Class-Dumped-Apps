...
@interface PSPDFSingleOptionCheckBoxCell : PSPDFTableViewCell <PSPDFThemeObserver>
{
    _Bool _isOnlyOption;
    UIColor *_themeColor;
}

@property(nonatomic) _Bool isOnlyOption; // @synthesize isOnlyOption=_isOnlyOption;
