...
@protocol PSPDFSearchHighlightViewManagerDataSource;
...
- (void).cxx_destruct;
- (void)addHighlightSearchResults:(id)arg1 animated:(_Bool)arg2;
...
- (void)clearHighlightedSearchResultsAnimated:(_Bool)arg1;
@property(readonly, nonatomic) _Bool hasVisibleSearchResults;
