...
#import <DropboxExtensions/APMEExperimentObserverDelegate-Protocol.h>

@class APMDatabase, APMEClient, APMPBMeasurementConfig, GULMutableDictionary, NSArray, NSNumberFormatter, NSString;
