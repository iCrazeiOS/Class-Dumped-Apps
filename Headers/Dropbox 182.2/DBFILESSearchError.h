...
- (void).cxx_destruct;
- (_Bool)isEqualToSearchError:(id)arg1;
...
- (_Bool)isPath;
@property(readonly, copy, nonatomic) NSString *invalidArgument; // @synthesize invalidArgument=_invalidArgument;
@property(readonly, nonatomic) DBFILESLookupError *path; // @synthesize path=_path;
- (id)initWithOther;
- (id)initWithInvalidArgument:(id)arg1;
