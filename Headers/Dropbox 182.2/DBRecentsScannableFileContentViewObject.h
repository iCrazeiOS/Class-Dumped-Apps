...
@class DBRecentsTimeGroupedEntry, NSString, UIImage, UIResponder;
@protocol DBContentView, DBRecentsBaseFileEntry;

@interface DBRecentsScannableFileContentViewObject : DBFileEntryContentViewObject <DBContainsRecentsTimeGroupedEntry>
{
