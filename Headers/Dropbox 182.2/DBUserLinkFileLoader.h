...
@class DBDropboxPath, DBRestClientRequestLinkFilesFactory, DBUserState, NSString, NSURL;

@interface DBUserLinkFileLoader : NSObject <DBLinkableStateObserverProtocol, DBLinkFileLoader>
{
...
- (void)dealloc;
- (id)initWithUserState:(id)arg1 filePath:(id)arg2 requestFactory:(id)arg3;
- (id)init;
