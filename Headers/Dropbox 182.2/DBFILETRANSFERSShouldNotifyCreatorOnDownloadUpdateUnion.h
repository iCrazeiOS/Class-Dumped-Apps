...
@interface DBFILETRANSFERSShouldNotifyCreatorOnDownloadUpdateUnion : NSObject <DBSerializable, NSCopying>
{
...
- (void).cxx_destruct;
- (_Bool)isEqualToShouldNotifyCreatorOnDownloadUpdateUnion:(id)arg1;
