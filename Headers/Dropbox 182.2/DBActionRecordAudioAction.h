...
@interface DBActionRecordAudioAction : DBFileAction
{
    // Error parsing type: , name: $__lazy_storage_$_modalPresenter
    // Error parsing type: , name: weakRecordAudioViewController
}
