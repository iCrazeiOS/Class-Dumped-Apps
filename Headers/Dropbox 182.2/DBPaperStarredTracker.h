...
@class DBObserverBlockMap, DBUserFileStarredManager, NSString, NSURL;

@interface DBPaperStarredTracker : NSObject <DBStarredStatusObserver, DBStarredTracker>
{
    NSURL *_url;
    NSString *_title;
...
- (void)dealloc;
- (id)initWithFileUrl:(id)arg1 title:(id)arg2 paperPathId:(id)arg3 fileType:(long long)arg4 userStarredManager:(id)arg5;
