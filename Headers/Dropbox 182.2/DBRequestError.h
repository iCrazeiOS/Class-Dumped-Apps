...
@class DBAUTHAccessError, DBAUTHAuthError, DBAUTHRateLimitError, DBCOMMONPathRootError, DBLocalizedUserMessage, NSError, NSNumber, NSString;
...
- (_Bool)isRateLimitError;
- (_Bool)isPathRootError;
- (_Bool)isAccessError;
- (_Bool)isAuthError;
