...
@class DBCollatedFileListDataProvider;
@protocol DBFileListDataProviderProtocol;

@protocol DBCollatedByTypeFileListDataProviderFactoryProtocol
...
+ (DBCollatedFileListDataProvider *)dateCollatedProvider:(id <DBFileListDataProviderProtocol>)arg1 withDateAccessor:(NSDate * (^)(id))arg2 secondaryComparator:(long long (^)(id, id))arg3;
