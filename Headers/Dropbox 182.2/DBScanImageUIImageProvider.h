...
@class DBImageDiskBackedStorage, DBImageStorageToken, NSString, UIImage;

@interface DBScanImageUIImageProvider : NSObject <DBScanImageProviderWithStorage>
{
    UIImage *_image;
...
- (id)initWithImage:(id)arg1 preferredThumbnailWidth:(double)arg2;
- (id)init;
