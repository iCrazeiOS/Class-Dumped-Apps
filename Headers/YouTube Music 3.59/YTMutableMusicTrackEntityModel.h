...
@class NSData, NSDictionary, NSString, YTLoggingDirectivesModel, YTMusicAlbumReleaseEntityModel, YTMusicLibraryEditEntityModel, YTMusicShareEntityModel, YTMusicTrackContentRatingModel, YTMusicTrackDetailEntityModel, YTMusicTrackUserDetailEntityModel, YTThumbnailDetailsModel;
...
@property(retain, nonatomic) YTMusicLibraryEditEntityModel *libraryEdit; // @dynamic libraryEdit;
@property(retain, nonatomic) YTMusicShareEntityModel *share; // @dynamic share;
