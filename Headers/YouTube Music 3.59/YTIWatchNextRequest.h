...
+ (id)descriptor;
+ (id)ytm_watchNextRequestWithCommand:(id)arg1 enablePersistentPlaylistPanel:(_Bool)arg2;
...
@property(nonatomic, setter=ytm_setPlaylistPanelSuppressed:) _Bool ytm_isPlaylistPanelSuppressed;
