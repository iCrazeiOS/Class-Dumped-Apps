...
@class NSError, NSString, UIView, UIViewController, YTCPN, YTExpectedPlayerLayout, YTIWatchNextResponse, YTPlaybackConfig, YTPlaybackControllerRestorableState, YTPlaybackDebugData, YTPlayerResponse, YTPlayerTransition, YTPlayerView;
@protocol YTPlaybackController, YTPlaybackControllerEventsDelegate, YTPlaybackControllerUIDelegate, YTPlayerOverlayFactory, YTResponder, YTSingleVideoObservable, YTVideoPlayerOverlayProtocol;
