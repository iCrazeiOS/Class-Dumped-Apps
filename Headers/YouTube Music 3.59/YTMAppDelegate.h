...
#import "YTMBackgroundFetchControllerDelegate-Protocol.h"
...
@interface YTMAppDelegate : UIResponder <MDXDeviceConnectivityInfoProtocol, FLXRTLLayoutDelegate, YTAudioSessionDelegate, YTMBackgroundFetchControllerDelegate, YTMFirstAppLaunchReporterDelegate, YTMMusicAppMetadataObserverProtocol, YTStorageControllerObserver, YTSystemNotificationsObserver, YTUserChangedObserver, UIApplicationDelegate>
{
    ...
    _Bool _shouldRestoreQueueUnconditionally;
...
- (void)maybeRestorePlaybackQueue;
...
- (void)backgroundFetchControllerDidHandleBackgroundFetchTaskLaunch;
