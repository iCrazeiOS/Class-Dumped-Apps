...
{
    // Error parsing type: {HLSCuepoint="cuepoint_"{CuePoint="_vptr$MessageLite"^^?"_internal_metadata_"{InternalMetadataWithArenaLite="ptr_"^v}"_has_bits_"{HasBits<1>="has_bits_"[1I]}"_cached_size_"{CachedSize="size_"{atomic<int>="__a_"Ai}}"cuepoint_context_"{ArenaStringPtr="ptr_"^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}"identifier_"{ArenaStringPtr="ptr_"^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}"type_"i"event_"i"total_duration_sec_"d"playhead_time_sec_"d"playhead_time_at_start_sec_"d"media_time_since_start_sec_"d}"chunk_start_time_"{Time="rep_"{Duration="rep_hi_"q"rep_lo_"I}}"chunk_duration_"{Duration="rep_hi_"q"rep_lo_"I}}, name: _cuepoint
...
// Property attributes: Tr^{HLSCuepoint={CuePoint=^^?{InternalMetadataWithArenaLite=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}iidddd}{Time={Duration=qI}}{Duration=qI}},R,N
...
-     // Error parsing type: @128@0:8{HLSCuepoint={CuePoint=^^?{InternalMetadataWithArenaLite=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}iidddd}{Time={Duration=qI}}{Duration=qI}}16, name: initWithHLSCuepoint:
