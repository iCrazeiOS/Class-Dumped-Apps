...
+ (id)builder;
+ (id)MPDWithStreamingData:(id)arg1 videoDetails:(id)arg2 additionalURLParameters:(id)arg3 location:(id)arg4 hamplayerLiveConfig:(id)arg5 livePlayerConfig:(id)arg6 windowedLiveConfig:(id)arg7 onesieVideoData:(id)arg8 offlineStreams:(id)arg9 offlineOnly:(_Bool)arg10 playerQueue:(id)arg11;
