...
@class GIMMe, GOOHeaderViewController, NSMutableArray, NSString, NSURL, UINavigationController, UIWindow, YTColdConfig, YTIdentityController, YTInnerTubeControllerFactory, YTMAppMealbarPromoController, YTMContentViewController, YTMObserverManager, YTMealbarPromoController;
...
- (_Bool)shouldMealbarPromoController:(id)arg1 displayConnectionStatusMealbar:(id)arg2 hasContentDownloaded:(_Bool)arg3;
