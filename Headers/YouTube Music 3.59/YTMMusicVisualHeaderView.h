...
@interface YTMMusicVisualHeaderView : YTMFlexibleHeaderBackgroundView <YTPageStyling, YTSubscribeSwitchContainer>
{
    ...
    YTMMusicThumbnailView *_foregroundThumbnailView;
...
@property(retain, nonatomic) YTIMusicThumbnailRenderer *foregroundThumbnailRenderer;
@property(readonly, nonatomic) YTMMusicThumbnailView *foregroundThumbnailView;
- (void)updateSubscriptionState:(_Bool)arg1;
@property(retain, nonatomic) YTIMusicThumbnailRenderer *thumbnailRenderer;
