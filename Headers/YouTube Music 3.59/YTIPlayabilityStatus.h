...
@property(nonatomic) _Bool hasPlexitDelayFillYpcChannelOfferThumbnail; // @dynamic hasPlexitDelayFillYpcChannelOfferThumbnail;
@property(nonatomic) _Bool hasPlexitDelayFillYpcClickwrap; // @dynamic hasPlexitDelayFillYpcClickwrap;
@property(nonatomic) _Bool hasPlexitDelayFillYpcErrorSkip; // @dynamic hasPlexitDelayFillYpcErrorSkip;
@property(nonatomic) _Bool hasPlexitDelayFillYpcErrorSkipIsUnplayable; // @dynamic hasPlexitDelayFillYpcErrorSkipIsUnplayable;
...
@property(nonatomic) _Bool plexitDelayFillYpcChannelOfferThumbnail; // @dynamic plexitDelayFillYpcChannelOfferThumbnail;
@property(nonatomic) _Bool plexitDelayFillYpcClickwrap; // @dynamic plexitDelayFillYpcClickwrap;
@property(nonatomic) _Bool plexitDelayFillYpcErrorSkip; // @dynamic plexitDelayFillYpcErrorSkip;
@property(nonatomic) _Bool plexitDelayFillYpcErrorSkipIsUnplayable; // @dynamic plexitDelayFillYpcErrorSkipIsUnplayable;
