...
@class CHRMetricAppStateInfo, CHRMetricHandoffInfo, CHRMetricIntentDetectorInfo, CHRMetricPrivacyScreenInfo, CHRMetricSiriInfo, CHRMetricWatchCommunicationInfo;
...
- (void).cxx_destruct;
- (id)initWithAppStateInfo:(id)arg1 handoffInfo:(id)arg2 siriInfo:(id)arg3 intentDetectorInfo:(id)arg4 privacyScreenInfo:(id)arg5 watchCommunicationInfo:(id)arg6;
