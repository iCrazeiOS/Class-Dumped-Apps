...
@class NSArray, NSData, NSString, YTIOfflineOrchestrationAction, YTOfflineOrchestrationActionMetadataModel;
...
@interface YTOfflineOrchestrationActionModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    YTOfflineOrchestrationActionMetadataModel *_actionMetadata;
    NSArray *_chainedActionsArray;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIOfflineOrchestrationAction *_protoBuf;
}

@property(copy, nonatomic) YTIOfflineOrchestrationAction *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTOfflineOrchestrationActionMetadataModel *actionMetadata; // @synthesize actionMetadata=_actionMetadata;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) NSArray *chainedActionsArray; // @synthesize chainedActionsArray=_chainedActionsArray;
