...
@class NSArray, NSData, NSDate, NSDictionary, NSHashTable, NSString, NSUserDefaults, YTAppStateInfo, YTIGetSearchSuggestionsResponse, YTIMusicAppMetadataRenderer, YTIPivotBarRenderer, YTUserDefaultsKeys;
...
- (_Bool)autoOffline;
@property(nonatomic) _Bool cachedLocationHistoryOptedInStatus;
@property(nonatomic) _Bool cachedLocationReportingOptedInStatus;
...
@property(nonatomic, getter=wasLibrarySongsUserEducationShown) _Bool librarySongsUserEducationShown;
@property(nonatomic, getter=wasLibraryArtistsUserEducationShown) _Bool libraryArtistsUserEducationShown;
...
@property(retain, nonatomic) NSDate *lastHomePageBackgroundFetchScheduledDate;
...
@property(retain, nonatomic) NSString *additionalDIALLaunchParameters;
