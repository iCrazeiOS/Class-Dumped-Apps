...
#import "YTMusicFormBooleanChoiceEntityModel.h"

#import "YTMutableEntity-Protocol.h"

@class NSData, NSDictionary, NSString, YTMusicFormEntityModel;

@interface YTMutableMusicFormBooleanChoiceEntityModel : YTMusicFormBooleanChoiceEntityModel <YTMutableEntity>
{
}
...
@property(retain, nonatomic) YTMusicFormEntityModel *parentFormEntityKey; // @dynamic parentFormEntityKey;
