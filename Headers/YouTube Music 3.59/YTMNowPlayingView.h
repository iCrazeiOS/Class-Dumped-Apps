...
@class NSString, QTMButton, UILabel, UITapGestureRecognizer, YTFormattedStringLabel, YTIFormattedString, YTMPlayerControlsView, YTMQueuePanelHeaderView, YTMScrollingLabel, YTMStoryboardScrubber;
...
@interface YTMNowPlayingView : UIView <UIGestureRecognizerDelegate>
{
    ...
    YTIFormattedString *_videoArtist;
