...
@class NSData, NSDictionary, NSString, YTButtonDataModel, YTIProductDetailsUnitEntity;
...
@interface YTProductDetailsUnitEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    YTButtonDataModel *_purchaseButton;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIProductDetailsUnitEntity *_protoBuf;
}

@property(copy, nonatomic) YTIProductDetailsUnitEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTButtonDataModel *purchaseButton; // @synthesize purchaseButton=_purchaseButton;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) _Bool disableInlineOptimisticCommand;
@property(readonly, nonatomic) _Bool hasDisableInlineOptimisticCommand;
