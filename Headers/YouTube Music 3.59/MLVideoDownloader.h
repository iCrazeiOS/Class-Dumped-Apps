...
@class GIMMe, MLVideoDownloadTaskCollection, MLVideoDownloaderSessionDelegate, NSMutableArray, NSMutableDictionary, NSString, NSURLSession;
...
- (_Bool)startTask:(id)arg1 formatStreams:(id)arg2 streamsToRefresh:(id)arg3 resumeData:(id)arg4 expirationDate:(id)arg5 allowCellularAccess:(_Bool)arg6 additionalURLParameters:(id)arg7 error:(id *)arg8;
...
- (id)downloadVideo:(id)arg1 toRepo:(id)arg2 targetAudioQuality:(int)arg3 targetVideoResolution:(int)arg4 allowCellularAccess:(_Bool)arg5 refreshStreams:(_Bool)arg6;
