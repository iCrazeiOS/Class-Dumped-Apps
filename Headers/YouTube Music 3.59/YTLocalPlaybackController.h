...
@class GIMMe, MLAudioSession, MLPlayerPool, NSError, NSHashTable, NSMutableArray, NSString, YTAdInterrupt, YTBackgroundabilityPolicy, YTCPN, YTPlaybackBackgroundTaskController, YTPlaybackConfig, YTPlaybackData, YTPlaybackLockScreenController, YTPlayerHeartbeatController, YTPlayerMacroState, YTPlayerPIPController, YTPlayerTransition, YTPlayerView, YTSingleVideoController, YTSingleVideoTime, YTUpcomingPlayerTransitionController, YTVSSControllerState, YTVideoResolver;
@protocol HAMClock, MLViewportSizeProvider, YTAdsPlaybackCoordinator, YTCorePlaybackControllerDelegate, YTGLSceneProtocol, YTPlaybackControllerUIDelegate, YTPlayerCallbackManager, YTPlayerOverlayFactory, YTPlayerViewControllerConfig, YTResponder, YTSingleVideoObservable, YTSingleVideoSequencer;
