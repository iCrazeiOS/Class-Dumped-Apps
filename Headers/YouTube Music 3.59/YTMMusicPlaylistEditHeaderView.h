...
@class GOOTextField, NSString, QTMButton, UIView, YTMCollaborationButton, YTPlaylistPrivacyButton;
...
@interface YTMMusicPlaylistEditHeaderView : YTMFlexibleHeaderBackgroundView <UITextFieldDelegate>
{
    ...
    YTMCollaborationButton *_collaborationButton;
    _Bool _collaborationButtonVisible;
    _Bool _collaborationButtonGreyedOut;
    id <YTMMusicPlaylistEditHeaderViewDelegate> _delegate;
}

@property(nonatomic) _Bool collaborationButtonGreyedOut; // @synthesize collaborationButtonGreyedOut=_collaborationButtonGreyedOut;
@property(nonatomic) _Bool collaborationButtonVisible; // @synthesize collaborationButtonVisible=_collaborationButtonVisible;
...
- (void)didPressCollaborationButton;
- (void)layoutCollaborationButton;
