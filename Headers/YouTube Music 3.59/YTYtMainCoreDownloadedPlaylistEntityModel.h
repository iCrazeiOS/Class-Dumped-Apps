...
@class NSArray, NSData, NSDictionary, NSString, YTIYtMainCoreDownloadedPlaylistEntity, YTYtMainPlaylistEntityModel;
@protocol YTEntityStore;

@interface YTYtMainCoreDownloadedPlaylistEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    NSString *_id_p;
    ...
    YTIYtMainCoreDownloadedPlaylistEntity *_protoBuf;
}

@property(copy, nonatomic) YTIYtMainCoreDownloadedPlaylistEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
