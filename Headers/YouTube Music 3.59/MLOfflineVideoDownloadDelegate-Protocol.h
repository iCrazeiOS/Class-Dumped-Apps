...
@protocol MLOfflineVideoDownloadControllerProtocol;

@protocol MLOfflineVideoDownloadDelegate <NSObject>
- (void)offlineDownloadController:(id <MLOfflineVideoDownloadControllerProtocol>)arg1 didFinishBackgroundTaskRestorationWithTask:(MLVideoDownloadTask *)arg2;
