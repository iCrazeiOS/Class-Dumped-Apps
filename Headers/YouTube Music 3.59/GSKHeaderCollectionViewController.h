...
@interface GSKHeaderCollectionViewController : QTMCollectionViewController <GOOHeaderNavigationParentViewController>
{
    ...
    _Bool _updatesToDarkModeAppearance;
...
@property(nonatomic) _Bool updatesToDarkModeAppearance; // @synthesize updatesToDarkModeAppearance=_updatesToDarkModeAppearance;
...
- (void).cxx_destruct;
- (void)updateUserInterfaceAppearanceIfNeededWithCompletion:(CDUnknownBlockType)arg1;
