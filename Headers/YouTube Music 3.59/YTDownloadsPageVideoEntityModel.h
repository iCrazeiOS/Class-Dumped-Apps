...
@class NSData, NSDictionary, NSString, YTCommandModel, YTDownloadStatusEntityModel, YTIDownloadsPageVideoEntity, YTThumbnailDetailsModel;
...
@interface YTDownloadsPageVideoEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTCommandModel *_onTapCommand;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIDownloadsPageVideoEntity *_protoBuf;
}

@property(copy, nonatomic) YTIDownloadsPageVideoEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTCommandModel *onTapCommand; // @synthesize onTapCommand=_onTapCommand;
