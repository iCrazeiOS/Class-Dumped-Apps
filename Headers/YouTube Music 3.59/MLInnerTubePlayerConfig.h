...
@interface MLInnerTubePlayerConfig : NSObject <MLPlayerConfig>
{
    ...
    _Bool _mediaShouldDownloadLicenses;
...
@property(readonly, nonatomic) _Bool mediaShouldDownloadLicenses; // @synthesize mediaShouldDownloadLicenses=_mediaShouldDownloadLicenses;
...
- (void).cxx_destruct;
- (id)initWithHLSProxyConfig:(id)arg1 AVPlayerConfig:(id)arg2 hamplayerConfig:(id)arg3 videoToAudioItagMap:(id)arg4 DRMSessionID:(id)arg5 fairPlayConfig:(id)arg6 livePlayerConfig:(id)arg7 VRConfig:(id)arg8 stickyCeilingDuration:(double)arg9 offlineable:(_Bool)arg10 offline:(_Bool)arg11 dataSaverConfig:(id)arg12 audioConfig:(id)arg13 mediaCommonConfig:(id)arg14 varispeedAllowed:(_Bool)arg15 useInnerTubeDRMService:(_Bool)arg16 mediaShouldDownloadLicenses:(_Bool)arg17 fetchManifestWhenNotActive:(_Bool)arg18 playbackStartConfig:(id)arg19 manifestlessWindowedLiveConfig:(id)arg20;
