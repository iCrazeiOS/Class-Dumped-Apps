...
@class NSData, NSString, YTCommandModel, YTIButtonData, YTLoggingDirectivesModel;
@protocol YTEntityStore;

@interface YTButtonDataModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    YTCommandModel *_buttonCommand;
    YTLoggingDirectivesModel *_loggingDirectives;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIButtonData *_protoBuf;
}

@property(copy, nonatomic) YTIButtonData *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTCommandModel *buttonCommand; // @synthesize buttonCommand=_buttonCommand;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) _Bool isInAppPurchase;
@property(readonly, nonatomic) _Bool hasIsInAppPurchase;
