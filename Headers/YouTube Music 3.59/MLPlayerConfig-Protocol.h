...
@class NSDictionary, NSString, YTIAudioConfig, YTIDataSaverConfig, YTIFairPlayConfig, YTIHamplayerConfig, YTIHlsProxyConfig, YTIIosAvPlayerConfig, YTILivePlayerConfig, YTIManifestlessWindowedLiveConfig, YTIMediaCommonConfig, YTIPlaybackStartConfig, YTIVrConfig;
...
@property(readonly, nonatomic) _Bool mediaShouldDownloadLicenses;
