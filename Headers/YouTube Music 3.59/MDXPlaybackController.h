...
@class AVAudioPlayer, GIMMe, MDXSession, MDXSingleVideoController, NSError, NSString, YTCPN, YTPlaybackConfig, YTPlaybackData, YTPlaybackLockScreenController, YTPlayerHeartbeatController, YTPlayerResponse, YTPlayerTransition, YTPlayerView, YTSingleVideoTime;
