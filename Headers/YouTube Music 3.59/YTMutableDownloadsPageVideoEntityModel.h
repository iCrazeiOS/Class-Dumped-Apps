...
#import "YTDownloadsPageVideoEntityModel.h"

#import "YTMutableEntity-Protocol.h"

@class NSData, NSDictionary, NSString, YTCommandModel, YTDownloadStatusEntityModel, YTThumbnailDetailsModel;
...
@property(retain, nonatomic) YTCommandModel *onTapCommand; // @dynamic onTapCommand;
