...
@class NSArray, NSData, NSDictionary, NSString, YTIYtMainDownloadsListEntity;
@protocol YTEntityStore;

@interface YTYtMainDownloadsListEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    NSString *_id_p;
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    NSArray *_downloadsArray;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIYtMainDownloadsListEntity *_protoBuf;
}

@property(copy, nonatomic) YTIYtMainDownloadsListEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(readonly, nonatomic) NSArray *downloadsArray; // @synthesize downloadsArray=_downloadsArray;
