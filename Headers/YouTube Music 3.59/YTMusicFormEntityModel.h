...
@class NSArray, NSData, NSDictionary, NSString, YTIMusicFormEntity;
@protocol YTEntityStore;

@interface YTMusicFormEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    NSString *_id_p;
    ...
    YTIMusicFormEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicFormEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (void)booleanChoiceEntityKeysArrayAtIndexes:(id)arg1 callbackQueue:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
@property(readonly, nonatomic) NSArray *booleanChoiceEntityKeysArray;
@property(readonly, nonatomic) _Bool hasBooleanChoiceEntityKeysArray;
