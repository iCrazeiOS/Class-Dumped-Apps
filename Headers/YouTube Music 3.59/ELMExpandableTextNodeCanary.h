...
@interface ELMExpandableTextNodeCanary : ASControlNode <ELMDisplayNode>
{
    ...
    // Error parsing type: r^{ExpandableTextType=^^?{InternalMetadataWithArenaLite=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{AttributedString}^{AttributedString}^{AttributedString}^{AttributedString}^{AttributedString}^{DimensionEdges}^{DimensionEdges}^{Command}^{Command}IBfiB}, name: _type
