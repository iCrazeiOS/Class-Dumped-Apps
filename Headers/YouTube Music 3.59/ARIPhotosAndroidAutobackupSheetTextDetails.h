...
@property(retain, nonatomic) ARIAndroidTextDetails *autoBackupDescriptionText; // @dynamic autoBackupDescriptionText;
...
@property(nonatomic) _Bool hasAutoBackupDescriptionText; // @dynamic hasAutoBackupDescriptionText;
