...
@interface GWARedirectForm : NSObject <GIPSuperWebViewHandler, GWAButtonViewDelegate, GWAFlowSection, GWATriggerComponent, GWAResultingComponent, GWAWebViewControllerDelegate, UIWebViewDelegate, GWAForm, GWAMegalogsSupportingComponent>
{
