...
#import "HAMAsyncSampleBufferSourceDelegate-Protocol.h"
#import "HAMFrameSource-Protocol.h"
#import "HAMVideoTrackRenderer-Protocol.h"

@class GIMMe, HAMPixelBuffer, NSObject, NSString;
@protocol HAMAsyncSampleBufferSource, HAMClock, HAMFormat, HAMFrameSourceDelegate, HAMRootMediaSource, HAMSampleBufferFrameSource, HAMTrackRendererDelegate, OS_dispatch_queue;
...
@property(readonly, nonatomic) id <HAMSampleBufferFrameSource> sampleBufferFrameSource;
