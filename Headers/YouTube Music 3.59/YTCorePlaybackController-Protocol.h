...
@class NSString, UIViewController, YTCPN, YTPlaybackConfig, YTPlayerHeartbeatController, YTPlayerTransition, YTSingleVideoTime;
@protocol MLCuepointObserver, YTAdVideoPlayerOverlayProtocol, YTPlaybackControllerUIDelegate, YTPlayerOverlayFactory;
