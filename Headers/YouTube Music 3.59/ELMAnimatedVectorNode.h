...
@interface ELMAnimatedVectorNode : ASDisplayNode <ELMDisplayNode>
{
    ...
    // Error parsing type: {AnimatedVectorProgressState="_vptr$MessageLite"^^?"_internal_metadata_"{InternalMetadataWithArenaLite="ptr_"^v}"_has_bits_"{HasBits<1>="has_bits_"[1I]}"_cached_size_"{CachedSize="size_"{atomic<int>="__a_"Ai}}"start_"f"end_"f}, name: _lastProgressState
    // Error parsing type: {AnimatedVectorFrameState="_vptr$MessageLite"^^?"_internal_metadata_"{InternalMetadataWithArenaLite="ptr_"^v}"_has_bits_"{HasBits<1>="has_bits_"[1I]}"_cached_size_"{CachedSize="size_"{atomic<int>="__a_"Ai}}"start_"i"end_"i}, name: _lastFrameState
    _Bool _flippedInRTL;
    ELMElement *_element;
}
