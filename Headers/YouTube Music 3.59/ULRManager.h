...
#import "ULRApplicationStateMonitorDelegate-Protocol.h"
...
@class ARIServiceProvider, CLLocationManager, NSArray, NSDate, NSLock, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSTimer, PHTBreakpadDecorator, ULRAnalyticsLogger, ULRAppInstallStateMonitor, ULRApplicationStateMonitor, ULRBackgroundTask, ULRBurstManager, ULRExpeditedLocationManager, ULRKeychain, ULRLocationCollector, ULRLocationEater, ULRMotionCollector, ULRPhenotypeFlags, ULRPowerObserver, ULRServer, ULRTriggerManager, ULRVisitCollector, ULRWiFiCollector;
@protocol OS_dispatch_queue, SSOService, ULRManagerDelegate, ULRMonitor;

@interface ULRManager : NSObject <CLLocationManagerDelegate, ULRLocationCollectorDelegate, ULRBurstManagerDelegate, ULRConnectionDelegate, ULRExpeditedLocationManagerDelegate, ULRTriggerManagerDelegate, ULRVisitCollectorDelegate, ULRWiFiCollectorDelegate, ULRApplicationStateMonitorDelegate, ULRManagerDeviceIDProvider>
{
    ...
    ULRAppInstallStateMonitor *_appInstallStateMonitor;
...
- (void).cxx_destruct;
- (void)resetLastKeychainScrubDate;
- (id)managerQueue;
...
- (_Bool)takeOverFromSensorCapabilitiesWithMotionActivity:(long long)arg1 lastForegroundActivity:(id)arg2 priorResponsibility:(id)arg3;
- (unsigned long long)sensorCapabilityScoreWithMotionActivity:(long long)arg1;
...
- (void)dealloc;
- (id)locationManager;
- (id)initWithIdentifyingURLScheme:(id)arg1 delegate:(id)arg2 ssoService:(id)arg3 ARIServiceProvider:(id)arg4 carrier:(id)arg5 analyticsLogger:(id)arg6 powerObserver:(id)arg7 locationEater:(id)arg8 managerQueue:(id)arg9 locationManager:(id)arg10 keychain:(id)arg11 ulrServer:(id)arg12 collectionQueue:(id)arg13 triggerManager:(id)arg14 burstManager:(id)arg15 expediatedLocationManager:(id)arg16 locationCollector:(id)arg17 visitCollector:(id)arg18 wifiCollector:(id)arg19 motionCollector:(id)arg20 applicationStateMonitor:(id)arg21 appInstallStateMonitor:(id)arg22;
