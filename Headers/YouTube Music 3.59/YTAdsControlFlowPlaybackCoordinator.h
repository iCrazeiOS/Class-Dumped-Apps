...
#import "YTAdsPlaybackSurface-Protocol.h"
...
#import "YTSlotUnscheduledEventListener-Protocol.h"

@class GIMMe, NSMutableArray, NSString, YTAdBreakStatus, YTContentVideoPlayerResponseSlotOpportunityAdapter, YTInPlayerExternallyManagedSlotAdapter, YTInstreamAdSingleVideoObserver, YTPlaybackData, YTPlayerAdEventTriggerAdapter, YTPlayerCurrentAdsState, YTVideoAdsOverlayCoordinator;
@protocol MLCuepointObserver, YTAdsPlaybackCoordinatorDelegate, YTResponder, YTSinglePlayerBytesEventListener;
...
@interface YTAdsControlFlowPlaybackCoordinator : NSObject <YTAdsPlaybackSurface, YTSlotUnscheduledEventListener, YTSingleVideoCurrentTimeObserver, YTSingleVideoErrorObserver, YTSingleVideoMediaStateObserver, YTSingleVideoMediaStateSideEffectfulObserver, YTSingleVideoLifecycleStateObserver, YTAdsPlaybackCoordinator, YTAdsPlaybackProtocol, YTResponder>
{
    ...
    _Bool _lastAdSkipped;
    _Bool _adsPlayingSupported;
