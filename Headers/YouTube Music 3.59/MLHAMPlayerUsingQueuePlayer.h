...
@protocol MLAudioFormatConstraint, MLCaptionDisplayController, MLCaptionTrack, MLCuepointCollector, MLHAMPlayerItemProtocol, MLHAMPlayerViewProtocol, MLPlayerCaptionDelegate, MLPlayerConfig, MLPlayerItemDelegate, MLPlayerItemInternal, MLVideoFormatConstraint, MLVideoSplicer;

@interface MLHAMPlayerUsingQueuePlayer : NSObject <MLHAMPlayerProtocol>
{
