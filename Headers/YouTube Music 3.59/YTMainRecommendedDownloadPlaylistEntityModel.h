...
@class NSArray, NSData, NSDictionary, NSString, YTIMainRecommendedDownloadPlaylistEntity, YTMainDownloadablePlaylistMetadataEntityModel, YTYtMainPlaylistEntityModel;
...
@interface YTMainRecommendedDownloadPlaylistEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMainRecommendedDownloadPlaylistEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMainRecommendedDownloadPlaylistEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
