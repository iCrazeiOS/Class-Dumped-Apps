...
@class NSData, NSMutableArray, NSString, YTIElementRendererCompatibilityOptions, YTISeparatorDetails;

@interface YTIElementRenderer : GPBMessage <YTCompanionAdRendererProtocol>
{
}
