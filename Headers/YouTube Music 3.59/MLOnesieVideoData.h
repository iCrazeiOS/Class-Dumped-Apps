...
@class MLAudioDecoderFactory, MLOnesieFormatData, MLRAMCachePinHandle, MLVideoDecoderFactory, NSMutableArray, NSSet, NSString, YTIHamplayerHotConfig, YTIOnesieHotConfig;
...
@property(retain, nonatomic) MLRAMCachePinHandle *cachePinHandle; // @synthesize cachePinHandle=_cachePinHandle;
