...
@class NSArray, NSData, NSDictionary, NSString, YTIDrmLicenseEntity;
...
@property(readonly, nonatomic) NSArray *licensesArray; // @synthesize licensesArray=_licensesArray;
