...
+ (id)ytm_headerRendererWithOfflinePlaylist:(id)arg1 offlineVideos:(id)arg2 shuffleEnabled:(_Bool)arg3;
+ (id)ytm_musicPlaylistDataFromOfflinePlaylistData:(id)arg1;
+ (id)ytm_headerRendererForAlbumWithOfflinePlaylist:(id)arg1 offlineVideos:(id)arg2 shuffleEnabled:(_Bool)arg3;
+ (id)ytm_headerRendererForPlaylistWithOfflinePlaylist:(id)arg1 offlineVideos:(id)arg2 shuffleEnabled:(_Bool)arg3;
