...
@interface ELMCollectionNode : ASCollectionNode <ASCollectionDataSource, ASCollectionDelegate, IGListAdapterDataSource, UIScrollViewDelegate, ELMSnapHelperDelegate, ELMDisplayNode>
{
    ...
    // Error parsing type: {optional<youtube::elements::CollectionTypeScrollToItemCommand>="engaged_"B""(?="data_"{CollectionTypeScrollToItemCommand="_vptr$MessageLite"^^?"_internal_metadata_"{InternalMetadataWithArenaLite="ptr_"^v}"_has_bits_"{HasBits<1>="has_bits_"[1I]}"_cached_size_"{CachedSize="size_"{atomic<int>="__a_"Ai}}"element_key_"{ArenaStringPtr="ptr_"^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}"index_"i"scroll_interval_seconds_"f"repeat_mode_"i"cancel_on_user_interaction_"B}"dummy_"{dummy_type="data"[48{empty_struct=}]})}, name: _scrollToItemCommand
    ELMElement *_element;
    ELMBaseSnapHelper *_snapHelper;
}

+ (void)assertInvalidElement;
+ (Class)replacementClassForElement:(id)arg1 withContext:(id)arg2;
...
-     // Error parsing type: r^{CollectionTypeSection=^^?{InternalMetadataWithArenaLite=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<youtube::elements::Element>=^{Arena}ii^{Rep}}}24@0:8Q16, name: sectionAtIndex:
...
-     // Error parsing type: v24@0:8r^{CollectionTypeScrollToItemCommand=^^?{InternalMetadataWithArenaLite=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}ifiB}16, name: handleScrollToItemCommand:
- (struct CGSize)calculateSizeThatFits:(struct CGSize)arg1;
-     // Error parsing type: {CGSize=dd}40@0:8{CGSize=dd}16r^{CollectionType=^^?{InternalMetadataWithArenaLite=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<youtube::elements::CollectionTypeSection>=^{Arena}ii^{Rep}}^{DimensionEdges}^{DimensionEdges}^{Command}^{Command}^{Command}iffBBBBii}32, name: calculateSizeThatFitsLargestCellWithConstrainedSize:forCollectionType:
- (_Bool)shouldBypassSizingCellForCollectionSizing:(id)arg1 isHorizontal:(_Bool)arg2;
-     // Error parsing type: B24@0:8r^{CollectionType=^^?{InternalMetadataWithArenaLite=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<youtube::elements::CollectionTypeSection>=^{Arena}ii^{Rep}}^{DimensionEdges}^{DimensionEdges}^{Command}^{Command}^{Command}iffBBBBii}16, name: isHorizontal:
