...
@class GWAButtonView, GWAInfoMessageView, GWAMegalogsContext, NSArray, NSData, NSNumber, NSString, OrchDocumentDownload, UIImageView, UIWebView;
@protocol GWADocumentDownloadDelegate;

@interface GWADocumentDownloadView : UIView <UIWebViewDelegate, GWAButtonViewDelegate, GWACollectionViewCell, GWAMegalogsSupportingComponent>
{
