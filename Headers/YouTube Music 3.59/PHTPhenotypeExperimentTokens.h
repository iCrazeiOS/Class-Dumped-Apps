...
@class EXHExperimentIds, NSArray, NSDictionary, NSString;
...
@interface PHTPhenotypeExperimentTokens : NSObject
{
    ...
    EXHExperimentIds *_externalExperimentIDs;
}

+ (id)experimentIDsStringWithTokensArray:(id)arg1 userID:(id)arg2;
+ (id)experimentIDsWithTokensArray:(id)arg1 userID:(id)arg2;
@property(readonly, copy, nonatomic) EXHExperimentIds *externalExperimentIDs; // @synthesize externalExperimentIDs=_externalExperimentIDs;
