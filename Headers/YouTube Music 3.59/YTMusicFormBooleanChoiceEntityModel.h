...
@class NSData, NSDictionary, NSString, YTIMusicFormBooleanChoiceEntity, YTMusicFormEntityModel;
@protocol YTEntityStore;

@interface YTMusicFormBooleanChoiceEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    NSString *_id_p;
    ...
    YTIMusicFormBooleanChoiceEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicFormBooleanChoiceEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (void)parentFormEntityKeyWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTMusicFormEntityModel *parentFormEntityKey;
