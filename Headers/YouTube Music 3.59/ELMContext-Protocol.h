...
@protocol ELMClientResourceLoader, ELMDispatcher, ELMErrorHandler, ELMFontLoader, ELMImageDownloader, ELMImageSelectionHandler, ELMInteractionLogger, ELMJSEnvironment, ELMLogger, ELMPerformanceAgent, ELMPriorityLoader, ELMResourceLoader, ELMRuntimeConfig, ELMStore, ELMTemplateLoader, ELMValueStore;
