...
#import "YTMusicFormEntityModel.h"

#import "YTMutableEntity-Protocol.h"

@class NSData, NSDictionary, NSString;

@interface YTMutableMusicFormEntityModel : YTMusicFormEntityModel <YTMutableEntity>
{
}

- (void)parseAndExtractFieldsFromProtoIfNecessary;
- (id)copyWithZone:(struct _NSZone *)arg1;
- (void)removeAllBooleanChoiceEntityKeysArray;
- (void)removeBooleanChoiceEntityKeysArray:(id)arg1;
- (void)addBooleanChoiceEntityKeysArray:(id)arg1;
