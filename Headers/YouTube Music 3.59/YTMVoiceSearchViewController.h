...
@class GIMMe, GSKMicButtonController, GSKSpeechToTextStreamingController, GSKVoiceSearchSoundController, GSKVoiceSearchViewControllerConfiguration, NSString, YTCommandResponderEvent, YTICommand, YTInteractionLoggingProxyButton, YTMSettings, YTMVoiceSearchPlateView;
