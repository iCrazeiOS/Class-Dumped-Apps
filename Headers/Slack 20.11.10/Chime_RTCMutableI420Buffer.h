...
#import <AmazonChimeSDKMedia/Chime_RTCI420Buffer.h>

#import <AmazonChimeSDKMedia/RTCMutableI420Buffer-Protocol.h>

@class NSString;

@interface Chime_RTCMutableI420Buffer : Chime_RTCI420Buffer <RTCMutableI420Buffer>
{
}
