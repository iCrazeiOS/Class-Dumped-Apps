...
#import <AmazonChimeSDKMedia/RTCRtpReceiver-Protocol.h>

@class Chime_RTCMediaStreamTrack, Chime_RTCRtpParameters, NSString, RTCPeerConnectionFactory;
@protocol RTCRtpReceiverDelegate;

@interface Chime_RTCRtpReceiver : NSObject <RTCRtpReceiver>
{
