...
#import <AmazonChimeSDKMedia/RTCRtpTransceiver-Protocol.h>

@class Chime_RTCRtpReceiver, Chime_RTCRtpSender, NSString, RTCPeerConnectionFactory;

@interface Chime_RTCRtpTransceiver : NSObject <RTCRtpTransceiver>
{
    RTCPeerConnectionFactory *_factory;
    scoped_refptr_f1ddbb35 _nativeRtpTransceiver;
    Chime_RTCRtpSender *_sender;
    Chime_RTCRtpReceiver *_receiver;
}
...
@property(readonly, nonatomic) Chime_RTCRtpReceiver *receiver; // @synthesize receiver=_receiver;
@property(readonly, nonatomic) Chime_RTCRtpSender *sender; // @synthesize sender=_sender;
- (id).cxx_construct;
- (void).cxx_destruct;
