...
@class Chime_RTCConfiguration, Chime_RTCPeerConnectionFactory, Chime_RTCSessionDescription, NSArray, NSMutableArray;
@protocol RTCPeerConnectionDelegate;

@interface Chime_RTCPeerConnection : NSObject
{
...
@property(readonly, nonatomic) Chime_RTCPeerConnectionFactory *factory; // @synthesize factory=_factory;
...
- (void)close;
@property(readonly, copy, nonatomic) Chime_RTCConfiguration *configuration;
...
@property(readonly, nonatomic) Chime_RTCSessionDescription *remoteDescription;
@property(readonly, nonatomic) Chime_RTCSessionDescription *localDescription;
@property(readonly, nonatomic) NSArray *localStreams;
- (id)initWithDependencies:(id)arg1 configuration:(id)arg2 constraints:(id)arg3 dependencies:(unique_ptr_f3d5ae95)arg4 delegate:(id)arg5;
