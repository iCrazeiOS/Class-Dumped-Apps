...
@interface _TtC5Slack36FilteredAuthedWorkspacesDataProvider : _TtCs12_SwiftObject
{
    // Error parsing type: , name: filter
    // Error parsing type: , name: filterMap
    ...
    // Error parsing type: , name: needsFilterBeforeCallback
}
