...
@class Chime_RTCRtpReceiver, Chime_RTCRtpSender, NSString;

@protocol RTCRtpTransceiver <NSObject>
@property(nonatomic) long long direction;
@property(readonly, nonatomic) _Bool isStopped;
@property(readonly, nonatomic) Chime_RTCRtpReceiver *receiver;
@property(readonly, nonatomic) Chime_RTCRtpSender *sender;
