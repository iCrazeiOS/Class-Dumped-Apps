...
@class Chime_RTCCertificate, Chime_RTCCryptoOptions, NSArray, NSNumber;

@interface Chime_RTCConfiguration : NSObject
{
    _Bool _enableDscp;
    _Bool _disableIPV6;
    ...
    NSArray *_iceServers;
    Chime_RTCCertificate *_certificate;
    ...
    Chime_RTCCryptoOptions *_cryptoOptions;
}
...
@property(retain, nonatomic) Chime_RTCCryptoOptions *cryptoOptions; // @synthesize cryptoOptions=_cryptoOptions;
...
@property(nonatomic) _Bool allowCodecSwitching; // @synthesize allowCodecSwitching=_allowCodecSwitching;
...
@property(retain, nonatomic) Chime_RTCCertificate *certificate; // @synthesize certificate=_certificate;
