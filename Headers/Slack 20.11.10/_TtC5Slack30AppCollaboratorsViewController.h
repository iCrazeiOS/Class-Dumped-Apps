...
@interface _TtC5Slack30AppCollaboratorsViewController : UITableViewController <UISearchControllerDelegate, UISearchBarDelegate, UISearchResultsUpdating, DZNEmptyDataSetSource>
{
    ...
    // Error parsing type: , name: searchInputBackup
