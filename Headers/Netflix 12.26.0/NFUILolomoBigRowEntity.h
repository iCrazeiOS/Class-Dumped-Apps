...
@class BillboardCellStyles, NSArray, NSDictionary, NSNumber, NSString;

@interface NFUILolomoBigRowEntity : NFUILolomoEntity
{
    _Bool _hasAwards;
...
- (id)overrideListActionName:(id)arg1;
- (void)prepareBillboardStyles;
- (id)trailerButtonData;
- (id)playButtonData;
