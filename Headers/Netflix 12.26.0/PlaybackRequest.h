...
@property(nonatomic) _Bool usePersistetRate; // @synthesize usePersistetRate=_usePersistetRate;
...
- (void)setUsePlaygraphPlayerForBranching:(_Bool)arg1;
- (_Bool)usePlaygraphPlayerForBranching;
- (void)setUsePlaygraphPlayer:(_Bool)arg1;
...
- (_Bool)canSupportPlaygraph;
- (_Bool)usePlaygraphPlayer;
