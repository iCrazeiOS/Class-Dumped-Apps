...
@class NFIChoiceModel, NFIChoicePointOverlayView, NFICountdownView, NFIModeratorViewController, NFIPlayerNavigatorView, NFISegmentModel, NFUITouchGestureRecognizer, NSArray, NSLayoutConstraint, NSMutableDictionary, NSNumber, NSString, UIImageView, UIView;

@interface NFIBranchingPlaylistSceneController : NFIBranchingSceneController <NFIChoicePointOverlayDelegate, NFIPlayerNavigatorDelegate, HTTPBatchRequestTaskDelegateProtocol, NFUITouchGestureDelegate, NFPlaylistPlayerDelegate, NFPlaygraphPlayerDelegate>
{
    ...
    NFIModeratorViewController *_debugMenuVC;
}

@property(retain, nonatomic) NFIModeratorViewController *debugMenuVC; // @synthesize debugMenuVC=_debugMenuVC;
...
- (void)animatePug;
- (void)displayIPP;
- (void)debugTapped:(id)arg1;
- (_Bool)playgraphPlayer:(id)arg1 shouldPerformSpeculativePreparationForNextSegmentsAfterSegment:(id)arg2;
