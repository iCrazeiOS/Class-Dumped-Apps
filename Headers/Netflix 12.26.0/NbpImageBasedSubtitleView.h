...
#import <Nbp/NFImageBasedSubtitleViewProvider-Protocol.h>
...
@interface NbpImageBasedSubtitleView : UIView <NFImageBasedSubtitleViewProvider, NFImageBasedSubtitleController>
{
...
- (void)stopSubtitles;
- (id)initWithFrame:(struct CGRect)arg1 manifestImageBasedSubtitleInformation:(id)arg2 playbackDelegate:(id)arg3 playbackReporter:(id)arg4 platformConfig:(id)arg5;
