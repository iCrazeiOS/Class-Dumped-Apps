...
@class InteractiveDataModel, NFIBranchingCollectionView, NFIChoiceCellViewModel, NSArray, NSIndexPath, NSMutableDictionary, NSString, UICollectionViewFlowLayout, UIView;

@interface NFIChoicePointNavigatorView : NFIPlayerNavigatorView <UICollectionViewDelegate, UICollectionViewDataSource, NFIBranchingPlayerControlsCellDelegate>
{
...
- (void)stopScrolling;
- (_Bool)futureEnabled:(id)arg1;
- (_Bool)isCellLocked:(id)arg1;
- (void)scrollToSegment:(id)arg1;
- (void)scrollToChapter:(id)arg1;
