...
@class NFUICloseButton, NSArray, NSLayoutConstraint, NSString, UIGestureRecognizer, UILabel, UIViewController;
...
@property(nonatomic) __weak NFUICloseButton *backButton; // @synthesize backButton=_backButton;
