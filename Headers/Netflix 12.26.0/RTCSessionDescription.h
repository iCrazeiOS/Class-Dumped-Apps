...
+ (long long)typeForStdString:(const struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> *)arg1;
+ (struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)stdStringForType:(long long)arg1;
