...
@interface NFIChoiceLayoutModel : NSObject
{
    ...
    NSString *_underlineStyleId;
    NSDictionary *_data;
    CDStruct_84bf8c3a _label;
}

@property(retain, nonatomic) NSDictionary *data; // @synthesize data=_data;
@property(readonly, nonatomic) NSString *underlineStyleId; // @synthesize underlineStyleId=_underlineStyleId;
...
- (id)visualStateTransitionsForElement:(id)arg1;
