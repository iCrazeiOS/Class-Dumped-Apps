...
@class NFUIBillboardPreviewsEntity, NFUIBillboardPreviewsListViewModel, NFUIBillboardPreviewsOverlayView, NFUIGradientView, NFUITitleTreatmentView, NSString, UIImage, UIImageViewAligned, UIView;

@interface NFUIBillboardPreviewsAnimationController : NSObject <NFUIAnimationControllerProtocol>
{
    _Bool _reverse;
    ...
    UIImageViewAligned *_sourceBrandingImage;
...
@property(nonatomic) __weak UIImageViewAligned *sourceBrandingImage; // @synthesize sourceBrandingImage=_sourceBrandingImage;
...
- (void).cxx_destruct;
- (void)resetTransitionViews:(_Bool)arg1;
- (void)initTransitionViewsWithVC:(id)arg1 containerView:(id)arg2 reverse:(_Bool)arg3 slide:(_Bool)arg4;
