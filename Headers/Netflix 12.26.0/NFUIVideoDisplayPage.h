...
#import "_TtP4Argo26MiniPlayerPostplayDelegate_-Protocol.h"

@class DisplayPageHeaderView, DisplayPageRequest, ModalShimViewController, NFLXFinalClassEnforcer, NFUICellNotifier, NFUICollectionViewItemDispatcher, NFUIDisplayPageCollectionViewDefaultState, NFUIDisplayPageItemDispatcher, NFUIDisplayPageItemWidthDispatcher, NFUIDisplayPagePullToCloseAction, NFUIDisplayPageSeasonSelectorDelegate, NFUIDisplayPageSelectionManager, NFUIDisplayPageViewModelResolver, NFUIDownloadButton, NFUIIconButton, NFUIMiniPlayerAnimator, NFUIMiniPlayerViewController, NFUIMobileCollectionsToolTipView, NFUIRatingService, NFUIReusableViewManager, NFUIRotationSensorViewController, NFUIScrollPointNotifier, NFUIVideoDisplayPageDataMap, NFUIVideoDisplayPageViewModel, NSDictionary, NSNumber, NSObject, NSString, NavigationBarAppearanceManager, PlaybackSourceModel, UIActivityIndicatorView, UICollectionView, UIView, UIWindow, VideoDisplayPageHeaderViewController, _TtC4Argo32MiniPlayerPostplayViewController;
@protocol NFUIDisplayPageNavigationProtocol, OS_dispatch_group;

@interface NFUIVideoDisplayPage : UIViewController <LinkedViewGestureDelegateProtocol, NFUIMiniPlayerDelegate, _TtP4Argo26MiniPlayerPostplayDelegate_, NFUIDisplayPageProtocol, NFUIDisplayPageViewDispatcherDelegateProtocol, NFUIDisplayPageCollectionViewProtocol, NFUIDisplayPageCollectionViewDefaultStateDelegateProtocol, NFUIDisplayPageViewModelDelegateProtocol, TransitioningOptionsProtocol, SeasonPickerViewControllerDelegateProtocol, NFUISectionDividerDelegateProtocol, NFUIDisplayPageSelectionManagerDelegateProtocol, NFUIDisplayPageHeaderViewProtocol, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, NFUISecondaryNavigationViewControllerDelegate>
{
    _Bool _isKids;
    ...
    UIView *secondaryNavigationContainer;
    ...
    NFUIDownloadButton *_firstDownloadButton;
...
@property(nonatomic) __weak NFUIDownloadButton *firstDownloadButton; // @synthesize firstDownloadButton=_firstDownloadButton;
...
@property(readonly, nonatomic) UIView *secondaryNavigationContainer; // @synthesize secondaryNavigationContainer;
...
- (void)miniPlayerPostPlayDidTapCloseFullscreen;
- (void)miniPlayerPostPlayGoToFullPlayback;
- (void)miniPlayerPostPlayDidTapReplay;
