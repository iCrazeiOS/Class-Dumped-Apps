...
@protocol CSLogDelegateProtocol, DataBrokerDataProviderProtocol, OS_dispatch_queue;
...
@interface CSLog : NSObject <NCLUploadDelegate, NFLXCrashManagerDelegateProtocol>
{
    ...
    id <CSLogDelegateProtocol> _logDelegate;
...
@property(nonatomic) __weak id <CSLogDelegateProtocol> logDelegate; // @synthesize logDelegate=_logDelegate;
...
- (void)logBillboardPreviewsEvent:(id)arg1 withToken:(id)arg2 lolomoId:(id)arg3 videoId:(id)arg4;
- (void)logBillboardPreviewsImpression:(id)arg1 videoId:(id)arg2;
- (void)logBillboardPreviewsActionWithToken:(id)arg1 lolomoId:(id)arg2 videoId:(id)arg3;
...
- (void)logEvent:(id)arg1 withData:(id)arg2 rareDebugEvent:(_Bool)arg3;
- (void)logEvent:(id)arg1 withData:(id)arg2;
- (void)private_logEvent:(id)arg1 withData:(id)arg2 rareDebugEvent:(_Bool)arg3;
...
- (id)startNonUniqueSession:(id)arg1 withData:(id)arg2 rareDebugEvent:(_Bool)arg3;
- (id)startNonUniqueSession:(id)arg1 withData:(id)arg2;
- (id)startRareDebugSession:(id)arg1;
