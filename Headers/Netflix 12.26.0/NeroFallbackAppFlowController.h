...
@class NFUIRatingService, NFUIStatusBarOverlay, NFUIStreamLimitUpgradeViewController, NSString, RootViewController, UIViewController;
...
@interface NeroFallbackAppFlowController : NSObject <StreamLimitDelegate, NFUIDownloadObserverDelegate, DataBrokerDataProviderProtocol, DeepLinkControllerDelegateProtocol>
{
    ...
    NFUIStreamLimitUpgradeViewController *_streamLimitViewController;
...
@property(retain, nonatomic) NFUIStreamLimitUpgradeViewController *streamLimitViewController; // @synthesize streamLimitViewController=_streamLimitViewController;
...
- (void)handleProfileSelectionError:(id)arg1 sourceId:(id)arg2 showProfilesGate:(_Bool)arg3;
...
- (void)showTitleMaturityWarning;
- (_Bool)shouldValidateTitleMaturity;
...
- (void)invokeDeepLinkActionDownload:(id)arg1 withMaturityValidation:(_Bool)arg2;
...
- (void)invokeDeepLinkActionSpecials:(id)arg1;
- (void)invokeGenreDeepLink:(id)arg1 originalAction:(id)arg2;
- (void)invokeDeepLinkActionRemindMe:(id)arg1;
- (void)invokeDeepLinkActionAdd:(id)arg1;
- (void)invokeDeepLinkActionRating:(id)arg1;
- (id)createDisplayPageRequestWithEntityId:(id)arg1 andTrackId:(id)arg2;
- (void)showMemberReferralUIArea;
- (void)showAccountView;
- (void)showMoreTab;
- (void)invokeDeepLinkActionSearch:(id)arg1;
- (void)invokeDeepLinkActionPlaybackSampling:(id)arg1 withMaturityValidation:(_Bool)arg2;
- (void)invokeDeepLinkActionPlaybackSampling:(id)arg1;
- (void)invokeDeepLinkActionBrowse:(id)arg1;
- (void)invokeDeepLinkActionTitle:(id)arg1 withMaturityValidation:(_Bool)arg2;
...
- (void)openMobileSafariWithURL:(id)arg1 withAutoLoginToken:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)openMobileSafariWithURL:(id)arg1 withAutoLoginToken:(_Bool)arg2;
- (void)openMobileSafariChangePlan;
- (void)openMobileSafariForgotPINForProfileGuid:(id)arg1;
...
- (void)showMyDownloads:(_Bool)arg1;
