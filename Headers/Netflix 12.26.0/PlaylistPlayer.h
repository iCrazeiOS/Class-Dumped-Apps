...
@class AVPlayer, ChoiceMapLoader, NSMutableDictionary, NSString, SegmentItem, UIView;
...
@interface PlaylistPlayer : NSObject <NFPlaylistTimeConversionDelegate, NFPlaylistPlayerDataSourceChangeObserver, ChoiceMapLoaderDelegate, SegmentItemDelegate, NFPlaylistPlayerInternal, NFPlaylistPlayer>
{
    ...
    _Bool _transitionEndLoggingPending;
...
@property(nonatomic) _Bool transitionEndLoggingPending; // @synthesize transitionEndLoggingPending=_transitionEndLoggingPending;
