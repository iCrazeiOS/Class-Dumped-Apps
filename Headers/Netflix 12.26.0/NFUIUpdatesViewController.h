...
@interface NFUIUpdatesViewController : UIViewController <UIScrollViewDelegate, NFUIMessagingUIServiceDelegate, NFUIUpdatesNotificationHeaderCellDelegate, UITableViewDelegate, UITableViewDataSource, NFUIVideoScrollLifecycleManagerDelegate, NFUINetworkErrorViewControllerDelegate, ViewControllerOverContextDelegateProtocol, NFUIUpdatesTableViewCellDelegate, NFUIScrollViewSnappingUtilDelegate, NFUITabContext>
{
    ...
    _Bool _hasPendingDeeplinkRemindMeAction;
    ...
    NSNumber *_overrideTrackIdForRemindMe;
...
@property(retain, nonatomic) NSNumber *overrideTrackIdForRemindMe; // @synthesize overrideTrackIdForRemindMe=_overrideTrackIdForRemindMe;
@property _Bool hasPendingDeeplinkRemindMeAction; // @synthesize hasPendingDeeplinkRemindMeAction=_hasPendingDeeplinkRemindMeAction;
...
- (void)autoRemindMeForTopPostIfNeeded:(id)arg1 videoId:(id)arg2;
- (void)viewDidLoad;
- (void)commonInit;
