...
@class DisplayPageRequest, ModalShimViewController, NFUICollectionViewCellManager, NFUIDisplayPageDataModel, NFUIManagedFeedViewController, NFUIMobileCollectionsToolTipView, NSDictionary, NSNumber, NSString, NavigationBarAppearanceManager, PlaybackSourceModel;
@protocol NFUIDisplayPageNavigationProtocol;

@interface NFUIDisplayPageViewController : UIViewController <NFUIDisplayPageProtocol, NFUIManagedCollectionViewControllerDelegate, NFUICollectionViewCellManagerDelegate, NFUICellSelectionProtocol, NFUIManagedFeedViewControllerDelegate>
{
