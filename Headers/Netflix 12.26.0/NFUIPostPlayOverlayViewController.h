...
@class NFOUICallToAction, NFUICloseButton, NFUIGradientView, NFUIPlayerViewController, NFUITouchGestureRecognizer, NSString, NSTimer, PostPlayViewModel, UIImageViewAligned, UITouch, UIView;
