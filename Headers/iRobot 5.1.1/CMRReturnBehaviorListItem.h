...
@interface CMRReturnBehaviorListItem : NSObject
{
    NSString *_titleId;
...
+ (id)ReturnBehaviorListItemWithTitleId:(id)arg1 descriptionId:(id)arg2 accessoryImageId:(id)arg3;
- (void).cxx_destruct;
...
- (id)initWithTitleId:(id)arg1 descriptionId:(id)arg2 accessoryImageId:(id)arg3;
