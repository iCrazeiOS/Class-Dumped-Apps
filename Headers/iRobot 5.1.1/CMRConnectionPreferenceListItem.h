...
@interface CMRConnectionPreferenceListItem : NSObject
{
    NSString *_titleId;
    NSString *_body;
...
+ (id)ConnectionPreferenceListItemWithTitleId:(id)arg1 body:(id)arg2 accessoryImageId:(id)arg3;
- (void).cxx_destruct;
...
- (id)initWithTitleId:(id)arg1 body:(id)arg2 accessoryImageId:(id)arg3;
