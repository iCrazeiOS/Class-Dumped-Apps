...
@protocol AWSSRWebSocketDelegate, OS_dispatch_queue;
...
@interface AWSSRWebSocket : NSObject <NSStreamDelegate>
{
    ...
    AWSSRWebSocket *_selfRetain;
    NSArray *_requestedProtocols;
    SRIOConsumerPool *_consumerPool;
    _Bool _allowsUntrustedSSLCertificates;
    id <AWSSRWebSocketDelegate> _delegate;
    NSURL *_url;
...
@property(nonatomic) __weak id <AWSSRWebSocketDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
