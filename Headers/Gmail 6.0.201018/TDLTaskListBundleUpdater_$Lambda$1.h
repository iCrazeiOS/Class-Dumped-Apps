...
@class NSString, TDLTaskListBundleUpdater;

@interface TDLTaskListBundleUpdater_$Lambda$1 : NSObject <ComGoogleCommonBaseFunction>
{
    TDLTaskListBundleUpdater *this$0_;
}
