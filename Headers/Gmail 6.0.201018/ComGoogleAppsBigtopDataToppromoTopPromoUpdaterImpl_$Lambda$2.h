...
@interface ComGoogleAppsBigtopDataToppromoTopPromoUpdaterImpl_$Lambda$2 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableMap *val$existingTopPromoAnnotationsMap_;
}
