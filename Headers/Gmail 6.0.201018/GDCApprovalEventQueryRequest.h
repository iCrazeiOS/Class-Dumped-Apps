...
@interface GDCApprovalEventQueryRequest : GPBMessage
{
}

+ (id)descriptor;
-     // Error parsing type: v24@0:8^{ApprovalEventQueryRequest=^^?{InternalMetadata=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{ArenaStringPtr={TaggedPtr<std::__1::basic_string<char> >=^v}}{ArenaStringPtr={TaggedPtr<std::__1::basic_string<char> >=^v}}^{MessageLite}q}16, name: toCpp:
