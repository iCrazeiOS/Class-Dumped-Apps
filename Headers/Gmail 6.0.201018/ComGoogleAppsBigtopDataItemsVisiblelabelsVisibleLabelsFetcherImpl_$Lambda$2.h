...
@interface ComGoogleAppsBigtopDataItemsVisiblelabelsVisibleLabelsFetcherImpl_$Lambda$2 : NSObject <ComGoogleCommonBasePredicate>
{
    id <JavaUtilSet> val$labelsToExcludeFromThreadlistView_;
}
