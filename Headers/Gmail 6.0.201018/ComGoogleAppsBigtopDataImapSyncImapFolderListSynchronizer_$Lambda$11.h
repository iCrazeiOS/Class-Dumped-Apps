...
@interface ComGoogleAppsBigtopDataImapSyncImapFolderListSynchronizer_$Lambda$11 : NSObject <ComGoogleCommonBasePredicate>
{
    id <JavaUtilCollection> val$foundTypes_;
}
