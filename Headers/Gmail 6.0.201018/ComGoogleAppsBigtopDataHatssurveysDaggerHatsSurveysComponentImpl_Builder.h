...
@protocol ComGoogleAppsBigtopDataCommonCommonComponent, ComGoogleAppsBigtopDataSettingsSettingsClientComponent, ComGoogleAppsBigtopDataStorageSystempropertiesApiSystemPropertiesComponent;

@interface ComGoogleAppsBigtopDataHatssurveysDaggerHatsSurveysComponentImpl_Builder : NSObject
{
