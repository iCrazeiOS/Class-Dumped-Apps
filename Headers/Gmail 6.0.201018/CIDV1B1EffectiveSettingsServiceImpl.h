...
#import "CIDV1B1EffectiveSettingsService-Protocol.h"

@class FCDRPC, NSArray, NSString;
@protocol FCDRPCAuthorizer, FCDRPCManager, FCDTransport;

@interface CIDV1B1EffectiveSettingsServiceImpl : FCDRPCService <CIDV1B1EffectiveSettingsService>
{
    FCDRPC *_rpcs[1];
}
...
+ (id)serviceName;
- (void).cxx_destruct;
@property(readonly, nonatomic) FCDRPC *getEffectiveSettingsRPC;
