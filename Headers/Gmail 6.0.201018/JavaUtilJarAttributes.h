...
- (void)readWithJavaUtilJarManifest_FastInputStream:(id)arg1 withByteArray:(id)arg2;
- (void)writeMainWithJavaIoDataOutputStream:(id)arg1;
- (void)writeWithJavaIoDataOutputStream:(id)arg1;
- (id)java_clone;
...
- (id)putValueWithNSString:(id)arg1 withNSString:(id)arg2;
- (id)putWithId:(id)arg1 withId:(id)arg2;
- (id)getValueWithJavaUtilJarAttributes_Name:(id)arg1;
- (id)getValueWithNSString:(id)arg1;
- (id)getWithId:(id)arg1;
- (id)initWithJavaUtilJarAttributes:(id)arg1;
