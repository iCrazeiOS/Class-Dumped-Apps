...
@interface DYNDoNotDisturbOptionContentViewObject : GOOBaseContentViewObject <DYNContentViewObject>
{
    BOOL _dividerType;
    NSString *_title;
}
...
- (void).cxx_destruct;
@property(nonatomic) BOOL dividerType; // @synthesize dividerType=_dividerType;
