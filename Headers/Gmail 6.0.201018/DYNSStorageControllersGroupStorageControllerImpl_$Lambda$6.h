...
@interface DYNSStorageControllersGroupStorageControllerImpl_$Lambda$6 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableMap *val$cachedNonRevisionedWorldData_;
}
