...
@interface ComGoogleAppsBigtopDataItemsStorageItemsQueryManager_$Lambda$18 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleAppsBigtopDataItemsItemsProto_ItemListEntry *val$summaryClusteredItemListEntry_;
}
