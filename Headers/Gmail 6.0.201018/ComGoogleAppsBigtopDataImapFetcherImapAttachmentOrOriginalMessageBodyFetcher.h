...
@class ComGoogleAppsBigtopDataImapCommandsImapFetchCommandProcessor, ComGoogleAppsBigtopDataImapCommandsImapSelectCommandProcessor, ComGoogleAppsBigtopDataImapStorageMessageSummaryTableController, ComGoogleAppsXplatSqlSqlDatabase;
@protocol ComGoogleAppsBigtopDataMailconnectionMailConnectionTaskRunner, JavaxInjectProvider;

@interface ComGoogleAppsBigtopDataImapFetcherImapAttachmentOrOriginalMessageBodyFetcher : NSObject
{
...
- (id)fetchOriginalMessageBodyWithNSString:(id)arg1;
