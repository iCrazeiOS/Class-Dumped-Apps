...
@class DYNSDataModelsConvertersGroupUserStateConverter, NSString;

@interface DYNSProcessorsUsergroupeventsGroupNotificationSettingsUpdatedEventsProcessor : NSObject <DYNSProcessorsUsergroupeventsUserGroupEventsProcessor>
{
