...
@class GHMQuestionSeriesMetadata, GPBFieldMask;

@interface GHMUpdateQuestionSeriesMetadataRequest : GPBMessage
{
}
...
@property(retain, nonatomic) GHMQuestionSeriesMetadata *questionSeriesMetadata; // @dynamic questionSeriesMetadata;
