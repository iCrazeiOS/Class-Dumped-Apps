...
@interface ComGoogleAppsBigtopDataImapSyncImapFromServerSynchronizer_$Lambda$6 : NSObject <ComGoogleCommonBaseFunction>
{
    id <JavaUtilMap_Entry> val$folderByKey_;
}
