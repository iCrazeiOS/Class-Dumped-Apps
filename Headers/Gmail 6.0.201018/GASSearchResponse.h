...
@class GASQueryInterpretation, NSMutableArray, NSString;

@interface GASSearchResponse : GPBMessage
{
}
...
@property(nonatomic) _Bool hasQueryInterpretation; // @dynamic hasQueryInterpretation;
...
@property(retain, nonatomic) GASQueryInterpretation *queryInterpretation; // @dynamic queryInterpretation;
