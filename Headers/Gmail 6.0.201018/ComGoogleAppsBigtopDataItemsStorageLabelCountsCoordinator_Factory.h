...
@interface ComGoogleAppsBigtopDataItemsStorageLabelCountsCoordinator_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> webOfflineEnabledProvider_;
}
