...
@interface DYNTypingIndicatorContentViewObject : GOOBaseContentViewObject <DYNContentViewObject>
{
    _Bool _smartReplyVisible;
    NSArray *_typingUserNames;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) NSArray *typingUserNames; // @synthesize typingUserNames=_typingUserNames;
@property(nonatomic) _Bool smartReplyVisible; // @synthesize smartReplyVisible=_smartReplyVisible;
- (_Bool)isEqualToDiffableObject:(id)arg1;
- (id)diffIdentifier;
- (_Bool)shouldShowInkView;
@property(retain, nonatomic) Class contentViewClass;
- (_Bool)isEqual:(id)arg1;
- (id)initWithTypingUserNames:(id)arg1;
