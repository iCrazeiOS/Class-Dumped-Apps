...
@class ComGoogleCommonCollectImmutableList, DYNSActionsGetTopicsHelper, NSString;

@interface DYNSActionsGetTopicsHelper_$Lambda$2 : NSObject <ComGoogleCommonBaseFunction>
{
    DYNSActionsGetTopicsHelper *this$0_;
