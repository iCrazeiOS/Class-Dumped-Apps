...
@class ComGoogleAppsBigtopDataSmtpSmtpSenderImpl, NSString;
@protocol ComGoogleAppsBigtopDataSmtpConnectionApiPersonalizedSmtpConnection;

@interface ComGoogleAppsBigtopDataSmtpSmtpSenderImpl_$Lambda$7 : NSObject <ComGoogleCommonUtilConcurrentAsyncFunction>
{
