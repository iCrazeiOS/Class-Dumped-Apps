...
#import "GBTSyncHintsServiceImplDeps-Protocol.h"

@class GOOProvider, NSString;
@protocol GBTAccountsService, SSOService;

@interface GBTSyncHintsServiceImplDepsImpl : NSObject <GBTSyncHintsServiceImplDeps>
{
...
- (id)initWithAccountsServiceProvider:(id)arg1 SSOServiceProvider:(id)arg2;
