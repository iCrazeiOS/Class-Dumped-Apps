...
@class GAVProjectorVC, NSArray, NSString, NSURL;
@protocol DYNProjectorViewControllerDelegate, DYNTimerEventLoggingService, GAVFileInfo, GAVFileLoading, GIPAccountID;

@interface DYNProjectorViewController : UIViewController <GAVProjectorDataSource, GAVProjectorDelegate>
{
    ...
    NSURL *_intentURL;
    id <DYNProjectorViewControllerDelegate> _delegate;
    NSArray *_rightBarButtons;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSArray *rightBarButtons; // @synthesize rightBarButtons=_rightBarButtons;
@property(nonatomic) __weak id <DYNProjectorViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)loadView;
- (id)initWithAccountID:(id)arg1 timerEventLoggingService:(id)arg2 fileLoader:(id)arg3 intentURL:(id)arg4 ssoAuthorization:(id)arg5 delegate:(id)arg6;
