...
@interface DYNSStatusImplUserStatusRequestManager_$Lambda$4 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableList *val$requestInputWithIds_;
}
