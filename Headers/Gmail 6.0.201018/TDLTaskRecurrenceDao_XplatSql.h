...
#import "TDLTaskRecurrenceDao-Protocol.h"

@class ComGoogleAppsXplatStorageDbAbstractDatabase, NSString;

@interface TDLTaskRecurrenceDao_XplatSql : NSObject <TDLTaskRecurrenceDao>
{
...
- (id)insertWithTDLTaskRecurrenceEntity:(id)arg1;
