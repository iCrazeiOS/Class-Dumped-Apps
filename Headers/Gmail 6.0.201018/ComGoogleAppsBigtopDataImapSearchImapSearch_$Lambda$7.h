...
@class ComGoogleAppsBigtopDataImapSearchImapSearch, ComGoogleAppsBigtopDataImapSearchImapSearchRequest, NSString;
@protocol ComGoogleAppsBigtopDataImapConnectionApiPersonalizedImapConnection;

@interface ComGoogleAppsBigtopDataImapSearchImapSearch_$Lambda$7 : NSObject <ComGoogleCommonUtilConcurrentAsyncFunction>
{
