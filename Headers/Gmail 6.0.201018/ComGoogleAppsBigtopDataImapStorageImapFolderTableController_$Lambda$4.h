...
@interface ComGoogleAppsBigtopDataImapStorageImapFolderTableController_$Lambda$4 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableList *val$folderTypes_;
}
