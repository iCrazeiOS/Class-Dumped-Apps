...
#import "DYNSUIModelsImplUiUserImpl_Builder.h"

@class DYNSCommonUserContextId, DYNSCommonUserType, JavaLangLong, JavaUtilOptional, NSString;
@protocol DYNSUIModelsUiUserStatus;

@interface DYNSUIModelsImplAutoValue_UiUserImpl_Builder : DYNSUIModelsImplUiUserImpl_Builder
{
...
- (id)setStatusWithDYNSUIModelsUiUserStatus:(id)arg1;
