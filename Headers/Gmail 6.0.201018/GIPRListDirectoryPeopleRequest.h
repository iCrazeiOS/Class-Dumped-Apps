...
@class GIPRExtensionSet, GIPRMergedPersonSourceOptions, GIPRPeopleContext, GIPRRequestMask, GPBEnumArray, NSString;

@interface GIPRListDirectoryPeopleRequest : GPBMessage
{
}
...
@property(readonly, nonatomic) int startOptionsOneOfCase; // @dynamic startOptionsOneOfCase;
