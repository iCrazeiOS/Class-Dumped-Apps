...
@protocol ComGoogleAppsBigtopDataCommonCommonComponent, ComGoogleAppsBigtopDataControlApiControlComponent, ComGoogleAppsBigtopSyncClientImplCommonSapiCommonComponent, ComGoogleAppsBigtopSyncClientImplCommonSapiMainThreadComponent, ComGoogleAppsBigtopSyncClientImplMetricsApiMetricsComponent, ComGoogleAppsBigtopSyncClientImplSyncApiSyncComponent, JBTLoggingEventLoggingComponent;

@interface ComGoogleAppsBigtopSyncClientImplShutdownDaggerShutdownComponentImpl_Builder : NSObject
{
