...
#import <AppAndExtensionsFramework/FCDRPCOperation-Protocol.h>

@class FCDRPCBackgroundTask, FCDRPCContext, FCDRPCRequest, NSString;
@protocol FCDInterceptorOperation, FCDRPCService, FCDRPCTransportOperation;
...
@property(readonly, nonatomic) id <FCDRPCService> service; // @synthesize service=_service;
