...
@class ComGoogleCommonBaseStopwatch, DYNSCommonGroupId, NSString;

@interface DYNSActionsSyncOnFlatGroupNotificationAction_$Lambda$2 : NSObject <ComGoogleCommonBaseFunction>
{
