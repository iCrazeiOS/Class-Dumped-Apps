...
@interface ComGoogleAppsBigtopSyncClientImplOrganizationSystemOrganizationElementProducerFactory_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> sapiMainExecutorProvider_;
    id <JavaxInjectProvider> observableSystemOrganizationElementsChangedProvider_;
    id <JavaxInjectProvider> systemOrganizationElementsReaderProvider_;
