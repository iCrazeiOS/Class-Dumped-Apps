...
@interface SunSecurityX509AuthorityInfoAccessExtension : SunSecurityX509Extension <SunSecurityX509CertAttrSet>
{
    id <JavaUtilList> accessDescriptions_;
}
