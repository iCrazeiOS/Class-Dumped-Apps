...
@class ComGoogleAppsXplatTracingTracingProto_AbortReason, ComGoogleAppsXplatTracingTracingProto_Attribute, ComGoogleAppsXplatTracingTracingProto_EventIntegrity, ComGoogleAppsXplatTracingTracingProto_Level, ComGoogleAppsXplatTracingTracingProto_Section, ComGoogleAppsXplatTracingTracingProto_ThreadNameMapping, ComGoogleAppsXplatTracingTracingProto_TraceId, NSString;
@protocol JavaUtilList;

@protocol ComGoogleAppsXplatTracingTracingProto_ProcessedTraceOrBuilder <ComGoogleProtobufMessageOrBuilder>
- (ComGoogleAppsXplatTracingTracingProto_Attribute *)getAttributesWithInt:(int)arg1;
- (id <JavaUtilList>)getAttributesList;
- (int)getAttributesCount;
- (ComGoogleAppsXplatTracingTracingProto_Section *)getSectionsWithInt:(int)arg1;
