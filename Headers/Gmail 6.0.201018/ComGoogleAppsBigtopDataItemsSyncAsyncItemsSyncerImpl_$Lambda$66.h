...
@class ComGoogleAppsBigtopDataItemsItemsProto_RequestPriority, ComGoogleAppsBigtopDataItemsSyncAsyncItemsSyncerImpl, ComGoogleCommonCollectImmutableMap, JBTSConfigureSyncRequest_SyncMode, NSString, OrgJodaTimeInstant;

@interface ComGoogleAppsBigtopDataItemsSyncAsyncItemsSyncerImpl_$Lambda$66 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleAppsBigtopDataItemsSyncAsyncItemsSyncerImpl *this$0_;
    ComGoogleCommonCollectImmutableMap *val$itemServerPermIdsMapInDefaultSyncSubscription_;
