...
@class ComGoogleNetWebchannelClientXplatSupportWebChannelSupportHttpRequest, NSString;

@interface ComGoogleNetWebchannelClientXplatSupportWebChannelSupportHttpRequest_WebChannelCharStreamHandler : NSObject <ComGoogleAppsXplatHttpBytestreamSerializer>
{
