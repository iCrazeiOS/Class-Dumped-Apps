...
@interface ComGoogleAppsBigtopSyncClientImplTasksFactoryTaskFactoryImpl_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> taskEditFactoryProvider_;
