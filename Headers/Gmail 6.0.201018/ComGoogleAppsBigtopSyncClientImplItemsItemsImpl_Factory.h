...
@interface ComGoogleAppsBigtopSyncClientImplItemsItemsImpl_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> legacyStorageIdsServiceProvider_;
