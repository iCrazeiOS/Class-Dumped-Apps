...
@protocol ComGoogleAppsBigtopDataCommonCommonComponent, ComGoogleAppsBigtopSyncClientImplCommonSapiMainThreadComponent;

@interface ComGoogleAppsBigtopSyncClientImplJobqueueDaggerSapiJobQueueComponentImpl_Builder : NSObject
{
