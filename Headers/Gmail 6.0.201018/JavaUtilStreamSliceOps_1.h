...
@interface JavaUtilStreamSliceOps_1 : JavaUtilStreamReferencePipeline_StatefulOp
{
    long long val$skip_;
...
- (id)unorderedSkipLimitSpliteratorWithJavaUtilSpliterator:(id)arg1 withLong:(long long)arg2 withLong:(long long)arg3 withLong:(long long)arg4;
