...
@interface SunSecurityX509CertificatePoliciesExtension : SunSecurityX509Extension <SunSecurityX509CertAttrSet>
{
    id <JavaUtilList> certPolicies_;
}
...
- (id)initWithJavaLangBoolean:(id)arg1 withJavaUtilList:(id)arg2;
