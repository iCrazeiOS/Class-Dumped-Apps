...
@interface DYNSStorageControllersTopicMessageStorageControllerImpl_$Lambda$20 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableList *val$removedMessageIdInfos_;
}
