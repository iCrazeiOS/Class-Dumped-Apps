...
@interface ComGoogleAppsBigtopSyncClientImplSnoozeSnoozeStringsFactory_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> settingsClientProvider_;
    id <JavaxInjectProvider> smartMailTranslationHelperProvider_;
