...
@class DYNSSyncV2UserCatchUpSaver, NSString;

@interface DYNSSyncV2UserCatchUpSaver_$Lambda$1 : NSObject <ComGoogleCommonBaseFunction>
{
    DYNSSyncV2UserCatchUpSaver *this$0_;
}
