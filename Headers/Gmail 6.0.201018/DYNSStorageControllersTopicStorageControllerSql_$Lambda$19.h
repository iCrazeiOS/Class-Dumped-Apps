...
@interface DYNSStorageControllersTopicStorageControllerSql_$Lambda$19 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableList *val$removedTopicIdInfos_;
}
