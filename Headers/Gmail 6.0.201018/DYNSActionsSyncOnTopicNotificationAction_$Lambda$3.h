...
@class ComGoogleCommonBaseStopwatch, DYNSCommonTopicId, NSString;

@interface DYNSActionsSyncOnTopicNotificationAction_$Lambda$3 : NSObject <ComGoogleCommonBaseFunction>
{
