...
@class GILClientVisualElement, MDCAlertActionManager, MDCAlertControllerView, MDCDialogTransitionController, NSArray, NSAttributedString, NSString, UIColor, UIFont, UIImage, UIView;
...
- (id)init;
- (void)dismissOnBackgrounding;
- (void)gil_instrumentAlertAction:(id)arg1 withClientVisualElement:(id)arg2;
- (void)gil_attachClientVisualElement:(id)arg1 syntheticParentView:(id)arg2;
@property(retain, nonatomic) GILClientVisualElement *gil_clientVisualElement;
- (void)gte_applyThemer:(id)arg1;
