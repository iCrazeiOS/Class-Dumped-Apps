...
@class ComGoogleAppsBigtopDataItemsItemlistsItemListManager, NSString;
@protocol JavaxInjectProvider;

@interface ComGoogleAppsBigtopDataItemsItemlistsItemListsServiceServer : NSObject <ComGoogleAppsBigtopDataItemsItemlistsApiItemListsService>
{
    id <JavaxInjectProvider> executor_;
    ComGoogleAppsBigtopDataItemsItemlistsItemListManager *itemListManager_;
}
