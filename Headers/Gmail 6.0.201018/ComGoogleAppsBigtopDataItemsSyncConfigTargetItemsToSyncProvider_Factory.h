...
@interface ComGoogleAppsBigtopDataItemsSyncConfigTargetItemsToSyncProvider_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> systemPropertiesClientProvider_;
    id <JavaxInjectProvider> enableDaysToSyncSettingProvider_;
    id <JavaxInjectProvider> defaultDaysToSyncSettingProvider_;
