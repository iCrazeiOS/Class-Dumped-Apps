...
@interface ComGoogleAppsBigtopSyncClientImplConversationsCommonAsyncContactFetchingListenerFactory : NSObject <ComGoogleAppsBigtopSyncClientImplConversationsApiInternalContactFetchingListener_Factory>
{
    id <ComGoogleAppsXplatDaggerAsyncProvider> contactFetchingListenerFactory_;
