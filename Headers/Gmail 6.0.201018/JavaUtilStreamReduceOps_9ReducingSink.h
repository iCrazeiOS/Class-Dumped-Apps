...
@interface JavaUtilStreamReduceOps_9ReducingSink : NSObject <JavaUtilStreamReduceOps_AccumulatingSink, JavaUtilStreamSink_OfLong>
{
...
- (id)initWithJavaUtilFunctionLongBinaryOperator:(id)arg1;
