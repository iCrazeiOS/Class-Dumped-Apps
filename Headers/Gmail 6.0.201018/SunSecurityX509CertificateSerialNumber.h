...
@class NSString, SunSecurityX509SerialNumber;

@interface SunSecurityX509CertificateSerialNumber : NSObject <SunSecurityX509CertAttrSet>
{
    SunSecurityX509SerialNumber *serial_;
}
