...
@interface ComGoogleAppsBigtopDataItemsStorageMessagedetailsItemMessagesTableController_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> executorProvider_;
    id <JavaxInjectProvider> shouldZipOnWritesProvider_;
