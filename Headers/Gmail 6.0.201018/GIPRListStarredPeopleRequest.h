...
@class GIPRCoreIdParams, GIPRExtensionSet, GIPRMergedPersonSourceOptions, GIPRPeopleContext, GIPRRequestMask, NSString;

@interface GIPRListStarredPeopleRequest : GPBMessage
{
}
