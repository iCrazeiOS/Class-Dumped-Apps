...
@interface ComGoogleAppsBigtopSyncClientImplItemlistsItemListElementProducer_$Lambda$22 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleAppsBigtopSyncClientImplItemlistsItemListElementProducer *this$0_;
    id <JavaUtilList> val$entries_;
}
