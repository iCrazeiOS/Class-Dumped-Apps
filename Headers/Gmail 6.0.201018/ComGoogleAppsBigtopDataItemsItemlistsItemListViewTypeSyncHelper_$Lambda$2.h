...
@interface ComGoogleAppsBigtopDataItemsItemlistsItemListViewTypeSyncHelper_$Lambda$2 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonBaseOptional *val$labelIdFromConfig_;
}
