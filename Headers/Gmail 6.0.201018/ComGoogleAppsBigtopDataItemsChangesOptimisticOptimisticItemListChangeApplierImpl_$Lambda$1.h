...
@interface ComGoogleAppsBigtopDataItemsChangesOptimisticOptimisticItemListChangeApplierImpl_$Lambda$1 : NSObject <ComGoogleCommonBasePredicate>
{
    NSString *val$pendingChangeItemServerPermId_;
}
