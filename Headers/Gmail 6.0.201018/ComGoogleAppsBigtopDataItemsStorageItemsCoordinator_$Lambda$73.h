...
@interface ComGoogleAppsBigtopDataItemsStorageItemsCoordinator_$Lambda$73 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableList *val$invalidatedMessages_;
}
