...
@interface DYNSSyncUploadClientMessageFlightLogSyncer_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> appFocusStateTrackerProvider_;
    id <JavaxInjectProvider> clearcutEventDataLoggerProvider_;
    id <JavaxInjectProvider> clientFlightLogStorageControllerProvider_;
