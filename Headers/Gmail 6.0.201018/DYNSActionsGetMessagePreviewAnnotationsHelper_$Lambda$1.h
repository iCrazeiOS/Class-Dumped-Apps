...
@interface DYNSActionsGetMessagePreviewAnnotationsHelper_$Lambda$1 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableList *val$clientAnnotations_;
}
