...
@interface ComGoogleAppsBigtopDataItemsStorageItemsEvictor_$Lambda$61 : NSObject <ComGoogleCommonBasePredicate>
{
    id <JavaUtilSet> val$activeItemServerPermIdsToExcludeForEviction_;
}
