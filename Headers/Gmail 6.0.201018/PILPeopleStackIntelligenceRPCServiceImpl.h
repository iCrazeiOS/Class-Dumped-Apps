...
#import "PILPeopleStackIntelligenceRPCService-Protocol.h"

@class FCDRPC, NSArray, NSString;
@protocol FCDRPCAuthorizer, FCDRPCManager, FCDTransport;

@interface PILPeopleStackIntelligenceRPCServiceImpl : FCDRPCService <PILPeopleStackIntelligenceRPCService>
{
    FCDRPC *_rpcs[1];
}
...
+ (id)serviceName;
- (void).cxx_destruct;
@property(readonly, nonatomic) FCDRPC *getAssistiveFeaturesRPC;
