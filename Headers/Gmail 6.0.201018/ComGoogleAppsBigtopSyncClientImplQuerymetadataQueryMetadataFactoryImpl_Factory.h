...
@interface ComGoogleAppsBigtopSyncClientImplQuerymetadataQueryMetadataFactoryImpl_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> clockProvider_;
    id <JavaxInjectProvider> messageVisibilityHelperFactoryProvider_;
    id <JavaxInjectProvider> searchRefinementChipFactoryProvider_;
