...
@interface ComGoogleAppsBigtopDataItemsItemlistsItemListSyncState_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> useSyncToRefreshSyncedLabelsEnabledProvider_;
