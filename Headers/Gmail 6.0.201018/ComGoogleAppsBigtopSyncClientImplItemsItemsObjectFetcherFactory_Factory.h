...
@interface ComGoogleAppsBigtopSyncClientImplItemsItemsObjectFetcherFactory_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> detailedItemPreloadingServiceProvider_;
