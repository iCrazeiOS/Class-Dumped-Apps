...
- (struct Status)assignBuffers:(map_7fc45808 *)arg1 outputIds:(const vector_12da65de *)arg2 usageRecordIds:(const map_99d22aef *)arg3 sharedBufferIds:(const vector_06e666a8 *)arg4 sharedBuffers:(const vector_aaf4ae7b *)arg5;
- (struct Status)setInputDimensionsWithDevice:(id)arg1 dimensions:(map_f5500562 *)arg2;
- (struct Status)compileWithDevice:(id)arg1 taskDescriptor:(shared_ptr_cee610e7)arg2 runtimeOptions:(const struct RuntimeOptions *)arg3;
