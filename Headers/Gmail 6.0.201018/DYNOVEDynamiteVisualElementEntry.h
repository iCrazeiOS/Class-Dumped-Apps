...
@class DYNOVEDynamiteVisualElementMetadata, LOGAncestryVisualElementProto;

@interface DYNOVEDynamiteVisualElementEntry : GPBMessage
{
}
...
@property(retain, nonatomic) DYNOVEDynamiteVisualElementMetadata *visualElementMetadata; // @dynamic visualElementMetadata;
