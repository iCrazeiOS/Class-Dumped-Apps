...
@interface DYNSStorageControllersUserSettingsStorageControllerImpl_$Lambda$11 : NSObject <ComGoogleCommonBaseFunction>
{
    _Bool val$shouldShowWorkingHoursEducation_;
}
