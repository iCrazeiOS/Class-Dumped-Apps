...
@interface ComGoogleAppsBigtopSyncClientImplRootSapiStartupCoordinator_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> syncWithMailProvider_;
    id <JavaxInjectProvider> syncWithoutMailProvider_;
}
