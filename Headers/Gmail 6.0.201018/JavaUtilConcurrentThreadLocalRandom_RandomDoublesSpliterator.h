...
@interface JavaUtilConcurrentThreadLocalRandom_RandomDoublesSpliterator : NSObject <JavaUtilSpliterator_OfDouble>
{
    long long index_;
    long long fence_;
    double origin_;
...
- (id)trySplit;
- (id)initWithLong:(long long)arg1 withLong:(long long)arg2 withDouble:(double)arg3 withDouble:(double)arg4;
