...
@class ComGoogleCommonBaseStopwatch, DYNSCommonGroupId, DYNSSyncV2CoordinatorsTopicPaginationHelper, DYNSSyncV2CoordinatorsTopicPaginationHelper_AnchorSortTimeInfo, DYNSSyncV2CoordinatorsTopicPaginationHelper_PaginationType, NSString;

@interface DYNSSyncV2CoordinatorsTopicPaginationHelper_$Lambda$1 : NSObject <ComGoogleCommonUtilConcurrentAsyncFunction>
{
