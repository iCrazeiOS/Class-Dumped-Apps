...
#import "GBTGuestBadgeServiceImplDeps-Protocol.h"

@class GOOProvider, NSString;
@protocol GBTSyncClientService, GIPAccountID;

@interface GBTGuestBadgeServiceImplDepsImpl : NSObject <GBTGuestBadgeServiceImplDeps>
{
...
- (id)initWithAccountID:(id)arg1 syncClientServiceProvider:(id)arg2;
