...
@protocol ComGoogleAppsBigtopDataCommonCommonComponent, ComGoogleAppsBigtopDataItemsStorageTypesItemsStorageTypesComponent, ComGoogleAppsBigtopDataStorageStorageComponent;

@interface ComGoogleAppsBigtopDataItemsStorageControllersDaggerItemsStorageControllersComponentImpl_Builder : NSObject
{
