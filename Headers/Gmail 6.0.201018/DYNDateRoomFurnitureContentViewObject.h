...
@interface DYNDateRoomFurnitureContentViewObject : GOOBaseContentViewObject <DYNContentViewObject, DYNMessageAssociable>
{
    id <DYNMessage> _message;
    NSString *_timestampTitle;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSString *timestampTitle; // @synthesize timestampTitle=_timestampTitle;
