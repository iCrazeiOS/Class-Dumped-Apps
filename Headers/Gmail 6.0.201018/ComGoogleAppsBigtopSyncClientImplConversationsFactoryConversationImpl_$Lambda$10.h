...
@interface ComGoogleAppsBigtopSyncClientImplConversationsFactoryConversationImpl_$Lambda$10 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleAppsBigtopSyncClientImplConversationsFactoryConversationImpl *target$_;
}
