...
@class GHMMeetingBreakoutState, GHMSyncMetadata;

@interface GHMBreakoutStateCollection : GPBMessage
{
}
...
@property(retain, nonatomic) GHMMeetingBreakoutState *breakoutState; // @dynamic breakoutState;
