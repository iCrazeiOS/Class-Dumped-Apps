...
+ (Class)layerClass;
+ (id)gte_floatingButtonWithShape:(long long)arg1 themer:(id)arg2;
+ (id)gte_flatButtonWithThemer:(id)arg1;
+ (id)gte_filledButtonWithThemer:(id)arg1;
+ (id)gte_textButtonWithThemer:(id)arg1;
+ (id)gte_buttonWithThemer:(id)arg1;
...
- (id)init;
- (void)gte_setTitleColor:(id)arg1;
