...
@interface ComGoogleAppsBigtopDataCommonJobsOneConcurrentLowPriorityRootJobThrottleStrategy_$Lambda$1 : NSObject <JavaUtilConcurrentCallable>
{
    ComGoogleAppsBigtopDataCommonJobsOneConcurrentLowPriorityRootJobThrottleStrategy *this$0_;
    id <ComGoogleCommonUtilConcurrentListenableFuture> val$taskResultFuture_;
