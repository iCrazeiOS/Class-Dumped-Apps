...
@interface PopupMenuView : PopupView <UITableViewDataSource, UITableViewDelegate, HUBFontManagerCachedFontAndAttributesRefresher>
{
...
+ (void)initialize;
- (void).cxx_destruct;
- (id)cellWithText:(id)arg1 automationIdentifier:(id)arg2;
- (void)createSubviews;
