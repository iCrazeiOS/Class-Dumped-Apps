...
@interface ComGoogleAppsBigtopSyncClientImplClienttriggeredscanClientTriggeredScannerImpl_Factory_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> sapiMainExecutorProvider_;
    id <JavaxInjectProvider> gmailApiServerApiaryClientProvider_;
    id <JavaxInjectProvider> itemsSyncControlServiceProvider_;
    id <JavaxInjectProvider> clientTriggeredScanUriProvider_;
    id <JavaxInjectProvider> clientTriggeredScanStateImplFactoryProvider_;
