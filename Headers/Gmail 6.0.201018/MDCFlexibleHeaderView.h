...
#import "MDCFlexibleHeaderMinMaxHeightDelegate-Protocol.h"
#import "MDCFlexibleHeaderTopSafeAreaDelegate-Protocol.h"
...
- (void)dealloc;
- (void)scrollTrackingViewIfNecessaryWithHeight:(double)arg1;
