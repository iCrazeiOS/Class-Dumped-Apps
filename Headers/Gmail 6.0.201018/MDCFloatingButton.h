...
@class MDCFloatingButtonModeAnimator, NSMutableDictionary, NSString, UIView;

@interface MDCFloatingButton : MDCButton <MDCFloatingButtonModeAnimatorDelegate>
{
    long long _shape;
...
- (id)init;
- (id)hub_title;
- (void)hub_setTitle:(id)arg1;
- (struct CGRect)hub_initialFrame;
- (void)hub_setInitialFrame:(struct CGRect)arg1;
- (struct CGPoint)hub_destinationCenterForInitialFrame:(struct CGRect)arg1 willExpand:(_Bool)arg2;
- (void)hub_collapse;
- (void)hub_expand;
