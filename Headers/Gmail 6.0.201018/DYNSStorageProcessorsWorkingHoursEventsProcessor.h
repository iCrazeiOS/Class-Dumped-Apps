...
@protocol DYNSStorageControllersWorkingHoursStorageControllerInternal;

@interface DYNSStorageProcessorsWorkingHoursEventsProcessor : DYNSStorageProcessorsAbstractEventsProcessor
{
    DYNSSyncV2SubscriptionsEventDispatcher *eventDispatcher_;
    id <DYNSStorageControllersWorkingHoursStorageControllerInternal> workingHoursStorageController_;
}
