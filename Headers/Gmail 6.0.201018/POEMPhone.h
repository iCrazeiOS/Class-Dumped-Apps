...
@class NSString, POEMFieldEmergencyInfo, POEMPersonFieldMetadata, POEMPhoneExtendedData;
...
@property(retain, nonatomic) POEMFieldEmergencyInfo *emergencyInfo; // @dynamic emergencyInfo;
...
@property(nonatomic) _Bool hasEmergencyInfo; // @dynamic hasEmergencyInfo;
