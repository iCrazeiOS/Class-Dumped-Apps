...
@interface ComGoogleAppsBigtopSyncClientImplComposeAsyncConversationMessageDraftImpl_$Lambda$1 : NSObject <ComGoogleCommonBasePredicate>
{
    id <JavaUtilSet> val$attachmentHashCodesToRemove_;
}
