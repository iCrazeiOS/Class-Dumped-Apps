...
@interface JavaUtilConcurrentThreadLocalRandom_RandomIntsSpliterator : NSObject <JavaUtilSpliterator_OfInt>
{
    long long index_;
    long long fence_;
    int origin_;
...
- (id)trySplit;
- (id)initWithLong:(long long)arg1 withLong:(long long)arg2 withInt:(int)arg3 withInt:(int)arg4;
