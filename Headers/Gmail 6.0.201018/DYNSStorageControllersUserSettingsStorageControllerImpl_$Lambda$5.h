...
@interface DYNSStorageControllersUserSettingsStorageControllerImpl_$Lambda$5 : NSObject <ComGoogleCommonBaseFunction>
{
    _Bool val$shouldShowOtrFirstEducation_;
}
