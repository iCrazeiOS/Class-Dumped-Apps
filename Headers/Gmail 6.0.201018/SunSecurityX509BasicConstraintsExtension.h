...
@interface SunSecurityX509BasicConstraintsExtension : SunSecurityX509Extension <SunSecurityX509CertAttrSet>
{
    _Bool ca_;
    int pathLen_;
}
...
- (id)initWithJavaLangBoolean:(id)arg1 withBoolean:(_Bool)arg2 withInt:(int)arg3;
- (id)initWithBoolean:(_Bool)arg1 withInt:(int)arg2;
- (void)encodeThis;
