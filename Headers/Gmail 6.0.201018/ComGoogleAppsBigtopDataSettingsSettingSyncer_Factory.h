...
@interface ComGoogleAppsBigtopDataSettingsSettingSyncer_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> btdDatabaseProvider_;
    id <JavaxInjectProvider> settingStorageProvider_;
    id <JavaxInjectProvider> syncServiceClientProvider_;
    id <JavaxInjectProvider> executorProvider_;
    id <JavaxInjectProvider> changesTableControllerProvider_;
    id <JavaxInjectProvider> settingSyncStatusManagerProvider_;
    id <JavaxInjectProvider> settableSettingDataChangedProvider_;
