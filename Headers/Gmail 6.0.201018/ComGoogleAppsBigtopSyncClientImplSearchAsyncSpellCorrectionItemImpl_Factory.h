...
@interface ComGoogleAppsBigtopSyncClientImplSearchAsyncSpellCorrectionItemImpl_Factory : NSObject
{
    ComGoogleAppsBigtopServicesGmailCommonComponentMessageVisibilityHelperFactory *messageVisibilityHelperFactory_;
}

- (void)dealloc;
- (id)createWithJBTId:(id)arg1 withComGoogleAppsBigtopServicesSearchSpellCorrection:(id)arg2;
