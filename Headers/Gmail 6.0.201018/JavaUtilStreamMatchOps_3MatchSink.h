...
@interface JavaUtilStreamMatchOps_3MatchSink : JavaUtilStreamMatchOps_BooleanTerminalSink <JavaUtilStreamSink_OfLong>
{
...
- (id)initWithJavaUtilStreamMatchOps_MatchKind:(id)arg1 withJavaUtilFunctionLongPredicate:(id)arg2;
