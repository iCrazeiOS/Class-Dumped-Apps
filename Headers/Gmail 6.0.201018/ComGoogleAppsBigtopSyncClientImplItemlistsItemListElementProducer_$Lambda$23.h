...
@class ComGoogleAppsBigtopServicesGmailCommonComponentSummaryItemData, ComGoogleAppsBigtopSyncClientImplItemlistsItemListElementProducer, ComGoogleCommonBaseOptional, NSString;
@protocol JBTId;

@interface ComGoogleAppsBigtopSyncClientImplItemlistsItemListElementProducer_$Lambda$23 : NSObject <ComGoogleCommonBaseFunction>
{
