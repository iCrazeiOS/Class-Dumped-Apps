...
@interface ComGoogleAppsBigtopDataImapChangesImapPostChangeFolderSynchronizer_$Lambda$7 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableList *val$latestRemoteMessages_;
}
