...
@interface ComGoogleAppsBigtopDataItemsStorageCommonSectionTeaserHelper_$Lambda$3 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonBaseOptional *val$maxSectionTeaserRank_;
}
