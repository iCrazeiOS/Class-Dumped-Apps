...
@interface ComGoogleAppsBigtopDataItemsSyncAsyncSyncToServerResponseHandler_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> itemsCoordinatorProvider_;
    id <JavaxInjectProvider> changesCoordinatorProvider_;
    id <JavaxInjectProvider> syncFailureHandlerProvider_;
    id <JavaxInjectProvider> itemsSyncStatusManagerProvider_;
    id <JavaxInjectProvider> processLocalBulkOpWorkJobFactoryProvider_;
    id <JavaxInjectProvider> settableRemoteChangeAppliedProvider_;
    id <JavaxInjectProvider> settablePermanentChangeFailureProvider_;
