...
@class ComGoogleCommonCollectImmutableMap_Builder, NSString;
@protocol JavaUtilMap_Entry;

@interface XPTXFutures_$Lambda$25 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableMap_Builder *val$outputBuilder_;
