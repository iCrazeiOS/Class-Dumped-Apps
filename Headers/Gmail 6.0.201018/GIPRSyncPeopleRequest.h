...
@class GIPRExtensionSet, GIPRMergedPersonSourceOptions, GIPRPeopleContext, GIPRRequestMask, GIPRSyncParams, NSString;

@interface GIPRSyncPeopleRequest : GPBMessage
{
}
...
@property(nonatomic) _Bool hasSyncParameters; // @dynamic hasSyncParameters;
...
@property(nonatomic) int peopleType; // @dynamic peopleType;
@property(retain, nonatomic) GIPRRequestMask *requestMask; // @dynamic requestMask;
@property(retain, nonatomic) GIPRSyncParams *syncParameters; // @dynamic syncParameters;
