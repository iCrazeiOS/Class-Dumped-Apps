...
@interface DYNSStorageControllersRosterStorageControllerImpl_$Lambda$3 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableMap *val$rosterMap_;
}
