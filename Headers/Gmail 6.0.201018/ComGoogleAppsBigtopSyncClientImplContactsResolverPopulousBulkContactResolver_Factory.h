...
@interface ComGoogleAppsBigtopSyncClientImplContactsResolverPopulousBulkContactResolver_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> sapiSpanFactoryProvider_;
    id <JavaxInjectProvider> contactsCacheProvider_;
    ...
    id <JavaxInjectProvider> contactsByEmailsFetcherProvider_;
