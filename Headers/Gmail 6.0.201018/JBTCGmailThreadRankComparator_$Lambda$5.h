...
@class JBTCGmailThreadRankComparator, NSString;

@interface JBTCGmailThreadRankComparator_$Lambda$5 : NSObject <ComGoogleCommonBasePredicate>
{
    JBTCGmailThreadRankComparator *this$0_;
}
