...
@interface ComGoogleAppsBigtopSyncClientImplSyncItemsSubscriptionAdapter_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> itemsSyncControlServiceProvider_;
    id <JavaxInjectProvider> observableItemsSyncControlServiceNeedsToSyncProvider_;
