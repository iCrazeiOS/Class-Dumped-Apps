...
@class ComGoogleAppsBigtopDataImapSyncImapChangeFromServerReconciler, ComGoogleAppsXplatSqlSqlTransaction, ComGoogleCommonCollectImmutableList, NSString;

@interface ComGoogleAppsBigtopDataImapSyncImapChangeFromServerReconciler_$Lambda$2 : NSObject <ComGoogleCommonUtilConcurrentAsyncFunction>
{
