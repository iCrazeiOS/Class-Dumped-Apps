...
@class DYNSSyncV2UserEventHandler, NSString;

@interface DYNSSyncV2UserEventHandler_$Lambda$1 : NSObject <ComGoogleCommonBaseFunction>
{
    DYNSSyncV2UserEventHandler *this$0_;
}
