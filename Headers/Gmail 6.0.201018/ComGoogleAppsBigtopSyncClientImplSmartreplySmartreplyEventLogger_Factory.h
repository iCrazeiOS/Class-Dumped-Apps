...
@interface ComGoogleAppsBigtopSyncClientImplSmartreplySmartreplyEventLogger_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> eventLoggerProvider_;
