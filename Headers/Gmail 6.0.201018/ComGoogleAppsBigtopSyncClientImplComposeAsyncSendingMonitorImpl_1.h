...
@class ComGoogleAppsBigtopSyncClientImplComposeAsyncSendingMonitorImpl, NSString;

@interface ComGoogleAppsBigtopSyncClientImplComposeAsyncSendingMonitorImpl_1 : NSObject <ComGoogleAppsBigtopSyncClientImplProducersElementProducer_Listener>
{
