...
@interface ComGoogleAppsBigtopDataItemsStorageItemVisibilityRecalculationScheduler_$Lambda$14 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonBaseOptional *val$oldTimezoneOffsetMs_;
}
