...
@interface ComGoogleAppsBigtopDataSettingsSettingSyncStatusManager_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> settableSettingSyncStatusProvider_;
