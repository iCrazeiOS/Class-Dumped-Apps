...
@class ComGoogleAppsBigtopDataImapChangesImapModifyLabelsCommandHandler, ComGoogleCommonBaseOptional, ComGoogleCommonCollectImmutableList, NSString;
@protocol ComGoogleAppsBigtopDataImapConnectionApiPersonalizedImapConnection;

@interface ComGoogleAppsBigtopDataImapChangesImapModifyLabelsCommandHandler_$Lambda$9 : NSObject <ComGoogleCommonUtilConcurrentAsyncFunction>
{
