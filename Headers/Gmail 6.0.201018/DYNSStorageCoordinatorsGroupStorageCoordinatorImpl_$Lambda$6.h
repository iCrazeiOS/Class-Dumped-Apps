...
@class ComGoogleCommonBaseStopwatch, ComGoogleCommonCollectImmutableList, DYNSCommonGroupId, DYNSCommonInternalRevision, DYNSStorageCoordinatorsGroupStorageCoordinatorImpl, NSString;

@interface DYNSStorageCoordinatorsGroupStorageCoordinatorImpl_$Lambda$6 : NSObject <ComGoogleAppsXplatSqlSqlDatabase_RunInTransaction>
{
