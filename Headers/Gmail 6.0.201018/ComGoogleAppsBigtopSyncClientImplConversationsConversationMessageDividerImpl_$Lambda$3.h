...
@interface ComGoogleAppsBigtopSyncClientImplConversationsConversationMessageDividerImpl_$Lambda$3 : NSObject <ComGoogleCommonBasePredicate>
{
    id <JavaUtilList> val$aliasedEmailAddresses_;
}
