...
@interface ComGoogleAppsBigtopSyncClientImplShutdownSapiShutdownCoordinatorImpl_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> controlServiceClientProvider_;
