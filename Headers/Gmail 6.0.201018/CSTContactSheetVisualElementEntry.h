...
@class CSTContactSheetVisualElementMetadata, LOGAncestryVisualElementProto;
...
@property(retain, nonatomic) CSTContactSheetVisualElementMetadata *visualElementMetadata; // @dynamic visualElementMetadata;
