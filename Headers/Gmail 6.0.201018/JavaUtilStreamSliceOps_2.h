...
#import "JavaUtilStreamIntPipeline_StatefulOp.h"

@interface JavaUtilStreamSliceOps_2 : JavaUtilStreamIntPipeline_StatefulOp
{
    long long val$skip_;
...
- (id)unorderedSkipLimitSpliteratorWithJavaUtilSpliterator_OfInt:(id)arg1 withLong:(long long)arg2 withLong:(long long)arg3 withLong:(long long)arg4;
