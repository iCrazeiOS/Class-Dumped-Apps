...
#import "ComGoogleAppsBigtopServicesSettingsCommonSettingId.h"

@class ComGoogleCommonBaseOptional;

@interface ComGoogleAppsBigtopServicesSettingsCommonAutoValue_SettingId : ComGoogleAppsBigtopServicesSettingsCommonSettingId
{
