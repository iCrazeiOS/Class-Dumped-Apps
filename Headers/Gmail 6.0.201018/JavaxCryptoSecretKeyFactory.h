...
- (id)translateKeyWithJavaxCryptoSecretKey:(id)arg1;
- (id)getKeySpecWithJavaxCryptoSecretKey:(id)arg1 withIOSClass:(id)arg2;
- (id)generateSecretWithJavaSecuritySpecKeySpec:(id)arg1;
- (id)nextSpiWithJavaxCryptoSecretKeyFactorySpi:(id)arg1;
- (id)getAlgorithm;
- (id)getProvider;
- (id)initWithNSString:(id)arg1;
- (id)initWithJavaxCryptoSecretKeyFactorySpi:(id)arg1 withJavaSecurityProvider:(id)arg2 withNSString:(id)arg3;
