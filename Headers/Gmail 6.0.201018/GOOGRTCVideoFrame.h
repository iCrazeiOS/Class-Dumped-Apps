...
@protocol GOOGRTCVideoFrameBuffer;
...
@interface GOOGRTCVideoFrame : NSObject
{
    ...
    int timeStamp;
    id <GOOGRTCVideoFrameBuffer> _buffer;
}

- (void).cxx_destruct;
@property(nonatomic) int timeStamp; // @synthesize timeStamp;
@property(readonly, nonatomic) id <GOOGRTCVideoFrameBuffer> buffer; // @synthesize buffer=_buffer;
