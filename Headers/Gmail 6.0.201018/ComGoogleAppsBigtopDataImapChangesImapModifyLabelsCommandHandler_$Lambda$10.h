...
@class ComGoogleAppsBigtopDataImapChangesImapModifyLabelsCommandHandler, ComGoogleAppsBigtopDataImapChangesImapModifyLabelsCommandHandler_FlagsToAddAndRemove, ComGoogleCommonCollectImmutableList, NSString;
@protocol ComGoogleAppsBigtopDataImapConnectionApiPersonalizedImapConnection;

@interface ComGoogleAppsBigtopDataImapChangesImapModifyLabelsCommandHandler_$Lambda$10 : NSObject <ComGoogleCommonUtilConcurrentAsyncFunction>
{
    ...
    ComGoogleCommonCollectImmutableList *val$messageUids_;
