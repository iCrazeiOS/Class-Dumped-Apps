...
@class GIPRExtensionSet, GIPRMergedPersonSourceOptions, GIPRPagingOptions, GIPRPeopleContext, GIPRRequestMask, GIPRRequestedAffinity, SGWPPDataFormats;

@interface GIPRListRankedTargetsRequest : GPBMessage
{
}
...
@property(retain, nonatomic) GIPRRequestedAffinity *affinity; // @dynamic affinity;
