...
@interface VCPBDoNotDisturbInfo_Mask : GPBMessage
{
}
...
@property(nonatomic) _Bool dndReason; // @dynamic dndReason;
...
@property(nonatomic) _Bool expiration; // @dynamic expiration;
