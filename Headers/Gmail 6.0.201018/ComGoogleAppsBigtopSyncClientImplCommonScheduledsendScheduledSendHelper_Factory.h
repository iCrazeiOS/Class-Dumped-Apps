...
@interface ComGoogleAppsBigtopSyncClientImplCommonScheduledsendScheduledSendHelper_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> labelCountsProvider_;
