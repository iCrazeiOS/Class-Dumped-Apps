...
@interface ComGoogleAppsBigtopSyncClientImplOrganizationOrganizationElementSectionsFactory : NSObject <ComGoogleAppsBigtopSyncClientImplSectionsApiSectionsFactory>
{
    id <ComGoogleAppsBigtopSyncClientImplCommonLiveListAdaptor> liveListAdaptor_;
    id <JavaUtilComparator> organizationElementComparator_;
