...
@interface ComGoogleAppsBigtopSyncClientImplSectionsSectionImpl_RangeRankOracle : NSObject <ComGoogleAppsBigtopSyncClientImplSectionsApiInternalSection_SectionOracle>
{
    NSString *minRank_;
    NSString *maxRank_;
}
