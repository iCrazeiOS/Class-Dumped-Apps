...
@interface ComGoogleAppsBigtopDataItemsMessagesDetailedItemPreloadingServiceServer_$Lambda$2 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonBaseOptional *val$threadAndLabelsOptional_;
}
