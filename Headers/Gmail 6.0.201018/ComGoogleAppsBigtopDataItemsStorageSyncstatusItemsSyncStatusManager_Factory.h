...
@interface ComGoogleAppsBigtopDataItemsStorageSyncstatusItemsSyncStatusManager_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> settableItemsSyncStatusProvider_;
    ...
    id <JavaxInjectProvider> observableEvictionFinishedProvider_;
