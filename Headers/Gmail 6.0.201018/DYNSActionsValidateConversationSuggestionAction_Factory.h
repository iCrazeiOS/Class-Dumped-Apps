...
@interface DYNSActionsValidateConversationSuggestionAction_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> conversationSuggestionsSettableProvider_;
}
