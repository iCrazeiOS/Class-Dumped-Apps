...
@class DYNSCommonGroupId, DYNSSyncV2CoordinatorsCatchUpManager, NSString;

@interface DYNSSyncV2CoordinatorsCatchUpManager_$Lambda$11 : NSObject <ComGoogleCommonBaseFunction>
{
