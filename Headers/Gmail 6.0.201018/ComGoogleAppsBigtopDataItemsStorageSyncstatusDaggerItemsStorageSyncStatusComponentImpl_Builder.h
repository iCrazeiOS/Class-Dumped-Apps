...
@class ComGoogleAppsBigtopDataItemsSyncStatusItemsSyncStatusComponent;
@protocol ComGoogleAppsBigtopDataCommonCommonComponent, ComGoogleAppsBigtopDataItemsChangesApplierAppliersComponent, ComGoogleAppsBigtopDataItemsStorageControllersItemsStorageControllersComponent, ComGoogleAppsBigtopDataItemsStorageItemsStorageComponent, ComGoogleAppsBigtopDataItemsStorageMessagedetailsApiItemMessagesCoordinatorComponent, ComGoogleAppsBigtopDataStorageStorageComponent;

@interface ComGoogleAppsBigtopDataItemsStorageSyncstatusDaggerItemsStorageSyncStatusComponentImpl_Builder : NSObject
{
