...
@class DYNReadingBehaviorHelper, NSString;

@interface DYNDirectMessageReadingBehavior : NSObject <DYNStreamBehavior>
{
    DYNReadingBehaviorHelper *_helper;
}

- (void).cxx_destruct;
- (void)finalizeWithStreamState:(id)arg1;
- (_Bool)isMessageReadingAllowedWithState:(id)arg1;
