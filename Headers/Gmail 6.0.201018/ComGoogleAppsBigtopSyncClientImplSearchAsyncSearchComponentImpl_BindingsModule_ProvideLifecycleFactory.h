...
@interface ComGoogleAppsBigtopSyncClientImplSearchAsyncSearchComponentImpl_BindingsModule_ProvideLifecycleFactory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> sapiLifecycleProvider_;
    id <JavaxInjectProvider> nonCriticalStartupEventProvider_;
