...
@class GIPRCoreIdParams, GIPRExtensionSet, GIPRFieldFilter, GIPRMergedPersonSourceOptions, GIPRPeopleContext, GIPRRequestMask, NSString;

@interface GIPRListContactPeopleRequest : GPBMessage
{
}
...
@property(nonatomic) int contactListType; // @dynamic contactListType;
