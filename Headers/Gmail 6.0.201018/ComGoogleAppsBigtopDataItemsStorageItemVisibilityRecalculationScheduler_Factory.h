...
@interface ComGoogleAppsBigtopDataItemsStorageItemVisibilityRecalculationScheduler_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> workProcessorProvider_;
    id <JavaxInjectProvider> workProcessorJobFactoryProvider_;
    ...
    id <JavaxInjectProvider> itemVisibilityVersionProvider_;
