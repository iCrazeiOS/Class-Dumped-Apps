...
@property(nonatomic) _Bool hasJspbUseCorrectProto2Semantics; // @dynamic hasJspbUseCorrectProto2Semantics;
...
@property(nonatomic) _Bool jspbUseCorrectProto2Semantics; // @dynamic jspbUseCorrectProto2Semantics;
