...
@interface ComGoogleAppsBigtopSyncClientImplConversationsFactoryConversationImpl_$Lambda$43 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleAppsBigtopSyncClientImplConversationsFactoryConversationImpl *this$0_;
    id <JBTSmartMailComponentContext> val$smartMailComponentContext_;
}
