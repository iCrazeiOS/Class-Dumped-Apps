...
#import "GBTOrphanedDataCleanupServiceImplDeps-Protocol.h"

@class GOOAccountScopedProvider, GOOProvider, NSString;
@protocol GBTAccountsService;

@interface GBTOrphanedDataCleanupServiceImplDepsImpl : NSObject <GBTOrphanedDataCleanupServiceImplDeps>
{
...
- (id)initWithAccountsServiceProvider:(id)arg1 eventLoggingServiceProvider:(id)arg2;
