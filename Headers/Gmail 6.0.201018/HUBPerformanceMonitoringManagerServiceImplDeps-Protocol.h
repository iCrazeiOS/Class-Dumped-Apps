...
@protocol GIPAccountID, GSCAccountsService, HUBAppAvailabilityService, HUBHostTabBarNavigationService;

@protocol HUBPerformanceMonitoringManagerServiceImplDeps <NSObject>
