...
@interface ComGoogleAppsBigtopSyncClientImplLabelsVisibleVisibleLabelFactory_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> translationHelperProvider_;
    id <JavaxInjectProvider> labelComparatorProvider_;
