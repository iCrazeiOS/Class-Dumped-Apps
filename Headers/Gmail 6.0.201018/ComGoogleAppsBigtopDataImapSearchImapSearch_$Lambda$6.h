...
@class ComGoogleAppsBigtopDataImapSearchImapSearch, NSString;
@protocol JavaUtilSet;

@interface ComGoogleAppsBigtopDataImapSearchImapSearch_$Lambda$6 : NSObject <ComGoogleCommonBaseFunction>
{
