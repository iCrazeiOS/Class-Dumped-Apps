...
@interface ComGoogleAppsBigtopDataItemsMessagesAbstractMemoryItemMessageList_$Lambda$3 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonBaseOptional *val$lifecycleStartDependency_;
}
