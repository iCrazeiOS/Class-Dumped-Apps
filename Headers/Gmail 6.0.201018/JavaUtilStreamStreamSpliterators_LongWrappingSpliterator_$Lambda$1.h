...
@interface JavaUtilStreamStreamSpliterators_LongWrappingSpliterator_$Lambda$1 : NSObject <JavaUtilStreamSink_OfLong>
{
    JavaUtilStreamSpinedBuffer_OfLong *target$_;
}
