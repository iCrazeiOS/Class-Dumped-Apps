...
@class NSString;
@protocol JavaUtilFunctionBiConsumer, JavaUtilFunctionBinaryOperator, JavaUtilFunctionSupplier;

@interface JavaUtilStreamReduceOps_3ReducingSink : JavaUtilStreamReduceOps_Box <JavaUtilStreamReduceOps_AccumulatingSink>
{
...
- (id)initWithJavaUtilFunctionSupplier:(id)arg1 withJavaUtilFunctionBiConsumer:(id)arg2 withJavaUtilFunctionBinaryOperator:(id)arg3;
