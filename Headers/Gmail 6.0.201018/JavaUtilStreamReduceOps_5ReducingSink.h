...
@interface JavaUtilStreamReduceOps_5ReducingSink : NSObject <JavaUtilStreamReduceOps_AccumulatingSink, JavaUtilStreamSink_OfInt>
{
    int val$identity_;
...
- (id)initWithInt:(int)arg1 withJavaUtilFunctionIntBinaryOperator:(id)arg2;
