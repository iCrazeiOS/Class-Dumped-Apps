...
@interface ComGoogleAppsBigtopDataImapSyncImapFromServerSynchronizer_$Lambda$3 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableMap *val$foldersByKey_;
}
