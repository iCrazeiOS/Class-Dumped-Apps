...
#import "DYNSStorageSchemaClientFlightLogDao-Protocol.h"

@class ComGoogleAppsXplatStorageDbAbstractDatabase, NSString;

@interface DYNSStorageSchemaClientFlightLogDao_XplatSql : NSObject <DYNSStorageSchemaClientFlightLogDao>
{
