...
@interface DYNSStorageControllersUserSettingsStorageControllerImpl_$Lambda$8 : NSObject <ComGoogleCommonBaseFunction>
{
    _Bool val$shouldShowRoomNotificationsPromo_;
}
