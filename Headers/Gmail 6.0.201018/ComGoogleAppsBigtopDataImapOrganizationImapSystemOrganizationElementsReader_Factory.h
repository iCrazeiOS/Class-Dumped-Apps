...
@interface ComGoogleAppsBigtopDataImapOrganizationImapSystemOrganizationElementsReader_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> folderTableControllerProvider_;
    id <JavaxInjectProvider> databaseProvider_;
    id <JavaxInjectProvider> imapExecutorProvider_;
    id <JavaxInjectProvider> treatJunkFolderAsSystemLabelProvider_;
