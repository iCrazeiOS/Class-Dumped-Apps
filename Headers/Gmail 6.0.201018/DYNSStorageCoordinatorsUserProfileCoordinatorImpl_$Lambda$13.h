...
@interface DYNSStorageCoordinatorsUserProfileCoordinatorImpl_$Lambda$13 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableList *val$updatedUsers_;
}
