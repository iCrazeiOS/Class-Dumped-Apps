...
@class DYNSCommonGroupId, DYNSStorageSchemaGroupDao_XplatSql, NSString;

@interface DYNSStorageSchemaGroupDao_XplatSql_$Lambda$47 : NSObject <ComGoogleCommonBaseFunction>
{
    DYNSStorageSchemaGroupDao_XplatSql *this$0_;
    _Bool val$param_isOffTheRecord_;
