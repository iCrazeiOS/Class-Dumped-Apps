...
@interface ComGoogleAppsBigtopSyncClientImplTaskssupportAsyncLocalReminderBumper_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> taskListProvider_;
