...
@interface DYNCreatePostActionButtonBehavior : NSObject <DYNStreamBehavior>
{
...
- (void).cxx_destruct;
- (void)navigateToCreatePostWithGroup:(id)arg1;
- (void)didTapCreatePostTopic;
- (double)desiredBottomContentInset;
