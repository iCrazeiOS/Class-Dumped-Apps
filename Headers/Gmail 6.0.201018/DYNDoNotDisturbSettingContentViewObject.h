...
@interface DYNDoNotDisturbSettingContentViewObject : GOOBaseContentViewObject <DYNContentViewObject>
{
    NSString *_title;
    long long _lengthInSeconds;
}

- (void).cxx_destruct;
@property(nonatomic) long long lengthInSeconds; // @synthesize lengthInSeconds=_lengthInSeconds;
