...
@class NSString;
@protocol DYNMemberCacheService, DYNStream;

@interface DYNMemberFetchAndRefreshBehavior : NSObject <DYNDMSupplementalRenderDelegate, DYNStreamBehavior>
{
...
- (void).cxx_destruct;
- (id)cvoReplacingCVO:(id)arg1;
- (void)fetchRequiredUsersForModel:(id)arg1;
