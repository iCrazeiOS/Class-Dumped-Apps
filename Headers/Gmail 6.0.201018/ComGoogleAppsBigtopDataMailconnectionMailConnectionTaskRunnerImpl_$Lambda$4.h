...
@class ComGoogleAppsBigtopDataMailconnectionMailConnectionTaskRunnerImpl, NSString;
@protocol ComGoogleAppsBigtopDataMailconnectionMailConnectionTaskRunner_RunWithMailConnection, JavaUtilConcurrentExecutor;

@interface ComGoogleAppsBigtopDataMailconnectionMailConnectionTaskRunnerImpl_$Lambda$4 : NSObject <ComGoogleCommonUtilConcurrentAsyncFunction>
{
