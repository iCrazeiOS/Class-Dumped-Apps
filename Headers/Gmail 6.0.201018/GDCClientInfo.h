...
@interface GDCClientInfo : GPBMessage
{
}
...
@property(nonatomic) _Bool hasScenarioType; // @dynamic hasScenarioType;
...
@property(nonatomic) int scenarioType; // @dynamic scenarioType;
