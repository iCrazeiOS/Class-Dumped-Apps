...
@interface ComGoogleAppsBigtopSyncClientImplFiltersFactoryFilterConfigFactoryImpl_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> itemServerPermIdParserProvider_;
}
