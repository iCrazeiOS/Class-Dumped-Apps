...
@class DYNSDataModelsConvertersUserSettingsConverter, DYNSSyncV2SubscriptionsEventDispatcher;
@protocol DYNSCommonKeyValueStore, DYNSStorageControllersUserSettingsStorageControllerInternal;

@interface DYNSStorageProcessorsUserSettingsEventsProcessor : DYNSStorageProcessorsAbstractEventsProcessor
{
