...
@interface ComGoogleAppsBigtopDataNetworkHttpAuthenticatedIosXplatHttpTransportModule_ProvideAuthedHttpClientFactory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> dapperTraceThresholdMsProvider_;
