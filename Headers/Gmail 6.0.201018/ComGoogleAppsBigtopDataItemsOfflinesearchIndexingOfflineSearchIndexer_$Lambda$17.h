...
@interface ComGoogleAppsBigtopDataItemsOfflinesearchIndexingOfflineSearchIndexer_$Lambda$17 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonBaseOptional *val$offlineIndexingContinuationInfo_;
}
