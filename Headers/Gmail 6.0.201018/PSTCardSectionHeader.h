...
@interface PSTCardSectionHeader : UICollectionReusableView
{
    UILabel *_titleLabel;
...
+ (void)collectXibData;
+ (id)font;
+ (double)referenceHeightForText:(id)arg1 placement:(unsigned long long)arg2 constrainedToWidth:(double)arg3;
- (void).cxx_destruct;
