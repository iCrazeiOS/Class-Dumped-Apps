...
@class DYNSSyncFileSyncManager, XPTXLogger;

@interface DYNSStorageProcessorsGroupFileEventsProcessor : DYNSStorageProcessorsAbstractEventsProcessor
{
    XPTXLogger *logger_;
    DYNSSyncFileSyncManager *fileSyncManager_;
}
