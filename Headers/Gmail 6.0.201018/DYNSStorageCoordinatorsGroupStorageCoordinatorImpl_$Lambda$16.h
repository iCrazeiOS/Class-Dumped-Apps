...
@class ComGoogleAppsXplatSqlSqlTransaction, ComGoogleCommonBaseStopwatch, ComGoogleCommonCollectImmutableList, DYNSCommonGroupId, DYNSStorageCoordinatorsGroupStorageCoordinatorImpl, NSString;

@interface DYNSStorageCoordinatorsGroupStorageCoordinatorImpl_$Lambda$16 : NSObject <XPTXFutures_AsyncTransform2>
{
