...
@interface ComGoogleAppsTasksSharedDataImplSyncRoomsDataSyncExecutor_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> platformRoomResolverProvider_;
