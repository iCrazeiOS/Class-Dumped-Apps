...
@interface JBTLoggingEventLoggingModule_ProvideEventUploaderFactory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> storeProvider_;
    id <JavaxInjectProvider> strategyProvider_;
    id <JavaxInjectProvider> executorProvider_;
    id <JavaxInjectProvider> logTransportForSyncServerProvider_;
}
