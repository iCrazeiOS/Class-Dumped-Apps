...
@class GTSClientSyncState, NSString, TDLDataModelShard;

@interface TDLStorageImpl_$Lambda$47 : NSObject <ComGoogleCommonBaseFunction>
{
    NSString *val$shardId_;
    TDLDataModelShard *val$shard_;
    GTSClientSyncState *val$clientSyncState_;
}
