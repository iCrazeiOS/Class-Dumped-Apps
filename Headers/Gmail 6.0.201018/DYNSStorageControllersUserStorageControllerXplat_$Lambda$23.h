...
@interface DYNSStorageControllersUserStorageControllerXplat_$Lambda$23 : NSObject <ComGoogleCommonBaseFunction>
{
    ComGoogleCommonCollectImmutableList *val$contextIds_;
}
