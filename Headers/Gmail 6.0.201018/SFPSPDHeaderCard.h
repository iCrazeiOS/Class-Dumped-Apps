...
@interface SFPSPDHeaderCard : GPBMessage
{
}
...
@property(nonatomic) _Bool coverPhotoIsDefault; // @dynamic coverPhotoIsDefault;
...
@property(nonatomic) _Bool hasCoverPhotoIsDefault; // @dynamic hasCoverPhotoIsDefault;
