...
@class CSTReportingChainData_ChainLink, NSString;

@interface SGCCReportingChainCard_ChainLink : GPBMessage
{
}

+ (id)descriptor;
@property(readonly, nonatomic) CSTReportingChainData_ChainLink *cstChainLinkData;
