...
@interface DYNSAutocompletePopulousApplicabilityDecider_$Lambda$5 : NSObject <ComGoogleCommonBaseFunction>
{
    JavaUtilOptional *val$dasherAccountUserCapabilities_;
}
