...
#import <WalmartCore/_TtC17FinancialServices26FraudWarningViewController.h>

@class NSString;

@interface _TtC17FinancialServices26FraudWarningViewController (FinancialServices)
