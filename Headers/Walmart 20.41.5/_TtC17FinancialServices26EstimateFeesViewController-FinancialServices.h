...
#import <WalmartCore/_TtC17FinancialServices26EstimateFeesViewController.h>

@class NSString;

@interface _TtC17FinancialServices26EstimateFeesViewController (FinancialServices)
