...
#import <WalmartCore/_TtC17FinancialServices20CameraViewController.h>

@class NSString;

@interface _TtC17FinancialServices20CameraViewController (FinancialServices)
- (void)captureTapped:(id)arg1;
