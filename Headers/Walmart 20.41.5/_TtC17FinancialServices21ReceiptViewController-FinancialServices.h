...
#import <WalmartCore/_TtC17FinancialServices21ReceiptViewController.h>

@class NSString;

@interface _TtC17FinancialServices21ReceiptViewController (FinancialServices)
- (void)didTouchShareReceipt;
