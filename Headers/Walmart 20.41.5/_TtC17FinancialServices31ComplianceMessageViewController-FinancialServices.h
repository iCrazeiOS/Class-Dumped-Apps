...
#import <WalmartCore/_TtC17FinancialServices31ComplianceMessageViewController.h>

@class NSString;

@interface _TtC17FinancialServices31ComplianceMessageViewController (FinancialServices)
