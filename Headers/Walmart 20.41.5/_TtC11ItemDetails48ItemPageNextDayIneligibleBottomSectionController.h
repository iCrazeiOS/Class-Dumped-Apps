...
@interface _TtC11ItemDetails48ItemPageNextDayIneligibleBottomSectionController : NSObject
{
    // Error parsing type: , name: identifier
    // Error parsing type: , name: viewModel
    // Error parsing type: , name: cellHeights
    // Error parsing type: , name: isShowOtherShippingEnabled
    // Error parsing type: , name: showOtherOptionsClosure
}
