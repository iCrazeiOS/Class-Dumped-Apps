...
@interface WMPangaeaCartGiftCardItem : NSObject <PangaeaCartEGiftCardItem>
{
...
@property(copy, nonatomic) NSString *recipientEmail; // @synthesize recipientEmail;
@property(copy, nonatomic) NSString *senderName; // @synthesize senderName;
@property(copy, nonatomic) NSString *giftMessage; // @synthesize giftMessage;
- (id)toDictionary;
