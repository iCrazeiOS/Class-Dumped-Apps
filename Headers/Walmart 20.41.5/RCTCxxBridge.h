...
#import <ElectrodeContainer/RCTBridge.h>
...
@interface RCTCxxBridge : RCTBridge
{
    ...
    // Error parsing type: {atomic<long>="__a_"{__cxx_atomic_impl<long, std::__1::__cxx_atomic_base_impl<long> >="__a_value"Aq}}, name: _pendingCount
...
- (shared_ptr_cb283e74)decorateNativeCallInvoker:(shared_ptr_cb283e74)arg1;
- (shared_ptr_cb283e74)jsCallInvoker;
- (void)invokeAsync:(function_445bca8f *)arg1;
