...
#import <WalmartCore/_TtC17FinancialServices27PrimarySearchViewController.h>

@class NSString;

@interface _TtC17FinancialServices27PrimarySearchViewController (FinancialServices)
