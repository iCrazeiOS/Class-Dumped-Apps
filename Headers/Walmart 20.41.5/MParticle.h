...
#import <mParticle_Apple_SDK/MPBackendControllerDelegate-Protocol.h>
#import <mParticle_Apple_SDK/WKScriptMessageHandler-Protocol.h>

@class CLLocation, MPAppNotificationHandler, MPBackendController, MPIdentityApi, MPKitActivity, MPKitContainer, MPNetworkOptions, MPPersistenceController, MPStateMachine, MParticleOptions, MParticleSession, MParticleWebView, NSArray, NSData, NSMutableArray, NSMutableDictionary, NSNumber, NSString;
