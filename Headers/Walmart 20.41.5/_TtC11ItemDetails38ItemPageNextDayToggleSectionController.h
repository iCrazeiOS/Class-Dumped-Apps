...
@interface _TtC11ItemDetails38ItemPageNextDayToggleSectionController : NSObject
{
    // Error parsing type: , name: identifier
    // Error parsing type: , name: cellHeights
    // Error parsing type: , name: sectionController
    // Error parsing type: , name: itemPageVC
    // Error parsing type: , name: isToggleSwitchUserInteractionEnabled
}
