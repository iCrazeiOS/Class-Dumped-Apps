...
#import <AtriusLocation/ATRILocationTransformStrategy-Protocol.h>

@class NSDictionary, NSString;

@interface GeoLocationTransformStrategy : NSObject <ATRILocationTransformStrategy>
{
...
- (id)initWithFloorspaces:(id)arg1;
