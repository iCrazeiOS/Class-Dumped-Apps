...
#import <ElectrodeContainer/NativeStatusBarManagerIOSSpec-Protocol.h>
...
+ (const struct RCTMethodInfo *)__rct_export__1813;
+ (const struct RCTMethodInfo *)__rct_export__1672;
+ (const struct RCTMethodInfo *)__rct_export__1531;
+ (const struct RCTMethodInfo *)__rct_export__1460;
