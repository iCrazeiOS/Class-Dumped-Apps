...
#import <WalmartCore/_TtC17FinancialServices33DeclinedTransactionViewController.h>

@class NSString;

@interface _TtC17FinancialServices33DeclinedTransactionViewController (FinancialServices)
