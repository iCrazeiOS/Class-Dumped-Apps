...
@interface _TtC18ElectrodeContainer11ItemSummary : _TtC18ElectrodeContainer15ElectrodeObject
{
...
- (id)init;
- (id)initWithUsItemId:(id)arg1 productName:(id)arg2 imageUrl:(id)arg3 price:(double)arg4;
