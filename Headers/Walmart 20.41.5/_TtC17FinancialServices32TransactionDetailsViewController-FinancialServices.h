...
#import <WalmartCore/_TtC17FinancialServices32TransactionDetailsViewController.h>

@class NSString;

@interface _TtC17FinancialServices32TransactionDetailsViewController (FinancialServices)
