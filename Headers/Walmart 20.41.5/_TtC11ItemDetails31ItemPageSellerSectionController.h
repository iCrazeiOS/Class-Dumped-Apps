...
@interface _TtC11ItemDetails31ItemPageSellerSectionController : NSObject
{
    // Error parsing type: , name: identifier
    // Error parsing type: , name: viewModel
    // Error parsing type: , name: scrollEventView
    // Error parsing type: , name: analytics
    // Error parsing type: , name: fetchAndPresentReturnPolicyBlock
...
- (id)initWithIdentifier:(id)arg1 viewModel:(id)arg2 analytics:(id)arg3;
@property(nonatomic, copy) CDUnknownBlockType fetchAndPresentReturnPolicyBlock;
