...
@class ASDisplayNode, AVAsset, AVAudioMix, AVPlayer, AVPlayerItem, AVPlayerLayer, AVVideoComposition, NSString, NSTimer, NSURL;
...
@interface ASVideoNode : ASNetworkImageNode
{
    ...
    NSString *_gravity;
    _Bool _allowPlayerLayerToBeShareable;
    _Bool _initiallyHidePlayerLayer;
...
@property(nonatomic) _Bool initiallyHidePlayerLayer; // @synthesize initiallyHidePlayerLayer=_initiallyHidePlayerLayer;
@property(nonatomic) _Bool allowPlayerLayerToBeShareable; // @synthesize allowPlayerLayerToBeShareable=_allowPlayerLayerToBeShareable;
- (void).cxx_destruct;
- (void)dealloc;
