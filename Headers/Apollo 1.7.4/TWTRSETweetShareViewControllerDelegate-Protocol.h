...
- (void)shareViewControllerWantsToCancelComposerWithPartiallyComposedTweet:(TWTRSETweet *)arg1;
- (void)shareViewControllerDidFinishSendingTweet;

@optional
- (void)shareViewControllerDidSelectAccount:(id <TWTRSEAccount>)arg1;
@end
