...
@property(readonly, nonatomic) _Bool isEmbeddableDefined; // @synthesize isEmbeddableDefined=_isEmbeddableDefined;
@property(readonly, nonatomic) _Bool embeddable; // @synthesize embeddable=_embeddable;
