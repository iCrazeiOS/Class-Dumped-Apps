...
@protocol OS_dispatch_queue, TWTRVideoPlayerOutputViewDelegate, TWTRVideoPlayerScribeDelegate;
...
@interface TWTRVideoPlayerOutputView : UIView
{
    ...
    id <TWTRVideoPlayerOutputViewDelegate> _delegate;
...
+ (CDStruct_198678f7)standardTotalTrimAmount;
+ (CDStruct_198678f7)standardTrim;
...
@property(nonatomic) __weak id <TWTRVideoPlayerOutputViewDelegate> delegate; // @synthesize delegate=_delegate;
