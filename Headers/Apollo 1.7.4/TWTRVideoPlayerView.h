...
#import <TwitterKit/TWTRVideoPlayerScribeDelegate-Protocol.h>
#import <TwitterKit/UIGestureRecognizerDelegate-Protocol.h>

@class NSLayoutConstraint, NSString, TWTRScribeSink, TWTRTweet, TWTRVideoControlsView, TWTRVideoControlsViewSynchronizer, TWTRVideoPlaybackConfiguration, TWTRVideoPlayerOutputView, UIImage, UITapGestureRecognizer;
@protocol TWTRVideoPlayerViewDelegate;

@interface TWTRVideoPlayerView : UIView <TWTRVideoPlayerOutputViewDelegate, TWTRVideoPlayerScribeDelegate, UIGestureRecognizerDelegate, TWTRVideoCTAViewDelegate, TWTRVideoControlsViewSynchronizerDelegate>
{
...
- (id)initWithTweet:(id)arg1 playbackConfiguration:(id)arg2 scribeSink:(id)arg3 controlsView:(id)arg4 previewImage:(id)arg5;
