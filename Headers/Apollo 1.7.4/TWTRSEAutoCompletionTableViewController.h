...
#import <TwitterKit/TWTRSEThrottledPropertyObserver-Protocol.h>
#import <TwitterKit/UITableViewDataSource-Protocol.h>
#import <TwitterKit/UITableViewDelegate-Protocol.h>

@class NSArray, NSString, TWTRSEAutoCompletionViewModel, TWTRSEThrottledProperty, UITableView, UIView;
@protocol TWTRSEAutoCompletion, TWTRSEAutoCompletionTableViewControllerDelegate, TWTRSEImageDownloader;

@interface TWTRSEAutoCompletionTableViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, TWTRSEThrottledPropertyObserver>
{
    id <TWTRSEAutoCompletionTableViewControllerDelegate> _delegate;
    UITableView *_tableView;
    id <TWTRSEAutoCompletion> _autoCompletion;
    id <TWTRSEImageDownloader> _imageDownloader;
    TWTRSEAutoCompletionViewModel *_viewModel;
    TWTRSEThrottledProperty *_wordAroundSelectionProperty;
...
@property(readonly, nonatomic) TWTRSEThrottledProperty *wordAroundSelectionProperty; // @synthesize wordAroundSelectionProperty=_wordAroundSelectionProperty;
@property(readonly, nonatomic) TWTRSEAutoCompletionViewModel *viewModel; // @synthesize viewModel=_viewModel;
...
@property(nonatomic) __weak id <TWTRSEAutoCompletionTableViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
