...
- (void)launchProfilePictureFlowFromController:(id)arg1 identity:(id)arg2 sourceView:(id)arg3 sourceViewType:(unsigned long long)arg4 userInterfaceStyle:(unsigned long long)arg5 useUIKit:(_Bool)arg6 successHandler:(CDUnknownBlockType)arg7;
