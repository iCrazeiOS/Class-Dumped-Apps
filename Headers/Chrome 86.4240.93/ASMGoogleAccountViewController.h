...
@class ASMExternalLauncher, ASMViewBlueprint, NSString, UIViewController;
@protocol ASMGoogleAccountViewModel, ASMNavigationHierarchyController, ASMSessionInternal, ASMViewControllerFactory, OGLAccountService;
...
- (void)viewDidLoad;
- (id)initWithViewModel:(id)arg1 viewControllerFactory:(id)arg2 externalLauncher:(id)arg3 singleAppSignOutCallback:(CDUnknownBlockType)arg4 removeAccountCallback:(CDUnknownBlockType)arg5 oglAccountService:(id)arg6 session:(id)arg7;
