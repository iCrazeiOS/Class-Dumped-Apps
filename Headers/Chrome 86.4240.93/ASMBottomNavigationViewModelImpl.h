...
#import <ChromeInternal/ASMBottomNavigationViewModel-Protocol.h>
...
- (id)initWithResourceKey:(id)arg1 navigationModel:(id)arg2 accountModel:(id)arg3 loggerModel:(id)arg4 useBottomNavigationBar:(_Bool)arg5;
