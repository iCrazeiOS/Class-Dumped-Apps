...
@class NSString;
@protocol GCRDiscoverFeedActionDelegate;

@interface GCRHostActionHandler : NSObject <DSCHostActionHandler>
{
    id <GCRDiscoverFeedActionDelegate> _actionDelegate;
}

- (void).cxx_destruct;
@property(nonatomic) __weak id <GCRDiscoverFeedActionDelegate> actionDelegate; // @synthesize actionDelegate=_actionDelegate;
...
- (id)initWithHostActionDelegate:(id)arg1;
