...
@class MDCBottomSheetPresentationController, NSString, UIColor, UIScrollView;
...
@interface MDCBottomSheetTransitionController : NSObject <UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate>
{
    ...
    MDCBottomSheetPresentationController *_currentPresentationController;
}

- (void).cxx_destruct;
@property(nonatomic) __weak MDCBottomSheetPresentationController *currentPresentationController; // @synthesize currentPresentationController=_currentPresentationController;
