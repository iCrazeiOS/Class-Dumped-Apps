...
@property(nonatomic) _Bool dataLatched; // @synthesize dataLatched=_dataLatched;
...
- (id)debugDescription;
- (id)description;
- (vector_fbd8023d)divideIntoSegmentsOfMaximumSize:(unsigned long long)arg1;
@property(readonly) vector_0f9f632f indexPathsForInsertedItems;
@property(readonly) vector_0f9f632f indexPathsForRemovedItems;
