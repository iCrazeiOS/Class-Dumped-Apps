...
#import <ChromeInternal/ASNetworkImageNode.h>

#import <ChromeInternal/ASImageCacheProtocol-Protocol.h>
#import <ChromeInternal/ASImageDownloaderProtocol-Protocol.h>
#import <ChromeInternal/ASNetworkImageNodeDelegate-Protocol.h>
#import <ChromeInternal/ELMDisplayNode-Protocol.h>
#import <ChromeInternal/ELMPriorityLoaderDelegate-Protocol.h>

@class ELMElement, ELMImageCacheInfo, NSString;
@protocol ELMContext, ELMController, ELMTextAttachmentDelegate;
...
@interface ELMImageNode : ASNetworkImageNode <ASNetworkImageNodeDelegate, ASImageDownloaderProtocol, ASImageCacheProtocol, ELMPriorityLoaderDelegate, ELMDisplayNode>
{
    ...
    ELMElement *_element;
    id <ELMTextAttachmentDelegate> _textAttachmentDelegate;
}
...
- (void).cxx_destruct;
@property(nonatomic) __weak id <ELMTextAttachmentDelegate> textAttachmentDelegate; // @synthesize textAttachmentDelegate=_textAttachmentDelegate;
...
- (void)processPlaybackState:(int)arg1;
