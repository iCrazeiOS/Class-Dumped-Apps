...
@protocol ELMClientResourceLoader, ELMDispatcher, ELMErrorHandler, ELMFontLoader, ELMImageDownloader, ELMImageSelectionHandler, ELMInteractionLogger, ELMJSEnvironment, ELMLogger, ELMPerformanceAgent, ELMPriorityLoader, ELMRuntimeConfig, ELMStore, ELMTemplateLoader, ELMValueStore;
