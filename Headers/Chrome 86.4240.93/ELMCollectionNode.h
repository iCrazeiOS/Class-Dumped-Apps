...
#import <ChromeInternal/ELMSnapHelperDelegate-Protocol.h>
...
@interface ELMCollectionNode : ASCollectionNode <ASCollectionDataSource, ASCollectionDelegate, IGListAdapterDataSource, UIScrollViewDelegate, ELMSnapHelperDelegate, ELMDisplayNode>
{
    ...
    // Error parsing type: {optional<youtube::elements::CollectionTypeScrollToItemCommand>="engaged_"B""(?="data_"{CollectionTypeScrollToItemCommand="_vptr$MessageLite"^^?"_internal_metadata_"{InternalMetadata="ptr_"^v}"_has_bits_"{HasBits<1>="has_bits_"[1I]}"_cached_size_"{CachedSize="size_"{atomic<int>="__a_"{__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >="__a_value"Ai}}}"element_key_"{ArenaStringPtr="tagged_ptr_"{TaggedPtr<std::__1::basic_string<char> >="ptr_"Q}}"animation_config_"^{MessageLite}"index_"i"scroll_interval_seconds_"f"repeat_mode_"i"cancel_on_user_interaction_"B}"dummy_"{dummy_type="data"[56{empty_struct=}]})}, name: _scrollToItemCommand
    ELMElement *_element;
...
-     // Error parsing type: v24@0:8r^{CollectionTypeScrollToItemCommand=^^?{InternalMetadata=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{ArenaStringPtr={TaggedPtr<std::__1::basic_string<char> >=Q}}^{MessageLite}ifiB}16, name: handleScrollToItemCommand:
- (struct CGSize)calculateSizeThatFits:(struct CGSize)arg1;
-     // Error parsing type: {CGSize=dd}40@0:8{CGSize=dd}16r^{CollectionType=^^?{InternalMetadata=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{WeakRepeatedPtrField<youtube::elements::CollectionTypeSection>=(?={RepeatedPtrField<youtube::elements::CollectionTypeSection>=^{Arena}ii^{Rep}})}^{MessageLite}^{MessageLite}^{MessageLite}^{MessageLite}^{MessageLite}iffBBBBii}32, name: calculateSizeThatFitsLargestCellWithConstrainedSize:forCollectionType:
- (_Bool)shouldBypassSizingCellForCollectionSizing:(id)arg1 isHorizontal:(_Bool)arg2;
-     // Error parsing type: B24@0:8r^{CollectionType=^^?{InternalMetadata=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{WeakRepeatedPtrField<youtube::elements::CollectionTypeSection>=(?={RepeatedPtrField<youtube::elements::CollectionTypeSection>=^{Arena}ii^{Rep}})}^{MessageLite}^{MessageLite}^{MessageLite}^{MessageLite}^{MessageLite}iffBBBBii}16, name: isHorizontal:
