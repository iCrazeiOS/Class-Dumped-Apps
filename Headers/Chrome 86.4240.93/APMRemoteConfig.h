...
#import <ChromeInternal/APMEExperimentObserverDelegate-Protocol.h>
...
@interface APMRemoteConfig : NSObject <APMEExperimentObserverDelegate>
{
    ...
    _Bool _sessionIDEnabled;
    _Bool _sessionNumberEnabled;
}

+ (id)defaultClientFromExperimentManager:(id)arg1 defaultFlags:(id)arg2;
+ (id)defaultInstanceFromExperimentManager:(id)arg1;
- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool sessionNumberEnabled; // @synthesize sessionNumberEnabled=_sessionNumberEnabled;
@property(readonly, nonatomic) _Bool sessionIDEnabled; // @synthesize sessionIDEnabled=_sessionIDEnabled;
