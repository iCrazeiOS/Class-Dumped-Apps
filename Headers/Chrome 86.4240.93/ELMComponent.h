...
#import <ChromeInternal/ELMEntitiesProcessorDelegate-Protocol.h>
#import <ChromeInternal/ELMStoreSubscriber-Protocol.h>
...
- (id)context;
- (struct Status)createUnderlyingComponent;
- (void)dealloc;
