...
@interface BSG_KSJSONCodec : NSObject
{
    ...
    struct BSG_KSJSONDecodeCallbacks *_callbacks;
    NSMutableData *_serializedData;
    NSError *_error;
}

+ (id)decode:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;
+ (id)encode:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;
+ (id)codecWithEncodeOptions:(unsigned long long)arg1 decodeOptions:(unsigned long long)arg2;
...
@property(nonatomic) struct BSG_KSJSONDecodeCallbacks *callbacks; // @synthesize callbacks=_callbacks;
...
- (void).cxx_destruct;
- (void)dealloc;
- (id)initWithEncodeOptions:(unsigned long long)arg1 decodeOptions:(unsigned long long)arg2;
