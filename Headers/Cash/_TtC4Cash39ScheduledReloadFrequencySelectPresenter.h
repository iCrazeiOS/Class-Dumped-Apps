...
@interface _TtC4Cash39ScheduledReloadFrequencySelectPresenter : _TtCs12_SwiftObject
{
    // Error parsing type: , name: reloadFrequency
    // Error parsing type: , name: allowsMultipleSelection
    // Error parsing type: , name: requiresAmountSelection
