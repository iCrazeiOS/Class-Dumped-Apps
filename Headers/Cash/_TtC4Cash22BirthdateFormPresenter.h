...
@interface _TtC4Cash22BirthdateFormPresenter : _TtCs12_SwiftObject
{
    // Error parsing type: , name: flow
    // Error parsing type: , name: logger
    // Error parsing type: , name: dateInputElementViewController
    // Error parsing type: , name: model
    // Error parsing type: , name: enteredDate
