...
@interface SQPBFranklinSyncInvestmentEntityRanking : GPBMessage
{
}
...
@property(nonatomic) _Bool hasRankingType; // @dynamic hasRankingType;
...
@property(nonatomic) int rankingType; // @dynamic rankingType;
