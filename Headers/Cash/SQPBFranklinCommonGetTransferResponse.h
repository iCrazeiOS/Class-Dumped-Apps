...
@class SQPBFranklinApiTransfer, SQPBFranklinCommonResponseContext, SQPBFranklinCommonScenariosScenarioPlan;

@interface SQPBFranklinCommonGetTransferResponse : GPBMessage
{
}
