...
@interface SQPBFranklinAppVerifyQrCodeRequest : GPBMessage
{
}
...
@property(nonatomic) _Bool hasQrCodeData; // @dynamic hasQrCodeData;
@property(nonatomic) _Bool hasRequestContext; // @dynamic hasRequestContext;
@property(copy, nonatomic) NSString *qrCodeData; // @dynamic qrCodeData;
