...
@interface _TtC10AppStartup28SessionInitializationManager : _TtCs12_SwiftObject
{
    ...
    // Error parsing type: , name: reachabilityDidChangeListener
    // Error parsing type: , name: applicationWillEnterForegroundListener
    // Error parsing type: , name: featureFlagLoader
