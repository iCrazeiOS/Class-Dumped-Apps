...
@class SQPBFranklinCommonResponseContext, SQPBFranklinCommonScenariosScenarioPlan, SQPBFranklinStatusResult;

@interface SQPBFranklinCommonSetDepositPreferenceResponse : GPBMessage
{
}
