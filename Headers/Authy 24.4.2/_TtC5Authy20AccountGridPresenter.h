...
@interface _TtC5Authy20AccountGridPresenter : _TtCs12_SwiftObject
{
    // Error parsing type: , name: isSearching
    // Error parsing type: , name: view
    // Error parsing type: , name: accounts
    // Error parsing type: , name: accountsRepresentations
    // Error parsing type: , name: visibleRepresentations
