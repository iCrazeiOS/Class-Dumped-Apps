...
- (void).cxx_destruct;
@property(retain, nonatomic) RCNConfigFetch *configFetch; // @synthesize configFetch=_configFetch;
...
- (void)activateWithEitherHandler:(CDUnknownBlockType)arg1 deprecatedHandler:(CDUnknownBlockType)arg2;
