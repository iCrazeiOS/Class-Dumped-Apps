...
@protocol OMIDHuluCommandPublisher;

@interface OMIDHuluAdSessionStatePublisher : NSObject
{
    id <OMIDHuluCommandPublisher> _commandPublisher;
...
@property(readonly, nonatomic) id <OMIDHuluCommandPublisher> commandPublisher; // @synthesize commandPublisher=_commandPublisher;
- (void).cxx_destruct;
