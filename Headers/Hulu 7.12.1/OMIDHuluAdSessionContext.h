...
@class NSArray, NSDictionary, NSString, OMIDHuluPartner, WKWebView;

@interface OMIDHuluAdSessionContext : NSObject
{
...
@property(readonly, nonatomic) OMIDHuluPartner *partner; // @synthesize partner=_partner;
