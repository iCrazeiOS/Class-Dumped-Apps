...
#import "OMIDHuluAdEventsPublisher-Protocol.h"
#import "OMIDHuluCommandPublisher-Protocol.h"
#import "OMIDHuluMediaEventsPublisher-Protocol.h"
#import "OMIDHuluSessionEventsPublisher-Protocol.h"

@class NSString;
@protocol OMIDHuluJSExecutor;

@interface OMIDHuluBridge : NSObject <OMIDHuluCommandPublisher, OMIDHuluSessionEventsPublisher, OMIDHuluAdEventsPublisher, OMIDHuluMediaEventsPublisher>
{
    id <OMIDHuluJSExecutor> _jsExecutor;
}

@property(readonly, nonatomic) id <OMIDHuluJSExecutor> jsExecutor; // @synthesize jsExecutor=_jsExecutor;
- (void).cxx_destruct;
