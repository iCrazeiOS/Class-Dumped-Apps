...
#import <GoogleCast/GCKRequestTrackerDelegate-Protocol.h>
...
- (long long)launchApplication:(id)arg1 senderLanguageCode:(id)arg2 supportedApplicationTypes:(id)arg3 appContextInformationProvider:(id)arg4;
