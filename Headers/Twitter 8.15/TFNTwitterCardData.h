...
@class NSDate, NSDictionary, NSNumber, NSSet, NSString, TAVAnalyticsMediaIdentifier, TFNTwitterCardImageSpec, TFNTwitterPromotedContent, TFNTwitterUnifiedCard, TFNTwitterUser, TFSTwitterCardDataAssimilatable;

@interface TFNTwitterCardData : NSObject <TFNUIDesignableAppDetails, TFNUIDesignableCardViewModel, TFNUIDesignableConversationCardViewModel, NSCoding, NSCopying, TFSModel>
{
...
- (id)convertingUCAppStoreDetailsToSetSubtitle:(id)arg1;
- (id)convertingUCAppStoreDetailsToAppRatings:(long long)arg1;
- (id)convertingUCAppStoreDetailsToSetTitle:(id)arg1;
- (id)convertingUCCarouselsToSingleMedia;
- (id)convertingUCMAPButtonToOverrideActionType:(id)arg1;
