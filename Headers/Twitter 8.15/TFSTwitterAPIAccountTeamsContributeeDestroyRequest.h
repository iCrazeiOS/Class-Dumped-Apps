...
@interface TFSTwitterAPIAccountTeamsContributeeDestroyRequest : TFSTwitterAPIEndpointRequest
{
}
...
- (id)initWithContributeeUserId:(long long)arg1 context:(id)arg2 responseModelBuilder:(id)arg3;
