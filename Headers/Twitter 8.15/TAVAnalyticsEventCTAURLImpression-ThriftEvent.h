...
#import <TwitterAVCore/TAVAnalyticsEventCTAURLImpression.h>
...
@interface TAVAnalyticsEventCTAURLImpression (ThriftEvent) <TVDIAnalyticsScribeMediaEventTypeBuilder>
- (id)thriftEvent;
