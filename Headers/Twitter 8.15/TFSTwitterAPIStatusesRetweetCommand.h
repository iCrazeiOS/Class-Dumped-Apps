...
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 statusID:(id)arg3 impressionID:(id)arg4 earned:(_Bool)arg5 source:(unsigned long long)arg6 responseModelBuilder:(id)arg7 responseProcessorBlock:(CDUnknownBlockType)arg8 completionBlock:(CDUnknownBlockType)arg9;
