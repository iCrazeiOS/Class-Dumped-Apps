...
@interface TFSTwitterAPIListsCreateRequest : TFSTwitterAPIEndpointRequest
{
}
...
- (id)initWithName:(id)arg1 description:(id)arg2 mode:(long long)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
