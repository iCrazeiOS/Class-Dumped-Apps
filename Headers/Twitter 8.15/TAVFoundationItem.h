...
@interface TAVFoundationItem : NSObject
{
    ...
    CDStruct_1b6d18a9 _stitchedLoopDuration;
}
...
@property(readonly, nonatomic) CDStruct_1b6d18a9 stitchedLoopDuration; // @synthesize stitchedLoopDuration=_stitchedLoopDuration;
...
- (id)initWithAVPlayerItem:(id)arg1 stitchedLoopDuration:(CDStruct_1b6d18a9)arg2;
