...
@interface TFSTwitterAPIAccountUpdatePasswordRequest : TFSTwitterAPIEndpointRequest
{
}
...
- (id)initWithCurrentPassword:(id)arg1 updatedPassword:(id)arg2 passwordConfirmation:(id)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
