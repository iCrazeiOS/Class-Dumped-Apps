...
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 searchTerm:(id)arg3 location:(id)arg4 queryType:(long long)arg5 source:(unsigned long long)arg6 includeLatLonParams:(_Bool)arg7 osVersion:(id)arg8 responseModelBuilder:(id)arg9 completionBlock:(CDUnknownBlockType)arg10;
