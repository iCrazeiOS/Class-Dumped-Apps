...
@interface TFSTwitterAPIConversationUnhideRequest : TFSTwitterAPIEndpointRequest
{
}

+ (id)endpointPath;
+ (long long)HTTPMethodValue;
- (id)initWithStatusID:(id)arg1 conversationID:(id)arg2 context:(id)arg3 responseModelBuilder:(id)arg4;
