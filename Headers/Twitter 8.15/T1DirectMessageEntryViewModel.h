...
@interface T1DirectMessageEntryViewModel : T1DirectMessageAbstractConversationEntryViewModel
{
    ...
    NSString *_precomputedAXAnnouncement;
    NSString *_precomputedAXHint;
    NSAttributedString *_precomputedAXAttributedLabel;
...
@property(readonly, nonatomic) NSAttributedString *precomputedAXAttributedLabel; // @synthesize precomputedAXAttributedLabel=_precomputedAXAttributedLabel;
@property(readonly, nonatomic) NSString *precomputedAXHint; // @synthesize precomputedAXHint=_precomputedAXHint;
@property(readonly, nonatomic) NSString *precomputedAXAnnouncement; // @synthesize precomputedAXAnnouncement=_precomputedAXAnnouncement;
@property(readonly, nonatomic) _Bool hasPrecomputedAXValues; // @synthesize hasPrecomputedAXValues=_hasPrecomputedAXValues;
...
- (id)_t1_accessibilityHint;
- (id)accessibilityHint;
- (id)_t1_accessibilityAnnouncement;
- (id)accessibilityAnnouncement;
- (id)accessibilityAttributedLabel;
- (id)_t1_accessibleAttributedMessageText;
