...
- (id)initWithUserID:(id)arg1 screenName:(id)arg2 context:(id)arg3 responseModelBuilder:(id)arg4;
- (id)initWithScreenName:(id)arg1 context:(id)arg2 responseModelBuilder:(id)arg3;
