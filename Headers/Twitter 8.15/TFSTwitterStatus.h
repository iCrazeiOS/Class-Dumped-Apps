...
@class NSArray, NSDate, NSNumber, NSString, TFSTwitterCameraMoment, TFSTwitterEntitySet, TFSTwitterEntityURL, TFSTwitterLocation, TFSTwitterPlace;
...
@property(nonatomic, readonly) NSArray *collectionStatusIDs;
@property(nonatomic, readonly) NSArray *collectionCardDataItemURLs;
