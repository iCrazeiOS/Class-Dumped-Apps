...
@class NSArray, NSSet, NSString, TFNTwitterAccount, TFNTwitterTimeline;
...
- (TFNTwitterTimeline *)timelineForAccount:(TFNTwitterAccount *)arg1 identifier:(NSString *)arg2;
