...
#import <TwitterAVCore/TAVAnalyticsEventCTAWatchImpression.h>
...
@interface TAVAnalyticsEventCTAWatchImpression (ThriftEvent) <TVDIAnalyticsScribeMediaEventTypeBuilder>
- (id)thriftEvent;
