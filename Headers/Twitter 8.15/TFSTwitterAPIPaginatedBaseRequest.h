...
@interface TFSTwitterAPIPaginatedBaseRequest : TFSTwitterAPIEndpointRequest
{
}

+ (unsigned long long)responseHydrationFlags;
+ (id)endpointPath;
- (id)initWithCursor:(id)arg1 additionalParameters:(id)arg2 context:(id)arg3 responseModelBuilder:(id)arg4;
