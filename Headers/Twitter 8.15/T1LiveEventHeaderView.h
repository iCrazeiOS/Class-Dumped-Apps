...
- (id)initWithFrame:(struct CGRect)arg1 useCustomNavigationBar:(_Bool)arg2 isHeaderLockingEnabled:(_Bool)arg3 isHeaderSubtitleBlue:(_Bool)arg4 isHeaderSubtitleTapToExpandShown:(_Bool)arg5;
