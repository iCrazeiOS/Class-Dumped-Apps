...
- (id)initWithService:(id)arg1 accountID:(id)arg2 authContext:(id)arg3 identifier:(id)arg4 userId:(id)arg5 requestId:(id)arg6 challengeResponse:(id)arg7 knownDeviceToken:(id)arg8 authTokenStorage:(id)arg9 source:(unsigned long long)arg10 responseModelBuilder:(id)arg11 completionBlock:(CDUnknownBlockType)arg12;
