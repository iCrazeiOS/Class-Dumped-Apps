...
@class NSLayoutConstraint, T1NewsCameraCapturePreviewControlsOverlayView, UIColor, UILayoutGuide;

@interface T1NewsCameraContentContainerView : UIView
{
...
- (void)_t1_newsCameraCaptureContainerView_initialize;
