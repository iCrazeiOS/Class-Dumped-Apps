...
@interface TFSTwitterAPIListsUpdateRequest : TFSTwitterAPIEndpointRequest
{
}
...
- (id)initWithListID:(id)arg1 name:(id)arg2 description:(id)arg3 mode:(long long)arg4 context:(id)arg5 responseModelBuilder:(id)arg6;
