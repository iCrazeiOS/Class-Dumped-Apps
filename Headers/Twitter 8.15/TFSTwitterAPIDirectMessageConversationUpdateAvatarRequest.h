...
@interface TFSTwitterAPIDirectMessageConversationUpdateAvatarRequest : TFSTwitterAPIEndpointRequest
{
}

+ (long long)HTTPMethodValue;
- (id)initWithConversationID:(id)arg1 avatarID:(id)arg2 requestID:(id)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
