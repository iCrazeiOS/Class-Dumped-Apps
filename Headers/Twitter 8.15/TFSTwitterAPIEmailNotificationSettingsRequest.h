...
@interface TFSTwitterAPIEmailNotificationSettingsRequest : TFSTwitterAPIEndpointRequest
{
}

+ (unsigned long long)responseHydrationFlags;
- (id)initWithUserID:(long long)arg1 settings:(id)arg2 context:(id)arg3 responseModelBuilder:(id)arg4;
