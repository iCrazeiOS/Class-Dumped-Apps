...
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 mediaID:(id)arg3 locationSharingRulesEnforced:(_Bool)arg4 latestReplayPlaylist:(_Bool)arg5 streamType:(id)arg6 source:(unsigned long long)arg7 responseModelBuilder:(id)arg8 completionBlock:(CDUnknownBlockType)arg9;
