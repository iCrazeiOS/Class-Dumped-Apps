...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 publicKey:(id)arg3 deviceIdentifier:(id)arg4 environment:(id)arg5 token:(id)arg6 responseModelBuilder:(id)arg7 completionBlock:(CDUnknownBlockType)arg8;
