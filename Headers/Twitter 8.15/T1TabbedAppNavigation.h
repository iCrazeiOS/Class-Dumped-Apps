...
@class NSArray, NSMutableArray, NSString, T1AppSplitViewController, T1ComposeController, T1DirectMessageParticipantValidator, T1DockingController, T1FoundMediaPresentationContext, T1OnboardingFlowController, T1PhotoGalleryPresentationContext, T1SettingsOnboardingFlowPresenter, TFNHUD, TFNTwitterAccount, TFNTwitterStatus, UIViewController;
@protocol T1PanelNavigationController, T1TabbedAppNavigationDelegate, TFSTwitterLegacyScribeLogMethods;

@interface T1TabbedAppNavigation : NSObject <T1AppNavigationDocking, T1OnboardingFlowControllerDelegate, T1ComposeControllerDelegate, T1TweetDraftsViewControllerDelegate, T1AppNavigation>
{
...
- (void)showRuxWithCxt:(id)arg1 refsrcTweet:(id)arg2 statusID:(long long)arg3 panel:(long long)arg4 modal:(_Bool)arg5 source:(long long)arg6 sourceNavigationMetadata:(id)arg7 completion:(CDUnknownBlockType)arg8;
...
- (void)dockViewController:(id)arg1 atCorner:(long long)arg2 delegate:(id)arg3 userAction:(long long)arg4 animationTransition:(long long)arg5;
- (void)showNewsCameraWithSource:(long long)arg1 presentation:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)showTopicLandingForTopicID:(id)arg1 withSource:(long long)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)showMomentsGuideWithSource:(long long)arg1 tab:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (id)_t1_legacySubscribersViewControllerForList:(id)arg1;
- (id)_t1_legacyMembersViewControllerForList:(id)arg1;
...
- (void)showNewsCameraContainerWithViewModel:(id)arg1 fromPanel:(long long)arg2 source:(long long)arg3 navigationContext:(id)arg4 transitionDelegate:(id)arg5 autoplayCoordinator:(id)arg6 fromController:(id)arg7 completion:(CDUnknownBlockType)arg8;
