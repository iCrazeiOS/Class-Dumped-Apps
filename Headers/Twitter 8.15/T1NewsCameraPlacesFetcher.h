...
@protocol T1NewsCameraPlacesFetcherDelegate;

@interface T1NewsCameraPlacesFetcher : NSObject
{
    id <T1NewsCameraPlacesFetcherDelegate> _delegate;
...
@property(nonatomic) __weak id <T1NewsCameraPlacesFetcherDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
