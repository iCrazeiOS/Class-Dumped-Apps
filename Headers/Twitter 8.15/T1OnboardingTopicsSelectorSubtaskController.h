...
@class NSMutableDictionary, NSString, T1OnboardingPromptDataSource, TFSTwitterOnboardingTopicsSelectorSubtask, TFSTwitterOnboardingTopicsSelectorSubtaskState;
...
@interface T1OnboardingTopicsSelectorSubtaskController : T1OnboardingSubtaskController <T1OnboardingTopicsSelectorViewControllerDelegate>
{
    ...
    NSMutableDictionary *_topicsByIDCache;
    NSMutableDictionary *_topicIDsByCategoryCache;
    NSMutableDictionary *_topicIDsBySearchTextCache;
    NSString *_flowToken;
...
- (void)private_fetchResultsForCategory:(id)arg1 orSearchText:(id)arg2 withTopicIDsCache:(id)arg3 cacheKey:(id)arg4 topicsByIDCache:(id)arg5 completion:(CDUnknownBlockType)arg6;
