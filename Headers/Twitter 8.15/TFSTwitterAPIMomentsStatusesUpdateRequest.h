...
@interface TFSTwitterAPIMomentsStatusesUpdateRequest : TFSTwitterAPIEndpointRequest
{
}

+ (id)endpointPath;
+ (long long)HTTPMethodValue;
- (id)initWithParameters:(id)arg1 context:(id)arg2 responseModelBuilder:(id)arg3;
