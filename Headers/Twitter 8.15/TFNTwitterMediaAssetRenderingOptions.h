...
- (id)init;
- (id)initWithImagePipeline:(id)arg1 editParameters:(id)arg2 maxDimension:(long long)arg3 allowsLosslessCompression:(_Bool)arg4 progressHandler:(CDUnknownBlockType)arg5;
