...
- (id)initWithImage:(id)arg1 parameters:(id)arg2 minSize:(struct CGSize)arg3 fixedCropShape:(long long)arg4 pinchEnabled:(_Bool)arg5 rotateEnabled:(_Bool)arg6 account:(id)arg7;
