...
@class NSNumber, NSOperationQueue, NSString, TFNDirectMessageContext, TFNDirectMessageInboxPageOperation, TFNDirectMessageInboxTimeline, TFNDirectMessageModel, TFNDirectMessageRefreshOperation, TFSCoalescingUpdater;
...
- (void)clear;
- (id)initWithContext:(id)arg1 cursor:(id)arg2 lastSeenEventID:(long long)arg3 trustedConversationsTimeline:(id)arg4 untrustedConversationsTimeline:(id)arg5 lowQualityConversationsTimeline:(id)arg6 lastLowQualityFilterState:(id)arg7;
