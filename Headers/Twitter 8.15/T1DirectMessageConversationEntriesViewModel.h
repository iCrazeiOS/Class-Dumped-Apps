...
+ (id)_t1_optimized_entryViewModelsForEntries:(id)arg1 previousViewModels:(id)arg2 displayState:(id)arg3 layoutMetrics:(id)arg4;
+ (id)_t1_legacy_entryViewModelsForEntries:(id)arg1 displayState:(id)arg2 layoutMetrics:(id)arg3;
