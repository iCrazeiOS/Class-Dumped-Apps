...
@class NSString, TAVUIAutoplayManager;
@protocol T1AutoplayableManager;

@interface TFNDataViewController (T1CardScribing) <T1MuteKeywordFormViewControllerDelegate, TFNItemsDummyObjectDelegate>
...
@property(retain, nonatomic) TAVUIAutoplayManager *policyBasedAutoplayManager;
@property(nonatomic) _Bool autoplayManagerNeedsCoordinateSpaceUpdate;
- (id)t1_activeAutoplayable;
- (id)t1_autoplayAccount;
...
- (void)t1_tearDownAutoplayManager;
