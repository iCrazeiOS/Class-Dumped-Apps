...
@class NSString, T1ThreadTweetsConnectorView, T1ThreadTweetsStatusView, T1ThreadTweetsViewController, T1TweetComposeThreadContextLoadingStatusView, T1TweetComposeThreadContextMoreButton, T1TweetComposeThreadContextNUXView, T1TwitterTooltip, TFNButton, TFNTwitterAccount, TFNTwitterComposition, TFNTwitterStatus, TFSTimer, TFSTwitterScribeContext, UIButton, UIView;
...
@interface T1TweetComposeThreadContextViewController : UIViewController <T1ThreadTweetsViewControllerDelegate, TFNModalSheetViewControllerLayoutDelegate, T1TweetComposeThreadContextNUXViewDelegate>
{
    ...
    T1TwitterTooltip *_moreRecentTweetsTooltip;
}

+ (void)resetMoreRecentTweetsTooltip;
@property(retain, nonatomic) T1TwitterTooltip *moreRecentTweetsTooltip; // @synthesize moreRecentTweetsTooltip=_moreRecentTweetsTooltip;
