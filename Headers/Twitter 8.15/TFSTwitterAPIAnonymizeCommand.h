...
+ (id)appTrackingDictionary:(id)arg1 systemName:(id)arg2 systemVersion:(id)arg3 userAgent:(id)arg4 guestID:(unsigned long long)arg5 identifierForVendor:(id)arg6;
