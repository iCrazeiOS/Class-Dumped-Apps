...
@class NSArray, NSDate, NSDictionary, NSString, TFNTwitterCardData, TFNTwitterFeedbackInfo, TFNTwitterFeedbackModule, TFNTwitterGeotag, TFNTwitterPromotedContent, TFNTwitterStatusConversationContext, TFNTwitterSuggestsInfo, TFNTwitterUser, TFSTwitterCameraMoment, TFSTwitterEntitySet, TFSTwitterMediaInfo, TFSTwitterVideoMonetizationSettings, TFSURTImageVariant, TFSURTRichText, UIColor;
...
@interface T1URTTimelineStatusItemViewModel : NSObject <T1StatusViewModel, NSObject>
{
    ...
    // Error parsing type: , name: $__lazy_storage_$_socialContext
...
- (id)conversationControlContextURL;
- (id)conversationControlBadgeName;
- (id)conversationControlText;
- (id)conversationControlDescription;
- (id)socialBadgeName;
- (id)socialText;
- (id)socialContextURL;
