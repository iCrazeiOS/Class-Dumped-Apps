...
#import <TwitterAVCore/TAVAnalyticsEventVideoMrcAudibleView.h>
...
@interface TAVAnalyticsEventVideoMrcAudibleView (ThriftEvent) <TVDIAnalyticsScribeMediaEventTypeBuilder>
- (id)thriftEvent;
