...
- (id)initWithMonitize:(_Bool)arg1 videoCategories:(id)arg2 advertiserBlacklist:(id)arg3 monetizationCategoryBlacklist:(id)arg4 adsCategoryBlacklist:(id)arg5 context:(id)arg6 responseModelBuilder:(id)arg7;
