...
@interface TFSTwitterAPIMutesAdvancedFiltersUpdateRequest : TFSTwitterAPIEndpointRequest
{
}

+ (unsigned long long)responseHydrationFlags;
+ (long long)HTTPMethodValue;
- (id)initWithAdvancedFilters:(id)arg1 context:(id)arg2 responseModelBuilder:(id)arg3;
