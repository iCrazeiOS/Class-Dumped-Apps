...
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 mediaID:(id)arg3 totalBytes:(id)arg4 originalMediaMD5:(id)arg5 scribeComponent:(id)arg6 scribeElement:(id)arg7 uploadTTL:(id)arg8 allowAsync:(_Bool)arg9 permittedRequestRetryCount:(unsigned long long)arg10 requestRetryDelay:(double)arg11 source:(unsigned long long)arg12 networkTransactionMetrics:(id)arg13 responseModelBuilder:(id)arg14 completionBlock:(CDUnknownBlockType)arg15;
