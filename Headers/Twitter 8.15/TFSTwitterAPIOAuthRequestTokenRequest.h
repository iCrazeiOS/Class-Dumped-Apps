...
@interface TFSTwitterAPIOAuthRequestTokenRequest : TFSTwitterAPIEndpointRequest
{
}
...
- (id)initWithAppBundleID:(id)arg1 jsonResponse:(_Bool)arg2 scopePolicyInResponse:(_Bool)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
