...
@interface TFSTwitterAPIAmplifyMarketplaceVideosRequest : TFSTwitterAPIEndpointRequest
{
}

+ (unsigned long long)responseHydrationFlags;
+ (id)endpointPath;
- (id)initWithMediaID:(id)arg1 context:(id)arg2 responseModelBuilder:(id)arg3;
