...
@class NSArray, NSDate, NSDictionary, NSString, TFNAttributedTextModel, TFNTwitterAccount, TFNTwitterCardData, TFNTwitterFeedbackInfo, TFNTwitterGeotag, TFNTwitterStatus, TFNTwitterStatusConversationContext, TFSTwitterCameraMoment, TFSTwitterEntitySet, TFSTwitterMediaInfo, TFSTwitterVideoMonetizationSettings, TFSURTImageVariant, TFSURTRichText, TFSURTUrl, UIColor, UIFont;
...
- (TFSURTUrl *)conversationControlContextURL;
- (NSString *)conversationControlBadgeName;
- (NSString *)conversationControlDescription;
- (NSString *)conversationControlText;
