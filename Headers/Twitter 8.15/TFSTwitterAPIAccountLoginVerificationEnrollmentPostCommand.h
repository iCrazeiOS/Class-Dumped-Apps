...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 publicKey:(id)arg3 deviceIdentifier:(id)arg4 offlineCode:(id)arg5 iterationCount:(id)arg6 environment:(id)arg7 token:(id)arg8 updatePushDestination:(_Bool)arg9 completionBlock:(CDUnknownBlockType)arg10;
