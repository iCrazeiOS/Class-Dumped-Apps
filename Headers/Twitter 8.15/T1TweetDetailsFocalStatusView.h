...
@class NSArray, NSString, T1StatusLiveEngagementManager, T1StatusViewCombinedViewModel, T1TweetDetailsFooterTextView, TFNComposableViewSet, TFNReusableViewCache, TFNTwitterAccount, TFSTwitterScribeContext;
...
- (id)_t1_viewSetUpadtesWithInfo:(id)arg1;
