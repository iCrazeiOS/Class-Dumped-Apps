...
#import "_TtP6fiverr36MatchmakerBaseViewControllerDelegate_-Protocol.h"
...
@interface FVRBuyerPostRequestViewController : XLFormViewController <UITableViewDataSource, UITableViewDelegate, FVRBuyerPostRequestEducationViewDelegate, _TtP6fiverr37MatchmakerStartViewControllerDelegate_, _TtP6fiverr36MatchmakerBaseViewControllerDelegate_, FVRAnalyticsManagerProtocol>
{
    _Bool _didSeeMatchmaker;
    NSString *_source;
...
+ (void)load;
@property(nonatomic) _Bool didSeeMatchmaker; // @synthesize didSeeMatchmaker=_didSeeMatchmaker;
...
- (void)matchmakerBaseViewControllerDidFinish;
...
- (void)setupTitle;
- (void)showActiveMatchmakerBrief;
- (void)showMatchmakerOpendFromStartScreen:(_Bool)arg1;
