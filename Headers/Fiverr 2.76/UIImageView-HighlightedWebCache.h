...
- (void)sd_setHighlightedImageWithURL:(id)arg1 options:(unsigned long long)arg2 context:(struct NSDictionary *)arg3 progress:(CDUnknownBlockType)arg4 completed:(CDUnknownBlockType)arg5;
...
- (void)sd_setHighlightedImageWithURL:(id)arg1 options:(unsigned long long)arg2 context:(struct NSDictionary *)arg3;
