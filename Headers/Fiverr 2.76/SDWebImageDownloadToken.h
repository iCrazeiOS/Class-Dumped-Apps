...
@class NSOperation, NSString, NSURL, NSURLRequest, NSURLResponse, SDWebImageDownloader;
...
@property(nonatomic) __weak SDWebImageDownloader *downloader; // @synthesize downloader=_downloader;
