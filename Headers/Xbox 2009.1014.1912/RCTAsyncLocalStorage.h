...
#import "NativeAsyncStorageSpec-Protocol.h"
...
+ (const struct RCTMethodInfo *)__rct_export__4545;
+ (const struct RCTMethodInfo *)__rct_export__4464;
+ (const struct RCTMethodInfo *)__rct_export__4163;
+ (const struct RCTMethodInfo *)__rct_export__3802;
+ (const struct RCTMethodInfo *)__rct_export__3601;
+ (const struct RCTMethodInfo *)__rct_export__3410;
+ (void)clearAllData;
+ (void)load;
+ (id)moduleName;
