...
@class AVAssetResourceLoadingRequest, AVPictureInPictureController, AVPlayer, AVPlayerItem, AVPlayerLayer, NSArray, NSDictionary, NSString, NSURL, RCTEventDispatcher, RCTVideoPlayerViewController, UIViewController;
...
@interface RCTVideo : UIView <RCTVideoPlayerViewControllerDelegate, AVPictureInPictureControllerDelegate, AVAssetResourceLoaderDelegate>
{
    ...
    NSURL *_videoURL;
    _Bool _requestingCertificate;
    _Bool _requestingCertificateErrored;
    NSDictionary *_drm;
    ...
    CDUnknownBlockType _onGetLicense;
}

@property(copy, nonatomic) CDUnknownBlockType onGetLicense; // @synthesize onGetLicense=_onGetLicense;
...
- (id)base64DataFromBase64String:(id)arg1;
- (_Bool)loadingRequestHandling:(id)arg1;
...
- (_Bool)finishLoadingWithError:(id)arg1;
- (_Bool)setLicenseResultError:(id)arg1;
- (void)setLicenseResult:(id)arg1;
...
- (void)setPreferredForwardBufferDuration:(float)arg1;
...
- (CDStruct_3c1748cc)playerItemSeekableTimeRange;
