...
- (void)backgroundVideo:(id)arg1;
- (void)backgroundImage:(id)arg1 stickerImage:(id)arg2 attributionURL:(id)arg3;
- (void)stickerImage:(id)arg1 backgroundTopColor:(id)arg2 backgroundBottomColor:(id)arg3 attributionURL:(id)arg4;
- (void)backgroundImage:(id)arg1 attributionURL:(id)arg2;
