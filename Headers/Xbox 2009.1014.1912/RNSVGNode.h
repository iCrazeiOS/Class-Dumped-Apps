...
@property(nonatomic) struct CGRect markerBounds; // @synthesize markerBounds=_markerBounds;
@property(nonatomic) struct CGRect strokeBounds; // @synthesize strokeBounds=_strokeBounds;
@property(nonatomic) struct CGRect fillBounds; // @synthesize fillBounds=_fillBounds;
...
@property(nonatomic) struct CGPath *markerPath; // @synthesize markerPath=_markerPath;
...
@property(nonatomic) struct CGAffineTransform screenCTM; // @synthesize screenCTM=_screenCTM;
...
@property(retain, nonatomic) NSString *markerEnd; // @synthesize markerEnd=_markerEnd;
@property(retain, nonatomic) NSString *markerMid; // @synthesize markerMid=_markerMid;
@property(retain, nonatomic) NSString *markerStart; // @synthesize markerStart=_markerStart;
