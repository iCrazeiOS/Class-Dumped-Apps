...
@property(nonatomic) struct CGAffineTransform viewBoxTransform; // @synthesize viewBoxTransform=_viewBoxTransform;
...
- (id)getDefinedMarker:(id)arg1;
- (void)defineMarker:(id)arg1 markerName:(id)arg2;
