...
+ (_Bool)tableExists:(id)arg1 inOpenedDatabase:(void *)arg2 result:(int *)arg3;
+ (_Bool)tableExists:(id)arg1 inOpenedDatabase:(void *)arg2;
...
- (_Bool)createTable:(id)arg1 columnsSchema:(struct NSArray *)arg2 uniqueColumnsConstraint:(id)arg3;
- (_Bool)createTable:(id)arg1 columnsSchema:(struct NSArray *)arg2;
- (void)dropDatabase;
