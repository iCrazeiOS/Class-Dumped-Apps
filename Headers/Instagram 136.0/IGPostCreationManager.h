...
@class IGAnnouncer, IGPostDataStore, IGPostSessionFactory, IGUploadService, IGUserSession, NSMutableDictionary, NSString;
...
- (id)postIds;
- (id)sharePostId:(id)arg1 shareType:(long long)arg2 shareParams:(id)arg3 pendingShareMetadata:(id)arg4 configureUserPk:(id)arg5;
...
- (void)uploadVideoComposition:(id)arg1 uploadParams:(id)arg2 contentTags:(id)arg3 previewImageEncoding:(id)arg4 useFirstFrameForCoverPhoto:(_Bool)arg5 mediaId:(id)arg6 postId:(id)arg7;
...
- (id)initWithNetworker:(id)arg1 cacheLimits:(id)arg2 userSession:(id)arg3 postSessionFactory:(id)arg4;
