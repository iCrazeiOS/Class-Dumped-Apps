...
@class IGFeedItem, IGHighlightsAddSheetCreateView, IGHighlightsStoryTrayDataSource, IGNavigationBar, IGShareSheetButton, IGUserSession, NSArray, NSSet, NSString, UICollectionView, UIImage, UIView, UIViewController;
@protocol IGAddHighlightsViewControllerDelegate;

@interface IGAddHighlightsViewController : IGViewController <UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, IGStoryTrayDataSourceListener, IGAnalyticsModule, IGGestureHandler>
{
