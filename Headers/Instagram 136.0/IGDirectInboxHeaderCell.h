...
@class IGDirectInboxFolder, IGSegmentedTabControl, IGTapButton, NSOrderedSet, UILabel, UIView;
...
@interface IGDirectInboxHeaderCell : UICollectionViewCell
{
    ...
    IGDirectInboxFolder *_currentFolder;
    NSOrderedSet *_folderTypes;
}
...
- (void)_updateCurrentFolder:(id)arg1;
- (void)_updateSegmentedTabControlWithFolderTypes:(id)arg1;
