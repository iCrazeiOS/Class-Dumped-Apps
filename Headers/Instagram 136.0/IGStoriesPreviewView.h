...
@class IGFNFVideoPlayer, IGGradientView, IGStoryFullscreenHeaderView, IGStoryViewerLoggingContext, IGUserSession, NSString, UIImageView;
@protocol IGStoryItemType;

@interface IGStoriesPreviewView : UIView <IGFNFVideoPlayerDelegate>
{
