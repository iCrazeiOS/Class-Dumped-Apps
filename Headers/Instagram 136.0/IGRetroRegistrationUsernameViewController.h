...
@class IGAuthenticator, IGFBSDKAccessToken, IGFacebookAuthHelper, IGGDPRConsentNavigationPresenter, IGKeyboardObserver, IGNUXLayoutSpec, IGParentalConsentCoordinator, IGRetroRegistrationUsernameStepView, IGUserSession, NSArray, NSDate, NSDictionary, NSString, NSTimer, UITapGestureRecognizer;
...
- (_Bool)_isEligibleForUsernameLoginUpsell;
- (void)_startGDPR;
...
- (void)viewDidLoad;
- (id)initWithSuggestedUsernames:(id)arg1 email:(id)arg2 phoneNumber:(id)arg3 SMSConsent:(_Bool)arg4 facebookInfo:(id)arg5 facebookAccessToken:(id)arg6 SMSSignUpCode:(id)arg7 forceSignUpCode:(id)arg8 fullName:(id)arg9 password:(id)arg10 isSwitchingUsers:(_Bool)arg11 wasLoginUpsellShown:(_Bool)arg12 authenticator:(id)arg13 fbAuthHelper:(id)arg14 networker:(id)arg15 layoutSpec:(id)arg16 isGDPRRequired:(_Bool)arg17 parentalConsentRequired:(_Bool)arg18 tosVersion:(id)arg19 dob:(id)arg20 flowName:(id)arg21 topButtonType:(unsigned long long)arg22 showFooterView:(_Bool)arg23 showTermView:(_Bool)arg24 isEligibleForUsernameSuggestions:(_Bool)arg25 subtitle:(id)arg26;
