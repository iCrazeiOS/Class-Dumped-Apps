...
@class IGProfilePictureImageView, IGTVAutoplayingMetadataViewModel, IGTVLabelSizeButton, NSDictionary, NSString, UIImageView, UILabel;
@protocol IGTVAutoplayingMetadataViewDelegate;

@interface IGTVAutoplayingMetadataView : UIView <IGProfilePictureImageViewDelegate>
{
    IGTVAutoplayingMetadataViewModel *_viewModel;
    UILabel *_titleLabel;
    ...
    id <IGTVAutoplayingMetadataViewDelegate> _delegate;
}

+ (double)preferredHeightForWidth:(double)arg1 withViewModel:(id)arg2;
- (void).cxx_destruct;
