...
@class IGStoryMusicBrowserBookmarkButton, IGStoryViewerBottomSheetIconAndLabelView, IGStoryViewerMusicSheetArtistButton, IGStoryViewerMusicSheetPlaybackControlsView, IGStoryViewerMusicSheetSongArtButton, IGStoryViewerMusicSheetTitleView, IGStoryViewerMusicSheetTopClipsView;
