...
@protocol IGFeedItemWYTSurveyCellControllerDelegate, IGFeedSectionViewsProvider, IGFeedTheme;
...
- (id)initWithListSectionContext:(id)arg1 feedItemSectionContext:(id)arg2 feedSectionViewsProvider:(id)arg3 feedItemTracker:(id)arg4 feedTheme:(id)arg5;
