...
- (id)initWithMessageId:(id)arg1 threadId:(id)arg2 action:(id)arg3 originalMessageClientContext:(id)arg4 updateClientContext:(id)arg5 updateOfflineThreadingId:(id)arg6 isE2ELoggingSampled:(_Bool)arg7;
