...
@class IGBouncyButton, IGCameraLoggingContext, IGCameraViewController, IGCameraZoomController, IGLFKLayoutView, IGProgressRingView, IGStoryCameraOverlayViewController, IGStoryExtendedGalleryViewController, IGStoryLayoutFormatBlurredPreviewView, IGTapButton, IGUserSession, NSArray, NSMutableArray, NSString, UIImageView, UIView;
@protocol FBCancelable, IGStoryFormatViewControllerProtocolDelegate;

@interface IGStoryLayoutFormatViewController : UIViewController <IGAnalyticsModule, IGCameraViewControllerDelegate, IGCameraViewControllerSampleBufferObserver, IGCameraZoomControllerDelegate, IGQuickCamCaptureButtonDelegate, IGStoryCameraOverlayViewControllerDelegate, IGStoryCameraOverlayViewControllerVariantSelectorDataSource, IGStoryCameraOverlayViewControllerVariantSelectorDelegate, IGStoryDrawerDismissDelegate, IGStoryExtendedGalleryViewControllerDelegate, UIGestureRecognizerDelegate, IGStoryFormatViewControllerProtocol>
{
    NSArray *_variants;
    ...
    id <FBCancelable> _volumeReleaseScheduler;
...
- (void)_cancelVolumeReleaseScheduler;
- (void)_volumeButtonReleased;
- (void)_volumeButtonPressed:(id)arg1;
- (void)_setupVolumeButtonCapture;
- (void)_capturePhoto;
