...
@class IGImageView, IGTVBlurredOverlayView, IGTVCardVideoHeaderView, IGTVCardView, IGTVThumbnailMetadataView, IGTVThumbnailViewModel, NSString;
@protocol IGTVThumbnailCellDelegate;

@interface IGTVThumbnailCell : IGDelayedBouncyCollectionViewCell <IGImageViewDelegate, UIGestureRecognizerDelegate>
{
    IGTVCardView *_cardView;
    IGImageView *_coverImageView;
    IGTVCardVideoHeaderView *_headerView;
    IGTVThumbnailMetadataView *_metadataView;
