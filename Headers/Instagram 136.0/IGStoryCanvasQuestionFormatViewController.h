...
@class IGQuestionAnswerStickerView, IGStoryCanvasToolbarConfig, IGStoryStickerContainerView, IGUserSession, NSArray, NSString;
...
- (void)viewDidLoad;
- (id)initWithUserSession:(id)arg1 models:(id)arg2 colorProvider:(id)arg3 contentInset:(struct UIEdgeInsets)arg4;
