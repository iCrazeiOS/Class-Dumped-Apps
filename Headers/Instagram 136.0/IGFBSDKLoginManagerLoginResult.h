...
@class IGFBSDKAccessToken, NSDictionary, NSMutableDictionary, NSSet;

@interface IGFBSDKLoginManagerLoginResult : NSObject
{
    NSMutableDictionary *_mutableLoggingExtras;
    _Bool _isCancelled;
    _Bool _isSkipped;
    IGFBSDKAccessToken *_token;
...
@property(copy, nonatomic) IGFBSDKAccessToken *token; // @synthesize token=_token;
- (void).cxx_destruct;
