...
@protocol IGUserExperimentSetProviding, IGUserSearchIndex;

@interface IGUserListLocalDataSource : NSObject <IGFeedItemUpdatedListener, IGAutocompleteAlmostAbstractDataSource>
{
...
- (id)initWithAutocompleteUsersStore:(id)arg1 surface:(id)arg2 currentUser:(id)arg3 experimentProvider:(id)arg4;
