...
@class IGFBSDKBridgeAPIRequest, NSDictionary, NSError, NSString;

@interface IGFBSDKBridgeAPIResponse : NSObject <IGFBSDKCopying>
{
    _Bool _cancelled;
    NSError *_error;
    IGFBSDKBridgeAPIRequest *_request;
...
@property(readonly, copy, nonatomic) IGFBSDKBridgeAPIRequest *request; // @synthesize request=_request;
