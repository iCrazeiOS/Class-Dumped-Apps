...
@class IGAdPlatformGapRules, IGCameraEffectChainingContext, IGLiveBroadcast, IGStoryAdPodRulesModel, IGStoryCarouselModel, IGStoryNetegoModel, IGStoryViewerCoverItemModel, IGStoryViewerPivotModel, IGUser, NSArray, NSDate, NSString;
...
- (id)initWithReelPK:(id)arg1 type:(long long)arg2 owner:(id)arg3 isNux:(_Bool)arg4 canReply:(_Bool)arg5 canReshare:(_Bool)arg6 supportsFollowing:(_Bool)arg7 items:(id)arg8 startingItem:(id)arg9 openViewerListAtLaunch:(_Bool)arg10 itemFilterTimestamp:(id)arg11 sourceToken:(id)arg12 broadcasts:(id)arg13 startingBroadcast:(id)arg14 fetchable:(_Bool)arg15 isSponsored:(_Bool)arg16 isArchive:(_Bool)arg17 isStoryHighlight:(_Bool)arg18 isInsights:(_Bool)arg19 currentUser:(id)arg20 pivotModel:(id)arg21 reelTitle:(id)arg22 uniqueReelID:(id)arg23 reelCoverModel:(id)arg24 allowExpiredStories:(_Bool)arg25 hideFooter:(_Bool)arg26 hideHeaderAvatar:(_Bool)arg27 focusBroadcastID:(id)arg28 arEffectChainingContext:(id)arg29 carouselModel:(id)arg30 storyNetegoModel:(id)arg31 gapRules:(id)arg32 adPodRulesModel:(id)arg33 videoToCarouselCutSecs:(id)arg34 cardificationCardType:(unsigned long long)arg35 isPrideReel:(_Bool)arg36 highlightsHeaderDesign:(long long)arg37 presentDiscussionStickerCommentsToTargetComment:(id)arg38;
- (id)initWithReelPK:(id)arg1 type:(long long)arg2 owner:(id)arg3 isNux:(_Bool)arg4 canReply:(_Bool)arg5 canReshare:(_Bool)arg6 supportsFollowing:(_Bool)arg7 items:(id)arg8 startingItem:(id)arg9 openViewerListAtLaunch:(_Bool)arg10 itemFilterTimestamp:(id)arg11 sourceToken:(id)arg12 broadcasts:(id)arg13 startingBroadcast:(id)arg14 fetchable:(_Bool)arg15 isSponsored:(_Bool)arg16 isArchive:(_Bool)arg17 isStoryHighlight:(_Bool)arg18 isInsights:(_Bool)arg19 currentUser:(id)arg20 pivotModel:(id)arg21 reelTitle:(id)arg22 uniqueReelID:(id)arg23 reelCoverModel:(id)arg24 allowExpiredStories:(_Bool)arg25 hideFooter:(_Bool)arg26 hideHeaderAvatar:(_Bool)arg27 carouselModel:(id)arg28 storyNetegoModel:(id)arg29 gapRules:(id)arg30 adPodRulesModel:(id)arg31 videoToCarouselCutSecs:(id)arg32 cardificationCardType:(unsigned long long)arg33 isPrideReel:(_Bool)arg34 highlightsHeaderDesign:(long long)arg35 presentDiscussionStickerCommentsToTargetComment:(id)arg36;
- (id)initWithReelPK:(id)arg1 type:(long long)arg2 owner:(id)arg3 isNux:(_Bool)arg4 canReply:(_Bool)arg5 canReshare:(_Bool)arg6 supportsFollowing:(_Bool)arg7 items:(id)arg8 itemFilterTimestamp:(id)arg9 sourceToken:(id)arg10 broadcasts:(id)arg11 startingBroadcast:(id)arg12 fetchable:(_Bool)arg13 isSponsored:(_Bool)arg14 isArchive:(_Bool)arg15 isStoryHighlight:(_Bool)arg16 isInsights:(_Bool)arg17 currentUser:(id)arg18 pivotModel:(id)arg19 uniqueReelID:(id)arg20 focusBroadcastID:(id)arg21;
- (id)initWithReelPK:(id)arg1 type:(long long)arg2 owner:(id)arg3 isNux:(_Bool)arg4 canReply:(_Bool)arg5 canReshare:(_Bool)arg6 supportsFollowing:(_Bool)arg7 items:(id)arg8 itemFilterTimestamp:(id)arg9 sourceToken:(id)arg10 broadcasts:(id)arg11 startingBroadcast:(id)arg12 fetchable:(_Bool)arg13 isSponsored:(_Bool)arg14 isArchive:(_Bool)arg15 isStoryHighlight:(_Bool)arg16 isInsights:(_Bool)arg17 currentUser:(id)arg18 pivotModel:(id)arg19 uniqueReelID:(id)arg20 shouldOpenViewerListAtLaunch:(_Bool)arg21 allowExpiredStories:(_Bool)arg22 isPrideReel:(_Bool)arg23;
