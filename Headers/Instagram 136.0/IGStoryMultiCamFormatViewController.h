...
@class IGCameraDynamicPreviewView, IGCameraViewController, IGCameraZoomController, IGStoryCameraOverlayViewController, IGStoryExtendedGalleryViewController, IGStoryStyledFrameBundleView, IGUserSession, NSArray, NSMutableDictionary, NSString;
...
- (_Bool)cameraViewControllerUseAdditionalPreviews:(id)arg1;
