...
@protocol UIViewControllerAnimatedTransitioning, UIViewControllerInteractiveTransitioning, UIViewControllerTransitionCoordinator;

@protocol IGNavigationControllerTransitionHandling <NSObject>
...
- (id <UIViewControllerTransitionCoordinator>)transitionCoordinatorWithDefault:(id <UIViewControllerTransitionCoordinator>)arg1;
@end
