...
@class IGPlaybackTimeline, IGStoryMusicLyricsSongModel, NSString, UICollectionView, UIColor, UIFont;

@interface IGStoryMusicLyricsCubeRevealStickerView : UIView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, IGPlaybackTimelineDelegate, IGStoryMusicLyricsStickerProtocol, IGDynamicSurfaceStickerViewType>
{
    UIFont *_activeFont;
    UICollectionView *_cubeFlipCollectionView;
