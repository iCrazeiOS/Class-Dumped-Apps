...
@interface IGDiscussionStickerTrayModel : NSObject <IGListDiffable, IGStickerModelType, IGSmartStickerModelType, NSCoding>
{
...
@property(readonly, nonatomic) NSString *promptText; // @synthesize promptText=_promptText;
- (void).cxx_destruct;
