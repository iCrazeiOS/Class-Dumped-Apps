...
@class IGAccessibilityFeedAggregationController, IGAdsBottomCTAController, IGCollectionViewVisibility, IGContextualFeedBottomNuxController, IGContextualFeedConfiguration, IGContextualFeedItemConfiguration, IGContextualFeedNavigationPerfComponents, IGFeedFocusCoordinator, IGFeedItemLogger, IGFeedPreviewingHandler, IGFeedScrollViewAnnouncer, IGFeedStatusView, IGListAdapter, IGListAdapterUpdaterLogger, IGMediaPreloader, IGPagingListAdapterController, IGRefreshControl, IGScrollPerfLogger, IGSessionTracker, IGUserSession, NSString, UICollectionView;
@protocol IGContextualFeedLogger, IGContextualFeedService, IGContextualFeedViewControllerDelegate, IGFeedSectionControllerComponentsType, IGFeedStatusViewDataSource;

@interface IGContextualFeedViewController : IGViewController <IGContextualFeedServiceDelegate, IGContextualFeedBottomNuxControllerDelegate, IGListAdapterDataSource, IGListAdapterDelegate, IGFeedStatusViewDelegate, IGFeedScrollViewListener, IGFeedPreviewingType, IGPagingListAdapterControllerDelegate, IGAccessibilityFeedAggregationDelegate, IGBugReportingProtocol>
{
...
- (void)viewDidLoad;
- (id)initWithContextualFeedService:(id)arg1 userSession:(id)arg2 itemConfiguration:(id)arg3 feedStatusViewDataSource:(id)arg4 focusCoordinator:(id)arg5 savedMediaCollection:(id)arg6 feedItemLogger:(id)arg7 contextualFeedLogger:(id)arg8 shoppingSessionTracker:(id)arg9;
