...
@class IGFeedItem, IGStoryCanvasToolbarConfig, IGStoryGradientRingView, IGStoryStickerContainerView, IGUserSession, NSArray, NSString, UISelectionFeedbackGenerator, UIView;
...
@interface IGStoryCanvasMentionsFormatViewController : UIViewController <IGResharedMentionStickerListViewControllerDelegate, IGCanvasControlsOverlayViewToolbarDelegate, IGStoryCanvasFormatGradientHandler, IGStoryCanvasFormatViewControllerType>
{
    ...
    IGFeedItem *_currentMentionedFeedItem;
...
- (void)_asynchronouslyCreateMentionStickerWithFeedItem:(id)arg1 shouldBounce:(_Bool)arg2;
- (void)viewDidLayoutSubviews;
- (void)viewDidDisappear:(_Bool)arg1;
- (void)viewDidAppear:(_Bool)arg1;
- (void)viewDidLoad;
- (id)initWithUserSession:(id)arg1 mentionedFeedItems:(id)arg2;
