...
@class IGDirectThreadNotificationPresenter, IGDirectThreadService, IGDirectThreadSubscriptionService, IGUserSession, NSString;

@interface IGDirectOutgoingUpdateAlertService : NSObject <IGDirectOutgoingUpdateListener, IGUserSessionObject>
{
