...
@class AVAudioPlayer, FBTimer, IGDirectAudioRecorder, IGDirectGradient, IGDirectVoiceRecordAppearance, IGDirectVoiceRecordInputView, IGDirectVoiceRecordLockView, IGVideoCallManager, NSDate, NSString, UIImageView, UILabel;
...
- (void)viewDidLoad;
- (id)initWithVideoCallManager:(id)arg1 backgroundGradient:(id)arg2;
