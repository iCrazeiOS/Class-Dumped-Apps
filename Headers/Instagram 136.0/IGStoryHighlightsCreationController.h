...
#import <InstagramAppCoreFramework/IGHighlightsMetadataEditDetailsViewControllerDelegate-Protocol.h>
...
@interface IGStoryHighlightsCreationController : IGViewController <IGHighlightsEditViewControllerDelegate, IGHighlightsEditDetailsViewControllerDelegate, IGHighlightsCoverEditViewControllerDelegate, IGHighlightsMetadataEditDetailsViewControllerDelegate, IGStoryArchiveNavigationHandler, IGStoryArchiveSelectionDelegate, IGStoryHighlightCustomCoverUploaderDelegate, IGStoryHighlightsCreationControllerType>
{
...
- (void)editReelWithController:(id)arg1 addedItems:(id)arg2 removedItems:(id)arg3 title:(id)arg4 location:(id)arg5 hashtagNames:(id)arg6;
...
- (void)metadataHighlightsEditDetailsVC:(id)arg1 didTapDoneWithTitle:(id)arg2 coverModel:(id)arg3 location:(id)arg4 hashtagNames:(id)arg5;
...
- (void)editHighlightsVC:(id)arg1 didTapDoneWithAddedItems:(id)arg2 removedItems:(id)arg3 title:(id)arg4 location:(id)arg5 hashtagNames:(id)arg6;
...
- (id)initWithCreationMode:(long long)arg1 entryPoint:(long long)arg2 items:(id)arg3 reelPK:(id)arg4 title:(id)arg5 coverInfo:(id)arg6 location:(id)arg7 hashtagNames:(id)arg8 userSession:(id)arg9;
