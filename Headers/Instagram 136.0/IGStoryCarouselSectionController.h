...
@protocol IGStoryCarouselSelectionDelegate, IGStoryItemType, IGUserExperimentSet;
...
- (id)initWithPostCreationManager:(id)arg1 reelPK:(id)arg2 experimentSet:(id)arg3 module:(id)arg4 feedItemUpdatedForAllAnnouncer:(id)arg5;
