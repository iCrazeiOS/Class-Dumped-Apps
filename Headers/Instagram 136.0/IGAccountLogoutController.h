...
@class IGAccountStoreCoordinator, IGBiometryOptInController, IGConfirmPhoneHelper, IGOneTapLoginLoggingHelper, IGUserSession, UIViewController;
...
- (void)_performAccountGroupLogoutWithOneTapLoginEnabledAccoutPKs:(id)arg1 logoutEntryPoint:(long long)arg2;
