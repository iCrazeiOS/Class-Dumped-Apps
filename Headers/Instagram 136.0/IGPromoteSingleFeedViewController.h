...
@class IGBoostPostLogger, IGFeedItem, IGFeedNetworkSource, IGFeedVideoCellManager, IGPromoteMediaPreviewingHandler, IGUserSession, IGVideoPlaybackLoggingConfig, IGVideoViewLogger, NSString, UICollectionView;

@interface IGPromoteSingleFeedViewController : IGViewController <UICollectionViewDelegate, UICollectionViewDataSource, IGFeedPreviewingType, IGFeedItemPreviewProviding, IGFeedNetworkSourceDelegate, IGPromoteMediaPickerDisplayViewControllerProtocol>
{
