...
@class IGFBSDKAccessToken, IGResetPasswordBundle, IGTwoFactorInfo, NSDictionary, NSString;
...
- (void)oneTapLoginViewController:(id <IGOneTapLoginViewControllerProtocol>)arg1 proceedTwoFactorWithInfo:(IGTwoFactorInfo *)arg2 facebookAccessToken:(IGFBSDKAccessToken *)arg3;
...
- (void)oneTapLoginViewController:(id <IGOneTapLoginViewControllerProtocol>)arg1 willProceedRegistrationWithFBInfo:(NSDictionary *)arg2 facebookAccessToken:(IGFBSDKAccessToken *)arg3 tosVersion:(NSString *)arg4;
- (void)oneTapLoginViewControllerProceedTwoFactorWithInfo:(IGTwoFactorInfo *)arg1 facebookAccessToken:(IGFBSDKAccessToken *)arg2;
