...
@class IGDirectSuggestedMediaViewController, IGFeedItem, NSArray;
...
- (void)suggestedMediaViewController:(IGDirectSuggestedMediaViewController *)arg1 didSelectFeedItem:(IGFeedItem *)arg2;
@end
