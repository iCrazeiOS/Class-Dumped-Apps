...
@class IGFeedItem, IGFeedItemLocationInfo, IGFeedItemPageCellState, IGFeedItemRow, IGListSectionController, IGVideoPlaybackLoggingConfig, NSIndexSet, NSSet, UIView;
@protocol IGAdInsertionProtocol, IGFeedConfigurationType, IGFeedSectionControllerActionDelegate, IGFeedSectionControllerAdsInfoProviding, IGFeedSectionControllerRowVisibilityDelegate;
...
@property(retain, nonatomic) id <IGAdInsertionProtocol> adInsertionHandler;
...
- (void)mediaHiddenListenerRemoveAnnouncerForFeedItem:(IGFeedItem *)arg1;
