...
@class IGBulkCommentDeleteManager, IGCommentCellRevealManager, IGCommentModel, IGFeedItem, IGRestrictedUserController, IGSponsoredSupportConfiguration, IGTranslationNetworkDataSource, IGUserSession, NSString;
...
- (void)_toggleRestrictForUser:(id)arg1 willRestrict:(_Bool)arg2 showDeleteCommentAlert:(_Bool)arg3;
...
- (id)initWithUserSession:(id)arg1 commentSectionController:(id)arg2 feedItem:(id)arg3 analyticsModule:(id)arg4 bulkDeleteManager:(id)arg5 cellRevealManager:(id)arg6 sponsoredSupportConfiguration:(id)arg7 restrictedUserController:(id)arg8;
