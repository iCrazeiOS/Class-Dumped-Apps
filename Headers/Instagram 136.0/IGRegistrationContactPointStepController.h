...
@class IGRegistrationContactPointViewController, IGRegistrationFlowContext, NSString;
...
- (void)registrationContactPointViewControllerDidTapLogInForEmailTakenDialog:(id)arg1;
