...
@protocol IGFBSDKBridgeAPIProtocol;

@interface IGFBSDKBridgeAPIRequest : NSObject <IGFBSDKCopying>
{
    NSString *_actionID;
    ...
    id <IGFBSDKBridgeAPIProtocol> _protocol;
}
...
@property(readonly, nonatomic) id <IGFBSDKBridgeAPIProtocol> protocol; // @synthesize protocol=_protocol;
