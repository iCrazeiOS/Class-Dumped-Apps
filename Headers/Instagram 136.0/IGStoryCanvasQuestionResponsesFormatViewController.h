...
@class IGQuestionAnswerStickerModel, IGQuestionAnswerStickerResponder, IGQuestionAnswerStickerResponsesModel, IGStoryCanvasToolbarConfig, IGStoryCanvasTooltipOverlayView, IGStoryStickerContainerView, IGUserSession, NSString, UIView;
...
- (void)viewDidLoad;
- (id)initWithUserSession:(id)arg1 questionModel:(id)arg2 responsesModel:(id)arg3 contentInset:(struct UIEdgeInsets)arg4;
