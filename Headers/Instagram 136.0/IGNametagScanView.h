...
@class CAShapeLayer, FBShimmeringView, IGGradientView, IGNametagView, IGNametagViewConfiguration, IGRadialLoadingIndicatorView, IGStoryCameraGalleryButton, IGTapButton, UIBarButtonItem, UINavigationBar, UIToolbar, UIVisualEffectView;
...
- (void)layoutSubviews;
- (id)initWithCardConfig:(id)arg1 useQRCode:(_Bool)arg2;
