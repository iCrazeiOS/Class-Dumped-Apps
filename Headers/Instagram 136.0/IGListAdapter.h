...
- (id)initWithUserSession:(id)arg1 module:(id)arg2 viewController:(id)arg3 workingRange:(unsigned long long)arg4 movesAsDeletesInserts:(_Bool)arg5 enableOffscreenCellFix:(_Bool)arg6;
...
- (CDStruct_27c46b5c)collectionView:(id)arg1 layout:(id)arg2 separatorOptionsForItemAtIndexPath:(id)arg3;
