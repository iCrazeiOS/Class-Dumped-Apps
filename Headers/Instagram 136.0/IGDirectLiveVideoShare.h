...
- (id)initWithMetadata:(id)arg1 broadcast:(id)arg2 comment:(id)arg3 textType:(long long)arg4 startPlaybackAtOffset:(long long)arg5 likers:(id)arg6 reactions:(id)arg7;
