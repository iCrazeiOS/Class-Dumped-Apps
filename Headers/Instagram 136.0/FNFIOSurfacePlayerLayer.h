...
@protocol FNFAVPlayer, FNFDecompressionSession, FNFFramesBufferManaging, FNFPlayerDisplayEngineDelegate, FNFVideoPlaybackLoggingContext, OS_dispatch_queue;
...
- (id)initWithConfig:(CDStruct_c95a5519)arg1 andCodecMap:(struct NSDictionary *)arg2;
- (id)initWithConfig:(CDStruct_c95a5519)arg1;
