...
@protocol IGAnalyticsEventLoggingProtocol, IGDirectRealtimeThreadFetcherListenerAnnouncer;
...
@interface IGDirectRealtimeThreadFetcher : NSObject
{
    ...
    id <IGDirectRealtimeThreadFetcherListenerAnnouncer> _listenerAnnouncer;
