...
#import <FBSharedFramework/IGFBSDKButtonImpressionTracking-Protocol.h>

@class IGFBSDKLoginManager, NSArray, NSDictionary, NSString;
@protocol IGFBSDKLoginButtonDelegate;

@interface IGFBSDKLoginButton : IGFBSDKButton <IGFBSDKButtonImpressionTracking>
{
    _Bool _hasShownTooltipBubble;
    IGFBSDKLoginManager *_loginManager;
    NSString *_userID;
    NSString *_userName;
    id <IGFBSDKLoginButtonDelegate> _delegate;
...
@property(nonatomic) __weak id <IGFBSDKLoginButtonDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)_updateContent;
