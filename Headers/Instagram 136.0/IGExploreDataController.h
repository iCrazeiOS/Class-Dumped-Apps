...
@class IGExploreNetworkFetchState, IGExploreNetworker, IGExploreTopicStore, IGSessionTracker, IGUserSession, NSMutableDictionary, NSString;
@protocol IGExploreDataControllerTopicsDelegate;
...
@interface IGExploreDataController : NSObject <IGExploreTopicDataControllerDelegate, IGExploreNetworkerDelegate>
{
    ...
    id <IGExploreDataControllerTopicsDelegate> _topicsDelegate;
}

@property(nonatomic) __weak id <IGExploreDataControllerTopicsDelegate> topicsDelegate; // @synthesize topicsDelegate=_topicsDelegate;
