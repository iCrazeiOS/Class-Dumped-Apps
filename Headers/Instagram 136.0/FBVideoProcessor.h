...
#import <InstagramAppCoreFramework/FBMediaProcessor-Protocol.h>

@class FBFilterContext, FBFilterGroup, FBGLContext, FBSurface, FBVideoProcessorConfig, NSArray, NSError, NSString;
...
@interface FBVideoProcessor : NSObject <FBFilterContextDelegate, FBMediaProcessor>
{
    ...
    FBSurface *_currentOutputSurface;
