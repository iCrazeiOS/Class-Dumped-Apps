...
#import <InstagramAppCoreFramework/IGRealtimeStatusQuerying-Protocol.h>
#import <InstagramAppCoreFramework/IGUserSessionObject-Protocol.h>

@class IGRealtimeMqttClient, NSString;

@interface IGRealtimeStatusQuerier : NSObject <IGUserSessionObject, IGRealtimeStatusQuerying>
{
