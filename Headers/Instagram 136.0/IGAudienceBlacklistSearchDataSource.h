...
@protocol IGUserListSectionControllerSelectionDelegate><IGAudienceBlacklistSearchDataSourceDelegate;

@interface IGAudienceBlacklistSearchDataSource : NSObject <IGFeedStatusViewDelegate, IGUserListNetworkDataSourceDelegate, IGTextViewSectionControllerDelegate, IGListAdapterDataSource>
{
    IGUserSession *_userSession;
    id <IGUserListSectionControllerSelectionDelegate><IGAudienceBlacklistSearchDataSourceDelegate> _delegate;
