...
@class CALayer, IGCoreTextView, IGFeedItemHeaderAvatarView, IGFeedItemHeaderCoreTextView, IGFeedItemHeaderViewModel, IGFollowController, IGStringStyle, IGTapButton, IGUserSession, NSMutableArray, NSObject, NSString, UIButton, UIImageView, UILabel, UIView;
@protocol IGFeedItemHeaderDelegate, IGFeedItemLoggingProviderDelegate, IGFeedTheme, IGFollowControllerLoggingProvider;

@interface IGFeedItemHeader : IGTimelineHeader <IGALLogContextModelProvider, IGFeedItemHeaderAvatarViewDelegate, IGFollowControllerDelegate, IGFollowControllerLoggingProvider, IGCoreTextLinkHandler, IGFeedItemHeaderCoreTextViewDelegate, IGUserUpdatedListener, IGFeedItemUpdatedListener>
{
    ...
    UIButton *_accountLocationButton;
...
@property(retain, nonatomic) UIButton *accountLocationButton; // @synthesize accountLocationButton=_accountLocationButton;
...
- (void)_configureAccountLocationButton;
...
@property(readonly, nonatomic) NSString *headerPrimaryTitle;
