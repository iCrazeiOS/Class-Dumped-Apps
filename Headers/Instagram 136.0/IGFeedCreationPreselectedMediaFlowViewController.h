...
@class IGFeedCreationFlowLogger, IGNavigationController, IGUserSession, NSString, UIViewController;
...
- (void)viewDidLoad;
- (id)initWithUserSession:(id)arg1 logger:(id)arg2 editorViewController:(id)arg3;
