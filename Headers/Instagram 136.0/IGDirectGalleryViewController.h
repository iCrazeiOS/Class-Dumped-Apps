...
@class IGCameraAndGalleryAccessPromptView, IGChevronTitleButton, IGDirectAlbumViewController, IGDirectMediaPickerLogger, IGEmptyFeedView, IGListAdapter, NSMutableArray, NSMutableDictionary, NSString, PHCachingImageManager, PHImageRequestOptions, UICollectionView;
@protocol IGDirectGalleryDataSourceProtocol, IGDirectGalleryViewControllerDelegate;

@interface IGDirectGalleryViewController : IGViewController <IGDirectAlbumViewControllerDelegate, IGDirectGalleryMediaSectionControllerSelectDelegate, IGListAdapterDataSource, IGPartialModalSheetListener, UICollectionViewDelegateFlowLayout, IGDirectScrollingTabChildViewControllerProtocol>
{
