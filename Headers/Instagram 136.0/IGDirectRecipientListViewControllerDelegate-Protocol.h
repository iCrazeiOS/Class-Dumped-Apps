...
@class IGDirectShareRecipient, IGFeedItem, IGGroupStoriesModel, IGPostItem, IGStoryViewerLoggingContext, IGStoryViewerViewModel, IGUser, IGViewController, NSArray, NSOrderedSet, NSSet, NSString;
...
- (void)selectRecipientViewController:(IGViewController<IGDirectRecipientListViewControllerType> *)arg1 didOneTapSendToStoryTarget:(long long)arg2 willShareToFbWithYourStoryButton:(_Bool)arg3 blacklistedUserIDs:(NSArray *)arg4;
@end
