...
@protocol FNFAVPlayer, FNFDecompressionSession, FNFFramesBufferManaging, FNFPlayerDisplayEngineDelegate, FNFPlayerGLRenderer, FNFVideoPlaybackLoggingContext, OS_dispatch_queue;
...
- (id)initWithConfig:(CDStruct_c95a5519)arg1 renderingThread:(id)arg2 framesBuffer:(id)arg3 codecMap:(struct NSDictionary *)arg4;
