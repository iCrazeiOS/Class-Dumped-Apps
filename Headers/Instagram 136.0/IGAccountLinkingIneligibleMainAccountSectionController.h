...
#import <InstagramAppCoreFramework/IGAccountLinkingIneligibleMainAccountCellDelegate-Protocol.h>

@class NSString;
@protocol IGAccountLinkingIneligibleMainAccountSectionControllerDelegate, IGPersistentLoginAccountPublicData;
