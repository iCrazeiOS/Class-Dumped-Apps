...
@class CAShapeLayer, IGPlaybackTimeline, IGStoryClipsAnimatedGradientView, NSString, UIImage, UIImageView;

@interface IGStoryClipsCameraShutterButton : UIView <IGPlaybackTimelineDelegate, IGDialMagnifierViewType>
{
