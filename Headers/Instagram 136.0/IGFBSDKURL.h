...
@class IGFBSDKAppLink, NSDictionary, NSURL;

@interface IGFBSDKURL : NSObject
{
    NSURL *_targetURL;
    NSDictionary *_targetQueryParameters;
    NSDictionary *_appLinkData;
    NSDictionary *_appLinkExtras;
    IGFBSDKAppLink *_appLinkReferer;
    NSURL *_inputURL;
...
@property(readonly, nonatomic) IGFBSDKAppLink *appLinkReferer; // @synthesize appLinkReferer=_appLinkReferer;
