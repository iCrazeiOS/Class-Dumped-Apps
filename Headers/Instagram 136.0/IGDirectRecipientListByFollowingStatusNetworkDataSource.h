...
- (void).cxx_destruct;
- (void)_onFetchFailed:(id)arg1 fromRequest:(id)arg2;
- (void)_onResponseReceived:(id)arg1 fromRequest:(id)arg2;
- (void)_performFetchNetworkRequest:(id)arg1;
- (void)fetchData;
- (id)initWithNetworker:(id)arg1 mediaId:(id)arg2 defaultRecipients:(id)arg3;
