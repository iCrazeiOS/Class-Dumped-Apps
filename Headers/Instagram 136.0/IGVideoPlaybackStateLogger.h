...
@protocol IGUserExperimentSetProviding, IGVideoPlaybackDataProvider, IGVideoPlaybackStateProvider;
...
- (id)initWithConfig:(id)arg1 stateProvider:(id)arg2 playbackDataProvider:(id)arg3 analyticsLogger:(id)arg4 enableWatchTimeCollector:(_Bool)arg5 inferChannelPriority:(_Bool)arg6 experimentSetProvider:(id)arg7;
