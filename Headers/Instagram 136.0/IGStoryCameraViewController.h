...
@class AVCaptureDevice, FBTimer, IGAREffectModel, IGAREffectTargetModel, IGARLinkBufferStreamProcessor, IGARLinkManager, IGARLinkStoryGalleryProcessor, IGAsyncTask, IGCameraEffectGalleryDataProvider, IGCameraLoggingContext, IGCameraOpenPerfComponents, IGCameraTargetModel, IGCameraToolsMenu, IGCameraViewController, IGCameraZoomController, IGDirectionalPanGestureRecognizer, IGLiveBroadcastLogger, IGLiveBroadcastMainViewController, IGNametagLoggingContext, IGQRCodeBufferStreamProcessor, IGSoundStateListener, IGStoryCameraFormatModel, IGStoryCameraOverlayViewController, IGStoryClipsFormatViewController, IGStoryCreationConfiguration, IGStoryExtendedGalleryViewController, IGStoryGalleryZoomTransitionController, IGStoryMediaReplyOverlayController, IGUserSession, NSDate, NSMutableSet, NSString, NSTimer, UIImage, UIImageView, UILongPressGestureRecognizer, UITapGestureRecognizer, UIView, UIViewController;
@protocol IGStoryCameraDirectShareRecipientSource, IGStoryCameraViewControllerDelegate, IGStoryFormatViewControllerProtocol;

@interface IGStoryCameraViewController : IGViewController <IGARLinkBufferStreamProcessorDelegate, IGQRCodeBufferStreamProcessorDelegate, IGSoundStateListenerDelegate, IGCameraZoomControllerDelegate, IGLiveBroadcastMainViewControllerDelegate, IGQuickCamCaptureButtonDelegate, UIGestureRecognizerDelegate, UINavigationControllerDelegate, UITextViewDelegate, IGCustomViewController, IGStoryCameraOverlayViewControllerDelegate, IGStoryCameraOverlayViewControllerDialAppearanceDelegate, IGStoryCameraOverlayViewControllerDataSource, IGStoryClipsFormatViewControllerDelegate, IGStoryFormatViewControllerProtocolDelegate, IGCameraViewControllerDelegate, IGCameraViewControllerAdditionalCaptureMetadataObserver, IGCameraViewControllerAREffectDelegate, IGCameraViewControllerAREffectNativeUIDelegate, IGStoryMediaReplyOverlayControllerDelegate, IGStoryExtendedGalleryViewControllerDelegate, IGCameraViewControllerSampleBufferObserver, IGStoryDrawerDismissDelegate, IGStoryPostCaptureEditingViewControllerDelegate, IGAREffectLoadingDelegate, IGARLinkScannerStateListener, IGARLinkDetectedCardViewControllerDelegate, IGBrowserControllerDelegate, IGGestureHandler, IGStoryCreationAnimationCameraPresentableType>
{
    ...
    IGCameraEffectGalleryDataProvider *_effectGalleryPrefetcher;
    ...
    IGLiveBroadcastLogger *_liveLogger;
    ...
    AVCaptureDevice *_ultraWideCaptureDevice;
    AVCaptureDevice *_activeCaptureDevice;
    _Bool _enableUltraWideCapture;
    _Bool _switchingCaptureDevice;
    unsigned long long _flipCount;
    IGCameraOpenPerfComponents *_perfComponents;
    NSDate *_qrCodeEffectIdWasScannedAt;
...
- (void)_animateCameraFlip:(_Bool)arg1;
...
- (long long)storyCameraOverlayViewControllerShoppingBagButtonAppearance:(id)arg1;
...
- (id)storyCameraOverlayViewController:(id)arg1 modelForSavedAREffectTrayItemAtIndex:(long long)arg2;
...
- (void)storyCameraOverlayViewController:(id)arg1 didToggleBoomerangButtonToMode:(id)arg2;
...
- (_Bool)_hasRecentlyScannedQRCodeCameraEffect;
...
- (_Bool)_cameraModeCanDisplayOverlayGrid:(long long)arg1;
- (void)_prefetchEffectGalleryIfNeeded;
...
- (void)liveMainViewControllerDidFinishSession:(id)arg1 afterSuccessfulBroadcasting:(_Bool)arg2 shouldAnimatePostToFeed:(_Bool)arg3 sharedToIGTV:(_Bool)arg4;
...
- (void)_cleanUpLiveViewController:(id)arg1 afterSuccessfulBroadcasting:(_Bool)arg2 shouldAnimatePostToFeed:(_Bool)arg3 sharedToIGTV:(_Bool)arg4;
...
- (void)_tryBeginRecordingWithAudioEnabled:(_Bool)arg1 captureDevices:(id)arg2;
...
- (void)_handleMulticamFormatTap:(id)arg1;
- (void)_handleHandsfreeFormatTap:(id)arg1;
- (void)_handleSuperzoomFormatTap:(id)arg1;
- (void)_handleLayoutFormatTap:(id)arg1;
- (void)_handleBoomerangFormatTap:(id)arg1;
- (void)_handleCreateFormatTap:(id)arg1;
- (id)toolsMenu;
...
- (id)initWithUserSession:(id)arg1 configuration:(id)arg2 initialCameraTargetModel:(id)arg3 initialCapturePosition:(long long)arg4 presentationStyle:(long long)arg5 showAspectFitPreview:(_Bool)arg6 cameraLoggingContext:(id)arg7;
