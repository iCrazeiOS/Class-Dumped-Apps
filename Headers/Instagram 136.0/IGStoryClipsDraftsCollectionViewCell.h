...
@class IGAsyncTask, IGGallerySelectionBadge, IGGradientView, UIImageView, UILabel, UIView;

@interface IGStoryClipsDraftsCollectionViewCell : UICollectionViewCell
{
...
@property(retain, nonatomic) IGAsyncTask *imageTask; // @synthesize imageTask=_imageTask;
- (void).cxx_destruct;
