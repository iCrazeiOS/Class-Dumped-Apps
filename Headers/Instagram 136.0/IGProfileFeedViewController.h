...
@class FBKVOController, IGCTAPresenterContext, IGFeedItemToggleComponents, IGFeedPreviewingHandler, IGFeedStarterKit, IGProfileFeedSource, IGProfileNavigationPerfComponents, IGUser, IGUserSession, NSString;
@protocol IGProfileFeedViewControllerDelegate;

@interface IGProfileFeedViewController : IGViewController <IGFeedNetworkSourceDelegate, IGFeedPreviewingType, IGFeedScrollViewListener, IGFeedStatusViewDelegate, IGMediaThumbnailSectionControllerSelectionDelegate, IGRefreshControlContentInsetDataSource, UICollectionViewDelegate, IGFeedItemPreviewProviding, IGListAdapterDataSource, IGProfileTabViewController>
{
