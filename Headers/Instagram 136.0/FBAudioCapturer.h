...
@protocol FBAudioBufferHandler, FBCaptureSessionRuntimeErrorDelegate, FBCaptureSessionStateDelegate, FBSystemAudioCaptureSessionInteracting, OS_dispatch_queue;

@interface FBAudioCapturer : NSObject <FBSystemAudioCaptureSessionInteractingDelegate, AVCaptureAudioDataOutputSampleBufferDelegate, FBAudioCapturerProtocol>
{
...
- (void)dealloc;
- (id)initWithBufferHandler:(id)arg1 sessionQueue:(id)arg2 systemAudioCaptureSessionInteractor:(id)arg3 ignoreRTCClientNotification:(_Bool)arg4 automaticallyConfiguresApplicationAudioSession:(_Bool)arg5 enableEchoCancellation:(_Bool)arg6;
