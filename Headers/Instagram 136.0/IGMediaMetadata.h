...
@class IGEditsMetadata, IGHashtagsMetadata, IGLocationMetadata, IGStoryUploadMetadata, IGTagsMetadata, IGVideoInfo, IGVideoMetadata, NSArray, NSDate, NSDictionary, NSMutableOrderedSet, NSSet, NSString, UIImage;
...
@property(readonly, nonatomic) IGHashtagsMetadata *hashtagsMetadata; // @synthesize hashtagsMetadata=_hashtagsMetadata;
...
- (id)initWithCameraEffectID:(id)arg1 cameraPosition:(long long)arg2 captureType:(id)arg3 persistedMetadata:(id)arg4;
