...
@class IGSundialViewerVideoCell, IGUser, NSString;
...
- (void)sundialViewerVideoCell:(IGSundialViewerVideoCell *)arg1 didReceiveLike:(_Bool)arg2 withDoubleTap:(_Bool)arg3;
