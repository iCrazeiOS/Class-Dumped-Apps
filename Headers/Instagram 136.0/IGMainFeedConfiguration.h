...
@class IGDefaultFeedConfiguration, IGFeedConsumptionTracker, IGSponsoredSupportConfiguration, IGUserSession, NSString;
...
- (id)initWithFeedConsumptionTracker:(id)arg1 analyticsModule:(id)arg2 sponsoredSupportConfiguration:(id)arg3 userSession:(id)arg4;
