...
- (void)_handleDecodeResult:(int)arg1 imageBuffer:(struct __CVBuffer *)arg2 frameIndex:(unsigned long long)arg3 presentationTimeStamp:(CDStruct_1b6d18a9)arg4 presentationDuration:(CDStruct_1b6d18a9)arg5 frameFixResult:(id)arg6;
- (int)_decodeFrame:(struct opaqueCMSampleBuffer *)arg1 index:(unsigned long long)arg2 fixResult:(id)arg3;
