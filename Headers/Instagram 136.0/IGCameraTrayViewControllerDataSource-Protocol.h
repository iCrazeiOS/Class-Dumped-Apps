...
@class IGCameraTrayViewController, NSAttributedString, NSString, NSURL, UIImage;
...
- (NSAttributedString *)cameraTrayViewController:(IGCameraTrayViewController *)arg1 attributedTitleForItemAtIndex:(long long)arg2;
- (NSString *)cameraTrayViewController:(IGCameraTrayViewController *)arg1 titleForItemAtIndex:(long long)arg2;
