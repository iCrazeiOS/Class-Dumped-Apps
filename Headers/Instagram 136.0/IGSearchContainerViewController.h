...
@class IGKeyboardObserver, IGSearchAnalyticsLogger, IGSearchNavigationPerfComponents, IGSearchSession, IGUserSession, IGViewController, NSString, UIColor;
...
@interface IGSearchContainerViewController : IGTabPageViewController <IGFriendStatusChangedListener, IGSearchViewControllerDelegate, IGTabPageViewControllerDelegate, IGKeyboardObserverShowDelegate, IGUserBlockingActionListener>
{
    ...
    IGViewController<IGSearchResultsViewControllerType> *_keywordsSearchViewController;
...
- (id)initWithUserSession:(id)arg1 tabBackgroundColor:(id)arg2;
