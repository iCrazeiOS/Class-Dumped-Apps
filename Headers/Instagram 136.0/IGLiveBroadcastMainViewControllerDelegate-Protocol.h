...
- (void)liveMainViewControllerDidFinishSession:(IGLiveBroadcastMainViewController *)arg1 afterSuccessfulBroadcasting:(_Bool)arg2 shouldAnimatePostToFeed:(_Bool)arg3 sharedToIGTV:(_Bool)arg4;
