...
@class IGFeedItem, IGFeedItemPhotoCellConfiguration, IGFeedPhotoView, IGPhotoIndicatorView, IGZoomController, NSString, UILongPressGestureRecognizer;
@protocol IGFeedItemPhotoCellDelegate, IGZoomControllerZoomingDelegate;

@interface IGFeedItemPhotoCell : IGFeedItemMediaCell <IGFeedMediaViewDelegate, IGFeedPhotoViewDelegate, IGZoomControllerLoadingDelegate, IGSaveToCollectionsUpsellable>
{
    IGPhotoIndicatorView *_indicatorView;
    IGFeedItemPhotoCellConfiguration *_configuration;
