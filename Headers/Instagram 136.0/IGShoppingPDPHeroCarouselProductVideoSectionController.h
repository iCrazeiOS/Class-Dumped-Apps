...
#import <InstagramAppCoreFramework/IGShoppingPDPProductMediaViewerViewControllerDelegate-Protocol.h>
#import <InstagramAppCoreFramework/IGZoomLoggerProtocol-Protocol.h>

@class IGFNFVideoPlayer, IGMediaPreloader, IGShoppingConsumptionFeedItemLogger, IGShoppingPDPHeroCarouselMediaZoomController, IGShoppingPDPHeroCarouselProductVideoViewModel, IGShoppingPDPProductMediaViewerAnimationController, IGUserSession, IGZoomViewPresenter, NSMutableDictionary, NSString;
@protocol IGShoppingPDPHeroCarouselProductVideoSectionControllerDelegate;

@interface IGShoppingPDPHeroCarouselProductVideoSectionController : IGListSectionController <IGFNFVideoPlayerDelegate, IGListWorkingRangeDelegate, IGShoppingPDPHeroCarouselMediaCellDelegate, IGShoppingPDPProductMediaViewerViewControllerDelegate, IGZoomLoggerProtocol>
{
...
- (void)_preloadMedia;
- (id)_visibleCell;
- (void)viewWillDisappearWithVideoPlayer:(id)arg1;
...
- (void)dealloc;
- (id)initWithUserSession:(id)arg1 animationStyle:(long long)arg2 logger:(id)arg3;
