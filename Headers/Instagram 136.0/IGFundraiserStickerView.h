...
@interface IGFundraiserStickerView : UIView <UITextViewDelegate, IGConstrainedSizeStickerViewType, IGUnpinnableStickerViewType, IGTappableStickerViewType>
{
    ...
    _Bool _showNewStickerDesign;
    _Bool _overrideColorsForNewDesign;
...
- (void)layoutSubviews;
- (void)_defaultInitWithModel:(id)arg1 showNewStickerDesign:(_Bool)arg2;
- (id)initConsumptionWithStickerModel:(id)arg1 showNewStickerDesign:(_Bool)arg2;
- (id)initCreationWithStickerModel:(id)arg1 showNewStickerDesign:(_Bool)arg2;
