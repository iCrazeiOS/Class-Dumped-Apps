...
@class IGFeedScrollViewAnnouncer, IGListAdapter, IGSessionTracker, IGShoppingConsumptionFeedItemLogger, IGShoppingDirectoryFollowedShopsDataModel, IGShoppingDirectorySuggestedShopsDataModel, IGShoppingFeedNetworker, IGUserSession, NSString, UICollectionView;
...
@interface IGShoppingDirectoryViewController : IGViewController <IGDiscoverPeopleSectionControllerDelegate, IGFeedScrollViewListener, IGListAdapterDataSource, IGShoppingSessionTracking>
{
    ...
    IGShoppingFeedNetworker *_suggestedShopsNetworker;
