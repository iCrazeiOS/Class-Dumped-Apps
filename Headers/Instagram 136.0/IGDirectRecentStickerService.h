...
@class IGDirectRecentStickerMemoryDataStore, IGObjectDiskStorage, NSArray, NSString;
@protocol IGDirectRecentStickerListenerAnnouncer;
...
@interface IGDirectRecentStickerService : NSObject <IGUserSessionObject>
{
    ...
    id <IGDirectRecentStickerListenerAnnouncer> _announcer;
