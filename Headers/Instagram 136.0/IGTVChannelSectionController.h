...
@protocol IGTVChannelSectionControllerDelegate, IGTVHScrollLoggingContextType;

@interface IGTVChannelSectionController : IGListGenericSectionController <IGTVFeedTrayThumbnailSectionControllerDelegate, IGTVHorizontalChannelListControllerDelegate>
{
    ...
    id <IGTVChannelSectionControllerDelegate> _delegate;
}

@property(nonatomic) __weak id <IGTVChannelSectionControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
