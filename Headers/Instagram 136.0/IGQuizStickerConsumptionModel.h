...
- (id)diffIdentifier;
- (id)initWithPk:(id)arg1 question:(id)arg2 options:(id)arg3 correctAnswerIndex:(id)arg4 textColor:(id)arg5 startBackgroundColor:(id)arg6 endBackgroundColor:(id)arg7 viewerCanAnswer:(_Bool)arg8 viewerAnswer:(id)arg9 isSharedResult:(_Bool)arg10;
