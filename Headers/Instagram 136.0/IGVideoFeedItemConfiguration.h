...
- (id)initWithUserSession:(id)arg1 feedTheme:(id)arg2 followButtonEnabled:(_Bool)arg3 showExploreContext:(_Bool)arg4 hideTimestamps:(_Bool)arg5 hideLikersRow:(_Bool)arg6 followControllerContextString:(id)arg7;
