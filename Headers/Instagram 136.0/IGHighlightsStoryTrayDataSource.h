...
@interface IGHighlightsStoryTrayDataSource : NSObject <IGStorySharePostListener, IGMediaHiddenListener, IGMediaDeletedListener, IGStoryTrayDataSource, IGStoryTrayEditableDataSource, IGListDiffable, IGUserSessionObject, IGStoryTrayLoggingContextDataSource>
{
    NSString *_userPK;
...
- (void)fetch;
- (id)initWithUserPK:(id)arg1 userSession:(id)arg2 allowCaching:(_Bool)arg3 legacyDiskPaths:(id)arg4 diskManager:(id)arg5;
