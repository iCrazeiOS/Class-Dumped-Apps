...
@class IGChainingFeedViewController, IGFeedItem;
...
- (void)chainingFeedViewController:(IGChainingFeedViewController *)arg1 didObserveFocusChangeToSection:(long long)arg2 focusedItem:(IGFeedItem *)arg3;
@end
