...
@interface IGCameraLogger : NSObject <IGUserSessionObject>
{
...
- (void)logBlacklistCrossPostOptionsCancelled;
- (void)logBlacklistCrossPostOptionsChanged:(_Bool)arg1 permanency:(_Bool)arg2;
- (void)logBlacklistCrossPostOptionsOpened;
- (void)logTapBlacklistCrossPostToggle:(long long)arg1 startState:(_Bool)arg2 endState:(_Bool)arg3;
- (void)logBlacklistDidTapSearch:(long long)arg1;
- (void)logMutatedBlacklistDidAdd:(_Bool)arg1 userIdentifier:(id)arg2 userIndex:(unsigned long long)arg3 isFromSearch:(_Bool)arg4 searchText:(id)arg5 blacklistType:(long long)arg6;
- (void)logCloseBlacklist:(long long)arg1 crossPostEligible:(_Bool)arg2 crossPostEnabled:(_Bool)arg3 selectedUserIdentifiers:(id)arg4;
- (void)logOpenBlacklistWithEntryPoint:(long long)arg1 blacklistType:(long long)arg2 isXpostEligible:(_Bool)arg3;
...
- (long long)currentCameraCaptureType;
