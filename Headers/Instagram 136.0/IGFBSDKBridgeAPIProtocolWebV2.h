...
#import <FBSharedFramework/IGFBSDKBridgeAPIProtocol-Protocol.h>

@class IGFBSDKBridgeAPIProtocolNativeV1, NSString;

@interface IGFBSDKBridgeAPIProtocolWebV2 : NSObject <IGFBSDKBridgeAPIProtocol>
{
    IGFBSDKBridgeAPIProtocolNativeV1 *_nativeProtocol;
}
