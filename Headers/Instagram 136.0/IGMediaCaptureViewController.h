...
#import <InstagramAppCoreFramework/IGFeedCameraViewControllerDelegate-Protocol.h>
...
@interface IGMediaCaptureViewController : IGViewController <UIScrollViewDelegate, IGCaptureControllerDelegate, IGFeedCameraViewControllerDelegate, IGMediaLibraryViewControllerDelegate, IGMediaLibraryViewControllerOffsetDelegate, IGMediaLibraryViewControllerSelectAlbumDelegate, IGMedialibraryViewControllerSetAssetDelegate, IGMediaLibraryViewControllerCameraDelegate, IGMediaCropperViewControllerDelegate, IGVideoShareToViewControllerDelegate>
{
    ...
    IGFeedCameraViewController *_cameraViewController;
...
@property(retain, nonatomic) IGFeedCameraViewController *cameraViewController; // @synthesize cameraViewController=_cameraViewController;
...
- (void)feedCameraViewControllerDidTapClose:(id)arg1;
- (void)feedCameraViewController:(id)arg1 didCaptureWithPreviewImage:(id)arg2 assetFetchRequest:(id)arg3 isVideo:(_Bool)arg4;
