...
@class IGBoostPostLogger, IGListAdapter, IGPromoteDataStore, IGPromoteEducationPresenter, IGPromoteHeaderViewModel, IGPromoteListWithDrawerView, IGUserSession, NSMutableArray, NSString;
@protocol IGPromoteDestinationViewControllerDelegate;

@interface IGPromoteDestinationViewController : IGPromoteViewController <IGListAdapterDataSource, UICollectionViewDelegate, IGPromoteRadioButtonListSectionControllerDelegate, IGPromoteEducationDrawerRowViewDelegate, IGPromoteEducationDrawerViewDelegate>
{
...
@property(copy, nonatomic) NSMutableArray *radioButtonViewModels; // @synthesize radioButtonViewModels=_radioButtonViewModels;
...
- (void)_onQuickPromoteCancelBarButtonTapped;
