...
@property(readonly, copy, nonatomic) NSArray *consumptionActionItems; // @synthesize consumptionActionItems=_consumptionActionItems;
...
- (id)diffIdentifier;
- (id)initWithPk:(id)arg1 title:(id)arg2 titleColor:(id)arg3 subtitleColor:(id)arg4 startBackgroundColor:(id)arg5 endBackgroundColor:(id)arg6 buttonTextColor:(id)arg7 businessProfileID:(id)arg8 user:(id)arg9 consumptionActionItems:(id)arg10 originalSubtitleHeight:(id)arg11;
