...
@protocol IGDiscoverySectionLoggingProvider, IGGridItemPositionProvider, IGHashtagListKitDataSourceDelegate;
...
- (id)initWithUserSession:(id)arg1 layoutConfig:(struct IGGridLayoutConfiguration)arg2 playbackCoordinator:(id)arg3 loggingProvider:(id)arg4 gridPositionProvider:(id)arg5 delegate:(id)arg6 attribution:(id)arg7;
