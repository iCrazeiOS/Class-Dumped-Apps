...
@class IGDirectAudioMessagePlaybackService, IGDirectAudioMessageViewModel, IGDirectPublishedMessageMetadata, NSString;
...
@interface IGDirectAudioMessageSectionController : IGDirectMessageSectionController <IGDirectAudioMessagePlaybackServiceListener, IGDirectAudioMessageCellSeekGestureDelegate>
{
    ...
    IGDirectPublishedMessageMetadata *_publishedMessageMetadata;
}
