...
#import <FBSharedFramework/RCTReloadListener-Protocol.h>

@class NSArray, NSDictionary, NSLock, NSString, NSURL, RCTAccessibilityManager, RCTDevMenu, RCTDevSettings, RCTPerformanceLogger, RCTRedBox, RCTUIManager;
