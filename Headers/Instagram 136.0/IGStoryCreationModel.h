...
@class IGMultiUploadMetadata, IGStoryCameraFormatModel, IGStoryCreationAttributionModel, IGStoryCreationEditsModel, IGStoryCreationHighlightConfig, IGStoryOriginalSoundInfo, IGStoryTapModelArray, NSArray, NSDate, NSDictionary, NSMutableOrderedSet, NSSet, NSString;
...
@property(retain, nonatomic) NSArray *blacklistedUserIDs; // @synthesize blacklistedUserIDs=_blacklistedUserIDs;
