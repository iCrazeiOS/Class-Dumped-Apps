...
@class IGAuthenticator, IGFacebookAuthHelper, IGFacebookInfoFetcher, IGNUXLayoutSpec, NSString;
...
- (void).cxx_destruct;
- (id)initWithNetworker:(id)arg1 layoutSpec:(id)arg2 title:(id)arg3 tryLoginWhenPossible:(_Bool)arg4 authenticator:(id)arg5 fbInfoFetcher:(id)arg6 fbAuthHelper:(id)arg7 isSwitchingUsers:(_Bool)arg8 isSACFlow:(_Bool)arg9;
