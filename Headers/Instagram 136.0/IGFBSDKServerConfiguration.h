...
#import <FBSharedFramework/IGFBSDKCopying-Protocol.h>
#import <FBSharedFramework/NSSecureCoding-Protocol.h>

@class IGFBSDKErrorConfiguration, NSArray, NSDate, NSDictionary, NSString, NSURL;

@interface IGFBSDKServerConfiguration : NSObject <IGFBSDKCopying, NSSecureCoding>
{
    ...
    IGFBSDKErrorConfiguration *_errorConfiguration;
...
@property(readonly, nonatomic) IGFBSDKErrorConfiguration *errorConfiguration; // @synthesize errorConfiguration=_errorConfiguration;
