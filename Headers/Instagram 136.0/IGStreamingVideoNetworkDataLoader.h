...
- (id)extracted;
- (id)initWithRequest:(id)arg1 requestBehavior:(unsigned long long)arg2 diskCache:(id)arg3 queue:(id)arg4 videoRequestTracker:(id)arg5 competingNetworkRequestTracker:(id)arg6 isTollFreeRequest:(_Bool)arg7 delegate:(id)arg8;
