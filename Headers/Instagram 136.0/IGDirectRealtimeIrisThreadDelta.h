...
@class IGDirectPublishedMessageContentMutation, IGDirectThreadMetadata, IGDirectThreadMetadataUpdate, NSDate, NSDictionary, NSString;
...
+ (id)markSeenWithUserId:(id)arg1 messageId:(id)arg2 timestamp:(id)arg3;
