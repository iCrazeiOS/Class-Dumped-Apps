...
@class IGFeedItem, IGInsightsAdapterDataSource, IGInsightsGraphQLDataFetcher, IGInsightsLogger, IGInsightsLoggingData, IGInsightsPerfLogger, IGInsightsPostInsightsData, IGInsightsPostInsightsViewModelGenerator, IGListAdapter, IGUserSession, NSDate, NSString, UICollectionView, UIViewController;
