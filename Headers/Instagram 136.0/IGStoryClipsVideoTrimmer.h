...
@class AVAsset, IGVideoTimelineView, NSString;
@protocol IGStoryClipsVideoTrimmerDelegate;

@interface IGStoryClipsVideoTrimmer : UIView <IGVideoTimelineViewDelegate>
{
    IGVideoTimelineView *_timelineView;
    id <IGStoryClipsVideoTrimmerDelegate> _delegate;
    AVAsset *_asset;
...
@property(nonatomic) __weak id <IGStoryClipsVideoTrimmerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
