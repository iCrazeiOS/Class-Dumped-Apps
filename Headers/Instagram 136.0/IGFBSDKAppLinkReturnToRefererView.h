...
@class IGFBSDKAppLink, UIButton, UIColor, UILabel, UITapGestureRecognizer;
@protocol IGFBSDKAppLinkReturnToRefererViewDelegate;

@interface IGFBSDKAppLinkReturnToRefererView : UIView
{
    _Bool _explicitlyHidden;
    _Bool _closed;
    id <IGFBSDKAppLinkReturnToRefererViewDelegate> _delegate;
    UIColor *_textColor;
    IGFBSDKAppLink *_refererAppLink;
...
@property(retain, nonatomic) IGFBSDKAppLink *refererAppLink; // @synthesize refererAppLink=_refererAppLink;
@property(retain, nonatomic) UIColor *textColor; // @synthesize textColor=_textColor;
@property(nonatomic) __weak id <IGFBSDKAppLinkReturnToRefererViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)updateHidden;
