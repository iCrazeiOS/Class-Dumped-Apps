...
#import <FBSharedFramework/IGFBSDKURLOpening-Protocol.h>

@class IGFBSDKKeychainStore, IGFBSDKLoginManagerLogger, NSSet, NSString, UIViewController;

@interface IGFBSDKLoginManager : NSObject <IGFBSDKURLOpening>
{
    CDUnknownBlockType _handler;
    IGFBSDKLoginManagerLogger *_logger;
    long long _state;
