...
@class IGDirectKey, IGDirectMessageActionsBarViewController, IGDirectMessageReactionSelectionViewController, IGDirectThreadAnalyticsLogger, IGKeyboardObserver, IGUserSession, IGViewController, NSMutableArray, NSString;
@protocol IGDirectMessageMenuActionHandling, IGDirectMessageMenuControllerDelegate;

@interface IGDirectMessageMenuController : NSObject <IGDirectMessageReactionSelectionDelegate, IGDirectSaveMediaDelegate, IGDirectMessageMenuActionHandlerDelegate, IGDirectMessageActionsBarDelegate, IGKeyboardObserverHideDelegate, IGKeyboardObserverShowDelegate, IGDirectMessageMenuItemTarget>
{
...
- (void)menuActionHandler:(id)arg1 didTapReplyToMessage:(id)arg2;
...
- (void)messageReactionSelectionViewControllerWillPresentEmojiPickerTray:(id)arg1;
- (void)messageReactionSelectionViewControllerDidTapOrPanBackgroundOverlay:(id)arg1;
- (void)messageReactionSelectionViewController:(id)arg1 didToggleEmoji:(id)arg2;
...
- (void)_incrementReactionsActivationCounter;
