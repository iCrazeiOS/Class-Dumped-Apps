...
- (id)initRequestWithTreeShapeId:(id)arg1 fieldSetId:(unsigned int)arg2 queryParams:(id)arg3 requestType:(unsigned long long)arg4 schemaType:(unsigned long long)arg5 useDjangoProxy:(_Bool)arg6 ignoreNonCriticalErrors:(_Bool)arg7 vcPolicy:(id)arg8 parser:(id)arg9 cachePolicy:(id)arg10 successHandler:(CDUnknownBlockType)arg11 failHandler:(CDUnknownBlockType)arg12;
