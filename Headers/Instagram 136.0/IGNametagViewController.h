...
@class IGLabel, IGListAdapter, IGNametagBackgroundDataSource, IGNametagLoggingContext, IGNametagNUXViewController, IGNametagView, IGNametagViewConfiguration, IGTapButton, IGUser, IGUserSession, NSArray, NSString, UIBarButtonItem, UICollectionView, UINavigationBar, UIPageControl, UIPanGestureRecognizer, UIToolbar, UIView;
...
@interface IGNametagViewController : UIViewController <IGListAdapterDataSource, IGNametagBackgroundCellDelegate, IGNametagSelfieBackgroundCellDelegate, UICollectionViewDelegate, UIScrollViewDelegate, IGNametagNUXViewControllerDelegate>
{
    ...
    UIPanGestureRecognizer *_cardPanGestureRecognizer;
    _Bool _showNUX;
    _Bool _shouldShowQRCode;
    unsigned long long _cardMode;
    double _cardRotationCount;
...
- (void)_handleCardPanGesture:(id)arg1;
- (void)_didTapNametagView:(id)arg1;
- (void)_updateCardModeIfNeededForRotationCount:(double)arg1;
- (void)_updateCardRotationCount:(double)arg1 velocity:(double)arg2 animated:(_Bool)arg3;
