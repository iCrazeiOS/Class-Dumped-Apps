...
@class IGActionableConfirmationToastController, IGDiscoveryGridItem, IGListAdapter, IGSessionTracker, IGUserSession, NSString;
@protocol IGShoppingDestinationProductPivotsCarouselLoggingProviderType;

@interface IGShoppingDestinationProductPivotsCarouselSectionController : IGListSectionController <IGListAdapterDataSource, IGSaveStatusListener, IGShoppingBasicProductFeedViewControllerDelegate, IGShoppingProductPivotsCellDelegate, IGShoppingProductWithContextCardSectionControllerDelegate>
{
