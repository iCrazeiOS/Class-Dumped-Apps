...
@class IGFeedNetworkSource, IGSingleFeedConfiguration, IGStoryViewerPresentationController, IGUserSession, NSString, UIView, UIViewController;
...
- (void)navigateToStoryCreationWithViewController:(id)arg1;
