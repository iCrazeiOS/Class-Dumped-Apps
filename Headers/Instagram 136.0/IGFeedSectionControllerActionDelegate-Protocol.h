...
@class IGFeedItem, IGHashtagModel, IGListSectionController, IGUser, NSString, UIView;
@protocol IGFeedSectionControllerType;

@protocol IGFeedSectionControllerActionDelegate <NSObject>
- (void)feedSectionController:(IGListSectionController<IGFeedSectionControllerType> *)arg1 showDetailsForFeedItem:(IGFeedItem *)arg2;
