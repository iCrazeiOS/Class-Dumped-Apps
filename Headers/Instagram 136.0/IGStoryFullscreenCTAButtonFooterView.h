...
@interface IGStoryFullscreenCTAButtonFooterView : UIView <IGDirectComposerButtonDelegate, IGDirectComposerTextListener>
{
    ...
    _Bool _shouldShowHollowButtonBackground;
    _Bool _shouldDwellHollowButton;
...
@property(nonatomic) _Bool shouldDwellHollowButton; // @synthesize shouldDwellHollowButton=_shouldDwellHollowButton;
@property(nonatomic) _Bool shouldShowHollowButtonBackground; // @synthesize shouldShowHollowButtonBackground=_shouldShowHollowButtonBackground;
