...
+ (void)initialize;
+ (id)groupStoriesShareTargetViewModelWithDirectShareRecipent:(id)arg1 oneTapStateTracker:(id)arg2 sectionType:(long long)arg3 backgroundColor:(id)arg4 module:(id)arg5;
