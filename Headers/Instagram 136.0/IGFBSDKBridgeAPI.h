...
#import <FBSharedFramework/IGFBSDKApplicationObserving-Protocol.h>
#import <FBSharedFramework/IGFBSDKContainerViewControllerDelegate-Protocol.h>

@class IGFBSDKBridgeAPIRequest, NSString, UIViewController;
@protocol IGFBSDKAuthenticationSession, IGFBSDKURLOpening;

@interface IGFBSDKBridgeAPI : NSObject <IGFBSDKApplicationObserving, IGFBSDKContainerViewControllerDelegate, ASWebAuthenticationPresentationContextProviding>
{
    IGFBSDKBridgeAPIRequest *_pendingRequest;
    CDUnknownBlockType _pendingRequestCompletionBlock;
    id <IGFBSDKURLOpening> _pendingURLOpen;
    id <IGFBSDKAuthenticationSession> _authenticationSession;
