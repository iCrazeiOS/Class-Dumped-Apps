...
+ (double)preferredHeightWithWidth:(double)arg1 title:(id)arg2 titleFont:(id)arg3 subtitle:(id)arg4 showFollowButton:(_Bool)arg5 followButtonState:(long long)arg6;
...
- (void)layoutSubviews;
- (void)configureWithMerchant:(id)arg1 userSession:(id)arg2 title:(id)arg3 titleFont:(id)arg4 subtitle:(id)arg5 showFollowButton:(_Bool)arg6 analyticsModule:(id)arg7;
