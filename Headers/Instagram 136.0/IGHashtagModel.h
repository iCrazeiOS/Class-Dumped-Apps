...
- (id)initWithTagName:(id)arg1 mediaCount:(id)arg2 pk:(id)arg3 profilePicURL:(id)arg4 isNonViolating:(_Bool)arg5 debugInfo:(id)arg6 isChallenge:(_Bool)arg7 challengeId:(id)arg8 followRestricted:(_Bool)arg9;
