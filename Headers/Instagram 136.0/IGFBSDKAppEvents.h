...
@class IGFBSDKAppEventsState, IGFBSDKServerConfiguration, NSString;
@protocol OS_dispatch_source;

@interface IGFBSDKAppEvents : NSObject
{
    _Bool _explicitEventsLoggedYet;
    IGFBSDKServerConfiguration *_serverConfiguration;
    IGFBSDKAppEventsState *_appEventsState;
    NSString *_userID;
    _Bool _isUnityInit;
    _Bool _disableTimer;
