...
@protocol IGDirectRecipientListViewControllerCollapsibleSectionDelegate, IGDirectRecipientListViewControllerDelegate, IGDirectRecipientListViewControllerPresentationDelegate;
...
@property(nonatomic) __weak id <IGDirectRecipientListViewControllerCollapsibleSectionDelegate> collapsibleSectionDelegate;
