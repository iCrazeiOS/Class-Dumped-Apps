...
- (id)diffIdentifier;
- (id)initWithPk:(id)arg1 question:(id)arg2 options:(id)arg3 promotedOptions:(id)arg4 viewerVote:(id)arg5 viewerCanVote:(_Bool)arg6 isSharedResult:(_Bool)arg7 isFBSticker:(_Bool)arg8;
