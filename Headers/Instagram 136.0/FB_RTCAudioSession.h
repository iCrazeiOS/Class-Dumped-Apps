...
@interface FB_RTCAudioSession : NSObject <FB_RTCAudioSessionActivationDelegate>
{
    ...
    // Error parsing type: {AsyncInvoker="_vptr$MessageHandler"^^?"pending_invocations_"{atomic<int>="__a_"Ai}"invocation_complete_"{scoped_refptr<rtc::RefCountedObject<rtc::Event> >="ptr_"^{RefCountedObject<rtc::Event>}}"destroying_"{atomic<bool>="__a_"AB}}, name: _asyncInvoker
