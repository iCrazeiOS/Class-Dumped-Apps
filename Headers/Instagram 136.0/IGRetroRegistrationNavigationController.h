...
@interface IGRetroRegistrationNavigationController : IGNavigationController <IGOneTapLoginViewControllerDelegate, IGRetroRegistrationWelcomeViewControllerDelegate, IGRetroRegistrationLoginViewControllerDelegate, IGRetroRegistrationSignInHelperViewControllerDelegate, IGGDPRBlockViewControllerDelegate, IGRecoverCodeVerificationViewControllerDelegate, IGTwoFactorVerificationViewControllerDelegate, IGRegistrationFlowCoordinatorDelegate, IGMultipleUsersRecoverViewControllerDelegate, IGAgePickerBlockViewControllerDelegate>
{
    ...
    struct NSArray *_cachedPersistedAccounts;
...
- (void)_startDynamicRegistrationWithFbUserInfo:(id)arg1 flowStartsDirectlyFromMAS:(_Bool)arg2;
...
- (struct NSArray *)_accountsWithCurrentLoggedinAccountsFilteredOut:(struct NSArray *)arg1;
...
- (void)viewDidLoad;
- (id)initWithNetworker:(id)arg1 deviceSession:(id)arg2 userSwitchedFrom:(id)arg3 startRegistrationFlow:(_Bool)arg4 showOneTapLoginScreenIfPossible:(_Bool)arg5 hideFacebookButton:(_Bool)arg6 createMultipleAccounts:(_Bool)arg7 isLoggingOut:(_Bool)arg8 authenticator:(id)arg9 directAppConfig:(id)arg10 twoFactorInfo:(id)arg11;
