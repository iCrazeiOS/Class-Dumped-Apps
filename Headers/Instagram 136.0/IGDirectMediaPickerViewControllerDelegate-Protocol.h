...
@class IGDirectGalleryPreviewMedia, IGDirectMediaPickerViewController, IGDirectScrollingTabViewModel, IGFeedItem, NSArray;
...
- (void)mediaPickerViewController:(IGDirectMediaPickerViewController *)arg1 didSelectFeedItem:(IGFeedItem *)arg2;
@end
