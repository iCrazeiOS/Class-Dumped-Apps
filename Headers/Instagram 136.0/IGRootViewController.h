...
@class IGLRUCache, IGPartialModalSheetViewController, NSMapTable, NSMutableDictionary, NSString;
...
- (id)_createMainAppControllerWithUserSession:(id)arg1 mainAppSetupBlock:(CDUnknownBlockType)arg2;
...
- (void)showCacheableViewControllerForUserSession:(id)arg1 previousUser:(id)arg2 initializer:(CDUnknownBlockType)arg3 viewControllerUpdated:(CDUnknownBlockType)arg4 animationType:(long long)arg5;
