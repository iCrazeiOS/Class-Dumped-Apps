...
@class IGFBSDKAppLink, NSDictionary;

@interface IGFBSDKAppLinkNavigation : NSObject
{
    NSDictionary *_extras;
    NSDictionary *_appLinkData;
    IGFBSDKAppLink *_appLink;
}
...
@property(retain, nonatomic) IGFBSDKAppLink *appLink; // @synthesize appLink=_appLink;
