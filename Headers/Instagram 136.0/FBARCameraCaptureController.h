...
@class FBCameraAudioLevelListenerAnnouncer, FBCameraCaptureFrameDropQueuedAnnouncer, FBCameraCaptureManagingProducerPorts, FBCaptureDevice, FBCaptureDeviceStateController, FBCaptureManagerEventQueuedAnnouncer, FBCaptureManagerPOIDetectorEventQueuedAnnouncer, FBFramePerformanceTracker, FBMPSessionContext, FBTimer, NSArray, NSMutableDictionary, NSString;
@protocol FBCCAudioSessionHolder, FBCameraActionPerformanceLoggerProviding, FBCameraAnalyticsPayloadProviding, FBCameraCaptureManaging, FBCameraStartPerformanceLoggerProviding, FBCaptureAudioSessionControlling, FBCaptureVideoSessionControlling, FBMPProducerPort, FBOrientationTracking, FBSystemAudioCaptureSessionInteracting, OS_dispatch_queue;
...
- (void)dealloc;
- (id)initWithCameraConfiguration:(const struct FBCameraConfiguration *)arg1 orientationTracker:(id)arg2 eventAnnouncer:(id)arg3 frameDropAnnouncer:(id)arg4 poiDetectorAnnouncer:(id)arg5 cameraActionPerformanceLogger:(id)arg6 cameraStartPerformanceLogger:(id)arg7 framePerformanceTracker:(id)arg8 framePerformanceTrackerForWaterfall:(id)arg9 analyticsPayloadProvider:(id)arg10 systemAudioCaptureSessionInteractor:(id)arg11 ccAudioSessionHolder:(id)arg12;
