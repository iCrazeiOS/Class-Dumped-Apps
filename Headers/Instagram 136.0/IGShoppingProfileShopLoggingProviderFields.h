...
@class IGAnalyticsNavigationState, IGSessionTracker, NSString;
...
- (void).cxx_destruct;
- (id)initWithPriorModule:(id)arg1 priorSubmodule:(id)arg2 waterfallId:(id)arg3 navState:(id)arg4 shoppingSessionTracker:(id)arg5;
