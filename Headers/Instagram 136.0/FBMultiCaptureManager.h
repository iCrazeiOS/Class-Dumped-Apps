...
@class AVCaptureAudioDataOutput, AVCaptureDeviceInput, AVCaptureVideoPreviewLayer, FBAVAudioDataProducer, FBAVPOIDataProducer, FBAVVideoDataProducer, FBCameraAudioLevelListenerAnnouncer, FBCameraCaptureFrameDropQueuedAnnouncer, FBCameraCaptureManagingProducerPorts, FBCameraProductionDebugLogger, FBCaptureConnectionManager, FBCaptureDevice, FBCaptureDeviceStateController, FBCaptureLowLightDetector, FBCaptureManagerEventQueuedAnnouncer, FBCaptureManagerPOIDetectorEventQueuedAnnouncer, FBCapturePOIDetector, FBCaptureSession, FBFramePerformanceTracker, FBSystemCaptureDeviceObserver, NSArray, NSDictionary, NSString;
@protocol FBAudioCapturerProtocol><AVCaptureAudioDataOutputSampleBufferDelegate, FBCameraActionPerformanceLoggerProviding, FBCameraAnalyticsPayloadProviding, FBCameraStartPerformanceLoggerProviding, FBCaptureAudioSessionControlling, FBCaptureVideoSessionControlling, FBMPProducerPort, FBOrientationTracking, FBSystemAudioCaptureSessionInteracting, OS_dispatch_queue;

@interface FBMultiCaptureManager : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate, FBAudioBufferHandler, FBCaptureSessionStateDelegate, FBCaptureSessionRuntimeErrorDelegate, FBCaptureLowLightDetectorDelegate, FBCaptureVideoSessionControlling, FBCaptureAudioSessionControlling, FBCameraCaptureManaging>
{
...
- (void)_configureVideoDataOutputConnection;
...
- (void)dealloc;
- (id)initWithCameraConfiguration:(const struct FBCameraConfiguration *)arg1 orientationTracker:(id)arg2 eventAnnouncer:(id)arg3 frameDropAnnouncer:(id)arg4 poiDetectorAnnouncer:(id)arg5 captureSession:(id)arg6 cameraActionPerformanceLogger:(id)arg7 cameraStartPerformanceLogger:(id)arg8 framePerformanceTracker:(id)arg9 framePerformanceTrackerForWaterfall:(id)arg10 analyticsPayloadProvider:(id)arg11 producerPorts:(id)arg12 captureDeviceStateController:(id)arg13 systemAudioCaptureSessionInteractor:(id)arg14 ccAudioSessionHolder:(id)arg15;
