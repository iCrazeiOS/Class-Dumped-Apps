...
@class IGCameraEffectPreview, IGDirectMessageMetadata, IGDirectQuotedPublishedMessage, NSArray, NSString;

@interface IGDirectCameraEffectMessage : FBValueObject <IGDirectMessageProtocol, NSCopying, NSCoding>
{
