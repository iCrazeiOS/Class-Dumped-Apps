...
@class IGFeedItem, IGReel, IGStoryViewerPresentationAnimationController, IGStoryViewerPresentationControllerConfig, IGUserSession, NSArray, NSString, UIView, UIViewController;
@protocol IGStoryChainingProtocol, IGStoryViewerEntryView, IGStoryViewerPresentationControllerDelegate;
