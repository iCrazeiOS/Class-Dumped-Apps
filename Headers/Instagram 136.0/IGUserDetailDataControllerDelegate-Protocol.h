...
@class IGGenericMegaphone, IGUserDetailDataController, NSDictionary, NSError, NSString;
...
- (void)userDetailDataController:(IGUserDetailDataController *)arg1 didFetchUserAdditionalDetailsWithMegaphone:(IGGenericMegaphone *)arg2 checklistResponseDict:(NSDictionary *)arg3;
