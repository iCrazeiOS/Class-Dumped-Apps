...
#import <InstagramAppCoreFramework/IGStoryMusicStickerProtocol-Protocol.h>

@class IGSmallAlbumArtMusicStickerView, IGStoryMusicTrack, NSString, UIColor;

@interface IGStoryMusicSimpleStickerView : UIView <IGStoryMusicStickerProtocol>
{
    IGSmallAlbumArtMusicStickerView *_smallAlbumArtMusicStickerView;
