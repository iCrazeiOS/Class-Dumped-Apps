...
@class IGLabelItemViewModel, IGListAdapter, IGLiveBroadcastLogger, IGLiveQuestionSheetView, IGUserSession, NSString;
...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithUserSession:(id)arg1 logger:(id)arg2 isBroadcasting:(_Bool)arg3;
