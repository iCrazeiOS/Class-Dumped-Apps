...
@class IGFBSDKGraphRequest, NSDictionary;

@interface IGFBSDKGraphRequestMetadata : NSObject
{
    IGFBSDKGraphRequest *_request;
...
@property(retain, nonatomic) IGFBSDKGraphRequest *request; // @synthesize request=_request;
- (void).cxx_destruct;
- (id)description;
