...
@interface FNFSynchronousPlayer : NSObject <FNFPlayerDisplayEngineDelegate, FNFAssetEventListener>
{
    ...
    _Bool _shouldPreventNegativeAudioStartTime;
...
- (void)_audioEngineEnqueueCallback:(struct AudioTimeStamp)arg1 firstFramePts:(double)arg2 lastFramePts:(double)arg3;
- (_Bool)_readyToPlay;
- (void)_syncVolume;
...
- (void)play;
- (id)description;
- (id)initWithDisplayEngine:(id)arg1 config:(CDStruct_1b066cef)arg2 audioEngine:(id)arg3 audioDecoder:(id)arg4 clock:(id)arg5 runningQueue:(id)arg6 muted:(_Bool)arg7 asyncTimebase:(_Bool)arg8;
- (void)dealloc;
