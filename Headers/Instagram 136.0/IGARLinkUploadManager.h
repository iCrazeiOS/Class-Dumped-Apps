...
- (void).cxx_destruct;
- (void)_logCannotFindUserWithTimeTaken:(double)arg1 errorCode:(long long)arg2 fromCamera:(_Bool)arg3 username:(id)arg4;
- (void)_logDidFindUser:(id)arg1 timeElapse:(double)arg2 confidenceScore:(double)arg3 fromCamera:(_Bool)arg4;
