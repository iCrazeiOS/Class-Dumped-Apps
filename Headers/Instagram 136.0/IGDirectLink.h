...
@class IGDirectLinkContext, IGDirectMessageMetadata, IGDirectQuotedPublishedMessage, NSArray, NSString;
...
- (id)initWithMetadata:(id)arg1 text:(id)arg2 storageKey:(id)arg3 linkContext:(id)arg4 likers:(id)arg5 reactions:(id)arg6;
