...
@class IGDiscoveryGridDataStore, IGDiscoveryTopicModel, IGExploreNetworkFetchState, IGExploreNetworker, NSString;
...
- (id)initWithTopic:(id)arg1 userSession:(id)arg2 configuration:(CDStruct_3d581f42)arg3 sessionTracker:(id)arg4 networkResponse:(id)arg5;
