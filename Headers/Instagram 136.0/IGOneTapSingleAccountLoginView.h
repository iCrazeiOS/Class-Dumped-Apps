...
- (void)layoutSubviews;
- (id)initWithPersistedAccount:(id)arg1 loginButtonImage:(id)arg2 loginButtonTitle:(id)arg3 dismissButtonEnabled:(_Bool)arg4 refactorEnabled:(_Bool)arg5 termsViewEnabled:(_Bool)arg6 footerModel:(id)arg7 module:(id)arg8 isAYMHAccount:(_Bool)arg9;
