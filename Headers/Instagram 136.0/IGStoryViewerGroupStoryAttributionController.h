...
@class IGDirectShareRecipientReelOwner, IGFeedItem, IGUserSession, NSString;
...
- (id)initWithGroupOwner:(id)arg1 feedItem:(id)arg2 isDisabledAttributionType:(_Bool)arg3 userSession:(id)arg4 partialModalSheetListener:(id)arg5 sourceModule:(id)arg6;
