...
- (id)initWithStory:(id)arg1 reelId:(id)arg2 reelTypeString:(id)arg3 mentionedUsers:(id)arg4 locationTaggedUser:(id)arg5 brandedContentSponsors:(id)arg6 sponsorUser:(id)arg7 canRepost:(_Bool)arg8 shouldPersistInThread:(_Bool)arg9 countdownId:(id)arg10;
