...
@protocol IGShopppingPDPLightboxFeedItemSectionControllerDelegate;
...
@interface IGShoppingPDPLightboxFeedItemSectionController : IGListSectionController <IGFNFVideoPlayerDelegate, IGListDisplayDelegate, IGShoppingPDPLightboxMediaCellDelegate>
{
    ...
    id <IGShopppingPDPLightboxFeedItemSectionControllerDelegate> _delegate;
}

@property(nonatomic) __weak id <IGShopppingPDPLightboxFeedItemSectionControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
@property(readonly, nonatomic) NSString *mediaAuthorPk;
