...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithExperimentSet:(id)arg1 storyCameraFormatModelProvider:(id)arg2 captureCoordinator:(id)arg3 loggingContext:(id)arg4 coWatchLogger:(id)arg5 powderRoomFaceFiltersEnabled:(_Bool)arg6;
