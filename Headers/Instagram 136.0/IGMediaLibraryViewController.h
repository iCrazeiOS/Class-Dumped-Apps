...
@interface IGMediaLibraryViewController : IGViewController <IGDraftBrowserViewControllerDelegate, IGGridViewControllerDelegate, IGGridViewControllerScrollDelegate, IGMediaCropViewDelegate, IGSelectAlbumDelegate, IGMediaLibraryAlbumLoadExecutor>
{
...
- (void)viewDidLoad;
- (id)initWithComposition:(id)arg1 userSession:(id)arg2 assetSelectionMechanic:(struct IGAssetSelectionMechanic)arg3 assetFilterType:(unsigned long long)arg4 nonSquareEnabled:(_Bool)arg5 usesCircularCrop:(_Bool)arg6 draftsEnabled:(_Bool)arg7 manageDraftsEnabled:(_Bool)arg8 useFullscreenGridAndStaticNavBar:(_Bool)arg9 analyticsModule:(id)arg10;
