...
- (void).cxx_destruct;
- (id)_createSingleSegmentTranscoderWithOutputFileURL:(id)arg1 segmentDuration:(CDStruct_1b6d18a9)arg2 assetReader:(id)arg3 assetWriter:(id)arg4 error:(id *)arg5;
