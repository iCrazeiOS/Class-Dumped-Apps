...
- (void).cxx_destruct;
- (void)matchLocalImage:(CDUnknownBlockType)arg1 remoteImage:(CDUnknownBlockType)arg2 adaptiveRemoteImage:(CDUnknownBlockType)arg3 userInterfaceStyleDependentRemoteImage:(CDUnknownBlockType)arg4;
- (_Bool)matchBooleanLocalImage:(CDUnknownBlockType)arg1 remoteImage:(CDUnknownBlockType)arg2 adaptiveRemoteImage:(CDUnknownBlockType)arg3 userInterfaceStyleDependentRemoteImage:(CDUnknownBlockType)arg4;
