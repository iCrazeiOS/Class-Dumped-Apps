...
@interface IGAdRequestParams : FBIvarBasedEqualityObject
{
    ...
    NSString *_iGTVAdRequestParams_pageType;
...
+ (id)iGTVAdRequestParamsWithOrganicItemIds:(id)arg1 pageType:(id)arg2;
- (void).cxx_destruct;
- (void)matchIGTVAdRequestParams:(CDUnknownBlockType)arg1 storiesAdRequestParam:(CDUnknownBlockType)arg2;
