...
@class IGCountdownStickerListModel, IGCountdownStickerView, IGStoryCanvasToolbarConfig, IGStoryStickerContainerView, IGUserSession, NSString;
...
- (void)viewDidLoad;
- (id)initWithUserSession:(id)arg1 model:(id)arg2 contentInset:(struct UIEdgeInsets)arg3;
