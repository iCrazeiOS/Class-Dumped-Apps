...
@class IGFeedItem, IGSponsoredSupportConfiguration, IGUserSession;
...
- (id)initWithUserSession:(id)arg1 feedItem:(id)arg2 sponsoredInfoProvider:(id)arg3 sponsoredSupportConfiguration:(id)arg4;
