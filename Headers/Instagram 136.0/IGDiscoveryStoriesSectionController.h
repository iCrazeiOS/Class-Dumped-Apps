...
@class IGDiscoveryGridHiddenStateHelper, IGDiscoveryGridItem, IGDiscoveryReelChain, IGDiscoveryReelChainingDataSource, IGDiscoveryReelChainingNetworkSource, IGDiscoveryStoriesModel, IGDiscoveryTopicModel, IGPlaybackCoordinator, IGReel, IGStoryViewerPresentationController, IGUserSession, NSString;
...
@interface IGDiscoveryStoriesSectionController : IGListSectionController <IGDiscoveryGridHiddenStateHelperDelegate, IGStoryViewerPresentationControllerDelegate, IGStoryChainingListener, IGReelSeenStateStoreListener, IGFeedPreviewableSectionController>
{
...
- (void)storyViewPresentationControllerWillFinishOnMediaId:(id)arg1;
