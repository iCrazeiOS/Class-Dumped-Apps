...
@class IGBusinessToolAlertViewController, IGGroupedTableViewFooterView, IGTVCreationAnalyticsSession, IGUser, IGUserSession, NSString;
@protocol IGTVMetadataEditorAdvancedSettingsViewControllerDelegate;

@interface IGTVMetadataEditorAdvancedSettingsViewController : IGGroupedTableViewController <IGCoreTextLinkHandler, IGAddPartnerTaggingViewControllerDelegate>
{
...
- (void)viewDidLoad;
- (id)initWithUserSession:(id)arg1 creationAnalytics:(id)arg2 sponsorPartner:(id)arg3;
