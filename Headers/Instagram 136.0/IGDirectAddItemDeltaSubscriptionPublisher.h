...
@class NSString;
@protocol IGDirectDataSubscriptionPublishingDelegate, IGDirectRealtimeServiceListenerAnnouncer;
...
{
    id <IGDirectRealtimeServiceListenerAnnouncer> _realtimeServiceAnnouncer;
