...
#import <SpeedTestEngine/GADCustomEventInterstitialDelegate-Protocol.h>

@class GADAdRenderingMetadata, GADInterstitialAd, GADMediatedIntermission, GADServerTransaction, NSDictionary, NSString;
