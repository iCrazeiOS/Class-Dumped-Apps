...
{
    shared_ptr_d4f3a8aa _rrStreamingAnalytics;
}

@property(nonatomic) shared_ptr_d4f3a8aa rrStreamingAnalytics; // @synthesize rrStreamingAnalytics=_rrStreamingAnalytics;
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)stop;
