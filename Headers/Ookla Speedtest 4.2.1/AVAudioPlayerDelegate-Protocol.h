...
- (void)audioPlayerEndInterruption:(AVAudioPlayer *)arg1 withFlags:(long long)arg2;
- (void)audioPlayerEndInterruption:(AVAudioPlayer *)arg1 withOptions:(long long)arg2;
