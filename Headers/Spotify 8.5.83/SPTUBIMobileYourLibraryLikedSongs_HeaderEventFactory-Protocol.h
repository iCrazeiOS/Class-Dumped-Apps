...
@class NSString;
@protocol SPTUBIEventAbsoluteLocation, SPTUBIEventLocation, SPTUBIMobileYourLibraryLikedSongs_Header_AddSongsButtonEventFactory, SPTUBIMobileYourLibraryLikedSongs_Header_FilterAndSortEventFactory, SPTUBIMobileYourLibraryLikedSongs_Header_PlayButtonEventFactory;
