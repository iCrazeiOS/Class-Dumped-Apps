...
- (void)pushViewController:(id)arg1 url:(id)arg2 options:(long long)arg3 completion:(CDUnknownBlockType)arg4;
...
- (id)equivalentForViewController:(id)arg1 inViewControllerNavigationStack:(id)arg2 viewControllerURL:(id)arg3 useURIEquivalence:(_Bool)arg4 options:(long long)arg5;
- (_Bool)doesViewController:(id)arg1 haveSameURIAsController:(id)arg2 withNavigationURL:(id)arg3;
