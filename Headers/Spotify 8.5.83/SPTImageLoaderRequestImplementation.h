...
@class NSDate, NSString, NSURL, SPTDataLoader, SPTTimeMeasurementBuilder;
...
@interface SPTImageLoaderRequestImplementation : NSObject <SPTImageLoaderRequest, SPTImageLoaderRemoteCallback>
{
    ...
    SPTTimeMeasurementBuilder *_timeMeasurement;
...
@property(retain, nonatomic) SPTTimeMeasurementBuilder *timeMeasurement; // @synthesize timeMeasurement=_timeMeasurement;
- (_Bool)cancelled;
- (void)cancel;
- (void)load;
- (id)init;
