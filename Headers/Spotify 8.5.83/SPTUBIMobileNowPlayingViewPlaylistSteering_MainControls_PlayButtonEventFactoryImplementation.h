...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_PlayButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_PlayButtonEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_PlayButtonEventFactory>
{
    NSArray *_components;
