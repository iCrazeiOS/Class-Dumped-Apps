...
@class GLUEAccessoryIconButton, NSIndexPath, UITableViewCell, UIViewController;
...
@property(nonatomic, readonly) id <SPTPodcastEpisodeCellActionHandlerEpisodeProvider> episodeProvider;
