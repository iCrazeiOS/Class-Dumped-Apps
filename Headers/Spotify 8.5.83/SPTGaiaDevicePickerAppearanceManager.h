...
@protocol SPTAccountProductInformationController, SPTGaiaConnectManager;
...
- (id)activeDevice;
- (id)initWithConnectManager:(id)arg1 productInformationController:(id)arg2 localDevicePermissions:(id)arg3;
