...
#import "SPTUBIMobileContextMenu_QueueTrackPlayLaterItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_QueueTrackPlayLaterItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_QueueTrackPlayLaterItemEventFactory>
{
    NSArray *_components;
