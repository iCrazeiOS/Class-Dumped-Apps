...
#import "SPTUBIMobileHome_Shelf_SectionHeaderEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_Shelf_SectionHeaderEventFactoryImplementation : NSObject <SPTUBIMobileHome_Shelf_SectionHeaderEventFactory>
{
    NSArray *_components;
