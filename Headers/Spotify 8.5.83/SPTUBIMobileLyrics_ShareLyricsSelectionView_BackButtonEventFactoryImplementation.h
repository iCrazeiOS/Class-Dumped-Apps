...
#import "SPTUBIMobileLyrics_ShareLyricsSelectionView_BackButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileLyrics_ShareLyricsSelectionView_BackButtonEventFactoryImplementation : NSObject <SPTUBIMobileLyrics_ShareLyricsSelectionView_BackButtonEventFactory>
{
    NSArray *_components;
