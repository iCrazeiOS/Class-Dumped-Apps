...
@class NSArray, NSIndexPath, NSMapTable, NSString, NSURL, SPTNowPlayingLogger, SPTNowPlayingModel, SPTNowPlayingSkipLimitReachedMessageRequester;
...
@interface SPTNowPlayingContentLayerViewModel : NSObject <SPTNowPlayingModelObserver>
{
    ...
    NSURL *_currentTrackImageURL;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSURL *currentTrackImageURL; // @synthesize currentTrackImageURL=_currentTrackImageURL;
