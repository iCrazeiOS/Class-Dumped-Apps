...
#import "SPTUBIMobileLyrics_ShareLyricsSelectionView_NextButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileLyrics_ShareLyricsSelectionView_NextButtonEventFactoryImplementation : NSObject <SPTUBIMobileLyrics_ShareLyricsSelectionView_NextButtonEventFactory>
{
    NSArray *_components;
