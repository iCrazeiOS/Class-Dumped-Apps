...
@protocol SPTAuthController, SPTNetworkConnectivityController;

@interface SPTAuthCacheEnvironmentObserver : NSObject <SPTNetworkConnectivityControllerObserver>
{
...
- (id)initWithCache:(id)arg1 authController:(id)arg2 networkConnectivityController:(id)arg3 notificationCenter:(id)arg4;
