...
#import "SPTUBIPDTMobileContextMenu_BrowseQueueItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_BrowseQueueItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_BrowseQueueItemEventFactory>
{
    NSArray *_components;
