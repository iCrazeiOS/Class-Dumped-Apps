...
#import "SPTUBIMobileSocialListening_OutputModeSelectionDialog_ListenOnOwnDeviceRadioButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListening_OutputModeSelectionDialog_ListenOnOwnDeviceRadioButtonEventFactoryImplementation : NSObject <SPTUBIMobileSocialListening_OutputModeSelectionDialog_ListenOnOwnDeviceRadioButtonEventFactory>
{
    NSArray *_components;
