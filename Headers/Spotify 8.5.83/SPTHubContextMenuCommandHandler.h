...
@protocol SPTContextMenuOptions, SPTContextMenuOptionsFactory, SPTContextMenuPresenterFactory, SPTHubInteractionLogger, SPTUBIHubsUtilities, SPTUBIPageInstanceIdentifierProvider;
...
- (id)initWithViewURI:(id)arg1 contextMenuLogContext:(id)arg2 contextMenuOptionsFactory:(id)arg3 contextMenuPresenterFactory:(id)arg4 interactionLogger:(id)arg5 ubiHubsInstrumentation:(id)arg6 pageInstanceIdProvider:(id)arg7;
