...
#import "SPTUBIMobileLyrics_CardView_VocalRemovalButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileLyrics_CardView_VocalRemovalButtonEventFactoryImplementation : NSObject <SPTUBIMobileLyrics_CardView_VocalRemovalButtonEventFactory>
{
    NSArray *_components;
