...
#import "SPTUBIMobileContextMenu_ShowCreditsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ShowCreditsItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ShowCreditsItemEventFactory>
{
    NSArray *_components;
