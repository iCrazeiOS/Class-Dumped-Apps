...
#import "SPTUBIMobileAlbumPage_TrackList_TrackPreview_EducationalMessageEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAlbumPage_TrackList_TrackPreview_EducationalMessageEventFactoryImplementation : NSObject <SPTUBIMobileAlbumPage_TrackList_TrackPreview_EducationalMessageEventFactory>
{
    NSArray *_components;
