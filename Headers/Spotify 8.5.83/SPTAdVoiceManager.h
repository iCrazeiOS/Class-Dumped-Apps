...
- (void)dealloc;
- (id)initWithVoiceSession:(id)arg1 adEntity:(id)arg2 player:(id)arg3 linkDispatcher:(id)arg4 cosmosBridge:(id)arg5 accessoryStateManager:(id)arg6 eventSender:(id)arg7 isAudioSignalEnabled:(_Bool)arg8 actionsHandler:(id)arg9;
