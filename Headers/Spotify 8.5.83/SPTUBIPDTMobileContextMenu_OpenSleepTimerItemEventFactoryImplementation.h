...
#import "SPTUBIPDTMobileContextMenu_OpenSleepTimerItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_OpenSleepTimerItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_OpenSleepTimerItemEventFactory>
{
    NSArray *_components;
