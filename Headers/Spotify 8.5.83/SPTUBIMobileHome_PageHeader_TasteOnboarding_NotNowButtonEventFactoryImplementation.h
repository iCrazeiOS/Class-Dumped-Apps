...
#import "SPTUBIMobileHome_PageHeader_TasteOnboarding_NotNowButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_PageHeader_TasteOnboarding_NotNowButtonEventFactoryImplementation : NSObject <SPTUBIMobileHome_PageHeader_TasteOnboarding_NotNowButtonEventFactory>
{
    NSArray *_components;
