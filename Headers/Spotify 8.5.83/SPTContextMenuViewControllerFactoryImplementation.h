...
- (id)contextMenuViewControllerIPadForTrackWithURL:(id)arg1 name:(id)arg2 metadata:(id)arg3 playable:(_Bool)arg4 imageURL:(id)arg5 artists:(id)arg6 albumName:(id)arg7 albumURL:(id)arg8 viewURL:(id)arg9 contextSourceURL:(id)arg10 senderView:(id)arg11 metadataTitle:(id)arg12 logContext:(id)arg13 options:(id)arg14 extraTasks:(id)arg15;
