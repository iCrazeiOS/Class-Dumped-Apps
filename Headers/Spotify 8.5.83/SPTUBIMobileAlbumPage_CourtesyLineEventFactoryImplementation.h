...
#import "SPTUBIMobileAlbumPage_CourtesyLineEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAlbumPage_CourtesyLineEventFactoryImplementation : NSObject <SPTUBIMobileAlbumPage_CourtesyLineEventFactory>
{
    NSArray *_components;
