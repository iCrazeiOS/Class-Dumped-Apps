...
@interface SPTFreeTierArtistTrackRowComponentView : HUBComponentView <SPTTrackRowArtistDelegate, HUBComponentViewWithEvents, SPTHubSwipeableTableViewCellComponentView>
{
...
- (id)initWithFrame:(struct CGRect)arg1 artistComponentFactory:(id)arg2;
