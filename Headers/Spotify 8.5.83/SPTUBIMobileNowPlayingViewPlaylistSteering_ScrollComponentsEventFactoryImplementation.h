...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_ScrollComponentsEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_ScrollComponentsEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_ScrollComponentsEventFactory>
{
    NSArray *_components;
