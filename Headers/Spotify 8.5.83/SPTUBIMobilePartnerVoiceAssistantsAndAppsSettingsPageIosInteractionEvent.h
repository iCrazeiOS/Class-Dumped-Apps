...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePartnerVoiceAssistantsAndAppsSettingsPageIosInteractionEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePartnerVoiceAssistantsAndAppsSettingsPageIosInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePartnerVoiceAssistantsAndAppsSettingsPageIosInteractionEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobilePartnerVoiceAssistantsAndAppsSettingsPageIosInteractionEventLocation *location; // @synthesize location=_location;
