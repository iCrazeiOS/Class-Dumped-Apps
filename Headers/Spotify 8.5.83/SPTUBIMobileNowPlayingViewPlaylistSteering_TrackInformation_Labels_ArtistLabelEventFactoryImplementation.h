...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_Labels_ArtistLabelEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_Labels_ArtistLabelEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_Labels_ArtistLabelEventFactory>
{
    NSArray *_components;
