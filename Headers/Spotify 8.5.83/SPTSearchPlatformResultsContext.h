...
@class NSArray, NSString, SPTSearchViewModel;
@protocol SPTSearch2CancellationToken, SPTSearchOnDemandPermissionMonitor, SPTSearchPlatformContextDelegate, SPTSearchPlatformViewModelFetcher, _TtP22AgeVerificationFeature26SPTAgeVerificationProvider_;
...
@interface SPTSearchPlatformResultsContext : NSObject <HUBContentOperationDelegate, SPTExplicitContentEnabledStateObserver, _TtP22AgeVerificationFeature43SPTCanPlayAgeRestrictedContentStateObserver_, SPTSearchOnDemandPermissionMonitorObserver, SPTSearchPlatformContext>
{
    ...
    SPTSearchViewModel *_unprocessedViewModel;
...
@property(retain, nonatomic) SPTSearchViewModel *unprocessedViewModel; // @synthesize unprocessedViewModel=_unprocessedViewModel;
