...
#import "SPTUBIMobileSocialListening_ConfirmJoinSessionDialogEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListening_ConfirmJoinSessionDialogEventFactoryImplementation : NSObject <SPTUBIMobileSocialListening_ConfirmJoinSessionDialogEventFactory>
{
    NSArray *_components;
...
- (id)notNowButtonFactoryWithUri:(id)arg1;
- (id)joinSessionButtonFactoryWithUri:(id)arg1;
- (id)absoluteLocation;
- (id)_location;
