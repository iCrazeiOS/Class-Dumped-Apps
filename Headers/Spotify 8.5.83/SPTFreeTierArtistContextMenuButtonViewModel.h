...
@protocol SPTContextMenuActionsProvider, SPTContextMenuPresenter, SPTContextMenuPresenterFactory, SPTFollowModelFactory, SPTFreeTierArtistContextMenuButtonViewModelLogger, SPTFreeTierArtistTestManager, SPTFreeTierEntityContextMenuButtonViewModelDelegate, SPTModerationReportDecorationRegistry, SPTModerationServiceState, SPTUBIPageInstanceIdentifierProvider;
...
- (id)initWithPresenterFactory:(id)arg1 actionFactory:(id)arg2 freeTierArtistTestManager:(id)arg3 artistURI:(id)arg4 followModelFactory:(id)arg5 decorationRegistry:(id)arg6 moderationFeatureState:(id)arg7 ubiLogger:(id)arg8 pageInstanceIdProvider:(id)arg9;
