...
#import "_TtC27ListeningHistoryFeatureImpl25ListeningHistoryViewModel.h"

#import "SPTSortingFilteringPickerDelegate-Protocol.h"

@interface _TtC27ListeningHistoryFeatureImpl25ListeningHistoryViewModel (ListeningHistoryFeatureImpl) <SPTSortingFilteringPickerDelegate>
...
- (void)updateSupportedViewModesWithViewModes:(id)arg1;
@end
