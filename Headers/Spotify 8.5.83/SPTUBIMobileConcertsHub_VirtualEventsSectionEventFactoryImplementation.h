...
#import "SPTUBIMobileConcertsHub_VirtualEventsSectionEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileConcertsHub_VirtualEventsSectionEventFactoryImplementation : NSObject <SPTUBIMobileConcertsHub_VirtualEventsSectionEventFactory>
{
    NSArray *_components;
...
- (id)impression;
- (id)virtualConcertFactoryWithPosition:(long long)arg1 uri:(id)arg2;
- (id)absoluteLocation;
- (id)_location;
