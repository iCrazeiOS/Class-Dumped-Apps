...
#import "SPTUBIMobilePodcastEpisodeCard_EpisodeCardContainer_Actions_AddEpisodeButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePodcastEpisodeCard_EpisodeCardContainer_Actions_AddEpisodeButtonEventFactoryImplementation : NSObject <SPTUBIMobilePodcastEpisodeCard_EpisodeCardContainer_Actions_AddEpisodeButtonEventFactory>
{
    NSArray *_components;
