...
#import "SPTUBIMobileDrivingJumpstartEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileDrivingJumpstartEventFactoryImplementation : NSObject <SPTUBIMobileDrivingJumpstartEventFactory>
{
    NSArray *_components;
