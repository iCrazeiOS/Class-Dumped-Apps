...
#import "SPTUBIMobilePartnerVoiceAssistantsAndAppsSettingsPageIos_Toolbar_BackButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePartnerVoiceAssistantsAndAppsSettingsPageIos_Toolbar_BackButtonEventFactoryImplementation : NSObject <SPTUBIMobilePartnerVoiceAssistantsAndAppsSettingsPageIos_Toolbar_BackButtonEventFactory>
{
    NSArray *_components;
