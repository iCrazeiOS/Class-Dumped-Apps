...
#import "SPTUBIMobileHome_Shortcuts_NavCardEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_Shortcuts_NavCardEventFactoryImplementation : NSObject <SPTUBIMobileHome_Shortcuts_NavCardEventFactory>
{
    NSArray *_components;
