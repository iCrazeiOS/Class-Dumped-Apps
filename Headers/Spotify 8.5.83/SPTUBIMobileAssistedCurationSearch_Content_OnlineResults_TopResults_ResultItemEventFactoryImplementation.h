...
#import "SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_TopResults_ResultItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_TopResults_ResultItemEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_Content_OnlineResults_TopResults_ResultItemEventFactory>
{
    NSArray *_components;
