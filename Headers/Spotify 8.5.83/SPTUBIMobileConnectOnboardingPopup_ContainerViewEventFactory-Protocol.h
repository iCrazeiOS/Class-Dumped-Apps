...
@class NSString;
@protocol SPTUBIEventAbsoluteLocation, SPTUBIEventLocation, SPTUBIImpressionEvent, SPTUBIMobileConnectOnboardingPopup_ContainerView_CloseEventFactory, SPTUBIMobileConnectOnboardingPopup_ContainerView_LaterButtonEventFactory, SPTUBIMobileConnectOnboardingPopup_ContainerView_ListenNowButtonEventFactory;
