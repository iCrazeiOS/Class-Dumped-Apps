...
#import "SPTUBIMobileSocialListeningParticipants_ToolbarEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListeningParticipants_ToolbarEventFactoryImplementation : NSObject <SPTUBIMobileSocialListeningParticipants_ToolbarEventFactory>
{
    NSArray *_components;
...
- (id)inviteButtonFactoryWithUri:(id)arg1;
- (id)absoluteLocation;
- (id)_location;
