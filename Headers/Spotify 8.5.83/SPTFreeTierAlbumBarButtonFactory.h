...
@protocol SPTCollectionPlatform, SPTCollectionPlatformConfiguration, SPTCollectionPlatformTestManager, SPTContextMenuActionsProvider, SPTContextMenuPresenterFactory, SPTLogCenter, SPTUBIPageInstanceIdentifierProvider;
...
- (id)initWithCollectionPlatform:(id)arg1 collectionTestManager:(id)arg2 contextMenuPresenterFactory:(id)arg3 contextMenuActionFactory:(id)arg4 logCenter:(id)arg5 ubiLogger:(id)arg6 pageInstanceIdProvider:(id)arg7;
