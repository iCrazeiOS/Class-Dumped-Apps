...
- (id)initWithSearchViewController:(id)arg1 logger:(id)arg2 linkDispatcher:(id)arg3 voiceuiService:(id)arg4 connectivityController:(id)arg5 assistedCurationLoggingEnabled:(_Bool)arg6;
