...
#import "SPTUBIMobileHome_PageHeader_TasteOnboardingEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_PageHeader_TasteOnboardingEventFactoryImplementation : NSObject <SPTUBIMobileHome_PageHeader_TasteOnboardingEventFactory>
{
    NSArray *_components;
