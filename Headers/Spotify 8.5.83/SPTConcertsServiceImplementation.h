...
@class NSSet, NSString, SPTAllocationContext, SPTConcertsDateFormatter, SPTConcertsLocalDataManager, SPTConcertsNowPlayingScrollProvider;
@protocol SPContextMenuFeature, SPTContainerService, SPTContainerUIService, SPTGLUEService, SPTHubFrameworkService, SPTImageLoadingService, SPTLocalSettings, SPTNavigationFeature, SPTNetworkService, SPTNowPlayingScrollDataSource, SPTPerformanceMetricsService, SPTPlayer, SPTPlayerFeature, SPTRemoteConfigurationResolver, SPTRemoteConfigurationService, SPTSessionService, SPTUBIService, SPTURIDispatchService;
...
@interface SPTConcertsServiceImplementation : NSObject <SPTConcertsService>
{
    ...
    SPTConcertsNowPlayingScrollProvider *_concertsProvider;
}

+ (id)serviceIdentifier;
- (void).cxx_destruct;
@property(retain, nonatomic) SPTConcertsNowPlayingScrollProvider *concertsProvider; // @synthesize concertsProvider=_concertsProvider;
