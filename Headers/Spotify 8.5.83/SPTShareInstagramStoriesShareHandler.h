...
@class NSString, SPTDataLoader, SPTShareData, SPTShareFeatureProperties, SPTShareHandlerCompletionDataModel, SPTShareLogger, SPTSharePresenterSharingSDKHelper, SPTSharingSDK;
