...
#import "SPTUBIMobileEditPlaylist_ChangeImageDialog_RemoveCurrentImageButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileEditPlaylist_ChangeImageDialog_RemoveCurrentImageButtonEventFactoryImplementation : NSObject <SPTUBIMobileEditPlaylist_ChangeImageDialog_RemoveCurrentImageButtonEventFactory>
{
    NSArray *_components;
