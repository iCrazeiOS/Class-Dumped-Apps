...
@class NSDictionary, NSMutableDictionary, NSString, RAPIEntertainmentAppLink, SPTAccessory, SPTBMWToolbar;
@protocol SPTAccessoryActionLogger, SPTAudioSessionActivator, SPTExternalIntegrationExternalActionOrigin, SPTExternalIntegrationPlatform, SPTImageLoader;
...
@interface SPTBMWLoggedInSession : NSObject <SPTExternalIntegrationPlaybackControllerObserver, SPTExternalIntegrationCollectionControllerObserver, SPTExternalIntegrationContentControllerObserver, SPTImageLoaderDelegate, SPTBMWListScreenDelegate>
{
    ...
    id <SPTAudioSessionActivator> _audioSessionActivator;
    id _debugLog;
}

- (void).cxx_destruct;
@property(retain, nonatomic) id debugLog; // @synthesize debugLog=_debugLog;
@property(retain, nonatomic) id <SPTAudioSessionActivator> audioSessionActivator; // @synthesize audioSessionActivator=_audioSessionActivator;
...
@property(readonly, nonatomic) SPTAccessory *currentAccessory; // @synthesize currentAccessory=_currentAccessory;
...
- (id)initWithExternalIntegrationPlatform:(id)arg1 toolbar:(id)arg2 imageLoaderFactory:(id)arg3 bmwAppLink:(id)arg4 accessory:(id)arg5 actionLogger:(id)arg6 debugLog:(id)arg7;
