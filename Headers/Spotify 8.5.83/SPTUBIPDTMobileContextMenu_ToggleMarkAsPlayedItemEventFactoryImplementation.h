...
#import "SPTUBIPDTMobileContextMenu_ToggleMarkAsPlayedItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ToggleMarkAsPlayedItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ToggleMarkAsPlayedItemEventFactory>
{
    NSArray *_components;
