...
#import "SPTUBIMobileContextMenu_TogglePlaylistCollaborativeItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_TogglePlaylistCollaborativeItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_TogglePlaylistCollaborativeItemEventFactory>
{
    NSArray *_components;
