...
#import "SPTUBIMobileSearch_Filters_FilterEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSearch_Filters_FilterEventFactoryImplementation : NSObject <SPTUBIMobileSearch_Filters_FilterEventFactory>
{
    NSArray *_components;
