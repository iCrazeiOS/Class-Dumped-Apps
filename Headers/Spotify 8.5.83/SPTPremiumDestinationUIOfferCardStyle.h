...
@interface SPTPremiumDestinationUIOfferCardStyle : NSObject <GLUEStyle>
{
    ...
    double _componentWidthPercentage;
    double _componentHeightPercentage;
    struct UIEdgeInsets _offerCardInsets;
    struct UIEdgeInsets _childComponentViewInsets;
}

@property(nonatomic) double componentHeightPercentage; // @synthesize componentHeightPercentage=_componentHeightPercentage;
@property(nonatomic) double componentWidthPercentage; // @synthesize componentWidthPercentage=_componentWidthPercentage;
