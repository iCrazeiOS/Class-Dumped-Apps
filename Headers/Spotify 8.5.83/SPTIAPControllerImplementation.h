...
@class NSArray, NSHashTable, NSMapTable, NSMutableArray, NSString, SKPaymentQueue, SPTAuthLegacySession, SPTDataLoaderFactory, SPTIAPControllerLogging, SPTIAPControllerRetryManager, SPTIAPProductRequest, SPTIAPRestoredTransactionsObserver, SPTIAPSimulationSettings;
@protocol SPTIAPRequestFactory;

@interface SPTIAPControllerImplementation : NSObject <SPTIAPProductRequestDelegate, SPTIAPPurchaseRequestDelegate, SPTIAPRestoredTransactionsObserverDelegate, SPTIAPControllerRetryManagerDelegate, SPTIAPController, SPTAuthLegacySessionObserver>
{
