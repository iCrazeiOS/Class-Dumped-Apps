...
#import "SPTUBIMobileEditPlaylist_ErrorDialog_TryAgainButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileEditPlaylist_ErrorDialog_TryAgainButtonEventFactoryImplementation : NSObject <SPTUBIMobileEditPlaylist_ErrorDialog_TryAgainButtonEventFactory>
{
    NSArray *_components;
