...
#import "SPTAudioSessionActivator-Protocol.h"

@class NSString, SPTAudioSessionControllerImpl;

@interface SPTAudioSessionActivator : NSObject <SPTAudioSessionActivator>
{
