...
#import "SPTUBIMobilePartnerVoiceAssistantsAndAppsSettingsPageIos_ToolbarEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePartnerVoiceAssistantsAndAppsSettingsPageIos_ToolbarEventFactoryImplementation : NSObject <SPTUBIMobilePartnerVoiceAssistantsAndAppsSettingsPageIos_ToolbarEventFactory>
{
    NSArray *_components;
