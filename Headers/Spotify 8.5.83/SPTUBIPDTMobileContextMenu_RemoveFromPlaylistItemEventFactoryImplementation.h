...
#import "SPTUBIPDTMobileContextMenu_RemoveFromPlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_RemoveFromPlaylistItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_RemoveFromPlaylistItemEventFactory>
{
    NSArray *_components;
