...
#import "SPTUBIMobileContextMenu_ToggleFollowItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ToggleFollowItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ToggleFollowItemEventFactory>
{
    NSArray *_components;
