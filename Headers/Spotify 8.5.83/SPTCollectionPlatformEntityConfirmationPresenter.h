...
@protocol SPTCollectionPlatformPropertiesManager, SPTEntityService, SPTLinkDispatcher, SPTPlaylistPlatformPlaylistDataLoader, SPTSnackbarConditionalPresenter;
...
- (void)refresh_showCollectionConfirmationProgressViewForAddedState:(_Bool)arg1 entityURL:(id)arg2 entityName:(id)arg3 isDownload:(_Bool)arg4;
- (void)presentSnackbarWithIdentifier:(id)arg1 message:(id)arg2 actionButtonTitle:(id)arg3 actionBlock:(CDUnknownBlockType)arg4;
...
- (void)showCollectionConfirmationProgressViewForAddedState:(_Bool)arg1 entityURL:(id)arg2 entityName:(id)arg3 isDownload:(_Bool)arg4;
...
- (CDUnknownBlockType)actionBlockForAddedToCollection:(_Bool)arg1 entityURL:(id)arg2 isDownload:(_Bool)arg3;
- (id)actionButtonTitleForAddedToCollection:(_Bool)arg1 entityURL:(id)arg2 isDownload:(_Bool)arg3;
- (id)confirmationTitleForAddedToCollection:(_Bool)arg1 entityURL:(id)arg2 isDownload:(_Bool)arg3;
- (id)initWithSnackbarPresenter:(id)arg1 entityService:(id)arg2 testManager:(id)arg3 playlistDataLoader:(id)arg4 linkDispatcher:(id)arg5;
