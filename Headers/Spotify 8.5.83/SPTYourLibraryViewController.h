...
@protocol SPTImageLoader, SPTPageContainer, SPTPageController, SPTViewLogger, SPTYourLibraryOfflineBanner, SPTYourLibraryViewModel;

@interface SPTYourLibraryViewController : UIViewController <SPTYourLibraryPageDelegate, SPTYourLibraryHeaderViewControllerDelegate, SPTYourLibrarySectionsHeadersViewControllerDelegate, SPTYourLibraryPagesViewControllerDatasource, SPTYourLibraryPagesViewControllerDelegate, SPTNavigationControllerNavigationBarState, SPTScrollToTopViewController, SPTYourLibraryViewModelObserver, SPTPageController, SPTPageContainer>
{
...
- (id)unwrapViewControllerFromPageLoaderIfNeeded:(id)arg1;
- (_Bool)isOnTopOfNavigationStack;
...
- (void)viewDidLoad;
- (id)initWithViewModel:(id)arg1 theme:(id)arg2 logger:(id)arg3 viewLogger:(id)arg4 offlineBannerViewController:(id)arg5 imageLoader:(id)arg6;
