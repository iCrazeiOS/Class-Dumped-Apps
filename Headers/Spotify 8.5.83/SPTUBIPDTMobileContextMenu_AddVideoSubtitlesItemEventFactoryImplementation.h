...
#import "SPTUBIPDTMobileContextMenu_AddVideoSubtitlesItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_AddVideoSubtitlesItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_AddVideoSubtitlesItemEventFactory>
{
    NSArray *_components;
