...
@interface SPTYourLibraryMusicSongsHeaderContentViewStyle : NSObject <GLUEStyle>
{
    ...
    double _collapsedFilterContentPlaceholderHeight;
...
@property(nonatomic) double collapsedFilterContentPlaceholderHeight; // @synthesize collapsedFilterContentPlaceholderHeight=_collapsedFilterContentPlaceholderHeight;
