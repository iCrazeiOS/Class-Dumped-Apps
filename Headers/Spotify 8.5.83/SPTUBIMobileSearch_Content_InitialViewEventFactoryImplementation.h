...
#import "SPTUBIMobileSearch_Content_InitialViewEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSearch_Content_InitialViewEventFactoryImplementation : NSObject <SPTUBIMobileSearch_Content_InitialViewEventFactory>
{
    NSArray *_components;
