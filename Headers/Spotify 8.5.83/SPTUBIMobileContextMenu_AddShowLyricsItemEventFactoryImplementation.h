...
#import "SPTUBIMobileContextMenu_AddShowLyricsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_AddShowLyricsItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_AddShowLyricsItemEventFactory>
{
    NSArray *_components;
