...
#import "SPTUBIMobileContextMenu_AddReportItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_AddReportItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_AddReportItemEventFactory>
{
    NSArray *_components;
