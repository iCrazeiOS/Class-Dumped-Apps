...
#import "SPTUBIMobileSearch_Content_InitialView_Recents_ClearRecentsEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSearch_Content_InitialView_Recents_ClearRecentsEventFactoryImplementation : NSObject <SPTUBIMobileSearch_Content_InitialView_Recents_ClearRecentsEventFactory>
{
    NSArray *_components;
