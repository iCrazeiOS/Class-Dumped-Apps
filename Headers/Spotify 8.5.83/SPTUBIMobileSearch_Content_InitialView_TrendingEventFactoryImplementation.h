...
#import "SPTUBIMobileSearch_Content_InitialView_TrendingEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSearch_Content_InitialView_TrendingEventFactoryImplementation : NSObject <SPTUBIMobileSearch_Content_InitialView_TrendingEventFactory>
{
    NSArray *_components;
...
- (id)trendingItemFactoryWithPosition:(long long)arg1;
- (id)absoluteLocation;
- (id)_location;
