...
#import "SPTUBIMobileHome_Shelf_TappableSectionHeaderEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_Shelf_TappableSectionHeaderEventFactoryImplementation : NSObject <SPTUBIMobileHome_Shelf_TappableSectionHeaderEventFactory>
{
    NSArray *_components;
