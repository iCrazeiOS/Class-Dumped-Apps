...
- (void)insertAndPlayTrailerTrackInQueue:(id)arg1 loggingParams:(id)arg2;
...
- (void)playPodcastTrailerWithURI:(id)arg1 podcastURI:(id)arg2 podcastTitle:(id)arg3 loggingParams:(id)arg4;
- (_Bool)resumePodcast:(id)arg1 episodeUrl:(id)arg2;
- (void)playPodcastWithContext:(id)arg1 itemID:(id)arg2 fromTimestamp:(id)arg3 loggingParams:(id)arg4;
- (void)playPodcastWithContextURI:(id)arg1 itemID:(id)arg2 fromTimestamp:(id)arg3 loggingParams:(id)arg4;
- (void)playPodcast:(id)arg1 withEpisodes:(id)arg2 withOrigin:(id)arg3 startEpisodeUrl:(id)arg4 fromTimestamp:(id)arg5 resetPlay:(_Bool)arg6 respectOrder:(_Bool)arg7 loggingParams:(id)arg8 completionHandler:(CDUnknownBlockType)arg9;
- (void)playPodcast:(id)arg1 withEpisodes:(id)arg2 withOrigin:(id)arg3 startEpisodeUrl:(id)arg4 fromTimestamp:(id)arg5 resetPlay:(_Bool)arg6 loggingParams:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;
- (void)playPodcast:(id)arg1 withEpisodes:(id)arg2 startEpisodeUrl:(id)arg3 fromTimestamp:(id)arg4 resetPlay:(_Bool)arg5 respectOrder:(_Bool)arg6 loggingParams:(id)arg7;
