...
@protocol SPTExternalIntegrationContentProvider, SPTExternalIntegrationContentRequestOptions, SPTExternalIntegrationContentRequestOrigin, SPTReachabilityMonitor;
...
- (id)initWithContentProvider:(id)arg1 URI:(id)arg2 options:(id)arg3 retryCount:(unsigned long long)arg4 retryTimeout:(double)arg5 reachabilityMonitor:(id)arg6 requestOrigin:(id)arg7;
