...
#import "SPTUBIMobileCreatePlaylist_CreateButtonAutorefreshEnabledEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileCreatePlaylist_CreateButtonAutorefreshEnabledEventFactoryImplementation : NSObject <SPTUBIMobileCreatePlaylist_CreateButtonAutorefreshEnabledEventFactory>
{
    NSArray *_components;
