...
#import "SPTUBIPDTMobileContextMenu_FindFriendsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_FindFriendsItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_FindFriendsItemEventFactory>
{
    NSArray *_components;
