...
#import "SPTUBIMobileContextMenu_ReportAbuseItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ReportAbuseItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ReportAbuseItemEventFactory>
{
    NSArray *_components;
