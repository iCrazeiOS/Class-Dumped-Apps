...
#import "SPTLoginThirdPartyAuthSignUpDisabledLogger-Protocol.h"

@class NSString;
@protocol SPTLoginLogger;

@interface SPTLoginGoogleSignUpDisabledLogger : NSObject <SPTLoginThirdPartyAuthSignUpDisabledLogger>
{
...
- (void)logUserDidTapDialogGoToSignUpButton;
