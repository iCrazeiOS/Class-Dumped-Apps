...
@class NSArray, NSDictionary, NSString, SPTUBIPDTMobileContextMenuInteractionEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenuInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIPDTMobileContextMenuInteractionEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIPDTMobileContextMenuInteractionEventLocation *location; // @synthesize location=_location;
