...
@protocol GaiaFeature, SPTAccessoryManagerSessionService, SPTAuthTestManager, SPTConnectivitySessionService, SPTContainerService, SPTContainerUIService, SPTEventSenderService, SPTExternalIntegrationPlatformService, SPTFeatureFlaggingService, SPTLoginDelayedSignupService, SPTNetworkService, SPTRemoteConfigurationService, SPTSessionService, SPTURIDispatchService;

@interface AuthFeatureImplementation : NSObject <SPTURISubtypeHandler, SPTAuthService, SPTAuthLegacySessionObserver>
{
