...
#import "SPTBarOverlayScrollViewGestureDelegate-Protocol.h"
...
@interface SPTBarInteractivePresentationController : NSObject <UIGestureRecognizerDelegate, SPTBarOverlayScrollViewGestureDelegate, UIViewControllerTransitioningDelegate>
{
