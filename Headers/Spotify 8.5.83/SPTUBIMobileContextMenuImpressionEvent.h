...
@class NSArray, NSString, SPTUBIMobileContextMenuEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenuImpressionEvent : NSObject <SPTUBIImpressionEvent>
{
    SPTUBIMobileContextMenuEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobileContextMenuEventLocation *location; // @synthesize location=_location;
