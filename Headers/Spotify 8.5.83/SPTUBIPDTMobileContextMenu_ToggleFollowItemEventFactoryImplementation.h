...
#import "SPTUBIPDTMobileContextMenu_ToggleFollowItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ToggleFollowItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ToggleFollowItemEventFactory>
{
    NSArray *_components;
