...
@class NSString, SPTAdFeatureFlagChecks, SPTObserverManager;
@protocol SPTAdsBaseGlobalSettingsController, SPTForegroundObserver, SPTProductState;

@interface SPTAdFocusManager : NSObject <SPTForegroundObserverDelegate, SPTAdFeatureFlagChecksObserver>
{
