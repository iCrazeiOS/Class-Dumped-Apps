...
@class NSString, SPTLoginOptionArray, SPTLoginSignupCopyProvider;
...
- (id)initWithHeader:(id)arg1 loginOptions:(id)arg2 layoutName:(id)arg3 layoutMLName:(id)arg4 signupCopyProvider:(id)arg5;
