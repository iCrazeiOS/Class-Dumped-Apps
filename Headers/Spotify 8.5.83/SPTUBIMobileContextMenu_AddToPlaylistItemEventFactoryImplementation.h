...
#import "SPTUBIMobileContextMenu_AddToPlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_AddToPlaylistItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_AddToPlaylistItemEventFactory>
{
    NSArray *_components;
