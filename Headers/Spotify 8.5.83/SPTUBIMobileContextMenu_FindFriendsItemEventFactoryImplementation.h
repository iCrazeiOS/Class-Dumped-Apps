...
#import "SPTUBIMobileContextMenu_FindFriendsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_FindFriendsItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_FindFriendsItemEventFactory>
{
    NSArray *_components;
