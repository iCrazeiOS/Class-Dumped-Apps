...
#import "SPTQuickActionsDelegate-Protocol.h"
...
@interface SPTQuickActionsController : NSObject <SPTRecentlyPlayedShortcutItemsUpdate, SPTScannablesShortcutItemProviderUpdateDelegate, SPTQuickActionsDelegate>
{
    NSURL *_searchURL;
