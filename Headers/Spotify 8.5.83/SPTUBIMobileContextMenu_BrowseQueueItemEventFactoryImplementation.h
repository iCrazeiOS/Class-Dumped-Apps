...
#import "SPTUBIMobileContextMenu_BrowseQueueItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_BrowseQueueItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_BrowseQueueItemEventFactory>
{
    NSArray *_components;
