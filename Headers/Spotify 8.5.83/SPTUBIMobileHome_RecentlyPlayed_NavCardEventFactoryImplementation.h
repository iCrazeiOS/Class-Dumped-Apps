...
#import "SPTUBIMobileHome_RecentlyPlayed_NavCardEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_RecentlyPlayed_NavCardEventFactoryImplementation : NSObject <SPTUBIMobileHome_RecentlyPlayed_NavCardEventFactory>
{
    NSArray *_components;
