...
#import "SPTUBIMobileContextMenu_ToggleDownloadItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ToggleDownloadItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ToggleDownloadItemEventFactory>
{
    NSArray *_components;
