...
#import "SPTUBIMobileEditPlaylist_ChangeImageDialog_ChooseImageButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileEditPlaylist_ChangeImageDialog_ChooseImageButtonEventFactoryImplementation : NSObject <SPTUBIMobileEditPlaylist_ChangeImageDialog_ChooseImageButtonEventFactory>
{
    NSArray *_components;
