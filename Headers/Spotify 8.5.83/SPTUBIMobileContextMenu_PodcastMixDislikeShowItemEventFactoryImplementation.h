...
#import "SPTUBIMobileContextMenu_PodcastMixDislikeShowItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_PodcastMixDislikeShowItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_PodcastMixDislikeShowItemEventFactory>
{
    NSArray *_components;
