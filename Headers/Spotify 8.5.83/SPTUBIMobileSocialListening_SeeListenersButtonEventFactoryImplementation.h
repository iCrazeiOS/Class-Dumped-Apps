...
#import "SPTUBIMobileSocialListening_SeeListenersButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListening_SeeListenersButtonEventFactoryImplementation : NSObject <SPTUBIMobileSocialListening_SeeListenersButtonEventFactory>
{
    NSArray *_components;
