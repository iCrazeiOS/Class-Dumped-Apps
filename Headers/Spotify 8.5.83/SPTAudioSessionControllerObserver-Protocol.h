...
@protocol SPTAudioSessionActivator, SPTAudioSessionController;
...
- (void)audioSessionController:(id <SPTAudioSessionController>)arg1 willReleaseLockForAudioSessionConfiguration:(id <SPTAudioSessionActivator>)arg2;
- (void)audioSessionController:(id <SPTAudioSessionController>)arg1 willAttemptLockForAudioSessionConfiguration:(id <SPTAudioSessionActivator>)arg2;
@end
