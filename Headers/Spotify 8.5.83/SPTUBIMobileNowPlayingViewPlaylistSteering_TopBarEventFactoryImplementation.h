...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_TopBarEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_TopBarEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_TopBarEventFactory>
{
    NSArray *_components;
