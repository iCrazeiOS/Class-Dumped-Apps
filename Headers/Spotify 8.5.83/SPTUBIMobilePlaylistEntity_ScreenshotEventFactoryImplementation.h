...
#import "SPTUBIMobilePlaylistEntity_ScreenshotEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_ScreenshotEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_ScreenshotEventFactory>
{
    NSArray *_components;
