...
@interface SPTCollectionPlatformConfigurationImplementation : NSObject <SPTCollectionPlatformConfiguration>
{
    ...
    NSURL *_collectionYourEpisodesImageURL;
...
@property(readonly, nonatomic) NSURL *collectionYourEpisodesImageURL; // @synthesize collectionYourEpisodesImageURL=_collectionYourEpisodesImageURL;
...
@property(readonly, nonatomic) NSString *collectionYourEpisodesTitle;
