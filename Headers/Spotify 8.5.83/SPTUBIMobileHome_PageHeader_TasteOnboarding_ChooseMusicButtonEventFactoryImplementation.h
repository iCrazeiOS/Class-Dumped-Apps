...
#import "SPTUBIMobileHome_PageHeader_TasteOnboarding_ChooseMusicButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_PageHeader_TasteOnboarding_ChooseMusicButtonEventFactoryImplementation : NSObject <SPTUBIMobileHome_PageHeader_TasteOnboarding_ChooseMusicButtonEventFactory>
{
    NSArray *_components;
