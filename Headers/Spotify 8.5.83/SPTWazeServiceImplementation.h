...
@interface SPTWazeServiceImplementation : NSObject <SPTWazeTestManagerObserver, SPTAuthControllerObserver, SPTExternalIntegrationPlaybackControllerObserver, SPTWazeService>
{
    ...
    id <SPTDrivingModeService> _drivingModeService;
...
@property(readonly, nonatomic) __weak id <SPTDrivingModeService> drivingModeService; // @synthesize drivingModeService=_drivingModeService;
