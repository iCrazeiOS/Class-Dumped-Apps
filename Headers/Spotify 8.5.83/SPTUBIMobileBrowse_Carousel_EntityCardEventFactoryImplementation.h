...
#import "SPTUBIMobileBrowse_Carousel_EntityCardEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileBrowse_Carousel_EntityCardEventFactoryImplementation : NSObject <SPTUBIMobileBrowse_Carousel_EntityCardEventFactory>
{
    NSArray *_components;
