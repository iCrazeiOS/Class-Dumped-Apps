...
- (void)networkClient:(SPTInAppMessageNetworkClient *)arg1 didFetchMessage:(NSData *)arg2 triggers:(NSArray *)arg3 triggerType:(NSString *)arg4 requestedPattern:(NSString *)arg5;
