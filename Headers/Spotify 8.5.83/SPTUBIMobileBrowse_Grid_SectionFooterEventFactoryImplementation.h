...
#import "SPTUBIMobileBrowse_Grid_SectionFooterEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileBrowse_Grid_SectionFooterEventFactoryImplementation : NSObject <SPTUBIMobileBrowse_Grid_SectionFooterEventFactory>
{
    NSArray *_components;
