...
- (id)bannerItemWithLocalizedTitle:(id)arg1 localizedMessage:(id)arg2 localizedActionButtonTitle:(id)arg3 image:(id)arg4 style:(long long)arg5 priority:(unsigned long long)arg6 presentationDuration:(double)arg7 customBackgroundColor:(id)arg8 shownOnTopOfModals:(_Bool)arg9;
