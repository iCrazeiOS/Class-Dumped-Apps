...
#import "SPTUBIPDTMobileContextMenu_CanvasChangePlaybackSettingsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_CanvasChangePlaybackSettingsItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_CanvasChangePlaybackSettingsItemEventFactory>
{
    NSArray *_components;
