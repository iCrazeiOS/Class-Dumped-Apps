...
@interface SPTInAppMessageFeatureProperties : NSObject <SPTRemoteConfigurationProperties>
{
    ...
    _Bool _inappSaveAndNavigateActionEnabled;
}

@property(readonly, nonatomic) _Bool inappSaveAndNavigateActionEnabled; // @synthesize inappSaveAndNavigateActionEnabled=_inappSaveAndNavigateActionEnabled;
