...
@protocol SPContextMenuFeature, SPTGLUEService, SPTNetworkService, SPTPlayerFeature, SPTRemoteConfigurationService, SPTSessionService, SPTUIPresentationService, SPTURIDispatchService;
