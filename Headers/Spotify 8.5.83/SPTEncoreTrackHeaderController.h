...
#import "SPTEncoreTrackHeaderDelegate-Protocol.h"
...
@class NSMutableSet, NSString, NSURL, SPTEncoreTrackHeader, UIColor, UIImage, UIView;
...
@interface SPTEncoreTrackHeaderController : NSObject <SPTImageLoaderDelegate, SPTEncoreTrackHeaderDelegate, SPTFreeTierEntityFeedbackButtonViewModelDelegate, SPTFreeTierEntityOfflineDelegate>
{
    UIView *_headerView;
    ...
    SPTEncoreTrackHeader *_trackHeader;
}

+ (struct CGSize)preferredHeaderSizeForContainerViewSize:(struct CGSize)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) SPTEncoreTrackHeader *trackHeader; // @synthesize trackHeader=_trackHeader;
...
- (id)initWithTrackHeader:(id)arg1 imageLoader:(id)arg2 linkDispatcher:(id)arg3;
