...
@protocol SPTCollectionPlatform, SPTCollectionPlatformConfiguration, SPTContextMenuPresenterFactory, SPTLogCenter, SPTUBILogger, SPTUBIPageInstanceIdentifierProvider, _TtP17OfflineMixFeature26SPTOfflineMixModelProvider_;
...
- (id)initWithCollectionConfiguration:(id)arg1 collectionPlatform:(id)arg2 contextMenuPresenterFactory:(id)arg3 offlineMixModelProvider:(id)arg4 logCenter:(id)arg5 ubiLogger:(id)arg6 pageInstanceIdProvider:(id)arg7;
