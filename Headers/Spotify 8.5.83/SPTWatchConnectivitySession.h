...
@protocol SPTWatchConnectivityDebugDelegate;

@interface SPTWatchConnectivitySession : NSObject <WCSessionDelegate, NSFileManagerDelegate>
{
    id <SPTWatchConnectivityDebugDelegate> _debugDelegate;
...
@property(nonatomic) __weak id <SPTWatchConnectivityDebugDelegate> debugDelegate; // @synthesize debugDelegate=_debugDelegate;
