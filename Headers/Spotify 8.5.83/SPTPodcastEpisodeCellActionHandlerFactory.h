...
@protocol SPTCollectionLogger, SPTExplicitContentAccessManager, SPTLinkDispatcher, SPTPodcastContextMenuProvider, SPTPodcastOffliningManager, SPTSnackbarConditionalPresenter, SPTYourEpisodesSaveManager;
...
@interface SPTPodcastEpisodeCellActionHandlerFactory : NSObject
{
    ...
    id <SPTYourEpisodesSaveManager> _yourEpisodesSaveManager;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) id <SPTYourEpisodesSaveManager> yourEpisodesSaveManager; // @synthesize yourEpisodesSaveManager=_yourEpisodesSaveManager;
...
- (id)initWithPodcastContextMenuProvider:(id)arg1 snackbarPresenter:(id)arg2 logger:(id)arg3 podcastOffliningManager:(id)arg4 collectionLogger:(id)arg5 explicitContentAccessManager:(id)arg6 linkDispatcher:(id)arg7 yourEpisodesSaveManager:(id)arg8;
