...
#import "SPTUBIPDTMobileContextMenu_AddItemToQueueEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_AddItemToQueueEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_AddItemToQueueEventFactory>
{
    NSArray *_components;
