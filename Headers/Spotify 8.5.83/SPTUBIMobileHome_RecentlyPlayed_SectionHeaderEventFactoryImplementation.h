...
#import "SPTUBIMobileHome_RecentlyPlayed_SectionHeaderEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_RecentlyPlayed_SectionHeaderEventFactoryImplementation : NSObject <SPTUBIMobileHome_RecentlyPlayed_SectionHeaderEventFactory>
{
    NSArray *_components;
