...
#import "_TtC21OfflineMixFeatureImpl14HeaderProvider.h"

#import "SPTFreeTierPlaylistHeaderProvider-Protocol.h"

@interface _TtC21OfflineMixFeatureImpl14HeaderProvider (OfflineMixFeatureImpl) <SPTFreeTierPlaylistHeaderProvider>
