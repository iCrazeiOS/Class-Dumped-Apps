...
#import "SPTUBIMobileArtistPage_TopTracks_TrackPreviewEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileArtistPage_TopTracks_TrackPreviewEventFactoryImplementation : NSObject <SPTUBIMobileArtistPage_TopTracks_TrackPreviewEventFactory>
{
    NSArray *_components;
