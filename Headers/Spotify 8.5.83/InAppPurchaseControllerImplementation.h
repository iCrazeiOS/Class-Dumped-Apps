...
@class InAppPurchaseModel, NSMutableArray, NSString, NSTimer, SKProductsRequest, SPTAuthLegacySession, SPTDataLoader, SPTHermesController, SPTIAPControllerLogging;
