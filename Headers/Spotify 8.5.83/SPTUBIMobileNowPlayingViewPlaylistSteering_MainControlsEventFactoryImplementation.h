...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_MainControlsEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_MainControlsEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_MainControlsEventFactory>
{
    NSArray *_components;
