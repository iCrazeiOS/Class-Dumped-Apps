...
#import "SPTUBIPDTMobileContextMenu_LessLikeThisEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_LessLikeThisEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_LessLikeThisEventFactory>
{
    NSArray *_components;
