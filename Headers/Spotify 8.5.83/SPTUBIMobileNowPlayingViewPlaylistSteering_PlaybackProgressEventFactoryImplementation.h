...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_PlaybackProgressEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_PlaybackProgressEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_PlaybackProgressEventFactory>
{
    NSArray *_components;
