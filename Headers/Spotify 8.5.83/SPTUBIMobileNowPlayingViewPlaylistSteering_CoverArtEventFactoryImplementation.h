...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_CoverArtEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_CoverArtEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_CoverArtEventFactory>
{
    NSArray *_components;
