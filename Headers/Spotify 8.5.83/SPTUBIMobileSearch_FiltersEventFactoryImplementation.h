...
#import "SPTUBIMobileSearch_FiltersEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSearch_FiltersEventFactoryImplementation : NSObject <SPTUBIMobileSearch_FiltersEventFactory>
{
    NSArray *_components;
...
- (id)filterFactoryWithPosition:(long long)arg1 uri:(id)arg2 reason:(id)arg3;
- (id)absoluteLocation;
- (id)_location;
