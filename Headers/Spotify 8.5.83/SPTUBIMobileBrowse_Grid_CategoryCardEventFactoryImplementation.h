...
#import "SPTUBIMobileBrowse_Grid_CategoryCardEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileBrowse_Grid_CategoryCardEventFactoryImplementation : NSObject <SPTUBIMobileBrowse_Grid_CategoryCardEventFactory>
{
    NSArray *_components;
