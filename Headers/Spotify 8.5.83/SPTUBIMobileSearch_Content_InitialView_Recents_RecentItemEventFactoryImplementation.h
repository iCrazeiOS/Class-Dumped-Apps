...
#import "SPTUBIMobileSearch_Content_InitialView_Recents_RecentItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSearch_Content_InitialView_Recents_RecentItemEventFactoryImplementation : NSObject <SPTUBIMobileSearch_Content_InitialView_Recents_RecentItemEventFactory>
{
    NSArray *_components;
