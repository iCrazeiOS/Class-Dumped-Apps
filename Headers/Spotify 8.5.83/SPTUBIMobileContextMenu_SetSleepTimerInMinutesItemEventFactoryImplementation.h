...
#import "SPTUBIMobileContextMenu_SetSleepTimerInMinutesItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_SetSleepTimerInMinutesItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_SetSleepTimerInMinutesItemEventFactory>
{
    NSArray *_components;
