...
- (id <SPTCreatePlaylistController>)provideCreatePlaylistControllerForPageURI:(NSURL *)arg1 inFolder:(NSURL *)arg2;
- (id <SPTCreatePlaylistController>)provideCreatePlaylistControllerForPageURI:(NSURL *)arg1;
@end
