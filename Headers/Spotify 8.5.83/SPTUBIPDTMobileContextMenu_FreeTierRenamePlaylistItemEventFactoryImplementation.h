...
#import "SPTUBIPDTMobileContextMenu_FreeTierRenamePlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_FreeTierRenamePlaylistItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_FreeTierRenamePlaylistItemEventFactory>
{
    NSArray *_components;
