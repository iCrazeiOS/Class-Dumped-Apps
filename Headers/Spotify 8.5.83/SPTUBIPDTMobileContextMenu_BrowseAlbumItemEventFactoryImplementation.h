...
#import "SPTUBIPDTMobileContextMenu_BrowseAlbumItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_BrowseAlbumItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_BrowseAlbumItemEventFactory>
{
    NSArray *_components;
