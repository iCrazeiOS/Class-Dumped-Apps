...
- (void)dealloc;
- (id)initWithTransport:(id)arg1 messageOwnerProvider:(id)arg2 clientId:(id)arg3 logger:(id)arg4 overrideClientVersion:(id)arg5 overrideDeviceId:(id)arg6 overrideDatabaseLocation:(id)arg7 overrideTimerInterval:(double)arg8 overridePersistentStore:(id)arg9;
- (id)initWithTransport:(id)arg1 messageOwnerProvider:(id)arg2 clientId:(id)arg3 logger:(id)arg4 overrideClientVersion:(id)arg5 overrideDeviceId:(id)arg6 overrideDatabaseLocation:(id)arg7;
