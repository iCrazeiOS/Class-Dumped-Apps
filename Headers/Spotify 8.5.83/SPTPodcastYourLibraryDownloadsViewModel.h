...
@protocol SPTExplicitContentAccessManager, SPTPodcastDataLoader, SPTPodcastDataLoaderRequestToken, SPTPodcastEpisodeFactory, SPTPodcastPlayer, SPTPodcastRequestFactory, SPTPodcastYourLibraryEpisodesViewModelDelegate, _TtP19YourEpisodesFeature26SPTYourEpisodesTestManager_;
...
- (id)initWithURL:(id)arg1 podcastRequestFactory:(id)arg2 dataLoader:(id)arg3 player:(id)arg4 episodeFactory:(id)arg5 explicitContentAccessManager:(id)arg6 yourEpisodesTestManager:(id)arg7;
