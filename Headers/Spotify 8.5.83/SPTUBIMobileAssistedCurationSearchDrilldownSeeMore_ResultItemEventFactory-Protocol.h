...
@class NSURL;
@protocol SPTUBIEventAbsoluteLocation, SPTUBIEventLocation, SPTUBIImpressionEvent, SPTUBIInteractionEvent, SPTUBIMobileAssistedCurationSearchDrilldownSeeMore_ResultItem_AlbumCoverEventFactory;

@protocol SPTUBIMobileAssistedCurationSearchDrilldownSeeMore_ResultItemEventFactory <NSObject>
...
- (id <SPTUBIMobileAssistedCurationSearchDrilldownSeeMore_ResultItem_AlbumCoverEventFactory>)albumCoverFactory;
