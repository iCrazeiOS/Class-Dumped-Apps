...
#import "SPTUBIPDTMobileContextMenu_ToggleDownloadItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ToggleDownloadItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ToggleDownloadItemEventFactory>
{
    NSArray *_components;
