...
#import "SPTUBIMobileContextMenu_SetPlaybackSpeedItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_SetPlaybackSpeedItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_SetPlaybackSpeedItemEventFactory>
{
    NSArray *_components;
