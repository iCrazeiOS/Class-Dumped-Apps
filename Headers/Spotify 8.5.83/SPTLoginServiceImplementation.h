...
@class NSString, SPTAllocationContext, SPTAuthenticationHandler, SPTAuthenticationHandlerLogger, SPTLoginAttemptLogger, SPTLoginAutoLoginTimeLogger, SPTLoginDbManager, SPTLoginDelayedSignupAccountCreator, SPTLoginDelayedSignupAccountSwitcher, SPTLoginDialogController, SPTLoginFeatureLayoutConfigurationProvider, SPTLoginFeatureNavigationCoordinator, SPTLoginKeychainManagerImplementation, SPTLoginLaunchTimeLogger, SPTLoginLogoutAwaiter, SPTLoginNavigationRouter, SPTLoginSignupConfigurationResolver, SPTLoginSlideUpModalPresenter, SPTLoginStateControllerImplementation, SPTObserverManager, SPTSigninWithAppleHandler, SPTSignupAttemptTrackerImplementation;
