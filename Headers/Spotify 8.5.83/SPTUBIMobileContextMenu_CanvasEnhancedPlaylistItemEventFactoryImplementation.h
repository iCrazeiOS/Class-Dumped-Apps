...
#import "SPTUBIMobileContextMenu_CanvasEnhancedPlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_CanvasEnhancedPlaylistItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_CanvasEnhancedPlaylistItemEventFactory>
{
    NSArray *_components;
