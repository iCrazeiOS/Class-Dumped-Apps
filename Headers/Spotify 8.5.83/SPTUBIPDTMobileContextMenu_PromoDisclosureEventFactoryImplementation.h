...
#import "SPTUBIPDTMobileContextMenu_PromoDisclosureEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_PromoDisclosureEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_PromoDisclosureEventFactory>
{
    NSArray *_components;
