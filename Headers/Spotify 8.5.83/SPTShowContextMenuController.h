...
@interface SPTShowContextMenuController : NSObject <SPTShowContextMenuMetadataViewDelegate, SPTContextMenuPresenterDelegate>
{
    ...
    id <SPTPodcastLogger><SPTPodcastUBILogger> _ubiLogger;
    id <_TtP19YourEpisodesFeature26SPTYourEpisodesSaveManager_> _yourEpisodeSaveManager;
...
@property(readonly, nonatomic) id <_TtP19YourEpisodesFeature26SPTYourEpisodesSaveManager_> yourEpisodeSaveManager; // @synthesize yourEpisodeSaveManager=_yourEpisodeSaveManager;
@property(readonly, nonatomic) id <SPTPodcastLogger><SPTPodcastUBILogger> ubiLogger; // @synthesize ubiLogger=_ubiLogger;
...
- (void)showCollectionConfirmationProgressViewForAddedState:(_Bool)arg1 entityURL:(id)arg2 isDownload:(_Bool)arg3;
- (id)provideWatchDownloadActionForURI:(id)arg1 sourceURL:(id)arg2;
...
- (id)provideMarkAsPlayedUnplayedActionForEpisode:(id)arg1 contextMenuDelegate:(id)arg2 inSourceURL:(id)arg3;
- (id)provideOfflineActionForEpisode:(id)arg1 contextMenuDelegate:(id)arg2 inViewController:(id)arg3 allowOffline:(_Bool)arg4;
- (id)provideRemoveFromYourEpisodesActionForEpisode:(id)arg1 inSourceURL:(id)arg2;
...
- (void)presentContexMenuForShow:(id)arg1 contextMenuDelegate:(id)arg2 inViewController:(id)arg3 senderView:(id)arg4 options:(id)arg5 inSourceURL:(id)arg6;
