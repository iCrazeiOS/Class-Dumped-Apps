...
#import "SPTUBIPDTMobileContextMenu_CreateRadioItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_CreateRadioItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_CreateRadioItemEventFactory>
{
    NSArray *_components;
