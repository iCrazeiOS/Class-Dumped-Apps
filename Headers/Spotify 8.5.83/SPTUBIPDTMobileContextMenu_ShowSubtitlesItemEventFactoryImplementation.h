...
#import "SPTUBIPDTMobileContextMenu_ShowSubtitlesItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ShowSubtitlesItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ShowSubtitlesItemEventFactory>
{
    NSArray *_components;
