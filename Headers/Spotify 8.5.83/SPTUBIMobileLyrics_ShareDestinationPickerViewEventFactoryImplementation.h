...
#import "SPTUBIMobileLyrics_ShareDestinationPickerViewEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileLyrics_ShareDestinationPickerViewEventFactoryImplementation : NSObject <SPTUBIMobileLyrics_ShareDestinationPickerViewEventFactory>
{
    NSArray *_components;
...
- (id)impression;
- (id)shareButtonFactoryWithIdentifier:(id)arg1;
- (id)shareCardFactory;
