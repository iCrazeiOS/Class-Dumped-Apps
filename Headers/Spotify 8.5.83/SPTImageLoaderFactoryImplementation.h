...
@class NSHashTable, NSString, SPTDataLoaderFactory, SPTImageLoaderCache, SPTImageLoaderEntityImageTracker, SPTImageLoaderRegistry, SPTImageLoaderTimeMeasurementFactory, SPTPersistentCache;
...
@interface SPTImageLoaderFactoryImplementation : NSObject <SPTImageLoaderFactory>
{
    ...
    SPTImageLoaderTimeMeasurementFactory *_timeMeasurementFactory;
...
@property(retain, nonatomic) SPTImageLoaderTimeMeasurementFactory *timeMeasurementFactory; // @synthesize timeMeasurementFactory=_timeMeasurementFactory;
