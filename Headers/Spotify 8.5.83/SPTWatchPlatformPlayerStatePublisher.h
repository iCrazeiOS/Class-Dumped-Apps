...
@protocol SPTExternalIntegrationContentController, SPTExternalIntegrationDebugLog, SPTExternalIntegrationObjectFactory, SPTExternalIntegrationPlaybackController, SPTVolumeAPI, SPTWatchConnectivityPubSubMessageQueue;
...
- (id)initWithPubSubMessageQueue:(id)arg1 playbackController:(id)arg2 volumeController:(id)arg3 contentController:(id)arg4 objectFactory:(id)arg5 radioPlayback:(id)arg6 externalIntegrationDebugLog:(id)arg7;
