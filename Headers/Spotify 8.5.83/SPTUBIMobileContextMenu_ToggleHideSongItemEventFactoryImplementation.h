...
#import "SPTUBIMobileContextMenu_ToggleHideSongItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ToggleHideSongItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ToggleHideSongItemEventFactory>
{
    NSArray *_components;
