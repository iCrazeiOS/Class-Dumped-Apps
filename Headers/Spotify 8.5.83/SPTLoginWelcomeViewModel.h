...
@class NSString, SPTLoginDbManager, SPTLoginErrorDecorator, SPTLoginWelcomeModel, SPTLoginWelcomeViewLogger;
...
- (id)initWithLoginStateController:(id)arg1 logger:(id)arg2 appleSavedPasswordController:(id)arg3 databaseManager:(id)arg4 guestModeEnabled:(_Bool)arg5 model:(id)arg6;
