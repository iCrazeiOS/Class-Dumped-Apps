...
@protocol SPTContextMenuOptions, SPTContextMenuOptionsFactory, SPTContextMenuPresenterFactory, SPTHubInteractionLogger, SPTPodcastContextMenuProvider, SPTSearchUBIHubsLogger, SPTUBIPageInstanceIdentifierProvider;
...
- (id)initWithViewURI:(id)arg1 contextMenuLogContext:(id)arg2 contextMenuOptionsFactory:(id)arg3 contextMenuPresenterFactory:(id)arg4 podcastContextMenuProvider:(id)arg5 interactionLogger:(id)arg6 ubiHubsLogger:(id)arg7 pageInstanceIdProvider:(id)arg8;
