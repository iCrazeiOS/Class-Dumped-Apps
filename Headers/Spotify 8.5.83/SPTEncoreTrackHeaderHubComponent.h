...
@class NSSet;
@protocol SPTEncoreTrackHeaderFactory, SPTFreeTierEntityOfflineViewModel, SPTImageLoader, SPTLinkDispatcher;

@interface SPTEncoreTrackHeaderHubComponent : NSObject <HUBComponent>
{
    ...
    id <SPTEncoreTrackHeaderFactory> _trackHeaderFactory;
...
@property(retain, nonatomic) id <SPTEncoreTrackHeaderFactory> trackHeaderFactory; // @synthesize trackHeaderFactory=_trackHeaderFactory;
...
- (id)initWithTrackHeaderFactory:(id)arg1 imageLoader:(id)arg2 linkDispatcher:(id)arg3;
