...
- (id)setUpItemEpisodeDictionaryForURLs:(id)arg1;
...
- (void)removeEpisodeURLs:(id)arg1 showUIConfirmation:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)removeEpisodeURL:(id)arg1 showUIConfirmation:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)addEpisodesURLs:(id)arg1 showUIConfirmation:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)addEpisodeURL:(id)arg1 showUIConfirmation:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
