...
@class NSString, SPTAuthLegacySession, SPTSettingsLogger, SPTSettingsTableViewCell, SettingsSwitchTableViewCell;
@protocol SPTNetworkConnectivityController, SPTOfflineManager, SPTProductState;

@interface OfflineSettingsSection : SettingsSection <SPTAuthLegacySessionObserver>
{
