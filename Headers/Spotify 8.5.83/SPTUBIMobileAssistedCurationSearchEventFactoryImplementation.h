...
#import "SPTUBIMobileAssistedCurationSearchEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearchEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearchEventFactory>
{
    NSArray *_components;
