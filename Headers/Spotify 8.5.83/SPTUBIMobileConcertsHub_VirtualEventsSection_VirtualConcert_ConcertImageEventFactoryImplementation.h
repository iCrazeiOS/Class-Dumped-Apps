...
#import "SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcert_ConcertImageEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcert_ConcertImageEventFactoryImplementation : NSObject <SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcert_ConcertImageEventFactory>
{
    NSArray *_components;
