...
@class NSArray, NSMutableDictionary, NSString, NSURL, SPTHomeFeatureProperties, SPTHomeLocalViewModelOverrides, SPTHomeNavigationItemDecorator, SPTHomeStatusBarAppearanceModifier, SPTHomeView, SPTHomeViewModelProvider, UIView;
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithViewURI:(id)arg1 hubImpressionLogger:(id)arg2 viewModelProvider:(id)arg3 shareDragDelegateFactory:(id)arg4 offlineState:(id)arg5 overrides:(id)arg6 remoteConfigProperties:(id)arg7 statusBarAppearanceModifier:(id)arg8 initialViewModel:(id)arg9 homeViewFactory:(CDUnknownBlockType)arg10 bannerPresentationManager:(id)arg11;
