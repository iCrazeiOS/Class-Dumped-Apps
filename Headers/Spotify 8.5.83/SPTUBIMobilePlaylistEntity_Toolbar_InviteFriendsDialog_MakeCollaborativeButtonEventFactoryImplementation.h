...
#import "SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsDialog_MakeCollaborativeButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsDialog_MakeCollaborativeButtonEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_Toolbar_InviteFriendsDialog_MakeCollaborativeButtonEventFactory>
{
    NSArray *_components;
