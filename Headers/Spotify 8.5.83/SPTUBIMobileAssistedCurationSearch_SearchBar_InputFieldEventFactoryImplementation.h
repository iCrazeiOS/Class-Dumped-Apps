...
#import "SPTUBIMobileAssistedCurationSearch_SearchBar_InputFieldEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_SearchBar_InputFieldEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_SearchBar_InputFieldEventFactory>
{
    NSArray *_components;
