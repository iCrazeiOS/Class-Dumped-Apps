...
#import "SPTUBIMobileTabBar_TabBar_YourLibraryTabEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileTabBar_TabBar_YourLibraryTabEventFactoryImplementation : NSObject <SPTUBIMobileTabBar_TabBar_YourLibraryTabEventFactory>
{
    NSArray *_components;
