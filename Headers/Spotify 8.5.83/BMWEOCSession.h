...
@class BMWEOCFlexBuffer, BMWEOCHashLookup, BMWEOCKeepAliveFilter, BMWEOCSessionSettings, EOCThreadPool, NSMutableArray;
@protocol BMWEOCSessionDataSource, OS_dispatch_queue;
...
@interface BMWEOCSession : NSObject
{
    ...
    EOCThreadPool *_sessionThreadPool;
...
@property(retain) EOCThreadPool *sessionThreadPool; // @synthesize sessionThreadPool=_sessionThreadPool;
...
- (void)callCompletionHandlerWithError:(id)arg1 forMessage:(id)arg2;
