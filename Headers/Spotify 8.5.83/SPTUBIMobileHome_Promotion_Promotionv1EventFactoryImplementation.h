...
#import "SPTUBIMobileHome_Promotion_Promotionv1EventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileHome_Promotion_Promotionv1EventFactoryImplementation : NSObject <SPTUBIMobileHome_Promotion_Promotionv1EventFactory>
{
    NSArray *_components;
