...
#import "SPTUBIMobileContextMenu_WatchUiDownloadActionItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_WatchUiDownloadActionItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_WatchUiDownloadActionItemEventFactory>
{
    NSArray *_components;
