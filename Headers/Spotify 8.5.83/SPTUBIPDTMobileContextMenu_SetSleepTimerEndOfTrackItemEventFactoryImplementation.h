...
#import "SPTUBIPDTMobileContextMenu_SetSleepTimerEndOfTrackItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_SetSleepTimerEndOfTrackItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_SetSleepTimerEndOfTrackItemEventFactory>
{
    NSArray *_components;
