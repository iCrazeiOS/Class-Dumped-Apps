...
#import "SPTUBIMobileContextMenu_ShareItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ShareItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ShareItemEventFactory>
{
    NSArray *_components;
