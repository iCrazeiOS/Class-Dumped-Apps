...
#import "SPTUBIPDTMobileContextMenu_WatchUiDownloadActionItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_WatchUiDownloadActionItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_WatchUiDownloadActionItemEventFactory>
{
    NSArray *_components;
