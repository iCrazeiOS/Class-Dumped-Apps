...
#import "SPTUBIMobileAssistedCurationSearch_ContentEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_ContentEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_ContentEventFactory>
{
    NSArray *_components;
