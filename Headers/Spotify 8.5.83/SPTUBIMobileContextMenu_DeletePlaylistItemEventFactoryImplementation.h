...
#import "SPTUBIMobileContextMenu_DeletePlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_DeletePlaylistItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_DeletePlaylistItemEventFactory>
{
    NSArray *_components;
