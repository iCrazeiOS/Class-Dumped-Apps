...
#import "SPTUBIMobileContextMenu_AddItemToQueueEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_AddItemToQueueEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_AddItemToQueueEventFactory>
{
    NSArray *_components;
