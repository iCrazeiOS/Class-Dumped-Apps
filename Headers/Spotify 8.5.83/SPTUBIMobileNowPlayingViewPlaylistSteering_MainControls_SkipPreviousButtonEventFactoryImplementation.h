...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_SkipPreviousButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_SkipPreviousButtonEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_SkipPreviousButtonEventFactory>
{
    NSArray *_components;
