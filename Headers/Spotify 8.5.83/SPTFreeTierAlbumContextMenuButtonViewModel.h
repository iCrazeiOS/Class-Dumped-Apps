...
@protocol SPTCollectionPlatformTestManager, SPTContextMenuActionsProvider, SPTContextMenuPresenterFactory, SPTFreeTierAlbumContextMenuButtonViewModelLogger, SPTFreeTierEntityContextMenuButtonViewModelDelegate, SPTUBIPageInstanceIdentifierProvider;
...
- (id)initWithPresenterFactory:(id)arg1 actionFactory:(id)arg2 albumViewModel:(id)arg3 collectionTestManager:(id)arg4 ubiLogger:(id)arg5 pageInstanceIdProvider:(id)arg6;
