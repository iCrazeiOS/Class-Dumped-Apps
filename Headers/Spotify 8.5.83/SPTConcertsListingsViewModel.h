...
@class NSArray, NSString, SPTConcertsDateFormatter, SPTConcertsFeatureProperties, SPTConcertsListingLogger, SPTConcertsListingsHeaderData, SPTConcertsLocalDataManager, SPTConcertsLocationModel, SPTConcertsServiceImplementation, SPTDataLoader;
@protocol SPTConcertsListingsViewModelDelegate, SPTLinkDispatcher, SPTOfflineModeState, SPTRemoteConfigurationResolver, SPTRemoteConfigurationService;

@interface SPTConcertsListingsViewModel : NSObject <SPTDataLoaderDelegate, SPTOfflineModeStateObserver>
{
    _Bool _loading;
    _Bool _offline;
    _Bool _shouldDisplayVirtualEvents;
    ...
    SPTConcertsFeatureProperties *_properties;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool shouldDisplayVirtualEvents; // @synthesize shouldDisplayVirtualEvents=_shouldDisplayVirtualEvents;
@property(retain, nonatomic) SPTConcertsFeatureProperties *properties; // @synthesize properties=_properties;
...
@property(readonly, nonatomic) NSArray *concertsOnline; // @synthesize concertsOnline=_concertsOnline;
...
- (void)dealloc;
- (id)initWithDataLoader:(id)arg1 localDataManager:(id)arg2 offlineModeState:(id)arg3 dateFormatter:(id)arg4 concertsService:(id)arg5 linkDispatcher:(id)arg6 concertsListingLogger:(id)arg7 remoteConfigurationResolver:(id)arg8;
