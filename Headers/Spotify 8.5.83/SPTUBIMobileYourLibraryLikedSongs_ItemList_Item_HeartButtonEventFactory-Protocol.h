...
@class NSURL;
@protocol SPTUBIEventAbsoluteLocation, SPTUBIEventLocation, SPTUBIInteractionEvent, SPTUBIMobileYourLibraryLikedSongs_ItemList_Item_HeartButton_CancelEventFactory, SPTUBIMobileYourLibraryLikedSongs_ItemList_Item_HeartButton_ConfirmRemoveLikeEventFactory;
