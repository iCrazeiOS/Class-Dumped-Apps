...
#import "SPTUBIMobileAlbumPage_TrackList_TrackRow_UnlikeButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAlbumPage_TrackList_TrackRow_UnlikeButtonEventFactoryImplementation : NSObject <SPTUBIMobileAlbumPage_TrackList_TrackRow_UnlikeButtonEventFactory>
{
    NSArray *_components;
