...
#import "SPTUBIMobileContextMenu_ToggleShuffleModeItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ToggleShuffleModeItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ToggleShuffleModeItemEventFactory>
{
    NSArray *_components;
