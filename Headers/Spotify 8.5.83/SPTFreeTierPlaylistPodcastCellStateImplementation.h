...
- (id)podcastSubtitle;
- (id)podcastTitle;
- (id)initWithPlaylistTrackViewModel:(id)arg1 allowEpisodeDownload:(_Bool)arg2 isCollaborative:(_Bool)arg3 showAddedByAsFace:(_Bool)arg4 allowSaveEpisode:(_Bool)arg5;
