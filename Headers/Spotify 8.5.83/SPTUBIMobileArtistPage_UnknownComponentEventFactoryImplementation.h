...
#import "SPTUBIMobileArtistPage_UnknownComponentEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileArtistPage_UnknownComponentEventFactoryImplementation : NSObject <SPTUBIMobileArtistPage_UnknownComponentEventFactory>
{
    NSArray *_components;
