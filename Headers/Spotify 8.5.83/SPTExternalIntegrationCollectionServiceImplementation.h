...
@protocol FollowFeature, SPTCollectionPlatformService, SPTContainerService, SPTExternalIntegrationCollectionController, SPTExternalIntegrationDebugLogService, SPTExternalIntegrationPlaybackService, SPTPlaylistPlatformService;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) __weak id <FollowFeature> followService; // @synthesize followService=_followService;
