...
@class NSArray, NSDictionary, NSString, SPTUBIMobileContextMenuInteractionEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenuInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileContextMenuInteractionEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobileContextMenuInteractionEventLocation *location; // @synthesize location=_location;
