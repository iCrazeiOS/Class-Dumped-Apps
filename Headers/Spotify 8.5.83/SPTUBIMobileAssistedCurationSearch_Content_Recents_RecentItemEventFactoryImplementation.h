...
#import "SPTUBIMobileAssistedCurationSearch_Content_Recents_RecentItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearch_Content_Recents_RecentItemEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearch_Content_Recents_RecentItemEventFactory>
{
    NSArray *_components;
