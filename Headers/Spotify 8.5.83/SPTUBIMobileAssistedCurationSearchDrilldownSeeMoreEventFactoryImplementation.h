...
#import "SPTUBIMobileAssistedCurationSearchDrilldownSeeMoreEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAssistedCurationSearchDrilldownSeeMoreEventFactoryImplementation : NSObject <SPTUBIMobileAssistedCurationSearchDrilldownSeeMoreEventFactory>
{
    NSArray *_components;
...
- (id)resultItemFactoryWithPosition:(long long)arg1 uri:(id)arg2 reason:(id)arg3;
- (id)absoluteLocation;
- (id)_location;
