...
@protocol GLUEImageLoader, SPTAudioPreviewModelFactory, SPTAudioPreviewUIFactory, SPTEncoreUserButtonFactory, SPTFreeTierAllSongsCellConfiguratorDelegate;
...
@property(readonly, nonatomic) id <SPTEncoreUserButtonFactory> userButtonFactory; // @synthesize userButtonFactory=_userButtonFactory;
...
- (id)provideAccessoryButtonWithIcon:(long long)arg1 iconColor:(id)arg2;
- (id)provideUserButtonWithAddedBy:(id)arg1;
...
- (Class)cellClass;
- (id)initWithViewURI:(id)arg1 theme:(id)arg2 viewModel:(id)arg3 imageLoader:(id)arg4 audioPreviewUIFactory:(id)arg5 audioPreviewModelFactory:(id)arg6 contextMenuPresenter:(id)arg7 userButtonFactory:(id)arg8 logger:(id)arg9;
