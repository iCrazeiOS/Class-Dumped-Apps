...
#import "SPTUBIMobileEditPlaylist_ChangeImageDialog_TakePhotoButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileEditPlaylist_ChangeImageDialog_TakePhotoButtonEventFactoryImplementation : NSObject <SPTUBIMobileEditPlaylist_ChangeImageDialog_TakePhotoButtonEventFactory>
{
    NSArray *_components;
