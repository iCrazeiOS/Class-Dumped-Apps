...
@optional
- (void)testManager:(SPTWatchPlatformTestManager *)arg1 didUpdateStreamingEnabledVersion:(long long)arg2;
- (void)testManager:(SPTWatchPlatformTestManager *)arg1 didUpdateAudioSessionActivationManagerEnabledState:(_Bool)arg2;
...
- (void)testManager:(SPTWatchPlatformTestManager *)arg1 didUpdateWatchStreamingBetaLabelVisibility:(long long)arg2;
