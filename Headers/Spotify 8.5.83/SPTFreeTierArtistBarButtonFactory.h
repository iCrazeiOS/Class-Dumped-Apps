...
@protocol SPTCollectionPlatformConfiguration, SPTContextMenuActionsProvider, SPTContextMenuPresenterFactory, SPTFollowModelFactory, SPTFreeTierArtistTestManager, SPTLogCenter, SPTModerationReportDecorationRegistry, SPTModerationServiceState, SPTUBIPageInstanceIdentifierProvider;
...
- (id)initWithCollectionConfiguration:(id)arg1 followModelFactory:(id)arg2 contextMenuPresenterFactory:(id)arg3 contextMenuActionFactory:(id)arg4 freeTierArtistTestManager:(id)arg5 logCenter:(id)arg6 decorationRegistry:(id)arg7 moderationFeatureState:(id)arg8 ubiLogger:(id)arg9 pageInstanceIdProvider:(id)arg10;
