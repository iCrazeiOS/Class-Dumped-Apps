...
#import "SPTUBIPDTMobileContextMenu_HideSongItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_HideSongItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_HideSongItemEventFactory>
{
    NSArray *_components;
