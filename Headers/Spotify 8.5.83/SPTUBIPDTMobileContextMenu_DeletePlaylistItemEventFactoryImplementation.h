...
#import "SPTUBIPDTMobileContextMenu_DeletePlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_DeletePlaylistItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_DeletePlaylistItemEventFactory>
{
    NSArray *_components;
