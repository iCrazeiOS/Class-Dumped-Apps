...
#import "SPTUBIPDTMobileContextMenu_AddToPlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_AddToPlaylistItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_AddToPlaylistItemEventFactory>
{
    NSArray *_components;
