...
@class NSMapTable, NSMutableArray, NSString, SPTObserverManager;

@interface SPTPageRegistryImplementation : NSObject <SPTPageRegistry>
{
    NSMutableArray *_featureRegistrations;
    NSMapTable *_featureRegistrationsMatches;
    NSMapTable *_featureRegistrationsURLs;
    SPTObserverManager *_observers;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) SPTObserverManager *observers; // @synthesize observers=_observers;
@property(readonly, nonatomic) NSMapTable *featureRegistrationsURLs; // @synthesize featureRegistrationsURLs=_featureRegistrationsURLs;
@property(readonly, nonatomic) NSMapTable *featureRegistrationsMatches; // @synthesize featureRegistrationsMatches=_featureRegistrationsMatches;
