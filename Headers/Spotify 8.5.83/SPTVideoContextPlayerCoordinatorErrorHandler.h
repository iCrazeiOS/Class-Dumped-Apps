...
@class NSString;
@protocol SPTAlertInterface, SPTBannerPresentationManager, SPTBannerPresentationManagerTicket;
...
- (id)initWithBannerPresentationManager:(id)arg1 alertInterface:(id)arg2;
