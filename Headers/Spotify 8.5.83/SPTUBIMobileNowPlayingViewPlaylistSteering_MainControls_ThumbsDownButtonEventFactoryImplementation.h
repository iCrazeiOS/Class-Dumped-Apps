...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_ThumbsDownButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_ThumbsDownButtonEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_MainControls_ThumbsDownButtonEventFactory>
{
    NSArray *_components;
