...
@protocol SPTAccountProductActivationController, SPTAlertInterface, SPTCollectionPlatform, SPTCollectionPlatformTestManager, SPTEmailVerificationHandler, SPTFeatureFlagSignal, SPTFollowModelFactory, SPTLinkDispatcher, SPTModalPresentationController, SPTNotificationPreferencesBackendIntegrator, SPTOnDemandSet, SPTPlayer, SPTPlaylistModel, SPTPodcastTestManager, SPTPushMessagingPermissionRequestor, SPTUIModeTransitionCoordinator, SPTWebViewFactory;
