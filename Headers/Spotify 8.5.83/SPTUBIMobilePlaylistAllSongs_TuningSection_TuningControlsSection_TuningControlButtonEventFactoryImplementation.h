...
#import "SPTUBIMobilePlaylistAllSongs_TuningSection_TuningControlsSection_TuningControlButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistAllSongs_TuningSection_TuningControlsSection_TuningControlButtonEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistAllSongs_TuningSection_TuningControlsSection_TuningControlButtonEventFactory>
{
    NSArray *_components;
