...
@protocol SPTUBIInteractionEvent, SPTUBILogger;
...
@property(copy, nonatomic) NSString *ubiInteractionID; // @synthesize ubiInteractionID=_ubiInteractionID;
