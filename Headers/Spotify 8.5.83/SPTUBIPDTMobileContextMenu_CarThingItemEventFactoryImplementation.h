...
#import "SPTUBIPDTMobileContextMenu_CarThingItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_CarThingItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_CarThingItemEventFactory>
{
    NSArray *_components;
