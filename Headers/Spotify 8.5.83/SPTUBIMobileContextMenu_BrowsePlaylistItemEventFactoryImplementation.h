...
#import "SPTUBIMobileContextMenu_BrowsePlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_BrowsePlaylistItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_BrowsePlaylistItemEventFactory>
{
    NSArray *_components;
