...
#import "SPTUBIPDTMobileContextMenu_ShowLyricsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ShowLyricsItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ShowLyricsItemEventFactory>
{
    NSArray *_components;
