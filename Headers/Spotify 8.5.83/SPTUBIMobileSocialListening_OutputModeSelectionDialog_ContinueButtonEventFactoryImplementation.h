...
#import "SPTUBIMobileSocialListening_OutputModeSelectionDialog_ContinueButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListening_OutputModeSelectionDialog_ContinueButtonEventFactoryImplementation : NSObject <SPTUBIMobileSocialListening_OutputModeSelectionDialog_ContinueButtonEventFactory>
{
    NSArray *_components;
