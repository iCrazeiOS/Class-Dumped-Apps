...
@class NSArray, NSDictionary, NSString, SPTUBIMobileNowPlayingViewPlaylistSteeringInteractionEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteeringInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileNowPlayingViewPlaylistSteeringInteractionEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobileNowPlayingViewPlaylistSteeringInteractionEventLocation *location; // @synthesize location=_location;
