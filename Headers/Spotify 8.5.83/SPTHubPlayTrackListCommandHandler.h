...
@protocol SPTHubInteractionLogger, SPTHubPlayTrackListCommandHandlerDelegate, SPTPlayer, SPTUBIHubsUtilities, SPTUBIPageInstanceIdentifierProvider;
...
- (id)initWithPlayer:(id)arg1 interactionLogger:(id)arg2 ubiHubsInstrumentation:(id)arg3 pageInstanceIdProvider:(id)arg4;
