...
@class GLUETableViewCellStyle, NSArray, NSString, NSURL, SPTAdMobileOverlayController, SPTAdRegistryInformationManager, SPTAdTestingHandler, SPTAdsViewModel, SPTPlayerMftCanPlayChecker, SettingsTextFieldTableViewCell, UITableView;
@protocol GLUETheme, SPTAdsBaseCosmosBridge, SPTAdsBaseGlobalSettingsController, SPTContainerUIService, SPTPageContainer;
...
- (void)dealloc;
- (id)initWithCosmosBridge:(id)arg1 testingHandler:(id)arg2 adsViewModel:(id)arg3 adSettingsController:(id)arg4 mobileOverlayController:(id)arg5 closeMenuBlock:(CDUnknownBlockType)arg6 mftRules:(id)arg7 linkDispatcher:(id)arg8 containerService:(id)arg9 adInformationManager:(id)arg10 glueTheme:(id)arg11;
