...
#import "SPTUBIMobileEditPlaylist_ErrorDialog_CancelButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileEditPlaylist_ErrorDialog_CancelButtonEventFactoryImplementation : NSObject <SPTUBIMobileEditPlaylist_ErrorDialog_CancelButtonEventFactory>
{
    NSArray *_components;
