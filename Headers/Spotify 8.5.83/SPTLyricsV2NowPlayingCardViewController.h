...
@class NSString, NSTimer, NSURL, SPTLyricsV2Colors, SPTLyricsV2Configuration, SPTLyricsV2FullscreenViewController, SPTLyricsV2GLUETheme, SPTLyricsV2LyricsViewController, SPTLyricsV2Model, SPTLyricsV2NowPlayingCardView, SPTLyricsV2SharingFlowCoordinator, SPTPlayerTrack, SPTVocalRemovalConfiguration;
...
{
    _Bool _didCardBecomeFullyVisible;
    _Bool _didLoadShareDestinations;
    NSString *_cardTitle;
    ...
    NSTimer *_vocalRemovalButtonAnimationTimer;
    NSURL *_imageURL;
    SPTLyricsV2Model *_lyricsModel;
    SPTLyricsV2FullscreenViewController *_fullscreenViewController;
    SPTLyricsV2SharingFlowCoordinator *_sharingFlowCoordinator;
    SPTPlayerTrack *_track;
    id <SPTNowPlayingService> _nowPlayingService;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool didLoadShareDestinations; // @synthesize didLoadShareDestinations=_didLoadShareDestinations;
@property(nonatomic) _Bool didCardBecomeFullyVisible; // @synthesize didCardBecomeFullyVisible=_didCardBecomeFullyVisible;
...
@property(retain, nonatomic) SPTLyricsV2SharingFlowCoordinator *sharingFlowCoordinator; // @synthesize sharingFlowCoordinator=_sharingFlowCoordinator;
...
@property(retain, nonatomic) NSTimer *vocalRemovalButtonAnimationTimer; // @synthesize vocalRemovalButtonAnimationTimer=_vocalRemovalButtonAnimationTimer;
...
- (void)startShareFlow:(_Bool)arg1;
- (void)startShareFlow;
...
- (void)vocalRemovalButtonTapped;
- (void)openFullscreenViewWithVocalRemovalEnabled:(_Bool)arg1;
