...
#import "SPTUBIPDTMobileContextMenu_ToggleShuffleModeItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ToggleShuffleModeItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ToggleShuffleModeItemEventFactory>
{
    NSArray *_components;
