...
#import "SPTUBIMobileContextMenu_RemoveFromPlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_RemoveFromPlaylistItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_RemoveFromPlaylistItemEventFactory>
{
    NSArray *_components;
