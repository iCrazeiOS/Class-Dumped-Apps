...
#import "SPTVideoMediaURLFactory-Protocol.h"

@class NSString, SPTVideoFeatureProperties;

@interface SPTVideoMediaURLFactoryImpl : NSObject <SPTVideoMediaURLFactory>
{
...
- (id)initWithVideoFeatureProperties:(id)arg1;
