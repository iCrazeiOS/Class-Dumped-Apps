...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_HeartButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_HeartButtonEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_TrackInformation_HeartButtonEventFactory>
{
    NSArray *_components;
