...
- (id)initWithCollectionController:(id)arg1 contentController:(id)arg2 driverDistractionController:(id)arg3 playbackController:(id)arg4 radioController:(id)arg5 searchController:(id)arg6 queueController:(id)arg7 platformLogging:(id)arg8 objectFactory:(id)arg9;
