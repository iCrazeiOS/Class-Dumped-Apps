...
#import "SPTUBIMobilePlaylistEntity_TuneButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_TuneButtonEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_TuneButtonEventFactory>
{
    NSArray *_components;
