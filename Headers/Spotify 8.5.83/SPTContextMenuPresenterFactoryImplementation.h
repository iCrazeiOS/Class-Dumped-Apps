...
- (id)contextMenuPresenterForTrackWithTrackURL:(id)arg1 trackName:(id)arg2 trackMetadata:(id)arg3 playable:(_Bool)arg4 imageURL:(id)arg5 artists:(id)arg6 albumName:(id)arg7 albumURL:(id)arg8 viewURL:(id)arg9 contextSourceURL:(id)arg10 metadataTitle:(id)arg11 logContextIphone:(id)arg12 logContextIpad:(id)arg13 senderView:(id)arg14 options:(id)arg15 ubiPageInstanceId:(id)arg16;
- (id)contextMenuPresenterForTrackWithTrackURL:(id)arg1 trackName:(id)arg2 trackMetadata:(id)arg3 playable:(_Bool)arg4 imageURL:(id)arg5 artists:(id)arg6 albumName:(id)arg7 albumURL:(id)arg8 viewURL:(id)arg9 contextSourceURL:(id)arg10 metadataTitle:(id)arg11 logContextIphone:(id)arg12 logContextIpad:(id)arg13 senderView:(id)arg14 options:(id)arg15;
- (id)contextMenuPresenterForHeaderImageURL:(id)arg1 headerImagePlaceholder:(id)arg2 imageStyle:(long long)arg3 title:(id)arg4 subtitle:(id)arg5 metadataTitle:(id)arg6 actions:(id)arg7 entityURL:(id)arg8 trackURL:(id)arg9 headerSubtitleStyle:(long long)arg10 senderView:(id)arg11 options:(id)arg12 ubiPageInstanceId:(id)arg13;
...
- (id)contextMenuPresenterForHeaderImageURL:(id)arg1 headerImagePlaceholder:(id)arg2 imageStyle:(long long)arg3 title:(id)arg4 subtitle:(id)arg5 metadataTitle:(id)arg6 tasks:(id)arg7 entityURL:(id)arg8 trackURL:(id)arg9 headerSubtitleStyle:(long long)arg10 senderView:(id)arg11 options:(id)arg12 ubiPageInstanceId:(id)arg13;
