...
#import "SPTUBIMobileSocialListening_ScanningEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileSocialListening_ScanningEventFactoryImplementation : NSObject <SPTUBIMobileSocialListening_ScanningEventFactory>
{
    NSArray *_components;
