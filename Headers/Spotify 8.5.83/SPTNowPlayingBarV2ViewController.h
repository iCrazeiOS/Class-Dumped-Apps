...
@class NSString, NSURL, SPTNowPlayingBackgroundViewModel, SPTNowPlayingBarLeftAccessoryUnitProvider, SPTNowPlayingBarLogger, SPTNowPlayingBarModel, SPTNowPlayingDurationViewV2, SPTNowPlayingLogger, SPTTheme, UIView;
@protocol SPTNowPlayingDurationUnitViewModel, SPTNowPlayingManager, SPTNowPlayingTestManager, SPTPageContainer;

@interface SPTNowPlayingBarV2ViewController : UIViewController <SPTNowPlayingUnitProviderObserver, SPTNowPlayingDurationViewV2DataSource, SPTNowPlayingDurationUnitViewModelDelegate, SPTNowPlayingBackgroundViewModelDelegate, SPTBarInteractiveTransitionParticipant, SPTPageController>
{
    SPTTheme *_theme;
...
@property(readonly, nonatomic) SPTNowPlayingBackgroundViewModel *backgroundViewModel; // @synthesize backgroundViewModel=_backgroundViewModel;
...
- (void)viewDidLoad;
- (id)initWithTheme:(id)arg1 model:(id)arg2 nowPlayingManager:(id)arg3 barViewController:(id)arg4 leftAccessoryUnitProvider:(id)arg5 animationView:(id)arg6 durationViewModel:(id)arg7 logger:(id)arg8 barLogger:(id)arg9 backgroundViewModel:(id)arg10 testManager:(id)arg11;
