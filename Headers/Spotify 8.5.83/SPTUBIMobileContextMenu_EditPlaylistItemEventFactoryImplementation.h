...
#import "SPTUBIMobileContextMenu_EditPlaylistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_EditPlaylistItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_EditPlaylistItemEventFactory>
{
    NSArray *_components;
