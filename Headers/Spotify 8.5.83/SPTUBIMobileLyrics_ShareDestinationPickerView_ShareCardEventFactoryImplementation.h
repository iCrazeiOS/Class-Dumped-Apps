...
#import "SPTUBIMobileLyrics_ShareDestinationPickerView_ShareCardEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileLyrics_ShareDestinationPickerView_ShareCardEventFactoryImplementation : NSObject <SPTUBIMobileLyrics_ShareDestinationPickerView_ShareCardEventFactory>
{
    NSArray *_components;
