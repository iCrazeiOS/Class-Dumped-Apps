...
#import "SPTUBIPDTMobileContextMenu_AddReportItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_AddReportItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_AddReportItemEventFactory>
{
    NSArray *_components;
