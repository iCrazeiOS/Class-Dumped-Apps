...
#import "SPTUBIMobileYourLibraryPlaylists_ItemList_YourEpisodesEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileYourLibraryPlaylists_ItemList_YourEpisodesEventFactoryImplementation : NSObject <SPTUBIMobileYourLibraryPlaylists_ItemList_YourEpisodesEventFactory>
{
    NSArray *_components;
