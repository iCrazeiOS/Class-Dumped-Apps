...
@class NSString, SPTAppProtocolBackgroundTask, UIApplication;
@protocol SPTAccessoryStateManager, SPTAppProtocolBackgroundControllerDelegate, SPTAudioSessionActivator, SPTAudioSessionController, SPTExternalIntegrationDebugLog, SPTExternalIntegrationPlaybackController, SPTGaiaConnectAPI;
...
- (void)shutdown;
- (void)dealloc;
- (id)initWithApplication:(id)arg1 playbackController:(id)arg2 accessoryStateManager:(id)arg3 connectManager:(id)arg4 backgroundTask:(id)arg5 debugLog:(id)arg6;
