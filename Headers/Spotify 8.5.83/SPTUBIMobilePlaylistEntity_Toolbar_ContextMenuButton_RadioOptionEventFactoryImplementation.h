...
#import "SPTUBIMobilePlaylistEntity_Toolbar_ContextMenuButton_RadioOptionEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobilePlaylistEntity_Toolbar_ContextMenuButton_RadioOptionEventFactoryImplementation : NSObject <SPTUBIMobilePlaylistEntity_Toolbar_ContextMenuButton_RadioOptionEventFactory>
{
    NSArray *_components;
