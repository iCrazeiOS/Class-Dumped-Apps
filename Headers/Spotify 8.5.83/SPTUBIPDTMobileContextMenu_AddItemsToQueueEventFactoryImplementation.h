...
#import "SPTUBIPDTMobileContextMenu_AddItemsToQueueEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_AddItemsToQueueEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_AddItemsToQueueEventFactory>
{
    NSArray *_components;
