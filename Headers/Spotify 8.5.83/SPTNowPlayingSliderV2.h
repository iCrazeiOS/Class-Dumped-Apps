...
@interface SPTNowPlayingSliderV2 : SPTSliderWithLabel
{
    ...
    double _accessibilityIncrementStep;
...
@property(nonatomic) double accessibilityIncrementStep; // @synthesize accessibilityIncrementStep=_accessibilityIncrementStep;
