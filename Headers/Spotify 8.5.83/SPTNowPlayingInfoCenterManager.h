...
{
    _Bool _shouldShowConcatenatedAdvertiserTitle;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool shouldShowConcatenatedAdvertiserTitle; // @synthesize shouldShowConcatenatedAdvertiserTitle=_shouldShowConcatenatedAdvertiserTitle;
