...
#import "SPTUBIMobileContextMenu_RemoveSleepTimerItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_RemoveSleepTimerItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_RemoveSleepTimerItemEventFactory>
{
    NSArray *_components;
