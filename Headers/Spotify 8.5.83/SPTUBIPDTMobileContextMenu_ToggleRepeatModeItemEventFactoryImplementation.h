...
#import "SPTUBIPDTMobileContextMenu_ToggleRepeatModeItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIPDTMobileContextMenu_ToggleRepeatModeItemEventFactoryImplementation : NSObject <SPTUBIPDTMobileContextMenu_ToggleRepeatModeItemEventFactory>
{
    NSArray *_components;
