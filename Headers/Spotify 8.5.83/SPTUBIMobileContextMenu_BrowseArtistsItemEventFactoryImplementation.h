...
#import "SPTUBIMobileContextMenu_BrowseArtistsItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_BrowseArtistsItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_BrowseArtistsItemEventFactory>
{
    NSArray *_components;
