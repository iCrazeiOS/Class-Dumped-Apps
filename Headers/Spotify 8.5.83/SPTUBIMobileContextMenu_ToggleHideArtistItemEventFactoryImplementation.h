...
#import "SPTUBIMobileContextMenu_ToggleHideArtistItemEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileContextMenu_ToggleHideArtistItemEventFactoryImplementation : NSObject <SPTUBIMobileContextMenu_ToggleHideArtistItemEventFactory>
{
    NSArray *_components;
