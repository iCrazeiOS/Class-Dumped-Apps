...
@class NSArray, NSDictionary, NSString, SPTUBIMobileAdsBookmarkButtonInteractionEventLocation;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileAdsBookmarkButtonInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileAdsBookmarkButtonInteractionEventLocation *_location;
...
@property(retain, nonatomic) SPTUBIMobileAdsBookmarkButtonInteractionEventLocation *location; // @synthesize location=_location;
