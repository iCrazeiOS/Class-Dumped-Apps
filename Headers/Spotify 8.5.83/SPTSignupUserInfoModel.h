...
@class NSArray, NSCalendar, NSDate, NSDictionary, NSString, NSURL, SPTSignupMarketRestrictionsModel, SPTSignupTermsAndPolicyAcceptanceModel;
...
@interface SPTSignupUserInfoModel : NSObject <SPTSignupDataLoaderDelegate, SPTSignupTermsAndPolicyViewConfiguration>
{
    ...
    SPTSignupTermsAndPolicyAcceptanceModel *_termsAcceptanceModel;
...
@property(retain, nonatomic) SPTSignupTermsAndPolicyAcceptanceModel *termsAcceptanceModel; // @synthesize termsAcceptanceModel=_termsAcceptanceModel;
