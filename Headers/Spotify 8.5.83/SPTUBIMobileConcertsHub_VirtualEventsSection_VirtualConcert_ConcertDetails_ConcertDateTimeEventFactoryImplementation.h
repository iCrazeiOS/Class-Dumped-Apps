...
#import "SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcert_ConcertDetails_ConcertDateTimeEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcert_ConcertDetails_ConcertDateTimeEventFactoryImplementation : NSObject <SPTUBIMobileConcertsHub_VirtualEventsSection_VirtualConcert_ConcertDetails_ConcertDateTimeEventFactory>
{
    NSArray *_components;
