...
#import "SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBar_ShareButtonEventFactory-Protocol.h"

@class NSArray, NSString;
@protocol SPTUBIEventAbsoluteLocation;

@interface SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBar_ShareButtonEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewPlaylistSteering_BottomBar_ShareButtonEventFactory>
{
    NSArray *_components;
