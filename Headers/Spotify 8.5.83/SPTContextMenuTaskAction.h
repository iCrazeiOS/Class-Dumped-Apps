...
#import "SPTContextMenuActionLogging-Protocol.h"
#import "SPTDismissContextMenuAction-Protocol.h"

@class NSString, SPAction, SPTask;
@protocol SPTContextMenuTaskActionDelegate;

@interface SPTContextMenuTaskAction : NSObject <SPTContextMenuAction, SPTDismissContextMenuAction, SPTContextMenuActionLogging>
{
    _Bool _valid;
