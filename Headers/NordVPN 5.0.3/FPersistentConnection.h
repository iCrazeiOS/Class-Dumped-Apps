...
#import "FConnectionDelegate-Protocol.h"

@class FAtomicNumber, FConnection, FIRDatabaseConfig, FIRRetryHelper, FRepoInfo, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString;
@protocol FAuthTokenProvider, FPersistentConnectionDelegate, OS_dispatch_queue;

@interface FPersistentConnection : NSObject <FConnectionDelegate>
{
    int connectionState;
    _Bool firstConnection;
...
@property(nonatomic) _Bool forceAuthTokenRefresh; // @synthesize forceAuthTokenRefresh=_forceAuthTokenRefresh;
...
@property(nonatomic) _Bool pauseWrites; // @synthesize pauseWrites=_pauseWrites;
...
- (void)sendAction:(id)arg1 body:(id)arg2 sensitive:(_Bool)arg3 callback:(CDUnknownBlockType)arg4;
...
- (void)sendUnauth;
- (void)sendAuthAndRestoreStateAfterComplete:(_Bool)arg1;
- (void)setupNotifications;
- (void)enteringForeground;
- (void)openNetworkConnectionWithToken:(id)arg1;
- (void)tryScheduleReconnect;
- (_Bool)isInterruptedForReason:(id)arg1;
