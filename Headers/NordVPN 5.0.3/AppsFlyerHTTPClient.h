...
- (id)requestWithURL:(CDUnknownBlockType)arg1 URLRequest:(CDUnknownBlockType)arg2 HTTPMethod:(id)arg3 dictionary:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
