...
@class AVPlayerLayer, NFUIPlaybackRequest, NFUIPlayerLogger, NFUISubtitleConfiguration, NSArray, NSDictionary, NSOrderedSet, NSString, UIView;
...
@property(nonatomic) long long audioMixing;
...
- (_Bool)selectSubtitleLanguage:(NSString *)arg1 makeSticky:(_Bool)arg2;
