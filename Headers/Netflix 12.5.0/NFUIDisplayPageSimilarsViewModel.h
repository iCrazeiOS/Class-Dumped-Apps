...
@interface NFUIDisplayPageSimilarsViewModel : NSObject <NFUIDisplayPageSimilarsCellListViewModelProtocol>
{
    NSArray *_items;
...
- (id)initWithSimilarsEntity:(id)arg1 withPlaybackSourceModel:(id)arg2 objectContext:(id)arg3;
