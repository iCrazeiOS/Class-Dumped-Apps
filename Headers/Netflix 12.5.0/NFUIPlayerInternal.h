...
@class AVPlayerLayer, NFLXOperation, NFUIPlayerController, NFUIPlayerLogger, NFUIPlayerView, NFUIPlayerViewController, NSDictionary, NSMutableArray, NSString, UIView;
...
- (_Bool)selectSubtitleLanguage:(id)arg1 makeSticky:(_Bool)arg2;
