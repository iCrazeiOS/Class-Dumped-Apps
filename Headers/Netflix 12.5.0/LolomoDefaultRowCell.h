...
@interface LolomoDefaultRowCell : LolomoAbstractEntityRowCell <LolomoRowCell, NFUICellFactoryItemProtocol>
{
}
...
- (void)didEndDisplayingMotionCells;
- (void)willDisplayMotionCells;
