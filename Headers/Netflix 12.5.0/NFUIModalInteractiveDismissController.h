...
#import "NFUIInteractiveTransitioningProtocol-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class NSString, UIGestureRecognizer;

@interface NFUIModalInteractiveDismissController : UIPercentDrivenInteractiveTransition <UIGestureRecognizerDelegate, NFUIInteractiveTransitioningProtocol>
{
...
- (id)initWithStateChangeBlock:(CDUnknownBlockType)arg1 conditionBlock:(CDUnknownBlockType)arg2;
