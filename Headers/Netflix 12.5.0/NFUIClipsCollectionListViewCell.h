...
#import "NFUIClipsCellDimmingProtocol-Protocol.h"
...
@interface NFUIClipsCollectionListViewCell : NFUIFamiliarityViewCell <NFUIFamiliarityViewCellProtocol, NFUICellFactoryItemProtocol, NFUICellSelectionProtocol, NFUIClipsCellDimmingProtocol, NFUIScrollViewPercentageVisibleDelegateProtocol>
{
...
- (void)dim:(_Bool)arg1;
- (void)toggleSelectionState:(_Bool)arg1 forIndexPath:(id)arg2 currentlyPlaying:(_Bool)arg3;
