...
@class CAGradientLayer, NFUIAnimatedPlayButton, NFUIAnimatedSeekButton, NFUIInlinePlaybackRequest, NFUILabel, NFUIMiniPlayerControlsView, NFUIMiniPlayerFooterView, NFUIPassThroughView, NFUIPinProtectionDialogView, NFUIPlayerLoadingView, NFUIStylizedLabel, NFUISystemVolumeViewRefresh, NFUITrickPlayController, NFUITrickPlayModelInternal, NFUIVolumeMuteButton, NSArray, NSLayoutConstraint, NSNumber, NSString, NSTimer, NSURL, UIButton, UIColor, UIImageView, UILabel, UIPinchGestureRecognizer, UIStackView, UITapGestureRecognizer, UIView;
@protocol NFUIMiniPlayerDelegate, NFUIPlayer;

@interface NFUIMiniPlayerViewController : UIViewController <NFUIPlayerDelegate, UIGestureRecognizerDelegate, NFUIPlayerScrubberDelegate, NFUISystemVolumeProtocol, NFUIPinProtectionDialogViewDelegate>
{
    ...
    NFUIInlinePlaybackRequest *_playbackRequest;
}

@property(retain, nonatomic) NFUIInlinePlaybackRequest *playbackRequest; // @synthesize playbackRequest=_playbackRequest;
...
- (void)handlePlayerState:(unsigned long long)arg1 isDelegateCall:(_Bool)arg2;
