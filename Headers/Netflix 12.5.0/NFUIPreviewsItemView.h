...
@class NFUINetworkErrorViewController, NFUIPreviewVideoViewModel, NFUIPreviewsLoadingView, NSString, UILabel;
@protocol NFUIVideoViewDelegate;

@interface NFUIPreviewsItemView : UIView <NFUIPlayerDelegate, NFUINetworkErrorViewControllerDelegate, NFUIReusableVideoViewProtocol>
{
