...
@class AWEProgressLoadingView, NSString, UIButton, UIImageView, UILabel, UIView;

@interface AWEPreLoginMessageViewController : UIViewController <AWEUserMessage, AWEUserLoginMessage>
{
    UIView *_contentView;
