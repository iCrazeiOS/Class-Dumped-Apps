...
#import "AWEReportProtocol-Protocol.h"

@class AWEProgressLoadingView, NSMutableDictionary, NSString, UITapGestureRecognizer;

@interface AWEReportManager : NSObject <AWEReportProtocol>
{
...
- (void)_reportWithType:(unsigned long long)arg1 objectID:(id)arg2 ownerID:(id)arg3 content:(id)arg4 roomID:(id)arg5 isSpam:(_Bool)arg6 extraParam:(id)arg7;
