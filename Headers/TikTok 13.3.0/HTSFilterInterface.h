...
@interface HTSFilterInterface : NSObject
{
    ...
    NSString *_filterID;
    struct HTSGPUTextureOptions _outputTextureOptions;
}
...
@property(nonatomic) struct HTSGPUTextureOptions outputTextureOptions; // @synthesize outputTextureOptions=_outputTextureOptions;
...
- (id)switchMultiFrameBuffer:(int)arg1 bufferHeight:(int)arg2;
- (void)dealloc;
