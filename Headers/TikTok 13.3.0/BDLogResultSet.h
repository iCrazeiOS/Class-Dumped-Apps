...
@class BDLogDatabase, BDLogStatement, NSMutableDictionary, NSString;

@interface BDLogResultSet : NSObject
{
    BDLogDatabase *_parentDB;
    BDLogStatement *_statement;
    NSString *_query;
    NSMutableDictionary *_columnNameToIndexMap;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) BDLogStatement *statement; // @synthesize statement=_statement;
