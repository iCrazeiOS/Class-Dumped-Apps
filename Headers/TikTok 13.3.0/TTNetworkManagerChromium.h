...
- (id)requestForBinaryWithURL_:(id)arg1 params:(id)arg2 method:(id)arg3 needCommonParams:(_Bool)arg4 headerField:(id)arg5 enableHttpCache:(_Bool)arg6 requestSerializer:(Class)arg7 responseSerializer:(Class)arg8 autoResume:(_Bool)arg9 headerCallback:(CDUnknownBlockType)arg10 dataCallback:(CDUnknownBlockType)arg11 callback:(CDUnknownBlockType)arg12 callbackWithResponse:(CDUnknownBlockType)arg13 redirectCallback:(CDUnknownBlockType)arg14 progress:(id *)arg15 dispatch_queue:(id)arg16;
