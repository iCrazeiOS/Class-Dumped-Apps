...
@interface AWEShareDetailWithQRCodeBaseContentView : UIView <AWEShareDetailWithQRCodeBaseContentViewLayout>
{
    ...
    UIView *_shareGuideView;
}

@property(retain, nonatomic) UIView *shareGuideView; // @synthesize shareGuideView=_shareGuideView;
...
- (id)initWithShareGuideStyle:(unsigned long long)arg1;
