...
@class NSString;
@protocol HTSLiveMessageDispatchProvider, IESLiveEnvironment, IESLiveHTTPClient, IESLiveTracker;
...
- (void).cxx_destruct;
- (void)reportShareInfoWithRoomModel:(id)arg1 shareType:(long long)arg2 platform:(id)arg3 currentUser:(id)arg4 eventContext:(id)arg5;
