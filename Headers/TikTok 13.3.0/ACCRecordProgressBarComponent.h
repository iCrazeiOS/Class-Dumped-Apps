...
@class AWEStudioVideoProgressView, NSMutableArray, NSString, UIViewController;
@protocol ACCCaptureComponentProtocol, ACCComponentBusProtocol, ACCComponentProtocol, ACCPotteryComponentProtocol, ACCRecordConfigPublishComponentProtocol, ACCRecordRootComponentProtocol;

@interface ACCRecordProgressBarComponent : NSObject <ACCCaptureComponentMessageProtocol, ACCRecordProgressBarComponentProtocol, ACCRecordSelectMusicComponentMessage, ACCRecordFlowComponentMessageProtocol, ACCPotteryComponentMessageProtocol, ACCRecordSwitchModeComponentMessageProtocol, ACCGameComponentMessageProtocol>
{
