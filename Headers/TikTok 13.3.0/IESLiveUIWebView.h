...
@class IESLiveUIWebViewDelegateWrapper, NSMutableSet, NSString, UIScrollView;
@protocol IESLiveJSBridgeProtocol, IESLiveWebViewDelegate, IESLiveWebViewService;

@interface IESLiveUIWebView : IESUIWebView <IESLiveWebViewProtocol>
{
    IESLiveUIWebViewDelegateWrapper *_delegateWrapper;
...
@property(retain, nonatomic) IESLiveUIWebViewDelegateWrapper *delegateWrapper; // @synthesize delegateWrapper=_delegateWrapper;
- (void).cxx_destruct;
- (void)setTimeStampOfWebPageWithDict:(id)arg1;
@property(nonatomic) __weak id <IESLiveWebViewDelegate> liveWebViewDelegate; // @dynamic liveWebViewDelegate;
- (_Bool)isInnerWK;
