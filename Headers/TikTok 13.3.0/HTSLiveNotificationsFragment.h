...
@class HTSEventContext, HTSLiveAnimationStore, HTSLiveNativeAnimationScheduler, IESLiveComponentContext, NSString;
@protocol HTSLiveTemplateProvider, HTSLiveViewHierarchyProvider, IESLiveAlertFactory, IESLiveEnvironment, IESLiveRpcService, IESLiveSettings, IESLiveTracker, IESLiveURLSchemaHandler, IESLiveUserService;
...
- (void)dispatchTopRegionAnimationWithMessage:(id)arg1 extra:(id)arg2;
- (void)dispatchTop20AnchorAnimationWithMessage:(id)arg1;
- (void)dispatchTop3AnchorAnimationWithMessage:(id)arg1 extra:(id)arg2;
