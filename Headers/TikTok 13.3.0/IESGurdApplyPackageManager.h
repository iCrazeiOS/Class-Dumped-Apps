...
- (void)traceEventWithInactiveMeta:(id)arg1 message:(id)arg2;
- (void)handleApplyResult:(_Bool)arg1 error:(id)arg2 inactiveMeta:(id)arg3;
- (void)innerUnzipWebCacheWithMeta:(id)arg1 zipFilePath:(id)arg2 targetPath:(id)arg3 tempPath:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (id)channelDirectoryPathForAccessKey:(id)arg1 channel:(id)arg2 createIfNeeded:(_Bool)arg3;
