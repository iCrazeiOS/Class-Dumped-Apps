...
@property(nonatomic) _Bool shouldUseExploreStyle; // @synthesize shouldUseExploreStyle=_shouldUseExploreStyle;
...
- (void)p_loadRecommendWithCursor:(id)arg1 count:(id)arg2 completion:(CDUnknownBlockType)arg3;
