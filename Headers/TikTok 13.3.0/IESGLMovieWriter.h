...
@class AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, HTSGLContext, HTSGLFramebuffer, HTSGLProgram, NSArray, NSString, NSURL, VEAudioEncodeConfig;
