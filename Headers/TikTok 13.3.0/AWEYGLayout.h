...
@interface AWEYGLayout : NSObject
{
    _Bool _isEnabled;
    _Bool _isIncludedInLayout;
    struct YGNode *_node;
    id <AWEYGViewProtocol> _view;
    id <AWEYGViewProtocol> _parent;
    NSMutableArray *_childrens;
}

+ (void)initialize;
@property(retain, nonatomic) NSMutableArray *childrens; // @synthesize childrens=_childrens;
@property(nonatomic) __weak id <AWEYGViewProtocol> parent; // @synthesize parent=_parent;
@property(readonly, nonatomic) __weak id <AWEYGViewProtocol> view; // @synthesize view=_view;
