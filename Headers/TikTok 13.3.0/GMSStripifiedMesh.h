...
- (id)initWithRenderOpInfo:(id)arg1 vertices:(vector_b547f507 *)arg2 strips:(id)arg3 edgeIndices:(vector_3203cf93 *)arg4 normals:(vector_1a85bb8f *)arg5 normalIndices:(vector_3203cf93 *)arg6 stylingID:(const struct StyleID *)arg7 rank:(short)arg8 attributes:(unsigned int)arg9;
