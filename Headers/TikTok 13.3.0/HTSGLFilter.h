...
@class HTSGLContext, HTSGLFramebuffer, HTSGLProgram, NSMutableDictionary, NSObject, NSString;
@protocol OS_dispatch_semaphore;

@interface HTSGLFilter : HTSFilterInterface <HTSGLInput>
{
    HTSGLFramebuffer *firstInputFramebuffer;
    HTSGLProgram *filterProgram;
...
- (void)setVec4:(struct HTSGPUVector4)arg1 forUniform:(int)arg2 program:(id)arg3;
- (void)setVec3:(struct HTSGPUVector3)arg1 forUniform:(int)arg2 program:(id)arg3;
...
- (void)setMatrix4f:(struct HTSGPUMatrix4x4)arg1 forUniform:(int)arg2 program:(id)arg3;
- (void)setMatrix3f:(struct HTSGPUMatrix3x3)arg1 forUniform:(int)arg2 program:(id)arg3;
