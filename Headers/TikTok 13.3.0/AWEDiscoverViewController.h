...
@interface AWEDiscoverViewController : UIViewController <BTDRouterViewControllerProtocol, AWEReferenceTrackable, UISearchBarDelegate, AWESearchMiddleProtocol, UIScrollViewDelegate, AWEIsTabAwaring>
{
    _Bool _isTab;
