...
@class AWEDiscoverCategoryModel, AWEDiscoverCellTopView, AWEDiscoverCollectionViewFooter, NSHashTable, NSIndexPath, NSString, UICollectionView, UIView;
...
@interface AWEDiscoverTableViewCell : UITableViewCell <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AWEDiscoverCellTopViewDelegate, AWEPreviewable, AWEZoomTransitionOuterContextProvider>
{
    ...
    CDUnknownBlockType _imageLoadCompletionBlock;
...
@property(copy, nonatomic) CDUnknownBlockType imageLoadCompletionBlock; // @synthesize imageLoadCompletionBlock=_imageLoadCompletionBlock;
