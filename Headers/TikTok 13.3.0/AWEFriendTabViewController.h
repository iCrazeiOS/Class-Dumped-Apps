...
@class AWEFollowFeedViewController, AWESlidingTabbarView, AWESlidingViewController, AWEVideoPublishViewModel, NSMutableArray, NSString, UIButton, UILabel, UIView, UIWindow;

@interface AWEFriendTabViewController : UIViewController <AWESlidingViewControllerDelegate, AWEViewControllerRefreshable, AWEUserMessage, UIScrollViewDelegate>
{
    _Bool _isNavStick;
...
- (void).cxx_destruct;
- (_Bool)p_shouldShowFriendListEntrance;
- (_Bool)p_shouldShowFriendTab;
