...
@class AVMutableAudioMix, AVMutableComposition, HTSMediaExporter, HTSVideoData, NSArray, NSMutableDictionary, NSObject, NSString;
...
+ (id)mixPlayerWithVideoData:(id)arg1 usedForAVPlayLayer:(_Bool)arg2;
+ (id)audioPlayerWithVideoData:(id)arg1;
+ (id)mixPlayerWithVideoData:(id)arg1 useNewModule:(_Bool)arg2 usedForAVPlayLayer:(_Bool)arg3;
+ (id)createItemWith:(id)arg1 useNewModule:(_Bool)arg2 processAudio:(_Bool)arg3 usedForAVPlayLayer:(_Bool)arg4;
+ (id)createItemWith:(id)arg1 useNewModule:(_Bool)arg2 processAudio:(_Bool)arg3;
...
- (id)applyAudioFilterWithType:(int)arg1 config:(id)arg2 atAudioIndex:(unsigned long long)arg3;
- (_Bool)removeVideoSoundFilter:(id)arg1;
- (id)applyAudioFilterWithType:(int)arg1 config:(id)arg2 forVideoAsset:(id)arg3;
- (id)applyAudioFilterWithType:(int)arg1 config:(id)arg2 atVideoIndex:(unsigned long long)arg3;
...
- (void)dealloc;
- (void)releaseMTAudioTapWithMix:(id)arg1;
