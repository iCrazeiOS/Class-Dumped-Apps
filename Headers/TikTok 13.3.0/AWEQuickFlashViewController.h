...
@class AWEAdWebViewController, NSArray, NSString, UIButton, UIImageView, UILabel, UIView;
...
+ (id)quickFlashViewControllerWithRequestURL:(id)arg1 loadingText:(id)arg2 userID:(id)arg3 viewDidAppearBlock:(CDUnknownBlockType)arg4;
