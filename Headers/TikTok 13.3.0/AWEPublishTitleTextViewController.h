...
@protocol AWEPublishTitleEditViewControllerDelegate, AWETextInputControllerProtocol;
...
@interface AWEPublishTitleTextViewController : UIViewController <UITextViewDelegate, AWETextInputControllerDelegate>
{
    ...
    AWEAnimatedButton *_poiButton;
}

@property(retain, nonatomic) AWEAnimatedButton *poiButton; // @synthesize poiButton=_poiButton;
