...
@class AVVideoCompositionRenderContext, HTSOGLRenderer, NSDictionary, NSString;
@protocol OS_dispatch_queue;

@interface HTSCompositor : NSObject <AVVideoCompositing>
{
    ...
    HTSOGLRenderer *_oglRenderer;
}

@property(retain, nonatomic) HTSOGLRenderer *oglRenderer; // @synthesize oglRenderer=_oglRenderer;
...
- (void).cxx_destruct;
- (struct __CVBuffer *)newRenderedPixelBufferForRequest:(id)arg1;
