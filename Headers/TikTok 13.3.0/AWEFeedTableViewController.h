...
@class AWEAnimatedButton, AWEAwemeModel, AWEFeedSkylightLiveView, AWEFollowEmptyHintViewController, AWEListDataController, AWEMainConcernLoginView, AWEUILoadingView, NSMutableArray, NSMutableDictionary, NSString, UIPanGestureRecognizer, UIScrollView, UITableView, UITableViewCell, UIView;
@protocol AWEFeedTableViewCellProtocol, AWELiveSkylightViewControllerProtocol, AWEWebViewLoadTaskMessage;

@interface AWEFeedTableViewController : UIViewController <AWEUserMessage, AWEAwemeDeletionMessage, UITableViewDelegate, UITableViewDataSource, AWEFeedMessage, AWEAwesomeSplashManagerMessage, AWEPublishTaskMessage, UIGestureRecognizerDelegate, AWEWebViewLoadTaskMessage, AWEFeedTabItemViewControllerProtocol, AWEFeedViewControllerSwitchProtocol>
{
...
- (void)userDidSelectRetrievalInterests:(id)arg1;
- (void)userDidSelectInterest:(id)arg1;
- (void)userDidSkipInterestSelect:(id)arg1;
