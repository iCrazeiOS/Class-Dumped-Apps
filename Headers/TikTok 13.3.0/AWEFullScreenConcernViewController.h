...
@class AWEConcernDataController, AWEFeedTableViewController, AWEFullscreenConcernLiveView, AWEPublishRetryViewManager, NSString, UILabel, UIPanGestureRecognizer;
@protocol AWEFeedRefreshAnimationProtocol, AWEFeedTabItemViewControllerProtocol;

@interface AWEFullScreenConcernViewController : UIViewController <AWEViewControllerRefreshable, UIGestureRecognizerDelegate>
{
