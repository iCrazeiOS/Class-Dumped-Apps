...
@interface AWEPanelTransitionController : UIPercentDrivenInteractiveTransition <UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning>
{
    _Bool _reversed;
    _Bool _interactive;
...
- (void)setupInteractiveTransitionWithPresentedViewController:(id)arg1 presentingViewController:(id)arg2;
