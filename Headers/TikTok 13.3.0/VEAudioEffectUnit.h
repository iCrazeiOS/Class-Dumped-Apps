...
@class IESMMAudioFade, IESMMAudioLimiter, IESMMAudioPitch, IESMMAudioPitchSpeed, VEAudioConfig;
...
- (unsigned int)processIntervalInput:(float **)arg1 inputSamples:(unsigned int)arg2 bufferMaxSamples:(unsigned int)arg3 frameTime:(double)arg4;
- (void)reset;
