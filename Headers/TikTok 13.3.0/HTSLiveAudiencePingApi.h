...
@class NSNumber;
@protocol HTSLiveAudiencePingApiDelegate, IESLiveSettings;
...
@property(nonatomic) __weak id <HTSLiveAudiencePingApiDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)request;
