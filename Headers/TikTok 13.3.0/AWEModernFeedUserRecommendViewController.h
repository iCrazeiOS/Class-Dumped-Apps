...
@class AWEUserRecommendViewController, NSString;
...
@interface AWEModernFeedUserRecommendViewController : UIViewController <AWEModernFeedCellControllerProtocol>
{
    ...
    AWEUserRecommendViewController *_userRecommendViewController;
...
@property(retain, nonatomic) AWEUserRecommendViewController *userRecommendViewController; // @synthesize userRecommendViewController=_userRecommendViewController;
