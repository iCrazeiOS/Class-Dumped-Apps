...
@class GMSx_GPBMessage, NSArray, NSData, NSString;

@protocol GMSx_GPBMessageSignatureProtocol
...
- (int)getEnum;
- (GMSx_GPBMessage *)getGroupAtIndex:(unsigned long long)arg1;
- (void)setGroup:(GMSx_GPBMessage *)arg1;
- (GMSx_GPBMessage *)getGroup;
- (GMSx_GPBMessage *)getMessageAtIndex:(unsigned long long)arg1;
- (void)setMessage:(GMSx_GPBMessage *)arg1;
- (GMSx_GPBMessage *)getMessage;
