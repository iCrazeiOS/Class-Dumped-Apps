...
@class AVAsset, HTSEffectManager, IESComposEffectProcess, IESMMCanvasConfig, IESMMImageMovieInfo, IESMMMVEffectFilter, IESMMRWLock, IESMMStoryConfig, IESMMTimeMachine, IESMMTranscoderParam, IESVideoAddEdgeData, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, VEAudioEncodeConfig, VEImageFetchAsset;
...
@interface HTSVideoData : IESMMObject <NSCopying>
{
    ...
    NSMutableDictionary *_audioDubTimeClipInfo;
    NSMutableArray *_audioDubAssets;
    AVAsset *_videoSoundSrcAsset;
    AVAsset *_videoSoundAndDubMixAsset;
    ...
    NSString *_lvMetadataInfo;
    id <NSObject><NSCopying> _relationMetadataInfo;
...
@property(retain, nonatomic) id <NSObject><NSCopying> relationMetadataInfo; // @synthesize relationMetadataInfo=_relationMetadataInfo;
@property(retain, nonatomic) NSString *lvMetadataInfo; // @synthesize lvMetadataInfo=_lvMetadataInfo;
...
@property(retain, nonatomic) AVAsset *videoSoundAndDubMixAsset; // @synthesize videoSoundAndDubMixAsset=_videoSoundAndDubMixAsset;
@property(retain, nonatomic) AVAsset *videoSoundSrcAsset; // @synthesize videoSoundSrcAsset=_videoSoundSrcAsset;
@property(nonatomic) _Bool isHaveVideoSound; // @synthesize isHaveVideoSound=_isHaveVideoSound;
@property(retain, nonatomic) NSMutableArray *audioDubAssets; // @synthesize audioDubAssets=_audioDubAssets;
@property(retain, nonatomic) NSMutableDictionary *audioDubTimeClipInfo; // @synthesize audioDubTimeClipInfo=_audioDubTimeClipInfo;
...
- (void)resetTransParamWithScene:(long long)arg1;
- (_Bool)hasRecordAudio;
- (void)addDubAudioObject:(id)arg1 withClip:(id)arg2;
- (void)removeAllAudioDubs;
- (void)removeAudioDubWithAsset:(id)arg1;
- (void)addAudioDubWithAssetAndClipRange:(id)arg1 withClip:(id)arg2;
...
- (id)effectContextForVideoAtIndex:(unsigned long long)arg1;
...
- (_Bool)awe_audioAssetHasChangedCompareWith:(id)arg1;
- (_Bool)awe_videoAssetHasChangedCompareWith:(id)arg1;
- (void)getRestoreVideoDurationWithSegmentCompletion:(CDUnknownBlockType)arg1;
