...
@interface AWECommentListInputView : UIView <AWEGrowingTextViewDelegate, AWETextInputControllerDelegate, AWEEmoticonKeyboardHelperDelegate, UITextFieldDelegate, AWECommentGiphySearchResultDelegate>
{
    _Bool _isAting;
