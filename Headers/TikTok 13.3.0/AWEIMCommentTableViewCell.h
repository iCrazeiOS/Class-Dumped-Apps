...
@class AWECommentModel, AWENotificationModel, AWEUserModel, NSString, UIImageView, UILabel, YYLabel;
@protocol AWEIMCommentActionDelegate;

@interface AWEIMCommentTableViewCell : UITableViewCell <AWEUserMessage>
{
