...
@protocol HTSLiveStreamEngineProvider, HTSLiveToolbarProvider, HTSLiveViewHierarchyProvider, IESLiveCamera, IESLiveEnvironment, IESLiveToastFactory, IESLiveTracker;
...
@property(retain, nonatomic) id <HTSLiveStreamEngineProvider> streamEngineProvider; // @synthesize streamEngineProvider=_streamEngineProvider;
