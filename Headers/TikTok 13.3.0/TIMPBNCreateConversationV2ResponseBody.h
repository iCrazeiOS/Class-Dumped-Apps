...
@class NSString, TIMPBNConversationInfoV2;

@interface TIMPBNCreateConversationV2ResponseBody : GPBMessage
{
}
...
@property(retain, nonatomic) TIMPBNConversationInfoV2 *conversation; // @dynamic conversation;
