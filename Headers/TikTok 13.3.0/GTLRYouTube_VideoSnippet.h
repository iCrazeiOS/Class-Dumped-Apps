...
@class GTLRDateTime, GTLRYouTube_ThumbnailDetails, GTLRYouTube_VideoLocalization, NSArray, NSString;
...
@property(copy, nonatomic) NSString *defaultAudioLanguage; // @dynamic defaultAudioLanguage;
...
@property(copy, nonatomic) NSString *liveBroadcastContent; // @dynamic liveBroadcastContent;
@property(retain, nonatomic) GTLRYouTube_VideoLocalization *localized; // @dynamic localized;
