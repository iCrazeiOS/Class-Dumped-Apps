...
@class AWEShareContext, NSNumber, NSString, UIImage;
...
- (void)showGifPanel;
- (void)showGifPanelWithContext:(AWEShareContext *)arg1 prepare:(void (^)(long long, AWEShareContext *, void (^)(NSError *)))arg2;
- (void)showPanelWithContext:(AWEShareContext *)arg1 imageURLString:(NSString *)arg2 isCover:(_Bool)arg3 enableMask:(_Bool)arg4 prepare:(void (^)(long long, AWEShareContext *, void (^)(NSError *)))arg5 hideOptions:(long long)arg6 hideFilter:(_Bool (^)(AWEShareChannel *))arg7;
- (void)showPanelWithContext:(AWEShareContext *)arg1 imageURLString:(NSString *)arg2 isCover:(_Bool)arg3 enableMask:(_Bool)arg4 prepare:(void (^)(long long, AWEShareContext *, void (^)(NSError *)))arg5 hideOptions:(long long)arg6;
- (void)showPanelWithContext:(AWEShareContext *)arg1 coverURLString:(NSString *)arg2 enableMask:(_Bool)arg3 prepare:(void (^)(long long, AWEShareContext *, void (^)(NSError *)))arg4 hideOptions:(long long)arg5;
