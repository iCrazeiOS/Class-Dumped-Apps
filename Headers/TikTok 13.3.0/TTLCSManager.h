...
- (void)configLCSWithMessageReceiver:(id)arg1 appKey:(id)arg2 fpId:(id)arg3 deviceId:(id)arg4 appId:(id)arg5 installId:(id)arg6 sessionId:(id)arg7 wsURLs:(id)arg8 customParams:(id)arg9;
