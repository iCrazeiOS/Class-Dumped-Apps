...
#import "HTSLiveDoodleAction-Protocol.h"
...
@interface HTSLiveNativeAnimationStore : NSObject <HTSLiveAnchorActions, HTSLiveDiggAction, HTSLiveMessageSubscriber, HTSLiveSmallGiftAction, HTSLiveUserEnterAction, HTSLiveDoodleAction, HTSLiveRoomRemoteActions>
{
...
- (void)dispatchDoodleWithMessage:(id)arg1;
