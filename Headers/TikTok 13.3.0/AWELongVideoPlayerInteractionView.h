...
@class AWEAwemeModel, AWEAwemePlayInteractionPresenter, AWEAwemePlayInteractionViewController, AWEFeedVideoButton, AWELongVideoPlayerViewController, NSDictionary, UIButton;
