...
@interface TTPlayerView : UIView
{
    ...
    // Error parsing type: ^{APOutRender=^^?^^?{atomic<com::ss::ttm::utils::AVState::States>=Ai}iiiB*^{AVSource}^{AVHandler}^{AVWindow}iiiiiii[8i]ii^{__CVBuffer}{_opaque_pthread_mutex_t=q[56c]}}, name: _render
