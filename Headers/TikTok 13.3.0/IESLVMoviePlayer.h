...
@protocol IESLVMoviePlayerDelegate, OS_dispatch_queue;
...
@interface IESLVMoviePlayer : NSObject <AVPlayerItemOutputPullDelegate>
{
    ...
    _Bool _isStart;
    _Bool _isProcessing;
    id <IESLVMoviePlayerDelegate> _delegate;
...
@property(nonatomic) __weak id <IESLVMoviePlayerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
