...
@class GMSx_GPBListValue, GMSx_GPBStruct, NSString;

@interface GMSx_GPBValue : GMSx_GPBMessage
{
}
...
@property(retain, nonatomic) GMSx_GPBListValue *listValue; // @dynamic listValue;
...
@property(retain, nonatomic) GMSx_GPBStruct *structValue; // @dynamic structValue;
