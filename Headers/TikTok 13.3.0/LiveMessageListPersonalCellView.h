...
@protocol HTSLiveDetailRouter, HTSLiveMessageListActions, HTSLivePushMessageActions, IESLiveEnvironment, IESLiveMonitor, IESLiveTracker, IESLiveUserService;

@interface LiveMessageListPersonalCellView : UITableViewCell
{
