...
+ (void)applyHighlightForAttributedComment:(id)arg1 range:(struct _NSRange)arg2 userId:(id)arg3 tapHighlightAction:(CDUnknownBlockType)arg4;
...
+ (_Bool)addHighlightForTranslatedAttrCommentContent:(id)arg1 prefix:(id)arg2 tapHighlightAction:(CDUnknownBlockType)arg3;
