...
@class AWEEditorStickerGestureViewController, AWEImagesView, AWEPlayer, AWESimplifiedStickerContainerView, AWEStickerEditBaseView, AWEStoryBackgroundTextView, AWEStoryTextContainerView, AWEVideoImageGenerator, AWEVideoPublishViewModel, AWEVideoRangeSlider, NSArray, NSDictionary, NSString, UIButton, UIImageView, UILabel, UIView;
...
@interface AWEVideoEditStickerSelectTimeViewController : UIViewController <AWEMediaSmallAnimationProtocol, AWEVideoRangeSliderDelegate, AWESimplifiedStickerContainerViewDelegate>
{
    ...
    AWEStoryBackgroundTextView *_selectedTextView;
...
@property(retain, nonatomic) AWEStoryBackgroundTextView *selectedTextView; // @synthesize selectedTextView=_selectedTextView;
