...
+ (id)unpackedTileWithTileCoords:(id)arg1 tileProto:(id)arg2 mapTileProto:(id)arg3 combinedTileEdition:(int)arg4 perTileEpoch:(int)arg5 tileType:(id)arg6 validationTime:(long long)arg7;
+ (void)populateHeaderForEdition:(int)arg1 perTileEpoch:(int)arg2 output:(id)arg3;
+ (unsigned long long)tileEncodedHeaderSize;
+ (id)unpackedTileWithTileCoords:(id)arg1 tileProto:(id)arg2 data:(id)arg3 tileDecodeOptions:(unsigned long long)arg4 offset:(int)arg5 tileType:(id)arg6 validationTime:(long long)arg7;
