...
@protocol HTSLiveMessageDispatchProvider, HTSLiveTemplateProvider, IESActionDispatcher, IESLiveMonitor, IESLiveTracker;

@interface IESLiveAnchorStore : NSObject <HTSLiveAnchorActions, HTSLiveMessageSubscriber>
{
