...
@protocol HTSLiveToolbarActions, HTSLiveViewHierarchyProvider, IESLiveEnvironment, IESLiveUserService;
...
@interface HTSLiveToolbar : UIView <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, CAAnimationDelegate, HTSLiveToolbar>
{
    ...
    NSArray *_sortedIDs;
    NSArray *_groupedSortedIDs;
}

@property(retain, nonatomic) NSArray *groupedSortedIDs; // @synthesize groupedSortedIDs=_groupedSortedIDs;
