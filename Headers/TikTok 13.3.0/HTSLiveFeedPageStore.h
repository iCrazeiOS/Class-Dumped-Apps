...
@class HTSLiveFeedDataApi, IESLiveFeedTabConfig, NSMutableArray, NSNumber, NSString;
...
@interface HTSLiveFeedPageStore : NSObject <HTSLiveFeedLayoutPageItem, HTSLiveFeedPageProtocol>
{
    ...
    NSMutableArray *_mFeedItems;
    NSMutableArray *_mHeaderItems;
...
@property(retain, nonatomic) NSMutableArray *mHeaderItems; // @synthesize mHeaderItems=_mHeaderItems;
@property(retain, nonatomic) NSMutableArray *mFeedItems; // @synthesize mFeedItems=_mFeedItems;
...
- (void)additional;
- (void)updateFeedEmptyState:(_Bool)arg1;
