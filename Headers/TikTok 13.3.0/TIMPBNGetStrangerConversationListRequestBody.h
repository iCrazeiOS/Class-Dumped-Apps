...
@interface TIMPBNGetStrangerConversationListRequestBody : GPBMessage
{
}
...
@property(nonatomic) _Bool hasShowTotalUnread; // @dynamic hasShowTotalUnread;
@property(nonatomic) _Bool showTotalUnread; // @dynamic showTotalUnread;
