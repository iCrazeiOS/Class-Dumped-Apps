...
{
    _Bool _availableBatchFromStorage;
    _Bool _pendingBatchQueueFull;
    _Bool _enabled;
    _Bool _paused;
    _Bool _discardLogs;
...
@property(nonatomic) _Bool discardLogs; // @synthesize discardLogs=_discardLogs;
@property(nonatomic, getter=isPaused) _Bool paused; // @synthesize paused=_paused;
@property(nonatomic, getter=isEnabled) _Bool enabled; // @synthesize enabled=_enabled;
@property(nonatomic) _Bool pendingBatchQueueFull; // @synthesize pendingBatchQueueFull=_pendingBatchQueueFull;
@property(nonatomic) _Bool availableBatchFromStorage; // @synthesize availableBatchFromStorage=_availableBatchFromStorage;
