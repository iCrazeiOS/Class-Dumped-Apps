...
+ (id)formatAddress:(unsigned long long)arg1 is64bit:(_Bool)arg2;
+ (unsigned long long)normalizeAddress:(unsigned long long)arg1 is64bit:(_Bool)arg2;
+ (id)uuidRefToString:(struct __CFUUID *)arg1;
+ (id)addressesFromReport:(id)arg1 is64bit:(_Bool)arg2;
+ (id)findCrashedThreadInReport:(id)arg1;
+ (_Bool)isCodeType64bit:(id)arg1;
...
+ (_Bool)isBinaryWithStart:(unsigned long long)arg1 end:(unsigned long long)arg2 inAddresses:(id)arg3;
+ (id)extractBinaryImagesFromReport:(id)arg1 codeType:(id)arg2 is64bit:(_Bool)arg3;
+ (id)selectorRegisterValueFromReport:(id)arg1 ofCrashedThread:(id)arg2 is64bit:(_Bool)arg3;
+ (id)extractExceptionReasonFromReport:(id)arg1;
+ (id)extractRegistersFromCrashedThread:(id)arg1 is64bit:(_Bool)arg2;
+ (id)formatStackFrame:(id)arg1 report:(id)arg2;
+ (id)extractThreadsFromReport:(id)arg1 crashedThread:(id)arg2 is64bit:(_Bool)arg3;
