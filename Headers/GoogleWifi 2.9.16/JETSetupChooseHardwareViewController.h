...
@interface JETSetupChooseHardwareViewController : JETGrOOBEListPickerViewController <JETGrOOBEListPickerViewControllerDataSource>
{
}

- (long long)selectedHardwareModel;
- (void)onRightButton;
- (id)rightButtonText;
