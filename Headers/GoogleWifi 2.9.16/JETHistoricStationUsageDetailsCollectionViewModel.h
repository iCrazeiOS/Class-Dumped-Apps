...
#import "JETHistoricUsageDetailsCollectionViewModel.h"

@class NSString;

@interface JETHistoricStationUsageDetailsCollectionViewModel : JETHistoricUsageDetailsCollectionViewModel
{
    NSString *_stationID;
}
