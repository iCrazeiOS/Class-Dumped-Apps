...
@class NSArray, NSDictionary, NSMutableSet, NSNumber, NSString, TFNTwitterAccount, TFNTwitterPromotedContent, TFNTwitterUserDataSource, TFSTwitterEntitySet, TFSTwitterEntityURL, TFSTwitterPaginatedResults, TFSTwitterPlace, TFSTwitterUserExtendedProfile, UIColor;
