...
@protocol T1AltTextExplanationPromptViewControllerDelegate;

@interface T1AltTextExplanationPromptViewController : T1PromptViewController <T1PromptDataSource>
{
    id <T1AltTextExplanationPromptViewControllerDelegate> _delegate;
}

@property(nonatomic) __weak id <T1AltTextExplanationPromptViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
