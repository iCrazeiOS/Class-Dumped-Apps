...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 subtaskID:(id)arg3 flowToken:(id)arg4 categoryID:(id)arg5 orKeyword:(id)arg6 includeCategories:(_Bool)arg7 source:(unsigned long long)arg8 responseModelBuilder:(id)arg9 completionBlock:(CDUnknownBlockType)arg10;
