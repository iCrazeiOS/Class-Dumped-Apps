...
@interface TFSTwitterAPIContactsUsersRequest : TFSTwitterAPIEndpointRequest
{
}

+ (unsigned long long)responseHydrationFlags;
+ (id)endpointPath;
- (id)initWithCount:(id)arg1 cursor:(id)arg2 includeRelationships:(_Bool)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
