...
#import <TFNUI/TFNActionItemStateDelegate-Protocol.h>

@class NSString, UIImage;

@interface TFNActionItem : NSObject <TFNActionItemStateDelegate, NSCopying>
{
    NSString *_title;
    NSString *_subtitle;
    long long _style;
    CDUnknownBlockType _action;
    CDUnknownBlockType _stateAction;
...
@property(copy, nonatomic) CDUnknownBlockType stateAction; // @synthesize stateAction=_stateAction;
...
- (void)actionItemStateDidUpdate:(long long)arg1;
