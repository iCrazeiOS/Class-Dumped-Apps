...
+ (id)sharedDirectMessageServiceForAccountID:(id)arg1 authenticatedUserID:(long long)arg2 modelContext:(id)arg3;
...
- (void)reset;
- (id)initWithAccountID:(id)arg1 authenticatedUserID:(long long)arg2 modelContext:(id)arg3;
- (id)init;
- (id)debugDescription;
- (id)description;
