...
@interface TFSTwitterAPIMomentsPivotRequest : TFSTwitterAPIEndpointRequest
{
}

+ (unsigned long long)responseHydrationFlags;
+ (id)endpointPath;
- (id)initWithMomentID:(id)arg1 UTCOffset:(id)arg2 includeBlocking:(_Bool)arg3 includeBlockedBy:(_Bool)arg4 context:(id)arg5 responseModelBuilder:(id)arg6;
