...
@interface TFSTwitterAPILiveEventSubscriptionRequest : TFSTwitterAPIEndpointRequest
{
}

+ (long long)HTTPMethodValue;
- (id)initWithEventID:(id)arg1 remindMe:(_Bool)arg2 notificationID:(id)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
