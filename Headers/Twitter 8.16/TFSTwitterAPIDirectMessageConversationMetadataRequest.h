...
@interface TFSTwitterAPIDirectMessageConversationMetadataRequest : TFSTwitterAPIEndpointRequest
{
}

- (id)initWithParticipantIDs:(id)arg1 context:(id)arg2 responseModelBuilder:(id)arg3;
- (id)initWithConversationID:(id)arg1 context:(id)arg2 responseModelBuilder:(id)arg3;
