...
@class NSString, NSURL, PTVExternalVideoAccessManager, PTVFastImageCacheUtilities, T1PeriscopeAccount, TFNTwitterAccount, TFNTwitterLiveEvent, TFNTwitterStatus, TFNTwitterUser, TFSTwitterBroadcast;
