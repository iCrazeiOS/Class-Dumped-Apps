...
- (id)initWithMediaID:(id)arg1 monetize:(_Bool)arg2 videoCategories:(id)arg3 advertiserBlacklist:(id)arg4 monetizationCategoryBlacklist:(id)arg5 adsCategoryBlacklist:(id)arg6 context:(id)arg7 responseModelBuilder:(id)arg8;
