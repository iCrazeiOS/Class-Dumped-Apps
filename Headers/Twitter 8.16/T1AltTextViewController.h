...
@class NSString, T1AltTextInputView, T1MediaAttachmentView, TFNAttributedTextView, TFNFormFieldCounterView, TFNFormFieldErrorView, TFNTwitterAccount, TFNTwitterMediaAsset, UIImage, UIScrollView;
...
@interface T1AltTextViewController : TFNViewController <T1AltTextInputViewDelegate, TFNAttributedTextViewDelegate>
{
    ...
    _Bool _ubiquitousOrGIFAttachmentEnabled;
...
@property(nonatomic, getter=isUbiquitousOrGIFAttachmentEnabled) _Bool ubiquitousOrGIFAttachmentEnabled; // @synthesize ubiquitousOrGIFAttachmentEnabled=_ubiquitousOrGIFAttachmentEnabled;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) long long maxAltTextCharacterCount;
