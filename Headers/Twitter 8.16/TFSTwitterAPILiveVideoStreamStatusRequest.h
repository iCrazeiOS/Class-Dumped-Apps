...
@interface TFSTwitterAPILiveVideoStreamStatusRequest : TFSTwitterAPIEndpointRequest
{
}
...
- (id)initWithMediaID:(id)arg1 locationSharingRulesEnforced:(_Bool)arg2 latestReplayPlaylist:(_Bool)arg3 streamType:(id)arg4 context:(id)arg5 responseModelBuilder:(id)arg6;
