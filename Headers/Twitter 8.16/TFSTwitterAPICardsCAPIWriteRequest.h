...
@interface TFSTwitterAPICardsCAPIWriteRequest : TFSTwitterAPIEndpointRequest
{
}
...
- (id)initWithCAPIEndpointPath:(id)arg1 parameters:(id)arg2 headerFields:(id)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
