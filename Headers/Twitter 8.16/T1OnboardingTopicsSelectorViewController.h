...
@class NSArray, NSHashTable, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, T1FlexibleLayoutView, T1OnboardingSearchView, TFNBadgeView, TFNButton, UIActivityIndicatorView, UIView;
@protocol T1OnboardingHeaderViewModel, T1OnboardingTopicsSelectorViewControllerDelegate;

@interface T1OnboardingTopicsSelectorViewController : TFNItemsDataViewController <T1OnboardingTopicCategoryRowViewDelegate, T1OnboardingTopicCategoryBranchViewDelegate, T1OnboardingTopicsSelectorViewControllerDelegate, T1OnboardingTopicViewDelegate, T1OnboardingSearchViewDelegate, TFNModalSheetViewControllerDelegate, TFNModalSheetViewControllerLayoutDelegate>
{
    ...
    id <T1OnboardingHeaderViewModel> _cartHeaderViewModel;
...
- (CDUnknownBlockType)private_fetchCompletionBlockWithCache:(id)arg1 keyPath:(id)arg2 validation:(CDUnknownBlockType)arg3;
