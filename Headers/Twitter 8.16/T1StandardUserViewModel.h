...
@class NSArray, NSDictionary, NSString, TFNTwitterPromotedContent, TFNTwitterUser, TFSTwitterEntityMedia, TFSTwitterRelationship, TFSTwitterUserReference, TFSURTUrl;
