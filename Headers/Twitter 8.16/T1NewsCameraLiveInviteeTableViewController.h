...
@protocol T1NewsCameraLiveInviteeTableViewControllerDelegate;

@interface T1NewsCameraLiveInviteeTableViewController : TFNItemsDataViewController <T1TypeaheadUserTableRowHost, T1DirectMessageUserTypeaheadRowAdapterDelegate>
{
    id <T1NewsCameraLiveInviteeTableViewControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <T1NewsCameraLiveInviteeTableViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
