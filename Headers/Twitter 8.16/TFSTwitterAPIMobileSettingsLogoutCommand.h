...
- (id)initWithService:(id)arg1 accountID:(id)arg2 userID:(long long)arg3 appID:(id)arg4 deviceUDID:(id)arg5 base64PushToken:(id)arg6 completionBlock:(CDUnknownBlockType)arg7;
