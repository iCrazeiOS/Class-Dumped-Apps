...
@interface TFSTwitterAPIOAuthAccessTokenForSingleSignOnRequest : TFSTwitterAPIEndpointRequest
{
}
...
- (id)initWithConsumerKey:(id)arg1 authParameters:(id)arg2 context:(id)arg3 responseModelBuilder:(id)arg4;
