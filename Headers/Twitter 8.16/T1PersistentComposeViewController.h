...
@interface T1PersistentComposeViewController : T1ComposeViewController <T1NewsCameraCaptureViewControllerDelegate, T1PersistentComposeViewDelgate, T1JumpBackToHomeTimelineBehavior, TFNModalSheetViewControllerDelegate>
{
