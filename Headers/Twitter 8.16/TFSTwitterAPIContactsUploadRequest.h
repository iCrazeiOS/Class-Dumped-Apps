...
@interface TFSTwitterAPIContactsUploadRequest : TFSTwitterAPIEndpointRequest
{
}
...
- (id)initWithVcardsJSONData:(id)arg1 optInToLiveSync:(_Bool)arg2 isLiveSyncRequest:(_Bool)arg3 isReupload:(_Bool)arg4 context:(id)arg5 responseModelBuilder:(id)arg6;
