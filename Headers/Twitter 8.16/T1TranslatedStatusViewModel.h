...
@class NSArray, NSDate, NSDictionary, NSString, TFNTwitterCardData, TFNTwitterDisplayTextModel, TFNTwitterFeedbackInfo, TFNTwitterFeedbackModule, TFNTwitterGeotag, TFNTwitterStatus, TFNTwitterStatusConversationContext, TFNTwitterSuggestsInfo, TFSTwitterCameraMoment, TFSTwitterEntitySet, TFSTwitterMediaInfo, TFSTwitterTranslateTweetResponse, TFSTwitterVideoMonetizationSettings, TFSURTImageVariant, TFSURTRichText, UIColor;
