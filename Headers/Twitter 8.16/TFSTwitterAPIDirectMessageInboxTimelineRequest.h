...
- (id)initWithType:(unsigned long long)arg1 maxID:(id)arg2 filterLowQuality:(id)arg3 includeQualityParameter:(id)arg4 dmUsers:(_Bool)arg5 context:(id)arg6 responseModelBuilder:(id)arg7;
