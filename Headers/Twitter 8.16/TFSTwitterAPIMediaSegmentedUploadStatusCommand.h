...
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 mediaID:(id)arg3 scribeComponent:(id)arg4 scribeElement:(id)arg5 permittedRequestRetryCount:(unsigned long long)arg6 requestRetryDelay:(double)arg7 source:(unsigned long long)arg8 networkTransactionMetrics:(id)arg9 responseModelBuilder:(id)arg10 completionBlock:(CDUnknownBlockType)arg11;
