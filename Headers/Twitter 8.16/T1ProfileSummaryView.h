...
#import <T1Twitter/T1FleetsProfileHeaderAvatarViewDelegate-Protocol.h>
...
@interface T1ProfileSummaryView : UIView <T1FleetsProfileHeaderAvatarViewDelegate>
{
...
- (void).cxx_destruct;
- (void)fleetsProfileHeaderAvatarViewDidAppear:(id)arg1;
