...
@class NSArray, NSDate, NSMutableArray, NSMutableOrderedSet, NSOperationQueue, NSString, TFNDirectMessageComposition, TFNDirectMessageContext, TFNDirectMessageConversationIdentifier, TFNDirectMessageConversationParticipant, TFNDirectMessageInbox, TFNDirectMessageMarkConversationAsReadOperation, TFNDirectMessageModel, TFNDirectMessageUser, TFNTwitterEntityImageInfo;
@protocol TFNDirectMessageConversationEntry, TFNDirectMessageConversationParticipant;
