...
@class NSNumber, NSString, NSURL, TFNTwitterUser, TFSTwitterUserReference;
...
@property(readonly, nonatomic) _Bool showAvatarView;
@property(readonly, nonatomic) _Bool isSphere;
@property(readonly, copy, nonatomic) NSString *text;
@property(readonly, nonatomic) struct CGRect salientRect;
