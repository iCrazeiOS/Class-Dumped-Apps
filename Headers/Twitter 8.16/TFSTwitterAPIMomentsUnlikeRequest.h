...
@interface TFSTwitterAPIMomentsUnlikeRequest : TFSTwitterAPIEndpointRequest
{
}

+ (long long)HTTPMethodValue;
- (id)initWithMomentID:(id)arg1 UTCOffset:(id)arg2 context:(id)arg3 responseModelBuilder:(id)arg4;
