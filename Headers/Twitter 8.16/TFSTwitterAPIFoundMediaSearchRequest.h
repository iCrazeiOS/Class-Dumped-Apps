...
@interface TFSTwitterAPIFoundMediaSearchRequest : TFSTwitterAPIEndpointRequest
{
}
...
+ (id)endpointPath;
- (id)initWithKeyword:(id)arg1 provider:(id)arg2 cursor:(id)arg3 imageFormat:(long long)arg4 context:(id)arg5 responseModelBuilder:(id)arg6;
