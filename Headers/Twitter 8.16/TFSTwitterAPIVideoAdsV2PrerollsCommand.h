...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 tweets:(id)arg3 prerollID:(id)arg4 dynamicPrerollType:(id)arg5 includeLongVideos:(_Bool)arg6 source:(unsigned long long)arg7 responseModelBuilder:(id)arg8 completionBlock:(CDUnknownBlockType)arg9;
