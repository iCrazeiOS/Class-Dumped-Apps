...
#import <T1Twitter/T1PinToTopSubscriptionManagerDelegate-Protocol.h>
#import <T1Twitter/T1RelevancePromptTableRowAdapterDelegate-Protocol.h>
#import <T1Twitter/T1SphereTimelineEntryViewModelAdapterDelegate-Protocol.h>
...
@interface T1HomeTimelineItemsViewController : TFNItemsDataViewController <TFNMarkAsViewedDelegate, UIActionSheetDelegate, UIDataSourceModelAssociation, T1ErrorDataViewAdapterDelegate, T1TimelineMessageEntryTableRowAdapterDelegate, T1LoadingGapDataViewAdapterDelegate, T1URTTimelineTombstoneItemViewModelDelegate, TFNTimelineDismissedItemDelegate, T1UpdateIndicatorDelegate, T1FeedbackActionProvider, T1RelevancePromptTableRowAdapterDelegate, T1PinToTopSubscriptionManagerDelegate, T1SphereTimelineEntryViewModelAdapterDelegate, TFNTooltipDelegate>
{
    ...
    T1PinToTopSubscriptionManager *_pinToTopSubscriptionManager;
...
@property(readonly, nonatomic) T1PinToTopSubscriptionManager *pinToTopSubscriptionManager; // @synthesize pinToTopSubscriptionManager=_pinToTopSubscriptionManager;
