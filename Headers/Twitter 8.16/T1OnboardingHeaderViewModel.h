...
#import <T1Twitter/T1OnboardingHeaderSpec-Protocol.h>
...
@interface T1OnboardingHeaderViewModel : NSObject <NSCopying, T1OnboardingHeaderSpec, T1OnboardingHeaderViewModel>
{
...
- (id)initWithStyle:(long long)arg1 account:(id)arg2 subtaskController:(id)arg3 subtaskDataProvider:(id)arg4 headerImage:(id)arg5 title:(id)arg6 subtitle:(id)arg7 imageAlignment:(long long)arg8 titleAlignment:(long long)arg9 subtitleAlignment:(long long)arg10;
