...
@interface TFNTwitterCoreServicesConfiguration : NSObject <TFNTwitterCoreServicesConfiguration, NSCopying>
{
    ...
    NSNumber *_queue_cachedCoreServices2GuestAuthRetryRefactorEnabled;
}

+ (id)_queue;
+ (void)updateConfiguration:(id)arg1;
+ (id)currentConfiguration;
@property(retain, nonatomic) NSNumber *queue_cachedCoreServices2GuestAuthRetryRefactorEnabled; // @synthesize queue_cachedCoreServices2GuestAuthRetryRefactorEnabled=_queue_cachedCoreServices2GuestAuthRetryRefactorEnabled;
