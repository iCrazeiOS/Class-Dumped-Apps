...
@interface T1TweetDetailsViewController : TFNItemsDataViewController <TFNTooltipDelegate, T1PersistentComposeViewControllerDelegate, T1ComposerPresenting, T1ComposeViewControllerDelegate, T1SlideshowBuilder, T1TweetDetailsTweetBodyItemsDelegate, T1ImageTransitionDelegate, T1DisplayTweetTranslationDelegate, T1ErrorDataViewAdapterDelegate, T1VideoMonetizationSettingsViewControllerDelegate, T1URTConversationTimelineObserver, T1URTTimelineTombstoneItemViewModelDelegate, T1DataViewControllerRenderPerformanceLoggerDataSource, T1NewsCameraImageTransitionDataSource, T1FeedbackActionProvider, T1HiddenRepliesConsumptionEducationPromptViewControllerDelegate, TFNDataViewKeyboardSelectionDelegate, T1TweetDetailsFocalStatusTableRowAdapterDelegate, UIResponderStandardEditActions, T1JumpBackToHomeTimelineBehavior, TFNLayoutMetricsEnvironment, T1SlideshowViewControllerDelegate, T1PersistentComposeAccountProvider, T1TweetDetailsSharedBehavior>
{
...
- (void)_t1_showRetweetWithCommentsTooltipIfNecessary;
...
- (id)newsCameraMediaStatusItemAdapterForAccount:(id)arg1;
