...
@interface TFSTwitterAPIStratostorePeriscopeAuthConsentGrantedUpdateRequest : TFSTwitterAPIEndpointRequest
{
}

+ (long long)HTTPMethodValue;
- (id)initWithUserID:(id)arg1 consentGranted:(_Bool)arg2 context:(id)arg3 responseModelBuilder:(id)arg4;
