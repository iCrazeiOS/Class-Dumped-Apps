...
@interface TFSTwitterAPIStickerProviderCatalogRequest : TFSTwitterAPIEndpointRequest
{
}

+ (unsigned long long)responseHydrationFlags;
+ (id)endpointPath;
- (id)initWithContext:(id)arg1 responseModelBuilder:(id)arg2 featuredOnly:(_Bool)arg3;
