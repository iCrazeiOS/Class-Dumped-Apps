...
@interface TFSTwitterAPIDirectMessageReactionDeleteRequest : TFSTwitterAPIEndpointRequest
{
}

+ (long long)HTTPMethodValue;
- (id)initWithConversationID:(id)arg1 dmID:(id)arg2 reactionKey:(id)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
