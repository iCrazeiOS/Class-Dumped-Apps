...
@interface _TtC10TelegramUI21ChatMessageBackground : ASDisplayNode
{
    // Error parsing type: , name: type
    // Error parsing type: , name: currentHighlighted
    // Error parsing type: , name: hasWallpaper
    // Error parsing type: , name: graphics
    // Error parsing type: , name: maskMode
    // Error parsing type: , name: imageNode
    // Error parsing type: , name: outlineImageNode
}
