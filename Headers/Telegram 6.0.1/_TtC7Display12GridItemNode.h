...
@interface _TtC7Display12GridItemNode : ASDisplayNode
{
    // Error parsing type: , name: isVisibleInGrid
    // Error parsing type: , name: isGridScrolling
    // Error parsing type: , name: cachedFrame
}
