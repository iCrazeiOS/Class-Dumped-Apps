...
@interface _TtC22TelegramBaseController41LocationBroadcastNavigationAccessoryPanel : ASDisplayNode
{
    ...
    // Error parsing type: , name: wavesNode
    ...
    // Error parsing type: , name: peersAndMode
}
