...
@interface _TtC10TelegramUI35NotificationContainerControllerNode : ASDisplayNode
{
    // Error parsing type: , name: validLayout
    // Error parsing type: , name: topItemAndNode
    // Error parsing type: , name: displayingItemsUpdated
