...
@class ASEditableTextNode, ASEditableTextNodeTargetForAction, NSString;

@protocol ASEditableTextNodeDelegate <NSObject>

@optional
- (void)editableTextNodeBackspaceWhileEmpty:(ASEditableTextNode *)arg1;
- (_Bool)editableTextNodeShouldReturn:(ASEditableTextNode *)arg1;
- (ASEditableTextNodeTargetForAction *)editableTextNodeTargetForAction:(SEL)arg1;
- (_Bool)editableTextNodeShouldPaste:(ASEditableTextNode *)arg1;
- (_Bool)editableTextNodeShouldCopy:(ASEditableTextNode *)arg1;
