...
@class NSURLCredential, NSURLRequest, NSURLResponse, NSURLSession, NSURLSessionTask;
...
- (id)initWithRequest:(NSURLRequest *)arg1 inSession:(NSURLSession *)arg2 options:(unsigned long long)arg3 context:(struct NSDictionary *)arg4;
