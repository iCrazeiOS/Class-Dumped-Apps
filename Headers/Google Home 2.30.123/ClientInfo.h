...
@class AndroidClientInfo, BattlestarClientInfo, BirdsongClientInfo, BrowserInfo, DesktopClientInfo, GoogleHomeClientInfo, IosClientInfo, JsClientInfo, KaiosClientInfo, LoonixClientInfo, MacClientInfo, NSString, PancettaClientInfo, PlayCeClientInfo, SparklightClientInfo, VrClientInfo, YetiClientInfo;
...
@property(retain, nonatomic) BattlestarClientInfo *battlestarClientInfo; // @dynamic battlestarClientInfo;
...
@property(nonatomic) _Bool hasBattlestarClientInfo; // @dynamic hasBattlestarClientInfo;
