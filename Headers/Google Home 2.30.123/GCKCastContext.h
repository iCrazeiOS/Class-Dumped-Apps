...
@class GCKAnalyticsEventLogger, GCKAppContextInformationStore, GCKCastAuthorizerManager, GCKCastDeviceProvider, GCKCastOptions, GCKClearcutEventSink, GCKDatabase, GCKDeviceProviderRegistry, GCKDiagnosticListener, GCKDiscoveryManager, GCKGuestModePairingUI, GCKNNetworkReachability, GCKPhysicalVolumeButtonController, GCKPrecacheController, GCKRuntimeConfiguration, GCKSessionManager, GCKUIExpandedMediaControlsViewController, NSString;
...
@interface GCKCastContext : NSObject <GCKRuntimeConfigurationValueObserver>
{
    ...
    GCKCastAuthorizerManager *_castAuthorizerManager;
...
@property(retain, nonatomic) GCKCastAuthorizerManager *castAuthorizerManager; // @synthesize castAuthorizerManager=_castAuthorizerManager;
...
- (void)setForegroundGaiaAccountID:(id)arg1;
