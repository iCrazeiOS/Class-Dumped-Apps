...
@class NSMutableDictionary, NSObject, NSString, TAGPBExtensionField, TAGPBFieldDescriptor, TAGPBUnknownFieldSet;
@protocol OS_dispatch_semaphore;

@interface TAGPBGeneratedMessage : TAGPBRootObject <TAGPBMutableArrayDelegate, NSMutableCopying>
{
