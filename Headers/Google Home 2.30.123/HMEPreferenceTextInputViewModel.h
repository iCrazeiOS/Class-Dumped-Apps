...
@interface HMEPreferenceTextInputViewModel : NSObject <HMEPreferenceMutableViewModel>
{
    _Bool _disabled;
    ...
    NSString *_errorText;
    NSURL *_prefixIconURL;
    NSURL *_suffixIconURL;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) NSURL *suffixIconURL; // @synthesize suffixIconURL=_suffixIconURL;
@property(readonly, nonatomic) NSURL *prefixIconURL; // @synthesize prefixIconURL=_prefixIconURL;
@property(readonly, copy, nonatomic) NSString *errorText; // @synthesize errorText=_errorText;
@property(readonly, copy, nonatomic) NSString *suggestionText; // @synthesize suggestionText=_suggestionText;
