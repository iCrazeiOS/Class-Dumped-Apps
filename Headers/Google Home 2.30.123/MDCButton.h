...
+ (Class)layerClass;
+ (id)hme_feedButtonWithTitle:(id)arg1 block:(CDUnknownBlockType)arg2;
+ (id)hme_feedFloatingButtonWithShape:(long long)arg1 greyTint600image:(id)arg2 block:(CDUnknownBlockType)arg3;
+ (id)hme_feedSecondaryFloatingButtonWithGreyTint800Image:(id)arg1 block:(CDUnknownBlockType)arg2;
+ (id)hme_feedImageButtonWithGreyTint600Image:(id)arg1 block:(CDUnknownBlockType)arg2;
+ (id)hme_feedTextButtonWithTitle:(id)arg1 cornerRadius:(double)arg2 block:(CDUnknownBlockType)arg3;
+ (id)hme_feedTextButtonWithTitle:(id)arg1 block:(CDUnknownBlockType)arg2;
