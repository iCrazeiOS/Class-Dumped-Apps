...
@class GHAExpression, GHAXoobeIcon, NSMutableArray;

@interface GHAXoobeAppBarIconButton : GPBMessage
{
}
...
@property(retain, nonatomic) GHAExpression *condition; // @dynamic condition;
