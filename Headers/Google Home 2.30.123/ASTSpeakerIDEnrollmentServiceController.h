...
- (void)fetchAssistantSettingsWithParameters:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)fetchAssistantSettingsWithParentSelectorForVoiceMatchEnrollment:(CDUnknownBlockType)arg1;
