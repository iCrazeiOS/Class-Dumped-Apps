...
@class GIMId, GIMRequestHeader, NSData;

@interface GIMCreateRelayPairingRequest : GPBMessage
{
}
...
@property(copy, nonatomic) NSData *clientExtensions; // @dynamic clientExtensions;
