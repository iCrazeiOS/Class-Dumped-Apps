...
@class GHCClientRpcInvocation, GHCConfirmationDialog, GHCPreferenceId, GHCPreferenceNewScreenAction, NSAttributedString, NSMutableArray, NSString, NSURL;
@protocol HMEPreferenceData;

@interface HMEPreferenceWiringGridViewModel : NSObject <HMEPreferenceViewModel, HMEPreferenceViewModelValidation>
{
    _Bool _disabled;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) NSMutableArray *gridItems; // @synthesize gridItems=_gridItems;
