...
@interface HMEPreferenceRadioListViewModel : NSObject <HMEPreferenceMutableViewModel>
{
    _Bool _disabled;
    ...
    NSArray *_radioButtonList;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) NSArray *radioButtonList; // @synthesize radioButtonList=_radioButtonList;
...
- (id)initWithPreferenceNode:(id)arg1 radioButtonList:(id)arg2 preferenceUpdateBlock:(CDUnknownBlockType)arg3;
