...
#import "HMELocalDeviceAuthorizationStatusRequestor-Protocol.h"

@class NSString;
@protocol HMEDeviceAuthData;

@interface HMELocalDeviceAuthorizationStatusRequestor : NSObject <HMELocalDeviceAuthorizationStatusRequestor>
{
