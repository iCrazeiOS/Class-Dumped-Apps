...
@interface ASTCCLDeviceSettingClientOp : NSObject <ASTCCLClientOp>
{
...
- (_Bool)turnFlashlight:(_Bool)arg1;
- (double)valueChangeFrom:(double)arg1 withArg:(id)arg2;
- (id)deviceModifySettingClientOpProperty;
