...
@interface _TtC74googlemac_iPhone_Home_Shared_Flux_Components_WeaveSetupTask_WeaveSetupTask21BorderRouterCheckTask : _TtCs12_SwiftObject
{
    ...
    // Error parsing type: , name: borderRouterNeededViewController
}
