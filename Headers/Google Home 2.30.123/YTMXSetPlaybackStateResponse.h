...
@class YTMXError, YTMXPlayerInfo, YTMXSetPlaybackStateRequest;

@interface YTMXSetPlaybackStateResponse : GPBMessage
{
}
...
@property(retain, nonatomic) YTMXSetPlaybackStateRequest *request; // @dynamic request;
