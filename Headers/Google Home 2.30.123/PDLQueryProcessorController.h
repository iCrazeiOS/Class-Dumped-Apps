...
@class NSArray, NSString, PDLClientConfig, PDLQueryProceesorDeliverer, PDLQueryProcessorContext, PDLResourceCollector, PDLSessionContext;
@protocol GIPAccountID, OS_dispatch_queue, PCCReachabilityProxy, PDLDeviceContactsService, PDLExperimentsService, PDLMetricsLogger, PDLQueryProcessor, PDLQueryProcessorFilter, PDLTopNCache;
