...
@interface JCVTableRowArgs : GPBMessage
{
}
...
@property(retain, nonatomic) NSMutableArray *cellParamsArray; // @dynamic cellParamsArray;
@property(readonly, nonatomic) unsigned long long cellParamsArray_Count; // @dynamic cellParamsArray_Count;
