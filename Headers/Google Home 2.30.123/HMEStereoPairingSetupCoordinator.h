...
@class HMESetupNavigationController, HMEStereoPairingSetupTaskCoordinator, NSString, SetupCastDevice, UIViewController;
@protocol AnalyticsLogger, GCAConfigurationFlags, HMEDeviceData, HMEDeviceQueryService, HMEHelpCoordinator, HMESpaceData, HMEStereoPairingSetupCoordinatorDelegate, HMEStructureData, HMETAGContainer, LinkedDevicesManager, SetupDeviceScanner;
