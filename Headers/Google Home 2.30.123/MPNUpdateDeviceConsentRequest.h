...
@interface MPNUpdateDeviceConsentRequest : GPBMessage
{
}
...
@property(nonatomic) long long constellationConsentTimestampUsec; // @dynamic constellationConsentTimestampUsec;
