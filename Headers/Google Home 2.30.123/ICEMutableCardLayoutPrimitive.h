...
#import "ICECardLayoutPrimitive.h"
...
@interface ICEMutableCardLayoutPrimitive : ICECardLayoutPrimitive <ICEMutableLayoutPrimitive>
{
}
...
@property(nonatomic) double cardSpacing; // @dynamic cardSpacing;
