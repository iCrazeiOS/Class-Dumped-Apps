...
@class HotwordMetadata, NSString, RecognitionContext, S3RecognizerInfo_GrammarSelectorParams, S3RecognizerInfo_PreambleMetadata;
...
@property(retain, nonatomic) S3RecognizerInfo_GrammarSelectorParams *grammarParams; // @dynamic grammarParams;
...
@property(nonatomic) _Bool hasGrammarParams; // @dynamic hasGrammarParams;
