...
@class YTMXError, YTMXPlayerInfo, YTMXSetCurrentLikeStatusRequest;

@interface YTMXSetCurrentLikeStatusResponse : GPBMessage
{
}
...
@property(retain, nonatomic) YTMXSetCurrentLikeStatusRequest *request; // @dynamic request;
