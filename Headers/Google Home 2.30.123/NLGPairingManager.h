...
#import "NLGPairingManager-Protocol.h"

@class NLGPairDeviceScanNetworksRequest, NLGWeaveCommandDispatcher, NLGWeaveDeviceManagerProxy, NSArray, NSData, NSOperationQueue, NSString;
@protocol NLGConnectionProfile, OS_dispatch_queue;

@interface NLGPairingManager : NSObject <NLGPairDeviceRequestDelegate, NLGPairingManager>
{
    NSObject<OS_dispatch_queue> *_proxyCallbackQueue;
    NLGWeaveCommandDispatcher *_commandDispatcher;
    NSOperationQueue *_operationQueue;
    NLGPairDeviceScanNetworksRequest *_persistentWiFiScanRequest;
    ...
    NSObject<NLGConnectionProfile> *_activeConnectionProfile;
...
@property(retain, nonatomic) NSObject<NLGConnectionProfile> *activeConnectionProfile; // @synthesize activeConnectionProfile=_activeConnectionProfile;
...
@property(retain, nonatomic) NLGPairDeviceScanNetworksRequest *persistentWiFiScanRequest; // @synthesize persistentWiFiScanRequest=_persistentWiFiScanRequest;
...
- (void)dealloc;
- (id)accountProvisioningRequestWithServiceInfo:(id)arg1 postRendezvousModeZeroDelay:(double)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (id)createNewThreadRequestWithReconnectConnectionProfile:(id)arg1 isJoiningExistingFabric:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (id)createNewFabricRequestWithCompletionHandler:(CDUnknownBlockType)arg1;
- (id)joinExistingFabricRequestWithConfigData:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)addThreadNetworksRequestWithThreadNetworks:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)updateWiFiNetworkToNetwork:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)getCameraAuthDataUsingNonce:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)completeDevicePairingUsingAccountInfo:(id)arg1 postRendezvousModeZeroDelay:(double)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)completeDevicePairingUsingAccountInfo:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)provisionWiFiNetwork:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)scanNetworksWithWirelessRegulatoryConfig:(id)arg1 repeatScanning:(_Bool)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;
...
- (void)reconnectDeviceWithCompletion:(CDUnknownBlockType)arg1;
