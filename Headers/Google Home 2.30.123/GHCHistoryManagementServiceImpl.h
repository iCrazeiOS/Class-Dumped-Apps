...
@interface GHCHistoryManagementServiceImpl : FCDRPCService <GHCHistoryManagementService>
{
    FCDRPC *_rpcs[2];
}
...
+ (id)serviceName;
- (void).cxx_destruct;
@property(readonly, nonatomic) FCDRPC *getFiltersRPC;
@property(readonly, nonatomic) FCDRPC *getHistoryRPC;
