...
@interface ICEMutableLayoutPrimitive : ICELayoutPrimitive <ICEMutableLayoutPrimitive>
{
}
...
@property(copy, nonatomic) NSArray *childComponents; // @dynamic childComponents;
