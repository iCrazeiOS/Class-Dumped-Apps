...
@class NSMutableArray, POEMAboutMeExtendedData, POEMCallerIdExtendedData, POEMGplusExtendedData, POEMHangoutsExtendedData, POEMPlayGamesExtendedData, POEMWebContactsExtendedData, SGWPPEAppsWaldoExtendedData, SGWPPEDynamiteExtendedData, SGWPPEPaisaExtendedData;
...
@property(retain, nonatomic) SGWPPEAppsWaldoExtendedData *appsWaldoExtendedData; // @dynamic appsWaldoExtendedData;
...
@property(nonatomic) _Bool hasAppsWaldoExtendedData; // @dynamic hasAppsWaldoExtendedData;
