...
- (void)hme_updateViewWithVisibility:(_Bool)arg1 animated:(_Bool)arg2;
- (void)hme_applyThemeToErrorActionChipForState:(long long)arg1;
- (void)hme_applyThemeToStatusViewForState:(long long)arg1 animated:(_Bool)arg2;
- (void)hme_applyThemeToActionViewForState:(long long)arg1 supportsOnOff:(_Bool)arg2 animated:(_Bool)arg3;
