...
@class GHCDeviceId, HMESetupNavigationController, HMEWaitingViewController, NSString;
@protocol AnalyticsLogger, HMEChooseStructureCoordinator, HMEDeviceData, HMEMoveDeviceStructureCoordinatorDelegate, HMESetupChooseRoomTaskCoordinator, HMESpaceData, HMEStructureData, HMEUnifiedDeviceData;
...
@property(readonly, nonatomic) id <HMESetupChooseRoomTaskCoordinator> chooseRoomTaskCoordinator; // @synthesize chooseRoomTaskCoordinator=_chooseRoomTaskCoordinator;
