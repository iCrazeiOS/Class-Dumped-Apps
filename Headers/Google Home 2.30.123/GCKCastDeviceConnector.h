...
#import "GCKRelayCastConnectorDelegate-Protocol.h"

@class GCKCastMessageDesegmenter, GCKCastMessageSegmenter, GCKCastSocket, GCKConnectionControlChannel, GCKDatabase, GCKDevice, GCKDeviceAuthChannel, GCKError, GCKGuestModeConnector, GCKHeartbeatChannel, GCKNNetworkReachability, GCKProximityInfoChannel, GCKReconnectStrategy, GCKRelayCastConnector, NSData, NSMutableDictionary, NSString, NSTimer;
@protocol GCKCastDeviceConnectorDelegate;

@interface GCKCastDeviceConnector : NSObject <GCKGuestModeConnectorDelegate, GCKRelayCastConnectorDelegate, GCKProximityInfoChannelDelegate, GCKCastSocketDelegate, GCKConnectionControlChannelDelegate, GCKDeviceAuthChannelDelegate, GCKHeartbeatChannelDelegate, GCKCastChannelMessageSink, GCKCastMessageSegmenterDelegate, GCKCastMessageDesegmenterDelegate>
{
    ...
    GCKRelayCastConnector *_relayCastConnector;
...
- (void)relayCastConnector:(id)arg1 didFailToConnectWithError:(id)arg2 shouldDeleteRAT:(_Bool)arg3;
- (void)relayCastConnector:(id)arg1 didConnectWithSocket:(id)arg2 peerSecurityTrust:(id)arg3;
