...
@interface HMEConciergeEntitlementViewModel : NSObject <HMESetupCollectionViewModel>
{
    HMESetupCollectionLayoutViewController *_parent;
    NSArray *_entitlementsForBasicTier;
    NSArray *_entitlementsForProTier;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSArray *entitlementsForProTier; // @synthesize entitlementsForProTier=_entitlementsForProTier;
@property(copy, nonatomic) NSArray *entitlementsForBasicTier; // @synthesize entitlementsForBasicTier=_entitlementsForBasicTier;
