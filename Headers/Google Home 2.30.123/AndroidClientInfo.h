...
@property(nonatomic) _Bool hasRSdkExtensionVersion; // @dynamic hasRSdkExtensionVersion;
...
@property(nonatomic) int rSdkExtensionVersion; // @dynamic rSdkExtensionVersion;
