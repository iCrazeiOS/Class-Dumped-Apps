...
@class GCKDatabase, GCKEndpointID, GCKNetworkAddress, GHCCRelayAccessToken, NSArray, NSMutableDictionary, NSMutableSet, NSString;
...
@interface GCKDevice : NSObject <NSCopying, NSSecureCoding>
{
    ...
    GHCCRelayAccessToken *_relayAccessToken;
}
...
+ (id)deviceForMode:(unsigned int)arg1 withEndpointDeviceID:(id)arg2;
+ (id)deviceForRelaycastModeWithEndpointDeviceID:(id)arg1;
+ (id)deviceForGuestModeWithEndpointDeviceID:(id)arg1;
+ (id)hme_normalizedDeviceID:(id)arg1;
+ (id)hme_normalizedDeviceID:(id)arg1;
- (void).cxx_destruct;
@property(copy, nonatomic) GHCCRelayAccessToken *relayAccessToken; // @synthesize relayAccessToken=_relayAccessToken;
...
@property(readonly, nonatomic) NSString *hme_normalizedDeviceID;
