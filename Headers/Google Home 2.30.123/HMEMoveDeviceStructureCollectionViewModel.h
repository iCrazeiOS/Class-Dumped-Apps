...
@interface HMEMoveDeviceStructureCollectionViewModel : NSObject <HMESetupCollectionViewModel, HMEModelObserver>
{
...
- (id)affectHouseholdItem;
- (id)removeFromCurrentStructureItem;
- (id)addToAnotherStructureItem;
- (void)modelDidChange:(id)arg1;
- (id)initWithCurrentStructure:(id)arg1 structureToMoveIn:(id)arg2;
