...
@class CRPTAppWrapper, CRPTEnrollment2Manager, CRPTKeyedOperationQueue, CRPTStorage, GIPClock, NSMutableArray, NSString;
@protocol SSOService;
...
- (void)finishEnrollmentsWithCallbacks:(id)arg1 error:(id)arg2;
