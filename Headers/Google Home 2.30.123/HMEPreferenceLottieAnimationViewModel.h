...
@class GHCCLottieAnimation, GHCClientRpcInvocation, GHCConfirmationDialog, GHCPreferenceId, GHCPreferenceNewScreenAction, NSAttributedString, NSString, NSURL;
@protocol HMEPreferenceData;

@interface HMEPreferenceLottieAnimationViewModel : NSObject <HMEPreferenceViewModel, HMEPreferenceViewModelValidation>
{
    _Bool _disabled;
    ...
    GHCCLottieAnimation *_lottieAnimation;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) GHCCLottieAnimation *lottieAnimation; // @synthesize lottieAnimation=_lottieAnimation;
