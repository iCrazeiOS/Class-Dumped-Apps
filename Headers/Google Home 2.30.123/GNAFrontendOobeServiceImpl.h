...
#import "GNAFrontendOobeService-Protocol.h"

@class FCDRPC, NSArray, NSString;
@protocol FCDRPCAuthorizer, FCDRPCManager, FCDTransport;

@interface GNAFrontendOobeServiceImpl : FCDRPCService <GNAFrontendOobeService>
{
    FCDRPC *_rpcs[1];
}
...
+ (id)serviceName;
- (void).cxx_destruct;
@property(readonly, nonatomic) FCDRPC *filterValidMixedNetworksRPC;
