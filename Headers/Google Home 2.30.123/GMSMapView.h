...
@class CAAnimation, CALayer, CLLocation, GMSBubbleEntityProvider, GMSCameraPosition, GMSCameraUpdate, GMSCoordinateBounds, GMSDelegateForward, GMSIndoorDisplay, GMSMapLayer, GMSMapStyle, GMSMarker, GMSMarkerDelayedRemovalManager, GMSMarkupProvider, GMSMyLocationProvider, GMSOffscreenEntitiesHostView, GMSProjection, GMSRenderTileProvider, GMSSDKEntityProvider, GMSServices, GMSStickersEntityProvider, GMSUISettings, GMSVectorMapView, GMSx_GMSLSpotlightDescription, NSDate, NSMutableArray, NSMutableSet, NSString, UILongPressGestureRecognizer;
@protocol GMSMapViewAllDelegates, GMSMapViewDelegate, GMSMapViewInternalNavSDKDelegate;
