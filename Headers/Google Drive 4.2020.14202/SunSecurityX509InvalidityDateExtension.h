...
@interface SunSecurityX509InvalidityDateExtension : SunSecurityX509Extension <SunSecurityX509CertAttrSet>
{
    JavaUtilDate *date_;
}

+ (const struct J2ObjcClassInfo *)__metadata;
+ (id)toImplWithJavaSecurityCertExtension:(id)arg1;
- (void)dealloc;
- (id)getName;
- (id)getElements;
...
- (id)initWithBoolean:(_Bool)arg1 withJavaUtilDate:(id)arg2;
