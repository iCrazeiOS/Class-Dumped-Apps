...
+ (void)initialize;
+ (struct ComGoogleProtobufExtensionRegistryLite *)getGeneratedRegistry;
+ (struct ComGoogleProtobufExtensionRegistryLite *)getEmptyRegistry;
- (id).cxx_construct;
- (void).cxx_destruct;
- (id)initWithBoolean:(_Bool)arg1;
- (id)getUnmodifiable;
- (void)addWithComGoogleProtobufExtensionLite:(struct ComGoogleProtobufExtensionLite *)arg1;
