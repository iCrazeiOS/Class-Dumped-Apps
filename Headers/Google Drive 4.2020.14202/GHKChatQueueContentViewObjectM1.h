...
#import <drive_extension_framework/GHKChatQueueContentViewObject-Protocol.h>

@class NSString;
@protocol GHKChatQueueContentViewDelegate;

@interface GHKChatQueueContentViewObjectM1 : GOOBaseContentViewObject <GHKChatQueueContentViewObject>
{
