...
@interface EntryMetadata : GPBMessage
{
}
...
@property(copy, nonatomic) NSData *encodedRestrict; // @dynamic encodedRestrict;
@property(nonatomic) _Bool hasEncodedRestrict; // @dynamic hasEncodedRestrict;
