...
+ (id)getInstanceFromCryptoProviderWithNSString:(id)arg1;
+ (id)getInstanceWithNSString:(id)arg1 withNSString:(id)arg2;
+ (int)getSdkTargetForCryptoProviderWorkaround;
+ (void)setSdkTargetForCryptoProviderWorkaroundWithInt:(int)arg1;
