...
@interface JavaUtilStreamStreamSpliterators_IntWrappingSpliterator_$Lambda$1 : NSObject <JavaUtilStreamSink_OfInt>
{
    JavaUtilStreamSpinedBuffer_OfInt *target$_;
}
