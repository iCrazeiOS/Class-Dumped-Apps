...
- (void)compute;
- (id)getRawResult;
- (id)initWithJavaUtilConcurrentConcurrentHashMap_BulkTask:(id)arg1 withInt:(int)arg2 withInt:(int)arg3 withInt:(int)arg4 withJavaUtilConcurrentConcurrentHashMap_NodeArray:(id)arg5 withJavaUtilConcurrentConcurrentHashMap_MapReduceEntriesToIntTask:(id)arg6 withJavaUtilFunctionToIntFunction:(id)arg7 withInt:(int)arg8 withJavaUtilFunctionIntBinaryOperator:(id)arg9;
