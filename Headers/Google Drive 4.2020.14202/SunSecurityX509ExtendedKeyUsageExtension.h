...
@interface SunSecurityX509ExtendedKeyUsageExtension : SunSecurityX509Extension <SunSecurityX509CertAttrSet>
{
    JavaUtilVector *keyUsages_;
}
...
- (id)initWithJavaLangBoolean:(id)arg1 withJavaUtilVector:(id)arg2;
