...
@class GDKFolderColorPalette, GDKPickerTypeParams, GDKTheme, NSNumber, NSString;
...
@interface GDKPickerParamsBuilder : NSObject
{
    ...
    NSNumber *_searchPlaceholderText_hazzer;
...
@property(retain, nonatomic) NSNumber *searchPlaceholderText_hazzer; // @synthesize searchPlaceholderText_hazzer=_searchPlaceholderText_hazzer;
