...
+ (id)approvalFromMutateResponse:(id)arg1 itemID:(id)arg2;
...
- (void).cxx_destruct;
- (id)stableIDFromItemID:(id)arg1;
- (id)recordApprovalDecision:(int)arg1 forApproval:(id)arg2 item:(id)arg3 comment:(id)arg4;
