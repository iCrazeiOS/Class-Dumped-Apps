...
#import "JavaUtilStreamSpinedBuffer_OfInt.h"

#import "JavaUtilStreamNode_Builder_OfInt-Protocol.h"
#import "JavaUtilStreamNode_OfInt-Protocol.h"

@class NSString;

@interface JavaUtilStreamNodes_IntSpinedNodeBuilder : JavaUtilStreamSpinedBuffer_OfInt <JavaUtilStreamNode_OfInt, JavaUtilStreamNode_Builder_OfInt>
{
    _Bool building_;
}
