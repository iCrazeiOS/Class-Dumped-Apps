...
@class NSArray, PDLClientConfigInternal, PDLPeopleLookupOptions, PDLPeopleLookupRPCDataProvider, PDLResourceCollector, Reachability;
@protocol OS_dispatch_queue, PDLCacheService, PDLCacheSyncingManager, PDLConfigurationService, PDLDeviceContactsService, PDLExperimentsService, PDLLeanDataProvider, PDLLookupPersonCache, PDLMetricsLogger, PDLMetricsTimer, PDLTopNCache;
...
- (void)executeLookup;
- (id)initWithAccountID:(id)arg1 personIDs:(id)arg2 options:(id)arg3 clientID:(long long)arg4 cacheService:(id)arg5 cacheSyncingManager:(id)arg6 experimentsService:(id)arg7 deviceContactsService:(id)arg8 metricsLogger:(id)arg9 peopleWithIDsQueue:(id)arg10 callback:(CDUnknownBlockType)arg11;
