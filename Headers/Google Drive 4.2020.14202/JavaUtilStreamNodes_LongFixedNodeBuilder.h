...
#import "JavaUtilStreamNodes_LongArrayNode.h"

#import "JavaUtilStreamNode_Builder_OfLong-Protocol.h"

@class NSString;

@interface JavaUtilStreamNodes_LongFixedNodeBuilder : JavaUtilStreamNodes_LongArrayNode <JavaUtilStreamNode_Builder_OfLong>
{
}
