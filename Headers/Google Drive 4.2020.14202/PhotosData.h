...
@class AutoBackupEvent, DatabaseSizeEvent, FaceGaiaOptInFailedEvent, OnDeviceSharingSuggestionEvent, OptimisticActionEvent, PhotoEditorEvent, PhotoSearchQueryEvent, PhotoSearchResultEvent, PhotosAssistantMigrationReport, PhotosBuyStorageEvent, PhotosCompleteOnboardingEvent, PhotosDeltaSyncEvent, PhotosDeviceManagementEvent, PhotosInitialMetadataSyncEvent, PhotosIosExtension, PhotosLocationHeaderDataEvent, PhotosNotificationSettingsEvent, PhotosOnDeviceClusteringEvent, PhotosOptimisticActionQueueState, PhotosPerformanceEvent, PhotosShareFlowEvent, PhotosUrlLaunchEvent, SLEPInteractionReliabilityEvent, SLEPMemoriesAvailabilityEvent, TaskLifecycleEvent, UserConnectivityInfo, VideoEditorEvent;
