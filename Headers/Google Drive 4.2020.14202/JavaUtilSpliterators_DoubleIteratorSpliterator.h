...
{
    id <JavaUtilPrimitiveIterator_OfDouble> it_;
...
- (id)trySplit;
- (id)initWithJavaUtilPrimitiveIterator_OfDouble:(id)arg1 withInt:(int)arg2;
- (id)initWithJavaUtilPrimitiveIterator_OfDouble:(id)arg1 withLong:(long long)arg2 withInt:(int)arg3;
