...
#import <drive_extension_framework/GDKActionPanelVCDelegate-Protocol.h>
#import <drive_extension_framework/GDKDialogControllerDelegate-Protocol.h>
#import <drive_extension_framework/GDKFilePileViewDelegate-Protocol.h>
#import <drive_extension_framework/UIGestureRecognizerDelegate-Protocol.h>

@class GDKFilePileView, GDKFolderColorPalette, GDKMultiSelectScreenOverlay, NSArray, NSMutableArray, NSString, UIPanGestureRecognizer, UIView, UIViewController;
@protocol GDKActionPanelItemProviding, GDKFileActionProvider, GDKFileFetcher, GDKFileListing, GDKFileResolving, GDKMultiSelectControllerDelegate, GDKSnackbarControlling, GDKViewControllerContaining;
...
- (id)initWithContainerVC:(id)arg1 actionProvider:(id)arg2 fileFetcher:(id)arg3 snackbarController:(id)arg4 fileResolver:(id)arg5 actionPanelItemProviderProducer:(CDUnknownBlockType)arg6 userID:(id)arg7 buttonOptions:(int)arg8 folderColorPalette:(id)arg9 teamDrivesEnabled:(_Bool)arg10 style:(int)arg11;
