...
#import "GMUPhotosStorageQuotaDataService-Protocol.h"

@class FCDRPC, FCDRPCContext, NSArray, NSString;
@protocol FCDRPCAuthorizer, FCDRPCManager, FCDTransport;

@interface GMUPhotosStorageQuotaDataServiceImpl : FCDRPCService <GMUPhotosStorageQuotaDataService>
{
    FCDRPC *_rpcs[1];
}
...
+ (id)serviceName;
- (void).cxx_destruct;
@property(readonly, nonatomic) FCDRPC *photosReadStorageQuotaRPC;
