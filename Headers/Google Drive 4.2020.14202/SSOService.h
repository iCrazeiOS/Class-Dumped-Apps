...
@class NSDateFormatter, NSError, NSMutableDictionary, NSString, NSURL, SSOConfiguration, SSOIdentity, SSORPCService, SSOServiceExternalAuthState;
@protocol OS_dispatch_queue, SSOIOSGuardManager, SSOProfileSource, SSOServiceSafariBootstrapDelegate;
