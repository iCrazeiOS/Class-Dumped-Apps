...
@property(nonatomic) _Bool hasSupportsTopTabIcons; // @dynamic hasSupportsTopTabIcons;
...
@property(nonatomic) _Bool supportsTopTabIcons; // @dynamic supportsTopTabIcons;
