...
@class NSArray, NSString, PDLClientConfigInternal, PDLLiveAutocompleteQueryProcessor, PDLQueryProceesorDeliverer, PDLQueryProcessorContext, PDLResourceCollector, PDLSessionContext, Reachability;
@protocol GIPAccountID, OS_dispatch_queue, PDLDeviceContactsService, PDLExperimentsService, PDLMetricsLogger, PDLQueryProcessor, PDLQueryProcessorFilter, PDLTopNCache;
