...
@class GDKOfflineStatusMonitor, GDKSharingClient, GSCImageFetcher, GSCImageFetcherCache, GTMSessionFetcherService, MGMMonogramService;
@protocol GDKAlertControlling, GDKCelloAccessing, GDKCelloAccessing><GDKCelloObserverRegistering><GDKCelloShuttingDown, GDKCelloObserverRegistering, GDKContentProvider, GDKFileFetcher, GDKFileMutating, GDKFileQuerent, GDKItemsLiveListQuerent, GDKSnackbarControlling, GDKThumbnailCaching, GDKUploadService, SSOAuthorization, SSOIdentity;
