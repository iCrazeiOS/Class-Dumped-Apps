...
@class JavaUtilRegexMatcher, NSString;
@protocol JavaLangCharSequence;

@interface JavaUtilRegexPattern_1MatcherIterator : NSObject <JavaUtilIterator>
{
    id <JavaLangCharSequence> val$input_;
    JavaUtilRegexMatcher *matcher_;
    int current_;
    NSString *nextElement_;
    int emptyElementCount_;
}
