...
+ (id)parseDelimitedFromWithJavaIoInputStream:(id)arg1 withComGoogleProtobufExtensionRegistryLite:(ComGoogleProtobufExtensionRegistryLite_b06a29df *)arg2;
+ (id)parseDelimitedFromWithJavaIoInputStream:(id)arg1;
+ (id)parseFromWithJavaIoInputStream:(id)arg1 withComGoogleProtobufExtensionRegistryLite:(ComGoogleProtobufExtensionRegistryLite_b06a29df *)arg2;
+ (id)parseFromWithJavaIoInputStream:(id)arg1;
+ (id)parseFromNSData:(id)arg1 registry:(ComGoogleProtobufExtensionRegistryLite_b06a29df *)arg2;
+ (id)parseFromNSData:(id)arg1;
+ (id)parseFromWithByteArray:(id)arg1 withComGoogleProtobufExtensionRegistryLite:(ComGoogleProtobufExtensionRegistryLite_b06a29df *)arg2;
