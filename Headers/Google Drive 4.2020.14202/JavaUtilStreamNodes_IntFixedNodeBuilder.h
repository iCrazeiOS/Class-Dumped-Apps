...
#import "JavaUtilStreamNodes_IntArrayNode.h"

#import "JavaUtilStreamNode_Builder_OfInt-Protocol.h"

@class NSString;

@interface JavaUtilStreamNodes_IntFixedNodeBuilder : JavaUtilStreamNodes_IntArrayNode <JavaUtilStreamNode_Builder_OfInt>
{
}
