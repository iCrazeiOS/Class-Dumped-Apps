...
@interface JavaUtilConcurrentThreadLocalRandom_RandomLongsSpliterator : NSObject <JavaUtilSpliterator_OfLong>
{
    long long index_;
    long long fence_;
    long long origin_;
...
- (id)trySplit;
- (id)initWithLong:(long long)arg1 withLong:(long long)arg2 withLong:(long long)arg3 withLong:(long long)arg4;
