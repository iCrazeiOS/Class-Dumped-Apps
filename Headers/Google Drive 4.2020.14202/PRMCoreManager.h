...
#import <drive_extension_framework/PRMManagerPrivate-Protocol.h>

@class NSMapTable, NSMutableSet, NSString, PRMApplicationStateListener, PRMCollectibleProvider, PRMLowPowerModeService, PRMScheduler;

@interface PRMCoreManager : NSObject <PRMManagerPrivate, PRMManager>
{
