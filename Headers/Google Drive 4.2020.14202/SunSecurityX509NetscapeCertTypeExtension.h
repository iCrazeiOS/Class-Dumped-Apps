...
@interface SunSecurityX509NetscapeCertTypeExtension : SunSecurityX509Extension <SunSecurityX509CertAttrSet>
{
...
+ (int)getPositionWithNSString:(id)arg1;
- (void)dealloc;
- (id)getKeyUsageMappedBits;
- (id)getName;
- (id)getElements;
