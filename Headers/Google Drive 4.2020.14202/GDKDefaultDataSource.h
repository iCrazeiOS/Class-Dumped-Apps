...
@class GDKCollectionViewModel, GDKFileChangeListener, GDKFileQuery, GDKSort, GIPReachability, NSMutableArray, NSString, UIView;
@protocol GDKDataSourceSectionProviding, GDKDragSessionManagerProtocol, GDKFile, GDKFileFetcher, GDKFileSectionProviding, GDKFilesViewDataSourceDelegate, GDKFilesViewViewControllerContainingDelegate, GDKItemsLiveList, GDKItemsLiveListQuerent, SSOIdentity;
...
- (void)peopleSectionProvider:(id)arg1 didSelectFileID:(id)arg2 fromView:(id)arg3;
...
- (id)initWithParams:(id)arg1 fileFetcher:(id)arg2 liveListQuerent:(id)arg3 fileSectionProvider:(id)arg4 additionalSectionProvider:(id)arg5 dragSessionManager:(id)arg6;
