...
@interface JavaUtilStreamStreamSpliterators_LongWrappingSpliterator_$Lambda$3 : NSObject <JavaUtilStreamSink_OfLong>
{
    id <JavaUtilFunctionLongConsumer> target$_;
}
