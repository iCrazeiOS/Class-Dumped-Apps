...
@interface JavaUtilStreamReduceOps_10ReducingSink : JavaUtilStreamReduceOps_Box <JavaUtilStreamReduceOps_AccumulatingSink, JavaUtilStreamSink_OfLong>
{
...
- (id)initWithJavaUtilFunctionSupplier:(id)arg1 withJavaUtilFunctionObjLongConsumer:(id)arg2 withJavaUtilFunctionBinaryOperator:(id)arg3;
