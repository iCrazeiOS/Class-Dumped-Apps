...
@class GTLRDiscussions_Author_Image, NSNumber, NSString;

@interface GTLRDiscussions_Author : GTLRObject
{
}
...
@property(retain, nonatomic) GTLRDiscussions_Author_Image *image; // @dynamic image;
