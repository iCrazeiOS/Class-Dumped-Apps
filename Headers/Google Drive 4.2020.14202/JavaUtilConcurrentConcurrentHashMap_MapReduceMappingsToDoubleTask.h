...
@protocol JavaUtilFunctionDoubleBinaryOperator, JavaUtilFunctionToDoubleBiFunction;
...
- (void)compute;
- (id)getRawResult;
- (id)initWithJavaUtilConcurrentConcurrentHashMap_BulkTask:(id)arg1 withInt:(int)arg2 withInt:(int)arg3 withInt:(int)arg4 withJavaUtilConcurrentConcurrentHashMap_NodeArray:(id)arg5 withJavaUtilConcurrentConcurrentHashMap_MapReduceMappingsToDoubleTask:(id)arg6 withJavaUtilFunctionToDoubleBiFunction:(id)arg7 withDouble:(double)arg8 withJavaUtilFunctionDoubleBinaryOperator:(id)arg9;
