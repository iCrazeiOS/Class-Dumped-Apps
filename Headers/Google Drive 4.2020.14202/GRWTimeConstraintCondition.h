...
{
    int _daysSet;
    CDStruct_e6dbcec9 _hoursRange;
}

+ (_Bool)supportsSecureCoding;
@property(nonatomic) CDStruct_e6dbcec9 hoursRange; // @synthesize hoursRange=_hoursRange;
...
- (id)initWithRangeOfDays:(int)arg1 rangeOfHours:(CDStruct_e6dbcec9)arg2;
