...
@interface JavaUtilStreamReduceOps_11ReducingSink : NSObject <JavaUtilStreamReduceOps_AccumulatingSink, JavaUtilStreamSink_OfDouble>
{
...
- (id)initWithDouble:(double)arg1 withJavaUtilFunctionDoubleBinaryOperator:(id)arg2;
