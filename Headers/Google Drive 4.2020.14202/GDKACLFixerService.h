...
+ (id)driveFixItemForFixItem:(id)arg1;
...
- (void).cxx_destruct;
- (void)fixACLWithOption:(int)arg1 withRole:(int)arg2 forFileIDs:(id)arg3 forRecipients:(id)arg4 snackbarController:(id)arg5 completion:(CDUnknownBlockType)arg6;
- (void)fixACLWithOption:(int)arg1 withRole:(int)arg2 forFileIDs:(id)arg3 forRecipients:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)checkACLStateWithRole:(int)arg1 forFileIDs:(id)arg2 forRecipients:(id)arg3 completion:(CDUnknownBlockType)arg4;
