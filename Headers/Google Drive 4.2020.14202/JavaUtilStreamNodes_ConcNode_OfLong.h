...
@interface JavaUtilStreamNodes_ConcNode_OfLong : JavaUtilStreamNodes_ConcNode_OfPrimitive <JavaUtilStreamNode_OfLong>
{
}
...
- (id)spliterator;
- (id)initWithJavaUtilStreamNode_OfLong:(id)arg1 withJavaUtilStreamNode_OfLong:(id)arg2;
