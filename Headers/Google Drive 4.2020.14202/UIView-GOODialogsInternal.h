...
#import <drive_extension_framework/SLKLayoutItem-Protocol.h>

@class MASViewAttribute, NSMutableSet, NSNumber, NSString;

@interface UIView (GOODialogsInternal) <SLKLayoutItem>
