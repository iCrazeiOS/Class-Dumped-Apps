...
{
    id <JavaUtilPrimitiveIterator_OfInt> it_;
...
- (id)trySplit;
- (id)initWithJavaUtilPrimitiveIterator_OfInt:(id)arg1 withInt:(int)arg2;
- (id)initWithJavaUtilPrimitiveIterator_OfInt:(id)arg1 withLong:(long long)arg2 withInt:(int)arg3;
