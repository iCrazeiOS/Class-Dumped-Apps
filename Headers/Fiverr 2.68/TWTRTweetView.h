...
@interface TWTRTweetView : UIView <TWTRAttributedLabelDelegate, TWTRProfileHeaderViewDelegate, TWTRTweetMediaViewDelegate, TWTRSubscriber, UIAppearanceContainer>
{
    _Bool _showBorder;
