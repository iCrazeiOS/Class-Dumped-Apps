...
@class DACircularProgressView, MWCaptionView, MWPhotoBrowser, MWTapDetectingImageView, MWTapDetectingView, NSString, UIButton, UIImageView, UILabel, _TtC6fiverr18MediaNoPreviewView;
@protocol MWPhoto;
...
@interface MWZoomingScrollView : UIScrollView <UIScrollViewDelegate, MWTapDetectingImageViewDelegate, MWTapDetectingViewDelegate>
{
    ...
    _TtC6fiverr18MediaNoPreviewView *_noPreviewView;
}

@property(readonly, nonatomic) _TtC6fiverr18MediaNoPreviewView *noPreviewView; // @synthesize noPreviewView=_noPreviewView;
