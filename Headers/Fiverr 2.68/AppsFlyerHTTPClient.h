...
- (id)requestWithURL:(CDUnknownBlockType)arg1 URLRequest:(CDUnknownBlockType)arg2 HTTPMethod:(id)arg3 dictionary:(id)arg4 retries:(long long)arg5 isReturnJSON:(_Bool)arg6 completionHandler:(CDUnknownBlockType)arg7;
