...
@class NSData, NSDictionary, NSString, YTIClipAttachmentCreationEntity;
...
@interface YTClipAttachmentCreationEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIClipAttachmentCreationEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIClipAttachmentCreationEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
