...
@class NSData, NSDictionary, NSString, YTIVideoAttachmentCreationEntity;
...
@interface YTVideoAttachmentCreationEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIVideoAttachmentCreationEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIVideoAttachmentCreationEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
