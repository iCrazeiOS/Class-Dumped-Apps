...
#import <Module_Framework/GCKSession.h>
...
+ (id)selectApplicationIDFromCastOptions:(id)arg1 sessionOptions:(id)arg2;
- (void).cxx_destruct;
...
- (void)resume;
- (void)start;
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 sessionOptions:(id)arg3 castOptions:(id)arg4 analyticsEventLogger:(id)arg5 discoveryManager:(id)arg6 runtimeConfiguration:(id)arg7;
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 sessionOptions:(id)arg3 castOptions:(id)arg4;
