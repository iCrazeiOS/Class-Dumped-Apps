...
@class NSString, QTMActivityIndicator, UITapGestureRecognizer, YTCommandResponderEvent, YTEditMetadataFullViewController, YTICommand, YTILocationMetadata, YTMESelectLocationViewController, YTQTMButton, YTUploadTaskController;
@protocol YTEditMetadataEditor, YTResponder;

@interface YTEditExistingVideoMetadataViewController : YTEditBaseMetadataViewController <YTStyleContextResponderProvider, YTPageStyleProvider, YTAvatarImageObserverDelegate, YTEditMetadataFullViewControllerDelegate, YTPageStyleControllerObserver, YTTopController, YTGraftingViewController>
{
    YTICommand *_model;
