...
@class NSData, NSDictionary, NSString, YTIStoriesCreatorInfoPanelDismissalStateEntity;
...
@interface YTStoriesCreatorInfoPanelDismissalStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIStoriesCreatorInfoPanelDismissalStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIStoriesCreatorInfoPanelDismissalStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
