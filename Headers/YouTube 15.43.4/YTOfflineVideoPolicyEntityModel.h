...
@class NSData, NSDictionary, NSString, YTClientEndpointBuilderDataModel, YTIOfflineVideoPolicyEntity, YTOfflineFutureUnplayableInfoModel;
...
@interface YTOfflineVideoPolicyEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIOfflineVideoPolicyEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIOfflineVideoPolicyEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
