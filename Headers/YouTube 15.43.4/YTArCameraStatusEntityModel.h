...
@class NSData, NSDictionary, NSString, YTIArCameraStatusEntity;
...
@interface YTArCameraStatusEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIArCameraStatusEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIArCameraStatusEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
