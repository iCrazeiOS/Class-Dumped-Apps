...
@class NSData, NSDictionary, NSString, YTISfvAudioItemCurrentlyPlayingEntity;
...
@interface YTSfvAudioItemCurrentlyPlayingEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTISfvAudioItemCurrentlyPlayingEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTISfvAudioItemCurrentlyPlayingEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
