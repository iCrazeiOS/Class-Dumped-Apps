...
@class NSArray, NSData, NSDictionary, NSString, YTISurveyStateEntity;
...
@interface YTSurveyStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    NSArray *_isSelectedArray;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTISurveyStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTISurveyStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) NSArray *isSelectedArray; // @synthesize isSelectedArray=_isSelectedArray;
