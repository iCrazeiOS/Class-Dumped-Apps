...
@class NSArray, NSData, NSString, YTFormattedStringSupportedAccessibilityDatasModel, YTIFormattedString;
...
@interface YTFormattedStringModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    NSArray *_runsArray;
    YTFormattedStringSupportedAccessibilityDatasModel *_accessibility;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIFormattedString *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIFormattedString *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTFormattedStringSupportedAccessibilityDatasModel *accessibility; // @synthesize accessibility=_accessibility;
@property(retain, nonatomic) NSArray *runsArray; // @synthesize runsArray=_runsArray;
