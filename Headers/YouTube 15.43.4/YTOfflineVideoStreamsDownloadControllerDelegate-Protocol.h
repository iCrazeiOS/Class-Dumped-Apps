...
- (void)downloadDidFailPermanentlyWithVideoID:(NSString *)arg1 error:(NSError *)arg2;
- (void)downloadDidFailRetryablyWithVideoID:(NSString *)arg1 error:(NSError *)arg2;
- (void)downloadDidCancelWithVideoID:(NSString *)arg1;
- (void)downloadDidCompleteWithVideoID:(NSString *)arg1;
