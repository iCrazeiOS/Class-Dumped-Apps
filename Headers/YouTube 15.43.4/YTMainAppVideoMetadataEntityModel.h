...
@class NSData, NSDictionary, NSString, YTIMainAppVideoMetadataEntity, YTVideoEntityModel;
...
@interface YTMainAppVideoMetadataEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMainAppVideoMetadataEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIMainAppVideoMetadataEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
