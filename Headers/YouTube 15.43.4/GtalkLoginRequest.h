...
@property(retain, nonatomic) NSMutableArray *emergencyRegionsArray; // @dynamic emergencyRegionsArray;
@property(readonly, nonatomic) unsigned long long emergencyRegionsArray_Count; // @dynamic emergencyRegionsArray_Count;
...
@property(nonatomic) _Bool hasCheckboxState; // @dynamic hasCheckboxState;
