...
@class ABCTooltipController, NSString;

@interface GRWMessagingDisplayTooltip : UIViewController <GRWMessagingDisplayPresentation>
{
    ABCTooltipController *_tooltipController;
}

- (void).cxx_destruct;
@property(retain, nonatomic) ABCTooltipController *tooltipController; // @synthesize tooltipController=_tooltipController;
