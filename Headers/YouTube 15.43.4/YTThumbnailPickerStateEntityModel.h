...
@class NSData, NSDictionary, NSString, YTIThumbnailPickerStateEntity;
...
@interface YTThumbnailPickerStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIThumbnailPickerStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIThumbnailPickerStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
