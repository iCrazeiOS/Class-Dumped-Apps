...
+ (id)yt_attributedStringFromHTMLString:(id)arg1 font:(id)arg2 boldFont:(id)arg3 trimLeadingWhitespace:(_Bool)arg4;
+ (id)yt_attributedStringWithHTMLString:(id)arg1 font:(id)arg2 boldFont:(id)arg3 trimLeadingWhitespace:(_Bool)arg4;
+ (id)as_attachmentStringWithEmojiImage:(id)arg1 fontSize:(double)arg2;
+ (id)as_attachmentStringWithContent:(id)arg1 contentMode:(long long)arg2 attachmentSize:(struct CGSize)arg3 alignToFont:(id)arg4 alignment:(long long)arg5 contentInsets:(struct UIEdgeInsets)arg6 userInfo:(id)arg7;
...
@property(readonly, copy, nonatomic) NSDictionary *as_ctAttributes;
