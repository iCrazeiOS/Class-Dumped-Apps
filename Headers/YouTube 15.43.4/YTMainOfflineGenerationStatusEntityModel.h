...
@class NSData, NSDictionary, NSString, YTIMainOfflineGenerationStatusEntity;
...
@interface YTMainOfflineGenerationStatusEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMainOfflineGenerationStatusEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIMainOfflineGenerationStatusEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
