...
@property(nonatomic) _Bool disablePlayerResponse; // @dynamic disablePlayerResponse;
@property(nonatomic) _Bool hasContext; // @dynamic hasContext;
@property(nonatomic) _Bool hasDisablePlayerResponse; // @dynamic hasDisablePlayerResponse;
