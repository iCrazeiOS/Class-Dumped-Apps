...
@class NSData, NSDictionary, NSString, YTIUnpluggedVideoDownloadStateEntity;
...
@interface YTUnpluggedVideoDownloadStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIUnpluggedVideoDownloadStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIUnpluggedVideoDownloadStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
