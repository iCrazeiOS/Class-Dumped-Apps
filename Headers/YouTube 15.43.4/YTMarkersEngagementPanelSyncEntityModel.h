...
@class NSData, NSDictionary, NSString, YTActiveSectionInfoModel, YTIMarkersEngagementPanelSyncEntity;
...
@interface YTMarkersEngagementPanelSyncEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    YTActiveSectionInfoModel *_activeSectionInfo;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIMarkersEngagementPanelSyncEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIMarkersEngagementPanelSyncEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTActiveSectionInfoModel *activeSectionInfo; // @synthesize activeSectionInfo=_activeSectionInfo;
