...
@class NSData, NSDictionary, NSString, YTIYtMainDownloadsLibraryEntity, YTYtMainDownloadsListEntityModel;
@protocol YTEntityStore;

@interface YTYtMainDownloadsLibraryEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    NSString *_id_p;
    ...
    YTIYtMainDownloadsLibraryEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIYtMainDownloadsLibraryEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (void)downloadsListWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTYtMainDownloadsListEntityModel *downloadsList;
