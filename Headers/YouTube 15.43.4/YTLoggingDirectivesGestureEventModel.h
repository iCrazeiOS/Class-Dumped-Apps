...
@class NSData, YTILoggingDirectivesGestureEvent;
...
@interface YTLoggingDirectivesGestureEventModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTILoggingDirectivesGestureEvent *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTILoggingDirectivesGestureEvent *protoBuf; // @synthesize protoBuf=_protoBuf;
