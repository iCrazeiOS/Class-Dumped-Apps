...
#import <Module_Framework/CCTGlobalLogTransformersProvider-Protocol.h>

@class CCTClientInfoMaker, NSMutableDictionary, NSString;
@protocol OS_dispatch_queue;

@interface CCTLogWriter : NSObject <CCTGlobalLogTransformersProvider>
{
