...
@class NSArray, NSData, NSDictionary, NSString, YTIFakeChannelEntity;
...
@interface YTFakeChannelEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    NSArray *_repeatedIntValuesArray;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    NSArray *_repeatedStringValuesArray;
...
@property(retain, nonatomic) NSArray *repeatedStringValuesArray; // @synthesize repeatedStringValuesArray=_repeatedStringValuesArray;
...
@property(retain, nonatomic) NSArray *repeatedIntValuesArray; // @synthesize repeatedIntValuesArray=_repeatedIntValuesArray;
...
- (void)oneofChannelEntityWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) YTFakeChannelEntityModel *oneofChannelEntity;
- (void)alternateChannelListArrayAtIndexes:(id)arg1 callbackQueue:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (void)alternateChannelWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
