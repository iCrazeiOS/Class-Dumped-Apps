...
+ (void)presentAlertController:(id)arg1 fromViewController:(id)arg2;
+ (id)alertControllerWithTitle:(id)arg1 message:(id)arg2 action:(id)arg3 showsCancelButton:(_Bool)arg4;
