...
#import <Module_Framework/YTMainRecommendedDownloadFormatModel.h>

@class NSData, NSString;

@interface YTMutableMainRecommendedDownloadFormatModel : YTMainRecommendedDownloadFormatModel
{
}
