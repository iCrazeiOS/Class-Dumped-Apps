...
@class NSData, YTFormattedStringModel, YTIOfflineabilityFormat;
@protocol YTEntityStore;

@interface YTOfflineabilityFormatModel : NSObject <NSCopying, NSMutableCopying>
{
    _Bool _parseAndExtractFieldsFromProtoData;
    _Bool _generateData;
    YTFormattedStringModel *_name;
    YTFormattedStringModel *_approximateSize;
    NSData *_data;
    id <YTEntityStore> _entityStore;
    YTIOfflineabilityFormat *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIOfflineabilityFormat *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTFormattedStringModel *approximateSize; // @synthesize approximateSize=_approximateSize;
@property(retain, nonatomic) YTFormattedStringModel *name; // @synthesize name=_name;
...
@property(readonly, nonatomic) _Bool hasFormatType;
- (id)entityVersion;
- (id)init;
