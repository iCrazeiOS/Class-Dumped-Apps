...
#import <Module_Framework/GCKCastDeviceStatusGoogleOnlyListener-Protocol.h>
#import <Module_Framework/GCKDiscoveryManagerListener-Protocol.h>
#import <Module_Framework/GCKSessionDelegate-Protocol.h>
...
- (id)defaultSessionOptionsForDeviceCategory:(id)arg1;
- (void)setDefaultSessionOptions:(id)arg1 forDeviceCategory:(id)arg2;
...
- (void)internalEndSession:(id)arg1 stopCasting:(_Bool)arg2;
- (_Bool)endSession:(id)arg1 stopCasting:(_Bool)arg2;
- (_Bool)endSessionAndStopCasting:(_Bool)arg1;
- (_Bool)endSession;
- (_Bool)startSessionWithDevice:(id)arg1 sessionOptions:(id)arg2 sessionID:(id)arg3 resumeReason:(int)arg4;
- (_Bool)startSessionWithOpenURLOptions:(id)arg1 sessionOptions:(id)arg2;
- (_Bool)startSessionWithDevice:(id)arg1 sessionOptions:(id)arg2;
- (_Bool)startSessionWithDevice:(id)arg1;
- (_Bool)joinSessionOnDevice:(id)arg1 sessionOptions:(id)arg2;
