...
@class NSData, NSDictionary, NSString, YTISubscriptionStateEntity;
...
@interface YTSubscriptionStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTISubscriptionStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTISubscriptionStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
