...
@class NSData, NSDictionary, NSString, YTINotificationOsSettingEntity;
...
@interface YTNotificationOsSettingEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTINotificationOsSettingEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTINotificationOsSettingEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
