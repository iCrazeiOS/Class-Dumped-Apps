...
#import <Module_Framework/_ASTableViewCellDelegate-Protocol.h>
...
- (id)_initWithFrame:(struct CGRect)arg1 style:(long long)arg2 dataControllerClass:(Class)arg3 owningNode:(id)arg4;
