...
@class NSData, YTIClientYouTubeDataMember_ScoringEventInfo;
...
@interface YTClientYouTubeDataMember_ScoringEventInfoModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIClientYouTubeDataMember_ScoringEventInfo *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIClientYouTubeDataMember_ScoringEventInfo *protoBuf; // @synthesize protoBuf=_protoBuf;
