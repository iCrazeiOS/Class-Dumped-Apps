...
@class NSData, YTIClientYouTubeDataMember_ChannelItem;
...
@interface YTClientYouTubeDataMember_ChannelItemModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIClientYouTubeDataMember_ChannelItem *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIClientYouTubeDataMember_ChannelItem *protoBuf; // @synthesize protoBuf=_protoBuf;
