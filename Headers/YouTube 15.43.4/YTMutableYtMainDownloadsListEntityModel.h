...
#import <Module_Framework/YTYtMainDownloadsListEntityModel.h>

#import <Module_Framework/YTMutableEntity-Protocol.h>

@class NSArray, NSData, NSDictionary, NSString;

@interface YTMutableYtMainDownloadsListEntityModel : YTYtMainDownloadsListEntityModel <YTMutableEntity>
{
}
...
@property(retain, nonatomic) NSArray *downloadsArray; // @dynamic downloadsArray;
