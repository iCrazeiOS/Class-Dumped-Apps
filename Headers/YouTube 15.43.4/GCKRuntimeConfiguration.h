...
#import <Module_Framework/GCKNHTTPRequestDelegate-Protocol.h>
#import <Module_Framework/GCKParameterMapDelegate-Protocol.h>

@class GCKAnalyticsEventLogger, GCKBSystemInfo, GCKNHTTPClient, GCKNHTTPRequest, GCKParameterMap, NSArray, NSCharacterSet, NSDictionary, NSMutableDictionary, NSString, NSTimer, NSURL;
