...
#import <Module_Framework/GRWRecommendedAppsUpdateListener-Protocol.h>
#import <Module_Framework/MDCAppBarNavigationControllerDelegate-Protocol.h>
...
- (id)blankViewForCollectionView:(id)arg1 kind:(id)arg2 atIndexPath:(id)arg3;
