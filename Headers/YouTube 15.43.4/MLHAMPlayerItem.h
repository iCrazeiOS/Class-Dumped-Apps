...
@class GIMMe, HAMEventCenter, HAMFormatSelection, HAMPlayerContext, MLABRPolicy, MLAdaptiveLiveController, MLBitrateCap, MLCachePinHandle, MLChunkFactoryProvider, MLChunkLoader, MLDRMController, MLFormat, MLFormat3Captions, MLHAMManifestlessSegmentMetadataFetcher, MLHAMQueuePlayerSegmentList, MLMediaDataLoader, MLOnesieVideoData, MLPlayerItemEventCenter, MLQOEPingController, MLSegmentTimeline, MLVideo, NSArray, NSError, NSString, NSURL, YTIHamplayerConfig, YTIHamplayerHotConfig;
