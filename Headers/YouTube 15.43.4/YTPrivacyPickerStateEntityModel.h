...
@class NSData, NSDictionary, NSString, YTIPrivacyPickerStateEntity, YTScheduledPublishingDetailsModel;
...
@interface YTPrivacyPickerStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    YTScheduledPublishingDetailsModel *_scheduledPublishingDetails;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIPrivacyPickerStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIPrivacyPickerStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) YTScheduledPublishingDetailsModel *scheduledPublishingDetails; // @synthesize scheduledPublishingDetails=_scheduledPublishingDetails;
