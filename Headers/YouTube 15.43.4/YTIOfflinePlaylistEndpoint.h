...
@property(retain, nonatomic) NSMutableArray *optimisticActionsArray; // @dynamic optimisticActionsArray;
@property(readonly, nonatomic) unsigned long long optimisticActionsArray_Count; // @dynamic optimisticActionsArray_Count;
