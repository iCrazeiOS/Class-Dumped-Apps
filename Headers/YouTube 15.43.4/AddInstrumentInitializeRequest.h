...
@class AddInstrumentParameters, NSData, OrchClientParameters, OrchRequestContext;
...
@property(retain, nonatomic) AddInstrumentParameters *parameters; // @dynamic parameters;
