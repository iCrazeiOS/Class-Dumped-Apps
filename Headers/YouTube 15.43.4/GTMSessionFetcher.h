...
@interface GTMSessionFetcher : NSObject <NSURLSessionDelegate>
{
    ...
    _Bool _clientWillReconnectBackgroundSession;
    ...
    CDUnknownBlockType _metricsCollectionBlock;
...
+ (void)reconnectFetchersForBackgroundSessionsOnAppLaunch:(id)arg1;
+ (void)load;
+ (id)ml_remoteSegmentForSessionFetcher:(id)arg1;
+ (_Bool)ml_isBackgroundDownloadFetcherForSessionIdentifier:(id)arg1;
+ (void)ml_stopFetcherWithSessionIdentifier:(id)arg1;
+ (id)ml_remoteSegmentForSessionIdentifier:(id)arg1;
...
@property(copy) CDUnknownBlockType metricsCollectionBlock; // @synthesize metricsCollectionBlock=_metricsCollectionBlock;
...
@property _Bool clientWillReconnectBackgroundSession; // @synthesize clientWillReconnectBackgroundSession=_clientWillReconnectBackgroundSession;
...
- (void)ml_setIsBackgroundDownloadFetcher:(_Bool)arg1;
- (void)ml_setRemoteSegment:(id)arg1;
