...
- (void)tapToPauseControllerViewDidShowPauseIcon:(id)arg1;
- (void)tapToPauseControllerViewDidAnimatePausePlayIcon:(id)arg1;
- (long long)tapToPauseControllerWillStartTapToPause:(id)arg1;
- (void)tapToPauseControllerDidEndTapToPause:(id)arg1;
