...
@class NSMutableArray, NSMutableDictionary, NSMutableSet, QTMCollectionView, UIColor;
...
+ (id)cellBackgroundImageWithStyleController:(id)arg1 sectionOrdinalPosition:(unsigned long long)arg2 atIndexPath:(id)arg3 elementKind:(unsigned long long)arg4 traitCollection:(id)arg5;
