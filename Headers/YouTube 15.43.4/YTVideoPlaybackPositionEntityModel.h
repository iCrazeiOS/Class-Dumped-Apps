...
@class NSData, NSDictionary, NSString, YTIVideoPlaybackPositionEntity;
...
@interface YTVideoPlaybackPositionEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIVideoPlaybackPositionEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIVideoPlaybackPositionEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
