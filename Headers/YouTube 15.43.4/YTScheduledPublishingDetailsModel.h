...
@class NSData, NSString, YTIScheduledPublishingDetails;
...
@interface YTScheduledPublishingDetailsModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIScheduledPublishingDetails *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIScheduledPublishingDetails *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(readonly, nonatomic) unsigned long long secondsFromEpoc;
@property(readonly, nonatomic) _Bool hasSecondsFromEpoc;
- (id)entityVersion;
- (id)init;
