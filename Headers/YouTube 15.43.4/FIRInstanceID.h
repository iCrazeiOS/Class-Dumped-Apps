...
#import <Module_Framework/FIRInstanceIDInstanceProvider-Protocol.h>
...
- (id)defaultTokenOptions;
- (void)messagingTokenDidChangeNotificationReceived:(id)arg1;
...
- (_Bool)isDefaultTokenWithAuthorizedEntity:(id)arg1 scope:(id)arg2;
...
- (void)deleteCheckinWithHandler:(CDUnknownBlockType)arg1;
