...
@class NSData, NSString, YTIClientEndpointBuilderData;
...
@interface YTClientEndpointBuilderDataModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIClientEndpointBuilderData *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIClientEndpointBuilderData *protoBuf; // @synthesize protoBuf=_protoBuf;
