...
@class NSData, NSDictionary, NSString, YTILocationPickerServerStateEntity;
...
@interface YTLocationPickerServerStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTILocationPickerServerStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTILocationPickerServerStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
