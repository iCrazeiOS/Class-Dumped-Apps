...
@class NSData, NSDictionary, NSString, YTIMainDownloadablePlaylistMetadataEntity;
...
@interface YTMainDownloadablePlaylistMetadataEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMainDownloadablePlaylistMetadataEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIMainDownloadablePlaylistMetadataEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
