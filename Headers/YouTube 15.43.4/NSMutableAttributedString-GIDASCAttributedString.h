...
+ (id)yt_attributedStringWithFormattedString:(id)arg1 typeKind:(long long)arg2 typeVariant:(long long)arg3;
+ (id)yt_attributedStringWithFormattedString:(id)arg1 typeKind:(long long)arg2;
+ (id)yt_attributedStringWithFormattedString:(id)arg1 typeKind:(long long)arg2 typeVariant:(long long)arg3 autoDetectURLEndpoints:(_Bool)arg4;
+ (id)yt_attributedStringWithFormattedString:(id)arg1 textColor:(id)arg2 fontSize:(int)arg3 fontStyle:(int)arg4 boldFontStyle:(int)arg5 italicFontStyle:(int)arg6 boldItalicFontStyle:(int)arg7 autoDetectURLEndpoints:(_Bool)arg8;
+ (id)yt_attributedStringWithFormattedString:(id)arg1 textColor:(id)arg2 fontSize:(int)arg3 fontStyle:(int)arg4;
...
- (void)updateFontForTextStyle:(id)arg1;
