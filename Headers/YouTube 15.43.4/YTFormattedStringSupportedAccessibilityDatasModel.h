...
@class NSData, YTAccessibilityDataModel, YTIFormattedStringSupportedAccessibilityDatas;
...
@interface YTFormattedStringSupportedAccessibilityDatasModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIFormattedStringSupportedAccessibilityDatas *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIFormattedStringSupportedAccessibilityDatas *protoBuf; // @synthesize protoBuf=_protoBuf;
