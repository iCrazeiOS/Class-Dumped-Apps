...
@class NSData, NSDictionary, NSString, YTIUnpluggedSpoilerModeStateEntity;
...
@interface YTUnpluggedSpoilerModeStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIUnpluggedSpoilerModeStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIUnpluggedSpoilerModeStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
