...
@class NSData, YTIUnpluggedLensClip_TimeRange;
...
@interface YTUnpluggedLensClip_TimeRangeModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIUnpluggedLensClip_TimeRange *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIUnpluggedLensClip_TimeRange *protoBuf; // @synthesize protoBuf=_protoBuf;
