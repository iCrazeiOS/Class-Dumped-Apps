...
@protocol HAMFrameSourceDelegate, MLAudioFormatConstraint, MLCaptionDisplayController, MLCaptionTrack, MLCuepointCollector, MLHAMPlayerItemProtocol, MLHAMPlayerViewProtocol, MLPlayerCaptionDelegate, MLPlayerConfig, MLPlayerDelegate, MLPlayerItemInternal, MLVideoFormatConstraint, MLVideoSplicer;
