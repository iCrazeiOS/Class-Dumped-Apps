...
@class NSData, NSDictionary, NSString, YTIUnpluggedDvrEntity;
...
@interface YTUnpluggedDvrEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIUnpluggedDvrEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIUnpluggedDvrEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
