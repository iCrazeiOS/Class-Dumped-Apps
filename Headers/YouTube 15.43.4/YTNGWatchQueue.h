...
@class GIMMe, MLPlayerStickySettings, NSHashTable, NSMutableArray, NSString, UIViewController, YTWatchTransition;
@protocol YTNGWatchQueueCollectionViewController, YTResponder, YTWatchFlowControllerProtocol, YTWatchViewControllerProtocol;

@interface YTNGWatchQueue : NSObject <YTNGWatchControllerDelegate, YTNGWatchQueue>
{
