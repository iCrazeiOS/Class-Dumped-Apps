...
@class NSData, YTIUnpluggedStreamChunkBasedPosition;
...
@interface YTUnpluggedStreamChunkBasedPositionModel : NSObject <NSCopying, NSMutableCopying>
{
    ...
    YTIUnpluggedStreamChunkBasedPosition *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIUnpluggedStreamChunkBasedPosition *protoBuf; // @synthesize protoBuf=_protoBuf;
