...
@class NSData, NSDictionary, NSString, YTIDownloadQuotaEntity;
@protocol YTEntityStore;

@interface YTDownloadQuotaEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    NSString *_key;
    ...
    YTIDownloadQuotaEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIDownloadQuotaEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(readonly, nonatomic) int availableQuota;
@property(readonly, nonatomic) _Bool hasAvailableQuota;
