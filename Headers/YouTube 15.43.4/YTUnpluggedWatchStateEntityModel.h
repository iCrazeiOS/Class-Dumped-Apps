...
@class NSData, NSDictionary, NSString, YTIUnpluggedWatchStateEntity;
...
@interface YTUnpluggedWatchStateEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIUnpluggedWatchStateEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIUnpluggedWatchStateEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
