...
@property(retain, nonatomic) NSArray *retryScheduleIntervalsInSecondsArray; // @synthesize retryScheduleIntervalsInSecondsArray=_retryScheduleIntervalsInSecondsArray;
