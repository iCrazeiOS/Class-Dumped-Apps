...
@class NSArray, NSData, NSDictionary, NSString, YTIDrmLicenseEntity, YTRefreshEntityModel;
...
@interface YTDrmLicenseEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    _Bool _generateData;
    NSArray *_licensesArray;
    NSData *_data;
    NSDictionary *_entityMetadata;
    id <YTEntityStore> _entityStore;
    YTIDrmLicenseEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIDrmLicenseEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
@property(retain, nonatomic) NSArray *licensesArray; // @synthesize licensesArray=_licensesArray;
