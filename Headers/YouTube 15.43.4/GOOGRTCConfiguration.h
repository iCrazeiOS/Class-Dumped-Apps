...
@class GOOGRTCCertificate, GOOGRTCCryptoOptions, NSArray, NSNumber;
...
@interface GOOGRTCConfiguration : NSObject
{
    ...
    NSArray *_iceServers;
    GOOGRTCCertificate *_certificate;
    ...
    GOOGRTCCryptoOptions *_cryptoOptions;
}
...
@property(retain, nonatomic) GOOGRTCCryptoOptions *cryptoOptions; // @synthesize cryptoOptions=_cryptoOptions;
...
@property(retain, nonatomic) GOOGRTCCertificate *certificate; // @synthesize certificate=_certificate;
