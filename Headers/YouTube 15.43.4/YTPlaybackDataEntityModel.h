...
@class NSArray, NSData, NSDictionary, NSString, YTDrmLicenseEntityModel, YTIPlaybackDataEntity, YTOfflineVideoPolicyEntityModel, YTTransferEntityModel;
...
@interface YTPlaybackDataEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIPlaybackDataEntity *_protoBuf;
}

- (void).cxx_destruct;
@property(copy, nonatomic) YTIPlaybackDataEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
...
- (void)offlineVideoPolicyWithCallbackQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
...
- (void)adsPlaybackDataArrayAtIndexes:(id)arg1 callbackQueue:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
