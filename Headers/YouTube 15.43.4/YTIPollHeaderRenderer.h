...
@property(nonatomic) _Bool hasQuestionThumbnail; // @dynamic hasQuestionThumbnail;
...
@property(retain, nonatomic) YTIThumbnailDetails *questionThumbnail; // @dynamic questionThumbnail;
