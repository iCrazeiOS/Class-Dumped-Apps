...
#import <Module_Framework/YTYtMainDownloadsLibraryEntityModel.h>

#import <Module_Framework/YTMutableEntity-Protocol.h>

@class NSData, NSDictionary, NSString, YTYtMainDownloadsListEntityModel;

@interface YTMutableYtMainDownloadsLibraryEntityModel : YTYtMainDownloadsLibraryEntityModel <YTMutableEntity>
{
}
...
@property(retain, nonatomic) YTYtMainDownloadsListEntityModel *downloadsList; // @dynamic downloadsList;
