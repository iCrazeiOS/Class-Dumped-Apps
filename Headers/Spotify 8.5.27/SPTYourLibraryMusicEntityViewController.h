...
@class NSString, NSURL, SPTProgressView, SPTTableView, SPTYourLibraryMusicEmptyView, SPTYourLibraryMusicFilterBarViewController, SPTYourLibraryMusicGLUETheme;
@protocol GLUEImageLoader, SPTPageContainer, SPTShareDragDelegateFactory, SPTSnackbarConditionalPresenter, SPTSortingFilteringUIFactory, SPTViewLogger, SPTYourLibraryMusicEntityCellConfigurator, SPTYourLibraryMusicEntityViewModel, SPTYourLibraryPageDelegate, UITableViewDragDelegate;
