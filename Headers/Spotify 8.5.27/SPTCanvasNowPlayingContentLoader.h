...
@class NSCache, NSMapTable, NSString, SPTCanvasContentLayerViewControllerViewModelFactory, SPTCanvasNowPlayingContentLoaderTracker, SPTCanvasNowPlayingContentReloader, SPTCanvasNowPlayingViewState;
@protocol SPTCanvasNowPlayingContentLoaderDelegate, SPTCanvasTrackChecker;
