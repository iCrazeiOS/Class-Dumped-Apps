...
@interface SPTFreeTierCollectionFeatureProperties : NSObject <SPTRemoteConfigurationProperties>
{
    ...
    _Bool _likedSongsAccessibleHeaderEnabled;
}

@property(readonly, nonatomic) _Bool likedSongsAccessibleHeaderEnabled; // @synthesize likedSongsAccessibleHeaderEnabled=_likedSongsAccessibleHeaderEnabled;
