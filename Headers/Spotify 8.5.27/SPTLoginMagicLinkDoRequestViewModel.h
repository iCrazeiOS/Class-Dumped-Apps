...
@protocol SPTMagicLinkDoRequestViewModelDelegate, SPTNavigationRouter;
...
- (id)viewStyle;
- (id)initWithTheme:(id)arg1 emailOrUsername:(id)arg2 errorMessage:(id)arg3 recoverAccountDataLoader:(id)arg4 navigationRouter:(id)arg5 logger:(id)arg6 magicLinkRequestTracker:(id)arg7 magicLinkWarningPresenter:(id)arg8;
