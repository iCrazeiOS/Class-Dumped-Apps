...
- (id)initWithVideoPlayerFactory:(id)arg1 videoAssetLoader:(id)arg2 imageResolverFactory:(id)arg3 linkDispatcher:(id)arg4 idleMonitorDelegate:(id)arg5 tooltipManager:(id)arg6;
