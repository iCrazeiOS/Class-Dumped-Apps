...
@protocol SPTGLUEImageLoaderFactory, SPTPerformanceMetricsViewLoggerFactory, SPTPlaylistPlatformPlaylistSynchroniser, SPTShareDragDelegateFactory, SPTSortingFilteringUIFactory, SPTYourLibraryMusicTestManager;
