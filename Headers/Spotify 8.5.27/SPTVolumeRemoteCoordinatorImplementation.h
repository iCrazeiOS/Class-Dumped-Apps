...
@class NSString, SPTVolumeOutputRouteManager, SPTVolumeRemoteControllerRouter;
@protocol SPTVolumeRemoteBuffer, SPTVolumeRemoteCoordinatorDelegate, SPTVolumeSynchronizationManager, SPTVolumeSystemAPI;
...
@interface SPTVolumeRemoteCoordinatorImplementation : NSObject <SPTRemoteVolumeMasterDelegate, SPTVolumeSynchronizationManagerObserver, SPTVolumeRemoteCoordinator>
{
    ...
    id <SPTVolumeRemoteBuffer> _remoteBuffer;
...
@property(readonly, nonatomic) id <SPTVolumeRemoteBuffer> remoteBuffer; // @synthesize remoteBuffer=_remoteBuffer;
