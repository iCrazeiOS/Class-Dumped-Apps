...
@interface SPTVolumeSynchronizationManagerImplementation : NSObject <SPTVolumeEventReceiver, SPTVolumeSynchronizationManager>
{
    ...
    _Bool _mobileToMobileEnabled;
    NSArray *_volumeEventEmmiters;
    SPTObserverManager *_observers;
}

@property(nonatomic) _Bool mobileToMobileEnabled; // @synthesize mobileToMobileEnabled=_mobileToMobileEnabled;
...
@property(readonly, nonatomic) NSArray *volumeEventEmmiters; // @synthesize volumeEventEmmiters=_volumeEventEmmiters;
...
- (void)setupEmmitersDelegate;
- (id)initWithEventEmmiters:(id)arg1;
