...
@class NSString, SPTEncoreTrackRow, SPTPSXLogger;
@protocol GLUETheme, SPTContextMenuOptionsFactory, SPTContextMenuPresenterFactory, SPTEncoreComponentFactory, SPTEncoreTrackRowModelHelper, SPTExplicitContentAccessManager, SPTFormatListItemModel, SPTFormatListPlatformManager, SPTPSXTestManager, SPTPSXTrackRowDelegate, SPTPSXViewModel, SPTShelves;
...
@interface SPTPSXEncoreTrackRowAdapter : SPTTableRowAdapter <SPTPlayerObserver, SPTEncoreTrackRowDelegate>
{
    ...
    SPTEncoreTrackRow *_trackRowComponent;
    id <GLUETheme> _theme;
}

@property(retain, nonatomic) id <GLUETheme> theme; // @synthesize theme=_theme;
@property(retain, nonatomic) SPTEncoreTrackRow *trackRowComponent; // @synthesize trackRowComponent=_trackRowComponent;
