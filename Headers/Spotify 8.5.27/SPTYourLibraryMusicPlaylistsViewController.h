...
@class NSString, NSURL, SPTProgressView, SPTTableView, SPTYourLibraryMusicEmptyView, SPTYourLibraryMusicFilterBarViewController, SPTYourLibraryMusicGLUETheme, SPTYourLibraryMusicPlaylistsCellConfigurator;
@protocol GLUEImageLoader, SPTPageContainer, SPTShareDragDelegateFactory, SPTSortingFilteringUIFactory, SPTViewLogger, SPTYourLibraryMusicPlaylistsViewModel, SPTYourLibraryPageDelegate, UITableViewDragDelegate;

@interface SPTYourLibraryMusicPlaylistsViewController : UIViewController <SPTYourLibraryMusicFilterBarViewControllerDelegate, SPTScrollToTopViewController, SPContentInsetViewController, UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, SPTPageController, SPTYourLibraryPage, SPTYourLibraryMusicPlaylistsViewModelDelegate, SPViewController>
{
