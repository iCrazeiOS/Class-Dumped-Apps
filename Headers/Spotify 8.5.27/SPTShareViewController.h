...
@class GLUELabel, NSArray, NSLayoutConstraint, NSString, SPTShareDataProvider, SPTShareDestinationUtility, SPTShareFeatureProperties, SPTShareItemView, SPTShareLogger, SPTShareScreenshotObserverManager, UIButton, UITableView, UIView;
...
- (void)viewDidLoad;
- (id)initWithShareLogger:(id)arg1 shareDataProvider:(id)arg2 shareDestinationUtility:(id)arg3 contextMenuPresenterFactory:(id)arg4 screenshotObserverManager:(id)arg5 imageLoader:(id)arg6 featureProperties:(id)arg7;
