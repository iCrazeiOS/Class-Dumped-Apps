...
@protocol SPTContainerService, SPTExternalIntegrationContentService, SPTExternalIntegrationDriverDistractionService, SPTExternalIntegrationPlaybackService, SPTFeatureFlaggingService, SPTGLUEService, SPTNetworkService, SPTNowPlayingPlatformService, SPTNowPlayingService, SPTOnDemandService, SPTPlayer, SPTPlayerFeature, SPTPlaylistPlatformService, SPTRemoteConfigurationResolver, SPTService, SPTSessionService, SPTSettingsFeature, SPTUIPresentationService;
...
- (id)createNowPlayingModesWithConfigurationManager:(id)arg1 remoteConfiguration:(id)arg2 optOutHandler:(id)arg3;
- (id)createSessionWithConfigurationManager:(id)arg1 remoteConfiguration:(id)arg2 optOutHandler:(id)arg3;
- (id)createDrivingModeControllerWithConfigurationManager:(id)arg1 remoteConfiguration:(id)arg2;
