...
@class NSDictionary, NSError, NSString, UIViewController, YTIForceAdParameters, YTPlaybackData, YTPlaybackTimeline, YTPlayerResponse;
...
- (void)setContentPlaybackData:(YTPlaybackData *)arg1 contentSingleVideo:(id <YTSingleVideoObservable>)arg2 playbackTimeline:(YTPlaybackTimeline *)arg3;
