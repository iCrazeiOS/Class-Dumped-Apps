...
#import "OGLGM2AccountSelectorMyAccountItem-Protocol.h"

@class NSString;

@interface OGLGM2AccountSelectorMyAccountChipItem : NSObject <OGLGM2AccountSelectorMyAccountItem, OGLGM2AccountSelectorItem>
{
