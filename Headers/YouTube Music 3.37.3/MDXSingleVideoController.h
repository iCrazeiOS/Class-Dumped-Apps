...
@class MDXSession, MDXVideoProgressController, MLFormat, MLNerdStatsPlaybackData, NSArray, NSData, NSDictionary, NSError, NSString, YTAdInterrupt, YTCPN, YTCaptionViewController, YTPlaybackData, YTPlayerResponse, YTSingleVideoEventCenter;
...
- (void)MDXSession:(id)arg1 audioTrackDidChange:(id)arg2;
