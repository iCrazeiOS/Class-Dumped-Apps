...
@interface YTAutonavEndscreenController : NSObject <YTAutonavPauseControllerDelegate, YTAutonavCountdownObserver, YTAutonavEndscreenViewDelegate, YTResponder>
{
    ...
    _Bool _autonavExperimentEnabled;
...
- (id)initWithParentResponder:(id)arg1 config:(id)arg2 imageService:(id)arg3 lastActionController:(id)arg4 reachabilityController:(id)arg5 autonavExperimentEnabled:(_Bool)arg6 autonavOffByDefault:(_Bool)arg7;
