...
+ (id)registeredSchemesForMapping:(struct NSDictionary *)arg1;
+ (id)grw_tagForIntentType:(int)arg1;
+ (_Bool)grw_isSafeLinkValid:(id)arg1 date:(id)arg2;
