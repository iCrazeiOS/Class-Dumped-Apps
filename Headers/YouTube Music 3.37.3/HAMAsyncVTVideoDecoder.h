...
- (void)dealloc;
- (id)initWithDelegate:(id)arg1 delegateQueue:(id)arg2 decodeQueue:(id)arg3 formatDescription:(id)arg4 pixelBufferAttributes:(id)arg5 supportedPixelFormats:(id)arg6 config:(CDStruct_63bc33bd)arg7;
