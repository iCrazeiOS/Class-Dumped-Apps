...
@interface ASLayoutElementStyle : NSObject <ASStackLayoutElement, ASAbsoluteLayoutElement, ASLayoutElementExtensibility, ASLocking>
{
    ...
    // Error parsing type: {atomic<ASStackLayoutAlignSelf>="__a_"AC}, name: _alignSelf
    ...
    // Error parsing type: {atomic<ASStackLayoutDirection>="__a_"AC}, name: _flexDirection
    // Error parsing type: {atomic<YGDirection>="__a_"AI}, name: _direction
    // Error parsing type: {atomic<ASStackLayoutJustifyContent>="__a_"AC}, name: _justifyContent
    // Error parsing type: {atomic<ASStackLayoutAlignItems>="__a_"AC}, name: _alignItems
    ...
    // Error parsing type: {atomic<YGOverflow>="__a_"AI}, name: _overflow
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) unsigned int overflow;
