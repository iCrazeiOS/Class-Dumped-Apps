...
- (void)dequeueEventsWithSize:(unsigned long long)arg1 eventType:(int)arg2 maxRetries:(unsigned long long)arg3 tier:(int)arg4 sortDescriptors:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;
