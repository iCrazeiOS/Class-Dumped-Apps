...
@class GWAComponentGroup, GWAMegalogsContext, NSArray, NSNumber, NSString, UIColor, UIFont, UIImage;
@protocol GWACardComponentDelegate, GWAFlowSectionDelegate;

@interface GWAInfoMessageSection : NSObject <GWADependencyGraphComponent, GWAFlowSection, GWAMegalogsSupporting>
{
