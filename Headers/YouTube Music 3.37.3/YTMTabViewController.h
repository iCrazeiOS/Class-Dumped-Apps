...
@class GIMMe, NSError, NSMutableArray, NSString, UIScrollView, YTISingleColumnBrowseResultsRenderer, YTMBaseInnerTubeViewController, YTMContentViewInsetDispatcher, YTMInnerTubeControllerFactory, YTMTabHeaderViewController, YTMTabView;
