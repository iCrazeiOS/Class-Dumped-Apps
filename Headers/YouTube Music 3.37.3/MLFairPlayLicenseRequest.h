...
- (id)initWithRequest:(id)arg1 requestIdentificationURI:(id)arg2 fairPlayConfig:(id)arg3 forOffline:(_Bool)arg4 videoID:(id)arg5 DRMParams:(id)arg6 DRMSessionID:(id)arg7 CPN:(id)arg8;
