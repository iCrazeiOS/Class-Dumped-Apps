...
@class GWAMegalogsContext, GWAUiFieldsSection, NSArray, NSNumber, NSString, OrchChallengeDepositForm;

@interface GWAChallengeDepositForm : NSObject <GWAForm, GWAMegalogsSupporting>
{
