...
@class GIMMe, MDXNotificationsService, MLPlayerPool, NSData, NSString, YTActiveVideoNotifier, YTCommandRouter, YTMonotonicDate, YTPlayerRequestFactory, YTPlayerService, YTPromosheetController;
@protocol MDXColdConfig, MDXConfig, MDXEventLogger, MDXHotConfig, MDXLocalStorage, MDXUserDefaults, MLCaptionConfig, MLCaptionControllerFactory, MLCaptionDisplaySettingsProvider, SSOAuthorization, YTAudioSession, YTInnerTubeUIServiceWithTimeoutInterval, YTResponder;
...
- (id)deviceApp;
- (id)initWithConfig:(id)arg1 coldConfig:(id)arg2 hotConfig:(id)arg3 commandRouter:(id)arg4 eventLogger:(id)arg5 localStorage:(id)arg6;
