...
@class GIMMe, NSMapTable, NSMutableDictionary, NSRecursiveLock, NSString, YTEntityStoreObservers;
@protocol YTIdentityProvider;

@interface YTInMemoryEntityStore : NSObject <YTUserChangedObserver, YTSystemNotificationsObserver, YTEntityStore, YTEntityStore_Private>
{
