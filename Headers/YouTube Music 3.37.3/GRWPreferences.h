...
+ (id)sharedInstance;
+ (id)valueForBundleIDKey:(id)arg1 dictionary:(id)arg2;
+ (id)schemesFromInfoDictionary:(id)arg1;
+ (id)schemes;
...
- (_Bool)isCountryCodeValid:(id)arg1;
@property(copy, nonatomic) NSString *lastAppsListFetchCountryCode;
@property(retain, nonatomic) NSDate *lastAppsListFetchDate;
- (id)schemesForBundleIDs;
- (id)appVersionsForBundleIDs;
- (id)growthKitVersionsForBundleIDs;
- (id)valueForBundleIDKey:(id)arg1;
- (id)lastRunDatesForBundleIDs;
- (id)appSchemesForBundleID:(id)arg1;
- (id)appLastRunDateForBundleID:(id)arg1;
- (long long)growthKitVersionForBundleID:(id)arg1;
- (id)appVersionForBundleID:(id)arg1;
