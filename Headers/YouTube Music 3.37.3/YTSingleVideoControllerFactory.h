...
- (id)singleVideoControllerWithPrebufferedVideoController:(id)arg1 initialTime:(CDStruct_d60ef703)arg2;
- (id)singleVideoControllerWithPlaybackData:(id)arg1 initialTime:(CDStruct_d60ef703)arg2;
