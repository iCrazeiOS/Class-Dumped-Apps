...
@interface ASDisplayNode : NSObject <MDCInkTouchControllerDelegate, MDCRippleTouchControllerDelegate, YTELMRippleTouchControllerDelegate, YTActiveStateSettingsObserver, YTScrollFocusContextListener, IGListDiffable, ASDebugNameProvider, ASLayoutElementStyleDelegate, ASLayoutElement, ASLayoutElementStylability, ASAsyncTransactionContainer, UIGestureRecognizerDelegate, _ASDisplayLayerDelegate, ASCATransactionQueueObserving, _ASTransitionContextCompletionDelegate, CALayerDelegate, ASLayoutElementTransition, ASDescriptionProvider, ASDebugDescriptionProvider, ASLocking>
{
    ...
    CDStruct_42a63532 _yogaCalculatedLayoutSizeRange;
...
- (void)calculateLayoutFromYogaRoot:(CDStruct_42a63532)arg1 willApply:(_Bool)arg2;
- (id)calculateLayoutYoga:(CDStruct_42a63532)arg1;
- (void)invalidateCalculatedYogaLayout;
- (void)updateYogaMeasureFuncIfNeeded;
- (_Bool)_locked_shouldHaveYogaMeasureFunc;
- (void)setupYogaCalculatedLayoutAndSetNeedsLayoutForChangedNodes:(_Bool)arg1;
- (id)layoutForYogaNode;
@property _Bool yogaLayoutInProgress;
@property(nonatomic) _Bool willApplyNextYogaCalculatedLayout;
