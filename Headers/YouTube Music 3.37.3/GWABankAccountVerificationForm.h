...
@class GWAChallengeDepositForm, GWAMegalogsContext, GWAVerificationOptionForm, GWAYodleeForm, NSArray, NSNumber, NSString;

@interface GWABankAccountVerificationForm : NSObject <GWAForm, GWAMegalogsSupporting>
{
