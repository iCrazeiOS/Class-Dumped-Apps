...
#import "HAMIOSurfacePixelBufferRenderingView.h"
...
@interface MLHAMIOSurfacePixelBufferRenderingView : HAMIOSurfacePixelBufferRenderingView <MLHAMPlayerViewProtocol>
{
}
