...
@interface YTPlayerLatencyLoggerWrapper : NSObject <YTSingleVideoMediaStateObserver, YTSingleVideoFormatSelectionObserver, YTSingleVideoLifecycleStateObserver>
{
...
- (void)handleFormatChangeWithVideoFormat:(id)arg1 audioFormat:(id)arg2;
