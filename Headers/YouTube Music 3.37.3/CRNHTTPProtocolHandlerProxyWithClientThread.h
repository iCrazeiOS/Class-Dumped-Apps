...
- (void)didRecieveAuthChallenge:(const struct AuthChallengeInfo *)arg1 nativeRequest:(const struct URLRequest *)arg2 callback:(const RepeatingCallback_f9343488 *)arg3;
