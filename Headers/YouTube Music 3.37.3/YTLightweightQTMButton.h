...
@class MDCInkTouchController, MDCInkView, NSMutableDictionary, NSString, QTMColorGroup, UIColor;
...
+ (_Bool)useInkTouchController;
+ (void)setUseInkTouchController:(_Bool)arg1;
