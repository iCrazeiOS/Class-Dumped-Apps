...
@interface ASLayoutElementStyleYoga : NSObject <ASStackLayoutElement, ASAbsoluteLayoutElement, ASLayoutElementExtensibility, ASLocking>
{
    ...
    // Error parsing type: {atomic<YGValue>="__a_"A{YGValue}}, name: _minWidth
    // Error parsing type: {atomic<YGValue>="__a_"A{YGValue}}, name: _minHeight
    ...
    // Error parsing type: {atomic<ASStackLayoutAlignItems>="__a_"AC}, name: _parentAlignStyle
...
- (void)setParentAlignStyle:(unsigned char)arg1;
...
- (unsigned char)parentAlignStyle;
- (double)aspectRatio;
