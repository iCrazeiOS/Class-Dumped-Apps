...
struct ASDisplayNodeFlags {
    ...
    unsigned int willApplyNextYogaCalculatedLayout:1;
...
struct CompressedTuple<unsigned long, absl::container_internal::StringHash, absl::container_internal::StringHashEq::Eq, std::__1::allocator<std::__1::basic_string<char>>> {
...
struct CompressedTuple<unsigned long, absl::hash_internal::Hash<int>, std::__1::equal_to<int>, std::__1::allocator<std::__1::pair<const int, ASDisplayNode *(^)(ELMElement *, id<ELMContext>)>>> {
    unsigned long long value;
};
...
struct ELMPerformanceEvent {
    ...
    struct ELMPerformanceEventInfo info;
    struct _opaque_pthread_t *threadIdentifier;
    _Bool isMainThread;
};

struct ELMPerformanceEventInfo {
    struct optional<std::__1::basic_string<char>> templateURI;
    struct optional<std::__1::basic_string<char>> nodeIdentifier;
...
struct HLSPlaylist {
    struct Duration target_duration_;
    ...
    struct Duration start_offset_;
    _Bool start_offset_is_precise_;
...
struct HttpResponseInfo {
    ...
    struct Optional<net::AuthChallengeInfo> _field19;
    struct scoped_refptr<net::SSLCertRequestInfo> _field20;
    struct SSLInfo _field21;
    struct scoped_refptr<net::HttpResponseHeaders> _field22;
    struct HttpVaryData _field23;
    struct scoped_refptr<net::IOBufferWithSize> _field24;
};
...
struct JsController {
    struct JscIsolateFactory _field1;
    struct flat_hash_set<std::__1::basic_string<char>, absl::container_internal::StringHash, absl::container_internal::StringHashEq::Eq, std::__1::allocator<std::__1::basic_string<char>>> _field2;
    struct unique_ptr<youtube::javascript::Isolate, std::__1::default_delete<youtube::javascript::Isolate>> _field3;
    struct unique_ptr<youtube::javascript::Context, std::__1::default_delete<youtube::javascript::Context>> _field4;
    struct unique_ptr<youtube::javascript::client::JsModuleLoader, std::__1::default_delete<youtube::javascript::client::JsModuleLoader>> _field5;
    struct unique_ptr<youtube::javascript::client::JsEventLogger, std::__1::default_delete<youtube::javascript::client::JsEventLogger>> _field6;
};

struct JsEventLogger;

struct JsModuleLoader;

struct JscIsolateFactory;
...
struct RepeatedPtrField<youtube::elements::extensions::MentionRun> {
...
struct TemplateResolver {
    ...
    struct vector<std::__1::pair<std::__1::function<bool (const youtube::elements::TemplateConfig &)>, std::__1::function<youtube::eko::Status (const youtube::elements::templates::TemplateResolver &, const youtube::elements::templates::TemplateResolutionRequest &)>>, std::__1::allocator<std::__1::pair<std::__1::function<bool (const youtube::elements::TemplateConfig &)>, std::__1::function<youtube::eko::Status (const youtube::elements::templates::TemplateResolver &, const youtube::elements::templates::TemplateResolutionRequest &)>>>> handlers_;
};
...
struct URLRequest {
    ...
    int _field20;
    int _field21;
    struct vector<net::CookieWithStatus, std::__1::allocator<net::CookieWithStatus>> _field22;
    struct vector<net::CookieAndLineWithStatus, std::__1::allocator<net::CookieAndLineWithStatus>> _field23;
    struct Delegate *_field24;
    struct URLRequestStatus _field25;
    struct HttpResponseInfo _field26;
    _Bool _field27;
    _Bool _field28;
    int _field29;
    struct UploadProgress _field30;
    int _field31;
    int _field32;
    _Bool _field33;
    basic_string_90719d97 _field34;
    _Bool _field35;
    struct LeakTracker<net::URLRequest> _field36;
    _Bool _field37;
    long long _field38;
    struct TimeTicks _field39;
    struct LoadTimingInfo _field40;
    struct ProxyServer _field41;
    int _field42;
...
struct flat_hash_map<int, ASDisplayNode *(^)(ELMElement *, id<ELMContext>), absl::hash_internal::Hash<int>, std::__1::equal_to<int>, std::__1::allocator<std::__1::pair<const int, ASDisplayNode *(^)(ELMElement *, id<ELMContext>)>>> {
    char *ctrl_;
    union map_slot_type<int, ASDisplayNode *(^)(ELMElement *, id<ELMContext>)> *slots_;
    unsigned long long size_;
    unsigned long long capacity_;
    struct HashtablezInfoHandle infoz_;
    struct CompressedTuple<unsigned long, absl::hash_internal::Hash<int>, std::__1::equal_to<int>, std::__1::allocator<std::__1::pair<const int, ASDisplayNode *(^)(ELMElement *, id<ELMContext>)>>> settings_;
};
...
struct flat_hash_set<std::__1::basic_string<char>, absl::container_internal::StringHash, absl::container_internal::StringHashEq::Eq, std::__1::allocator<std::__1::basic_string<char>>> {
    char *_field1;
    basic_string_90719d97 *_field2;
    unsigned long long _field3;
    unsigned long long _field4;
    struct HashtablezInfoHandle _field5;
    struct CompressedTuple<unsigned long, absl::container_internal::StringHash, absl::container_internal::StringHashEq::Eq, std::__1::allocator<std::__1::basic_string<char>>> _field6;
};
...
struct optional<youtube::elements::util::DispatchFuture<LayoutFutureInput, ELMCellNode *>> {
    _Bool _field1;
    union {
        struct DispatchFuture<LayoutFutureInput, ELMCellNode *> _field1;
        struct dummy_type _field2;
    } _field2;
};
...
struct pair<std::__1::function<bool (const youtube::elements::TemplateConfig &)>, std::__1::function<youtube::eko::Status (const youtube::elements::templates::TemplateResolver &, const youtube::elements::templates::TemplateResolutionRequest &)>>;
...
struct unique_ptr<youtube::javascript::Isolate, std::__1::default_delete<youtube::javascript::Isolate>> {
    struct __compressed_pair<youtube::javascript::Isolate *, std::__1::default_delete<youtube::javascript::Isolate>> {
        struct Isolate *_field1;
    } _field1;
};
...
struct unique_ptr<youtube::javascript::client::JsController, std::__1::default_delete<youtube::javascript::client::JsController>> {
    struct __compressed_pair<youtube::javascript::client::JsController *, std::__1::default_delete<youtube::javascript::client::JsController>> {
        struct JsController *__value_;
    } __ptr_;
};

struct unique_ptr<youtube::javascript::client::JsEventLogger, std::__1::default_delete<youtube::javascript::client::JsEventLogger>> {
    struct __compressed_pair<youtube::javascript::client::JsEventLogger *, std::__1::default_delete<youtube::javascript::client::JsEventLogger>> {
        struct JsEventLogger *_field1;
    } _field1;
};

struct unique_ptr<youtube::javascript::client::JsModuleLoader, std::__1::default_delete<youtube::javascript::client::JsModuleLoader>> {
    struct __compressed_pair<youtube::javascript::client::JsModuleLoader *, std::__1::default_delete<youtube::javascript::client::JsModuleLoader>> {
        struct JsModuleLoader *_field1;
    } _field1;
};
...
struct vector<std::__1::pair<std::__1::function<bool (const youtube::elements::TemplateConfig &)>, std::__1::function<youtube::eko::Status (const youtube::elements::templates::TemplateResolver &, const youtube::elements::templates::TemplateResolutionRequest &)>>, std::__1::allocator<std::__1::pair<std::__1::function<bool (const youtube::elements::TemplateConfig &)>, std::__1::function<youtube::eko::Status (const youtube::elements::templates::TemplateResolver &, const youtube::elements::templates::TemplateResolutionRequest &)>>>> {
    struct pair<std::__1::function<bool (const youtube::elements::TemplateConfig &)>, std::__1::function<youtube::eko::Status (const youtube::elements::templates::TemplateResolver &, const youtube::elements::templates::TemplateResolutionRequest &)>> *__begin_;
    struct pair<std::__1::function<bool (const youtube::elements::TemplateConfig &)>, std::__1::function<youtube::eko::Status (const youtube::elements::templates::TemplateResolver &, const youtube::elements::templates::TemplateResolutionRequest &)>> *__end_;
    struct __compressed_pair<std::__1::pair<std::__1::function<bool (const youtube::elements::TemplateConfig &)>, std::__1::function<youtube::eko::Status (const youtube::elements::templates::TemplateResolver &, const youtube::elements::templates::TemplateResolutionRequest &)>>*, std::__1::allocator<std::__1::pair<std::__1::function<bool (const youtube::elements::TemplateConfig &)>, std::__1::function<youtube::eko::Status (const youtube::elements::templates::TemplateResolver &, const youtube::elements::templates::TemplateResolutionRequest &)>>>> {
        struct pair<std::__1::function<bool (const youtube::elements::TemplateConfig &)>, std::__1::function<youtube::eko::Status (const youtube::elements::templates::TemplateResolver &, const youtube::elements::templates::TemplateResolutionRequest &)>> *__value_;
    } __end_cap_;
};
...
typedef struct RepeatedPtrField<youtube::elements::extensions::MentionRun> {
    struct Arena *_field1;
    int _field2;
    int _field3;
    struct Rep *_field4;
} RepeatedPtrField_73f6bbf5;
...
union map_slot_type<int, ASDisplayNode *(^)(ELMElement *, id<ELMContext>)>;
