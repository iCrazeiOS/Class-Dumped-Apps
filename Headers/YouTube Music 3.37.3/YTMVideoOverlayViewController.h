...
@class GIMMe, MLNerdStatsOverlayViewController, MLNerdStatsPlaybackData, MPVolumeView, NSString, QTMButton, YTAnnotationsViewController, YTCaptionTrackSwitchController, YTCaptionViewController, YTDoubleTapToSeekController, YTHintController, YTIMenuRenderer, YTIPlayerOverlayRenderer, YTISkippableSegmentsConfig, YTLiveOfflineSlateViewController, YTMAutoOfflineController, YTMButtonVisibilityLogger, YTMLightsourceColorSampler, YTMMusicAppMetadata, YTMNowPlayingViewController, YTMSettings, YTMThemeController, YTMVideoOverlayView, YTOfflineCoordinator, YTPlayerResponse, YTThumbnailController, YTVideoZoomOverlayController, YTVolumeBarView;
