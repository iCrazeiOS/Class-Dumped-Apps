...
-     // Error parsing type: v24@0:8r^{MentionsEditableTextType=^^?{InternalMetadataWithArenaLite=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<youtube::elements::extensions::MentionRun>=^{Arena}ii^{Rep}}^{AttributedString}^{AttributedString}^{Command}^{Command}^{Command}BBBB}16, name: setTextFontAndColor:
