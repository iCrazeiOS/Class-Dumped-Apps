...
#import "GFBAttachmentToggleButtonDelegate-Protocol.h"

@class GFBAttachmentToggleButton, MDCCard, MDCInkTouchController, NSLayoutConstraint, NSString, UIButton, UIImage, UIImageView, UILabel;
@protocol GFBAttachmentBoxDelegate;

@interface GFBAttachmentBox : UIView <GFBAttachmentToggleButtonDelegate>
{
    ...
    UIView *_labels;
    GFBAttachmentToggleButton *_toggleButton;
    UILabel *_titleLabel;
...
- (void)didTapAttachmentToggleButton:(id)arg1 checked:(_Bool)arg2;
