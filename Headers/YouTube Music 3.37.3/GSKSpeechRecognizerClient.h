...
@class GSKAudioSession, GSKEndpointer, GSKLanguage, GSKSpeechSessionConfig, GSKSpeexEncoder, NSDate, NSMutableArray, NSNumber, NSString, NSTimer;
...
- (void)dealloc;
- (id)init;
- (id)initWithAudioCapture:(id)arg1 endpointer:(id)arg2 encoder:(id)arg3 minimumCaptureDuration:(double)arg4 endpointingGracePeriod:(id)arg5 endpointerTimeout:(double)arg6;
