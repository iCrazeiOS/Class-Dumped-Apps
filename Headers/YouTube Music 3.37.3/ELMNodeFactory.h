...
@interface ELMNodeFactory : NSObject
{
    ...
    struct flat_hash_map<int, ASDisplayNode *(^)(ELMElement *, id<ELMContext>), absl::hash_internal::Hash<int>, std::__1::equal_to<int>, std::__1::allocator<std::__1::pair<const int, ASDisplayNode *(^)(ELMElement *, id<ELMContext>)>>> _nodeTypeToCreationBlock;
}
