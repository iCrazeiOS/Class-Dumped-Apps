...
- (_Bool)updateWithOfflineVideo:(id)arg1 downloadProgress:(double)arg2 estimatedTotalSizeInBytes:(long long)arg3 pendingDownloadReasons:(unsigned long long)arg4 isUndergoingOfflineRefresh:(_Bool)arg5 replaceThumbnailsIfPresent:(_Bool)arg6 shouldBadgeWatchPercent:(_Bool)arg7;
