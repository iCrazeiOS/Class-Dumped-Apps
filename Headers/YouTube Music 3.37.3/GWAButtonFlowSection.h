...
@class GWAButtonView, GWAComponentGroup, GWAMegalogsContext, NSArray, NSNumber, NSString, OAStackView, UIColor, UIImage;
@protocol GWAButtonViewDelegate, GWACardComponentDelegate, GWAFlowSectionDelegate;

@interface GWAButtonFlowSection : NSObject <GWAButtonViewDelegate, GWADependencyGraphComponent, GWAFormComponentDelegate, GWAFlowSection, GWAMegalogsSupporting>
{
    ...
    id <GWAButtonViewDelegate> _customButtonViewDelegate;
}

@property(retain, nonatomic) id <GWAButtonViewDelegate> customButtonViewDelegate; // @synthesize customButtonViewDelegate=_customButtonViewDelegate;
