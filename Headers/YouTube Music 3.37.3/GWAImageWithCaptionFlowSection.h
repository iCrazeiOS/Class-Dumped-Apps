...
@class GWAComponentGroup, GWAImageWithCaptionView, GWAMegalogsContext, NSArray, NSNumber, NSString, UIColor, UIImage;
@protocol GWACardComponentDelegate, GWAFlowSectionDelegate;

@interface GWAImageWithCaptionFlowSection : NSObject <GWAFlowSection, GWADependencyGraphComponent, GWAMegalogsSupporting>
{
...
- (void)setSectionImageViewMargins:(long long)arg1;
