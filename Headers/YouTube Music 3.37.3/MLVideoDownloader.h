...
- (_Bool)startTask:(id)arg1 formatStreams:(id)arg2 resumeData:(id)arg3 expirationDate:(id)arg4 allowCellularAccess:(_Bool)arg5 additionalURLParameters:(id)arg6 error:(id *)arg7;
