...
@class NSString, PRMApplicationInfo, PRMBatteryUsageMetric, PRMCPUTimeMetric, PRMCPUUsageMetric, PRMClientErrorLoggingMetric, PRMCrashMetric, PRMDroppedFramesEvent, PRMFrameRateMetric, PRMLaunchTimeMetric, PRMMemoryUsageMetric, PRMMetricExtension, PRMNetworkUsageMetric, PRMTimerMetric, PRMTraceMetric, PRMUuidProto;
