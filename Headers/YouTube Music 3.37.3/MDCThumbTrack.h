...
@class CALayer, CAShapeLayer, MDCDiscreteDotView, MDCInkTouchController, MDCNumericValueLabel, MDCRippleView, MDCThumbView, NSString, UIColor, UIPanGestureRecognizer, UITouch, UIView;
