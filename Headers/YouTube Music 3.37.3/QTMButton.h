...
@class GWAMegalogsContext, MDCInkView, MDCPalette, NSArray, NSMutableDictionary, NSNumber, NSString, QTMColorGroup, UIColor;

@interface QTMButton : UIButton <GWAMegalogsSupporting>
{
    long long _shape;
...
+ (id)buttonWithPalette:(id)arg1 shape:(long long)arg2;
+ (id)buttonWithColorGroup:(id)arg1;
+ (id)buttonWithPalette:(id)arg1;
...
+ (id)ytm_flatRoundButtonFromButtonRenderer:(id)arg1;
+ (id)ytm_flatRoundButtonFromToggleButtonRenderer:(id)arg1;
...
+ (id)ytm_actionButtonWithColor:(id)arg1;
+ (id)ytm_actionButton;
