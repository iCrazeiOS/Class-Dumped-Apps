...
@class GMDCColorScheme, GSCAccount, MDCAppBarViewController, NSString, SKTAccessoryWrapperView, UIButton, UIView, UIViewController;
@protocol SKTAdvancedTransitionsService, SKTFullScreenViewControllerOptions, SKTMaximizeTransitionOrigin;

@interface SKTFullScreenViewController : SKTMaximizedViewController <SKTAccessoryWrapperViewDelegate, SKTMaximizeTransitionDestination, UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning>
{
