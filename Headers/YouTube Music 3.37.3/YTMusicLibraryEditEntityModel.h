...
@class NSData, NSDictionary, NSString, YTIMusicLibraryEditEntity;
...
@interface YTMusicLibraryEditEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicLibraryEditEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicLibraryEditEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
