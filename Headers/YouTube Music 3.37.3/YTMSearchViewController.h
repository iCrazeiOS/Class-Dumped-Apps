...
@class NSString, UIButton, UIViewController, YTICommand, YTInteractionLoggingProxyButton, YTMAlertView, YTMAssistantController, YTMChipCloudView, YTMPlaybackPublishController, YTMSearchQueryView, YTMSettings, YTMSuggestService, YTMVoiceSearchPlateView, YTMVoiceSearchViewController;
