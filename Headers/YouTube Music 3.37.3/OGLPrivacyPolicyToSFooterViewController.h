...
@class NSString, OGLAnalyticsComponentContext, OGLPrivacyPolicyToSFooterView, UIColor;
@protocol OGLAccount, OGLDrawerChildViewControllerDelegate, OGLPrivacyPolicyToSController, OGLPrivacyPolicyToSFooterViewControllerDelegate;
...
@interface OGLPrivacyPolicyToSFooterViewController : UIViewController <OGLAnalyticsPrivacyPolicyToSDelegate, OGLPrivacyPolicyToSFooterViewDelegate, OGLDrawerFooter>
{
    ...
    UIColor *_titleColor;
    OGLPrivacyPolicyToSFooterView *_contentView;
    struct UIEdgeInsets _edgeInsets;
}

@property(retain, nonatomic) OGLPrivacyPolicyToSFooterView *contentView; // @synthesize contentView=_contentView;
