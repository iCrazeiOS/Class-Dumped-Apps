...
-     // Error parsing type: {optional<youtube::media::PersistedBandwidthSamples>=B(?={PersistedBandwidthSamples=^^?{InternalMetadataWithArenaLite=^v}{RepeatedField<float>=ii^v}{atomic<int>=Ai}{RepeatedField<float>=ii^v}{atomic<int>=Ai}{RepeatedField<float>=ii^v}{atomic<int>=Ai}{RepeatedField<float>=ii^v}{atomic<int>=Ai}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}i{CachedSize={atomic<int>=Ai}}}{dummy_type=[128{empty_struct=}]})}16@0:8, name: bandwidthSamplesForPersistence
-     // Error parsing type: v24@0:8r^{PersistedBandwidthSamples=^^?{InternalMetadataWithArenaLite=^v}{RepeatedField<float>=ii^v}{atomic<int>=Ai}{RepeatedField<float>=ii^v}{atomic<int>=Ai}{RepeatedField<float>=ii^v}{atomic<int>=Ai}{RepeatedField<float>=ii^v}{atomic<int>=Ai}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}i{CachedSize={atomic<int>=Ai}}}16, name: setPersistedSamples:
