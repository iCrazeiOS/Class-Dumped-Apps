...
@class GIMMe, NSString, YTIButtonRenderer, YTILikeButtonRenderer, YTMNowPlayingView, YTMQueueHeaderViewController, YTMSongInfoBrowseViewController, YTMSongInfoViewController;
@protocol YTMNowPlayingViewControllerDelegate, YTMNowPlayingViewControllerScrubberDelegate, YTResponder;

@interface YTMNowPlayingViewController : UIViewController <YTMNowPlayingViewDelegate, YTMSongInfoBrowseViewControllerDelegate, YTMSongInfoViewControllerDelegate, YTSystemNotificationsObserver, YTResponder, YTStoryboardControllerDelegate>
{
