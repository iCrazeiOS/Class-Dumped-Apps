...
@interface GWAFieldSelectorForm : NSObject <GWAFlowSection, GWASelectorOptionDelegate, GWAForm, GWAFormComponent, GWATriggerComponent, GWAResultingComponent, GWAMegalogsSupporting>
{
