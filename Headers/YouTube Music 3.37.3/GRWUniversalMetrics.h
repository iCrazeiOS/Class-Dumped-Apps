...
- (void)logAppSwitchEvent:(int)arg1 intentType:(int)arg2 linkType:(int)arg3 presentedApps:(id)arg4 bundleIdentifier:(id)arg5 iTunesCampaignCode:(id)arg6 isFirstPrompt:(_Bool)arg7 isCounterfactual:(_Bool)arg8;
