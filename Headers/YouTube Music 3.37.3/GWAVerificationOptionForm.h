...
@class GWAMegalogsContext, GWAVerificationOptionFlowSection, NSArray, NSNumber, NSString, OrchVerificationOptionForm;

@interface GWAVerificationOptionForm : NSObject <GWAForm, GWAMegalogsSupporting>
{
