...
@class MLNerdStatsPlaybackData, NSArray, NSError, NSString, UIView, YTCPN, YTCaptionViewController, YTIAudioTrack, YTIInfoCardRenderer, YTIWatchNextResponse, YTPlayerHeartbeatController, YTPlayerResponse;
@protocol MLCaptionTrack, YTSingleVideoObservable, YTVideoPlayerOverlayDelegate;
