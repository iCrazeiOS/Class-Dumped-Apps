...
@class AVAudioPlayer, GIMMe, MDXSession, MDXSingleVideoController, NSError, NSString, YTCPN, YTPlaybackConfig, YTPlaybackData, YTPlaybackLockScreenController, YTPlayerHeartbeatController, YTPlayerResponse, YTPlayerTransition, YTPlayerView;
...
@interface MDXPlaybackController : NSObject <MDXSessionObserver, MDXSessionManagerObserver, YTAdVideoPlayerOverlayDelegate, YTSingleVideoCurrentTimeObserver, YTSingleVideoErrorObserver, YTSingleVideoMediaStateObserver, YTCorePlaybackController>
{
    ...
    CDStruct_d60ef703 _timeBeforeDisconnect;
