...
+ (id)commaSeparatedDisplayNameFromGroup:(id)arg1;
...
- (id)initWithDisplayName:(id)arg1 primaryCollationName:(id)arg2 secondaryCollationName:(id)arg3 familyName:(id)arg4 givenName:(id)arg5 photoURLs:(id)arg6 primaryMethod:(id)arg7 allMethods:(id)arg8 displayNameType:(unsigned long long)arg9;
