...
@class NSData, NSDictionary, NSString, YTIMusicShareEntity;
...
@interface YTMusicShareEntityModel : NSObject <YTEntity, NSCopying, NSMutableCopying>
{
    ...
    YTIMusicShareEntity *_protoBuf;
}

@property(copy, nonatomic) YTIMusicShareEntity *protoBuf; // @synthesize protoBuf=_protoBuf;
