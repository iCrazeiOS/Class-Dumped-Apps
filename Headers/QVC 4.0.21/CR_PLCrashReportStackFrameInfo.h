...
@class CR_PLCrashReportSymbolInfo;

@interface CR_PLCrashReportStackFrameInfo : NSObject
{
    unsigned long long _instructionPointer;
    CR_PLCrashReportSymbolInfo *_symbolInfo;
}

@property(readonly, nonatomic) CR_PLCrashReportSymbolInfo *symbolInfo; // @synthesize symbolInfo=_symbolInfo;
