...
@class NSString, WSO_GPBEnumDescriptor, WSO_GPBOneofDescriptor;

@interface WSO_GPBFieldDescriptor : NSObject
{
    struct GPBMessageFieldDescription *description_;
    WSO_GPBOneofDescriptor *containingOneof_;
    SEL getSel_;
    SEL setSel_;
    SEL hasOrCountSel_;
    SEL setHasSel_;
    CDUnion_e7169284 defaultValue_;
    Class msgClass_;
    union {
        WSO_GPBEnumDescriptor *enumDescriptor_;
        CDUnknownFunctionPointerType enumVerifier_;
    } enumHandling_;
}

@property(readonly, nonatomic) WSO_GPBOneofDescriptor *containingOneof; // @synthesize containingOneof=containingOneof_;
...
@property(readonly, nonatomic) WSO_GPBEnumDescriptor *enumDescriptor;
