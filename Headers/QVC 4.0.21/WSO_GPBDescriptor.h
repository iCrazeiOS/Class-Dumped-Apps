...
@class NSArray, NSString, WSO_GPBFileDescriptor;

@interface WSO_GPBDescriptor : NSObject <NSCopying>
{
    NSArray *fields_;
    NSArray *oneofs_;
    unsigned int storageSize_;
    Class messageClass_;
    WSO_GPBFileDescriptor *file_;
    _Bool wireFormat_;
...
@property(readonly, nonatomic) WSO_GPBFileDescriptor *file; // @synthesize file=file_;
...
@property(readonly) WSO_GPBDescriptor *containingType;
