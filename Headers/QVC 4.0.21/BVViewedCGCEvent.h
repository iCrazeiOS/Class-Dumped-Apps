...
- (void).cxx_destruct;
- (id)toRaw;
- (id)initWithProductId:(id)arg1 withRootCategoryID:(id)arg2 withCategoryId:(id)arg3 withProductType:(long long)arg4 withBrand:(id)arg5 withAdditionalParams:(id)arg6;
