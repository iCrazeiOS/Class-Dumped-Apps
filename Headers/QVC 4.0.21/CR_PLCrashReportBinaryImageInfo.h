...
@interface CR_PLCrashReportBinaryImageInfo : NSObject
{
...
@property(readonly, nonatomic) CR_PLCrashReportProcessorInfo *codeType; // @synthesize codeType=_processorInfo;
- (void)dealloc;
