...
@class NSMutableArray, NSString, WSO_GPBSourceContext;

@interface WSO_GPBType : WSO_GPBMessage
{
}
...
@property(retain, nonatomic) WSO_GPBSourceContext *sourceContext; // @dynamic sourceContext;
