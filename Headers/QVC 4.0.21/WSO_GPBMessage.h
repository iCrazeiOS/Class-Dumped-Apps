...
@class NSMutableDictionary, WSO_GPBExtensionDescriptor, WSO_GPBFieldDescriptor, WSO_GPBUnknownFieldSet;

@interface WSO_GPBMessage : NSObject <NSSecureCoding, NSCopying>
{
    WSO_GPBUnknownFieldSet *unknownFields_;
    NSMutableDictionary *extensionMap_;
    NSMutableDictionary *autocreatedExtensionMap_;
    WSO_GPBMessage *autocreator_;
    WSO_GPBFieldDescriptor *autocreatorField_;
    WSO_GPBExtensionDescriptor *autocreatorExtension_;
...
@property(copy, nonatomic) WSO_GPBUnknownFieldSet *unknownFields;
