...
@interface _TtC3QVC17QVCEDDInputModule : UICollectionViewCell
{
    ...
    // Error parsing type: , name: allowEnterZipCode
    // Error parsing type: , name: isValidZipCode
}
...
- (void)submitButtonSelected:(id)arg1;
- (void)awakeFromNib;
@property(nonatomic) __weak UIButton *submitButton; // @synthesize submitButton;
@property(nonatomic) __weak UITextField *zipCodeField; // @synthesize zipCodeField;
