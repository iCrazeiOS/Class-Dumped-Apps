...
@class NSMutableDictionary, WSO_GPBMessage;

@interface WSO_GPBUInt32ObjectDictionary : NSObject <GPBDictionaryInternalsProtocol, NSCopying>
{
    WSO_GPBMessage *_autocreator;
