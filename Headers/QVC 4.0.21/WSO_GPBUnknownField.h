...
@class NSArray, NSMutableArray, WSO_GPBUInt32Array, WSO_GPBUInt64Array;

@interface WSO_GPBUnknownField : NSObject <NSCopying>
{
    int number_;
    WSO_GPBUInt64Array *mutableVarintList_;
    WSO_GPBUInt32Array *mutableFixed32List_;
    WSO_GPBUInt64Array *mutableFixed64List_;
...
@property(readonly, nonatomic) WSO_GPBUInt64Array *fixed64List; // @synthesize fixed64List=mutableFixed64List_;
@property(readonly, nonatomic) WSO_GPBUInt32Array *fixed32List; // @synthesize fixed32List=mutableFixed32List_;
@property(readonly, nonatomic) WSO_GPBUInt64Array *varintList; // @synthesize varintList=mutableVarintList_;
