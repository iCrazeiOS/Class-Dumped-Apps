...
@class CR_PLCrashMachExceptionPortSet, CR_PLCrashMachExceptionServer, CR_PLCrashReporterConfig, NSString;

@interface CR_PLCrashReporter : NSObject
{
    CR_PLCrashReporterConfig *_config;
    _Bool _enabled;
    CR_PLCrashMachExceptionServer *_machServer;
    CR_PLCrashMachExceptionPortSet *_previousMachPorts;
