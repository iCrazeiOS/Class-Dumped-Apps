...
@class NSArray, NSDictionary, NSString, OMIDAmazonPartner, WKWebView;
...
@property(readonly, nonatomic) OMIDAmazonPartner *partner; // @synthesize partner=_partner;
