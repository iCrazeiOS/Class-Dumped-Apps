...
@interface _TtC6Twitch18EmoteCardTitleView : TWThemeableView
{
    // Error parsing type: , name: $__lazy_storage_$_emoteImageView
    // Error parsing type: , name: $__lazy_storage_$_titleTextView
