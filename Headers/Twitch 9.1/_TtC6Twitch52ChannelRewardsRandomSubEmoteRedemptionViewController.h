...
@interface _TtC6Twitch52ChannelRewardsRandomSubEmoteRedemptionViewController : TWBaseViewController
{
    ...
    // Error parsing type: , name: unlockableEmoteVariants
    // Error parsing type: , name: descriptionLabel
    // Error parsing type: , name: imageView
    // Error parsing type: , name: $__lazy_storage_$_randomizeUnlockButton
}
