...
@protocol OMIDAmazonCommandPublisher;

@interface OMIDAmazonAdSessionStatePublisher : NSObject
{
    id <OMIDAmazonCommandPublisher> _commandPublisher;
...
@property(readonly, nonatomic) id <OMIDAmazonCommandPublisher> commandPublisher; // @synthesize commandPublisher=_commandPublisher;
- (void).cxx_destruct;
