...
@interface AWSPinpointTargetingSMSChannelResponse : AWSModel
{
    ...
    NSString *_platform;
    NSNumber *_promotionalMessagesPerSecond;
    NSString *_senderId;
    NSString *_shortCode;
    NSNumber *_transactionalMessagesPerSecond;
    NSNumber *_version;
}
...
@property(retain, nonatomic) NSNumber *transactionalMessagesPerSecond; // @synthesize transactionalMessagesPerSecond=_transactionalMessagesPerSecond;
...
@property(retain, nonatomic) NSNumber *promotionalMessagesPerSecond; // @synthesize promotionalMessagesPerSecond=_promotionalMessagesPerSecond;
