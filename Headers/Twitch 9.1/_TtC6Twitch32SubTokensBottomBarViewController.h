...
@interface _TtC6Twitch32SubTokensBottomBarViewController : TWBaseViewController
{
    // Error parsing type: , name: state
    // Error parsing type: , name: $__lazy_storage_$_contentView
    // Error parsing type: , name: $__lazy_storage_$_bottomBarView
    // Error parsing type: , name: accessoryViewProvider
    // Error parsing type: , name: subscriptionsViewController
}
