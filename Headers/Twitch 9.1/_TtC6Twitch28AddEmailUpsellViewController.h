...
@protocol _TtP6Twitch36AddEmailUpsellViewControllerDelegate_;

__attribute__((visibility("hidden")))
@interface _TtC6Twitch28AddEmailUpsellViewController : TWBaseViewController
{
    ...
    // Error parsing type: , name: errorToEmailFieldSpacer
    // Error parsing type: , name: emailFormField
    // Error parsing type: , name: $__lazy_storage_$_emailValidityView
    // Error parsing type: , name: emailFieldToButtonSpacer
...
@property(nonatomic) __weak id <_TtP6Twitch36AddEmailUpsellViewControllerDelegate_> delegate; // @synthesize delegate;
