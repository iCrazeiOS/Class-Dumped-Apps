...
@class NSDictionary, NSMutableDictionary, NSString, NlsLogger;
...
@property(retain, nonatomic) NSString *lastError; // @synthesize lastError=_lastError;
- (void).cxx_destruct;
- (id)resolveOR:(id)arg1;
- (id)evaluate:(id)arg1 strict:(_Bool)arg2 withSuccess:(_Bool *)arg3;
- (int)findEnd:(id)arg1 limiter:(BOOL)arg2 startIndex:(long long)arg3;
- (id)parse:(id)arg1 withResult:(_Bool *)arg2;
- (_Bool)calculateVariable:(long long)arg1 baseServerTime:(long long)arg2 baseDeviceTime:(long long)arg3 offsetName:(id)arg4;
