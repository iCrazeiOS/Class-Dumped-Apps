...
@class NlsErrorReporter, NlsLogger;
@protocol NlsWebViewHolder;

@interface NlsJSBridge : NSObject
{
    NlsLogger *_logger;
    NlsErrorReporter *_errorReporter;
    id <NlsWebViewHolder> _webViewHolder;
}

@property(retain, nonatomic) id <NlsWebViewHolder> webViewHolder; // @synthesize webViewHolder=_webViewHolder;
