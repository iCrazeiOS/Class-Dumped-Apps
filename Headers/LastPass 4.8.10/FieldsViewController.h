...
@class FieldsTableViewModel, LPAccount, NSMutableDictionary, NSString, PasswordReprompt, TableViewModelCell;

@interface FieldsViewController : LPViewViewController <LastPassModelObserver>
{
