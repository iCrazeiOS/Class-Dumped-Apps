...
@interface _TtC8LastPass17LogViewController : UIViewController
{
    // Error parsing type: , name: delegate
    // Error parsing type: , name: showNetworkLogOnly
...
- (void)shareButton_clicked:(id)arg1;
- (void)clearButton_clicked:(id)arg1;
