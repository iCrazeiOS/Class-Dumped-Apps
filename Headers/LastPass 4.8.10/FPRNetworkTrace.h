...
@class FPRTraceBackgroundActivityTracker, NSArray, NSDictionary, NSError, NSMutableArray, NSMutableDictionary, NSString, NSURLRequest, NSURLSessionTask;
...
@interface FPRNetworkTrace : NSObject <FPRNetworkResponseHandler, FIRPerformanceAttributable>
{
    ...
    NSURLSessionTask *_observedTask;
    NSString *_keyPathObserved;
...
@property(copy, nonatomic) NSString *keyPathObserved; // @synthesize keyPathObserved=_keyPathObserved;
@property(nonatomic) __weak NSURLSessionTask *observedTask; // @synthesize observedTask=_observedTask;
...
- (void)observeSessionTask:(id)arg1 forKeyPath:(id)arg2;
