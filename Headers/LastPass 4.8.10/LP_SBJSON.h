...
#import "LP_SBJsonParser-Protocol.h"
#import "LP_SBJsonWriter-Protocol.h"

@class LP_SBJsonParser, LP_SBJsonWriter;

@interface LP_SBJSON : LP_SBJsonBase <LP_SBJsonParser, LP_SBJsonWriter>
{
    LP_SBJsonParser *jsonParser;
    LP_SBJsonWriter *jsonWriter;
}
