...
@class AutomaticEvents, MPABTestDesignerConnection, MPConnectIntegrations, MPNetwork, MixpanelPeople, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSNumber, NSSet, NSString, NSTimer, SessionMetadata, UILongPressGestureRecognizer, UIViewController;
...
+ (_Bool)isMixpanelPushNotification:(id)arg1;
+ (id)libVersion;
+ (id)unarchiveFromFile:(id)arg1 asClass:(Class)arg2;
+ (id)unarchiveOrDefaultFromFile:(id)arg1 asClass:(Class)arg2;
+ (void)trackPushNotificationEventFromRequest:(id)arg1 event:(id)arg2 properties:(id)arg3;
...
- (void)trackPushNotification:(id)arg1 event:(id)arg2 properties:(id)arg3;
