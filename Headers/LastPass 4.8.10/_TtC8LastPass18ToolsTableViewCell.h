...
@class UIImageView, UILabel, _TtC8LastPass14EdgeInsetLabel;

@interface _TtC8LastPass18ToolsTableViewCell : UITableViewCell
{
...
- (void)awakeFromNib;
@property(nonatomic) __weak _TtC8LastPass14EdgeInsetLabel *secondaryTitleLabel; // @synthesize secondaryTitleLabel;
