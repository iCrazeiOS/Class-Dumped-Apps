...
@class MPFEvent, NSString;

@interface MPFAbstractReportEventRequest : CoralModel <NSCoding, NSCopying>
{
    MPFEvent *_event;
...
@property(retain, nonatomic) MPFEvent *event; // @synthesize event=_event;
- (void).cxx_destruct;
