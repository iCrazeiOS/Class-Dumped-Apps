...
@class UICButton;
@protocol SXAutomotiveEUAlertViewDelegate;

@interface SXAutomotiveEUAlertView : UICAlert
{
...
@property(nonatomic) __weak id <SXAutomotiveEUAlertViewDelegate> delegate;
