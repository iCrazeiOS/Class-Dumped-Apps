...
@class NSString;
@protocol AMILocalization, AMIWeblabBridgeService, CNMErrorHandleProtocol;

@interface CNMErrorViewModule : NSObject <AMIModule>
{
    id <AMIWeblabBridgeService> _weblabBridge;
    id <CNMErrorHandleProtocol> _errorHandleService;
...
@property(retain, nonatomic) id <CNMErrorHandleProtocol> errorHandleService; // @synthesize errorHandleService=_errorHandleService;
