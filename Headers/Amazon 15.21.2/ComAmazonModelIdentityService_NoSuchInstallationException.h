...
@class ComAmazonModelIdentityService_InstallationId, NSString;

@interface ComAmazonModelIdentityService_NoSuchInstallationException : CoralModel <NSCoding, NSCopying>
{
