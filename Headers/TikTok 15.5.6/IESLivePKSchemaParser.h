...
@class NSString;
@protocol HTSLiveDetailRouter, IESLIvePKAnchorBuilderAction, IESLiveSettings, IESLiveToastFactory;

@interface IESLivePKSchemaParser : NSObject <IESLiveSchemaParser>
{
