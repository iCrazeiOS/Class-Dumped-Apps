...
@class AVCaptureDevice, AVCaptureSession, AVCaptureVideoDataOutput, ByteRtcCameraVideoProcessor, NSString;
...
@interface ByteRtcCameraVideoCapturer : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate>
{
    ...
    double _beginTime;
    ByteRtcCameraVideoProcessor *_frameProcessor;
...
@property(retain, nonatomic) ByteRtcCameraVideoProcessor *frameProcessor; // @synthesize frameProcessor=_frameProcessor;
