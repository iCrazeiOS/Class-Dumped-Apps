...
@class ActivityStruct, AdCoverTitle, AvatarDecorationStruct, BlueVBrandInfoStruct, CommerceInfoStruct, CommercePermissionStruct, CommerceUserStruct, DouplusToastStruct, EffectArtistStruct, GPBInt64Array, HotsearchSprintStruct, LifeStoryBlockStruct, LiveHonorStruct, NSMutableArray, NSString, OriginalMusicianStruct, PermissionStruct, QuickShopStruct, RFansGroupInfo, ShareStruct, UrlStruct;

@interface UserStructWithConfidentialLevel : GPBMessage
{
}
