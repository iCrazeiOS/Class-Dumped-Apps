...
@interface aweme_v1_urge_list_response : GPBMessage
{
}
...
@property(nonatomic) _Bool hasHasHistory; // @dynamic hasHasHistory;
@property(nonatomic) _Bool hasHasMore; // @dynamic hasHasMore;
@property(nonatomic) int hasHistory; // @dynamic hasHistory;
