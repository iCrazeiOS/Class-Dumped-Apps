...
@class HTSLiveCommon, HTSLiveImage, HTSLiveUser;

@interface HTSLiveNobleToastMessage : GPBMessage
{
}
...
@property(nonatomic) _Bool hasToastIcon; // @dynamic hasToastIcon;
@property(nonatomic) _Bool hasUser; // @dynamic hasUser;
@property(retain, nonatomic) HTSLiveImage *toastIcon; // @dynamic toastIcon;
