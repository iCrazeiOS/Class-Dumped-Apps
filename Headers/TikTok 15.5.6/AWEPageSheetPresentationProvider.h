...
+ (void)enablePageSheetPresentationForViewController:(id)arg1 configurationBlock:(CDUnknownBlockType)arg2;
+ (void)enablePageSheetPresentationForViewController:(id)arg1;
