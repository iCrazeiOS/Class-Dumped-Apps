...
#import "TTFileUploadiOSCancelable-Protocol.h"

@class NSString;
@protocol TTFileUploadiOSDNSProtocol;

@interface TTFileUploadiOSDNSParserAction : NSObject <TTFileUploadiOSCancelable>
{
    _Bool _isUserCancel;
    _Bool _mainFinished;
    ...
    id <TTFileUploadiOSDNSProtocol> _mainParser;
    id <TTFileUploadiOSDNSProtocol> _backParser;
...
@property(retain, nonatomic) id <TTFileUploadiOSDNSProtocol> backParser; // @synthesize backParser=_backParser;
@property(retain, nonatomic) id <TTFileUploadiOSDNSProtocol> mainParser; // @synthesize mainParser=_mainParser;
