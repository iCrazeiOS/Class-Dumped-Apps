...
#import "ACCActivityComponentMessageProtocol-Protocol.h"
...
@class ACCFilterViewModel, ACCMusicModel, AWE2DTextInputViewController, AWEStickerDataManager, AWEStickerFeatureManager, IESEffectModel, NSMutableArray, NSMutableDictionary, NSString, UIView;
@protocol ACCActivityComponentProtocol, ACCAlgorithmCallbackComponentProtocol, ACCCaptureComponentProtocol, ACCComponentBusProtocol, ACCComponentProtocol, ACCComponentViewModelProvider, ACCGameComponentProtocol, ACCRecordARComponentProtocol, ACCRecordConfigPublishComponentProtocol, ACCRecordProgressBarComponentProtocol, ACCRecordRootComponentProtocol, ACCRecordSelectMusicComponentProtocol, ACCRecordToolBarComponentProtocol;

@interface ACCStickerComponent : ACCFeatureComponent <AWEStickerDataManagerDelegate, AWEStickerFeatureDelegate, AWEMojiEffectMessage, ACCActivityComponentMessageProtocol, AWEModernStickerViewControllerDelegate, AWEVideoBGStickerManagerDelegate, ACCStickerComponentProtocol, ACCCaptureComponentMessageProtocol, ACCRecordConfigPublishComponentMessageProtocol, ACCRecordSelectPropComponentMessage, ACCRecordCloseComponentMessageProtocol, ACCRecordFlowComponentMessageProtocol, ACCRecordSwitchModeComponentMessageProtocol>
{
    ...
    id <ACCActivityComponentProtocol> _activityComponent;
    ...
    ACCMusicModel *_firstApplyMusic;
...
@property(retain, nonatomic) ACCMusicModel *firstApplyMusic; // @synthesize firstApplyMusic=_firstApplyMusic;
...
@property(readonly, nonatomic) __weak id <ACCActivityComponentProtocol> activityComponent; // @synthesize activityComponent=_activityComponent;
...
- (void)msg_ClickUseBonusSticker:(id)arg1;
...
- (void)msg_didClickBackButton:(id)arg1;
...
- (void)applyStickerManagerSticker:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)applyCameraSticker:(id)arg1;
- (void)setStickerViewControllerDismissBlockIfNeeded;
- (void)applyLocalSticker;
- (void)configStickerFeatureManagerBlocks;
...
- (void)downloadCompleteWithEffect:(id)arg1;
- (void)handleMojiCheckUpdateProcess:(id)arg1 completionWrapper:(CDUnknownBlockType)arg2;
...
- (void)dealloc;
- (id)autoInjectComponentDictionaryOfactivityComponent;
