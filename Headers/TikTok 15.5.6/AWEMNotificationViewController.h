...
@class AWEGroupFilterView, AWEMHotLiveNotificationTableViewCell, AWEUITextLoadingView, NSArray, NSMutableArray, NSString, UIButton, UILabel, UITableView;

@interface AWEMNotificationViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, AWEUserMessage, AWETutorialVideoEntryViewDelegate, AWEMNotificationViewControllerProtocal>
{
    _Bool _isRefreshing;
