...
#import "AWEIMChatBannerViewManagerDelegate-Protocol.h"
#import "AWETutorialVideoEntryViewDelegate-Protocol.h"

@class AWEIMChatBannerViewManager, AWEIMFollowRequestView, AWEIMUnreadDotView, CALayer, NSArray, NSString, UIButton, UILabel, UIView;
@protocol AWEIMInteractListViewControllerDelegate, AWETutorialVideoEntryViewProtocol;

@interface AWEIMInteractListViewController : NSObject <AWEIMChatBannerViewDelegate, AWEIMChatBannerViewManagerDelegate, AWETutorialVideoEntryViewDelegate>
{
    _Bool _isInCurrentVC;
    _Bool _appearDuoshanBanner;
    _Bool _appearNewBannerStyle;
    UIView *_view;
    ...
    UIView<AWETutorialVideoEntryViewProtocol> *_tutorialVideoEntryView;
    AWEIMChatBannerViewManager *_bannerViewManager;
    double _maximumButtonHeight;
}

@property(nonatomic) _Bool appearNewBannerStyle; // @synthesize appearNewBannerStyle=_appearNewBannerStyle;
@property(nonatomic) _Bool appearDuoshanBanner; // @synthesize appearDuoshanBanner=_appearDuoshanBanner;
...
@property(retain, nonatomic) UIView<AWETutorialVideoEntryViewProtocol> *tutorialVideoEntryView; // @synthesize tutorialVideoEntryView=_tutorialVideoEntryView;
@property(retain, nonatomic) NSArray *bannerViewList; // @synthesize bannerViewList=_bannerViewList;
...
- (void)bannerViewDidChange;
- (void)tutorialVideoEntryViewHeightDidChange:(id)arg1 heightIs:(double)arg2;
...
- (void)tutorialVideoViewTrack;
- (void)listViewControllerBannerViewDidDisappear;
- (void)listViewControllerBannerViewDidAppear;
