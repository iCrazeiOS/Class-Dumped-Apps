...
+ (void)trackEventWithTag:(id)arg1 link:(long long)arg2 subtype:(unsigned long long)arg3 referString:(id)arg4 userID:(id)arg5 attributes:(id)arg6 awemeModel:(id)arg7;
