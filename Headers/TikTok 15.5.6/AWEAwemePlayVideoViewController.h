...
@protocol AWEADFunPlayingSeasonViewProtocol;
...
@property(retain, nonatomic) id <AWEADFunPlayingSeasonViewProtocol> funPlayingSeasonViewDelegate; // @synthesize funPlayingSeasonViewDelegate=_funPlayingSeasonViewDelegate;
...
- (void).cxx_destruct;
- (_Bool)shouldShowDouPlusGuideAnimaiton;
- (void)cancelTryDelayShowDouPlusEntryAniamation;
- (void)tryDelayShowDouPlusEntryAniamation;
