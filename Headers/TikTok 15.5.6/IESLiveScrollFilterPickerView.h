...
@class IESLivePagingView, IESLiveRoomFilter, IESLiveSlideLabelAnimator, NSArray, NSString;
@protocol IESLiveFilterProvider, IESLiveLanguageService, IESLiveScrollFilterPickerViewDelegate, IESLiveSettings;
...
@property(retain, nonatomic) IESLiveSlideLabelAnimator *animator; // @synthesize animator=_animator;
