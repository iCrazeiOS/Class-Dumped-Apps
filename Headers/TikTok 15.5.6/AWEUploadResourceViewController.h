...
@class AWEGalleryBaseViewController, AWESlidingTabbarView, AWESlidingViewController, NSArray, NSString;
...
@property(nonatomic) _Bool showGalleryAllTab; // @synthesize showGalleryAllTab=_showGalleryAllTab;
...
- (void)viewDidLoad;
- (id)initWithShowGalleryAllTab:(_Bool)arg1 selectedVideoCompletionWithAssetModel:(CDUnknownBlockType)arg2 selectedVideoCompletionWithHTSVideoData:(CDUnknownBlockType)arg3 clickPhotoCompletion:(CDUnknownBlockType)arg4;
