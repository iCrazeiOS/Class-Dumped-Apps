...
@class CAEAGLLayer, HTSGLContext, HTSGLFramebuffer, IESGLesTextureMvpRenderer, NSString, VELimitLogger;
...
+ (Class)layerClass;
@property(retain) IESGLesTextureMvpRenderer *textureMvpRenderer; // @synthesize textureMvpRenderer=_textureMvpRenderer;
