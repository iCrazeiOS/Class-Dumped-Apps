...
@class CommerceStickerStruct, NSMutableArray, NSString, ShareStruct, UrlStruct;

@interface NewFaceStickerStruct : GPBMessage
{
}
...
@property(retain, nonatomic) CommerceStickerStruct *commerceSticker; // @dynamic commerceSticker;
