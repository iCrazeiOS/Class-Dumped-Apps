...
+ (id)ieslive_colorFromAHexString:(id)arg1;
+ (id)ieslive_colorFromHexString:(id)arg1;
+ (id)ieslive_fontOrSystemFontForName:(id)arg1 size:(double)arg2;
+ (id)ieslive_attributedStringFromNode:(struct _xmlNode *)arg1 normalFont:(id)arg2 boldFont:(id)arg3 italicFont:(id)arg4 imageMap:(id)arg5;
+ (id)ieslive_attributedStringFromHTML:(id)arg1 normalFont:(id)arg2 boldFont:(id)arg3 italicFont:(id)arg4 imageMap:(id)arg5;
+ (id)ieslive_attributedStringFromHTML:(id)arg1 normalFont:(id)arg2 boldFont:(id)arg3 italicFont:(id)arg4;
+ (id)ieslive_attributedStringFromHTML:(id)arg1 boldFont:(id)arg2 italicFont:(id)arg3;
+ (id)ieslive_attributedStringFromHTML:(id)arg1;
