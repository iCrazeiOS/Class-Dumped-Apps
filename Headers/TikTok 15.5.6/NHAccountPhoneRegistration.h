...
- (void)startResetPassword:(id)arg1 ticket:(id)arg2 captcha:(id)arg3 finishBlock:(CDUnknownBlockType)arg4;
- (void)startVerifyEmailCodeForTicketWithEmail:(id)arg1 code:(id)arg2 type:(long long)arg3 captcha:(id)arg4 finishBlock:(CDUnknownBlockType)arg5;
...
- (void)startSendCodeWithEmail:(id)arg1 password:(id)arg2 captcha:(id)arg3 type:(long long)arg4 nextURL:(id)arg5 finishBlock:(CDUnknownBlockType)arg6;
- (void)checkPhoneNumberUnusableState:(id)arg1 finishBlock:(CDUnknownBlockType)arg2;
- (void)canCheckPhoneNumberUnusableState:(id)arg1 finishBlock:(CDUnknownBlockType)arg2;
- (void)startQuickLoginWithToken:(id)arg1 carrierType:(long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)startIDVerificationWithData:(id)arg1 sharkTicket:(id)arg2 finishBlock:(CDUnknownBlockType)arg3;
- (void)getIDVerificationInfoWithSharkTicket:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)startSMSLoginWithPhoneNumber:(id)arg1 code:(id)arg2 captcha:(id)arg3 finishBlock:(CDUnknownBlockType)arg4;
...
- (void)startSendVoiceCodeWithPhoneNumber:(id)arg1 captcha:(id)arg2 ticket:(id)arg3 sharkTicket:(id)arg4 type:(long long)arg5 finishBlock:(CDUnknownBlockType)arg6;
