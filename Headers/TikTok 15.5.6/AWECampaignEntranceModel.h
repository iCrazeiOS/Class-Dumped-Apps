...
@class AWECampaignFeedPendantModel, AWECampaignFragmentsCollectionConfiguration, AWECampaignLoginBannerModel, AWECampaignPopupWindowModel, AWECampaignProfileActivityModel, AWECampaignProfileTabbarModel, NSArray, NSDictionary, NSNumber, NSString;
...
@interface AWECampaignEntranceModel : MTLModel <MTLJSONSerializing>
{
    ...
    AWECampaignFragmentsCollectionConfiguration *_fragmentsConfig;
...
@property(retain, nonatomic) AWECampaignFragmentsCollectionConfiguration *fragmentsConfig; // @synthesize fragmentsConfig=_fragmentsConfig;
