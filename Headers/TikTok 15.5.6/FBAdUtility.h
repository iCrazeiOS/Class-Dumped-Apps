...
+ (void)currentUserAgentV2WithBlock:(CDUnknownBlockType)arg1;
+ (void)currentUserAgentV1WithBlock:(CDUnknownBlockType)arg1;
...
+ (CDStruct_1b6d18a9)timeUntilSkipOrEndForTime:(CDStruct_1b6d18a9)arg1 duration:(CDStruct_1b6d18a9)arg2 forcedViewTime:(CDStruct_1b6d18a9)arg3;
