...
@class IESLivePhotoTosUploadConfig, NSString, UIActivityIndicatorView, UIImagePickerController;
@protocol IESLiveAppInfo, IESLiveHTTPClient, IESLiveInternalRouter, IESLiveUserService;
...
@property(retain, nonatomic) IESLivePhotoTosUploadConfig *config; // @synthesize config=_config;
