...
#import "ACCSpecialEffectComponentProtocol-Protocol.h"

@class NSString;
@protocol ACCComponentBusProtocol, ACCComponentProtocol, ACCComponentViewModelProvider, ACCEditPlayerComponentProtocol, ACCTextStickerContainerComponentProtocol, ACCVideoEditViewComponentProtocol;

@interface ACCSpecialEffectComponent : NSObject <ACCSpecialEffectComponentProtocol>
{
