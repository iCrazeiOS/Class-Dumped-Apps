...
@protocol GMSDASHConnection, GMSServicesZwiebackMonitor, GMSTileServiceRegistry;
...
+ (id)sharedServices;
@property(readonly, nonatomic) NSCache *coordToPanoIDCache; // @synthesize coordToPanoIDCache=_coordToPanoIDCache;
