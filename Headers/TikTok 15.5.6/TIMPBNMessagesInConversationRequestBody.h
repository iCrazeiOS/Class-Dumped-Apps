...
@interface TIMPBNMessagesInConversationRequestBody : GPBMessage
{
}
...
@property(nonatomic) long long anchorIndex; // @dynamic anchorIndex;
...
@property(nonatomic) _Bool hasAnchorIndex; // @dynamic hasAnchorIndex;
