...
@class AWEContactListTableViewHeader, AWEContactLocalSearchManager, AWEDetailFansCollectionViewController, AWEListDataController, AWERelationListDataController, AWEUILoadingView, AWEUINotificationBarView, AWEUserModel, NSArray, NSMutableSet, NSString, UIButton, UITableView, UIView;
@protocol AWERecommendUserDataControllerProtocol;

@interface AWEFanStarViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, AWECommonSearchBarDelegate>
{
    _Bool _isMine;
    _Bool _isSearching;
...
- (id)p_footerForVCD;
- (id)p_footerForFindFriend;
- (id)p_headerViewForRecommend;
...
- (_Bool)p_showHotsoonFooter;
- (_Bool)p_showVCDAuthorizedBar;
- (_Bool)p_hotsoonAccountUnauthorize;
- (_Bool)p_showVCDAuthorizedView;
- (_Bool)p_shouldShowInviteFriend;
- (_Bool)p_shouldShowRecommend;
- (_Bool)p_shouldShowVCDFooter;
...
- (void)storyAvatarViewTapped:(id)arg1;
