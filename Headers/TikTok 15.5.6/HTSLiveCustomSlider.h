...
@class HTSDanmukuSettingCustomSlider, IESLiveCustomSliderConfig, UILabel;

@interface HTSLiveCustomSlider : UIView
{
    CDUnknownBlockType _valueChangedBlock;
    HTSDanmukuSettingCustomSlider *_slider;
    UILabel *_valueLabel;
    long long _currentValue;
    IESLiveCustomSliderConfig *_config;
}

@property(retain, nonatomic) IESLiveCustomSliderConfig *config; // @synthesize config=_config;
