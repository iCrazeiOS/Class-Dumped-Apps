...
@class NSMutableArray, NSString, TIMPBNMessageBody;

@interface TIMPBNStrangerConversation : GPBMessage
{
}
...
@property(retain, nonatomic) TIMPBNMessageBody *lastMessage; // @dynamic lastMessage;
