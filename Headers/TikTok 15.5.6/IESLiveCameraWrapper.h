...
@class IESLiveBeautyEffectConfig, IESLiveEffectComposerParameterMaker, NSString, RACCompoundDisposable;
@protocol IESActionDispatcher, IESLiveEffectPlatformService, IESLiveEnvironment, IESLiveRecoder, IESLiveRecoderService, IESLiveSettings, IESLiveViewExternalConfig;
