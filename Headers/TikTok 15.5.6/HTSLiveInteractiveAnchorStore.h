...
#import "HTSLiveInteractiveAnchorActions-Protocol.h"
#import "HTSLiveMessageSubscriber-Protocol.h"

@class HTSLiveInteractiveAPI, HTSLiveInteractiveUserModel, LiveRoomModel, NSArray, NSData, NSDate, NSMutableDictionary, NSNumber, NSString, RACDisposable, TTSignalUser;
@protocol HTSLiveInteractionEntranceProvider, HTSLiveMessageDispatchProvider, HTSLiveMessageHandler, IESActionDispatcher, IESLiveEnvironment, IESLiveMonitor, IESLiveSettings, IESLiveTracker;

@interface HTSLiveInteractiveAnchorStore : NSObject <HTSLiveInteractiveAnchorActions, HTSInteractiveControlProtocol, HTSLiveMessageSubscriber, HTSLiveAnchorActions>
{
...
@property(copy, nonatomic) NSData *zegoAppKey; // @synthesize zegoAppKey=_zegoAppKey;
