...
@class NSMutableIndexSet, NSSet, NSString;
...
@property(retain, nonatomic) NSSet *acceptableContentTypeSet; // @synthesize acceptableContentTypeSet=_acceptableContentTypeSet;
- (void).cxx_destruct;
