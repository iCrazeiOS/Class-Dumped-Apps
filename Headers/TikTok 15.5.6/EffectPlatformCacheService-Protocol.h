...
@class IESEffectModel, IESEffectPlatformNewResponseModel, IESEffectPlatformResponseModel, NSDictionary, NSString;

@protocol EffectPlatformCacheService <NSObject>
- (void)setJson:(NSDictionary *)arg1 effect:(IESEffectModel *)arg2 forKey:(NSString *)arg3;
...
- (IESEffectModel *)effectWithKey:(NSString *)arg1;
@end
