...
@interface AWEIMShareAndForwardPOICouponImpl : NSObject <AWEIMShareAndForwardToChatProtocol>
{
...
- (void).cxx_destruct;
- (id)poiInfoModel;
- (void)p_setPOICouponTextMessageViewWithText:(id)arg1 contentLabel:(id)arg2;
