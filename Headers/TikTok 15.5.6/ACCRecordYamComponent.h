...
@class ACCFilterViewModel, NSDictionary, NSString;
@protocol ACCComponentBusProtocol, ACCComponentProtocol, ACCComponentViewModelProvider, AWEYAMSceneRecordProtocol;

@interface ACCRecordYamComponent : ACCFeatureComponent <ACCRecordYamComponentProtocol, ACCStickerComponentMessageProtocol>
{
