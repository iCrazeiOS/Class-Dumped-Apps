...
- (id)getH265EncodeSetting:(long long)arg1 maxKeyFrameDuration:(double)arg2;
...
- (id)initWithVideoData:(id)arg1 needReencode:(_Bool)arg2 usenewModule:(_Bool)arg3 useLVModel:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (id)init;
