...
@class AFSDKiAdClient, AppsFlyerAES128Crypto, AppsFlyerKeychainWrapper, NSArray, NSDate, NSDictionary, NSString, NSURL;
@protocol AFSDKHTTPClientProtocol, AFSDKStorageProtocol, AppsFlyerTrackerDelegate, OS_dispatch_queue;
...
- (void)___getConversionData___v4;
