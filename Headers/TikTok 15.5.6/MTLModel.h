...
+ (void)setIsFastMode:(_Bool)arg1;
+ (_Bool)isFastMode;
+ (void)live_mergeDictionaryAndCheckDuplicated:(id)arg1 source:(id)arg2;
+ (id)live_callPropertyKeyCategoryMethod;
+ (void)awe_mergeDictionaryAndCheckDuplicated:(id)arg1 source:(id)arg2;
...
- (void)awe_callInitWithDictyCategoryMethod:(id)arg1;
