...
@class HTSCameraWriter, HTSFilterInterface, HTSGLFilterInput, HTSMediaMixPlayer, HTSVideoData, IESEffectModel, IESMMARCamera, IESMMBGVideoPlayer, IESMMEffectGroup, NSMutableArray, NSString, UIImage, VEAudioReaderUnit, VEEffectAuidoPlayerFactory;
@protocol AWEComposerEffectProtocol, IESMMARCameraDelegate;

@interface IESMMRecoder : IESMMCamera <ACCApplyBeautyProtocol, AWEVideoRecoderProtocol, VECameraWriterDelegate, HTSMediaMixPlayerDelegate, IESMMRecoderProtocol>
{
