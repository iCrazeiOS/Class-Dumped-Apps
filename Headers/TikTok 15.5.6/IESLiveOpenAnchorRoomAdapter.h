...
- (void)createRoomWithType:(unsigned long long)arg1 coverURI:(id)arg2 title:(id)arg3 enableShop:(_Bool)arg4 openLocationPermission:(_Bool)arg5 poiID:(id)arg6 challengeID:(id)arg7 completion:(CDUnknownBlockType)arg8;
