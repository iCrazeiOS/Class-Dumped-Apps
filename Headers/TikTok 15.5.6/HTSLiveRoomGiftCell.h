...
@class HTSLiveGiftItem, IESLiveGiftListComboView, IESLiveGiftSelectedView, RACDisposable, UIImageView, UILabel, UIView;
@protocol HTSLiveGiftActions, IESLiveEnvironment, IESLiveMonitor, IESLiveSettings, IESLiveWebImageService;
...
@interface HTSLiveRoomGiftCell : UICollectionViewCell
{
    ...
    IESLiveGiftListComboView *_comboView;
    ...
    IESLiveGiftSelectedView *_giftSelectedView;
...
@property(retain, nonatomic) IESLiveGiftSelectedView *giftSelectedView; // @synthesize giftSelectedView=_giftSelectedView;
...
@property(nonatomic) __weak IESLiveGiftListComboView *comboView; // @synthesize comboView=_comboView;
...
@property(nonatomic) __weak id <HTSLiveGiftActions> dispatcher; // @synthesize dispatcher=_dispatcher;
