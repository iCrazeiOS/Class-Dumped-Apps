...
@class NSString, TIMPBNConversationSettingInfo;

@interface TIMPBNUpsertConversationSettingExtInfoResponseBody : GPBMessage
{
}
...
@property(retain, nonatomic) TIMPBNConversationSettingInfo *settingInfo; // @dynamic settingInfo;
