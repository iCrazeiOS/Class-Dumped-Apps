...
@interface HTSLiveInteractiveStickerSettingView : UIView <IESLiveEffectStickerSelectProtocol>
{
    NSString *_stickerPath;
    UIView *_faceMaskPickerView;
...
@property(retain, nonatomic) UIView *faceMaskPickerView; // @synthesize faceMaskPickerView=_faceMaskPickerView;
