...
@class GMSx_GPBFileDescriptor, NSArray, NSString;

@interface GMSx_GPBDescriptor : NSObject <NSCopying>
{
    NSArray *fields_;
    NSArray *oneofs_;
    unsigned int storageSize_;
    Class messageClass_;
    GMSx_GPBFileDescriptor *file_;
    _Bool wireFormat_;
...
@property(readonly, nonatomic) GMSx_GPBFileDescriptor *file; // @synthesize file=file_;
...
@property(readonly) GMSx_GPBDescriptor *containingType;
