...
+ (id)viewModelWithChallengeID:(id)arg1 hashtagName:(id)arg2 authorID:(id)arg3 showSortMenu:(_Bool)arg4 isCommerce:(_Bool)arg5;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool showingSkeletonLoading;
