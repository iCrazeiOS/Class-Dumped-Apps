...
{
    const CDStruct_ba12166d *_tones;
...
+ (id)colorWithRGBA:(CDStruct_ba12166d)arg1;
...
- (id)initWithGroupID:(long long)arg1 tones:(const CDStruct_ba12166d *)arg2 numTones:(unsigned long long)arg3;
