...
@class IESLiveMTSpeedGiftTipBubbleView;
@protocol HTSLiveViewHierarchyProvider;

@interface IESLiveMTSpeedGiftTipView : UIView
{
    IESLiveMTSpeedGiftTipBubbleView *_bubbleView;
...
@property(retain, nonatomic) IESLiveMTSpeedGiftTipBubbleView *bubbleView; // @synthesize bubbleView=_bubbleView;
- (void).cxx_destruct;
