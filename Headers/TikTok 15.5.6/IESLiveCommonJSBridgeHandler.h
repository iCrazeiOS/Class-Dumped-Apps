...
@protocol HTSKVStore, HTSLiveInteractionEntranceActions, HTSLiveViewHierarchyProvider, IESActionDispatcher, IESLiveAlertFactory, IESLiveAppInfo, IESLiveChargeService, IESLiveCommentService, IESLiveContainerRouter, IESLiveEnvironment, IESLiveFeedbackService, IESLiveHTTPClient, IESLiveInternalRouter, IESLiveJSBridgeProtocol, IESLiveLocationService, IESLiveMonitor, IESLivePortalActions, IESLiveRoomService, IESLiveRpcService, IESLiveSettings, IESLiveShareService, IESLiveToastFactory, IESLiveTracker, IESLiveURLSchemaHandler, IESLiveUserService, IESLiveVerifyConfig, IESLiveWalletService, IESLiveWebViewService;
...
@interface IESLiveCommonJSBridgeHandler : NSObject <IESLiveUserActions, IESLiveJSBridgeHandlerProtocol>
{
    ...
    id <IESLiveCommentService> _commentService;
...
@property(retain, nonatomic) id <IESLivePortalActions> portalAction; // @synthesize portalAction=_portalAction;
...
@property(retain, nonatomic) id <IESLiveCommentService> commentService; // @synthesize commentService=_commentService;
...
- (_Bool)p_isAnchor;
- (void)p_realLoginProcessWithCallbackId:(id)arg1 needCallBack:(_Bool)arg2;
- (_Bool)_loginWithCallbackId:(id)arg1 result:(id)arg2 needCallBack:(_Bool)arg3;
- (void)registerSystemAuthorization;
- (void)registerLogout;
- (void)registerLogin;
- (void)registerAddRedDot;
- (void)registerPlayVideo;
- (void)uploadTosPhotoWithArgs:(id)arg1 callbackId:(id)arg2;
- (void)uploadTosVideoWithArgs:(id)arg1 callbackId:(id)arg2;
- (void)registerUpload;
