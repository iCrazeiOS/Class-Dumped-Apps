...
@class IESLiveWebViewNetworkErrorView, IESLiveWebpLoadingView, MASConstraint, NSArray, NSString, NSURL, RACDisposable, UIPanGestureRecognizer;
@protocol HTSLiveDetailRouter, HTSLiveViewHierarchyProvider, IESActionDispatcher, IESLiveEnvironment, IESLiveMTSwipeUpGuideCoordinator, IESLiveMonitor, IESLivePanelWebViewDelegate, IESLiveRoomService, IESLiveUserService, IESLiveWebViewFactory, IESLiveWebViewProtocol, IESLiveWebViewService;
...
@interface IESLivePanelWebView : UIView <IESLiveWebViewDelegate, HTSLiveOrientationActions>
{
    ...
    struct CGPoint _originLocation;
}

@property(retain, nonatomic) UIPanGestureRecognizer *panGesture; // @synthesize panGesture=_panGesture;
@property(nonatomic) struct CGPoint originLocation; // @synthesize originLocation=_originLocation;
...
- (void)moveWebView:(struct CGPoint)arg1;
- (void)didPan:(id)arg1;
- (void)addPanGesture;
- (id)webViewScene;
...
- (void)setUpSubscribe;
- (id)initWithFrame:(struct CGRect)arg1 url:(id)arg2 width:(double)arg3 height:(double)arg4 radius:(double)arg5 margin:(double)arg6 showLoading:(_Bool)arg7 forceWK:(_Bool)arg8 delegate:(id)arg9 forceFixContent:(_Bool)arg10 allowPullToClose:(_Bool)arg11;
- (void)dealloc;
