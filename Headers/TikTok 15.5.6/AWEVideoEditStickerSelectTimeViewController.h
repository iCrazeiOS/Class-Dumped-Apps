...
@class AWEEditorStickerGestureViewController, AWEImagesView, AWEPlayer, AWESimplifiedStickerContainerView, AWEStoryTextContainerView, AWEVideoImageGenerator, AWEVideoPublishViewModel, AWEVideoRangeSlider, NSArray, NSDictionary, NSString, UIButton, UIImageView, UILabel, UIView;
@protocol ACCExclusiveStickerComponentProtocol, ACCExclusiveStickerContainerProtocol, ACCStickerSelectTimeRangeProtocol;
...
@interface AWEVideoEditStickerSelectTimeViewController : UIViewController <AWEMediaSmallAnimationProtocol, AWEVideoRangeSliderDelegate, AWESimplifiedStickerContainerViewDelegate>
{
    ...
    UIView<ACCExclusiveStickerContainerProtocol> *_exclusiveSickerContainer;
    id <ACCExclusiveStickerComponentProtocol> _exclusiveSickerComponent;
    struct CGPoint _containerCenter;
    struct CGRect _originalPlayerRect;
}

@property(retain, nonatomic) id <ACCExclusiveStickerComponentProtocol> exclusiveSickerComponent; // @synthesize exclusiveSickerComponent=_exclusiveSickerComponent;
@property(retain, nonatomic) UIView<ACCExclusiveStickerContainerProtocol> *exclusiveSickerContainer; // @synthesize exclusiveSickerContainer=_exclusiveSickerContainer;
