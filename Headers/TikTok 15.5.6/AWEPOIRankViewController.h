...
#import "AWEPOIRankTableViewCellDelegate-Protocol.h"
...
@class AWENavigationBarView, AWEPOIRankItemWrapper, AWEPOIRankTopBannerModel, AWEPOIRankTopBannerView, AWEPoiRankCityOptionModel, AWEUILoadingView, NSArray, NSNumber, NSString, UIButton, UICollectionView, UITableView, UITableViewCell, UIView;

@interface AWEPOIRankViewController : UIViewController <BTDRouterViewControllerProtocol, UITableViewDataSource, UITableViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UIGestureRecognizerDelegate, AWEPOIRankTableViewCellDelegate>
{
    _Bool _rankInfoLoadFailed;
    _Bool _isRequestOnAir;
    _Bool _isCollectRequestOnAir;
    NSString *_cityCode;
    ...
    UICollectionView *_districtCollectionView;
    UIView *_districtBackgroundView;
...
@property(nonatomic) _Bool isCollectRequestOnAir; // @synthesize isCollectRequestOnAir=_isCollectRequestOnAir;
...
@property(retain, nonatomic) UIView *districtBackgroundView; // @synthesize districtBackgroundView=_districtBackgroundView;
@property(retain, nonatomic) UICollectionView *districtCollectionView; // @synthesize districtCollectionView=_districtCollectionView;
...
- (void)hideDistrictCollectionView;
- (void)didClickedTilte:(id)arg1;
- (void)didClickedBack:(id)arg1;
- (void)favoriteStatusChanged:(id)arg1;
- (void)rankTableViewCell:(id)arg1 collectItem:(id)arg2;
