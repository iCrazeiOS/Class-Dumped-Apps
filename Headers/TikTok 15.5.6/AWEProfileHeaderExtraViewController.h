...
@interface AWEProfileHeaderExtraViewController : UIViewController <AWEUserMessage, AWEDigitalWellbeingMessage, AWEProfileHeaderExtraViewControllerProtocol>
{
