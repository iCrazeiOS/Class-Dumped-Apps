...
#import "IESLiveAccessibilityDelegate-Protocol.h"
#import "UIScrollViewDelegate-Protocol.h"

@class CALayer, IESLiveScrollView, NSArray, NSDictionary, NSMutableArray, NSString, UIColor;
...
@property(retain, nonatomic) IESLiveScrollView *scrollView; // @synthesize scrollView=_scrollView;
...
- (void)scrollTo:(unsigned long long)arg1 animated:(_Bool)arg2;
