...
@class IESGLesTexture, NSArray;

@interface HTSGLFilterToneCurve : HTSGLFilter
{
    unsigned int _toneCurveTexture;
    char *_toneCurveByteArray;
    NSArray *_redCurve;
    NSArray *_greenCurve;
    NSArray *_blueCurve;
    ...
    IESGLesTexture *_glesToneCurveTexture;
}

@property(retain, nonatomic) IESGLesTexture *glesToneCurveTexture; // @synthesize glesToneCurveTexture=_glesToneCurveTexture;
