...
#import "AWEModernSearchStickerViewDelegate-Protocol.h"
...
@class ACCCollectionButton, ACCGradientView, AWEAggregatedEffectView, AWECameraContainerToolButtonWarpView, AWEMattingView, AWEMemojiContainerView, AWEModernSearchStickerView, AWEModernStickerCollectionViewCoordinator, AWEModernStickerContentCollectionView, AWEModernStickerSwitchTabView, AWEOriginStickerUserView, AWEPixaloopGuideView, AWEStickerCommerceEnterView, AWEStickerDataManager, AWEVideoBGStickerManager, IESEffectModel, NSArray, NSDictionary, NSIndexPath, NSMutableDictionary, NSMutableSet, NSNumber, NSString, UIButton, UIView, UIViewController;
@protocol ACCTextLoadingViewProtcol, AWEModernStickerPickerDelegate, AWEModernStickerViewControllerDelegate, UIViewControllerTransitioningDelegate, UIViewControllerTransitioningDelegate><ACCInteractiveTransitionProtocol;

@interface AWEModernStickerViewController : AWEStudioBaseViewController <UICollectionViewDataSource, UICollectionViewDelegate, AWEMattingViewProtocol, AWEAggregatedEffectViewDelegate, AWEMemojiContainerViewDelegate, ACCUserServiceMessage, AWEMojiEffectMessage, AWEModernStickerCollectionViewCoordinatorDelegate, AWEModernSearchStickerViewDelegate, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate, AWEModernStickerPicker>
{
    _Bool _isPhotoMode;
    _Bool _isShowing;
    ...
    double _mojiContainerViewAlpha;
    UIView *_searchStickerButtonContainerView;
    UIButton *_searchStickerButton;
    AWEModernSearchStickerView *_searchStickerView;
...
@property(retain, nonatomic) AWEModernSearchStickerView *searchStickerView; // @synthesize searchStickerView=_searchStickerView;
@property(retain, nonatomic) UIButton *searchStickerButton; // @synthesize searchStickerButton=_searchStickerButton;
@property(retain, nonatomic) UIView *searchStickerButtonContainerView; // @synthesize searchStickerButtonContainerView=_searchStickerButtonContainerView;
@property(nonatomic) _Bool hasSelectedWhenSearching; // @synthesize hasSelectedWhenSearching=_hasSelectedWhenSearching;
@property(nonatomic) double mojiContainerViewAlpha; // @synthesize mojiContainerViewAlpha=_mojiContainerViewAlpha;
...
@property(nonatomic) __weak UIView *loadingViewAnchorView; // @synthesize loadingViewAnchorView=_loadingViewAnchorView;
...
@property(nonatomic) long long pixaLoopImageSourceMark; // @synthesize pixaLoopImageSourceMark=_pixaLoopImageSourceMark;
...
- (void)updateStickersOfCategories:(id)arg1;
- (void)markSearchSelectedStateForBackUse;
- (void)updateHotCategoryIfNeeded;
...
- (void)p_handleMojiStickerClickProcess:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (long long)searchResultCount:(id)arg1;
- (void)searchStickerView:(id)arg1 searchStickerWithText:(id)arg2;
- (void)keyboardHideForSearchStickerView:(id)arg1;
- (void)searchStickerView:(id)arg1 changeFrameWithKeyboardSize:(struct CGSize)arg2 duration:(double)arg3 options:(unsigned long long)arg4;
- (void)searchStickerView:(id)arg1 didTapOnBackButton:(id)arg2;
...
- (id)p_collectionView:(id)arg1 getSearchStickerCellForIndexPath:(id)arg2;
- (id)p_collectionView:(id)arg1 getStickerCellForIndexPath:(id)arg2;
- (void)p_handleSelectedMojiEffectWhenDisplayCell:(id)arg1;
...
- (void)showMattingViewWithVideoBGPixaloop:(id)arg1 pixaloopResourcePath:(id)arg2 pixaloopImgK:(id)arg3 success:(_Bool)arg4 sticker:(id)arg5;
...
- (void)didTapOnSearchStickerButton:(id)arg1;
- (void)restoreSubViewsHiddenStateIfNeeded;
- (void)saveSubViewsHiddenStateIfNeeded;
- (_Bool)currentIsShowingSearchView;
- (_Bool)tryRemoveConstraintsForView:(id)arg1;
- (void)batchSwitchViewsBottomConstraints;
...
- (void)didFinishDownloadNewResourcesProcessWithMoji:(id)arg1 error:(id)arg2;
