...
+ (id)styleWithStrokeWidth:(double)arg1 textureState:(reffed_ptr_7371fe81)arg2 relativeDrawPriority:(int)arg3 consumeDistance:(_Bool)arg4;
+ (id)styleWithStrokeWidth:(double)arg1 strokeColor:(id)arg2 relativeDrawPriority:(int)arg3;
+ (id)styleWithStrokeWidth:(double)arg1 textureStrokeColor:(int)arg2 dim:(_Bool)arg3 relativeDrawPriority:(int)arg4 consumeDistance:(_Bool)arg5;
