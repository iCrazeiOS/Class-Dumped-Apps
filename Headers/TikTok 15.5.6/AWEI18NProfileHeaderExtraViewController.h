...
@class AWEButton, AWEI18NUserRelationView, AWEProfileHeaderActionController, AWEUIButton, MASConstraint, NSString, UIButton, UIImageView, UIView;
@protocol AWEI18NProfileHeaderExtraViewControllerDelegate;

@interface AWEI18NProfileHeaderExtraViewController : UIViewController <AWEUserMessage, AWEDigitalWellbeingMessage, AWEProfileHeaderExtraViewControllerProtocol>
{
    _Bool _hasBeenFollowed;
    _Bool _isCurrentUser;
    id <AWEI18NProfileHeaderExtraViewControllerDelegate> _delegate;
    AWEUIButton *_editButton;
    AWEI18NUserRelationView *_relationView;
    ...
    MASConstraint *_mailButtonWidthConstraint;
}

@property(retain, nonatomic) MASConstraint *mailButtonWidthConstraint; // @synthesize mailButtonWidthConstraint=_mailButtonWidthConstraint;
...
@property(retain, nonatomic) AWEI18NUserRelationView *relationView; // @synthesize relationView=_relationView;
@property(retain, nonatomic) AWEUIButton *editButton; // @synthesize editButton=_editButton;
@property(nonatomic) __weak id <AWEI18NProfileHeaderExtraViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
