...
#import "AWEMarkViewProtocol-Protocol.h"

@class AWEMarkViewUIConfigModel, NSString, UIImageView, UILabel, UIView;

@interface AWEMarkView : AWEAnimatedButton <AWEMarkViewProtocol>
{
