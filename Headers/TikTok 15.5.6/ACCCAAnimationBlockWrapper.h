...
@interface ACCCAAnimationBlockWrapper : NSObject <CAAnimationDelegate>
{
...
- (id)initWithStartedBlock:(CDUnknownBlockType)arg1 completedBlock:(CDUnknownBlockType)arg2;
