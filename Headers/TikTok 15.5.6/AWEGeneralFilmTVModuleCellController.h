...
@interface AWEGeneralFilmTVModuleCellController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, AWEAwemeDetailTableViewControllerDelegate, AWEModernFeedCellControllerProtocol>
{
...
- (void)openDetail:(id)arg1 withIndex:(long long)arg2;
