...
@class AWEEditStickerBubbleManager, AWEEditorStickerGestureViewController, AWEInteractionStickerLocationModel, AWEInteractionStickerModel, AWEPollStickerView, AWEStoryFontModel, CAShapeLayer, NSArray, NSMutableArray, NSString, UIButton, UIColor;
@protocol AWEEditorStickerGestureDelegate;

@interface AWEPollStickerEditView : UIView <UIGestureRecognizerDelegate, UITextViewDelegate, AWEInfoStickerEditViewProtocol>
{
    _Bool _selected;
    _Bool _enableEdit;
