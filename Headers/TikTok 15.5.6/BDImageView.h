...
@property(copy, nonatomic) CDUnknownBlockType firstFramePlayBlock; // @synthesize firstFramePlayBlock=_firstFramePlayBlock;
@property(copy, nonatomic) CDUnknownBlockType loopCompletionBlock; // @synthesize loopCompletionBlock=_loopCompletionBlock;
@property(nonatomic) _Bool hightAnimationControl; // @synthesize hightAnimationControl=_hightAnimationControl;
...
- (void)imagePlayerStartPlay:(id)arg1;
