...
@interface YYKVStorage : NSObject
{
    ...
    _Bool _isDatabaseMalformed;
    unsigned long long _type;
}

+ (void)setYYCacheLRUDisable:(_Bool)arg1;
@property(nonatomic) _Bool isDatabaseMalformed; // @synthesize isDatabaseMalformed=_isDatabaseMalformed;
...
- (_Bool)saveItemsFromDictionary:(id)arg1;
