...
@class IESLiveGiftPanelDataSharing, RACCommand;
...
- (id)initWithGiftPanelDataSharing:(IESLiveGiftPanelDataSharing *)arg1;

@optional
@property(nonatomic) __weak id <IESLiveGiftPanelReaction> reaction;
