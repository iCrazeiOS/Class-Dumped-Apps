...
@protocol AWELiveAudienceControllerDelegate, IESActionDispatcher, IESLiveContainerRouter, IESLiveFeedDrawerService, IESLiveFinishViewFactory, IESLiveToastFactory, IESLiveUserService;

@interface AWELiveAudienceContainerController : NSObject <HTSLiveAudienceViewControllerDelegate>
{
