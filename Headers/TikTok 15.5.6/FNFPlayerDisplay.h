...
- (id)initWithConfig:(CDStruct_b6254f9e)arg1 renderingThread:(id)arg2 framesBuffer:(id)arg3 layer:(id)arg4;
- (id)initWithConfig:(CDStruct_b6254f9e)arg1 andLayer:(id)arg2;
