...
@interface AWEGeneralTopUserMixVideoCellController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, AWEModernFeedCellControllerProtocol>
{
