...
@interface AWEAwemeShareViewController : BTDShareBaseViewController <UIGestureRecognizerDelegate, BTDShareActionDelegate, UIScrollViewDelegate, AWEShareViewControllerProtocol>
{
    ...
    _Bool _hasCPCAdAuthDisplay;
    _Bool _hasShareCopyLinkTracked;
    ...
    AWEShareIconAndTitleCell *_cpcAdAuthCell;
    AWEShareIconAndTitleCell *_shareCopyLinkCell;
    struct CGPoint _lastLocation;
}

+ (id)ntType;
@property(nonatomic) _Bool hasShareCopyLinkTracked; // @synthesize hasShareCopyLinkTracked=_hasShareCopyLinkTracked;
@property(nonatomic) __weak AWEShareIconAndTitleCell *shareCopyLinkCell; // @synthesize shareCopyLinkCell=_shareCopyLinkCell;
@property(nonatomic) _Bool hasCPCAdAuthDisplay; // @synthesize hasCPCAdAuthDisplay=_hasCPCAdAuthDisplay;
@property(nonatomic) __weak AWEShareIconAndTitleCell *cpcAdAuthCell; // @synthesize cpcAdAuthCell=_cpcAdAuthCell;
...
- (void)_updateSeparateLine;
- (void)_updateCancelButton;
- (void)_updateTitleLabel;
- (void)_updateSecondLineView;
- (void)checkShareType:(long long)arg1 option:(unsigned long long)arg2 shareItems:(id)arg3 needForceInsert:(_Bool)arg4 forceInsertIndex:(long long)arg5;
- (void)_updateFirstLineView;
- (_Bool)mus_shareDownloadDisabledForType:(long long)arg1;
- (_Bool)dou_isDisabledShareType:(long long)arg1 forAweme:(id)arg2;
- (id)p_youthControlToastTextOfShareType:(long long)arg1;
- (_Bool)p_shareTypeDisabledInYouthControl:(long long)arg1;
- (id)p_showUnreviewedToastWithType:(long long)arg1;
- (id)p_showUnreviewedShareGuideWithType:(long long)arg1;
...
- (void)_saveWithShareType:(long long)arg1 fromWebShare:(_Bool)arg2;
...
- (void)trackCPCAdAuthCellDisplayEvent;
- (_Bool)checkCPCAdAuthCellFirstDisplay;
- (void)trackCopyLinkEvent;
- (_Bool)checkCopyLinkCellDisplay;
...
- (id)showNotDownloadReason;
- (_Bool)showDisabledToastForLongVideoForShareType:(long long)arg1;
- (_Bool)shouldDisableShareTypeForLongVideo:(long long)arg1;
- (void)shareViewTapped:(id)arg1;
- (id)currentVideoControl;
- (void)showOnView:(id)arg1 enableMask:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)dismissIsIncommentVideoSaveStep:(_Bool)arg1;
- (void)dismiss;
- (void)viewSafeAreaInsetsDidChange;
- (void)viewDidDisappear:(_Bool)arg1;
- (void)endControlServerContextWithType:(id)arg1;
