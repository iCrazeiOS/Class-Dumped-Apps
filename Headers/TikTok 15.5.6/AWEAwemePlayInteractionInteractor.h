...
- (void)onAdDescriptionClicked:(id)arg1 range:(struct _NSRange)arg2 url:(id)arg3;
...
- (void)p_onCommenAnchorClicked:(id)arg1 type:(unsigned long long)arg2;
...
- (void)onUnfamiliarViewFollow:(CDUnknownBlockType)arg1;
- (void)onUnfamiliarViewUnfollow:(CDUnknownBlockType)arg1;
