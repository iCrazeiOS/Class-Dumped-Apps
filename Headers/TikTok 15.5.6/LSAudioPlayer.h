...
@class AVAudioSession, AVPlayer, AVPlayerItem, LSLiveAudioUnitProcess;
...
@property(retain, nonatomic) LSLiveAudioUnitProcess *audioUnitPlayer; // @synthesize audioUnitPlayer=_audioUnitPlayer;
@property(nonatomic) int type; // @synthesize type=_type;
@property(nonatomic) long long index; // @synthesize index=_index;
@property(nonatomic) double loadRange; // @synthesize loadRange=_loadRange;
@property(nonatomic) double totalTime; // @synthesize totalTime=_totalTime;
@property(nonatomic) __weak id <LSAudioPlayerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)dealloc;
