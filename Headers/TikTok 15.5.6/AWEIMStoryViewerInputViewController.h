...
@protocol AWEIMStoryViewerInputViewControllerDelegate;

@interface AWEIMStoryViewerInputViewController : UIViewController <AWEGrowingTextViewDelegate>
{
    id <AWEIMStoryViewerInputViewControllerDelegate> _delegate;
    AWEGrowingTextView *_textView;
}

@property(retain, nonatomic) AWEGrowingTextView *textView; // @synthesize textView=_textView;
@property(nonatomic) __weak id <AWEIMStoryViewerInputViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)p_setupUI;
...
- (void)handleKeyboardChangeNoti:(id)arg1;
