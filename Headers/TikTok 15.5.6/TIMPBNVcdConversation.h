...
@interface TIMPBNVcdConversation : GPBMessage
{
}
...
@property(nonatomic) _Bool hasVcdVersion; // @dynamic hasVcdVersion;
@property(nonatomic) long long vcdVersion; // @dynamic vcdVersion;
