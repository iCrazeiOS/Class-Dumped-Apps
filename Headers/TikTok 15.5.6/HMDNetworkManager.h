...
+ (id)sharedInstance;
@property(retain, nonatomic) id <HMDNetworkProtocol> urlsessionManager; // @synthesize urlsessionManager=_urlsessionManager;
@property(retain, nonatomic) id <HMDNetworkProtocol> ttnetManager; // @synthesize ttnetManager=_ttnetManager;
- (void).cxx_destruct;
