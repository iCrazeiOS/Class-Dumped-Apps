...
@class NSString, TIMPBNGroupInfo;

@interface TIMPBNSetGroupInfoResponseBody : GPBMessage
{
}
...
@property(retain, nonatomic) TIMPBNGroupInfo *groupInfo; // @dynamic groupInfo;
