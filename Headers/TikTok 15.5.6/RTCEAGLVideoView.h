...
#import <ByteRtcEngineKit/GLKViewDelegate-Protocol.h>
#import <ByteRtcEngineKit/RTCVideoRenderer-Protocol.h>

@class EAGLContext, GLKView, NSString, RTCDisplayLinkTimer, RTCI420TextureCache, RTCNV12TextureCache, RTCRGBTextureCache, RTCVideoFrame;
