...
@class AVAsset, HTSEffectManager, IESComposEffectProcess, IESMMCanvasConfig, IESMMImageMovieInfo, IESMMMVEffectFilter, IESMMStoryConfig, IESMMTimeMachine, IESMMTranscoderParam, IESVideoAddEdgeData, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, VEAudioEncodeConfig, VEImageFetchAsset, VEReadWriteLock, VERecordRecoveryData;
...
+ (id)p_videoDataApplyTimeMachine:(id)arg1;
...
@property(nonatomic) double notSupportCrossplat; // @synthesize notSupportCrossplat=_notSupportCrossplat;
