...
@interface IESLiveSuperNobleUserGameEnterView : UIView <HTSLiveUserEnterViewProtocol>
{
    _Bool _noShowAnimation;
...
@property(nonatomic) _Bool noShowAnimation; // @synthesize noShowAnimation=_noShowAnimation;
