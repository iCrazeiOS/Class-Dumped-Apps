...
@class AWEGeneralHotSpotTopView, AWEGeneralSearchModel, AWEGeneralSearchScrollTailView, NSArray, NSString, UICollectionView, UIView;
@protocol AWEModernFeedCellContext;

@interface AWEGeneralHotSpotVideosCellController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AWEAwemeDetailTableViewControllerDelegate, AWEModernFeedCellControllerProtocol>
{
    ...
    AWEGeneralHotSpotTopView *_topView;
...
@property(retain, nonatomic) AWEGeneralHotSpotTopView *topView; // @synthesize topView=_topView;
