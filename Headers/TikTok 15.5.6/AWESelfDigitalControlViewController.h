...
@interface AWESelfDigitalControlViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, AWEIMSettingModelUpdateMessage, AWEUserMessage, AWEComplianceMessage, BTDRouterViewControllerProtocol>
{
