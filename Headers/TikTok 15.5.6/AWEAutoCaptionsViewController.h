...
@class AWEAudioExport, AWECaptionBottomView, AWEEditorStickerGestureViewController, AWEPlayer, AWEStoryBackgroundTextView, AWEStoryTextContainerView, AWEStudioCaptionsManager, AWEVideoPublishViewModel, HTSVideoData, NSString, UIButton, UIImageView, UIView;
...
- (void)viewDidLoad;
- (id)initWithModel:(id)arg1 player:(id)arg2 textContainerView:(id)arg3 originalPlayerRect:(struct CGRect)arg4 captionManager:(id)arg5;
- (id)init;
- (void)dealloc;
