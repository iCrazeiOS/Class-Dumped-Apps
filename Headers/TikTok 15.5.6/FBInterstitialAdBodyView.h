...
@class CAShapeLayer, FBAdAudioMuteButton, FBAdCTAButton, FBAdPlacementDefinition, FBAdVideoProgressBar, FBAdViewabilityValidator, FBGradientView, FBInterstitialAdMediaView, FBInterstitialAdTextView, FBNativeAdDataModel, FBNativeAdMultiProductDataModel, NSNumber, NSString;
