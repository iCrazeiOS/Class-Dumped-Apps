...
@protocol LynxPageControlDelegate;

@interface LynxPageControl : UIControl
{
    ...
    id <LynxPageControlDelegate> _delegate;
...
@property(nonatomic) id <LynxPageControlDelegate> delegate; // @synthesize delegate=_delegate;
