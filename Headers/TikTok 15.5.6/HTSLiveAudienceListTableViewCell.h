...
@class HTSLiveAvatarImageView, IESLiveAudienceListCellFollowFactory, IESLiveAudienceModel, IESLiveUserModel, UIButton, UIImageView, UILabel, UIView;
@protocol HTSLiveAudienceListActions, IESLiveAudienceListCellViewAffair, IESLiveEnvironment, IESLiveSettings, IESLiveToastFactory, IESLiveUserService, IESLiveWebImageService;
...
@interface HTSLiveAudienceListTableViewCell : UITableViewCell
{
    ...
    id <IESLiveAudienceListCellViewAffair> _cellCommonAffair;
    id <IESLiveAudienceListCellViewAffair> _cellAffair;
    IESLiveAudienceListCellFollowFactory *_followBtnFactory;
}

@property(retain, nonatomic) IESLiveAudienceListCellFollowFactory *followBtnFactory; // @synthesize followBtnFactory=_followBtnFactory;
@property(retain, nonatomic) id <IESLiveAudienceListCellViewAffair> cellAffair; // @synthesize cellAffair=_cellAffair;
@property(retain, nonatomic) id <IESLiveAudienceListCellViewAffair> cellCommonAffair; // @synthesize cellCommonAffair=_cellCommonAffair;
