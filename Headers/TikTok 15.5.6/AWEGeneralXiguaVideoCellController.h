...
@class AWEGeneralXiguaVideoSingleCellViewController, NSString;
@protocol AWEModernFeedCellContext;

@interface AWEGeneralXiguaVideoCellController : UIViewController <AWEModernFeedCellControllerProtocol>
{
    NSString *_enterFrom;
    AWEGeneralXiguaVideoSingleCellViewController *_xiguaVideoSingleViewController;
...
@property(retain, nonatomic) AWEGeneralXiguaVideoSingleCellViewController *xiguaVideoSingleViewController; // @synthesize xiguaVideoSingleViewController=_xiguaVideoSingleViewController;
