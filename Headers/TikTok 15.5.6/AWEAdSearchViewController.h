...
@class AWEAdSearchCardView, NSString;
@protocol AWEModernFeedCellContext;

@interface AWEAdSearchViewController : UIViewController <AWEModernFeedCellControllerProtocol>
{
    id <AWEModernFeedCellContext> _context;
    AWEAdSearchCardView *_searchCardView;
}

+ (double)modernFeedCellPreferedHeightForModel:(id)arg1 width:(double)arg2;
+ (void)__awe__codeRunnerRun_24;
@property(retain, nonatomic) AWEAdSearchCardView *searchCardView; // @synthesize searchCardView=_searchCardView;
