...
@interface AWEDiscoverViewController : UIViewController <BTDRouterViewControllerProtocol, AWEReferenceTrackable, UISearchBarDelegate, AWESearchMiddleProtocol, UIScrollViewDelegate, AWEIsTabAwaring, AWEDiscoverViewControllerProtocol>
{
    _Bool _isTab;
