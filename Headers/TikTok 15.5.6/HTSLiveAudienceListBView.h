...
@protocol HTSLiveAudienceListActions, HTSLiveDetailRouter, HTSLiveViewHierarchyProvider, IESLiveEnvironment, IESLiveSettings, IESLiveTracker, IESLiveURLSchemaHandler, IESLiveUserService;

@interface HTSLiveAudienceListBView : HTSLivePopUpView <UIScrollViewDelegate, HTSLiveAudienceListTopViewDelegate>
{
