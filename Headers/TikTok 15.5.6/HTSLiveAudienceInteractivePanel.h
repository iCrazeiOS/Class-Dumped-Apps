...
@class CALayer, HTSLiveInteractiveAudienceStore, NSArray, NSString, UIButton, UICollectionView, UILabel, UIView;
@protocol HTSLiveAudienceInteractivePanelDelegate, IESLiveEnvironment;

@interface HTSLiveAudienceInteractivePanel : HTSLivePopUpView <UICollectionViewDelegate, UICollectionViewDataSource>
{
    NSArray *_waitingList;
    id <HTSLiveAudienceInteractivePanelDelegate> _delegate;
    UILabel *_title;
...
@property(nonatomic) __weak id <HTSLiveAudienceInteractivePanelDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
