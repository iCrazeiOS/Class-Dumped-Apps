...
@interface AWEAwemePlayInteractionPresenter : NSObject <AWEAwemeMessage>
{
    ...
    double _recentVolumeValue;
}

@property(nonatomic) double recentVolumeValue; // @synthesize recentVolumeValue=_recentVolumeValue;
...
- (void)onVolumeValueChangedAfterReduceFrequency:(id)arg1;
...
- (void)onTikTokFollowSwitchViewClicked:(id)arg1;
- (void)lookTiredVideo;
