...
+ (double)coverImageRatioNewStyleForAweme:(id)arg1;
+ (double)cellHeightForModel:(id)arg1 withWidth:(double)arg2 shouldShowPOI:(_Bool)arg3 shouldOptimizeNearbyUI:(_Bool)arg4 useTwoLine:(_Bool)arg5;
+ (double)cellHeightForModel:(id)arg1 withWidth:(double)arg2 shouldShowPOI:(_Bool)arg3 shouldOptimizeNearbyUI:(_Bool)arg4;
+ (double)cellHeightForModel:(id)arg1 withWidth:(double)arg2 useTwoLine:(_Bool)arg3;
