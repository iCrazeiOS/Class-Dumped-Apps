...
@class AWEIMSettingModel, AWEListDataController, AWEUserModel, NSDictionary, NSObject, NSString, UITableView, UITableViewCell, UIViewController;
@protocol AWEAlertWindowManagerProtocol, AWEAntiAddictedOptTimeManager, AWEAntiAddictedTimeManager, AWEAwemePrivacyControlProtocol, AWEComplianceMonitor, AWEContentLanguageManagerProtocol, AWEDouyinLabCenterProtocol, AWEFavoriteManagerProtocol, AWEGradientPunishManagerProtocol, AWEOtherProfileSettingActionProtocol, AWEProfileSettingSliderViewControllerProtocol, AWEPushNoticeProtocol, AWESettingsTableViewCellProtocol, AWEUserPrivacyManagerProtocol;
...
- (NSObject<AWEOtherProfileSettingActionProtocol> *)otherProfileSettingActionWithUser:(AWEUserModel *)arg1;
- (void)uploadBusinessLicenseWithParams:(NSDictionary *)arg1 completion:(void (^)(NSDictionary *, _Bool, _Bool))arg2;
- (UIViewController<AWEProfileSettingSliderViewControllerProtocol> *)newProfileSettingSliderViewController;
- (AWEListDataController *)favoriteAwemeDataControllerWithPageSize:(long long)arg1;
...
- (UIViewController *)othersSettingViewControllerWithUser:(AWEUserModel *)arg1;
...
- (NSObject<AWEComplianceMonitor> *)complianceMonitor;
...
- (Class)douyinLabCenterClass;
- (NSObject<AWEDouyinLabCenterProtocol> *)douyinLabSharedCenter;
- (NSObject<AWEAntiAddictedOptTimeManager> *)antiAddictedTimeOptSharedManager;
