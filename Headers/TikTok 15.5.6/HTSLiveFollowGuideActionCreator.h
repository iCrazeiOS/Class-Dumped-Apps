...
@protocol HTSLiveFollowGuideActions, IESLiveEnvironment, IESLiveSettings, IESLiveToastFactory, IESLiveTracker, IESLiveUserService;

@interface HTSLiveFollowGuideActionCreator : NSObject
{
    _Bool _popUpScheduled;
    LiveRoomModel *_room;
    HTSEventContext *_trackContext;
    id <IESLiveSettings> _settings;
    id <HTSLiveFollowGuideActions> _guideActionDispatcher;
...
@property(nonatomic) __weak id <HTSLiveFollowGuideActions> guideActionDispatcher; // @synthesize guideActionDispatcher=_guideActionDispatcher;
