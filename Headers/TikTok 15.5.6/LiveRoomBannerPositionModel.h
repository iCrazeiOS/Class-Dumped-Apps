...
@interface LiveRoomBannerPositionModel : MTLModel <MTLJSONSerializing>
{
    ...
    IESLiveBannerListModel *_activityTopRight;
}

+ (id)JSONKeyPathsByPropertyKey;
@property(retain, nonatomic) IESLiveBannerListModel *activityTopRight; // @synthesize activityTopRight=_activityTopRight;
