...
@interface TIMPBNBroadcastRecvMessageRequestBody : GPBMessage
{
}
...
@property(nonatomic) _Bool hasReverse; // @dynamic hasReverse;
@property(nonatomic) long long limit; // @dynamic limit;
@property(nonatomic) _Bool reverse; // @dynamic reverse;
