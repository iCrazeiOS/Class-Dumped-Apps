...
@interface TIMPBNModifyPropertyBody : GPBMessage
{
}
...
@property(retain, nonatomic) NSMutableArray *modifyPropertyContentArray; // @dynamic modifyPropertyContentArray;
@property(readonly, nonatomic) unsigned long long modifyPropertyContentArray_Count; // @dynamic modifyPropertyContentArray_Count;
