...
@interface LiveStreamSession : NSObject
{
    ...
    // Error parsing type: ^{AudioDevice={mutex={_opaque_pthread_mutex_t=q[56c]}}{mutex={_opaque_pthread_mutex_t=q[56c]}}@^{OpaqueAudioComponentInstance}^{OpaqueAudioComponent}^{AudioBufferList}ddiBBBB@{AudioStreamBasicDescription=dIIIIIIII}{atomic<bool>=AB}BBB{function<void (AudioBufferList *, int, void *)>={type=[24C]}^{__base<void (AudioBufferList *, int, void *)>}}{function<void (AudioBufferList *, int, AudioBufferList *, AudioBufferList *, void *)>={type=[24C]}^{__base<void (AudioBufferList *, int, AudioBufferList *, AudioBufferList *, void *)>}}^v^v^vdq}, name: audioDevice
...
- (_Bool)isRunning;
- (void)releaseBlackImageBuf;
- (struct __CVBuffer *)blackFrameForAudioStream;
- (_Bool)pushBlackFrameForAudioStreamIfNeeded;
