...
@protocol IESActionDispatcher, IESLiveDouPlusService;

@interface IESLiveAudienceDouPlusFragment : NSObject <HTSLiveGiftActions, HTSLiveCommentActions, HTSLiveRoomProfileReaction, HTSLiveUserPreviewActions, HTSLiveAudienceActions, IESLiveAudienceCommerceReaction, HTSLiveRoomRemoteActions, HTSLiveFollowGuideActions, HTSLiveSpeedGiftActions, HTSLiveAudienceListActions, HTSLiveComponent>
{
