...
@class AWEIMMessage, AWEShareContext, AWEURLModel, NSString;
...
- (void)performAyncTaskBeforeShareToShareUserList:(id)arg1 asynPerformBlock:(CDUnknownBlockType)arg2;
