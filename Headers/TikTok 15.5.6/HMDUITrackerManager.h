...
@interface HMDUITrackerManager : HeimdallrModule <HMDPerformanceReporterDataSource>
{
...
@property NSNumber *sceneInPushing; // @synthesize sceneInPushing=_sceneInPushing;
