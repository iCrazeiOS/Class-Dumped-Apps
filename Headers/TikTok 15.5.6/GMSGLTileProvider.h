...
@class GMSAnalytics, GMSForegroundDispatchQueue, GMSGLTileCoordsGenerator, GMSGLTileResources, GMSLRUCache, GMSServerResourceManager, GMSTileCoordsTombstoneTracker, GMSTileRequestCoordinator, NSMutableDictionary, NSMutableSet;
@protocol GMSGLTileProviderConsumer, GMSTileService;
