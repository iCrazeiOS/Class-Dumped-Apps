...
@class AWEStorage, NSMutableArray, NSMutableDictionary, NSMutableSet;
...
@interface AWEAwesomeSplashCacheHelper : NSObject
{
    ...
    NSMutableSet *_realDownloadingSet;
}

@property(retain, nonatomic) NSMutableSet *realDownloadingSet; // @synthesize realDownloadingSet=_realDownloadingSet;
...
- (void)recordRealDownloadEvent:(id)arg1 finished:(_Bool)arg2;
- (_Bool)shouldStashPreload:(id)arg1;
...
- (void)preloadStashModelInFeedMode:(_Bool)arg1;
