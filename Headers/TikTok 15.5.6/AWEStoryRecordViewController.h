...
@class AWEAnimatedButton, AWECameraFilterConfiguration, AWEModalTransitionDelegate, AWERecordFilterSwitchManager, AWEStickerDataManager, AWEStickerFeatureManager, AWEStickerHintView, AWEStoryAuthorityView, AWEStoryCameraContainerView, AWEStoryCameraManager, AWEStoryPublishStatusManager, AWESwitchRecordModeView, AWEVideoPublishViewModel, IESEffectModel, IESMMRecoder, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSTimer, UIImageView, UIView;
@protocol ACCApplyBeautyProtocol, AWEEditPageProtocol;

@interface AWEStoryRecordViewController : UIViewController <AWEStoryRecordAnimationViewDelegate, AWEStickerDataManagerDelegate, AWEStickerFeatureDelegate, AWEModernStickerViewControllerDelegate, AWERecordFilterSwitchProtocol, AWEFullScreenPopTransitionCustomize, UIGestureRecognizerDelegate, AWEStoryCameraManagerDelegate, AWESwitchRecordModeViewDelegate, AWEStoryCameraContainerViewDelegate, AWEParallelSlideRightInnerContextProvider, AWEZoomTransitionOuterContextProvider>
{
    ...
    IESMMRecoder<ACCApplyBeautyProtocol> *_camera;
    ...
    UIViewController<AWEEditPageProtocol> *_editVc;
...
@property(retain, nonatomic) UIViewController<AWEEditPageProtocol> *editVc; // @synthesize editVc=_editVc;
...
@property(retain, nonatomic) IESMMRecoder<ACCApplyBeautyProtocol> *camera; // @synthesize camera=_camera;
