...
@class AWEAwemeDetailTableViewController, AWEConcernUsersCardDataController, AWEListDataController, NSArray, NSDictionary, NSMutableDictionary, NSString, UICollectionView, UIView;
@protocol AWEFollowEmptyHintViewControllerProtocol, AWENearbyProtocol;

@interface AWEFeedCollectionViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, AWECollectionViewDelegateWaterfallLayout, AWEPreviewable, AWEAwemeDeletionMessage, AWEUserMessage, AWENewCollectionDelegateWaterfallLayout, AWEFeedTabItemViewControllerProtocol, AWEFeedViewControllerSwitchProtocol, AWEZoomTransitionOuterContextProvider, AWEFeedCollectionViewControllerProtocol, UIScrollViewDelegate>
{
...
@property(copy, nonatomic) NSArray *prevVisibleIndexPaths; // @synthesize prevVisibleIndexPaths=_prevVisibleIndexPaths;
...
- (_Bool)useDoubleColumnCardMixStyle;
- (_Bool)useWideSpacing;
