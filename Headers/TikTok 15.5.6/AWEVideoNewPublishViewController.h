...
@class AWEBubble, AWECommerceAnchorPublishModel, AWENewPublishAnchorTableViewCell, AWENewPublishCommentsSwitchCell, AWENewPublishEntranceTableCell, AWENewPublishGoodsSeedTableCell, AWENewPublishGoodsTableCell, AWENewPublishLocationTableViewCell, AWENewPublishPrivacySelectTableCell, AWENewPublishSNSShareTableCell, AWENewPublishSyncPopupView, AWENewPublishTableCell, AWEPOIInfoModel, AWEPlayer, AWEProgressLoadingView, AWEPublishNormalVideoTask, AWEPublishVCManager, AWESaveVideoToAblumTask, AWESaveVideoToAlbumTaskForModeo, AWEStudioCaptionsManager, AWETextView, AWETextViewManager, AWEUITextLoadingView, AWEURLModel, AWEVideoPublishInputSuggestionView, AWEVideoPublishViewModel, NSArray, NSDictionary, NSMutableDictionary, NSNumber, NSObject, NSSet, NSString, UIButton, UIImageView, UILabel, UIStackView, UITableView, UITableViewCell, UIView;
@protocol AWETextInputControllerProtocol, OS_dispatch_group;

@interface AWEVideoNewPublishViewController : UIViewController <AWECommerceAnchorMessageProtocol, AWENewPublishLocationTableViewCellDelegate, UITableViewDelegate, UITableViewDataSource, UITextViewDelegate, AWETextInputControllerDelegate, AWEZoomTransitionOuterContextProvider, AWEUserMessage, AWEPublishHeloManagerDelegate, AWENewPublishSyncPopupViewDelegate>
{
    ...
    AWENewPublishTableCell *_categoryTableViewCell;
...
@property(retain, nonatomic) AWENewPublishTableCell *categoryTableViewCell; // @synthesize categoryTableViewCell=_categoryTableViewCell;
...
- (_Bool)enableHashtag;
- (_Bool)shouldShowPrivacySettingItem;
...
@property(readonly, nonatomic) AWECommerceAnchorPublishModel *AIAnchorModel;
- (void)didClickAIAnchorWithCompletion:(CDUnknownBlockType)arg1;
- (void)updateAIAnchorWithJson:(id)arg1;
- (_Bool)firstShowAIAnchor;
- (void)setFirstShowAIAnchor:(_Bool)arg1;
...
@property(readonly, nonatomic) _Bool hasGameEntrance;
@property(readonly, nonatomic) _Bool hasGoodsSeedEntrance;
- (_Bool)hasCommonAnchorEntranceWithType:(long long)arg1;
@property(readonly, nonatomic) _Bool hasCompanyCouponEntrance;
@property(readonly, nonatomic) _Bool hasMediumEntrance;
...
- (void)cleanAnchorData;
@property(readonly, nonatomic) AWENewPublishTableCell *articleTableViewCell;
@property(readonly, nonatomic) _Bool shouldShowArticle;
- (void)cancleSelectedArticle:(id)arg1;
- (void)articleJSBResultNotification:(id)arg1;
- (void)didClickArticleCell;
- (void)addArticleObserver;
- (void)setupUIForArticle;
- (void)updateArticleWith:(id)arg1;
- (void)addAIAnchorWithType:(long long)arg1 anchorDismissBlock:(CDUnknownBlockType)arg2;
...
- (void)didClickCompanyCouponWithCompletion:(CDUnknownBlockType)arg1;
- (void)cancleSelectedCompanyCoupo:(id)arg1;
- (void)updateCompanyCouponWith:(id)arg1;
- (void)companyCouponJSBResultNotification:(id)arg1;
- (void)setupUIForCompanyCoupon;
- (void)addCompanyCouponObserver;
@property(readonly, nonatomic) _Bool shouldShowCompanyCoupon;
@property(readonly, nonatomic) AWENewPublishTableCell *companyCouponTableViewCell;
@property(readonly, nonatomic) AWENewPublishTableCell *gameTableViewCell;
- (void)cancleSelectedGame:(id)arg1;
- (void)didClickGameWithCompletion:(CDUnknownBlockType)arg1;
@property(readonly, nonatomic) _Bool shouldShowGameByAlone;
- (void)setupUIForGame;
- (void)addGameAnchorNotification:(id)arg1;
- (void)addAnchorGameObserver;
- (void)updateGameWithJsonString:(id)arg1;
- (void)updateGameWithGameID:(id)arg1 title:(id)arg2 jsonString:(id)arg3;
...
- (void)toastIfNeededForDraftID:(id)arg1;
...
@property(readonly, nonatomic) AWENewPublishGoodsSeedTableCell *mediumTableViewCell;
- (void)cancleSelectedMedium:(id)arg1;
- (void)didClickMediumWithCompletion:(CDUnknownBlockType)arg1;
@property(readonly, nonatomic) _Bool shouldShowMediumByAlone;
- (void)setupUIForMedium;
- (void)addMediumAnchorNotification:(id)arg1;
- (void)addAnchorMediumObserver;
- (void)updateMediumWithJsonString:(id)arg1;
- (void)didClearPOI;
