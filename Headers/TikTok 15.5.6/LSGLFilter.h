...
@class LSGLContext, LSGLFramebuffer, LSGLProgram, NSMutableDictionary, NSObject, NSString;
...
- (void)setIntegerArray:(int *)arg1 length:(int)arg2 forUniform:(int)arg3 program:(id)arg4;
- (void)setPointArray:(struct CGPoint *)arg1 length:(int)arg2 forUniform:(int)arg3 program:(id)arg4;
- (void)setFloatArray:(float *)arg1 length:(int)arg2 forUniform:(int)arg3 program:(id)arg4;
- (void)setVec4:(struct LSGPUVector4)arg1 forUniform:(int)arg2 program:(id)arg3;
- (void)setVec3:(struct LSGPUVector3)arg1 forUniform:(int)arg2 program:(id)arg3;
...
- (void)setMatrix4f:(struct LSGPUMatrix4x4)arg1 forUniform:(int)arg2 program:(id)arg3;
- (void)setMatrix3f:(struct LSGPUMatrix3x3)arg1 forUniform:(int)arg2 program:(id)arg3;
- (void)setFloatArray:(float *)arg1 length:(int)arg2 forUniform:(id)arg3;
- (void)setFloatVec4:(struct LSGPUVector4)arg1 forUniform:(id)arg2;
- (void)setFloatVec3:(struct LSGPUVector3)arg1 forUniformName:(id)arg2;
...
- (id)initWithFragmentShaderFromString:(id)arg1 context:(id)arg2;
- (id)initWithVertexShaderFromString:(id)arg1 fragmentShaderFromString:(id)arg2 context:(id)arg3;
