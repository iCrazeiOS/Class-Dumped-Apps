...
#import "FBAdJSBridgedInterfaceDelegate-Protocol.h"
#import "FBAdTouchGestureRecognizerDelegate-Protocol.h"
#import "UIWebViewDelegate-Protocol.h"

@class FBAdDataModel, FBAdJSBridgedInterface, NSString, NSURL, UIView, UIWebView;
...
@interface FBAdWebContentContainer : NSObject <UIWebViewDelegate, FBAdTouchGestureRecognizerDelegate, FBAdJSBridgedInterfaceDelegate, FBAdContentContainer>
{
    ...
    NSURL *_requestURL;
    FBAdJSBridgedInterface *_jsBridgedInterface;
...
+ (void)initialize;
@property(retain, nonatomic) FBAdJSBridgedInterface *jsBridgedInterface; // @synthesize jsBridgedInterface=_jsBridgedInterface;
