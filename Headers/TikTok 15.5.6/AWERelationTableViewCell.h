...
@interface AWERelationTableViewCell : AWEUIListTableViewCell <AWEUserMessage, AWEStoryMessage, AWERelationTableViewCellProtocol, AWEStoryEntranceLoadingDataSource>
{
    _Bool _isMine;
    _Bool _followMe;
    NSString *_enterFrom;
    CDUnknownBlockType _rightIconImageViewAction;
    CDUnknownBlockType _storyAvatarViewAction;
...
@property(copy, nonatomic) CDUnknownBlockType storyAvatarViewAction; // @synthesize storyAvatarViewAction=_storyAvatarViewAction;
...
- (void)p_trackFollowActionEvent:(id)arg1 label:(id)arg2 value:(id)arg3 sceneID:(long long)arg4;
