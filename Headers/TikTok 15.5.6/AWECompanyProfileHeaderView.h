...
@class AWECompanyLinkAreaView, AWEGlobalTranslationSubscription, AWEProfileHeaderActionController, AWESimpleInfoView, AWETopVideoEntranceView, AWEUserModel, NSString, NSTimer, UIButton, UIColor, UIImageView, UILabel, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;
