...
- (_Bool)evaluateFiltersForNanoUserProperty:(id)arg1 cachedSequenceEvaluationTimestamps:(id)arg2 evaluationTime:(id)arg3;
- (_Bool)evaluateFiltersForUserProperty:(id)arg1;
- (_Bool)evaluateFiltersForUserProperty:(id)arg1 cachedSequenceEvaluationTimestamps:(id)arg2 evaluationTimestamp:(double)arg3;
