...
@class ActivityStruct, AdCoverTitle, AvatarDecorationStruct, BlueVBrandInfoStruct, CommerceInfoStruct, CommercePermissionStruct, CommerceUserStruct, DouplusToastStruct, EffectArtistStruct, GPBInt64Array, HotListStruct, HotsearchSprintStruct, LifeStoryBlockStruct, LiveHonorStruct, NSMutableArray, NSString, OriginalMusicianStruct, PermissionStruct, QuickShopStruct, RFansGroupInfo, ShareStruct, TabSettingStruct, UrgeStruct, UrlStruct, UserAwemeCoverStruct, UserRateRemindInfo, UserVideoCoverStruct, UserWxInfoStruct, VideoUnreadStruct;

@interface UserStruct : GPBMessage
{
}
...
@property(retain, nonatomic) ActivityStruct *activity; // @dynamic activity;
...
@property(retain, nonatomic) UserAwemeCoverStruct *awemeCover; // @dynamic awemeCover;
@property(nonatomic) int awemeHotsoonAuth; // @dynamic awemeHotsoonAuth;
@property(nonatomic) int awemeHotsoonAuthRelation; // @dynamic awemeHotsoonAuthRelation;
...
@property(retain, nonatomic) CommercePermissionStruct *commercePermissions; // @dynamic commercePermissions;
...
@property(nonatomic) int contentLanguageAlreadyPopup; // @dynamic contentLanguageAlreadyPopup;
...
@property(nonatomic) _Bool douplusOldUser; // @dynamic douplusOldUser;
@property(retain, nonatomic) DouplusToastStruct *douplusToast; // @dynamic douplusToast;
...
@property(nonatomic) _Bool dpLevel; // @dynamic dpLevel;
@property(nonatomic) int duetSetting; // @dynamic duetSetting;
@property(nonatomic) int education; // @dynamic education;
@property(retain, nonatomic) EffectArtistStruct *effectDetail; // @dynamic effectDetail;
...
@property(nonatomic) _Bool hasAwemeHotsoonAuth; // @dynamic hasAwemeHotsoonAuth;
@property(nonatomic) _Bool hasAwemeHotsoonAuthRelation; // @dynamic hasAwemeHotsoonAuthRelation;
...
@property(nonatomic) _Bool hasContentLanguageAlreadyPopup; // @dynamic hasContentLanguageAlreadyPopup;
...
@property(nonatomic) _Bool hasDouplusOldUser; // @dynamic hasDouplusOldUser;
...
@property(nonatomic) _Bool hasDpLevel; // @dynamic hasDpLevel;
...
@property(nonatomic) _Bool hasFriendCount; // @dynamic hasFriendCount;
...
@property(nonatomic) _Bool hasNameField; // @dynamic hasNameField;
@property(nonatomic) _Bool hasNeedAddrCard; // @dynamic hasNeedAddrCard;
...
@property(nonatomic) _Bool hasPostDefaultDownloadSetting; // @dynamic hasPostDefaultDownloadSetting;
...
@property(nonatomic) _Bool hasPrivateAwemeCount; // @dynamic hasPrivateAwemeCount;
@property(nonatomic) _Bool hasProAccountTcmRedDot; // @dynamic hasProAccountTcmRedDot;
@property(nonatomic) _Bool hasProfileCompletion; // @dynamic hasProfileCompletion;
@property(nonatomic) _Bool hasProfilePv; // @dynamic hasProfilePv;
...
@property(nonatomic) _Bool hasRegisterFrom; // @dynamic hasRegisterFrom;
...
@property(nonatomic) _Bool hasShowArtistPlaylist; // @dynamic hasShowArtistPlaylist;
@property(nonatomic) _Bool hasShowFavoriteList; // @dynamic hasShowFavoriteList;
...
@property(nonatomic) _Bool hasShowPrivateTab; // @dynamic hasShowPrivateTab;
...
@property(nonatomic) _Bool hasTabSettings; // @dynamic hasTabSettings;
...
@property(nonatomic) _Bool hasUrgeDetail; // @dynamic hasUrgeDetail;
...
@property(nonatomic) _Bool hasUserRateRemindInfo; // @dynamic hasUserRateRemindInfo;
...
@property(nonatomic) _Bool hasVerificationBadgeType; // @dynamic hasVerificationBadgeType;
...
@property(nonatomic) _Bool hasVideoCover; // @dynamic hasVideoCover;
...
@property(nonatomic) _Bool hasWxInfo; // @dynamic hasWxInfo;
...
@property(nonatomic) _Bool hasYoutubeLastRefreshTime; // @dynamic hasYoutubeLastRefreshTime;
@property(nonatomic) _Bool hasYoutubeRefreshToken; // @dynamic hasYoutubeRefreshToken;
...
@property(retain, nonatomic) NSMutableArray *homepageBottomToastArray; // @dynamic homepageBottomToastArray;
@property(readonly, nonatomic) unsigned long long homepageBottomToastArray_Count; // @dynamic homepageBottomToastArray_Count;
...
@property(nonatomic) _Bool needAddrCard; // @dynamic needAddrCard;
@property(retain, nonatomic) NSMutableArray *needPointsArray; // @dynamic needPointsArray;
@property(readonly, nonatomic) unsigned long long needPointsArray_Count; // @dynamic needPointsArray_Count;
...
@property(nonatomic) _Bool postDefaultDownloadSetting; // @dynamic postDefaultDownloadSetting;
@property(nonatomic) int prExempt; // @dynamic prExempt;
@property(nonatomic) _Bool preventDownload; // @dynamic preventDownload;
@property(nonatomic) int privateAwemeCount; // @dynamic privateAwemeCount;
@property(nonatomic) int proAccountTcmRedDot; // @dynamic proAccountTcmRedDot;
@property(nonatomic) float profileCompletion; // @dynamic profileCompletion;
@property(nonatomic) long long profilePv; // @dynamic profilePv;
...
@property(retain, nonatomic) RFansGroupInfo *rFansGroupInfo; // @dynamic rFansGroupInfo;
...
@property(copy, nonatomic) NSString *registerFrom; // @dynamic registerFrom;
...
@property(nonatomic) int showArtistPlaylist; // @dynamic showArtistPlaylist;
@property(nonatomic) _Bool showFavoriteList; // @dynamic showFavoriteList;
...
@property(nonatomic) _Bool showPrivateTab; // @dynamic showPrivateTab;
...
@property(retain, nonatomic) TabSettingStruct *tabSettings; // @dynamic tabSettings;
@property(copy, nonatomic) NSString *thirdName; // @dynamic thirdName;
@property(nonatomic) long long totalFavorited; // @dynamic totalFavorited;
...
@property(retain, nonatomic) UrgeStruct *urgeDetail; // @dynamic urgeDetail;
...
@property(retain, nonatomic) UserRateRemindInfo *userRateRemindInfo; // @dynamic userRateRemindInfo;
@property(nonatomic) int userStoryCount; // @dynamic userStoryCount;
@property(nonatomic) int vcdAuthBlock; // @dynamic vcdAuthBlock;
@property(nonatomic) int verificationBadgeType; // @dynamic verificationBadgeType;
...
@property(retain, nonatomic) UserVideoCoverStruct *videoCover; // @dynamic videoCover;
...
@property(retain, nonatomic) UserWxInfoStruct *wxInfo; // @dynamic wxInfo;
...
@property(nonatomic) long long youtubeLastRefreshTime; // @dynamic youtubeLastRefreshTime;
@property(copy, nonatomic) NSString *youtubeRefreshToken; // @dynamic youtubeRefreshToken;
