...
@property(retain, nonatomic) NSArray *disablingRuleId; // @dynamic disablingRuleId;
@property(retain, nonatomic) NSArray *enablingRuleId; // @dynamic enablingRuleId;
@property(copy, nonatomic) NSString *fingerprint; // @dynamic fingerprint;
@property(copy, nonatomic) NSString *macroId; // @dynamic macroId;
