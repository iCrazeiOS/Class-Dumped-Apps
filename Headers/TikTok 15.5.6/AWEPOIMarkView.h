...
@class AWEPOIMarkViewUIConfigModel, UIImageView, UILabel, UIView;
...
@property(retain, nonatomic) AWEPOIMarkViewUIConfigModel *uiConfigModel; // @synthesize uiConfigModel=_uiConfigModel;
