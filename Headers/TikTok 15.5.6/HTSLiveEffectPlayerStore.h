...
@class HTSEventContext, HTSGroupedLiveMessageHandler, HTSLiveEffectNode, HTSLiveMessageFakedFilter, HTSLiveSpecialGiftQueue, IESLiveComponentContext, LiveRoomModel, NSMutableDictionary, NSMutableSet, NSString, RACDisposable;
...
@interface HTSLiveEffectPlayerStore : NSObject <HTSLiveMessageSubscriber, HTSLiveOrientationActions, HTSLiveHideComponentAction, HTSLiveEffectPlayerAction, IESLiveEffectStoreAbstract>
{
