...
@protocol ACCComponentProtocol, ACCComponentProvider, ACCComponentViewModelProvider, UIViewControllerTransitionCoordinator;
...
- (id)initWithContainerViewController:(UIViewController *)arg1 rootComponentProtocol:(Protocol *)arg2 componentProvider:(id <ACCComponentProvider>)arg3 viewModelProvider:(id <ACCComponentViewModelProvider>)arg4;
