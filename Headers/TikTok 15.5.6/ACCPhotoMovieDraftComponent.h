...
#import "ACCPhotoMovieDraftComponentMessageProtocol-Protocol.h"
#import "ACCPhotoMovieDraftComponentProtocol-Protocol.h"

@class NSString;
@protocol ACCComponentBusProtocol, ACCComponentProtocol, ACCComponentViewModelProvider;

@interface ACCPhotoMovieDraftComponent : NSObject <ACCPhotoMovieDraftComponentMessageProtocol, ACCPhotoMovieDraftComponentProtocol>
{
...
- (void).cxx_destruct;
- (void)msg_photoMovieHadBeenEdited;
- (id)publishModel;
