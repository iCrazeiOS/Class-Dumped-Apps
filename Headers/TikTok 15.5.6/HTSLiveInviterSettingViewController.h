...
@class LiveRoomModel, NSString, UITableView;

@interface HTSLiveInviterSettingViewController : HTSLivePopupBaseViewController <UITableViewDelegate, UITableViewDataSource, HTSLivePKSettingSwitchCellDelegate>
{
