...
@class AWEAwemeDetailTableViewController, AWEAwemeModel, AWEModernFeedSectionReusablePool, NSMutableArray, NSString, NSTimer, UICollectionView, UIScrollView, UITableView;
@protocol AWEVideoFeedListViewProtocol, AWEVideoFeedViewScrollDelegate;

@interface AWEVideoFeedViewController : UIViewController <AWEModernFullscreenTransitionOuterContextProvider, AWEZoomTransitionOuterContextProvider, AWEAwemeDetailTableViewControllerDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AWECollectionViewDelegateWaterfallLayout, AWENewCollectionDelegateWaterfallLayout, UITableViewDataSource, UITableViewDelegate>
{
    float *_speedHistory;
...
- (_Bool)shouldUseModernFullScreenTransitionForAweme:(id)arg1;
...
@property(copy, nonatomic) CDUnknownBlockType refreshRecommendUserBlock;
@property(copy, nonatomic) CDUnknownBlockType unlikeUserBlock;
- (void)cleanObservers;
