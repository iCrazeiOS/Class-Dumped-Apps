...
#import "AWENewCollectionViewWaterfallLayoutProtocol-Protocol.h"

@class NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString;
@protocol AWENewCollectionDelegateWaterfallLayout;

@interface AWEWaterfallCollectionViewLayout : UICollectionViewLayout <AWENewCollectionViewWaterfallLayoutProtocol>
{
    ...
    id <AWENewCollectionDelegateWaterfallLayout> _delegate;
...
@property(nonatomic) __weak id <AWENewCollectionDelegateWaterfallLayout> delegate; // @synthesize delegate=_delegate;
