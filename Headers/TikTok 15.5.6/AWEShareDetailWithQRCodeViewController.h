...
@class AWEShareContext, AWEShareDetailWithQRCodeBaseContentView, AWESharePanelView, AWEUILoadingView, MASConstraint, NSArray, NSNumber, NSString;
...
@interface AWEShareDetailWithQRCodeViewController : UIViewController <AWESharePanelViewDelegate>
{
    ...
    CDUnknownBlockType _customDismissalHandler;
...
@property(copy, nonatomic) CDUnknownBlockType customDismissalHandler; // @synthesize customDismissalHandler=_customDismissalHandler;
...
- (void).cxx_destruct;
- (_Bool)precheckSharingWithType:(long long)arg1;
...
- (unsigned long long)adjustedQRCodeType;
