...
@class AWEIMFeedVideoMessagePlayController, AWEIMMessageConversation, AWEIMMessageListViewModel, NSIndexPath, NSMutableArray, NSSet, NSString, UITableView;
@protocol AWEIMMessageListViewControllerDelegate;

@interface AWEIMMessageListViewController : UIViewController <UITableViewDataSource, AWEIMMessageBaseTableViewCellDelegate, AWEIMGreetingMessageTableViewCellDelegate, UITableViewDelegate>
{
