...
@class AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, HTSGLContext, HTSGLFramebuffer, IESGLesTextureMvpRenderer, NSArray, NSString, NSURL, VEAudioEncodeConfig, VELimitLogger;
