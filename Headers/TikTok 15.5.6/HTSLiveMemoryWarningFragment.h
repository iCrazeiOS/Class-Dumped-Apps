...
@class NSString;
@protocol HTSLiveViewHierarchyProvider, IESLiveAlertFactory, IESLiveMonitor, IESLiveSettings, OS_dispatch_source;

@interface HTSLiveMemoryWarningFragment : NSObject <HTSLiveComponent>
{
