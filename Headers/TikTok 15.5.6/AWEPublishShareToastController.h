...
@class AWEAwemeModel, AWEPublishSuccessView, NSString, UIButton, UIImageView, UILabel, UIScrollView, UIView;
...
@property(retain, nonatomic) AWEPublishSuccessView *publishSuccessView; // @synthesize publishSuccessView=_publishSuccessView;
