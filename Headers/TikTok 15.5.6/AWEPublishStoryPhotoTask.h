...
@class AWECreateStoryResponse, AWEOneDayLifeStoryModel, AWEPlayer, AWEPublishCreateStoryStage, AWEPublishPhotoFinalStage, AWEPublishPhotoPrepareStage, AWEPublishRequestParamStage, AWEPublishTimeTracker, AWEPublishUploadPhotoStage, AWEResourceUploadParametersResponseModel, NSError, NSString;

@interface AWEPublishStoryPhotoTask : AWEPublishBaseTask
{
    AWEPlayer *_player;
