...
@protocol WAXOutgoingStanzaElementEsPaymentSendAdditionalKycDataRequest_Account;

@protocol WAXOutgoingStanzaEsPaymentSendAdditionalKycDataRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementEsPaymentSendAdditionalKycDataRequest_Account> account;
