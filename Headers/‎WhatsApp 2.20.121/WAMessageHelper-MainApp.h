...
+ (id)mediaCompressionTypeForMessageType:(int)arg1 andChatJID:(id)arg2;
+ (id)resizeImageIfNeeded:(id)arg1 forCompressionType:(id)arg2;
+ (void)generateXMPPThumbnailFrom:(id)arg1 forJID:(id)arg2 baseName:(id)arg3 writeToDisk:(_Bool)arg4 compressionType:(id)arg5 completion:(CDUnknownBlockType)arg6;
