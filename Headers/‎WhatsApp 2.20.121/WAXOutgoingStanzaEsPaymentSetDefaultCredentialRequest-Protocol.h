...
@protocol WAXOutgoingStanzaElementEsPaymentSetDefaultCredentialRequest_Account;

@protocol WAXOutgoingStanzaEsPaymentSetDefaultCredentialRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementEsPaymentSetDefaultCredentialRequest_Account> account;
