...
@protocol WAXOutgoingStanzaElementNoviPaymentSaveCountryOfResidenceRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentSaveCountryOfResidenceRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentSaveCountryOfResidenceRequest_Account> account;
