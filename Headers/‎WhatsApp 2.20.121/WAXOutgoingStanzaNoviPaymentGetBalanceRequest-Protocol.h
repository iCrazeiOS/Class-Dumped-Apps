...
@protocol WAXOutgoingStanzaElementNoviPaymentGetBalanceRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentGetBalanceRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentGetBalanceRequest_Account> account;
