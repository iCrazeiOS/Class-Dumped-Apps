...
@protocol WAXOutgoingStanzaElementNoviPaymentSaveDOBRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentSaveDOBRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentSaveDOBRequest_Account> account;
