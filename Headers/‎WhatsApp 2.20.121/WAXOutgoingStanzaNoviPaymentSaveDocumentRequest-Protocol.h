...
@protocol WAXOutgoingStanzaElementNoviPaymentSaveDocumentRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentSaveDocumentRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentSaveDocumentRequest_Account> account;
