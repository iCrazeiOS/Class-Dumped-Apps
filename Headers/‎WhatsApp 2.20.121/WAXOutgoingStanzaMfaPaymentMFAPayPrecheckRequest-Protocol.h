...
@protocol WAXOutgoingStanzaElementMfaPaymentMFAPayPrecheckRequest_Account;

@protocol WAXOutgoingStanzaMfaPaymentMFAPayPrecheckRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementMfaPaymentMFAPayPrecheckRequest_Account> account;
