...
@protocol WAXOutgoingStanzaElementNoviPaymentEncryptedSaveAddressRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentEncryptedSaveAddressRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentEncryptedSaveAddressRequest_Account> account;
