...
@protocol WAXOutgoingStanzaElementEsPaymentEUConfirmAccountRecoveryRequest_Account;

@protocol WAXOutgoingStanzaEsPaymentEUConfirmAccountRecoveryRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementEsPaymentEUConfirmAccountRecoveryRequest_Account> account;
