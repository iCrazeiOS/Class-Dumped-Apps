...
@interface WAPaymentBaseAccount : NSObject <WAPaymentAccount>
{
...
@property(nonatomic, readonly) _Bool isDefaultAccount;
...
@property(nonatomic, copy) WAPaymentMoney *balance; // @synthesize balance;
