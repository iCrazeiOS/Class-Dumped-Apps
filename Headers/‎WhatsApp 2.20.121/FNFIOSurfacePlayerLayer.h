...
#import <Core/CALayerDelegate-Protocol.h>
#import <Core/FNFAVPlayerLayer-Protocol.h>
#import <Core/FNFDecompressionSessionDelegate-Protocol.h>
#import <Core/FNFPlayerDisplayEngine-Protocol.h>
...
- (id)initWithConfig:(CDStruct_d07cd00d)arg1 andCodecMap:(id)arg2;
- (id)initWithConfig:(CDStruct_d07cd00d)arg1;
