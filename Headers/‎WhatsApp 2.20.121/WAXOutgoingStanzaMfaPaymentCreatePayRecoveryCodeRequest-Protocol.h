...
@protocol WAXOutgoingStanzaElementMfaPaymentCreatePayRecoveryCodeRequest_Account;

@protocol WAXOutgoingStanzaMfaPaymentCreatePayRecoveryCodeRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementMfaPaymentCreatePayRecoveryCodeRequest_Account> account;
