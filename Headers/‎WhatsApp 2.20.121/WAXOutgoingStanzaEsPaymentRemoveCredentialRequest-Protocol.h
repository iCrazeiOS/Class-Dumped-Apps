...
@protocol WAXOutgoingStanzaElementEsPaymentRemoveCredentialRequest_Account;

@protocol WAXOutgoingStanzaEsPaymentRemoveCredentialRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementEsPaymentRemoveCredentialRequest_Account> account;
