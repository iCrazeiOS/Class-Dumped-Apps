...
#import "WAPaymentRegistrationHandlerDelegate-Protocol.h"
...
@class NSArray, NSMutableArray, NSNumber, NSSet, NSString, UIBarButtonItem, UILabel, UIToolbar, UIView, WABlocklistAlertManager, WAChatCellData, WAChatMessagesTableView, WAChatPromptCardCell, WAGroupInviteJoinController, WAMessage, WAMessageBubbleTableViewCell, WAMessagePresenterHelper, WAMultiSendMediaItem, WAPaymentBaseHandler, WAPaymentCoordinator, WAProgressAlertController, WAUserJID, WAVCardMatchCell, WAWallpaperView, WAWeakTimer;
@protocol UIViewControllerAnimatedTransitioning, WABlurredBackgroundProviding, WAChatMessagesControllerProtocol;

@interface WAChatMessagesViewController : WAViewController <WAPaymentCoordinatorDelegate, WAPaymentTransactionHandlerDelegate, WAPaymentAccountSetupHandlerDelegate, WAPaymentRootHandlerDelegate, WAPaymentRegistrationHandlerDelegate, WANewContactViewControllerDelegate, WAParticipantPickerViewControllerDelegate, WAShareContactViewControllerDelegate, UIViewControllerTransitioningDelegate, EKEventEditViewDelegate, WAGroupInviteJoinControllerDelegate, _TtP14MainAppLibrary35WAListMessageViewControllerDelegate_, WAMessageBubbleTableViewCellDelegate, WAStickerPackViewControllerDelegate, WAChatMessagesControllerDelegate, WATableViewCellPreviewingDelegate, WAVCardMessagePreviewActionDelegate, UIViewControllerAnimatedTransitioning, WAImageToImageTransitioning, WANavigationControllerPopToAnimating, WAReplyButtonsCellDelegate, WAChatMessagesTableViewDelegate, UITableViewDataSource, WACalloutViewPresenterDelegate>
{
...
- (void)blockContactFromTriggeredBlockWithJID:(id)arg1;
- (void)blockContactFromChatWithJID:(id)arg1;
...
- (void)retryReceiverPaymentForMessage:(id)arg1;
...
- (void)presentListForListMessage:(id)arg1;
...
- (void)bubbleTableViewCellDidRequestReceiverRetryPayment:(id)arg1;
