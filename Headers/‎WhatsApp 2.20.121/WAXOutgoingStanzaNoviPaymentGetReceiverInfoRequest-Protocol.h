...
@protocol WAXOutgoingStanzaElementNoviPaymentGetReceiverInfoRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentGetReceiverInfoRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentGetReceiverInfoRequest_Account> account;
