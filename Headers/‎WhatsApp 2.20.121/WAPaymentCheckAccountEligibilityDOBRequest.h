...
@interface WAPaymentCheckAccountEligibilityDOBRequest : WAPaymentRequest
{
    // Error parsing type: , name: dobBanDecision
...
- (id)initWithDobBanDecision:(id)arg1 actionType:(long long)arg2;
