...
@interface XMPPSocket : NSObject <GCDAsyncSocketDelegate>
{
    ...
    unsigned long long _dnsResolutionID;
...
@property(copy, nonatomic) NSArray *fallbackAddresses;
- (void)connectToEndpoints:(id)arg1;
- (void)resolveHostNameAsync:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (id)socket;
