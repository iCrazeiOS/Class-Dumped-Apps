...
@protocol WAXOutgoingStanzaElementEsPaymentVerifyEmailRequest_Account;

@protocol WAXOutgoingStanzaEsPaymentVerifyEmailRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementEsPaymentVerifyEmailRequest_Account> account;
