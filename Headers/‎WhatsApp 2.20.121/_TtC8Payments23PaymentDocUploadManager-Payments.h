...
#import <Payments/_TtC8Payments23PaymentDocUploadManager.h>

#import <Payments/WAMMSMediaUploadOperationEncryptedDelegate-Protocol.h>

@interface _TtC8Payments23PaymentDocUploadManager (Payments) <WAMMSMediaUploadOperationEncryptedDelegate>
