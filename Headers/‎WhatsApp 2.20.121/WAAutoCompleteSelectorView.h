...
@interface WAAutoCompleteSelectorView : UIView <UITableViewDelegate, UITableViewDataSource>
{
...
- (void)reloadData;
- (void)updateItemCountCompletionWithItemCount:(long long)arg1;
- (void)didUpdateItemsMatchingSearchTerm:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)updateSearchTerm:(id)arg1 forTextRange:(struct _NSRange)arg2 completion:(CDUnknownBlockType)arg3;
