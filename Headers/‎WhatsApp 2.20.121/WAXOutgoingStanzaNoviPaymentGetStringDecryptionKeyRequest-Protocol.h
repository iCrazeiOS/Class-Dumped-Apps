...
@protocol WAXOutgoingStanzaElementNoviPaymentGetStringDecryptionKeyRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentGetStringDecryptionKeyRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentGetStringDecryptionKeyRequest_Account> account;
