...
@protocol WAXOutgoingStanzaElementMfaPaymentCreatePINRequest_Account;

@protocol WAXOutgoingStanzaMfaPaymentCreatePINRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementMfaPaymentCreatePINRequest_Account> account;
