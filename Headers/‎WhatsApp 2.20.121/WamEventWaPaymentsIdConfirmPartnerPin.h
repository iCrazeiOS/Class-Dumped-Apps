...
@interface WamEventWaPaymentsIdConfirmPartnerPin : WamEvent
{
    double _forgot_code_selected;
...
@property(nonatomic) double forgot_code_selected; // @synthesize forgot_code_selected=_forgot_code_selected;
