...
@class NSMutableDictionary, NSString, WAChatStorage, WAMMSTaskSessionV4, WANetworkUsageManager, WANetworkUsageMetricsManager, WAOptimisticMediaUploadManager, WASimpleOperationQueue, XMPPConnection;
...
+ (_Bool)messageIsValidForFastForward:(id)arg1;
...
- (void)fetchMostRecentItemForReuseWithPlaintextFileHash:(id)arg1 mediaKeyData:(out id *)arg2 mediaKeyDate:(out id *)arg3 mediaKeyReuseReason:(out unsigned long long *)arg4 mediaFilePath:(out id *)arg5;
