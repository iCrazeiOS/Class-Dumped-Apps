...
- (id)initWithLocalURL:(id)arg1 async:(_Bool)arg2 decompressedOutput:(_Bool)arg3 containerDimensions:(struct CGSize)arg4 shouldApplyRotationTransform:(_Bool)arg5 enableDroppableFrames:(_Bool)arg6;
