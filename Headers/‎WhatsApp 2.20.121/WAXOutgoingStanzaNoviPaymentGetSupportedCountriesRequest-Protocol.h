...
@protocol WAXOutgoingStanzaElementNoviPaymentGetSupportedCountriesRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentGetSupportedCountriesRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentGetSupportedCountriesRequest_Account> account;
