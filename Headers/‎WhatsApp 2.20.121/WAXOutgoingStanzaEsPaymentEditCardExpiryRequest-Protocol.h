...
@protocol WAXOutgoingStanzaElementEsPaymentEditCardExpiryRequest_Account;

@protocol WAXOutgoingStanzaEsPaymentEditCardExpiryRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementEsPaymentEditCardExpiryRequest_Account> account;
