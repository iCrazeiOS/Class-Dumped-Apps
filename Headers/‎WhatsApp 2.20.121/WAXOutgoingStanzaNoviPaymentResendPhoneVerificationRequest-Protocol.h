...
@protocol WAXOutgoingStanzaElementNoviPaymentResendPhoneVerificationRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentResendPhoneVerificationRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentResendPhoneVerificationRequest_Account> account;
