...
@protocol WAXOutgoingStanzaElementMfaPaymentCreateAuthTicktBasedFactorRequest_Account;

@protocol WAXOutgoingStanzaMfaPaymentCreateAuthTicktBasedFactorRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementMfaPaymentCreateAuthTicktBasedFactorRequest_Account> account;
