...
@class NSArray, NSDictionary, NSNumber, NSString, WAActorJIDWrapper, WAChatJID, WAIncomingStanza, WAJID, WAMessageID, WAUserJID, XMPPCallAckStanza, XMPPCallStanza, XMPPConnection, XMPPMessageStatusChangeRequest, XMPPReceiptStanza;
...
- (void)xmppConnection:(XMPPConnection *)arg1 didReceiveServerErrorForOutgoingMessageWithStanzaID:(NSString *)arg2 receipt:(XMPPReceiptStanza *)arg3;
