...
@protocol WAXOutgoingStanzaElementCommonPaymentCreateNewAccountRequest_Account;

@protocol WAXOutgoingStanzaCommonPaymentCreateNewAccountRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementCommonPaymentCreateNewAccountRequest_Account> account;
