...
@protocol WAXOutgoingStanzaElementNoviPaymentLoginRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentLoginRequest <NSObject, WAXOutgoingStanza>
@property(readonly, nonatomic) NSObject<WAXOutgoingStanzaElementNoviPaymentLoginRequest_Account> *account;
