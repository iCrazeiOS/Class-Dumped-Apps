...
@protocol WAXOutgoingStanzaElementEsPaymentTransactionWithdrawalActionRequest_Account;

@protocol WAXOutgoingStanzaEsPaymentTransactionWithdrawalActionRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementEsPaymentTransactionWithdrawalActionRequest_Account> account;
