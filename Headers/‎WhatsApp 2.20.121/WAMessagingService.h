...
- (id)messageToSendWithSendTask:(id)arg1 actorJIDWrapper:(id)arg2 retryCount:(unsigned long long)arg3;
...
- (_Bool)encryptAndResendMessage:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (_Bool)canSendMessages;
- (_Bool)removePendingSendTaskIfNecessaryForMessage:(id)arg1;
- (_Bool)hasAnyIdentityChangesForPendingDevicesOfMessage:(id)arg1;
...
- (void)submitRetrtFromUnknownDeviceFieldStatsWithPrimary:(_Bool)arg1;
...
- (void)resendMessageDueToNewDevice:(id)arg1;
- (void)deviceSyncAndResendMessage:(id)arg1;
