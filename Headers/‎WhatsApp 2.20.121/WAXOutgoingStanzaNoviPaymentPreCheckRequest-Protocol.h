...
@protocol WAXOutgoingStanzaElementNoviPaymentPreCheckRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentPreCheckRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentPreCheckRequest_Account> account;
