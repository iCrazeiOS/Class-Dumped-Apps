...
#import <Core/WASearchControllerDelegate-Protocol.h>

@class NSArray, NSMutableArray, NSString, WACountryCellModel, WACountryInfo;
...
@interface WACountryPickerController : WATableViewController <WASearchControllerDelegate, UITableViewDataSource, UITableViewDelegate>
{
    ...
    WACountryCellModel *_selectedCellModel;
    _Bool _hidesPhoneNumberPrefixes;
    id <WACountryPickerControllerDelegate> _delegate;
    NSString *_preferredTitle;
}

+ (void)initialize;
+ (id)controllerWithDelegate:(id)arg1 preferredCountries:(id)arg2 countries:(id)arg3 showOther:(_Bool)arg4;
- (void).cxx_destruct;
@property(nonatomic) _Bool hidesPhoneNumberPrefixes; // @synthesize hidesPhoneNumberPrefixes=_hidesPhoneNumberPrefixes;
...
- (void)performSearchByCountryCode:(id)arg1;
- (void)performSearchByCountryName:(id)arg1;
...
@property(nonatomic) _Bool otherSelected;
@property(retain, nonatomic) WACountryInfo *selectedCountry;
- (void)wa_fontSizeDidChange;
- (id)findSelectedCellModelIndexPath;
- (void)viewWillAppear:(_Bool)arg1;
- (void)viewDidLoad;
- (id)initWithStyle:(long long)arg1 preferredCountries:(id)arg2 countries:(id)arg3 showOther:(_Bool)arg4;
