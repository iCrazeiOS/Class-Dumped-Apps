...
@protocol WAXOutgoingStanzaElementCommonPaymentDeleteAccountRequest_Account;

@protocol WAXOutgoingStanzaCommonPaymentDeleteAccountRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementCommonPaymentDeleteAccountRequest_Account> account;
