...
@protocol WAXOutgoingStanzaElementNoviPaymentCreateAccountRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentCreateAccountRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentCreateAccountRequest_Account> account;
