...
@protocol WAXOutgoingStanzaElementNoviPaymentSubmitOnboardingDetailsRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentSubmitOnboardingDetailsRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentSubmitOnboardingDetailsRequest_Account> account;
