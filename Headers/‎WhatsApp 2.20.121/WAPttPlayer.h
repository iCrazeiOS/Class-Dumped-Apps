...
#import <Core/WAAudioPlayerInterfaceDelegate-Protocol.h>

@class NSDictionary, NSString, NSTimer, WAAudioActivity, WAAudioPlayerInterface, WAReferenceCountToken;
@protocol WAPttPlayerDelegate;

@interface WAPttPlayer : NSObject <WAAudioPlayerInterfaceDelegate>
{
    WAAudioPlayerInterface *_pttAudioPlayer;
...
- (void)audioPlayerInterfaceDidFinishPlaying;
- (void)audioPlayerInterfaceDidFailWithError:(id)arg1;
- (void)audioPlayerInterfaceIsReadyToPlay;
...
- (void)finish;
- (void)pause;
- (unsigned long long)continuePlayAndLogAfterPlayerIsReady;
- (unsigned long long)playAndLog;
- (void)finishLoggingWithResult:(unsigned long long)arg1;
- (long long)play;
