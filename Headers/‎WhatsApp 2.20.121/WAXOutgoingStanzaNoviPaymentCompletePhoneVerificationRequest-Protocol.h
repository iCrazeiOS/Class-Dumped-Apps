...
@protocol WAXOutgoingStanzaElementNoviPaymentCompletePhoneVerificationRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentCompletePhoneVerificationRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentCompletePhoneVerificationRequest_Account> account;
