...
- (id)initWithDisplayEngine:(id)arg1 clock:(id)arg2 config:(CDStruct_f37e1f32)arg3 asyncTimebase:(_Bool)arg4 enableOpus:(_Bool)arg5;
- (id)initWithDisplayEngine:(id)arg1 config:(CDStruct_f37e1f32)arg2 asyncTimebase:(_Bool)arg3 enableOpus:(_Bool)arg4;
