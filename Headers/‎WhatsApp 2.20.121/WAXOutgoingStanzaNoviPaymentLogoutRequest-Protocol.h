...
@protocol WAXOutgoingStanzaElementNoviPaymentLogoutRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentLogoutRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentLogoutRequest_Account> account;
