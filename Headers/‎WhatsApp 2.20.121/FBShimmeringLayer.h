...
#import <Payments/CAAnimationDelegate-Protocol.h>
#import <Payments/CALayerDelegate-Protocol.h>
#import <Payments/FBShimmering-Protocol.h>
...
- (void)fb_updateShimmering;
- (void)fb_updateMaskLayout;
- (void)fb_updateMaskColors;
- (void)fb_createMaskIfNeeded;
- (void)fb_clearMask;
