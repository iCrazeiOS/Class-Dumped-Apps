...
@protocol WAXOutgoingStanzaElementNoviPaymentRegisterAppInstallationRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentRegisterAppInstallationRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentRegisterAppInstallationRequest_Account> account;
