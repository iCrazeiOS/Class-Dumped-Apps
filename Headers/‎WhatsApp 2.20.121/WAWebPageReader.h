...
#import <Core/WAWebPageMetadataLoadable-Protocol.h>
...
@interface WAWebPageReader : NSObject <WAWebPageMetadataLoadable, NSURLSessionDataDelegate>
{
...
+ (id)processedImageURLForTwitterIfNeeded:(id)arg1;
