...
+ (id)keyCode;
+ (id)saltWithAppId:(id)arg1 mobile:(id)arg2 deviceId:(id)arg3 transactionId:(id)arg4 amountString:(id)arg5 payer:(id)arg6 payee:(id)arg7;
+ (id)hmacForAppId:(id)arg1 mobile:(id)arg2 deviceId:(id)arg3 token:(id)arg4 transactionId:(id)arg5 amountString:(id)arg6 payer:(id)arg7 payee:(id)arg8;
