...
@protocol WAXOutgoingStanzaElementNoviPaymentGetOnboardingConfigRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentGetOnboardingConfigRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentGetOnboardingConfigRequest_Account> account;
