...
@protocol WAXOutgoingStanzaElementCommonPaymentPIDSetupRequest_Account;

@protocol WAXOutgoingStanzaCommonPaymentPIDSetupRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementCommonPaymentPIDSetupRequest_Account> account;
