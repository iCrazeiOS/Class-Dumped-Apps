...
@protocol WAXOutgoingStanzaElementMfaPaymentVerifyFactorRequest_Account;

@protocol WAXOutgoingStanzaMfaPaymentVerifyFactorRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementMfaPaymentVerifyFactorRequest_Account> account;
