...
@class NSURL, UIImageView, WAContact, WAMessage, WAMessageAttributedTextSliceLink, WAMessageContainerSliceView, WAProductDescriptor;
...
- (void)messageContainerSliceViewDidRequestReceiverRetryPayment:(WAMessageContainerSliceView *)arg1;
