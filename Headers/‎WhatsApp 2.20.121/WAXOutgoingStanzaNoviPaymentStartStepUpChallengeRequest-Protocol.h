...
@protocol WAXOutgoingStanzaElementNoviPaymentStartStepUpChallengeRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentStartStepUpChallengeRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentStartStepUpChallengeRequest_Account> account;
