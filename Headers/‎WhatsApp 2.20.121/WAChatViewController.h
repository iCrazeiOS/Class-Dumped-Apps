...
@class NSArray, NSMutableArray, NSMutableSet, NSNumber, NSString, NSUserActivity, UIButton, UIGestureRecognizer, UIImageView, UIImpactFeedbackGenerator, UIResponder, UITapGestureRecognizer, UIView, WABlocklistAlertManager, WAChatBar, WAChatBarCameraPlugin, WAChatBarHelper, WAChatBarShareContactPlugin, WAChatBarShareLocationPlugin, WAChatSearchBar, WAChatSession, WAChatSessionNotificationView, WAConversationHeaderView, WAMentionsSelectorView, WAMessage, WAMessageBubbleTableViewCell, WAMessageSearchPreparingTextController, WAName, WAPlaceholderViewEventLogger, WAProductCatalogForwardActivity, WAProgressAlertController, WAPttComponent, WAScrollToBottomButton, WAScrollToNextCatchUpButton, WASearchResultsController, WAUserJID, WAViewControllerConnectionObserver;
...
- (void).cxx_destruct;
@property(nonatomic, getter=isShowingEphemeralNUX) _Bool showingEphemeralNUX; // @synthesize showingEphemeralNUX=_showingEphemeralNUX;
...
- (void)openEphemeralSettingInContactInfoForUserJID:(id)arg1;
...
- (void)presentDeviceChangeAlert:(id)arg1;
- (id)formattedStringForDeviceChangeAlertComplex:(id)arg1;
- (id)formattedStringForDeviceChangeAlertRemove:(id)arg1;
- (id)formattedStringForDeviceChangeAlertAdd:(id)arg1;
...
- (void)newAnimationBehavior_startAnimationOnAllVisibleStickersIfNeeded_previewAnimation:(_Bool)arg1 animateIndefinitely:(_Bool)arg2;
...
- (void)actionBlockContactWithJID:(id)arg1;
