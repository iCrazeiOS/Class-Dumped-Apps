...
@protocol WAXOutgoingStanzaElementNoviPaymentSaveNameRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentSaveNameRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentSaveNameRequest_Account> account;
