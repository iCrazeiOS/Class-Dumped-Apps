...
@protocol WAXOutgoingStanzaElementEsPaymentSendEmailOTPRequest_Account;

@protocol WAXOutgoingStanzaEsPaymentSendEmailOTPRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementEsPaymentSendEmailOTPRequest_Account> account;
