...
@protocol WAXOutgoingStanzaElementNoviPaymentStartPhoneVerificationRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentStartPhoneVerificationRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentStartPhoneVerificationRequest_Account> account;
