...
@protocol WAXOutgoingStanzaElementEsPaymentCollectEmailRequest_Account;

@protocol WAXOutgoingStanzaEsPaymentCollectEmailRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementEsPaymentCollectEmailRequest_Account> account;
