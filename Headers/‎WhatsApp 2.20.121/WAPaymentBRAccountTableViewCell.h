...
@interface WAPaymentBRAccountTableViewCell : WAPaymentAccountTableViewCell
{
}
...
- (id)initWithBRAccount:(id)arg1 headerText:(id)arg2 subtitleOverride:(id)arg3 subtitleCustomCopySelector:(SEL)arg4 reusableIdentifier:(id)arg5;
