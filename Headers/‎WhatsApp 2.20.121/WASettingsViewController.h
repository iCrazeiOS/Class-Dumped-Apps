...
@interface WASettingsViewController : WAStaticTableViewController <UINavigationControllerDelegate, WAContactQRCodeScannerViewControllerDelegate, WAContactDetailsViewControllerDelegate, WANewContactViewControllerDelegate, WAMediaPickerControllerDelegate, WAContactQRPhotoPreviewViewControllerDelegate, WAContactQRViewControllerDelegate>
{
