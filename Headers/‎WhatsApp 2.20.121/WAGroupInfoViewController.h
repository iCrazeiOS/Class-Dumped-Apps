...
@class NSArray, NSMutableArray, NSMutableSet, NSString, UIBarButtonItem, WABlocklistAlertManager, WAChatMediaManager, WAGroupCreationFooterView, WAGroupJID, WAGroupParticipantsController, WALabelAndButtonHeaderView, WAMutableDictionary, WATableRow, WATableSection, WAUserJID;
...
- (id)contactTableViewCellWithName:(id)arg1 indexPath:(id)arg2 cellIdentifier:(id)arg3 participantCellState:(int)arg4;
...
- (void)showRevokeAlertViewForName:(id)arg1;
...
- (void)showRequestEphemeralityInternalOnlyWarning;
- (void)presentEphemeralitySettingIfNeeded;
- (void)updateGroupEphemeralitySettingCell;
- (void)showErrorMessageForAdminSettingsChangeError:(id)arg1 connectionErrorMessage:(id)arg2;
- (void)requestGroupEphemeralitySettingChange:(id)arg1;
