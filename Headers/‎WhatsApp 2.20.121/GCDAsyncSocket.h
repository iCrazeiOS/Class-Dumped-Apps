...
- (id)init;
- (_Bool)connectToEndpoint:(id)arg1 interface:(id)arg2 timeout:(double)arg3 error:(id *)arg4;
- (void)wa_didNotConnect:(int)arg1 message:(const char *)arg2 reason:(const char *)arg3;
