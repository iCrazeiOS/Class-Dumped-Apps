...
- (void)cacheImage:(id)arg1 forStickerWithFileHash:(id)arg2 isPreview:(_Bool)arg3;
- (id)cachedAnimatedImageForStickerFileHash:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (id)cachedStaticImageForStickerFileHash:(id)arg1 isPreview:(_Bool)arg2;
- (_Bool)cacheHasAnimatedImageForStickerFileHash:(id)arg1;
- (_Bool)cacheHasStaticImageForStickerFileHash:(id)arg1 isPreview:(_Bool)arg2;
- (void)inMemoryCacheImage:(id)arg1 forSticker:(id)arg2 imageType:(long long)arg3 isPreview:(_Bool)arg4;
- (id)inMemoryCachedImageForSticker:(id)arg1 isPreview:(_Bool)arg2;
...
- (void)fetchPreviewImageForSticker:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)imageForAbsoluteFilePath:(id)arg1 callbackQueue:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (id)initWithStickerStorage:(id)arg1 keyValueStore:(id)arg2 mmsTaskSession:(id)arg3 storageDirectory:(id)arg4 pinnedCertificate:(id)arg5 userSessionPreferences:(id)arg6 pngImageCache:(id)arg7 networkUsageManager:(id)arg8 networkUsageMetricsManager:(id)arg9;
