...
@class NSArray, NSString, UITableView, WAActivityIndicatorView, WAActivityLabel, WAViewControllerConnectionObserver, _TtC8Payments16WAPaymentManager;
@protocol WAPaymentBankListItem;

@interface WAPaymentBanksViewController : WAViewController <WASearchControllerDelegate, UITableViewDelegate, UITableViewDataSource, WAPaymentFlowViewControllerType>
{
