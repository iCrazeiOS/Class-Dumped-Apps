...
@protocol WAXOutgoingStanzaElementMfaPaymentResetPINRequest_Account;

@protocol WAXOutgoingStanzaMfaPaymentResetPINRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementMfaPaymentResetPINRequest_Account> account;
