...
- (void)processIncomingLocationNotification:(id)arg1;
- (void)handleUserDisabledLocationSharingNotification:(id)arg1 notification:(id)arg2;
...
- (void)handleFinalLocationUpdateOrRetryResponse:(id)arg1 notification:(id)arg2;
- (void)handleFinalLocationUpdate:(id)arg1 notification:(id)arg2;
- (_Bool)finalLocationUpdateOrRetryResponseIsRetryResponse:(id)arg1;
- (void)handleFinalLocationRetryResponse:(id)arg1 notification:(id)arg2;
- (_Bool)shouldRequestRetryOfKeyDistributionMessageWithDecryptionError:(id)arg1;
- (void)handleKeyDistributionMessage:(id)arg1 notification:(id)arg2;
- (void)handleRetryDeny:(id)arg1 incomingNotification:(id)arg2;
...
- (void)handleIncomingRetryRequestFrom:(id)arg1 count:(long long)arg2 registrationData:(id)arg3 final:(_Bool)arg4 finalMessageID:(id)arg5 context:(id)arg6 notification:(id)arg7;
