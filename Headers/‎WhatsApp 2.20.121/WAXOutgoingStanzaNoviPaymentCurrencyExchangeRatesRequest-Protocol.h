...
@protocol WAXOutgoingStanzaElementNoviPaymentCurrencyExchangeRatesRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentCurrencyExchangeRatesRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentCurrencyExchangeRatesRequest_Account> account;
