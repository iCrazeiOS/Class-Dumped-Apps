...
@protocol WAXOutgoingStanzaElementMfaPaymentGetTrustedServerKeyRequest_Account;

@protocol WAXOutgoingStanzaMfaPaymentGetTrustedServerKeyRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementMfaPaymentGetTrustedServerKeyRequest_Account> account;
