...
@protocol WAXOutgoingStanzaElementNoviPaymentResetPasswordRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentResetPasswordRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentResetPasswordRequest_Account> account;
