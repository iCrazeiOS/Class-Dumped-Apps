...
@class NSLayoutConstraint, NSNumberFormatter, NSString, UIBarButtonItem, UIButton, UIImage, UIImageView, WACaptionBar, WAMentionsSelectorView, WAPaymentAmountTextView, WAPaymentConfiguration, WAPaymentSendInfoView, _TtC8Payments16WAPaymentManager;
