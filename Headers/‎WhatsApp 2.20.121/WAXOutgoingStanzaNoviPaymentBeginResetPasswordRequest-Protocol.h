...
@protocol WAXOutgoingStanzaElementNoviPaymentBeginResetPasswordRequest_Account;

@protocol WAXOutgoingStanzaNoviPaymentBeginResetPasswordRequest <NSObject, WAXOutgoingStanza>
@property(nonatomic, readonly) id <WAXOutgoingStanzaElementNoviPaymentBeginResetPasswordRequest_Account> account;
