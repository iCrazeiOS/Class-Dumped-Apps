...
#import <FBSharedFramework/RCTModalHostViewInteractor-Protocol.h>
...
@interface RCTModalHostViewManager : RCTViewManager <RCTModalHostViewInteractor, RCTInvalidating>
{
    ...
    CDUnknownBlockType _dismissWaitingBlock;
}
...
+ (id)moduleName;
- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType dismissWaitingBlock; // @synthesize dismissWaitingBlock=_dismissWaitingBlock;
