...
@class IGFeedKeepWatchingOverlayButtonStyle, IGFeedVideoPreviewOverlayView;
@protocol IGVideoPlayerPreviewOverlayDelegate;

@interface IGVideoPlayerPreviewOverlay : IGVideoPlayerOverlay
{
    IGFeedKeepWatchingOverlayButtonStyle *_overlayStyle;
