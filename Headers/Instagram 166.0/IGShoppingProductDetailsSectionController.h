...
@class IGDirectShareSheetToastHelper, IGSessionTracker, IGShoppingConsumptionFeedItemLogger, IGShoppingProductDetailsViewModel, IGUserSession, NSString;
...
- (void)_handleTapOnViewAdditionalDiscounts;
...
- (void)shoppingProductDetailsViewDidTapMoreButton:(id)arg1;
