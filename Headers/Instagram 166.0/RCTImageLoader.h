...
#import <InstagramAppCoreFramework/NativeImageLoaderIOSSpec-Protocol.h>
...
#import <InstagramAppCoreFramework/RCTImageLoaderWithAttributionProtocol-Protocol.h>

@class NSArray, NSMutableArray, NSOperationQueue, NSString, RCTBridge;
@protocol OS_dispatch_queue, RCTImageCache, RCTImageRedirectProtocol, RCTTurboModuleRegistry;
...
+ (const struct RCTMethodInfo *)__rct_export__12143;
+ (const struct RCTMethodInfo *)__rct_export__11982;
+ (const struct RCTMethodInfo *)__rct_export__11791;
+ (const struct RCTMethodInfo *)__rct_export__11600;
