...
@class IGDirectCameraCreationViewMode, IGDirectThreadService, IGMedia, IGMediaMetadata, IGStoryAnalyticsUploadWaterfall, IGUserSession, IGViewController, NSArray, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSOrderedSet, NSSet, NSString;
@protocol IGDirectRecipientListViewControllerType, IGStoryRecipientListControllerDelegate;

@interface IGStoryRecipientListController : NSObject <IGDirectRecipientListViewControllerDelegate, IGAddHighlightsViewControllerDelegate, IGDirectRecipientListViewControllerPresentationDelegate, IGStorySharePostListener>
{
...
- (void)_shareToStoryTarget:(long long)arg1 directRecipients:(id)arg2 externalServices:(id)arg3 invitesStickerModel:(id)arg4 uploadModels:(id)arg5 metadata:(id)arg6 uploadWaterfall:(id)arg7 userSession:(id)arg8 replyType:(long long)arg9 isSubsequentConfiguration:(_Bool)arg10 isMultiConfiguration:(_Bool)arg11 blocklistedUserIDs:(id)arg12;
