...
#import <InstagramAppCoreFramework/IABAutofillControllerDelegate-Protocol.h>
#import <InstagramAppCoreFramework/IGBrowserSettingsViewControllerDelegate-Protocol.h>
#import <InstagramAppCoreFramework/IGIABAutofillControllerDelegate-Protocol.h>
...
@class FBBrowserIntegrityLoggingController, FBPassLoader, FBTimer, IABLoggingCoordinator, IGIABAutofillController, IGInstantExperienceBrowserSetupManager, IGNavigationController, IGRefreshControl, IGUserSession, IGWebViewErrorPage, NSDate, NSNumber, NSString, NSURL, NSURLRequest, UILongPressGestureRecognizer, UIScrollView, UIView;
@protocol FBScriptMessageHandling, FBWebView, IABPCMControllerConforming, IGWebViewControllerChromeDelegate, IGWebViewControllerDelegate, IGWebViewControllerScrollDelegate;

@interface IGWebViewController : IGViewController <FBPassLoaderDelegate, FBWebViewDelegate, IGWebViewErrorPageDelegate, UIGestureRecognizerDelegate, UIScrollViewDelegate, IGRefreshControlContentInsetDataSource, IGIABAutofillControllerDelegate, IABAutofillControllerDelegate, IGBrowserSettingsViewControllerDelegate>
{
...
- (void)_logTTIMetricIfNeededWithDetectionMethod:(long long)arg1;
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithUserSession:(id)arg1 browserSessionID:(id)arg2 browserHistoryItemId:(id)arg3 analyticsModule:(id)arg4 options:(unsigned long long)arg5 loggingCoordinator:(id)arg6 scriptMessageHandler:(id)arg7 browserIntegrityController:(id)arg8 redirectURL:(id)arg9;
