...
@class IGLiveFundraiserViewV2, IGLiveShoppingPinnedProductViewV2, IGLiveTappablePinnedViewModel, IGLiveUserPayPinnedInfoViewV2, NSString, UIButton, UIView;
...
@interface IGLiveTappablePinnedViewControllerV2 : UIViewController <IGLiveTappablePinnedViewDelegate>
{
    ...
    IGLiveShoppingPinnedProductViewV2 *_shoppingView;
    UIView *_pinnedView;
