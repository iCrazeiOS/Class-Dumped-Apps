...
#import <InstagramAppCoreFramework/IGCameraNavigationControllerDelegate-Protocol.h>
...
@class IGCameraAspectRatioOverlayView, IGCameraLoggingContext, IGCameraNavigationController, IGCameraViewController, IGCameraZoomController, IGStoryCameraOverlayViewController, IGStoryDrawerViewController, IGStoryExtendedGalleryViewController, IGUserSession, NSString;
@protocol IGStoryFormatViewControllerProtocolDelegate;

@interface IGStoryFeedFormatViewController : UIViewController <IGStoryCameraOverlayViewControllerDelegate, IGCameraViewControllerDelegate, IGCameraZoomControllerDelegate, IGQuickCamCaptureButtonDelegate, IGFeedCreationFlowDelegate, UIGestureRecognizerDelegate, IGCameraNavigationControllerDelegate, IGStoryFormatViewControllerProtocol>
{
...
- (void)_presentFeedGalleryViewControllerWithPanGesture:(id)arg1;
...
- (void)_presentFeedGalleryAfterUserStoppedScrollingModeSwitcher;
