...
@class IGImageEncoding, IGPostPendingShareMetadata, IGPostSessionInternal, NSDictionary, NSError, NSString, NSURL;
@protocol IGPostDataProvider, IGUserExperimentSetProviding;
...
- (id)initWithShareId:(id)arg1 postSession:(id)arg2 postDataProvider:(id)arg3 experimentSetProvider:(id)arg4;
