...
@class IGMainFeedNetworkSourceController, IGNavigationController, IGShoppingDestinationPrefetchController, IGUserSession, IGViewController;
...
@interface IGTabBarViewControllerManager : NSObject
{
    ...
    IGShoppingDestinationPrefetchController *_prefetchController;
...
- (void)destroyCurrentDiscoverVideoNavigationController;
