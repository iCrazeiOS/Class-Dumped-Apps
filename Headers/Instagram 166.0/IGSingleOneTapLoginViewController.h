...
@class IGAuthenticator, IGFacebookAuthHelper, IGFacebookInfoFetcher, IGOneTapLoginManager, IGOneTapSingleAccountLoginView, IGRegistrationLogger, NSString;
...
@interface IGSingleOneTapLoginViewController : UIViewController <IGFacebookAuthHelperDelegate, IGOneTapLoginManagerDelegate, IGOneTapSingleAccountLoginViewDelegate, IGPasswordLoginViewControllerDelegate, IGRegistrationLoginResponseHandlerDelegate, IGAnalyticsModule, IGOneTapLoginViewControllerProtocol>
{
    ...
    _Bool _isCloudAYMHExperimentEnabled;
...
- (void)viewDidLoad;
- (id)initWithNetworker:(id)arg1 account:(id)arg2 authenticator:(id)arg3 accountStoreCoordinator:(id)arg4 isSwitchingUsers:(_Bool)arg5 fbAuthHelper:(id)arg6 fbInfoFetcher:(id)arg7 persistentAccountStore:(id)arg8 cloudPersistentAccountStore:(id)arg9 logger:(id)arg10;
