...
@class CAShapeLayer, IABLoggingCoordinator, IGBrowserChromeCoordinator, IGBrowserInteractiveLayoutConfiguration, IGBrowserTitleBar, IGWebViewController, IGWebViewToolbar, NSArray, NSString, UIView;
...
- (void)viewDidLoad;
- (id)initWithWebViewController:(id)arg1 leftTitleBarButtonTypes:(id)arg2 rightTitleBarButtonType:(unsigned long long)arg3 loggingCoordinator:(id)arg4;
