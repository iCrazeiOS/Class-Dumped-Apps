...
#import <InstagramAppCoreFramework/IGDirectMessageBlurable-Protocol.h>
...
@class IGDirectMessageBlurredImageViewModel, IGDirectMessageCellViewModel, IGDirectPostMessageBubbleViewModel, IGDirectReshareDiffIdentifier, IGDirectTextMessageBubbleViewModel, IGDirectUIMessageMetadata, IGMedia, NSString, NSURL;
@protocol IGSponsoredInfoProviding;

@interface IGDirectPostMessageViewModel : NSObject <IGDirectMessageBlurable, IGDirectMessageViewModelProtocol, IGDirectReshareMessageHeaderViewModel, IGListDiffable>
{
