...
+ (void)_logAlertViewButtonShownForActionTypes:(id)arg1;
...
+ (_Bool)presentAlertViewForError:(id)arg1 response:(id)arg2 attributedDescriptionText:(id)arg3 footerText:(id)arg4 delegate:(id)arg5 callbackResolver:(CDUnknownBlockType)arg6 isIGDS:(_Bool)arg7;
