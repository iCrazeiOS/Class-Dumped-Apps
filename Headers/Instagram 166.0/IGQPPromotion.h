...
- (_Bool)isValid;
- (id)initWithPromotionID:(id)arg1 qpCreative:(id)arg2 maxImpressions:(long long)arg3 priority:(long long)arg4 startTime:(id)arg5 endTime:(id)arg6 qpTemplate:(id)arg7 triggers:(id)arg8 isExposureHoldout:(_Bool)arg9 loggingData:(id)arg10 contextualFilters:(id)arg11;
