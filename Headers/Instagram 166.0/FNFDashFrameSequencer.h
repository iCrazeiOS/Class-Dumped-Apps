...
@class FNFDashJumpDetector, FNFDashPlaylist, FNFDashReplayRecord, FNFDashUnstallThresholder, FNFDashVideoPlayerMetadata, NSMutableArray, NSMutableDictionary, NSString;
...
@interface FNFDashFrameSequencer : NSObject <FNFDashReplayRecording, FNFDashFrameSequencing, FNFDashChunkManagerDelegate>
{
