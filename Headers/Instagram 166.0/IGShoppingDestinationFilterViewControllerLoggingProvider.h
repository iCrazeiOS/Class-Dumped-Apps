...
#import <InstagramAppCoreFramework/IGResultsFilterViewControllerLoggingProviderType-Protocol.h>

@class IGUserSession, NSDictionary, NSString;

@interface IGShoppingDestinationFilterViewControllerLoggingProvider : NSObject <IGResultsFilterViewControllerLoggingProviderType>
{
