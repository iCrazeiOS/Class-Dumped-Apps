...
- (void)layoutSubviews;
- (void)hideCameraRoll;
- (id)initWithBugReportType:(long long)arg1 withDelegate:(id)arg2 displayUpdateButton:(_Bool)arg3 displayCameraRoll:(_Bool)arg4 experimentSetProvider:(id)arg5;
