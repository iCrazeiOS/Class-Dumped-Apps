...
- (void)finallyFetchedBroadcastID:(NSString *)arg1 withWebRTCSessionConfig:(CDStruct_b14ccfc0)arg2 rtmpConfig:(CDStruct_6c65f63b)arg3 rtmpMessageChannel:(id <FBVideoBroadcastOutOfBandMessageChannel>)arg4;
- (void)startOffline;
