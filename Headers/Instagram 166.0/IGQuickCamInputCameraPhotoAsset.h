...
#import <FBSharedFramework/IGQuickCamImageType-Protocol.h>
...
- (void)adjustImageToSize:(struct CGSize)arg1;
- (id)initWithImage:(id)arg1 devicePosition:(long long)arg2 flashMode:(long long)arg3 metadata:(id)arg4;
- (id)initWithImage:(id)arg1 devicePosition:(long long)arg2 deviceType:(id)arg3 deviceID:(id)arg4 flashMode:(long long)arg5 metadata:(id)arg6;
