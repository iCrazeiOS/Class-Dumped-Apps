...
- (void)configureWithPostItem:(id)arg1 coverImageURL:(id)arg2 videoLogger:(id)arg3 videoLoggingConfig:(id)arg4 indicatorConfiguration:(id)arg5 userSession:(id)arg6 options:(CDStruct_3e79a85c)arg7 module:(id)arg8;
