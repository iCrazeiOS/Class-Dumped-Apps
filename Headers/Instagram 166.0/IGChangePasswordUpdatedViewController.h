...
#import <InstagramAppCoreFramework/IGChangePasswordViewDelegate-Protocol.h>

@class IGChangePasswordView, IGUserSession, NSString, UIBarButtonItem;
...
- (void).cxx_destruct;
- (void)showFailedSubmissionDropdownErrorWithMessage:(id)arg1;
