...
@interface IGShoppingProductGridPlaceholderCell : UICollectionViewCell <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
{
...
- (void).cxx_destruct;
- (long long)_numberOfItemsForCollectionView:(id)arg1;
- (struct CGSize)_sizeOfItemForCollectionView:(id)arg1;
