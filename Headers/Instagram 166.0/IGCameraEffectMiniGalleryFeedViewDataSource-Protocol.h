...
@class IGCameraEffectMiniGalleryFeedView, IGImageSpecifier;
...
- (IGImageSpecifier *)miniGalleryFeedView:(IGCameraEffectMiniGalleryFeedView *)arg1 imageSpecifierForItemAtIndex:(long long)arg2;
