...
+ (id)jsBundleURLForBundleRoot:(id)arg1 packagerHost:(id)arg2 enableDev:(_Bool)arg3 enableMinification:(_Bool)arg4 modulesOnly:(_Bool)arg5 runModule:(_Bool)arg6;
