...
- (id)initWithURL:(id)arg1 config:(CDStruct_ffd1a133)arg2 dispatchQueue:(id)arg3 isAsync:(_Bool)arg4;
...
- (id)initWithURL:(id)arg1 config:(CDStruct_ffd1a133)arg2;
- (id)initWithURL:(id)arg1 config:(CDStruct_ffd1a133)arg2 eventListener:(id)arg3;
