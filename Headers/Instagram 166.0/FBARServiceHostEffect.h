...
+ (id)newWithServiceHostConfiguration:(id)arg1 assetsPath:(id)arg2 assetLoader:(shared_ptr_9ee3ad0a)arg3 manifest:(shared_ptr_8f3f58d1)arg4 SDKVersion:(shared_ptr_602211e3)arg5 analyticsInfo:(id)arg6 effectAttribution:(shared_ptr_f86b0e66)arg7 analyticsLogger:(id)arg8;
- (id).cxx_construct;
- (void).cxx_destruct;
...
- (void)dealloc;
- (id)initWithServiceHostConfiguration:(id)arg1 assetsPath:(id)arg2 assetLoader:(shared_ptr_9ee3ad0a)arg3 manifest:(shared_ptr_8f3f58d1)arg4 SDKVersion:(shared_ptr_602211e3)arg5 analyticsInfo:(id)arg6 effectAttribution:(shared_ptr_f86b0e66)arg7 analyticsLogger:(id)arg8;
