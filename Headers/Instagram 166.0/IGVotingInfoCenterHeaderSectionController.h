...
@class IGVotingInfoCenterHeaderCell, NSString;

@interface IGVotingInfoCenterHeaderSectionController : IGListGenericSectionController <IGListDisplayDelegate>
{
    IGVotingInfoCenterHeaderCell *_cell;
}
