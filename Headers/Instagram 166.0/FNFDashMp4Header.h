...
@interface FNFDashMp4Header : NSObject <FNFDashHeading>
{
    ...
    vector_7984f87c _editListPreProcessedSegmentDuration;
}
...
@property(readonly, nonatomic) vector_7984f87c editListPreProcessedSegmentDuration; // @synthesize editListPreProcessedSegmentDuration=_editListPreProcessedSegmentDuration;
...
- (id)description;
- (void)dealloc;
- (id)initWithEncodedInitSegment:(id)arg1 track:(long long)arg2 enableDashMp4RotationSupport:(_Bool)arg3;
