...
@class IGCoWatchPhotoViewModel, IGUser, NSArray, NSString;

@interface IGCoWatchMediaSyncPhotoItem : NSObject <IGCoWatchableMedia>
{
...
- (void).cxx_destruct;
@property(readonly, nonatomic) IGCoWatchPhotoViewModel *photoViewModel; // @synthesize photoViewModel=_photoViewModel;
