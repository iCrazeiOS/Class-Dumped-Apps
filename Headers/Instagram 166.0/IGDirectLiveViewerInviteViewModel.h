...
@class IGDirectArchivedStoryViewModel, IGDirectLiveVideoDiffIdentifier, IGDirectMessageCellViewModel, IGDirectTextMessageBubbleViewModel, IGDirectUIMessageMetadata, IGStyledString, IGUser, NSAttributedString, NSString, NSURL;
