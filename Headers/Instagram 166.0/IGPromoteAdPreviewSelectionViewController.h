...
@class IGBoostPostLogger, IGListAdapter, IGPromoteDataStore, IGPromoteHeaderViewModel, IGTextViewItemViewModel, IGUserSession, NSArray, NSString, UICollectionView;

@interface IGPromoteAdPreviewSelectionViewController : IGPromoteViewController <IGListAdapterDataSource, UICollectionViewDelegate, IGPromoteAdPreviewSelectionChevronViewListSectionControllerDelegate, IGTextViewSectionControllerDelegate>
{
