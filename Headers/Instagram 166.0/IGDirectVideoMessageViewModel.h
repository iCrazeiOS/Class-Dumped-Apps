...
- (id)initWithVideo:(id)arg1 photo:(id)arg2 previewImageSize:(struct CGSize)arg3 messageMetadata:(id)arg4 messageCellViewModel:(id)arg5 imageURL:(id)arg6 cacheKey:(id)arg7 isInteropThread:(_Bool)arg8 supportsAggregatedMediaViewer:(_Bool)arg9 shouldBlurMedia:(_Bool)arg10;
