...
- (id)initWithBroadcastRecipients:(id)arg1 folder:(id)arg2 isBroadcast:(_Bool)arg3 message:(id)arg4 offlineThreadingId:(long long)arg5 tags:(id)arg6 tid:(long long)arg7 to:(id)arg8 useExistingGroup:(_Bool)arg9 viewed:(_Bool)arg10 associatedObjectId:(long long)arg11 storyId:(id)arg12 extra:(id)arg13;
- (id)init;
