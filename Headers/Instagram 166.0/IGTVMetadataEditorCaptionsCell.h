...
@class IGTVCreationFlowToggle, IGTVMetadataEditorSectionHeaderView;
@protocol IGTVMetadataEditorCaptionsCellDelegate;

@interface IGTVMetadataEditorCaptionsCell : UICollectionViewCell
{
    IGTVMetadataEditorSectionHeaderView *_sectionHeaderView;
    IGTVCreationFlowToggle *_captionToggle;
