...
- (void)viewDidLoad;
- (id)initWithUserSession:(id)arg1 coverPhotoSelection:(id)arg2 creationAnalytics:(id)arg3 broadcastDuration:(long long)arg4 broadcastTitle:(id)arg5 internalRowState:(long long)arg6 shoppingEnabled:(_Bool)arg7 archivedMediaId:(id)arg8;
