...
#import <InstagramAppCoreFramework/IGFBFilterTrayManagerViewControllerDelegate-Protocol.h>
...
@class IGIGLContext, IGUserSession, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UICollectionView;
@protocol IGFBFilterCollectionControllerDelegate;

@interface IGFBFilterCollectionController : NSObject <LXReorderableCollectionViewDataSource, LXReorderableCollectionViewDelegateFlowLayout, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, IGFBFilterTrayManagerViewControllerDelegate>
{
...
- (_Bool)isVisibleFilterIdentifier:(id)arg1;
- (void)setFilterIdentifier:(id)arg1 isVisible:(_Bool)arg2;
...
@property(readonly, nonatomic) NSArray *filterIdentifiersInTray;
