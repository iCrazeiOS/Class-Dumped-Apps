...
@protocol IGPostAnalyticsProvider, IGUserFeatureSets;
...
- (id)initWithAnalyticsProvider:(id)arg1 userSession:(id)arg2 featureSets:(id)arg3 uploadID:(id)arg4 fbFlowLogger:(id)arg5 fbUploadLogger:(id)arg6 extras:(id)arg7;
