...
@class IGFeedItemMediaCollectionCellController, IGMedia, UICollectionViewCell;
@protocol IGFeedVideoCell;

@protocol IGFeedItemMediaCollectionCellControllerDelegate <NSObject>
- (void)mediaCollectionCellController:(IGFeedItemMediaCollectionCellController *)arg1 didTapSaveToCollections:(IGMedia *)arg2;
