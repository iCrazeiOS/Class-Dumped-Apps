...
@class IGCTABottomPresentationController, IGCTAPresenterContext, IGFeedNetworkSource, IGFeedScrollViewAnnouncer, IGFeedStatusView, IGFollowListLogger, IGListAdapter, IGMedia, IGRefreshControl, IGSearchBar, IGSearchBarConfig, IGStoryViewerPresentationController, IGUserListNetworkDataSource, IGUserSession, IGVideoViewCountListAdapterDataSource, NSString, UIBarButtonItem, UICollectionView;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool shouldDisplayPlayCount; // @synthesize shouldDisplayPlayCount=_shouldDisplayPlayCount;
...
- (void)viewDidLoad;
- (id)initWithContextPK:(id)arg1 shouldShowSearch:(_Bool)arg2 canPullToRefresh:(_Bool)arg3 playCountInDevelopment:(_Bool)arg4 userSession:(id)arg5 ctaPresenterContext:(id)arg6;
