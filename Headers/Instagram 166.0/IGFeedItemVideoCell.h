...
#import <FBSharedFramework/IGFeedItemVideoViewDelegate-Protocol.h>
#import <FBSharedFramework/IGFeedItemVideoViewDoubleTapDelegate-Protocol.h>
#import <FBSharedFramework/IGFeedItemVideoViewSingleTapDelegate-Protocol.h>
#import <FBSharedFramework/IGFeedMediaViewDelegate-Protocol.h>
#import <FBSharedFramework/IGFeedVideoCell-Protocol.h>
#import <FBSharedFramework/IGRenderingLoggingProviding-Protocol.h>
#import <FBSharedFramework/IGSaveToCollectionsUpsellable-Protocol.h>

@class IGFeedItemVideoView, IGMedia, IGZoomController, NSString, UILongPressGestureRecognizer;
...
@interface IGFeedItemVideoCell : IGFeedItemMediaCell <IGFeedVideoCell, IGFeedItemVideoViewDelegate, IGFeedItemVideoViewDoubleTapDelegate, IGFeedItemVideoViewSingleTapDelegate, IGFeedMediaViewDelegate, IGSaveToCollectionsUpsellable, IGRenderingLoggingProviding>
{
...
- (void)configureWithVideo:(id)arg1 coverPhoto:(id)arg2 media:(id)arg3 isSponsoredPost:(_Bool)arg4 logger:(id)arg5 loggingConfig:(id)arg6 indicatorConfiguration:(id)arg7 userSession:(id)arg8 options:(CDStruct_3e79a85c)arg9 feedTheme:(id)arg10;
