...
@class IGMedia, IGSessionTracker, IGShoppingCartLogger, IGShoppingNavigationAnalyticsContext, IGUserSession, NSString, UIViewController;
@protocol IGTVShoppingContentViewAdapterDelegate;

@interface IGTVShoppingContentViewAdapter : NSObject <IGSaveStatusListener, IGShoppingGenericProductWithContextCardSectionControllerDelegate, IGShoppingProductWithContextCardSectionControllerTapDelegate>
{
    IGMedia *_media;
    ...
    id <IGTVShoppingContentViewAdapterDelegate> _delegate;
}

- (void).cxx_destruct;
@property(nonatomic) __weak id <IGTVShoppingContentViewAdapterDelegate> delegate; // @synthesize delegate=_delegate;
...
- (id)initWithMedia:(id)arg1 userSession:(id)arg2 viewController:(id)arg3 analyticsContext:(id)arg4 shoppingSessionTracker:(id)arg5 gridLayoutConfiguration:(struct IGGridLayoutConfiguration)arg6;
