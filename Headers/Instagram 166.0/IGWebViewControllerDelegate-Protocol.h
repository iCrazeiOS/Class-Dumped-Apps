...
- (void)webViewControllerTtiDetected:(IGWebViewController *)arg1;
...
- (void)webViewController:(IGWebViewController *)arg1 didCommitNavigationRequestWithWebview:(UIView<FBWebView> *)arg2;
