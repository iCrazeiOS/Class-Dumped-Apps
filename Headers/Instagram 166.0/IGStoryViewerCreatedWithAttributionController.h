...
@interface IGStoryViewerCreatedWithAttributionController : NSObject <IGStoryViewerHeaderAttributionType>
{
    NSArray *_attributionControllers;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) NSArray *attributionControllers; // @synthesize attributionControllers=_attributionControllers;
- (id)analyticsStrings;
...
- (id)initWithAttributionControllers:(id)arg1;
