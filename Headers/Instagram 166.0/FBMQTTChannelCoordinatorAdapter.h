...
@interface FBMQTTChannelCoordinatorAdapter : NSObject <FBMQTTNetworkStatusChangedListening, LigerReachabilityCallback, FBMQTTChannelCoordinating>
{
    ...
    // Error parsing type: {atomic<FBMQTTChannelCoordinatorState>="__a_"{__cxx_atomic_impl<FBMQTTChannelCoordinatorState, std::__1::__cxx_atomic_base_impl<FBMQTTChannelCoordinatorState> >="__a_value"Aq}}, name: _state
