...
- (void)notifyViewControllerDidTapThumbnailWithMediaId:(NSString *)arg1 isExplorePlacementEligible:(_Bool)arg2 isStoryPlacementEligible:(_Bool)arg3 isFeedPlacementEligible:(_Bool)arg4 mediaProductType:(NSString *)arg5 politicalAdBylineText:(NSString *)arg6 destination:(long long)arg7;
