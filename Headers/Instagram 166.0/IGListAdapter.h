...
@protocol IGListAdapterDataSource, IGListAdapterDelegate, IGListAdapterMoveDelegate, IGListAdapterPerformanceDelegate, IGListUpdatingDelegate, IGListUpdatingDelegateExperimental, UICollectionViewDelegate, UIScrollViewDelegate;
...
- (void)_performExperimentalUpdatesWithUpdater:(id)arg1 dataSource:(id)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
- (void)_performRegularUpdatesWithUpdater:(id)arg1 dataSource:(id)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
