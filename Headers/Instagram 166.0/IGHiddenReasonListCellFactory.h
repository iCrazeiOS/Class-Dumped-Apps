...
+ (void)configureCell:(id)arg1 withReasonList:(id)arg2 delegate:(id)arg3 feedTheme:(id)arg4 type:(unsigned long long)arg5 userSession:(id)arg6 analyticsModule:(id)arg7;
