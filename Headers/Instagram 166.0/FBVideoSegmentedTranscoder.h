...
@class AVAsset, FBVideoEdits, FBVideoSegmentedEncoder, FBVideoTranscoderConfig, FBVideoTranscoderTracer, NSDictionary, NSMutableArray, NSString, NSURL;
...
- (id)initWithAsset:(id)arg1 outputAdapter:(id)arg2 videoEdits:(id)arg3 config:(id)arg4 videoProcessor:(id)arg5 videoEncoderFactory:(CDUnknownBlockType)arg6 discreteVideoEncoderProvider:(CDUnknownBlockType)arg7 discreteAudioEncoderProvider:(CDUnknownBlockType)arg8 assetWriterProvider:(CDUnknownBlockType)arg9 applicationStateProvider:(CDUnknownBlockType)arg10 transcodeTracer:(id)arg11 optionalConfig:(id)arg12;
