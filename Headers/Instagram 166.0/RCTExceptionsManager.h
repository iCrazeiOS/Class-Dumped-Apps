...
#import <FBSharedFramework/NativeExceptionsManagerSpec-Protocol.h>
#import <FBSharedFramework/RCTBridgeModule-Protocol.h>

@class NSString, RCTBridge;
@protocol OS_dispatch_queue, RCTExceptionsManagerDelegate, RCTTurboModuleRegistry;
...
+ (const struct RCTMethodInfo *)__rct_export__1355;
