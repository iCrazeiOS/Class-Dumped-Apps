...
@class IGActivityToastData, IGDirectToastData, IGMainAppSurfaceIntent, IGTooltipView, IGUnreadBubbleView, IGUserSession, NSMapTable, NSNumber, NSString, UIView;
...
@interface IGTabBarTooltipPresentationManager : NSObject <IGDirectSurfaceEntryListener, IGTooltipViewDelegate, IGWarmStartListener, IGNewsPresentationDelegate>
{
    ...
    _Bool _isActivityFeedInProfile;
