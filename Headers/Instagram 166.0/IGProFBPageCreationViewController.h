...
@class IG4BLogger, IGBottomButtonsView, IGBusinessConversionFacebookPageDataSource, IGFacebookPageInfo, IGInterestAccountLoggingProvider, IGListAdapter, IGProAccountConversionExperimentProvider, IGProFBPageCreationViewControllerConfiguration, IGProFBPageNameViewModel, IGProListItemViewModel, IGStepperHeaderControl, IGUserSession, NSMutableArray, NSString, UICollectionView;
@protocol IGListDiffable, IGProFBPageCreationViewControllerDelegate;

@interface IGProFBPageCreationViewController : IGViewController <IGDismissableViewController, IGProCategorySelectionViewControllerDelegate, IGListAdapterDataSource, IGProListItemSectionControllerDelegate, IGProFBPageNameCellSectionControllerDelegate, UIGestureRecognizerDelegate, IGBusinessViewControllerLoadingAware>
{
...
- (void)_logPageCreationSubmitErrorByLogger:(id)arg1 withPageName:(id)arg2 subcategoryID:(id)arg3 subcategoryName:(id)arg4 errorMessage:(id)arg5;
