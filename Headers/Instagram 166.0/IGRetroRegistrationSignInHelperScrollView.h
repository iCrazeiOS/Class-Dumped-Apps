...
@class IGFacebookButton, IGLabel, IGPhoneNumberField, IGRetroRegistrationFacebookButtonSeperator, IGRetroRegistrationNextButton, IGRetroRegistrationSignInHelperToggleView, IGRetroRegistrationTextField, IGTextField, NSString, UIActivityIndicatorView, UIButton, UIImageView, UILabel;
