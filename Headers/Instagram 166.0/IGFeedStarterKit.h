...
#import <InstagramAppCoreFramework/IGViewLayoutListener-Protocol.h>
...
- (id)initWithUserSession:(id)arg1 viewController:(id)arg2 scrollViewTopInset:(double)arg3 module:(id)arg4 accessibilityIdentifier:(id)arg5 enableScrollPerfLogging:(_Bool)arg6 scrollPerfMarkerId:(int)arg7 workingRangeSize:(long long)arg8 loadDistance:(double)arg9 collectionViewBlock:(CDUnknownBlockType)arg10 refreshControlBlock:(CDUnknownBlockType)arg11;
- (id)initWithUserSession:(id)arg1 viewController:(id)arg2 scrollViewTopInset:(double)arg3 module:(id)arg4 accessibilityIdentifier:(id)arg5 enableScrollPerfLogging:(_Bool)arg6 scrollPerfMarkerId:(int)arg7 workingRangeSize:(long long)arg8 collectionViewBlock:(CDUnknownBlockType)arg9 refreshControlBlock:(CDUnknownBlockType)arg10;
