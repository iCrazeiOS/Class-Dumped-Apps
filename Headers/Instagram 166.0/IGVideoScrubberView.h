...
@class CALayer, FBSurfaceView, IGIGLContext, IGSurfaceView, NSMutableArray, UILabel;
...
@interface IGVideoScrubberView : UIView
{
    ...
    FBSurfaceView *_fbCenterHandleImageView;
    double _keyPosition;
...
@property(readonly, nonatomic) FBSurfaceView *fbCenterHandleImageView; // @synthesize fbCenterHandleImageView=_fbCenterHandleImageView;
