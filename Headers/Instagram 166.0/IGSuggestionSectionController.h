...
@class IGStoryReelOwnerView, IGStoryViewerPresentationAnimationController, IGSuggestionCellViewModel, IGUserSession, NSObject, NSString;
...
- (void)_reloadSectionControllerWithMedia:(id)arg1 animated:(_Bool)arg2;
...
- (void)suggestionCell:(id)arg1 didTapHiddenThumbnailWithMedia:(id)arg2;
- (void)suggestionCell:(id)arg1 reelView:(id)arg2 didTapStoryViewWithReel:(id)arg3 storyViewModel:(id)arg4;
- (void)suggestionCell:(id)arg1 didTapThumbnailWithMedia:(id)arg2;
