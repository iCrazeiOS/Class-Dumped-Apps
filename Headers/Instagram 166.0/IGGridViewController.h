...
@class IGPHAssetDataSource, IGPHAssetsFetchResult, IGPhotoLibraryLimitedAccessHeaderView, IGScrollPerfLogger, IGUserSession, NSArray, NSIndexPath, NSMutableOrderedSet, NSString, PHAssetCollection, PHCachingImageManager, PHFetchResult, PHImageRequestOptions, UICollectionView, UIColor, UILongPressGestureRecognizer;
