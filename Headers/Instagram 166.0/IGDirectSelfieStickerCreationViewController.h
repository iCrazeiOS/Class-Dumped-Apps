...
- (void)viewDidLoad;
- (id)initWithUserSession:(id)arg1 backgroundColor:(id)arg2 tintColor:(id)arg3 arrowColor:(id)arg4 cameraButtonStyle:(long long)arg5 entryPoint:(unsigned long long)arg6;
