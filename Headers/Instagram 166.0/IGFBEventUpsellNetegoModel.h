...
- (id)initWithTitle:(id)arg1 buttonTitle:(id)arg2 headerTitle:(id)arg3 headerSubtitle:(id)arg4 mediaUrl:(id)arg5 mediaAspectRatio:(double)arg6 msiteUrl:(id)arg7 pk:(id)arg8 trackingToken:(id)arg9 gapRules:(id)arg10;
