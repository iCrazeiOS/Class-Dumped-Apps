...
- (id)activeAsset;
- (void)dealloc;
- (id)initWithAssetBlock:(CDUnknownBlockType)arg1 validateCMTime:(_Bool)arg2 skipDurationQueryOnError:(_Bool)arg3 shouldBufferVideoAsSoonAsPossible:(_Bool)arg4 fixMissingCodecFormat:(_Bool)arg5 enableDashStartPauseCall:(_Bool)arg6 enableUserQualitySelectionWithRepresentationId:(_Bool)arg7;
