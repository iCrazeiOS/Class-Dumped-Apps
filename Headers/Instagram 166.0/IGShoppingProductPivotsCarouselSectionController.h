...
@class IGFeedPreviewHandler, IGListAdapter, IGSessionTracker, IGShoppingExploreAnalyticsContext, IGShoppingProductPivotsViewModel, IGUserSession, IGViewController, NSString;
@protocol IGPivotControllerDelegate, IGShoppingProductPivotsCarouselLoggingProviderType;

@interface IGShoppingProductPivotsCarouselSectionController : IGListSectionController <IGListAdapterDataSource, IGSaveStatusListener, IGShoppingProductPivotsCellDelegate, IGShoppingGenericProductWithContextCardSectionControllerDelegate>
{
...
- (id)initWithUserSession:(id)arg1 previewViewController:(id)arg2 loggingProvider:(id)arg3 analyticsModule:(id)arg4 shoppingSessionTracker:(id)arg5 exploreInfo:(id)arg6 delegate:(id)arg7;
