...
@class IGStoryMusicBrowserOriginalAudioCellModel, IGStoryMusicLoggingMetadata, IGUserSession, NSOrderedSet, NSString;
@protocol IGStoryMusicBrowserOriginalAudioSectionControllerDelegate, IGSubscriptionToken;

@interface IGStoryMusicBrowserOriginalAudioSectionController : IGListBindingSectionController <IGListBindingSectionControllerDataSource, IGListBindingSectionControllerSelectionDelegate, IGStoryMusicBrowserSongCellDelegate, IGStoryMusicTrackPlaybackEventListener, IGListDisplayDelegate>
{
    IGUserSession *_userSession;
    unsigned long long _category;
    unsigned long long _bookmarkCallsSurface;
    IGStoryMusicBrowserOriginalAudioCellModel *_originalAudioModel;
    ...
    id <IGStoryMusicBrowserOriginalAudioSectionControllerDelegate> _delegate;
    long long _theme;
...
@property(nonatomic) __weak id <IGStoryMusicBrowserOriginalAudioSectionControllerDelegate> delegate; // @synthesize delegate=_delegate;
