...
@class IGEffectSlider, IGGradientColorToggleButton, IGGradientView, IGStoryImageAdjustmentsPicker, IGStoryMediaCompositionState, IGStoryMultiEditCompositionThumbnailTray, IGStoryPostCaptureHeaderView, IGUserSession, IGVideoLayerListView, IGVideoTimelineView, NSString, UIControl;

@interface IGSundialDraftsPostcaptureEditingControlsOverlayView : IGPassthroughView <IGStoryMediaCompositionEditingControlsOverlayViewProtocol>
{
...
@property(readonly, nonatomic) UIControl *confirmEditsButton; // @synthesize confirmEditsButton=_confirmEditsButton;
