...
@class IGAnalyticsNavigationState, IGFeedScrollViewAnnouncer, IGListAdapter, IGMedia, IGSaveToCollectionsCreationView, IGSaveToCollectionsDataSource, IGSaveToCollectionsHorizontalListView, IGSaveToCollectionsNavigationBar, IGSavedCollectionsPreviewingHandler, IGSharedKeyboardObserver, IGSponsoredSupportConfiguration, IGUserSession, NSMutableArray, NSString, NSURL, UIView;
