...
@protocol IGNetworking, IGPostAnalyticsProvider, IGUploadTaskListener, IGUserFeatureSets, OS_dispatch_queue;
...
- (id)createOperation;
- (id)initWithTaskId:(id)arg1 uploadId:(id)arg2 waterfallId:(id)arg3 uploadParams:(id)arg4 networker:(id)arg5 executingQueue:(id)arg6 userSession:(id)arg7 analyticsProvider:(id)arg8 uploadTaskListener:(id)arg9 featureSets:(id)arg10;
