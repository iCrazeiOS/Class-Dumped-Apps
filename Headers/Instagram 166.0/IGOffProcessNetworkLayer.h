...
- (id)_initWithDataUsageLogger:(id)arg1 analyticsLogger:(id)arg2 application:(id)arg3 concurrentSessionHandler:(id)arg4 URLSessionBlock:(CDUnknownBlockType)arg5 operationQueue:(id)arg6 responseFileManager:(id)arg7;
- (id)initWithDataUsageLogger:(id)arg1 analyticsLogger:(id)arg2 application:(id)arg3 concurrentSessionHandler:(id)arg4;
