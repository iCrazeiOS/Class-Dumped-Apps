...
@class IGDiscoveryTopicModel, IGSessionTracker, IGShoppingBasicProductFeedTitleConfiguration, IGShoppingNavigationAnalyticsContext, IGUserSession, NSArray, NSDictionary, NSString;

@interface IGShoppingCreatorsBasicProductFeedConfiguration : NSObject <IGShoppingBasicProductFeedViewControllerConfigurationType>
{
    ...
    NSArray *_initialProducts;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) NSArray *initialProducts; // @synthesize initialProducts=_initialProducts;
...
- (id)initWithUserSession:(id)arg1 title:(id)arg2 subtitle:(id)arg3 analyticsModule:(id)arg4 priorModule:(id)arg5 discoveryTopicModel:(id)arg6 entryPoint:(long long)arg7 areProductCellsDismissable:(_Bool)arg8 initialProducts:(id)arg9 shoppingSessionTracker:(id)arg10;
