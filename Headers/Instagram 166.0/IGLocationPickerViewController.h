...
@class IGLocationServicesUpsellView, IGNearbyLocationDataSource, IGPerformanceComponent, IGPerformanceNavigationLogger, IGPlainTableView, IGSearchBar, IGTableLayoutSpec, IGUserSession, NSString, UIBarButtonItem;
