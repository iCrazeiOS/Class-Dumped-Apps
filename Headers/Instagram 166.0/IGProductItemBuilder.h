...
@class IGPhoto, IGShoppingCheckoutProperties, IGShoppingProductDiscountInformation, IGShoppingProductIncentiveInformation, IGShoppingProductLaunchInformation, IGShoppingTextWithEntities, IGShoppingUntaggableReason, IGUser, NSArray, NSString, NSURL;
