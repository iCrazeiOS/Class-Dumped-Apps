...
#import <FBSharedFramework/RCTEventDispatcherProtocol-Protocol.h>
...
@interface RCTEventDispatcher : NSObject <RCTTurboModule, RCTEventDispatcherProtocol>
{
    ...
    CDUnknownBlockType _invokeJSWithModuleDotMethod;
}

+ (void)load;
+ (id)moduleName;
- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType invokeJSWithModuleDotMethod; // @synthesize invokeJSWithModuleDotMethod=_invokeJSWithModuleDotMethod;
