...
#import <InstagramAppCoreFramework/IGAnalyticsModuleUriProvider-Protocol.h>
#import <InstagramAppCoreFramework/IGBrowserChromeViewControllerDelegate-Protocol.h>
#import <InstagramAppCoreFramework/IGBrowserHistoryLinkHandlerDelegate-Protocol.h>
...
@class IABLoggingCoordinator, IGBrowserChromeViewController, IGBrowserFullscreenTransitioningDelegate, IGBrowserOverflowMenuController, IGBrowserSession, IGUserSession, IGWebViewController, IGWebViewSendInDirectController, NSDate, NSString, NSURL, UIView;
@protocol FBWebView, IGAnalyticsEventLoggingProtocol, IGBrowserViewControllerDelegate;

@interface IGBrowserViewController : IGViewController <IGAnalyticsModuleUriProvider, IGBrowserChromeViewControllerDelegate, IGBrowserHistoryLinkHandlerDelegate, IGWebViewControllerDelegate, IGGestureHandler>
{
...
- (void)_willCloseBrowser:(unsigned long long)arg1 animated:(_Bool)arg2;
...
- (void)webViewControllerTtiDetected:(id)arg1;
...
- (void)webViewController:(id)arg1 didCommitNavigationRequestWithWebview:(id)arg2;
