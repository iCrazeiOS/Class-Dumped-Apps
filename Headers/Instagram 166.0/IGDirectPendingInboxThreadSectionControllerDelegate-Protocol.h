...
@class IGDirectInboxThreadSectionController, IGUser, NSString;
...
- (void)inboxThreadSectionController:(IGDirectInboxThreadSectionController *)arg1 didRequestPresentBlockPromptForUser:(IGUser *)arg2 threadId:(NSString *)arg3;
