...
@class IGUserSession, NSArray, NSMutableIndexSet, NSString, UITableView;
...
- (id)_cellWithText:(id)arg1 image:(id)arg2;
- (id)_payoutInfoCell;
- (id)_learnMoreCell;
- (id)_settingsCell;
- (id)_baseStyledCell;
...
- (void)layoutSubviews;
- (id)initWithUserSession:(id)arg1 delegate:(id)arg2 mesEligibilityDecisions:(id)arg3;
