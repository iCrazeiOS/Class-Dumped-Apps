...
@class IGCoWatchFacebookVideo, IGDirectGalleryPreviewMedia, IGDirectMediaPickerViewController, IGDirectScrollingTabViewModel, IGMedia, NSArray;
...
- (void)mediaPickerViewController:(IGDirectMediaPickerViewController *)arg1 didSelectFeedItem:(IGMedia *)arg2;
@end
