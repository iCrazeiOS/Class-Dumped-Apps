...
@class IGDirectEmbeddedPublishedMessage, IGDirectForwardMetadata, IGDirectPowerupsMetadata, IGDirectUIMessageMetadata, IGVotingInfoSharingModel, NSArray, NSString;
...
@property(readonly, copy, nonatomic) IGVotingInfoSharingModel *votingInfo; // @synthesize votingInfo=_votingInfo;
