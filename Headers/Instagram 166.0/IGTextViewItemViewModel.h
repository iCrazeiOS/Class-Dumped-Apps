...
- (id)diffIdentifier;
- (id)initWithIdentifier:(id)arg1 styledString:(id)arg2 insets:(struct UIEdgeInsets)arg3 backgroundColor:(id)arg4 showsTopSeparator:(_Bool)arg5 showsBottomSeparator:(_Bool)arg6 usePaddedTapDetection:(_Bool)arg7 enableAccessibilityLinks:(_Bool)arg8 isAccessibilityLink:(_Bool)arg9 numberOfLinesOfTruncatedString:(long long)arg10 shouldBadge:(_Bool)arg11;
