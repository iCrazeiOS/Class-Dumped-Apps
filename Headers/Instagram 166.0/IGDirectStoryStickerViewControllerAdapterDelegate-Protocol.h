...
@class IGAREffectModel, IGDirectMessageEffect, IGDirectSelfieStickerModel, IGDirectStoryStickerViewControllerAdapter, IGGiphyGIFModel, IGStaticStickerModel, IGVideoComposition, NSString;
