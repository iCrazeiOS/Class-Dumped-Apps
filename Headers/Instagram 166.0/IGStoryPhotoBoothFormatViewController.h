...
@class AVCaptureDevice, IGAsyncTask, IGCameraViewController, IGCameraZoomController, IGCountdownController, IGPassthroughView, IGStoryCameraOverlayViewController, IGStoryExtendedGalleryViewController, IGStoryPhotoBoothCountdownAnimationController, IGTapButton, IGUserSession, KeyframesView, NSMutableArray, NSString, UIView;
@protocol IGStoryFormatViewControllerProtocolDelegate;

@interface IGStoryPhotoBoothFormatViewController : UIViewController <IGStoryCameraOverlayViewControllerDelegate, IGCameraViewControllerDelegate, IGCameraZoomControllerDelegate, IGCountdownControllerDelegate, IGQuickCamCaptureButtonDelegate, IGStoryDrawerDismissDelegate, IGStoryFormatViewControllerProtocol>
{
...
- (void)_startTransitionToPostCapture;
