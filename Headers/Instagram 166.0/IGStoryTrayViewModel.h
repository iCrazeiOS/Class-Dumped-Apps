...
@class IGLiveBroadcast, IGPhoto, IGRingViewSpec, IGStoryDismissCard, NSArray, NSData, NSDate, NSString, NSURL;
@protocol IGStoryItemType><IGUnitItemInformationProviding, IGStoryReelOwnerType;
...
- (id)initWithReelPK:(id)arg1 type:(long long)arg2 owner:(id)arg3 guests:(id)arg4 sortedItems:(id)arg5 currentItem:(id)arg6 seen:(_Bool)arg7 latestReelMediaDate:(id)arg8 rankedPosition:(long long)arg9 seenRankedPosition:(long long)arg10 isNux:(_Bool)arg11 showNuxTooltip:(_Bool)arg12 isMuted:(_Bool)arg13 canReply:(_Bool)arg14 canReshare:(_Bool)arg15 hideFromFeedUnit:(_Bool)arg16 isPlaceholder:(_Bool)arg17 hasCopyrightViolation:(_Bool)arg18 hasRightsManagerViolation:(_Bool)arg19 placeholderStyle:(long long)arg20 broadcasts:(id)arg21 currentBroadcast:(id)arg22 latestBroadcastDate:(id)arg23 fetchable:(_Bool)arg24 isSponsored:(_Bool)arg25 prefetchCount:(long long)arg26 dismissCard:(id)arg27 currentUser:(id)arg28 customRingSpec:(id)arg29 ringBadgeURL:(id)arg30 trayContext:(id)arg31 hasFavoritesMedia:(_Bool)arg32 hasPrideMedia:(_Bool)arg33 title:(id)arg34 coverURL:(id)arg35 shouldShowBadge:(_Bool)arg36 timeSinceInteraction:(id)arg37 mediaPreviewPhoto:(id)arg38 mediaPreviewData:(id)arg39 hasSkippedSegment:(_Bool)arg40 hasRecentlyPostedTo:(_Bool)arg41;
