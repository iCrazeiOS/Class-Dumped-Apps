...
- (id)initWithCookieManagement:(unsigned long long)arg1 timeoutInterval:(double)arg2 requestType:(unsigned long long)arg3 behavior:(unsigned long long)arg4 retryPolicy:(unsigned long long)arg5 privilege:(unsigned long long)arg6 cachePolicy:(id)arg7 offProcessKey:(id)arg8 surface:(id)arg9 mediaId:(id)arg10;
