...
- (id)_initWithLinkContext:(id)arg1 text:(id)arg2 contentType:(id)arg3 messageMetadata:(id)arg4 messageCellViewModel:(id)arg5 shouldDisableLinks:(_Bool)arg6;
- (id)initWithLinkContext:(id)arg1 text:(id)arg2 messageMetadata:(id)arg3 messageCellViewModel:(id)arg4 shouldDisableLinks:(_Bool)arg5;
- (id)initWithLinkMessage:(id)arg1 messageCellViewModel:(id)arg2 shouldDisableLinks:(_Bool)arg3;
