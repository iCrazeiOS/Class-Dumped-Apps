...
+ (id)newWithLogger:(id)arg1 analyticsLogger:(id)arg2 performanceLogger:(shared_ptr_859d849d)arg3 experimentConfiguration:(id)arg4 ARClassSource:(id)arg5 networkClientSource:(shared_ref_855019a2)arg6 supportedCameraCapabilities:(unsigned long long)arg7 sessionRecordingConfiguration:(id)arg8;
+ (id)newWithLogger:(id)arg1 analyticsLogger:(id)arg2 performanceLogger:(shared_ptr_859d849d)arg3 experimentConfiguration:(id)arg4 ARClassSource:(id)arg5 networkClientSource:(shared_ref_855019a2)arg6 supportedCameraCapabilities:(unsigned long long)arg7;
...
- (void)dealloc;
- (id)initWithLogger:(id)arg1 analyticsLogger:(id)arg2 performanceLogger:(shared_ptr_859d849d)arg3 rawEventLogger:(shared_ref_c47c2ea2)arg4 experimentConfiguration:(id)arg5 ARClassSource:(id)arg6 networkClientSource:(shared_ref_855019a2)arg7 supportedCameraCapabilities:(unsigned long long)arg8 effectSessionListener:(Optional_5fae1a92)arg9 dataSnapshotterCreator:(Optional_bb731cbb)arg10 sessionRecordingConfiguration:(id)arg11;
- (id)initWithLogger:(id)arg1 analyticsLogger:(id)arg2 performanceLogger:(shared_ptr_859d849d)arg3 experimentConfiguration:(id)arg4 ARClassSource:(id)arg5 networkClientSource:(shared_ref_855019a2)arg6 dataSnapshotterCreator:(Optional_bb731cbb)arg7;
- (id)initWithLogger:(id)arg1 analyticsLogger:(id)arg2 performanceLogger:(shared_ptr_859d849d)arg3 experimentConfiguration:(id)arg4 ARClassSource:(id)arg5 networkClientSource:(shared_ref_855019a2)arg6 supportedCameraCapabilities:(unsigned long long)arg7 sessionRecordingConfiguration:(id)arg8;
