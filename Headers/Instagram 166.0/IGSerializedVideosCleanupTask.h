...
- (id)initWithFileManager:(id)arg1 folder:(id)arg2 multipleAccountHandler:(id)arg3 checkForPendingUploads:(_Bool)arg4 draftColocator:(id)arg5 shouldFixDraftsMemoryLeak:(_Bool)arg6;
