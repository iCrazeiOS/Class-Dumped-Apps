...
@class IGDirectMediaViewerTransitionManager, IGDirectMessageMenuController, IGDirectReactingUserListViewController, IGDirectThreadAnalyticsLogger, IGDirectThreadKey, IGDirectThreadViewOutgoingMessageSendAttributionFactory, IGLinkTapHandlingService, IGStoryViewerPresentationController, IGSupportService, IGUserSession, IGVideoPlayerManager, NSString, UIImpactFeedbackGenerator, UIViewController;
@protocol IGDirectFooterTextPromotionActionHandling, IGDirectLiveVideoPresenting, IGDirectLoadingViewProtocol, IGDirectMessageCellSwipeToReplyHandler, IGDirectMessageReplying, IGDirectMessageSending, IGDirectReplyToAuthorViewControllerPresenting, IGDirectThreadListMessageQuerying;
...
- (void)presentStoryViewerForReelId:(id)arg1 media:(id)arg2 sourceController:(id)arg3 loadingView:(id)arg4 viewToPresentFrom:(id)arg5 showSingleItem:(_Bool)arg6 isStoryReshare:(_Bool)arg7 canRepostOnMention:(_Bool)arg8;
...
- (_Bool)handleSendFailIfNeededForMessageKey:(id)arg1 outgoingMessageStatus:(id)arg2 sourceController:(id)arg3 isGroupThread:(_Bool)arg4 isPendingThread:(_Bool)arg5;
...
- (void)handleTapOnGoToChatWithViewModel:(id)arg1 sourceController:(id)arg2 threadId:(id)arg3;
...
- (id)transitionManagerWithMediaViewerProducer:(id)arg1 isInteropThread:(_Bool)arg2 sourceController:(id)arg3 delegate:(id)arg4;
...
- (id)initWithUserSession:(id)arg1 messageSender:(id)arg2 videoPlayerManager:(id)arg3 analyticsLogger:(id)arg4 menuController:(id)arg5 liveVideoPresenter:(id)arg6 messageQuerier:(id)arg7 threadKey:(id)arg8 messageReplyHandler:(id)arg9 swipeToReplyHandler:(id)arg10 sendAttributionFactory:(id)arg11 footerTextActionHandler:(id)arg12 lastSeenShhMessageIdForCurrentUserWhenEnteringShhMode:(id)arg13;
