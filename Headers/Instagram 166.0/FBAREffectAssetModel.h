...
- (id)initWithFilename:(id)arg1 graphQLID:(id)arg2 cacheKey:(id)arg3 uri:(id)arg4 MD5Hash:(id)arg5 fileSize:(unsigned long long)arg6 assetType:(long long)arg7 compression:(long long)arg8 asyncAssets:(id)arg9;
