...
#import <InstagramAppCoreFramework/FB_RTCAudioSessionActivationDelegate-Protocol.h>
...
@interface FB_RTCAudioSession : NSObject <FB_RTCAudioSessionActivationDelegate>
{
    ...
    // Error parsing type: {AsyncInvoker="_vptr$MessageHandler"^^?"pending_invocations_"{atomic<int>="__a_"{__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >="__a_value"Ai}}"invocation_complete_"{scoped_refptr<rtc::RefCountedObject<rtc::Event> >="ptr_"^{RefCountedObject<rtc::Event>}}"destroying_"{atomic<bool>="__a_"{__cxx_atomic_impl<bool, std::__1::__cxx_atomic_base_impl<bool> >="__a_value"AB}}}, name: _asyncInvoker
