...
- (void)layoutSubviews;
- (id)initWithDelegate:(id)arg1 callDuration:(double)arg2 participantView:(id)arg3 userInitiatedHangup:(_Bool)arg4 showFeedback:(_Bool)arg5 goodFeedbackButtonOnRightSide:(_Bool)arg6 tapToDismiss:(_Bool)arg7;
