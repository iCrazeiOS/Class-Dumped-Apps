...
- (id)initWithLauncherSet:(id)arg1 experimentSet:(id)arg2 analyticsModule:(id)arg3 entryPoint:(long long)arg4 IGTVConfiguration:(CDStruct_0ba6daeb)arg5 adItemMapper:(id)arg6 prioritizedDirectRecipient:(id)arg7;
