...
#import <FBSharedFramework/IGQuickCamVideoInfoType-Protocol.h>
...
- (id)initWithVideoInfo:(id)arg1 devicePosition:(long long)arg2 deviceType:(id)arg3 deviceUniqueID:(id)arg4 flashMode:(long long)arg5 assetSource:(long long)arg6;
