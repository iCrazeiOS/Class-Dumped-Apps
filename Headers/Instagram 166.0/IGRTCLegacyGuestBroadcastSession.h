...
@class IGAudioSessionClient, IGCallSession, IGLiveBroadcastLogger, IGRTCVideoCropMode, IGUserSession, IGWebRTCAudioStallSentry, IGWebRTCPeerConnectionController, NSDate, NSSet, NSString;
...
@interface IGRTCLegacyGuestBroadcastSession : NSObject <IGCallSessionDelegate, IGWebRTCPeerConnectionControllerDelegate, IGWebRTCAudioStallSentryDelegate, FBVideoBroadcastRTCSession>
{
    ...
    IGRTCVideoCropMode *_videoCropMode;
    _Bool _restarting;
    _Bool _didJoin;
...
@property(readonly, nonatomic) CDStruct_886bc7b8 config; // @synthesize config=_config;
...
- (void)dealloc;
- (id)initWithUserSession:(id)arg1 config:(CDStruct_886bc7b8)arg2 broadcastId:(id)arg3 remoteCallMessageHandler:(id)arg4 defaultVideoCropMode:(id)arg5 logger:(id)arg6 liveWithDelegate:(id)arg7 liveInfoDelegate:(id)arg8;
