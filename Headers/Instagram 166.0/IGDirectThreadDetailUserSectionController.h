...
@class IGDirectThreadDetailUserViewModel, IGUserSession, NSString;
@protocol IGDirectThreadDetailUserCellDelegate;

@interface IGDirectThreadDetailUserSectionController : IGListSectionController <IGFollowControllerTapDelegate>
{
