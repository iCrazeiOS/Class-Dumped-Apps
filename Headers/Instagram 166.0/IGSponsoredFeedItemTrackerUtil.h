...
+ (void)trackInvalidationForFeedItemTracker:(id)arg1 media:(id)arg2 withReasons:(id)arg3 extra:(id)arg4 analyticsLogger:(id)arg5 sponsoredSupportConfiguration:(id)arg6;
