...
@class IGBrowserSession, IGBrowserViewController, IGFeedNetworkSource, IGFeedScrollViewAnnouncer, IGListAdapter, IGMedia, IGProfileAdsOverlayView, IGUserSession, NSIndexPath, NSString, UICollectionView;
...
- (id)initWithMedia:(id)arg1 logger:(id)arg2 delegate:(id)arg3 userSession:(id)arg4;
