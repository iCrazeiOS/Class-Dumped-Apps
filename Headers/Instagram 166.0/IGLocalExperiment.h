...
- (id)peekGroupName;
- (id)groupName;
- (id)initWithExperimentName:(id)arg1 salt:(id)arg2 totalSegments:(unsigned long long)arg3 expirationDate:(id)arg4 groups:(id)arg5 deployGroupIndex:(unsigned long long)arg6 shouldLogImmediately:(_Bool)arg7 deviceID:(id)arg8 killSwitchBlock:(CDUnknownBlockType)arg9;
- (id)initWithExperimentName:(id)arg1 salt:(id)arg2 totalSegments:(unsigned long long)arg3 expirationDate:(id)arg4 groups:(id)arg5 deployGroupIndex:(unsigned long long)arg6 shouldLogImmediately:(_Bool)arg7 killSwitchBlock:(CDUnknownBlockType)arg8;
