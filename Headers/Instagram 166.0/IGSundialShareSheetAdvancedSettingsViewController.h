...
@class IGBusinessToolAlertViewController, IGGroupedTableViewFooterView, IGTooltipView, IGUser, IGUserSession, NSArray, NSString;
@protocol IGSundialShareSheetAdvancedSettingsViewControllerDelegate;

@interface IGSundialShareSheetAdvancedSettingsViewController : IGGroupedTableViewController <IGCoreTextLinkHandler, IGAddPartnerTaggingViewControllerDelegate>
{
...
- (void)viewDidLoad;
- (id)initWithUserSession:(id)arg1 showBrandedContentSection:(_Bool)arg2;
