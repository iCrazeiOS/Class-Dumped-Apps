...
@class IGMemoryHeaderStickerView, IGOnThisDayModel, IGPerformanceNavigationLogger, IGStoryCanvasToolbarConfig, IGStoryGradientRingView, IGStoryStickerContainerView, IGUserSession, NSArray, NSString, UISelectionFeedbackGenerator, UIView;
