...
@class IGAudioSessionClient, IGCropView, IGEditorAssetLoadingView, IGEditorTabBar, IGFBFilterCollectionController, IGFBVideoPlaybackView, IGFeedCreationFlowLogger, IGFeedEditorNavigationPerfComponents, IGFeedGalleryVideoFetchRequest, IGFilterCollectionController, IGFilterControlView, IGIGLContext, IGMediaMetadata, IGRearrangeOverlayView, IGSegmentedProgressView, IGShareListManager, IGSoundStateListener, IGTooltipView, IGUserSession, IGVideoComposition, IGVideoInfo, IGVideoPlayButton, IGVideoPlaybackView, IGVideoScrubberView, IGVideoTrimViewController, NSMutableDictionary, NSString, UIBarButtonItem, UIButton, UICollectionView, UIImage, UIImageView, UILabel, UIView;
@protocol IGEditorTabView, IGVideoEditorDelegate, IGVideoPlaybackViewType;

@interface IGVideoEditorViewController : IGViewController <IGCropViewUserInteractionDelegate, IGFilterCollectionControllerDelegate, IGFBFilterCollectionControllerDelegate, IGVideoPlaybackViewDelegate, IGEditorTabBarDelegate, IGVideoScrubberViewDelegate, IGFeedGalleryAssetFetchRequestDelegate, IGFilterControlViewDelegate, IGVideoTrimControllerDelegate, IGVideoTrimConfirmationDelegate, IGSoundStateListenerDelegate, IGMediaLibraryViewControllerDelegate, IGShareViewControllerDelegate>
{
