...
#import <InstagramAppCoreFramework/IGVideoCallMiniPreviewViewControllerDelegate-Protocol.h>
...
@class IGCoWatchCoordinator, IGMinimizableContext, IGUserSession, IGVideoCallBlurredAvatarView, IGVideoCallManager, IGVideoCallMiniHeaderView, IGVideoCallMiniPreviewViewController, IGVideoCallMiniViewerOverlayView, IGVideoCallNavigationTracker, IGVideoCallSession, IGVideoCallUser, IGVideoCallVideoStreamsViewController, NSString;
@protocol FBCancelable, IGVideoCallCaptureCoordinatorAREffectProtocol;

@interface IGVideoCallMiniViewController : IGViewController <IGVideoCallNavigationTrackerDelegate, IGVideoCallSessionListener, IGVideoCallGridLayoutDelegate, IGVideoCallMiniHeaderViewDelegate, IGCoWatchCoordinatorDelegate, IGVideoCallMiniPreviewViewControllerDelegate, IGVideoCallViewController>
{
    ...
    IGVideoCallMiniPreviewViewController *_miniPreviewViewController;
}
...
- (void)miniPreviewViewControllerDidTapVideoButton:(id)arg1;
- (void)miniPreviewViewControllerDidTapCancelButton:(id)arg1;
