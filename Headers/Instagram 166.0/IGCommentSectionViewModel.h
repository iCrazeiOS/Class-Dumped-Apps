...
+ (id)commentViewModelFromComment:(id)arg1 isChildComment:(_Bool)arg2 style:(long long)arg3 contentViewType:(long long)arg4 captionIsEdited:(_Bool)arg5 socialContextInCaption:(id)arg6 socialContextURL:(id)arg7 contentEnabledAction:(long long)arg8 useInlineStyle:(_Bool)arg9 canHidePIA:(_Bool)arg10 likeButtonPosition:(long long)arg11 module:(id)arg12 width:(double)arg13 expanded:(_Bool)arg14 truncateToNumberOfLines:(long long)arg15 canShowTranslationButton:(_Bool)arg16 canShowCheckmarkButton:(_Bool)arg17 showUnhideButton:(_Bool)arg18 privateReplyEnabled:(_Bool)arg19;
- (void).cxx_destruct;
