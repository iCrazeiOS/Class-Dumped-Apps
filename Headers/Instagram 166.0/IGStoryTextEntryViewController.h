...
@class IGGradientView, IGKeyboardObserver, IGStoryRichTextEntryTextView, IGStoryTextEntryControlsOverlayView, IGStoryTextEntryViewControllerConfiguration, IGUserSession, NSArray, NSNumber, NSSet, NSString, UISelectionFeedbackGenerator, UITapGestureRecognizer, UIView;
...
- (void)_onInputModeChange:(id)arg1;
