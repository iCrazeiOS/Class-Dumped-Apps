...
@class IGProfilePictureImageView, IGStackLayout, IGTableLayoutSpec, NSString, UILabel, UIView;
@protocol IGListItemViewProviderDelegate;

@interface IGInsightsProductCreatorBreakdownViewProvider : NSObject <IGListItemViewProvider>
{
    UILabel *_creatorUsername;
    UILabel *_creatorFullName;
    ...
    IGProfilePictureImageView *_leadingContentView;
...
@property(retain, nonatomic) IGProfilePictureImageView *leadingContentView; // @synthesize leadingContentView=_leadingContentView;
