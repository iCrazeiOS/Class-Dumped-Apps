...
@class IGUpcomingEvent, NSString, NSURL;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool canBubbleExpand; // @synthesize canBubbleExpand=_canBubbleExpand;
...
- (id)initWithPk:(id)arg1 userProfilePictureUrl:(id)arg2 username:(id)arg3 caption:(id)arg4 showVerifiedBadge:(_Bool)arg5 displayType:(long long)arg6 isArchive:(_Bool)arg7 isVideoMedia:(_Bool)arg8 isSidecarMedia:(_Bool)arg9 selectedPostId:(id)arg10 hasProductTags:(_Bool)arg11 mediaImageUrl:(id)arg12 mediaAspectRatio:(double)arg13 mediaOwnerPk:(id)arg14 productType:(id)arg15 hidePreviewImage:(_Bool)arg16 upcomingEvent:(id)arg17 canBubbleExpand:(_Bool)arg18;
