...
@interface IGGLKRenderer : NSObject
{
    ...
    shared_ptr_00a1b2d6 _vertexModuleIGL;
    shared_ptr_00a1b2d6 _fragmentModuleIGL;
...
- (void)_bindUniforms:(id)arg1 renderCommandEncoder:(unique_ptr_d491fbc2 *)arg2 pipelineState:(shared_ptr_f6a92caa *)arg3 isVertex:(_Bool)arg4;
- (void)_setupShaderModule:(id)arg1;
- (void)_setValueIGL:(id)arg1 forUniform:(id)arg2 isVertexUniform:(_Bool)arg3;
- (void)_setFragmentUniforms:(pair_66c261d2 *)arg1;
- (void)_setVertexUniforms:(pair_66c261d2 *)arg1;
