...
@protocol FNFBandwidthProvider, FNFDashContextualConfig, FNFDashHeading, FNFDashTrackEntryContaining><FNFDashVirtualEntryContaining;
...
- (id)representationId;
- (id)description;
- (id)initWithConfig:(struct FNFDashConfig)arg1 contextualConfig:(id)arg2 trackMetadata:(id)arg3 containerFormat:(unsigned char)arg4 trackMetadataIsFinal:(_Bool)arg5 containsCompleteTimeline:(_Bool)arg6 track:(long long)arg7 bandwidthProvider:(id)arg8 playerMetadata:(id)arg9;
