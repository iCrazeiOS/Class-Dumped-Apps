...
@class IGFNFVideoPlayer, IGMedia, IGMediaPreloader, IGSessionTracker, IGShoppingConsumptionFeedItemLogger, IGShoppingPDPHeroCarouselMediaZoomController, IGShoppingPDPHeroCarouselReelViewModel, IGUserSession, IGZoomViewPresenter, NSString;
...
- (void)dealloc;
- (id)initWithUserSession:(id)arg1 productItemPk:(id)arg2 merchantId:(id)arg3 logger:(id)arg4 shoppingSessionTracker:(id)arg5;
