...
@class IGDate, IGRingViewSpec, IGUser, NSArray, NSData, NSString, NSURL;
...
- (id)takenAtDate;
- (id)expiringAtDate;
- (id)initWithTakenAtDate:(id)arg1 user:(id)arg2 image:(id)arg3 overlayImage:(id)arg4 mediaType:(long long)arg5 overlayTapModels:(id)arg6 storyLinkUrl:(id)arg7 totalDuration:(double)arg8 uploadId:(id)arg9 mediaAudience:(long long)arg10 videoDataFileURL:(id)arg11 isPrideMedia:(_Bool)arg12 customRingSpec:(id)arg13 ringeBadgeURL:(id)arg14;
