...
@class FNFPlayerExponentialBackoffTimer, NSError, NSString;
...
@interface FNFSynchronousPlayer : NSObject <FNFPlayerDisplayEngineDelegate, FNFAssetEventListener, FNFPlayerControlling>
{
...
- (id)initWithDisplayEngine:(id)arg1 config:(CDStruct_84e6a719)arg2 audioEngine:(id)arg3 audioDecoder:(id)arg4 clock:(id)arg5 runningQueue:(id)arg6 muted:(_Bool)arg7 asyncTimebase:(_Bool)arg8;
- (void)dealloc;
