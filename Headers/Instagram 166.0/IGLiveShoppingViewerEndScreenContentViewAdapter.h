...
@class IGLiveShoppingViewerEndScreenContentDataSource, IGSessionTracker, IGShoppingCartLogger, IGShoppingNavigationAnalyticsContext, IGUserSession, NSString, UIViewController;
@protocol IGLiveShoppingViewerEndScreenContentViewAdapterDelegate;

@interface IGLiveShoppingViewerEndScreenContentViewAdapter : NSObject <IGLiveShoppingViewerEndScreenContentDataSourceListener, IGSaveStatusListener, IGShoppingGenericProductWithContextCardSectionControllerDelegate>
{
...
- (id)initWithDataSource:(id)arg1 userSession:(id)arg2 viewController:(id)arg3 analyticsContext:(id)arg4 shoppingSessionTracker:(id)arg5 gridLayoutConfiguration:(struct IGGridLayoutConfiguration)arg6;
