...
#import <FBSharedFramework/FNFSynchronousPlayerDelegate-Protocol.h>

@class FNFAudioQueue, NSError, NSString;
@protocol FNFAVPlayerItem, FNFPlayerAudioDecoder, FNFPlayerControlling, FNFPlayerStateUpdateListener, OS_dispatch_queue;
...
- (id)initWithDisplayEngine:(id)arg1 clock:(id)arg2 config:(CDStruct_84e6a719)arg3 asyncTimebase:(_Bool)arg4 enableOpus:(_Bool)arg5;
- (id)initWithDisplayEngine:(id)arg1 config:(CDStruct_84e6a719)arg2 asyncTimebase:(_Bool)arg3 enableOpus:(_Bool)arg4;
