...
@class NSArray, NSMutableDictionary, NSMutableSet, NSString, NSTimer, SwipeScrollView, UIScrollView;
@protocol UjetSwipeViewDataSource, UjetSwipeViewDelegate;

@interface UjetSwipeView : UIView <UIScrollViewDelegate, UIGestureRecognizerDelegate>
{
    ...
    id <UjetSwipeViewDataSource> _dataSource;
    id <UjetSwipeViewDelegate> _delegate;
    ...
    SwipeScrollView *_castedScrollView;
...
@property(retain, nonatomic) SwipeScrollView *castedScrollView; // @synthesize castedScrollView=_castedScrollView;
...
@property(nonatomic) __weak id <UjetSwipeViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak id <UjetSwipeViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
