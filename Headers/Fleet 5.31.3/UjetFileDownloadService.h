...
#import <UJET/NSURLSessionDelegate-Protocol.h>
#import <UJET/NSURLSessionDownloadDelegate-Protocol.h>

@class NSMutableDictionary, NSString;

@interface UjetFileDownloadService : NSObject <NSURLSessionDelegate, NSURLSessionDownloadDelegate>
{
