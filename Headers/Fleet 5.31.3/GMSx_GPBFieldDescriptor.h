...
- (id)textFormatName;
@property(readonly, nonatomic) CDUnion_7ae79ea2 defaultValue;
...
- (id)initWithFieldDescription:(void *)arg1 includesDefault:(_Bool)arg2 usesClassRefs:(_Bool)arg3 syntax:(unsigned char)arg4;
- (id)init;
