...
@class CTTelephonyNetworkInfo, NSDictionary, NSLock, NSMutableDictionary, NSRegularExpression, UjetNBMetadataHelper;

@interface UjetNBPhoneNumberUtil : NSObject
{
    ...
    UjetNBMetadataHelper *_helper;
}

+ (void)initialize;
+ (id)sharedInstance;
@property(retain, nonatomic) UjetNBMetadataHelper *helper; // @synthesize helper=_helper;
