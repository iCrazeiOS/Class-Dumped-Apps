...
@class NSMutableArray, NSMutableString, NSRegularExpression, NSString, UjetNBPhoneMetaData, UjetNBPhoneNumberUtil;

@interface UjetNBAsYouTypeFormatter : NSObject
{
    ...
    UjetNBPhoneNumberUtil *_phoneUtil_;
    ...
    UjetNBPhoneMetaData *_currentMetaData_;
    UjetNBPhoneMetaData *_defaultMetaData_;
    UjetNBPhoneMetaData *_EMPTY_METADATA_;
}

@property(retain, nonatomic) UjetNBPhoneMetaData *EMPTY_METADATA_; // @synthesize EMPTY_METADATA_=_EMPTY_METADATA_;
@property(retain, nonatomic) UjetNBPhoneMetaData *defaultMetaData_; // @synthesize defaultMetaData_=_defaultMetaData_;
@property(retain, nonatomic) UjetNBPhoneMetaData *currentMetaData_; // @synthesize currentMetaData_=_currentMetaData_;
...
@property(retain, nonatomic) UjetNBPhoneNumberUtil *phoneUtil_; // @synthesize phoneUtil_=_phoneUtil_;
...
- (id)inputString:(id)arg1 inRange:(struct _NSRange)arg2;
...
- (id)removeStringInRange:(struct _NSRange)arg1;
- (id)removeLastDigit;
