...
@class CADisplayLink, MBBackgroundView, NSArray, NSDate, NSProgress, NSTimer, UIButton, UIColor, UILabel, UIMotionEffectGroup;
...
@property(retain, nonatomic) UIMotionEffectGroup *bezelMotionEffects; // @synthesize bezelMotionEffects=_bezelMotionEffects;
