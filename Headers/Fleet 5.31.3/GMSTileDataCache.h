...
@interface GMSTileDataCache : NSObject <GMSTileDataCache>
{
    ...
    // Error parsing type: {atomic<int>="__a_"Ai}, name: _deleteTileDataCachePendings
    _Bool _tuning;
    int _tileType;
...
- (void)storeTileCoords:(id)arg1 validationTime:(long long)arg2 perTileEpoch:(int)arg3 dataVersion:(int)arg4 versionID:(id)arg5 data:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
