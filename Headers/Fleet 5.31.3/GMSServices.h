...
@class GMSAPIClientParameters, GMSDASHConnection, GMSDisplayLink, GMSMapsClearcutClient, GMSNetworkMonitor, GMSServerResourceManager, GMSServiceOptions, GMSStyleTableService, GMSSystemClock, GMSTileRequestCoordinator, GMSTileServiceRegistrar, GMSVectorMapSharedResourceCache, GMSVersion, NSCache, NSMutableDictionary, NSString;
