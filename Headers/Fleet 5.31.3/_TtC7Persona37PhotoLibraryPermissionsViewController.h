...
@interface _TtC7Persona37PhotoLibraryPermissionsViewController : UIViewController
{
...
- (void)viewDidLoad;
- (void)dealloc;
@property(nonatomic) __weak _TtC7Persona13PersonaButton *button; // @synthesize button;
