...
@interface STPBlockBasedApplePayDelegate : NSObject <PKPaymentAuthorizationViewControllerDelegate>
{
    ...
    CDUnknownBlockType _onPaymentMethodCreation;
...
@property(copy, nonatomic) CDUnknownBlockType onPaymentMethodCreation; // @synthesize onPaymentMethodCreation=_onPaymentMethodCreation;
