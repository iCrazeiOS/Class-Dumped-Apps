...
@class NSString, UjetNBPhoneMetaData;

@interface UjetNBMetadataHelper : NSObject
{
    UjetNBPhoneMetaData *_cachedMetaData;
...
@property(retain, nonatomic) UjetNBPhoneMetaData *cachedMetaData; // @synthesize cachedMetaData=_cachedMetaData;
- (void).cxx_destruct;
