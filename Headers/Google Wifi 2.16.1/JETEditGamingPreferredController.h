...
@interface JETEditGamingPreferredController : JETGroupAwareCollectionViewController <GOONavigationCustomization, JETSavableViewController>
{
    GOOSwitchContentViewObject *_gamingPreferredSwitch;
    UIBarButtonItem *_saveButton;
}

@property(retain, nonatomic) UIBarButtonItem *saveButton; // @synthesize saveButton=_saveButton;
@property(retain, nonatomic) GOOSwitchContentViewObject *gamingPreferredSwitch; // @synthesize gamingPreferredSwitch=_gamingPreferredSwitch;
- (void).cxx_destruct;
