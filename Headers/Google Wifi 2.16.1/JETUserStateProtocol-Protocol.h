...
@optional
@property(readonly, nonatomic) int maxAllowedDevices;
@property(nonatomic) _Bool usingCachedGroupList;
@property(readonly, nonatomic) GTLRAccesspoints_UserPreferences *userPreferences;
@property(retain, nonatomic) JETUsageWindow *usageWindow;
@property(readonly, nonatomic) JETUserUpdateGroupOperationQueue *updateOperationQueue;
@property(nonatomic) _Bool signInCompleted;
@property(nonatomic) _Bool showMACAddressInNetworkDetails;
@property(readonly, nonatomic) NSString *selectedAccessPointGroupID;
@property(readonly, nonatomic) JETNotificationsClient *notificationsClient;
@property(retain, nonatomic) NSDictionary *latestMeshTestResults;
@property(retain, nonatomic) SSOIdentity *identity;
@property(readonly, nonatomic) GTMSessionFetcherService *helpKitFetcherService;
@property(readonly, nonatomic) id <JETHalfcourtClient> halfcourtClient;
@property(nonatomic) long long GUNSRegistrationState;
@property(nonatomic) long long groupListRefreshState;
@property(retain, nonatomic) JETFactoryResettingGroup *factoryResettingGroup;
@property(readonly, nonatomic) JETContactsClient *contactsClient;
@property(readonly, nonatomic) id <JETConsentLoggingService> consentLoggingService;
@property(readonly, nonatomic) NSArray *availableGroups;
