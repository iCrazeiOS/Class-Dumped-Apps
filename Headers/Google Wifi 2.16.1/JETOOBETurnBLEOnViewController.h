...
@interface JETOOBETurnBLEOnViewController : JETOOBEViewController <GOONavigationCustomization>
{
    _Bool _shownBLEPrompt;
...
@property(nonatomic) _Bool shownBLEPrompt; // @synthesize shownBLEPrompt=_shownBLEPrompt;
- (void).cxx_destruct;
- (void)continuePressed;
- (void)nextPressed;
- (void)viewDidLayoutSubviews;
- (void)layoutSubviews;
- (void)populateRightButton;
- (id)rightButton;
- (void)loadView;
