...
@class NSArray, NSData, NSError, NSMutableData, NSString, NSThread, NSURLAuthenticationChallenge, NSURLRequest, NSURLResponse, NSURLSessionDataTask;

@interface IBGURLProtocol : NSURLProtocol <NSURLSessionDataDelegate>
{
    _Bool _didExceedsResponseBodyLimit;
...
@property _Bool didExceedsResponseBodyLimit; // @synthesize didExceedsResponseBodyLimit=_didExceedsResponseBodyLimit;
