...
@protocol IBGEventLoggerObserver, OS_dispatch_queue;
...
@interface IBGEventLogger : NSObject <IBGSnapshotProtcol>
{
    ...
    NSObject<OS_dispatch_queue> *_eventLogsQueue;
}

+ (id)dataLayerService;
+ (void)destroy;
+ (id)sharedInstance;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *eventLogsQueue; // @synthesize eventLogsQueue=_eventLogsQueue;
...
- (void)loadSnapshotAsyncForSessionId:(id)arg1 WithCompletion:(CDUnknownBlockType)arg2;
- (void)loadSnapshotSynchronouslyForSessionId:(id)arg1 WithCompletionHandler:(CDUnknownBlockType)arg2;
- (void)clearLastSessionLogs;
- (void)clearOldLogs;
- (void)clearAllLogs;
- (void)loadSnapshotWithSessionId:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
- (void)loadSnapshotSynchronously:(_Bool)arg1 sessionId:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
...
- (void)migrateEventsFromUUID:(id)arg1 toUUID:(id)arg2 completion:(CDUnknownBlockType)arg3;
