...
@interface InstabugSurveys : NSObject <IBGSurveysRequestDelegate, IBGAnnouncementsRequestDelegate, IBGSurveyViewControllerDelegate, IBGSessionListener, IBGEventLoggerObserver, IBGCurrentDeviceLocaleListener, IBGUserControllerListener, InstabugFrameworks, IBGSnapshotManagerDelegate>
{
    ...
    CDUnknownBlockType _willSendSurveyAnswerHandler;
...
@property _Bool isTryingToShowingSurvey; // @synthesize isTryingToShowingSurvey=_isTryingToShowingSurvey;
...
@property(copy, nonatomic) CDUnknownBlockType willSendSurveyAnswerHandler; // @synthesize willSendSurveyAnswerHandler=_willSendSurveyAnswerHandler;
...
- (void)setAppStoreURLBySDK:(id)arg1;
