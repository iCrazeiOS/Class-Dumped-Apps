...
@class IBGAppVersion, IBGEditableValue, NSArray, NSAttributedString, NSDate, NSDictionary, NSOrderedSet, NSString;
...
@interface IBGDefaults : NSObject
{
    ...
    NSString *_userAttributesIfMatchHeader;
    IBGAppVersion *_appVersionFirstSeenData;
    NSString *_lastSessionUUID;
    NSString *_email;
    NSString *_reportingNumber;
    NSString *_name;
...
@property(nonatomic) _Bool shouldReturnNormalCategoriesWhenMocking; // @synthesize shouldReturnNormalCategoriesWhenMocking=_shouldReturnNormalCategoriesWhenMocking;
...
@property(nonatomic) _Bool disableMethodSwizzling; // @synthesize disableMethodSwizzling=_disableMethodSwizzling;
...
@property(nonatomic) _Bool shouldShowChatManually; // @synthesize shouldShowChatManually=_shouldShowChatManually;
@property(nonatomic) _Bool questionInPromptEnabled; // @synthesize questionInPromptEnabled=_questionInPromptEnabled;
...
@property(copy, nonatomic) NSString *identifiedName; // @synthesize identifiedName=_identifiedName;
...
@property(copy, nonatomic) NSString *reportingNumber; // @synthesize reportingNumber=_reportingNumber;
@property(copy, nonatomic) NSString *email; // @synthesize email=_email;
@property(nonatomic) _Bool hasRecentActivity; // @synthesize hasRecentActivity=_hasRecentActivity;
@property(copy, nonatomic) NSString *identifiedEmail; // @synthesize identifiedEmail=_identifiedEmail;
- (void).cxx_destruct;
...
- (_Bool)shouldShowQuestionInPrompt;
...
@property(retain, nonatomic) NSString *userAttributesIfMatchHeader; // @synthesize userAttributesIfMatchHeader=_userAttributesIfMatchHeader;
...
@property(retain, nonatomic) IBGAppVersion *appVersionFirstSeenData; // @synthesize appVersionFirstSeenData=_appVersionFirstSeenData;
@property(retain, nonatomic) NSOrderedSet *appVersionsHistory; // @synthesize appVersionsHistory=_appVersionsHistory;
@property(retain, nonatomic) NSDate *signupDate; // @synthesize signupDate=_signupDate;
