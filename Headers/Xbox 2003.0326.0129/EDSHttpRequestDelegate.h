...
@interface EDSHttpRequestDelegate : NSObject <XBXHttpRequestDelegate>
{
    struct HttpRequestCallback _callback;
}
...
- (id)initWithCallback:(struct HttpRequestCallback)arg1;
