...
@class NSDictionary, NSString, XCAudioConsentCallback, XCAudioDeviceInfo, XCConversationData, XCTextMessage, XCTokenAndSignatureCallback, XCVoiceMemberStatus;
...
- (void)OnMemberStatusChanged:(XCVoiceMemberStatus *)arg1;
