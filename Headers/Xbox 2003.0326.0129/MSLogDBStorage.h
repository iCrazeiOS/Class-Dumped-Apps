...
- (_Bool)loadLogsWithGroupId:(id)arg1 limit:(unsigned long long)arg2 excludedTargetKeys:(id)arg3 afterDate:(id)arg4 beforeDate:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (unsigned long long)countLogsBeforeDate:(id)arg1;
- (_Bool)saveLog:(id)arg1 withGroupId:(id)arg2 flags:(unsigned long long)arg3;
- (id)init;
