...
@interface SGReviewsViewController : XBXViewController <XBXSwitchPanelItemDelegate, UITableViewDataSource, UITableViewDelegate>
{
...
- (id)getViewModel;
- (void)onViewModelReviewsChanged;
- (void)onDestroy;
