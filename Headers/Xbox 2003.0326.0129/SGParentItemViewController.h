...
@interface SGParentItemViewController : SGViewController <XBXSwitchPanelItemDelegate, UITableViewDelegate, UITableViewDataSource>
{
...
- (void)onViewModelParentItemsChanged;
- (void)onDestroy;
