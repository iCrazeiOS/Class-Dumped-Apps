...
@interface SGGalleryViewController : SGViewController <XBXSwitchPanelItemDelegate, UITableViewDelegate, UITableViewDataSource>
{
...
- (void)onViewModelGalleryItemsChanged;
- (id)getViewModel;
- (void)onDestroy;
