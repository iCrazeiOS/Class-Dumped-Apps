...
#import "SGProfileFollowingsViewController.h"
...
@interface SGProfileFollowingsViewController_iPhone : SGProfileFollowingsViewController <UITableViewDataSource, UITableViewDelegate>
{
...
- (void)onViewModelClubsChanged;
- (void)onViewModelCombinedListChanged;
- (void)onDestroy;
