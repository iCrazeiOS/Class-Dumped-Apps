...
@interface SGSettingsViewController_iPhone : SGSettingsViewController
{
...
- (void)onDestroy;
- (void)scrollToLaunchedSetting;
- (struct CGPoint)getScrollToPointForTag:(id)arg1;
- (id)getTagFromContext;
- (void)onInitialize;
