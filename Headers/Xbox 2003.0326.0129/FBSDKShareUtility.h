...
+ (_Bool)_validateAssetLibraryURL:(id)arg1 name:(id)arg2 error:(id *)arg3;
...
+ (void)_testOpenGraphValueContainer:(id)arg1 containsMedia:(_Bool *)arg2 containsPhotos:(_Bool *)arg3;
+ (void)_testObject:(id)arg1 containsMedia:(_Bool *)arg2 containsPhotos:(_Bool *)arg3;
...
+ (void)testShareContent:(id)arg1 containsMedia:(_Bool *)arg2 containsPhotos:(_Bool *)arg3;
