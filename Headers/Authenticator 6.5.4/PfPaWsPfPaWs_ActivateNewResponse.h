...
@interface PfPaWsPfPaWs_ActivateNewResponse : BaseWSObject
{
    NSNumber *activateNewResult;
...
@property(copy) NSNumber *activateNewResult; // @synthesize activateNewResult;
