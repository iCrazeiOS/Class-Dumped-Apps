...
+ (_Bool)hasReceivedMemoryWarningInLastSession;
...
@property _Bool didReceiveMemoryWarningInLastSession; // @synthesize didReceiveMemoryWarningInLastSession=_didReceiveMemoryWarningInLastSession;
