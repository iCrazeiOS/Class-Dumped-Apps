...
#import <RNGestureHandler/RCTEvent-Protocol.h>
...
- (id)init;
- (id)initWithRactTag:(id)arg1 handlerTag:(id)arg2 state:(long long)arg3 prevState:(long long)arg4 extraData:(id)arg5;
