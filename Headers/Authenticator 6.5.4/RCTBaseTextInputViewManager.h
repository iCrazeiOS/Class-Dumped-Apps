...
#import <RCTText/RCTUIManagerObserver-Protocol.h>
...
+ (const struct RCTMethodInfo *)__rct_export__124378;
+ (const struct RCTMethodInfo *)__rct_export__112377;
+ (const struct RCTMethodInfo *)__rct_export__104376;
