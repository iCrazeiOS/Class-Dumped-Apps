...
#import <RCTImage/NativeImageLoaderIOSSpec-Protocol.h>
#import <RCTImage/RCTBridgeModule-Protocol.h>
#import <RCTImage/RCTImageLoaderProtocol-Protocol.h>
#import <RCTImage/RCTImageLoaderWithAttributionProtocol-Protocol.h>
...
+ (const struct RCTMethodInfo *)__rct_export__11883;
+ (const struct RCTMethodInfo *)__rct_export__11722;
+ (const struct RCTMethodInfo *)__rct_export__11531;
+ (const struct RCTMethodInfo *)__rct_export__11340;
...
- (id)loadImageWithURLRequest:(id)arg1 size:(struct CGSize)arg2 scale:(double)arg3 clipped:(_Bool)arg4 resizeMode:(long long)arg5 priority:(unsigned long long)arg6 attribution:(const struct ImageURLLoaderAttribution *)arg7 progressBlock:(CDUnknownBlockType)arg8 partialLoadBlock:(CDUnknownBlockType)arg9 completionBlock:(CDUnknownBlockType)arg10;
- (CDUnknownBlockType)_loadURLRequest:(id)arg1 progressBlock:(CDUnknownBlockType)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (id)_loadImageOrDataWithURLRequest:(id)arg1 size:(struct CGSize)arg2 scale:(double)arg3 resizeMode:(long long)arg4 priority:(unsigned long long)arg5 attribution:(const struct ImageURLLoaderAttribution *)arg6 progressBlock:(CDUnknownBlockType)arg7 partialLoadBlock:(CDUnknownBlockType)arg8 completionBlock:(CDUnknownBlockType)arg9;
- (void)dequeueTasks;
- (CDUnknownBlockType)loadImageWithURLRequest:(id)arg1 size:(struct CGSize)arg2 scale:(double)arg3 clipped:(_Bool)arg4 resizeMode:(long long)arg5 priority:(unsigned long long)arg6 progressBlock:(CDUnknownBlockType)arg7 partialLoadBlock:(CDUnknownBlockType)arg8 completionBlock:(CDUnknownBlockType)arg9;
...
- (CDUnknownBlockType)loadImageWithURLRequest:(id)arg1 priority:(unsigned long long)arg2 callback:(CDUnknownBlockType)arg3;
