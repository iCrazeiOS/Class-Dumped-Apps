...
@class NSString, UAInAppMessage, UAInAppMessageFullScreenStyle, UAInAppMessageFullScreenViewController, UIWindowScene;
...
@interface UAInAppMessageFullScreenAdapter : NSObject <UAInAppMessageAdapterProtocol>
{
    ...
    UAInAppMessageFullScreenViewController *_fullScreenController;
...
@property(retain, nonatomic) UAInAppMessageFullScreenViewController *fullScreenController; // @synthesize fullScreenController=_fullScreenController;
