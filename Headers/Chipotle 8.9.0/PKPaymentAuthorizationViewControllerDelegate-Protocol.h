...
- (void)paymentAuthorizationViewController:(PKPaymentAuthorizationViewController *)arg1 didSelectShippingAddress:(id)arg2 completion:(void (^)(long long, NSArray *, NSArray *))arg3;
