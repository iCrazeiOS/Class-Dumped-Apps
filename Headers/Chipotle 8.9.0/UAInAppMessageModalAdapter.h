...
@class NSString, UAInAppMessage, UAInAppMessageModalStyle, UAInAppMessageModalViewController, UAInAppMessageResizableViewController, UIWindowScene;
...
@interface UAInAppMessageModalAdapter : NSObject <UAInAppMessageAdapterProtocol>
{
    ...
    UAInAppMessageModalViewController *_modalController;
...
@property(retain, nonatomic) UAInAppMessageModalViewController *modalController; // @synthesize modalController=_modalController;
