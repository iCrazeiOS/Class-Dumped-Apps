...
- (void)sd_setBackgroundImageWithURL:(id)arg1 forState:(unsigned long long)arg2 placeholderImage:(id)arg3 options:(unsigned long long)arg4 context:(struct NSDictionary *)arg5 progress:(CDUnknownBlockType)arg6 completed:(CDUnknownBlockType)arg7;
...
- (void)sd_setBackgroundImageWithURL:(id)arg1 forState:(unsigned long long)arg2 placeholderImage:(id)arg3 options:(unsigned long long)arg4 context:(struct NSDictionary *)arg5;
...
- (void)sd_setImageWithURL:(id)arg1 forState:(unsigned long long)arg2 placeholderImage:(id)arg3 options:(unsigned long long)arg4 context:(struct NSDictionary *)arg5 progress:(CDUnknownBlockType)arg6 completed:(CDUnknownBlockType)arg7;
...
- (void)sd_setImageWithURL:(id)arg1 forState:(unsigned long long)arg2 placeholderImage:(id)arg3 options:(unsigned long long)arg4 context:(struct NSDictionary *)arg5;
