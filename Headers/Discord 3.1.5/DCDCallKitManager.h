...
+ (const struct RCTMethodInfo *)__rct_export__1808;
+ (const struct RCTMethodInfo *)__rct_export__1677;
+ (const struct RCTMethodInfo *)__rct_export__1506;
+ (const struct RCTMethodInfo *)__rct_export__1385;
...
- (void)reportNewIncomingCall:(id)arg1 handle:(id)arg2 hasVideo:(_Bool)arg3 localizedCallerName:(id)arg4 resolve:(CDUnknownBlockType)arg5 reject:(CDUnknownBlockType)arg6;
