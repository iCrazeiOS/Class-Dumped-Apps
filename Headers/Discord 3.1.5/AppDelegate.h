...
@class DCDBundleUpdater, NSString, NSTimer, UIActivityIndicatorView, UIWindow;

@interface AppDelegate : UIResponder <UIApplicationDelegate, UNUserNotificationCenterDelegate, CrashlyticsDelegate>
{
