...
+ (id)unmuteDMToastWithUserReference:(id)arg1 undoAction:(CDUnknownBlockType)arg2;
+ (id)muteDMToastWithUserReference:(id)arg1 undoAction:(CDUnknownBlockType)arg2;
