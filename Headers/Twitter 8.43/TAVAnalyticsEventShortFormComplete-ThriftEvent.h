...
#import <TwitterAVCore/TAVAnalyticsEventShortFormComplete.h>
...
@interface TAVAnalyticsEventShortFormComplete (ThriftEvent) <TVDIAnalyticsScribeMediaEventTypeBuilder>
- (id)thriftEvent;
