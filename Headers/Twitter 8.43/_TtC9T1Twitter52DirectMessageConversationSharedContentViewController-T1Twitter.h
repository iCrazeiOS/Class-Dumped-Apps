...
#import <T1Twitter/_TtC9T1Twitter52DirectMessageConversationSharedContentViewController.h>

@interface _TtC9T1Twitter52DirectMessageConversationSharedContentViewController (T1Twitter)
