...
#import <T1Twitter/TFSProgressCenterObserver-Protocol.h>
...
@interface T1TabBarViewController : UIViewController <TFNCustomTabBarDelegate, TFNLayoutMetricsEnvironment, TFSProgressCenterObserver, T1TabBarIntegration>
{
    _Bool _tabBarHidden;
