...
@interface TFSTwitterAPIDirectMessageUpdateLastSeenEventIDRequest : TFSTwitterAPIEndpointRequest
{
}

+ (long long)HTTPMethodValue;
+ (id)endpointPath;
- (id)initWithLastSeenEventID:(id)arg1 trustedLastEventID:(id)arg2 untrustedLastSeenEventID:(id)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
