...
- (id)request;
- (id)initWithAccountID:(id)arg1 conversationID:(id)arg2 dmID:(id)arg3 reactionKey:(id)arg4 requestID:(id)arg5 context:(id)arg6 source:(unsigned long long)arg7 completionBlock:(CDUnknownBlockType)arg8;
