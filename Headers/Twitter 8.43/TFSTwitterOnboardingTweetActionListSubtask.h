...
@interface TFSTwitterOnboardingTweetActionListSubtask : TFSTwitterOnboardingSubtask
{
    ...
    TFSTwitterOnboardingNavigationLink *_errorLink;
...
@property(readonly, nonatomic) TFSTwitterOnboardingNavigationLink *errorLink; // @synthesize errorLink=_errorLink;
