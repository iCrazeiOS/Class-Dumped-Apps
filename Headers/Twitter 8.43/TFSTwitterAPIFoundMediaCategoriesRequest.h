...
@interface TFSTwitterAPIFoundMediaCategoriesRequest : TFSTwitterAPIEndpointRequest
{
}

+ (_Bool)supportSharedCaching;
+ (unsigned long long)responseHydrationFlags;
- (id)initWithCategoryPathItems:(id)arg1 provider:(id)arg2 cursor:(id)arg3 imageFormat:(long long)arg4 context:(id)arg5 responseModelBuilder:(id)arg6;
