...
@class NSArray, NSMutableSet, NSString, TFNTwitterMediaUploadConfiguration, TNUTransactionMetrics;
@protocol TFNTwitterMediaAssetUploaderDelegate, TFSTwitterLegacyScribeLogMethods, TNUNetworkQualityProvider;
