...
- (id)request;
- (id)initWithAccountID:(id)arg1 conversationID:(id)arg2 avatarID:(id)arg3 requestID:(id)arg4 context:(id)arg5 source:(unsigned long long)arg6 completionBlock:(CDUnknownBlockType)arg7;
