...
- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool mutingEnabledState; // @synthesize mutingEnabledState=_mutingEnabledState;
...
- (void)run;
- (id)initWithModel:(id)arg1 updatedLowQualityFilterState:(id)arg2 updatedNsfwMediaFilterState:(id)arg3 updatedMutingEnabledState:(_Bool)arg4;
- (id)init;
