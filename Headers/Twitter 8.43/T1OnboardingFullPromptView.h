...
@class NSArray, NSString, T1FlexibleLayoutView, T1PromptContentViewSpec, T1PromptImageSpec, T1PromptTextSpec, TFNAttributedTextView, UIButton, UIImageView, UIScrollView;
