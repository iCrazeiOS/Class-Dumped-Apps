...
#import <TwitterCrashlytics/OIDExternalUserAgentRequest-Protocol.h>
...
+ (_Bool)isSupportedResponseType:(id)arg1;
- (void).cxx_destruct;
...
- (id)initWithConfiguration:(id)arg1 clientId:(id)arg2 clientSecret:(id)arg3 scope:(id)arg4 redirectURL:(id)arg5 responseType:(id)arg6 state:(id)arg7 nonce:(id)arg8 codeVerifier:(id)arg9 codeChallenge:(id)arg10 codeChallengeMethod:(id)arg11 additionalParameters:(id)arg12;
- (id)init;
