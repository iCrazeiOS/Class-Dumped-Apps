...
@interface TAVAnalyticsShortFormCompleteTracker : NSObject <TAVAnalyticsTracker>
{
...
- (id)playthroughStateForPlayThroughID:(id)arg1;
- (void)handlePlaybackCompletionNotification:(id)arg1;
