...
@class NSString, TFNBasicTransitionCoordinator, TFNDimBackgroundTransitionEffect, TFNNativeModalSheetContentHostView, TFNNativeModalSheetTransitioningDelegate, UIBarButtonItem, UIColor, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;
@protocol TFNModalContainerViewControllerDelegate, TFNModalSheetViewControllerLayoutDelegate;

@interface TFNNativeModalSheetViewController : UIViewController <UIGestureRecognizerDelegate, TFNLayoutMetricsEnvironment, TFNModalContainerViewController, TFNPopoverSourceSpecification, TFNModalSheetViewController>
{
    TFNNativeModalSheetTransitioningDelegate *_modalSheetTransitioningDelegate;
    TFNNativeModalSheetContentHostView *_modalContentHostView;
...
- (void)setDismissAnimationDuration:(double)arg1;
- (double)dismissAnimationDuration;
- (void)setDismissAnimationVelocity:(double)arg1;
- (double)dismissAnimationVelocity;
- (void)setPresented:(_Bool)arg1;
- (_Bool)isPresented;
- (void)setAnimatingPresentationTransition:(_Bool)arg1;
- (_Bool)isAnimatingPresentationTransition;
- (void)setBackgroundTransitionEffect:(id)arg1;
- (id)backgroundTransitionEffect;
...
- (void)_setupCustomGestureRecognizersIfNeeded;
...
- (id)_tfn_rootTraitCollection;
- (struct CGSize)_modalContentSizeForPopover;
- (struct CGRect)_tfn_modalContentFrameForPopover;
...
- (_Bool)isCurrentLayoutModeCustom;
- (_Bool)isCurrentLayoutModeNative;
