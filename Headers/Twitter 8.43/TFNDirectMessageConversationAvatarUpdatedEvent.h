...
@class NSDate, NSString, TFNDirectMessageConversationAvatarUpdatedEntry, TFSTwitterEntityImageInfo;
...
- (id)initWithEventID:(long long)arg1 time:(id)arg2 requestID:(id)arg3 conversationID:(id)arg4 avatarInfo:(id)arg5 entry:(id)arg6;
