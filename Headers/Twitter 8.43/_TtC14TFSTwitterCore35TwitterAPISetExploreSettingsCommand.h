...
@interface _TtC14TFSTwitterCore35TwitterAPISetExploreSettingsCommand : TFSTwitterAPICommand
{
    // Error parsing type: , name: usePersonalizedTrends
    // Error parsing type: , name: useCurrentLocation
