...
@interface TUIEmptyContentMessage : NSObject
{
    NSString *_title;
    NSString *_subtitle;
...
- (id)initWithTitle:(id)arg1 titleBoldTextRange:(struct _NSRange)arg2 subtitle:(id)arg3 subtitleActiveTextRange:(struct _NSRange)arg4 subtitleActiveTextAction:(CDUnknownBlockType)arg5 buttonText:(id)arg6 scribeContext:(id)arg7 buttonStrength:(unsigned long long)arg8 buttonAction:(CDUnknownBlockType)arg9;
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 buttonText:(id)arg3 scribeContext:(id)arg4 buttonAction:(CDUnknownBlockType)arg5;
