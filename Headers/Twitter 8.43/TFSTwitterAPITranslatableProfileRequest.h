...
@interface TFSTwitterAPITranslatableProfileRequest : TFSTwitterAPIEndpointRequest
{
}

+ (unsigned long long)baseURLType;
- (id)initWithProfileUserID:(long long)arg1 destinationLanguage:(id)arg2 context:(id)arg3 responseModelBuilder:(id)arg4;
