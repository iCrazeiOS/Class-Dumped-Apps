...
@interface TFSTwitterAPIAmplifyMarketplaceVideosPostRequest : TFSTwitterAPIEndpointRequest
{
}
...
- (id)initWithMediaID:(id)arg1 monetize:(_Bool)arg2 videoCategories:(id)arg3 excludedAdvertisers:(id)arg4 excludedMonetizationCategories:(id)arg5 excludedAdsCategories:(id)arg6 context:(id)arg7 responseModelBuilder:(id)arg8;
