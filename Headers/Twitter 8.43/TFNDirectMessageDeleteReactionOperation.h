...
@class NSString, TFNDirectMessageConversation, TFNDirectMessageEntry, TFNDirectMessageModel;

@interface TFNDirectMessageDeleteReactionOperation : TFNDirectMessageAPICommandOperation
{
