...
@interface TFSTwitterAPIDirectMessageConversationMuteRequest : TFSTwitterAPIEndpointRequest
{
}

+ (long long)HTTPMethodValue;
- (id)initWithConversationID:(id)arg1 userID:(id)arg2 muted:(_Bool)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
