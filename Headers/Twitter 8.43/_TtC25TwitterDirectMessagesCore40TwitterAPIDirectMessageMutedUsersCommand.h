...
@interface _TtC25TwitterDirectMessagesCore40TwitterAPIDirectMessageMutedUsersCommand : TFSTwitterAPICommand
{
    // Error parsing type: , name: dmUsers
    // Error parsing type: , name: count
    // Error parsing type: , name: responseCursor
