...
+ (id)createFrameAtIndex:(unsigned long long)arg1 source:(struct CGImageSource *)arg2 scale:(double)arg3 preserveAspectRatio:(_Bool)arg4 thumbnailSize:(struct CGSize)arg5;
