...
#import <AmazonChimeSDKMedia/AVCaptureVideoDataOutputSampleBufferDelegate-Protocol.h>

@class AVCaptureDevice, AVCaptureSession, AVCaptureVideoDataOutput, NSObject, NSString;
@protocol OS_dispatch_queue;

@interface Chime_RTCCameraVideoCapturer : Chime_RTCVideoCapturer <AVCaptureVideoDataOutputSampleBufferDelegate>
{
