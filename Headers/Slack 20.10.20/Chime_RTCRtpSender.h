...
#import <AmazonChimeSDKMedia/RTCRtpSender-Protocol.h>

@class Chime_RTCMediaStreamTrack, Chime_RTCRtpParameters, NSArray, NSString, RTCPeerConnectionFactory;
@protocol RTCDtmfSender;

@interface Chime_RTCRtpSender : NSObject <RTCRtpSender>
{
