...
- (_Bool)handleCommandDM:(NSMutableArray *)arg1 genericChannel:(id <SLKChannelGenerics>)arg2 textEncoder:(id <SLKMessageEncoderProtocol>)arg3 messageInfo:(SLKMessageInfo *)arg4;
- (_Bool)handleCommandMSG:(NSMutableArray *)arg1 genericChannel:(id <SLKChannelGenerics>)arg2 textEncoder:(id <SLKMessageEncoderProtocol>)arg3 messageInfo:(SLKMessageInfo *)arg4;
- (_Bool)handleCommandRemoveAppUser:(NSString *)arg1 channelId:(NSString *)arg2;
- (_Bool)handleCommandInvite:(NSMutableArray *)arg1 genericChannel:(id <SLKChannelGenerics>)arg2 textEncoder:(id <SLKMessageEncoderProtocol>)arg3;
