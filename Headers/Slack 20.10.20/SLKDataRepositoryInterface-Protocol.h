...
@class NSDictionary, NSManagedObjectContext, NSNotificationCenter, SLKAccount, SLKManagedObjectContext, SLKTraceContext, _TtC13SlackCoreData23SLKManagedObjectContext, _TtC13SlackCoreData29DataRepositoryObserverManager;
...
- (SLKManagedObjectContext *)contextForType:(unsigned long long)arg1;
