...
#import <AmazonChimeSDKMedia/RTCVideoEncoder-Protocol.h>

@class Chime_RTCVideoCodecInfo, NSString;

@interface Chime_RTCVideoEncoderH264 : NSObject <RTCVideoEncoder>
{
    Chime_RTCVideoCodecInfo *_codecInfo;
    ...
    _Bool _gpu_acceleration_disabled;
