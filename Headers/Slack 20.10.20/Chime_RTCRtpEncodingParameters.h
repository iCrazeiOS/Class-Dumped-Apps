...
@interface Chime_RTCRtpEncodingParameters : NSObject
{
    _Bool _isActive;
    NSString *_rid;
...
@property(nonatomic) double bitratePriority; // @synthesize bitratePriority=_bitratePriority;
