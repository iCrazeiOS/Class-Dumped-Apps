...
@class JVFloatLabeledTextField, NSLayoutConstraint, SLKActivityIndicator, UILabel, UIView;
...
@property(nonatomic, retain) SLKActivityIndicator *loadingIndicator; // @synthesize loadingIndicator;
